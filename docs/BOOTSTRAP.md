...
`bootstrap/bootstrap.c` file produced by the **self-hosted** Vader compiler,
...
└────────────┬─────────────────┘
             │
             ▼  cc -O2 bootstrap/bootstrap.c runtime/c/vader_runtime.c -Iruntime/c -o stage1
┌──────────────────────────────┐
...
- **`bootstrap/bootstrap.c`** — a plain C translation unit, the mirror of
...
```
bootstrap/bootstrap.c   -diff -merge linguist-generated=true
```
...
mkdir -p build
cc -O2 -o build/stage1 bootstrap/bootstrap.c runtime/c/vader_runtime.c -Iruntime/c -lm
...
The contract : `cc -O2 bootstrap/bootstrap.c
...
1. `cc -O2 bootstrap/bootstrap.c runtime/c/vader_runtime.c -Iruntime/c -lm -o build/stage1`
...
> `bootstrap/bootstrap.c` lets any machine with a C compiler build the
