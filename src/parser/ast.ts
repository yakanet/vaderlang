...
export interface Program extends AstNode {
  ...
  /** The `module "..."` declaration. Null when absent — the parser is
   *  tolerant ; the resolver's scan emits R2020 on absence. */
