...
vader_string_t std_path_to_posix(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_struct___lambda_env_lib_std_path_1_t* _a0_obj = (vader_struct___lambda_env_lib_std_path_1_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_lib_std_path_1_t));
    ...
    _a1_closure->code = (void*) &vader_fn_lift___lambda_lib_std_path_0;
    _a1_closure->env = t0;
    l1 = (void*) _a1_closure;
