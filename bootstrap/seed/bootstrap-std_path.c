...
vader_string_t std_path_filename(vader_string_t l0) {
    ...
    l1 = l0;
    l2 = std_string_last_index_of(l1, 47u, (ptrdiff_t) 0);
    if ((l2 < INT64_C(0))) {
...
vader_string_t std_path_parent(vader_string_t l0) {
    ...
    if (l2 == INT64_C(0)) {
        { vader_gc_top = gc_frame.prev; return 278u; }
    }
    l3 = vader_host_std_core_bytes(l1);
...
vader_string_t std_path_to_posix(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_struct___lambda_env_std_path_1_t* _a0_obj = (vader_struct___lambda_env_std_path_1_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_std_path_1_t));
    vader_obj_header_init(_a0_obj, 226u);
    t0 = (void*) _a0_obj;
    vader_fn_t* _a1_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a1_closure, 162u);
    _a1_closure->code = (void*) &vader_fn_lift___lambda_std_path_0;
    _a1_closure->env = t0;
    l1 = (void*) _a1_closure;
    t1 = std_string_replace_chars_where(l0, l1, 278u);
