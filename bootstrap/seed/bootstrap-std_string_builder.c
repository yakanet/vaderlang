...
void std_string_builder_append(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_push((vader_array_t*) ((vader_struct_std_string_builder_StringBuilder_t*) l0)->f_parts, vader_box_string(177u, l1));
...
void std_string_builder_append_char(void* l0, uint32_t l1) {
    ...
    vader_array_push((vader_array_t*) l2, vader_box_string(177u, l3));
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
void std_string_builder_append_repeated(void* l0, uint32_t l1, int32_t l2) {
    ...
    l4 = INT32_C(0);
    {
        loop_7: {
            if ((l4 < l2)) {
                vader_array_push((vader_array_t*) ((vader_struct_std_string_builder_StringBuilder_t*) l0)->f_parts, vader_box_string(177u, l3));
                l4 = (l4 + INT32_C(1));
                goto loop_7;
            }
        }
