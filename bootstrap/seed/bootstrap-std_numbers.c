...
vader_box_t std_numbers_parse_uint_in_base(vader_string_t l0, int32_t l1) {
    ...
    l4 = std_string_chars(l0);
    {
        loop_16: {
            ...
            if (l5.tag == 0u) {
                t3 = vader_box_i64(180u, (int64_t)(uint64_t) l2);
...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    t1 = std_string_string_Contains_contains(l5, 865u);
    if (!(t1)) {
    ...
    vader_obj_header_init(_a2_closure, 142u);
...
vader_string_t std_numbers_to_hex(uint64_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(7u, 0u, 11u, 170u);
    l1 = (void*) _a0_arr;
