...
vader_box_t std_numbers_parse_uint_in_base(vader_string_t l0, int32_t l1) {
    ...
    l4 = std_string_chars(l0);
    {
        loop_16: {
            ...
            l11 = t3;
            if (l12 == INT32_C(1)) {
                t5 = vader_box_i64(186u, (int64_t)(uint64_t) l2);
...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    t1 = std_string_string_Contains_contains(l5, 900u);
    if (!(t1)) {
    ...
    vader_obj_header_init(_a1_obj, 212u);
    t0 = (void*) _a1_obj;
...
vader_string_t std_numbers_to_hex(uint64_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(7u, 0u, 11u, 176u);
    l1 = (void*) _a0_arr;
