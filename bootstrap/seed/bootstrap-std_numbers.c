...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    vader_struct___lambda_env_6090_t* _a1_obj = (vader_struct___lambda_env_6090_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_6090_t));
    ...
    _a2_closure->code = (void*) &vader_fn_lift_2516;
    _a2_closure->env = t0;
    l3 = (void*) _a2_closure;
