...
vader_box_t std_numbers_parse_uint_in_base(vader_string_t l0, int32_t l1) {
    ...
    t4 = vader_box_i64(170u, (int64_t)(uint64_t) l2);
...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    vader_struct___lambda_env_5936_t* _a1_obj = (vader_struct___lambda_env_5936_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5936_t));
    ...
    _a2_closure->code = (void*) &vader_fn_lift_2486;
    _a2_closure->env = t0;
    l3 = (void*) _a2_closure;
...
vader_string_t std_numbers_to_hex(uint64_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(7u, 0u, 11u, 161u);
    l1 = (void*) _a0_arr;
