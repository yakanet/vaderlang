...
vader_box_t std_numbers_parse_uint_in_base(vader_string_t l0, int32_t l1) {
    ...
    t4 = vader_box_i64(169u, (int64_t)(uint64_t) l2);
...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    t1 = std_string_byte_contains(l5, 857u);
    if (!(t1)) {
        { vader_string_t __vret = l5; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_struct___lambda_env_6037_t* _a1_obj = (vader_struct___lambda_env_6037_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_6037_t));
    vader_obj_header_init(_a1_obj, 263u);
    t0 = (void*) _a1_obj;
    vader_fn_t* _a2_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a2_closure, 134u);
    _a2_closure->code = (void*) &vader_fn_lift_2500;
    _a2_closure->env = t0;
    l3 = (void*) _a2_closure;
...
vader_string_t std_numbers_to_hex(uint64_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(7u, 0u, 11u, 160u);
    l1 = (void*) _a0_arr;
