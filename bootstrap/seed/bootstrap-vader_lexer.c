    ...
    l2 = (size_t) (int64_t) INT64_C(0);
    {
        loop_3: {
            if ((l2 < l1)) {
                ...
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l6, 170u);
            ...
            if (!(t0)) {
                ...
                if (l5 == 95u) {
                    ...
                    if (l9) {
                        ...
                        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l10, 2250u);
                    } else {
                    }
                    l3 = true;
                    l4 = false;
...
static void vader_lexer_flush_string_part(void* l0, void* l1, void* l2, bool l3) {
    ...
    ((vader_struct_vader_lexer_Token_t*) l5)->f_value = vader_box_string(164u, l4);
...
static void vader_lexer_lex_char(void* l0) {
    ...
    if (t0 == 39u) {
        ...
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(4), l2, 1339u);
        ...
        ((vader_struct_vader_lexer_Token_t*) l2)->f_value = vader_box_i32(167u, INT32_C(0));
    ...
    if (t0 == 92u) {
        ...
        ((vader_struct_vader_lexer_Token_t*) l31)->f_value = vader_box_i32(172u, (int32_t)(uint32_t) l6);
    ...
    if (l7) {
        l2 = vader_lexer_error_span(l0, l1);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(4), l2, 2273u);
        l2 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_bytes;
        l3 = ((vader_struct_toolchain_span_Position_t*) l1)->f_offset;
        l4 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_pos;
...
static uint32_t vader_lexer_lex_escape(void* l0, bool l1) {
    ...
    if (t0) {
        ...
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(3), l3, 1688u);
    ...
    if (l4 == 39u) {
        l3 = vader_lexer_error_span(l0, l2);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(3), l3, 1462u);
        { uint32_t __vret = (uint32_t) (int32_t) ((int32_t) (uint32_t) l4); vader_gc_top = gc_frame.prev; return __vret; }
    }
    l7 = (uint8_t) (int32_t) INT32_C(3);
    l8 = vader_lexer_error_span(l0, l2);
...
static void vader_lexer_lex_number(void* l0) {
    ...
    if (l3 != INT32_C(10)) {
        ...
        if (t1 == l6) {
            ...
            vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l7, 1485u);
        } else {
        }
    } else {
        ...
        if (l5) {
            ...
            if (!(t2)) {
                l7 = vader_lexer_error_span(l0, l1);
                vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l7, 1490u);
            } else {
            }
            vader_lexer_consume_digits(l0, INT32_C(10), l1);
        } else {
    ...
    if (t2) {
        ((vader_struct_vader_lexer_Token_t*) l7)->f_value = vader_box_i64(168u, INT64_C(0));
    ...
    if (l2) {
        ...
        if ((l12.tag == 160u || l12.tag == 161u)) {
            t4 = ((double) l12.payload.f);
            l13 = vader_box_f64(161u, t4);
    ...
    if (l12.tag == 173u) {
        ...
        ((vader_struct_vader_lexer_Token_t*) l7)->f_value = vader_box_i64(173u, (int64_t)(uint64_t) l14);
        VADER_WRITE_BARRIER((vader_struct_vader_lexer_Token_t*) l7);
        vader_lexer_emit(l0, l7);
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void vader_lexer_lex_one(void* l0) {
    ...
    if (l1.tag == 693u) {
        ...
        if (l2) {
            l3 = vader_lexer_position_here(l0);
            vader_lexer_advance(l0, (size_t) (int64_t) INT64_C(1));
            vader_lexer_push_simple(l0, (uint8_t) (int32_t) INT32_C(10), 2411u, l3);
            t2 = l1.payload.obj;
        ...
        t4 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l54, 170u);
    ...
    if (l1.tag == 0u) {
        ...
        t4 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l54, 170u);
        t5 = ((uint8_t) t4.payload.i);
        l55 = std_string_utf8_lead_len(t5);
        vader_lexer_advance(l0, l55);
        l56 = (uint8_t) (int32_t) INT32_C(0);
...
static void vader_lexer_lex_string_body(void* l0, bool l1, bool l2) {
        ...
        loop_9: {
            ...
            if (!(t1)) {
                ...
                if (l30) {
                    ...
                    vader_obj_header_init(_a10_obj, 383u);
                    _a10_obj->f_parts = t0;
                    l4 = (void*) _a10_obj;
                    l5 = false;
                    goto loop_9;
    ...
    vader_obj_header_init(_a12_obj, 475u);
    _a12_obj->f_start = l3;
    _a12_obj->f_end = l3;
    l3 = (void*) _a12_obj;
...
static uint32_t vader_lexer_lex_unicode_escape(void* l0, void* l1) {
    ...
    if (t0 != 123u) {
        l2 = vader_lexer_error_span(l0, l1);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(8), l2, 1467u);
        { vader_gc_top = gc_frame.prev; return (uint32_t) (int32_t) INT32_C(0); }
    }
    vader_lexer_advance(l0, (size_t) (int64_t) INT64_C(1));
    l3 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_pos;
...
static void* vader_lexer_new_lexer(vader_string_t l0, vader_string_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(54u, 0u, 13u, 695u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(52u, 0u, 13u, 692u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(53u, 0u, 13u, 693u);
    l5 = (void*) _a2_arr;
...
void* vader_lexer_tokenize(vader_string_t l0, vader_string_t l1) {
    ...
    if ((t0 >= INT64_C(3))) {
        ...
        t1 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) INT32_C(0), 170u);
    ...
    if (l3) {
        ...
        t1 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) INT32_C(1), 170u);
        t2 = ((uint8_t) t1.payload.i);
        l3 = t2 == INT32_C(187);
    } else {
        l3 = false;
    ...
    if (l3) {
        ...
        t1 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) INT32_C(2), 170u);
        t2 = ((uint8_t) t1.payload.i);
        l3 = t2 == INT32_C(191);
    } else {
        l3 = false;
