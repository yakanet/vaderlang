            ...
            if (!(t0)) {
                ...
                if (l5 == 95u) {
                    ...
                    if (l9) {
                        ...
                        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l10, 2256u);
                    } else {
                    }
                    l3 = true;
                    l4 = false;
...
static void vader_lexer_lex_char(void* l0) {
    ...
    if (t0 == 39u) {
        ...
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(4), l2, 1342u);
    ...
    if (l7) {
        l2 = vader_lexer_error_span(l0, l1);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(4), l2, 2279u);
        l2 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_bytes;
        l3 = ((vader_struct_toolchain_span_Position_t*) l1)->f_offset;
        l4 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_pos;
...
static uint32_t vader_lexer_lex_escape(void* l0, bool l1) {
    ...
    if (t0) {
        ...
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(3), l3, 1691u);
    ...
    if (l4 == 39u) {
        l3 = vader_lexer_error_span(l0, l2);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(3), l3, 1465u);
        { uint32_t __vret = (uint32_t) (int32_t) ((int32_t) (uint32_t) l4); vader_gc_top = gc_frame.prev; return __vret; }
    }
    l7 = (uint8_t) (int32_t) INT32_C(3);
    l8 = vader_lexer_error_span(l0, l2);
...
static void vader_lexer_lex_number(void* l0) {
    ...
    if (l3 != INT32_C(10)) {
        ...
        if (t1 == l6) {
            ...
            vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l7, 1488u);
        } else {
        }
    } else {
        ...
        if (l5) {
            ...
            if (!(t2)) {
                l7 = vader_lexer_error_span(l0, l1);
                vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(5), l7, 1493u);
            } else {
            }
            vader_lexer_consume_digits(l0, INT32_C(10), l1);
        } else {
...
static void vader_lexer_lex_one(void* l0) {
    ...
    if (l1.tag == 716u) {
        ...
        if (l2) {
            l3 = vader_lexer_position_here(l0);
            vader_lexer_advance(l0, (size_t) (int64_t) INT64_C(1));
            vader_lexer_push_simple(l0, (uint8_t) (int32_t) INT32_C(10), 2417u, l3);
            t2 = l1.payload.obj;
        ...
        loop_9: {
            ...
            if (!(t1)) {
                ...
                if (l22) {
                    ...
                    _a5_obj->f_end = l24;
                    l25 = (void*) _a5_obj;
                    l26 = vader_lexer_make_token((uint8_t) (int32_t) INT32_C(9), 265u, l25);
                    ...
                    vader_obj_header_init(_a6_obj, 716u);
                ...
                if (l30) {
                    ...
                    _a7_obj->f_end = l32;
                    l33 = (void*) _a7_obj;
                    l34 = vader_lexer_make_token((uint8_t) (int32_t) INT32_C(9), 253u, l33);
...
static uint32_t vader_lexer_lex_unicode_escape(void* l0, void* l1) {
    ...
    if (t0 != 123u) {
        l2 = vader_lexer_error_span(l0, l1);
        vader_lexer_push_error(l0, (uint8_t) (int32_t) INT32_C(8), l2, 1470u);
        { vader_gc_top = gc_frame.prev; return (uint32_t) (int32_t) INT32_C(0); }
    }
    vader_lexer_advance(l0, (size_t) (int64_t) INT64_C(1));
    l3 = ((vader_struct_vader_lexer_Lexer_t*) l0)->f_pos;
...
static void* vader_lexer_new_lexer(vader_string_t l0, vader_string_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(54u, 0u, 13u, 718u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(52u, 0u, 13u, 715u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(53u, 0u, 13u, 716u);
    l5 = (void*) _a2_arr;
