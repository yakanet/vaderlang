...
static void vader_lexer_lex_char(void* l0) {
    ...
    if (t0 == 92u) {
        ...
        ((vader_struct_vader_lexer_Token_t*) l31)->f_value = vader_box_i32(171u, (int32_t)(uint32_t) l6);
...
static void vader_lexer_lex_number(void* l0) {
    ...
    if (l12.tag == 172u) {
        ...
        ((vader_struct_vader_lexer_Token_t*) l7)->f_value = vader_box_i64(172u, (int64_t)(uint64_t) l14);
        VADER_WRITE_BARRIER((vader_struct_vader_lexer_Token_t*) l7);
        vader_lexer_emit(l0, l7);
        { vader_gc_top = gc_frame.prev; return; }
    }
        ...
        loop_9: {
            ...
            if (!(t1)) {
                ...
                if (l22) {
                    ...
                    vader_obj_header_init(_a6_obj, 713u);
...
static void* vader_lexer_new_lexer(vader_string_t l0, vader_string_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(53u, 0u, 13u, 715u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(51u, 0u, 13u, 712u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(52u, 0u, 13u, 713u);
    l5 = (void*) _a2_arr;
