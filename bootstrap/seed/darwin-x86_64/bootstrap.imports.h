...
static inline int32_t vader_host_system_posix_ns_get_executable_path(void* a0, uint32_t a1) { vader_slice_t s0 = vader_array_bytes((vader_array_t*) a0); uint32_t p1 = a1; return _NSGetExecutablePath((void*) s0.ptr, (void*) &p1); }
