...
static bool json_decode_unicode_escape(void* l0, void* l1) {
    ...
    if (t0) {
        ...
        if ((l4 <= l5)) {
            ...
            t3 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 181u);
        ...
        if (l6) {
            ...
            t3 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 181u);
            t4 = ((uint8_t) t3.payload.i);
            l6 = t4 == INT32_C(117);
        } else {
            l6 = false;
...
static void* json_fail(void* l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a0_obj, 281u);
    _a0_obj->f_msg = l1;
    _a0_obj->f_pos = l2;
    t0 = (void*) _a0_obj;
    ...
    l3 = (size_t) (int64_t) INT64_C(0);
    {
        loop_20: {
            if ((l3 < l2)) {
                ...
                if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
                if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 181u);
                l6 = ((uint8_t) t2.payload.i);
                l7 = vader_host_std_core_byte_at(l1, l3);
                if (l6 != l7) {
                    { vader_gc_top = gc_frame.prev; return false; }
                }
                t1 = (l3 + INT64_C(1));
...
static void* json_new_parser(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 286u);
    _a0_obj->f_src = l0;
    _a0_obj->f_bytes = l1;
...
static vader_box_t json_parse_array(void* l0, int32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1034u);
    l2 = (void*) _a0_arr;
    json_skip_ws(l0);
    t2 = json_at_end(l0);
    if (!(t2)) {
    ...
    if (l3) {
        ...
        vader_obj_header_init(_a1_obj, 279u);
        _a1_obj->f_items = l2;
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_37: {
            ...
            if (!(t2)) {
                ...
                if (l7 == 93u) {
                    ...
                    vader_obj_header_init(_a2_obj, 279u);
                    _a2_obj->f_items = l2;
                    t1 = (void*) _a2_obj;
                    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
                }
                t1 = json_fail(l0, 1534u);
                { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
            }
        }
    }
...
static vader_box_t json_parse_number(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_slice((vader_array_t*) l5, (size_t) l1, (size_t) l6);
    t2 = (void*) _a0_arr;
    t3 = vader_host_std_core_bytes_to_string(t2);
    l7 = std_string_parse_float(t3);
    if ((l7.tag == 171u || l7.tag == 172u)) {
        t4 = ((double) l7.payload.f);
        ...
        vader_obj_header_init(_a1_obj, 283u);
        _a1_obj->f_value = t4;
        t2 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l7.tag == 394u) {
        t2 = json_fail(l0, 1804u);
        { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t json_parse_object(void* l0, int32_t l1) {
    ...
    if (l5) {
        ...
        vader_obj_header_init(_a4_obj, 284u);
    ...
    }
    {
        loop_49: {
            ...
            if (!(t2)) {
                ...
                l9 = l6.payload.s;
                l10 = l8;
                std_collections_MutableMap_IndexSet_set_at__string__Any(l2, l9, l10);
                json_skip_ws(l0);
                t2 = json_at_end(l0);
                if (t2) {
                    t1 = json_fail(l0, 2347u);
                    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
                }
                ...
                if (l11 == 125u) {
                    ...
                    vader_obj_header_init(_a5_obj, 284u);
                    _a5_obj->f_entries = l2;
                    t1 = (void*) _a5_obj;
                    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
                }
                t1 = json_fail(l0, 1535u);
                { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
            }
        }
    }
    ...
    l2 = ((vader_struct_json_Parser_t*) l0)->f_pos;
    {
        loop_18: {
            ...
            if ((l2 < l3)) {
                ...
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l2, 181u);
                                            ...
                                            if (l3 == 98u) {
                                                ...
                                                if (l3 == 102u) {
                                                    ...
                                                    if (l3 == 117u) {
                                                        ...
                                                        if (!(t0)) {
                                                            t3 = json_fail(l0, 1794u);
                                                            { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                                                        }
                                                    } else {
                                                        t3 = json_fail(l0, 2330u);
                                                        { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                                                    }
                                                }
                                            }
...
static vader_box_t json_parse_value(void* l0, int32_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l1 > INT32_C(200))) {
        t0 = json_fail(l0, 1895u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    json_skip_ws(l0);
    t1 = json_at_end(l0);
    if (t1) {
        t0 = json_fail(l0, 2324u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    l2 = json_peek_byte(l0);
    if (l2 == 34u) {
        ...
        vader_obj_header_init(_a0_obj, 285u);
        _a0_obj->f_value = t2;
        t0 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
