...
static bool json_decode_unicode_escape(void* l0, void* l1) {
    ...
    if (t0) {
        ...
        if ((l4 <= l5)) {
            ...
            t3 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 169u);
        ...
        if (l6) {
            ...
            t3 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 169u);
            t4 = ((uint8_t) t3.payload.i);
            l6 = t4 == INT32_C(117);
        } else {
            l6 = false;
...
static void* json_fail(void* l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a0_obj, 289u);
    _a0_obj->f_msg = l1;
    _a0_obj->f_pos = l2;
    t0 = (void*) _a0_obj;
...
static void* json_new_parser(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 294u);
    _a0_obj->f_src = l0;
    _a0_obj->f_bytes = l1;
...
static vader_box_t json_parse_array(void* l0, int32_t l1) {
    ...
    if (l3) {
        ...
        vader_obj_header_init(_a1_obj, 287u);
        _a1_obj->f_items = l2;
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t json_parse_null(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 290u);
    t1 = (void*) _a0_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t json_parse_number(void* l0) {
    ...
    if (l2) {
        ...
        if ((l19.tag == 159u || l19.tag == 160u)) {
            ...
            vader_obj_header_init(_a5_obj, 291u);
            _a5_obj->f_value = t4;
            t2 = (void*) _a5_obj;
            { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
        }
...
static vader_box_t json_parse_object(void* l0, int32_t l1) {
    ...
    if (l5) {
        ...
        vader_obj_header_init(_a4_obj, 292u);
        ...
        loop_49: {
            ...
            if (!(t2)) {
                ...
                if (l11 == 125u) {
                    ...
                    vader_obj_header_init(_a5_obj, 292u);
