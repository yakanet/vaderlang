...
static vader_box_t json_parse_array(void* l0, int32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(110u, 0u, 13u, 1006u);
    l2 = (void*) _a0_arr;
    json_skip_ws(l0);
    t2 = json_at_end(l0);
    if (!(t2)) {
...
static vader_box_t json_parse_bool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 2163u);
    if (t0) {
    ...
    t0 = json_match_keyword(l0, 1549u);
    if (t0) {
...
static vader_box_t json_parse_null(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 1895u);
    if (!(t0)) {
        t1 = json_fail(l0, 1487u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
            ...
            if (!(t0)) {
                ...
                if (l2 == 92u) {
                    ...
                    if (l3 == 117u) {
                        ...
                        if (!(t0)) {
                            t3 = json_fail(l0, 1739u);
                            { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                        }
                        goto loop_1;
                    }
                    t3 = json_fail(l0, 2269u);
                    { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                }
