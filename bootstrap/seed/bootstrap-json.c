...
static bool json_decode_unicode_escape(void* l0, void* l1) {
    ...
    if (t0) {
        ...
        if ((l4 <= l5)) {
            ...
            t3 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 182u);
        ...
        if (l6) {
            ...
            t3 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 182u);
            t4 = ((uint8_t) t3.payload.i);
            l6 = t4 == INT32_C(117);
        } else {
            l6 = false;
    ...
    l3 = (size_t) (int64_t) INT64_C(0);
    {
        loop_20: {
            if ((l3 < l2)) {
                ...
                if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
                if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 182u);
...
static void* json_new_parser(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 288u);
    _a0_obj->f_src = l0;
    _a0_obj->f_bytes = l1;
...
static vader_box_t json_parse_array(void* l0, int32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(120u, 0u, 13u, 1039u);
    l2 = (void*) _a0_arr;
    json_skip_ws(l0);
    t2 = json_at_end(l0);
    if (!(t2)) {
    ...
    if (l3) {
        ...
        vader_obj_header_init(_a1_obj, 281u);
        _a1_obj->f_items = l2;
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_37: {
            ...
            if (!(t2)) {
                ...
                if (l7 == 93u) {
                    ...
                    vader_obj_header_init(_a2_obj, 281u);
                    _a2_obj->f_items = l2;
                    t1 = (void*) _a2_obj;
                    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
                }
                t1 = json_fail(l0, 1559u);
                { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
            }
        }
    }
...
static vader_box_t json_parse_bool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 2252u);
    if (t0) {
    ...
    t0 = json_match_keyword(l0, 1624u);
    if (t0) {
...
static vader_box_t json_parse_object(void* l0, int32_t l1) {
    ...
    if (l5) {
        ...
        vader_obj_header_init(_a4_obj, 286u);
    ...
    l2 = ((vader_struct_json_Parser_t*) l0)->f_pos;
    {
        loop_18: {
            ...
            if ((l2 < l3)) {
                ...
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l2, 182u);
                                            ...
                                            if (l3 == 98u) {
                                                ...
                                                if (l3 == 102u) {
                                                    ...
                                                    if (l3 == 117u) {
                                                        ...
                                                        if (!(t0)) {
                                                            t3 = json_fail(l0, 1819u);
                                                            { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                                                        }
                                                    } else {
                                                        t3 = json_fail(l0, 2358u);
                                                        { vader_box_t __vret = vader_ref_box(t3); vader_gc_top = gc_frame.prev; return __vret; }
                                                    }
                                                }
                                            }
...
static vader_box_t json_parse_value(void* l0, int32_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l1 > INT32_C(200))) {
        t0 = json_fail(l0, 1919u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    json_skip_ws(l0);
    t1 = json_at_end(l0);
    if (t1) {
        t0 = json_fail(l0, 2352u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    l2 = json_peek_byte(l0);
    if (l2 == 34u) {
        ...
        vader_obj_header_init(_a0_obj, 287u);
        _a0_obj->f_value = t2;
        t0 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
