...
static bool json_decode_unicode_escape(void* l0, void* l1) {
    ...
    if (t0) {
        ...
        if ((l4 <= l5)) {
            ...
            t3 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 175u);
        ...
        if (l6) {
            ...
            t3 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 175u);
            t4 = ((uint8_t) t3.payload.i);
            l6 = t4 == INT32_C(117);
        } else {
            l6 = false;
...
static vader_box_t json_parse_bool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 2167u);
    if (t0) {
    ...
    t0 = json_match_keyword(l0, 1558u);
    if (t0) {
...
static vader_box_t json_parse_null(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 1911u);
    if (!(t0)) {
        t1 = json_fail(l0, 1496u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
