...
static vader_box_t json_parse_bool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 2185u);
    if (t0) {
    ...
    t0 = json_match_keyword(l0, 1570u);
    if (t0) {
