...
static bool json_decode_unicode_escape(void* l0, void* l1) {
    ...
    if (t0) {
        ...
        if ((l4 <= l5)) {
            ...
            t3 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l4, 172u);
        ...
        if (l6) {
            ...
            t3 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 172u);
            t4 = ((uint8_t) t3.payload.i);
            l6 = t4 == INT32_C(117);
        } else {
            l6 = false;
...
static vader_box_t json_parse_array(void* l0, int32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(110u, 0u, 13u, 1009u);
    l2 = (void*) _a0_arr;
    json_skip_ws(l0);
    t2 = json_at_end(l0);
    if (!(t2)) {
...
static vader_box_t json_parse_null(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = json_match_keyword(l0, 1896u);
    if (!(t0)) {
