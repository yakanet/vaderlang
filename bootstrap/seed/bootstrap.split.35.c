...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 313u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1866u);
        ...
        l3 = std_core_write_string_at(l4, l3, 465u);
        l3 = std_core_write_string_at(l4, l3, l2);
        l3 = std_core_write_string_at(l4, l3, 484u);
    ...
    if (l0.tag == 317u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 618u);
    ...
    if (l0.tag == 305u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1362u);
    ...
    if (l0.tag == 312u) {
        { vader_gc_top = gc_frame.prev; return 692u; }
    }
    if (l0.tag == 319u) {
        { vader_gc_top = gc_frame.prev; return 488u; }
    }
    if (l0.tag == 310u) {
    ...
    if (l0.tag == 302u) {
        { vader_gc_top = gc_frame.prev; return 499u; }
    }
...
vader_box_t vader_types_mk_array(vader_box_t l0, bool l1) {
    ...
    vader_obj_header_init(_a0_obj, 303u);
...
vader_box_t vader_types_mk_distinct(void* l0, vader_box_t l1) {
    ...
    vader_obj_header_init(_a0_obj, 304u);
    _a0_obj->f_symbol = l0;
...
vader_box_t vader_types_mk_enum(void* l0, vader_string_t l1, void* l2) {
    ...
    vader_obj_header_init(_a0_obj, 305u);
    _a0_obj->f_symbol = l0;
    _a0_obj->f_repr = l1;
...
vader_box_t vader_types_mk_fn(void* l0, vader_box_t l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(101u, 0u, 12u, 7u);
    l2 = (void*) _a0_arr;
    ...
    vader_obj_header_init(_a1_obj, 306u);
    _a1_obj->f_params = l0;
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(7u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
    ...
    vader_obj_header_init(_a2_obj, 306u);
    _a2_obj->f_params = l1;
...
vader_box_t vader_types_mk_fn_like(void* l0, void* l1, vader_box_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 306u);
    _a0_obj->f_params = l1;
...
vader_box_t vader_types_mk_primitive(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 311u);
    _a0_obj->f_name = l0;
    t0 = (void*) _a0_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
vader_box_t vader_types_mk_struct(void* l0, void* l1, bool l2) {
    ...
    vader_obj_header_init(_a0_obj, 313u);
    _a0_obj->f_symbol = l0;
    _a0_obj->f_args = l1;
...
vader_box_t vader_types_mk_trait(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 314u);
    _a0_obj->f_symbol = l0;
    _a0_obj->f_args = l1;
    t0 = (void*) _a0_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
vader_box_t vader_types_mk_tuple(void* l0, bool l1) {
    ...
    vader_obj_header_init(_a0_obj, 315u);
...
vader_box_t vader_types_mk_type_param(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 317u);
    _a0_obj->f_symbol = l0;
    t0 = (void*) _a0_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
vader_box_t vader_types_mk_union(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 318u);
...
void* vader_types_strip_distinct_each(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(321u, 0u, 13u, 301u);
    l1 = (void*) _a0_arr;
    l2 = l0;
    l3 = ((vader_array_t*) l2)->length;
    l4 = (size_t) (int64_t) INT64_C(0);
...
bool vader_types_type_is_immutable(vader_box_t l0) {
    ...
    if ((l0.tag == 302u || l0.tag == 304u || l0.tag == 305u || l0.tag == 306u || l0.tag == 307u || l0.tag == 308u || l0.tag == 309u || l0.tag == 310u || l0.tag == 311u || l0.tag == 312u || l0.tag == 314u || l0.tag == 316u || l0.tag == 317u || l0.tag == 318u || l0.tag == 319u)) {
        return false;
    }
...
void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 312u) {
        std_string_builder_append(l0, 694u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 319u) {
        std_string_builder_append(l0, 488u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 310u) {
        std_string_builder_append(l0, 1772u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 309u) {
    ...
    if (l1.tag == 303u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 318u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 306u;
        }
        if (l6) {
        ...
        std_string_builder_append(l0, 801u);
        if (l2) {
    ...
    if (l1.tag == 302u) {
        std_string_builder_append(l0, 502u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
