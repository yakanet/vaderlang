...
static void* vader_parser_consume_closing_angle(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(46)) {
        ...
        vader_obj_header_init(_a5_obj, 698u);
...
static vader_string_t vader_parser_describe_token(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l0)->f_kind == INT32_C(0)) {
        { vader_gc_top = gc_frame.prev; return 1457u; }
    }
    t0 = ((vader_struct_vader_lexer_Token_t*) l0)->f_text;
...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    l10 = concat_2(890u, l10);
    l11 = vader_parser_span_of(l0, l5, l9);
    l12 = ((vader_struct_vader_lexer_Token_t*) l3)->f_span;
    vader_array_t* _a0_arr = vader_array_new(34u, 0u, 13u, 469u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(25u, 0u, 13u, 417u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(22u, 0u, 13u, 402u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(20u, 0u, 13u, 396u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(22u, 0u, 13u, 402u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(111u, 0u, 13u, 1029u);
    l12 = (void*) _a8_arr;
...
static void* vader_parser_expect(void* l0, uint8_t l1, vader_string_t l2) {
    ...
    l5 = concat_5(1475u, l2, 48u, l5, 329u);
...
static void* vader_parser_expect_string_literal(void* l0, vader_string_t l1) {
    ...
    if (!(t0)) {
        ...
        l4 = concat_5(1475u, l1, 48u, l4, 329u);
        ...
        loop_39: {
            ...
            if (l5) {
                ...
                if (((vader_struct_vader_lexer_Token_t*) l6)->f_kind == INT32_C(9)) {
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(0), l9, 1721u);
                    {
                        loop_95: {
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 452u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(113u, 0u, 13u, 1042u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 4u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(51u, 0u, 13u, 695u);
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1037u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(34u, 0u, 13u, 469u);
    l1 = (void*) _a1_arr;
    ...
    if (t0) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(51), 1070u);
    }
    { void* __vret = l1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_parser_parse_block(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(113u, 0u, 13u, 1042u);
        l5 = (void*) _a0_arr;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(113u, 0u, 13u, 1042u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(113u, 0u, 13u, 1042u);
    l5 = (void*) _a3_arr;
    ...
    if ((l16 > INT64_C(0))) {
        ...
        if (l18.tag == 389u) {
            ...
            vader_obj_header_init(_a10_obj, 393u);
            _a10_obj->f_span = l9;
            _a10_obj->f_id = l27;
            _a10_obj->f_stmts = l5;
        ...
        if (l18.tag == 419u) {
            ...
            vader_obj_header_init(_a16_obj, 393u);
            _a16_obj->f_span = l9;
            _a16_obj->f_id = l27;
            _a16_obj->f_stmts = l5;
        ...
        if (l18.tag == 395u) {
            ...
            vader_obj_header_init(_a18_obj, 393u);
            _a18_obj->f_span = l9;
            _a18_obj->f_id = l27;
            _a18_obj->f_stmts = l5;
        ...
        if (l18.tag == 401u) {
            ...
            vader_obj_header_init(_a20_obj, 393u);
            _a20_obj->f_span = l9;
            _a20_obj->f_id = l27;
            _a20_obj->f_stmts = l5;
        ...
        if (l18.tag == 404u) {
            ...
            vader_obj_header_init(_a22_obj, 393u);
            _a22_obj->f_span = l9;
            _a22_obj->f_id = l27;
            _a22_obj->f_stmts = l5;
    ...
    vader_obj_header_init(_a24_obj, 393u);
    _a24_obj->f_span = l9;
    _a24_obj->f_id = l27;
    _a24_obj->f_stmts = l5;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(20u, 0u, 13u, 396u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
        ...
        loop_16: {
            ...
            if (t0) {
                ...
                if (l4) {
                    ...
                    _a2_obj->f_name = vader_box_string(165u, l10);
                    _a2_obj->f_value = l6;
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
        ...
        if (l3) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(28), l5, 1075u);
            ...
            if (l7.tag == 455u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 457u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(22u, 0u, 13u, 402u);
                        l13 = (void*) _a5_arr;
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(29), l5, 1076u);
                    t0 = vader_box_obj(0u, NULL);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
                }
                t2 = l7.payload.obj;
        ...
        vader_array_t* _a8_arr = vader_array_new(22u, 0u, 13u, 402u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(22u, 0u, 13u, 402u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(111u, 0u, 13u, 1029u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(23u, 0u, 13u, 411u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                if (!(t0.tag == 0u)) {
                    l10 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(3), 1714u);
                    l11 = ((vader_struct_vader_lexer_Token_t*) l10)->f_value;
                    if (l11.tag == 174u) {
                        t2 = ((uint64_t) l11.payload.i);
                        t3 = ((int64_t) (uint64_t) t2);
                        l8 = vader_box_i64(169u, t3);
                    } else {
                        l8 = vader_box_i32(168u, INT32_C(0));
                    }
...
static vader_box_t vader_parser_parse_expr(void* l0, int32_t l1) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 1508u);
        vader_struct_toolchain_ast_NullLitExpr_t* _a0_obj = (vader_struct_toolchain_ast_NullLitExpr_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_NullLitExpr_t));
        vader_obj_header_init(_a0_obj, 444u);
        _a0_obj->f_span = l3;
        _a0_obj->f_id = (size_t) (int64_t) INT64_C(0);
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(111u, 0u, 13u, 1029u);
    l2 = (void*) _a0_arr;
...
static vader_box_t vader_parser_parse_ident_or_struct_lit(void* l0) {
    ...
    if (l2) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), 1040u);
        l5 = vader_parser_parse_call_args(l0);
        l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1048u);
        l7 = vader_parser_span_of(l0, l1, l7);
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    vader_array_t* _a3_arr = vader_array_new(24u, 0u, 13u, 416u);
    l8 = (void*) _a3_arr;
...
static void* vader_parser_parse_import_decl(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_parser_advance(l0);
    l3 = vader_parser_expect_string_literal(l0, 1688u);
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(26u, 0u, 13u, 427u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(114u, 1u, 13u, 1044u);
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1057u);
    l9 = vader_parser_parse_expr(l0, INT32_C(0));
    l1 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    t2 = l9.payload.obj;
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(28u, 0u, 13u, 437u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
vader_box_t vader_parser_parse_module_header(vader_string_t l0, vader_string_t l1) {
    ...
    if ((l3 >= INT64_C(3))) {
        ...
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) INT32_C(0) >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) INT32_C(0), 171u);
    ...
    if (l5) {
        ...
        t0 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) INT32_C(1), 171u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(187);
    } else {
        l5 = false;
    ...
    if (l5) {
        ...
        t0 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) INT32_C(2), 171u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(191);
    } else {
        l5 = false;
    ...
    if (((l4 + INT64_C(1)) < l3)) {
        ...
        t0 = vader_array_read_u8(_a3_slotarr, _a3_slotarr->offset + (size_t) l4, 171u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(35);
    } else {
        l5 = false;
    ...
    l6 = vader_parser_header_budget(l3);
    {
        loop_101: {
            if ((l4 < l6)) {
                ...
                t0 = vader_array_read_u8(_a5_slotarr, _a5_slotarr->offset + (size_t) l4, 171u);
                ...
                if (l10) {
                    ...
                    t0 = vader_array_read_u8(_a6_slotarr, _a6_slotarr->offset + (size_t) l12, 171u);
                    t1 = ((uint8_t) t0.payload.i);
                    l11 = t1 == INT32_C(47);
                } else {
                    l11 = false;
                ...
                if (l13) {
                    ...
                    t0 = vader_array_read_u8(_a7_slotarr, _a7_slotarr->offset + (size_t) l15, 171u);
                    t1 = ((uint8_t) t0.payload.i);
                    l14 = t1 == INT32_C(42);
                } else {
                    l14 = false;
    ...
    t0 = vader_array_read_u8(_a8_slotarr, _a8_slotarr->offset + (size_t) l4, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(109)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a9_slotarr, _a9_slotarr->offset + (size_t) l6, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(111)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a10_slotarr, _a10_slotarr->offset + (size_t) l6, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(100)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a11_slotarr, _a11_slotarr->offset + (size_t) l6, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(117)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l6, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(108)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a13_slotarr, _a13_slotarr->offset + (size_t) l6, 171u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(101)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    l4 = (size_t) (int64_t) t2;
    {
        loop_339: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a14_slotarr, _a14_slotarr->offset + (size_t) l4, 171u);
                l7 = ((uint8_t) t0.payload.i);
                if (l7 == INT32_C(32)) {
                    l5 = true;
                } else {
    ...
    if ((l4 >= l3)) {
        ...
        t0 = vader_array_read_u8(_a15_slotarr, _a15_slotarr->offset + (size_t) l4, 171u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 != INT32_C(34);
    }
    if (l5) {
    ...
    l6 = l4;
    {
        loop_399: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a16_slotarr, _a16_slotarr->offset + (size_t) l4, 171u);
                t1 = ((uint8_t) t0.payload.i);
                l5 = t1 != INT32_C(34);
            } else {
                l5 = false;
...
static vader_box_t vader_parser_parse_postfix(void* l0, vader_box_t l1, void* l2) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(79)) {
        ...
        l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1555u);
        t1 = l1.payload.obj;
        l4 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_toolchain_ast_ArrayTypeExpr_t*) t1)->f_span)->f_start;
        l5 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l3)->f_span)->f_end;
        vader_struct_toolchain_span_Span_t* _a2_obj = (vader_struct_toolchain_span_Span_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_span_Span_t));
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 858u) {
            ...
            l11 = concat_3(1037u, l11, 925u);
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), l11);
            vader_array_t* _a11_arr = vader_array_new(111u, 0u, 13u, 1029u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
                    ...
                    loop_473: {
                        ...
                        if (t2) {
                            ...
                            if ((l14 < l15)) {
                                ...
                                t1 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l14, 171u);
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(112u, 0u, 13u, 1037u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(112u, 0u, 13u, 1037u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1058u);
    l2 = vader_parser_parse_expr(l0, INT32_C(0));
    l3 = -(INT32_C(1));
    l4 = vader_parser_peek_at(l0, l3);
    l4 = vader_parser_span_of(l0, l1, l4);
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(34u, 0u, 13u, 469u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(25u, 0u, 13u, 417u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(22u, 0u, 13u, 402u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(25u, 1u, 13u, 417u);
...
static vader_box_t vader_parser_parse_stmt(void* l0) {
    ...
    if (l1) {
        ...
        t1 = vader_parser_parse_for(l0, vader_box_string(165u, l3), false);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(74));
    if (t0) {
    ...
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            ...
            if (l3) {
                ...
                vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(0), l17, 1704u);
                vader_parser_advance(l0);
                goto loop_6;
            } else {
            }
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(30u, 0u, 13u, 459u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                l15 = vader_parser_peek(l0);
                l16 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1554u);
        ...
        loop_7: {
            ...
            if (l3) {
                ...
                if (!(t1.tag == 0u)) {
                    ...
                    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(79), 1061u);
...
static void* vader_parser_parse_struct_pattern(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(31u, 0u, 13u, 464u);
    l2 = (void*) _a0_arr;
    {
        loop_10: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l3) {
                l4 = vader_parser_peek(l0);
                l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1557u);
...
static void* vader_parser_parse_trait_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    l4 = vader_parser_parse_struct_type_param_list(l0);
    l5 = vader_box_obj(0u, NULL);
    vader_array_t* _a0_arr = vader_array_new(24u, 0u, 13u, 416u);
    l6 = (void*) _a0_arr;
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
    if (!(t0.tag == 0u)) {
        l5 = vader_parser_parse_type(l0);
...
static void* vader_parser_parse_tuple_let(void* l0) {
    ...
    if (t0) {
        ...
        if (((vader_struct_vader_lexer_Token_t*) t1)->f_kind == INT32_C(80)) {
            ...
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(57), 1068u);
        }
    } else {
        l5 = vader_parser_peek(l0);
        ...
        if (l6) {
            ...
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(64), 1064u);
        }
    }
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1044u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
...
static vader_box_t vader_parser_parse_type_mut_marker(void* l0) {
    ...
    vader_obj_header_init(_a2_obj, 698u);
        ...
        loop_4: {
            ...
            if (l6.tag == 0u) {
                ...
                if (l1.tag == 440u) {
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(26), l7, 1033u);
                    goto loop_4;
                }
                t1 = l1.payload.obj;
...
static vader_box_t vader_parser_parse_type_primary(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(74)) {
        ...
        if (t1) {
            l6 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(4), l6, 1453u);
            l6 = vader_parser_advance(l0);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(2)) {
        ...
        l5 = vader_ref_box(t0);
        {
            loop_207: {
                ...
                if (t1) {
                    vader_parser_advance(l0);
                    l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1556u);
                    t0 = l5.payload.obj;
...
static void* vader_parser_parse_typed_const_decl(void* l0, void* l1, uint8_t l2) {
    ...
    vader_parser_advance(l0);
    l4 = vader_parser_parse_type(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(80), 1066u);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
    if (t0) {
        t1 = vader_parser_peek_at(l0, INT32_C(1));
    ...
    l4 = INT32_C(1);
    {
        loop_5: {
            ...
            if (l5) {
                ...
                if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
                if ((size_t) l3 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l3, 171u);
                l6 = ((uint8_t) t0.payload.i);
                t1 = (l3 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                if ((size_t) l7 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l7, 171u);
