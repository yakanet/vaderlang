...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(33u, 0u, 13u, 468u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(24u, 0u, 13u, 416u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(21u, 0u, 13u, 401u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(19u, 0u, 13u, 395u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(21u, 0u, 13u, 401u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(108u, 0u, 13u, 1022u);
    l12 = (void*) _a8_arr;
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 451u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(110u, 0u, 13u, 1035u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 4u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(50u, 0u, 13u, 692u);
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(109u, 0u, 13u, 1030u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(33u, 0u, 13u, 468u);
    l1 = (void*) _a1_arr;
...
static void* vader_parser_parse_block(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(110u, 0u, 13u, 1035u);
        l5 = (void*) _a0_arr;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(110u, 0u, 13u, 1035u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(110u, 0u, 13u, 1035u);
    l5 = (void*) _a3_arr;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(19u, 0u, 13u, 395u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
            ...
            if (l7.tag == 454u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 456u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(21u, 0u, 13u, 401u);
                        l13 = (void*) _a5_arr;
        ...
        vader_array_t* _a8_arr = vader_array_new(21u, 0u, 13u, 401u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 401u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(108u, 0u, 13u, 1022u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(22u, 0u, 13u, 410u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(108u, 0u, 13u, 1022u);
    l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    vader_array_t* _a3_arr = vader_array_new(23u, 0u, 13u, 415u);
    l8 = (void*) _a3_arr;
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 426u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(113u, 0u, 13u, 1061u);
        l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(111u, 1u, 13u, 1037u);
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(27u, 0u, 13u, 436u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 854u) {
            ...
            vader_array_t* _a11_arr = vader_array_new(108u, 0u, 13u, 1022u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(109u, 0u, 13u, 1030u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(109u, 0u, 13u, 1030u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(33u, 0u, 13u, 468u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(24u, 0u, 13u, 416u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(21u, 0u, 13u, 401u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(24u, 1u, 13u, 416u);
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1063u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_lit_fields(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(115u, 0u, 13u, 1064u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    {
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(111u, 0u, 13u, 1037u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
