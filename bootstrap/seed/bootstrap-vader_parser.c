...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a8_arr = vader_array_new(113u, 0u, 13u, 1039u);
    l12 = (void*) _a8_arr;
...
static void* vader_parser_parse_block(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(115u, 0u, 13u, 1052u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_101: {
    ...
    vader_array_t* _a3_arr = vader_array_new(115u, 0u, 13u, 1052u);
    l5 = (void*) _a3_arr;
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(118u, 0u, 13u, 1079u);
        l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(116u, 1u, 13u, 1054u);
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 863u) {
            ...
            vader_array_t* _a11_arr = vader_array_new(113u, 0u, 13u, 1039u);
            l10 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1047u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(114u, 0u, 13u, 1047u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1081u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_lit_fields(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(120u, 0u, 13u, 1082u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    {
