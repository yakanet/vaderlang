...
static vader_box_t vader_parser_parse_c_size(void* l0, void* l1);
    ...
    if (l0 == INT32_C(58)) {
        ...
        if (l0 == INT32_C(59)) {
            ...
            if (l0 == INT32_C(60)) {
                ...
                vader_obj_header_init(_a2_obj, 873u);
                ...
                if (l0 == INT32_C(61)) {
                    ...
                    if (l0 == INT32_C(62)) {
                        ...
                        vader_obj_header_init(_a5_obj, 873u);
...
static void* vader_parser_consume_closing_angle(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(46)) {
        ...
        vader_obj_header_init(_a1_obj, 497u);
        _a1_obj->f_file = l7;
        _a1_obj->f_offset = l3;
        _a1_obj->f_line = l5;
        _a1_obj->f_column = l6;
        ...
        vader_obj_header_init(_a2_obj, 498u);
        ...
        vader_obj_header_init(_a3_obj, 718u);
        ...
        vader_obj_header_init(_a5_obj, 718u);
...
static vader_string_t vader_parser_describe_token(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l0)->f_kind == INT32_C(1)) {
        { vader_gc_top = gc_frame.prev; return 1864u; }
    }
    if (((vader_struct_vader_lexer_Token_t*) l0)->f_kind == INT32_C(0)) {
        { vader_gc_top = gc_frame.prev; return 1451u; }
    }
    t0 = ((vader_struct_vader_lexer_Token_t*) l0)->f_text;
...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(35u, 0u, 13u, 490u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(26u, 0u, 13u, 438u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(23u, 0u, 13u, 423u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(21u, 0u, 13u, 417u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(23u, 0u, 13u, 423u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(112u, 0u, 13u, 1048u);
    l12 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a9_obj, 423u);
    _a9_obj->f_span = l11;
    _a9_obj->f_id = (size_t) (int64_t) INT64_C(0);
    _a9_obj->f_name = 1360u;
    _a9_obj->f_args = l12;
    l11 = (void*) _a9_obj;
...
static void* vader_parser_expect(void* l0, uint8_t l1, vader_string_t l2) {
    ...
    l5 = concat_5(1469u, l2, 48u, l5, 328u);
...
static void* vader_parser_expect_string_literal(void* l0, vader_string_t l1) {
    ...
    if (!(t0)) {
        ...
        l4 = concat_5(1469u, l1, 48u, l4, 328u);
        ...
        loop_39: {
            ...
            if (l5) {
                ...
                if (((vader_struct_vader_lexer_Token_t*) l6)->f_kind == INT32_C(9)) {
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(0), l9, 1714u);
                    {
                        loop_95: {
...
static void* vader_parser_infix_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(49)) {
        ...
        vader_obj_header_init(_a4_obj, 876u);
        _a4_obj->f_has = true;
    ...
    if (l0 == INT32_C(50)) {
        ...
        vader_obj_header_init(_a5_obj, 876u);
        _a5_obj->f_has = true;
    ...
    if (l0 == INT32_C(51)) {
        ...
        vader_obj_header_init(_a6_obj, 876u);
        _a6_obj->f_has = true;
    ...
    if (l0 == INT32_C(52)) {
        ...
        vader_obj_header_init(_a7_obj, 876u);
        _a7_obj->f_has = true;
    ...
    if (l0 == INT32_C(19)) {
        ...
        vader_obj_header_init(_a8_obj, 876u);
        _a8_obj->f_has = true;
    ...
    if (l0 == INT32_C(21)) {
        ...
        vader_obj_header_init(_a9_obj, 876u);
        _a9_obj->f_has = true;
    ...
    if (l0 == INT32_C(65)) {
        ...
        vader_obj_header_init(_a10_obj, 876u);
        _a10_obj->f_has = true;
    ...
    if (l0 == INT32_C(66)) {
        ...
        vader_obj_header_init(_a11_obj, 876u);
        _a11_obj->f_has = true;
    ...
    if (l0 == INT32_C(43)) {
        ...
        vader_obj_header_init(_a13_obj, 876u);
        _a13_obj->f_has = true;
    ...
    if (l0 == INT32_C(41)) {
        ...
        vader_obj_header_init(_a14_obj, 876u);
        _a14_obj->f_has = true;
    ...
    if (l0 == INT32_C(45)) {
        ...
        vader_obj_header_init(_a15_obj, 876u);
        _a15_obj->f_has = true;
    ...
    if (l0 == INT32_C(46)) {
        ...
        vader_obj_header_init(_a16_obj, 876u);
        _a16_obj->f_has = true;
    ...
    if (l0 == INT32_C(38)) {
        ...
        vader_obj_header_init(_a19_obj, 876u);
        _a19_obj->f_has = true;
    ...
    if (l0 == INT32_C(40)) {
        ...
        vader_obj_header_init(_a21_obj, 876u);
        _a21_obj->f_has = true;
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 473u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(114u, 0u, 13u, 1061u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(113u, 0u, 13u, 1056u);
    l3 = (void*) _a1_arr;
    ...
    vader_obj_header_init(_a2_obj, 881u);
    _a2_obj->f_tokens = l0;
    _a2_obj->f_file = l1;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(35u, 0u, 13u, 490u);
    l1 = (void*) _a1_arr;
    ...
    if (t0) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(51), 1061u);
    }
    { void* __vret = l1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_parser_parse_block(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1117u);
    ...
    if ((t0 > INT32_C(256))) {
        ...
        ((vader_struct_vader_parser_Parser_t*) l0)->f_expr_depth = l2;
        VADER_WRITE_BARRIER((vader_struct_vader_parser_Parser_t*) l0);
        vader_parser_report_nesting_too_deep(l0, 1246u);
        l2 = INT32_C(1);
        {
            loop_32: {
                if ((l2 > INT32_C(0))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1061u);
        l5 = (void*) _a0_arr;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(114u, 0u, 13u, 1061u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(114u, 0u, 13u, 1061u);
    l5 = (void*) _a3_arr;
    ...
    if ((l16 > INT64_C(0))) {
        ...
        if (l18.tag == 496u) {
            ...
            vader_obj_header_init(_a14_obj, 413u);
            _a14_obj->f_span = l9;
            _a14_obj->f_id = l27;
            _a14_obj->f_stmts = l5;
        ...
        if (l18.tag == 440u) {
            ...
            vader_obj_header_init(_a16_obj, 413u);
            _a16_obj->f_span = l9;
            _a16_obj->f_id = l27;
            _a16_obj->f_stmts = l5;
        ...
        if (l18.tag == 415u) {
            ...
            vader_obj_header_init(_a18_obj, 413u);
            _a18_obj->f_span = l9;
            _a18_obj->f_id = l27;
            _a18_obj->f_stmts = l5;
        ...
        if (l18.tag == 422u) {
            ...
            vader_obj_header_init(_a20_obj, 413u);
            _a20_obj->f_span = l9;
            _a20_obj->f_id = l27;
            _a20_obj->f_stmts = l5;
        ...
        if (l18.tag == 425u) {
            ...
            vader_obj_header_init(_a22_obj, 413u);
            _a22_obj->f_span = l9;
            _a22_obj->f_id = l27;
            _a22_obj->f_stmts = l5;
    ...
    vader_obj_header_init(_a24_obj, 413u);
    _a24_obj->f_span = l9;
    _a24_obj->f_id = l27;
    _a24_obj->f_stmts = l5;
...
static vader_box_t vader_parser_parse_c_size(void* l0, void* l1) {
    ...
    void* t2 = NULL;
    vader_box_t* gc_roots[3] = { &l3, &l4, &t1 };
    ...
    vader_gc_top = &gc_frame;
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_Decorator_t*) l1)->f_args)->length;
    if (t0 != INT64_C(2)) {
        l2 = ((vader_struct_toolchain_ast_Decorator_t*) l1)->f_span;
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l2, 1072u);
        t1 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_Decorator_t*) l1)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) INT32_C(0) >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    l3 = vader_array_ref_load_box(_a0_slotarr->buf, _a0_slotarr->offset + (size_t) INT32_C(0));
    if (!(l3.tag == 452u)) {
        t2 = l3.payload.obj;
        l2 = ((vader_struct_toolchain_ast_ArrayTypeExpr_t*) t2)->f_span;
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l2, 1073u);
        t1 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a1_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_Decorator_t*) l1)->f_args);
    if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
    if ((size_t) INT32_C(1) >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
    l4 = vader_array_ref_load_box(_a1_slotarr->buf, _a1_slotarr->offset + (size_t) INT32_C(1));
    if (!(l4.tag == 430u)) {
        t2 = l4.payload.obj;
        l2 = ((vader_struct_toolchain_ast_ArrayTypeExpr_t*) t2)->f_span;
        l5 = concat_2(1074u, 1051u);
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l2, l5);
        t1 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l2 = ((vader_struct_toolchain_ast_Decorator_t*) l1)->f_span;
    t2 = l3.payload.obj;
    l6 = ((vader_struct_toolchain_ast_IntLitExpr_t*) t2)->f_value;
    t2 = l4.payload.obj;
    l5 = ((vader_struct_toolchain_ast_DotVariantExpr_t*) t2)->f_variant;
    vader_struct_toolchain_ast_CSizeSelector_t* _a2_obj = (vader_struct_toolchain_ast_CSizeSelector_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_CSizeSelector_t));
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 417u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
        ...
        loop_16: {
            ...
            if (t0) {
                ...
                if (l4) {
                    ...
                    _a2_obj->f_name = vader_box_string(164u, l10);
                    _a2_obj->f_value = l6;
...
static void* vader_parser_parse_const_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_parser_reject_target_decorator(l0, l1, 1137u);
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
        ...
        if (l3) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l5, 1066u);
            ...
            if (l7.tag == 476u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 478u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(23u, 0u, 13u, 423u);
                        l13 = (void*) _a5_arr;
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l5, 1067u);
                    t0 = vader_box_obj(0u, NULL);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
                }
                t2 = l7.payload.obj;
        ...
        vader_array_t* _a8_arr = vader_array_new(23u, 0u, 13u, 423u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            ...
            if (t0) {
                l2 = vader_parser_advance(l0);
                l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1412u);
                vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1048u);
                l4 = (void*) _a1_arr;
                ...
                if (!(t1.tag == 0u)) {
                    ...
                    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1035u);
                } else {
                }
                l8 = -(INT32_C(1));
                l9 = vader_parser_peek_at(l0, l8);
...
static void* vader_parser_parse_defer(void* l0) {
    ...
    if (t1) {
        ...
        if (!(l5.tag == 0u)) {
            ...
            vader_obj_header_init(_a4_obj, 426u);
            _a4_obj->f_stmt = l5;
            t0 = (void*) _a4_obj;
            l4 = vader_ref_box(t0);
        } else {
    ...
    if (l4.tag == 426u) {
        ...
        vader_obj_header_init(_a5_obj, 498u);
        _a5_obj->f_start = l3;
        _a5_obj->f_end = l6;
        l7 = (void*) _a5_obj;
    ...
    if (l4.tag == 424u) {
        ...
        vader_obj_header_init(_a7_obj, 498u);
        _a7_obj->f_start = l3;
        _a7_obj->f_end = l6;
        l7 = (void*) _a7_obj;
        l8 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_parser_reject_target_decorator(l0, l1, 1166u);
    vader_parser_advance(l0);
    l4 = vader_box_obj(0u, NULL);
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(72));
    if (!(t0.tag == 0u)) {
        l4 = vader_parser_parse_type(l0);
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1036u);
    } else {
    }
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1118u);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(24u, 0u, 13u, 432u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
    ...
    l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1124u);
    l7 = vader_parser_span_of(l0, l3, l7);
...
static vader_box_t vader_parser_parse_expr(void* l0, int32_t l1) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 1502u);
        vader_struct_toolchain_ast_NullLitExpr_t* _a0_obj = (vader_struct_toolchain_ast_NullLitExpr_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_NullLitExpr_t));
        vader_obj_header_init(_a0_obj, 465u);
        _a0_obj->f_span = l3;
        _a0_obj->f_id = (size_t) (int64_t) INT64_C(0);
            ...
            if (l5) {
                ...
                if (l12) {
                    if (l2 == INT32_C(20)) {
                        ...
                        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(9), l13, 1337u);
                    } else {
                        vader_parser_advance(l0);
                        vader_parser_advance(l0);
                    ...
                    if (l18) {
                        if (l2 == INT32_C(20)) {
                            ...
                            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(9), l19, 1338u);
                        } else {
                            ...
                            if (((vader_struct_vader_lexer_Token_t*) t1)->f_kind == INT32_C(29)) {
                                ...
                                vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(0), l23, 1099u);
                            } else {
                            }
                            t1 = l4.payload.obj;
                        ...
                        if (l35) {
                            ...
                            if (l36) {
                                ...
                                if (l43) {
                                    ...
                                    vader_obj_header_init(_a10_obj, 470u);
                                    _a10_obj->f_span = l46;
                                    _a10_obj->f_id = (size_t) (int64_t) INT64_C(0);
                                    ...
                                    if (l50) {
                                        vader_parser_advance(l0);
                                        l51 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1237u);
                                    ...
                                    vader_obj_header_init(_a11_obj, 498u);
...
static void* vader_parser_parse_fn_signature_params(void* l0) {
    ...
    l2 = (void*) _a1_arr;
    l3 = false;
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), 1031u);
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
    if (!(t0)) {
        l4 = true;
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1040u);
    ...
    vader_obj_header_init(_a6_obj, 875u);
    _a6_obj->f_params = l2;
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), 1030u);
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1037u);
...
static void* vader_parser_parse_for(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l8) {
        ...
        vader_obj_header_init(_a6_obj, 440u);
        _a6_obj->f_span = l6;
        _a6_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a6_obj->f_label = l1;
    ...
    if (t0) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(21), 1110u);
        l12 = vader_parser_parse_expr(l0, INT32_C(0));
        ((vader_struct_vader_parser_Parser_t*) l0)->f_allow_struct_lit = l7;
        VADER_WRITE_BARRIER((vader_struct_vader_parser_Parser_t*) l0);
        l4 = vader_parser_parse_block(l0);
        ...
        vader_obj_header_init(_a8_obj, 428u);
        ...
        vader_obj_header_init(_a9_obj, 449u);
        ...
        vader_obj_header_init(_a10_obj, 440u);
        _a10_obj->f_span = l5;
        _a10_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a10_obj->f_label = l1;
    ...
    if (l9.tag == 470u) {
        ...
        vader_obj_header_init(_a12_obj, 429u);
        l6 = (void*) _a12_obj;
        l10 = l9.payload.obj;
        ...
        vader_obj_header_init(_a13_obj, 449u);
        ...
        vader_obj_header_init(_a14_obj, 440u);
        _a14_obj->f_span = l5;
    ...
    vader_obj_header_init(_a16_obj, 492u);
    _a16_obj->f_cond = l9;
    l5 = (void*) _a16_obj;
    ...
    vader_obj_header_init(_a17_obj, 440u);
    _a17_obj->f_span = l3;
...
static vader_box_t vader_parser_parse_ident_or_struct_lit(void* l0) {
    ...
    if (l2) {
        ...
        if (l2) {
            ...
            l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1129u);
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), 1032u);
        l5 = vader_parser_parse_call_args(l0);
        l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1039u);
        l7 = vader_parser_span_of(l0, l1, l7);
    ...
    if (l2) {
        ...
        l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1129u);
...
static void* vader_parser_parse_if_expr(void* l0) {
    ...
    if (l5.tag == 443u) {
        ...
        vader_obj_header_init(_a5_obj, 445u);
        _a5_obj->f_span = l9;
        _a5_obj->f_id = l10;
        _a5_obj->f_cond = l3;
    ...
    if (l5.tag == 0u) {
        ...
        vader_obj_header_init(_a7_obj, 445u);
        _a7_obj->f_span = l9;
        _a7_obj->f_id = l10;
        _a7_obj->f_cond = l3;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(14), 1108u);
    vader_array_t* _a0_arr = vader_array_new(35u, 0u, 13u, 490u);
    l4 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(49));
    if (t0) {
    ...
    l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2154u);
    vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1048u);
    l6 = (void*) _a1_arr;
    ...
    vader_array_t* _a3_arr = vader_array_new(25u, 0u, 13u, 437u);
    l8 = (void*) _a3_arr;
    ...
    if (l13) {
            ...
            loop_141: {
                ...
                if (l13) {
                    ...
                    if (l14.tag == 437u) {
                        ...
                        vader_parser_reject_target_decorator(l0, l16, 1167u);
        ...
        l11 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1125u);
        l18 = vader_parser_span_of(l0, l2, l11);
        l9 = (size_t) (int64_t) INT64_C(0);
        l19 = ((vader_struct_vader_lexer_Token_t*) l5)->f_text;
        l20 = ((vader_struct_vader_lexer_Token_t*) l5)->f_span;
    ...
    vader_obj_header_init(_a6_obj, 446u);
    _a6_obj->f_span = l18;
    _a6_obj->f_id = l9;
...
static void* vader_parser_parse_import_decl(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_parser_advance(l0);
    l3 = vader_parser_expect_string_literal(l0, 1681u);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(29));
    if (t0) {
        l4 = vader_parser_peek(l0);
        l4 = ((vader_struct_vader_lexer_Token_t*) l4)->f_span;
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l4, 2133u);
        vader_parser_advance(l0);
        t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(2));
        if (t0) {
            vader_parser_advance(l0);
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(27u, 0u, 13u, 448u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
    ...
    vader_parser_skip_newlines(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1126u);
...
static void* vader_parser_parse_lambda_without_fn(void* l0) {
    ...
    l1 = vader_parser_peek(l0);
    l2 = vader_parser_parse_fn_signature_params(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1046u);
...
static void* vader_parser_parse_let(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 475u);
    _a0_obj->f_span = l4;
    _a0_obj->f_id = (size_t) (int64_t) INT64_C(0);
    _a0_obj->f_name = l5;
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(117u, 0u, 13u, 1088u);
        l2 = (void*) _a0_arr;
        ...
        if (!(t0)) {
            {
                loop_17: {
                    ...
                    if (t0) {
                        ...
                        if (!(t1.tag == 0u)) {
                            l4 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1855u);
        ...
        l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(75), 1095u);
    ...
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1238u);
    l2 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    l6 = ((vader_struct_vader_lexer_Token_t*) l1)->f_text;
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(115u, 1u, 13u, 1063u);
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1047u);
    l9 = vader_parser_parse_expr(l0, INT32_C(0));
    l1 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    t2 = l9.payload.obj;
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_parser_Parser_t*) l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1119u);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(29u, 0u, 13u, 458u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
    ...
    l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1127u);
    l3 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l3)->f_span)->f_start;
...
vader_box_t vader_parser_parse_module_header(vader_string_t l0, vader_string_t l1) {
    ...
    if ((l3 >= INT64_C(3))) {
        ...
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) INT32_C(0) >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) INT32_C(0), 170u);
    ...
    if (l5) {
        ...
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
        if ((size_t) INT32_C(1) >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) INT32_C(1), 170u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(187);
    } else {
        l5 = false;
    ...
    if (l5) {
        ...
        t0 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) INT32_C(2), 170u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(191);
    } else {
        l5 = false;
    ...
    if (((l4 + INT64_C(1)) < l3)) {
        ...
        t0 = vader_array_read_u8(_a3_slotarr, _a3_slotarr->offset + (size_t) l4, 170u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(35);
    } else {
        l5 = false;
    ...
    l6 = vader_parser_header_budget(l3);
    {
        loop_101: {
            if ((l4 < l6)) {
                ...
                t0 = vader_array_read_u8(_a5_slotarr, _a5_slotarr->offset + (size_t) l4, 170u);
                ...
                if (l10) {
                    ...
                    t0 = vader_array_read_u8(_a6_slotarr, _a6_slotarr->offset + (size_t) l12, 170u);
                    t1 = ((uint8_t) t0.payload.i);
                    l11 = t1 == INT32_C(47);
                } else {
                    l11 = false;
                ...
                if (l13) {
                    ...
                    t0 = vader_array_read_u8(_a7_slotarr, _a7_slotarr->offset + (size_t) l15, 170u);
                    t1 = ((uint8_t) t0.payload.i);
                    l14 = t1 == INT32_C(42);
                } else {
                    l14 = false;
    ...
    t0 = vader_array_read_u8(_a8_slotarr, _a8_slotarr->offset + (size_t) l4, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(109)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a9_slotarr, _a9_slotarr->offset + (size_t) l6, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(111)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a10_slotarr, _a10_slotarr->offset + (size_t) l6, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(100)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a11_slotarr, _a11_slotarr->offset + (size_t) l6, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(117)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l6, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(108)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a13_slotarr, _a13_slotarr->offset + (size_t) l6, 170u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(101)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    l4 = (size_t) (int64_t) t2;
    {
        loop_339: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a14_slotarr, _a14_slotarr->offset + (size_t) l4, 170u);
                l7 = ((uint8_t) t0.payload.i);
                if (l7 == INT32_C(32)) {
                    l5 = true;
                } else {
    ...
    if ((l4 >= l3)) {
        ...
        t0 = vader_array_read_u8(_a15_slotarr, _a15_slotarr->offset + (size_t) l4, 170u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 != INT32_C(34);
    }
    if (l5) {
    ...
    l6 = l4;
    {
        loop_399: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a16_slotarr, _a16_slotarr->offset + (size_t) l4, 170u);
                t1 = ((uint8_t) t0.payload.i);
                l5 = t1 != INT32_C(34);
            } else {
                l5 = false;
    ...
    vader_obj_header_init(_a18_obj, 878u);
    _a18_obj->f_name = l17;
...
static void* vader_parser_parse_named_import_decl(void* l0, void* l1, void* l2) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l5, 2138u);
...
static vader_box_t vader_parser_parse_optional_module_decl(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    l2 = vader_parser_expect_string_literal(l0, 1850u);
...
static vader_box_t vader_parser_parse_paren(void* l0) {
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_parser_Parser_t*) l0);
    vader_parser_skip_newlines(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1041u);
...
static vader_box_t vader_parser_parse_pattern(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2373u);
        l3 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(19)) {
        ...
        if (t1) {
            l2 = vader_parser_advance(l0);
            l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2373u);
        ...
        if (!(t2.tag == 0u)) {
            t0 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1237u);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(2)) {
        ...
        vader_obj_header_init(_a5_obj, 412u);
        _a5_obj->f_span = l2;
        _a5_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a5_obj->f_name = l5;
        t0 = (void*) _a5_obj;
    ...
    if (t1) {
        ...
        if (l10) {
            ...
            vader_obj_header_init(_a6_obj, 471u);
            _a6_obj->f_span = t0;
            _a6_obj->f_id = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_parser_parse_postfix(void* l0, vader_box_t l1, void* l2) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(79)) {
        ...
        l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1550u);
        t1 = l1.payload.obj;
        l4 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_toolchain_ast_ArrayTypeExpr_t*) t1)->f_span)->f_start;
        l5 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l3)->f_span)->f_end;
        vader_struct_toolchain_span_Span_t* _a2_obj = (vader_struct_toolchain_span_Span_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_span_Span_t));
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(72)) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1039u);
        t1 = l1.payload.obj;
        l4 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_toolchain_ast_ArrayTypeExpr_t*) t1)->f_span)->f_start;
        l8 = -(INT32_C(1));
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(75), 1096u);
    t1 = l1.payload.obj;
    ...
    vader_obj_header_init(_a10_obj, 498u);
    _a10_obj->f_start = l3;
    _a10_obj->f_end = l4;
    t1 = (void*) _a10_obj;
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(32)) {
        ...
        vader_obj_header_init(_a4_obj, 414u);
        _a4_obj->f_span = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
        _a4_obj->f_id = (size_t) (int64_t) INT64_C(0);
    ...
    if (l6) {
        ...
        vader_obj_header_init(_a7_obj, 491u);
        _a7_obj->f_span = t0;
        _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a7_obj->f_op = l7;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(34)) {
        vader_parser_advance(l0);
        t0 = vader_parser_ident_expr(((vader_struct_vader_lexer_Token_t*) l1)->f_span, 1968u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        l8 = vader_parser_advance(l0);
        l9 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1412u);
        ...
        if (l3.tag == 0u) {
            ...
            vader_obj_header_init(_a10_obj, 465u);
            _a10_obj->f_span = t0;
            _a10_obj->f_id = (size_t) (int64_t) INT64_C(0);
            t0 = (void*) _a10_obj;
            { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
        ...
        if (l3.tag == 877u) {
            ...
            l11 = concat_3(1029u, l11, 920u);
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), l11);
            vader_array_t* _a11_arr = vader_array_new(112u, 0u, 13u, 1048u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
                    ...
                    loop_473: {
                        ...
                        if (t2) {
                            ...
                            if ((l14 < l15)) {
                                ...
                                t1 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l14, 170u);
            ...
            vader_obj_header_init(_a13_obj, 453u);
            _a13_obj->f_span = l8;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l8 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2373u);
        ...
        vader_obj_header_init(_a14_obj, 498u);
        _a14_obj->f_start = l9;
        _a14_obj->f_end = l10;
        l9 = (void*) _a14_obj;
        ...
        vader_obj_header_init(_a15_obj, 430u);
        _a15_obj->f_span = l9;
    ...
    vader_obj_header_init(_a16_obj, 465u);
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(113u, 0u, 13u, 1056u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(113u, 0u, 13u, 1056u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1048u);
    l2 = vader_parser_parse_expr(l0, INT32_C(0));
    l3 = -(INT32_C(1));
    l4 = vader_parser_peek_at(l0, l3);
    l4 = vader_parser_span_of(l0, l1, l4);
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(35u, 0u, 13u, 490u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(26u, 0u, 13u, 438u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(23u, 0u, 13u, 423u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_seq_lit(void* l0) {
    ...
    l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(75), 1097u);
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(26u, 1u, 13u, 438u);
...
void* vader_parser_parse_source(vader_string_t l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a1_obj, 880u);
...
static vader_box_t vader_parser_parse_stmt(void* l0) {
    ...
    if (l1) {
        ...
        t1 = vader_parser_parse_for(l0, vader_box_string(164u, l3), false);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(74));
    if (t0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a1_obj, 411u);
        _a1_obj->f_span = l2;
        _a1_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a1_obj->f_op = l10;
        _a1_obj->f_left = l5;
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(118u, 0u, 13u, 1090u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
            ...
            if (l3) {
                ...
                vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(0), l17, 1697u);
                vader_parser_advance(l0);
                goto loop_6;
            } else {
            }
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    uint8_t l7;
    size_t l10, l11;
    vader_box_t l13 = vader_box_null(), l20 = vader_box_null(), l21 = vader_box_null();
    ...
    vader_box_t t3 = vader_box_null();
    void* t4 = NULL;
    vader_box_t* gc_roots[4] = { &l13, &l20, &l21, &t3 };
    void** gc_raw_roots[16] = { &l0, &l1, &l3, &l4, &l5, &l8, &l9, &l12, &l14, &l15, &l18, &l19, &l23, &l24, &l26, &t4 };
    vader_string_t* gc_atom_roots[4] = { &l16, &l17, &l25, &t1 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 4u, 16u, gc_roots, gc_raw_roots, 0u, NULL, 4u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_parser_reject_target_decorator(l0, l1, 1145u);
    vader_parser_advance(l0);
    l4 = vader_parser_parse_struct_type_param_list(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1120u);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(31u, 0u, 13u, 480u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                l9 = vader_parser_parse_decorators(l0);
                l7 = (uint8_t) (int32_t) INT32_C(0);
                vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 416u);
                l8 = (void*) _a1_arr;
                    ...
                    loop_50: {
                        if ((l11 < l10)) {
                            ...
                            if (t1 == 1710u) {
                                ...
                                t1 = ((vader_struct_toolchain_ast_Decorator_t*) l12)->f_name;
                                if (t1 == 1304u) {
                                    l13 = vader_parser_parse_c_size(l0, l12);
                                    if (!(l13.tag == 0u)) {
                                        l14 = l13.payload.obj;
                                        vader_array_push((vader_array_t*) l8, vader_ref_box(l14));
                                    } else {
                                    }
                                } else {
                                    l15 = ((vader_struct_toolchain_ast_Decorator_t*) l12)->f_span;
                                    l16 = ((vader_struct_toolchain_ast_Decorator_t*) l12)->f_name;
                                    t1 = concat_3(1065u, l16, 942u);
                                    l17 = concat_2(t1, 1071u);
                                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l15, l17);
                                }
                            }
                            t2 = (l11 + INT64_C(1));
                ...
                l18 = vader_parser_peek(l0);
                l19 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1549u);
                vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(80), 1056u);
                l20 = vader_parser_parse_type(l0);
                l21 = vader_box_obj(0u, NULL);
                t3 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
                if (!(t3.tag == 0u)) {
                    vader_parser_skip_newlines(l0);
                    l21 = vader_parser_parse_expr(l0, INT32_C(0));
                } else {
                }
                l22 = -(INT32_C(1));
                l23 = vader_parser_peek_at(l0, l22);
                l24 = vader_parser_span_of(l0, l18, l23);
                l25 = ((vader_struct_vader_lexer_Token_t*) l19)->f_text;
                vader_struct_toolchain_ast_StructField_t* _a3_obj = (vader_struct_toolchain_ast_StructField_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_StructField_t));
                vader_obj_header_init(_a3_obj, 480u);
                _a3_obj->f_span = l24;
                _a3_obj->f_id = (size_t) (int64_t) INT64_C(0);
                _a3_obj->f_name = l25;
                _a3_obj->f_ty = l20;
                _a3_obj->f_visibility = l7;
                _a3_obj->f_default_v = l21;
                _a3_obj->f_c_sizes = l8;
                _a3_obj->f_c_size_missing = false;
                l26 = (void*) _a3_obj;
                vader_array_push((vader_array_t*) l5, vader_ref_box(l26));
                t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
                if (!(t0)) {
                    vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(78));
                    vader_parser_skip_newlines(l0);
    ...
    l8 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1128u);
    l8 = vader_parser_span_of(l0, l3, l8);
    l16 = ((vader_struct_vader_lexer_Token_t*) l3)->f_text;
    l9 = ((vader_struct_vader_lexer_Token_t*) l3)->f_span;
    vader_struct_toolchain_ast_StructDecl_t* _a4_obj = (vader_struct_toolchain_ast_StructDecl_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_StructDecl_t));
    vader_obj_header_init(_a4_obj, 479u);
    _a4_obj->f_span = l8;
    _a4_obj->f_id = (size_t) (int64_t) INT64_C(0);
    _a4_obj->f_name = l16;
    _a4_obj->f_name_span = l9;
    _a4_obj->f_visibility = l2;
    _a4_obj->f_type_params = l4;
    _a4_obj->f_fields = l5;
    _a4_obj->f_decorators = l1;
    t4 = (void*) _a4_obj;
...
static void* vader_parser_parse_struct_lit_fields(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1091u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    {
        loop_7: {
            ...
            if (l3) {
                ...
                if (!(t1.tag == 0u)) {
                    ...
                    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(79), 1052u);
                    l9 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2105u);
                    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(57), 1058u);
                    l10 = vader_parser_parse_expr(l0, INT32_C(0));
                    l11 = -(INT32_C(1));
...
static void* vader_parser_parse_struct_pattern(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1121u);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(32u, 0u, 13u, 485u);
    l2 = (void*) _a0_arr;
    {
        loop_10: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l3) {
                l4 = vader_parser_peek(l0);
                l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1552u);
                ...
                vader_obj_header_init(_a4_obj, 485u);
                _a4_obj->f_span = l15;
                _a4_obj->f_id = (size_t) (int64_t) INT64_C(0);
                _a4_obj->f_name = l16;
    ...
    l4 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1130u);
    l1 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    ...
    vader_obj_header_init(_a6_obj, 484u);
    _a6_obj->f_span = t1;
    _a6_obj->f_id = (size_t) (int64_t) INT64_C(0);
    _a6_obj->f_fields = l2;
    t1 = (void*) _a6_obj;
...
static void* vader_parser_parse_struct_type_param_list(void* l0) {
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1043u);
    { void* __vret = l1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_parser_parse_trait_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_parser_reject_target_decorator(l0, l1, 1146u);
    vader_parser_advance(l0);
    l4 = vader_parser_parse_struct_type_param_list(l0);
    l5 = vader_box_obj(0u, NULL);
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 437u);
    l6 = (void*) _a0_arr;
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
    if (!(t0.tag == 0u)) {
        l5 = vader_parser_parse_type(l0);
    ...
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(76), 1122u);
    vader_parser_skip_newlines(l0);
    {
        loop_71: {
    ...
    l8 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(77), 1131u);
    l8 = vader_parser_span_of(l0, l3, l8);
    l9 = ((vader_struct_vader_lexer_Token_t*) l3)->f_text;
    l10 = ((vader_struct_vader_lexer_Token_t*) l3)->f_span;
...
static void* vader_parser_parse_tuple_let(void* l0) {
    ...
    if (t0) {
        ...
        if (((vader_struct_vader_lexer_Token_t*) t1)->f_kind == INT32_C(80)) {
            ...
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(57), 1059u);
        }
    } else {
        l5 = vader_parser_peek(l0);
        ...
        if (l6) {
            ...
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(64), 1055u);
        }
    }
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(115u, 0u, 13u, 1063u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
    ...
    l4 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(75), 1098u);
    t2 = ((vader_array_t*) l2)->length;
    if ((t2 < INT64_C(2))) {
...
static vader_box_t vader_parser_parse_type(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 2164u);
        t1 = vader_parser_ident_expr(l2, 523u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(42));
...
static vader_box_t vader_parser_parse_type_mut_marker(void* l0) {
    ...
    vader_obj_header_init(_a2_obj, 718u);
        ...
        loop_4: {
            ...
            if (l6.tag == 0u) {
                ...
                if (l1.tag == 461u) {
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(26), l7, 1025u);
                    goto loop_4;
                }
                t1 = l1.payload.obj;
...
static vader_box_t vader_parser_parse_type_primary(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(71)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2169u);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(72)) {
        ...
        l5 = vader_parser_parse_type(l0);
        vader_parser_skip_newlines(l0);
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(73), 1042u);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(74)) {
        ...
        if (t1) {
            l6 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(4), l6, 1447u);
            l6 = vader_parser_advance(l0);
        ...
        l6 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(75), 1094u);
        t3 = ((vader_array_t*) l3)->length;
        if (t3 == INT64_C(1)) {
            l7 = vader_parser_span_of(l0, l2, l6);
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(20), l7, 2287u);
            l7 = vader_parser_span_of(l0, l2, l6);
            vader_array_t* _a3_slotarr = ((vader_array_t*) l3);
            if (_a3_slotarr->buf != NULL && _a3_slotarr->buf->header.forward != NULL) { _a3_slotarr->buf = vader_array_buf_forward(_a3_slotarr->buf); }
            if ((size_t) INT32_C(0) >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(33)) {
        vader_parser_advance(l0);
        t0 = vader_parser_ident_expr(((vader_struct_vader_lexer_Token_t*) l1)->f_span, 1877u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(2)) {
        l2 = vader_parser_advance(l0);
        ...
        l5 = vader_ref_box(t0);
        {
            loop_207: {
                ...
                if (t1) {
                    vader_parser_advance(l0);
                    l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1551u);
                    t0 = l5.payload.obj;
                    ...
                    vader_obj_header_init(_a7_obj, 435u);
                    _a7_obj->f_span = l8;
                    _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
                    _a7_obj->f_target = l5;
                    _a7_obj->f_field = l4;
        ...
        if (!(t2.tag == 0u)) {
            ...
            vader_obj_header_init(_a8_obj, 441u);
            _a8_obj->f_span = t0;
            _a8_obj->f_id = (size_t) (int64_t) INT64_C(0);
            _a8_obj->f_callee = l5;
    ...
    l4 = concat_2(1606u, l4);
    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(4), l2, l4);
    vader_parser_advance(l0);
    t0 = vader_parser_ident_expr(((vader_struct_vader_lexer_Token_t*) l1)->f_span, 523u);
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_parser_parse_typed_const_decl(void* l0, void* l1, uint8_t l2) {
    ...
    vader_parser_advance(l0);
    l4 = vader_parser_parse_type(l0);
    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(80), 1057u);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
    if (t0) {
        t1 = vader_parser_peek_at(l0, INT32_C(1));
...
static void vader_parser_reject_removed_const(void* l0) {
    ...
    if (!(l1.tag == 0u)) {
        ...
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(23), l2, 1148u);
    } else {
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
static void vader_parser_report_nesting_too_deep(void* l0, vader_string_t l1) {
    ...
    l5 = std_core_write_string_at(l6, l5, 139u);
    l7 = ((int64_t) (int32_t) INT32_C(256));
    l5 = std_core_write_int(l6, l5, l7);
    l5 = std_core_write_string_at(l6, l5, 134u);
    ...
    l4 = INT32_C(1);
    {
        loop_5: {
            ...
            if (l5) {
                ...
                l7 = (size_t) (int64_t) t1;
                if ((size_t) l7 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l7, 170u);
...
static void vader_parser_walk_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 464u) {
        ...
        if ((l5.tag == 415u || l5.tag == 422u || l5.tag == 473u)) {
            vader_parser_walk_stmt(l5, l1);
            return;
        }
        if ((l5.tag == 407u || l5.tag == 410u || l5.tag == 411u || l5.tag == 413u || l5.tag == 414u || l5.tag == 418u || l5.tag == 419u || l5.tag == 420u || l5.tag == 430u || l5.tag == 435u || l5.tag == 436u || l5.tag == 439u || l5.tag == 441u || l5.tag == 442u || l5.tag == 445u || l5.tag == 450u || l5.tag == 452u || l5.tag == 453u || l5.tag == 455u || l5.tag == 459u || l5.tag == 461u || l5.tag == 464u || l5.tag == 465u || l5.tag == 470u || l5.tag == 474u || l5.tag == 476u || l5.tag == 481u || l5.tag == 491u)) {
