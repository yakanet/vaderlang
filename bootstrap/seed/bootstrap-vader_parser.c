...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(35u, 0u, 13u, 471u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(26u, 0u, 13u, 419u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(23u, 0u, 13u, 404u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(21u, 0u, 13u, 398u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(23u, 0u, 13u, 404u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(112u, 0u, 13u, 1029u);
    l12 = (void*) _a8_arr;
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 454u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(114u, 0u, 13u, 1042u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(113u, 0u, 13u, 1037u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(35u, 0u, 13u, 471u);
    l1 = (void*) _a1_arr;
...
static void* vader_parser_parse_block(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1042u);
        l5 = (void*) _a0_arr;
        ...
        vader_obj_header_init(_a1_obj, 394u);
        _a1_obj->f_span = l4;
        _a1_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a1_obj->f_stmts = l5;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(114u, 0u, 13u, 1042u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(114u, 0u, 13u, 1042u);
    l5 = (void*) _a3_arr;
    ...
    if ((l16 > INT64_C(0))) {
        ...
        if (l18.tag == 437u) {
            ...
            vader_obj_header_init(_a8_obj, 394u);
            _a8_obj->f_span = l9;
            _a8_obj->f_id = l27;
            _a8_obj->f_stmts = l5;
        ...
        if (l18.tag == 454u) {
            ...
            vader_obj_header_init(_a12_obj, 394u);
            _a12_obj->f_span = l9;
            _a12_obj->f_id = l27;
            _a12_obj->f_stmts = l5;
        ...
        if (l18.tag == 421u) {
            ...
            vader_obj_header_init(_a16_obj, 394u);
            _a16_obj->f_span = l9;
            _a16_obj->f_id = l27;
            _a16_obj->f_stmts = l5;
        ...
        if (l18.tag == 396u) {
            ...
            vader_obj_header_init(_a18_obj, 394u);
            _a18_obj->f_span = l9;
            _a18_obj->f_id = l27;
            _a18_obj->f_stmts = l5;
        ...
        if (l18.tag == 403u) {
            ...
            vader_obj_header_init(_a20_obj, 394u);
            _a20_obj->f_span = l9;
            _a20_obj->f_id = l27;
            _a20_obj->f_stmts = l5;
        ...
        if (l18.tag == 406u) {
            ...
            vader_obj_header_init(_a22_obj, 394u);
            _a22_obj->f_span = l9;
            _a22_obj->f_id = l27;
            _a22_obj->f_stmts = l5;
    ...
    vader_obj_header_init(_a24_obj, 394u);
    _a24_obj->f_span = l9;
    _a24_obj->f_id = l27;
    _a24_obj->f_stmts = l5;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 398u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
            ...
            if (l7.tag == 457u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 459u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(23u, 0u, 13u, 404u);
                        l13 = (void*) _a5_arr;
        ...
        vader_array_t* _a8_arr = vader_array_new(23u, 0u, 13u, 404u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(23u, 0u, 13u, 404u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1029u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_defer(void* l0) {
    ...
    if (l4.tag == 405u) {
        ...
        vader_obj_header_init(_a8_obj, 406u);
        _a8_obj->f_span = l7;
        _a8_obj->f_id = l8;
        _a8_obj->f_body = l4;
        t0 = (void*) _a8_obj;
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(24u, 0u, 13u, 413u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(112u, 0u, 13u, 1029u);
    l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    vader_array_t* _a3_arr = vader_array_new(25u, 0u, 13u, 418u);
    l8 = (void*) _a3_arr;
    ...
    vader_obj_header_init(_a6_obj, 427u);
    _a6_obj->f_span = l18;
    _a6_obj->f_id = l9;
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(27u, 0u, 13u, 429u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(117u, 0u, 13u, 1069u);
        l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(115u, 1u, 13u, 1044u);
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(29u, 0u, 13u, 439u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 858u) {
            ...
            vader_array_t* _a11_arr = vader_array_new(112u, 0u, 13u, 1029u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(113u, 0u, 13u, 1037u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(113u, 0u, 13u, 1037u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(35u, 0u, 13u, 471u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(26u, 0u, 13u, 419u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(23u, 0u, 13u, 404u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(26u, 1u, 13u, 419u);
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(118u, 0u, 13u, 1071u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(31u, 0u, 13u, 461u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                l7 = (uint8_t) (int32_t) INT32_C(0);
                vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 397u);
                l8 = (void*) _a1_arr;
...
static void* vader_parser_parse_struct_pattern(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(32u, 0u, 13u, 466u);
    l2 = (void*) _a0_arr;
    {
        loop_10: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_trait_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    l4 = vader_parser_parse_struct_type_param_list(l0);
    l5 = vader_box_obj(0u, NULL);
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 418u);
    l6 = (void*) _a0_arr;
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
    if (!(t0.tag == 0u)) {
        l5 = vader_parser_parse_type(l0);
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(115u, 0u, 13u, 1044u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
