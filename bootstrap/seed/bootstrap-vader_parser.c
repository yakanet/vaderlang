...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    l10 = concat_2(902u, l10);
    l11 = vader_parser_span_of(l0, l5, l9);
    l12 = ((vader_struct_vader_lexer_Token_t*) l3)->f_span;
    vader_array_t* _a0_arr = vader_array_new(33u, 0u, 13u, 470u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(24u, 0u, 13u, 418u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(21u, 0u, 13u, 403u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(19u, 0u, 13u, 397u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(21u, 0u, 13u, 403u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(109u, 0u, 13u, 1026u);
    l12 = (void*) _a8_arr;
...
static void* vader_parser_expect(void* l0, uint8_t l1, vader_string_t l2) {
    ...
    l5 = concat_5(1478u, l2, 48u, l5, 347u);
...
static void* vader_parser_expect_string_literal(void* l0, vader_string_t l1) {
    ...
    if (!(t0)) {
        ...
        l4 = concat_5(1478u, l1, 48u, l4, 347u);
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 453u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(111u, 0u, 13u, 1039u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(110u, 0u, 13u, 1034u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(33u, 0u, 13u, 470u);
    l1 = (void*) _a1_arr;
    ...
    if (t0) {
        ...
        vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(51), 1075u);
    }
    { void* __vret = l1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_parser_parse_block(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        ((vader_struct_vader_parser_Parser_t*) l0)->f_expr_depth = l2;
        VADER_WRITE_BARRIER((vader_struct_vader_parser_Parser_t*) l0);
        vader_parser_report_nesting_too_deep(l0, 1255u);
        l2 = INT32_C(1);
        {
            loop_32: {
                if ((l2 > INT32_C(0))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(111u, 0u, 13u, 1039u);
        l5 = (void*) _a0_arr;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(111u, 0u, 13u, 1039u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(111u, 0u, 13u, 1039u);
    l5 = (void*) _a3_arr;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(19u, 0u, 13u, 397u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
        ...
        if (l3) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l5, 1080u);
            ...
            if (l7.tag == 456u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 458u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(21u, 0u, 13u, 403u);
                        l13 = (void*) _a5_arr;
                    ...
                    vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(13), l5, 1081u);
                    t0 = vader_box_obj(0u, NULL);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
                }
                t2 = l7.payload.obj;
        ...
        vader_array_t* _a8_arr = vader_array_new(21u, 0u, 13u, 403u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 403u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(109u, 0u, 13u, 1026u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            ...
            if (l6) {
                l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2412u);
                l8 = vader_box_obj(0u, NULL);
...
static vader_box_t vader_parser_parse_expr(void* l0, int32_t l1) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 1511u);
        vader_struct_toolchain_ast_NullLitExpr_t* _a0_obj = (vader_struct_toolchain_ast_NullLitExpr_t*) vader_gc_alloc(sizeof(vader_struct_toolchain_ast_NullLitExpr_t));
        vader_obj_header_init(_a0_obj, 445u);
        _a0_obj->f_span = l3;
        _a0_obj->f_id = (size_t) (int64_t) INT64_C(0);
            ...
            if (l5) {
                ...
                if (l12) {
                    if (l2 == INT32_C(20)) {
                        ...
                        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(9), l13, 1345u);
                    } else {
                        vader_parser_advance(l0);
                        vader_parser_advance(l0);
                    ...
                    if (l18) {
                        if (l2 == INT32_C(20)) {
                            ...
                            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(9), l19, 1346u);
                        } else {
                        ...
                        if (l35) {
                            ...
                            if (l36) {
                                ...
                                if (l43) {
                                    ...
                                    if (l50) {
                                        vader_parser_advance(l0);
                                        l51 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1246u);
...
static vader_box_t vader_parser_parse_fn_decl_inside_trait(void* l0) {
    ...
    if (!(l3)) {
        ...
        if (((vader_struct_vader_lexer_Token_t*) l4)->f_kind == INT32_C(11)) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l5, 2190u);
        } else {
            l5 = ((vader_struct_vader_lexer_Token_t*) l4)->f_span;
            l6 = vader_parser_describe_token(l4);
            l6 = concat_3(1498u, l6, 347u);
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(109u, 0u, 13u, 1026u);
    l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2187u);
    vader_array_t* _a1_arr = vader_array_new(109u, 0u, 13u, 1026u);
    l6 = (void*) _a1_arr;
    ...
    vader_array_t* _a3_arr = vader_array_new(23u, 0u, 13u, 417u);
    l8 = (void*) _a3_arr;
...
static void* vader_parser_parse_import_decl(void* l0, void* l1) {
    ...
    if (t0) {
        l4 = vader_parser_peek(l0);
        l4 = ((vader_struct_vader_lexer_Token_t*) l4)->f_span;
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l4, 2166u);
        vader_parser_advance(l0);
        t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(2));
        if (t0) {
            vader_parser_advance(l0);
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 428u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1065u);
        l2 = (void*) _a0_arr;
    ...
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1247u);
    l2 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    l6 = ((vader_struct_vader_lexer_Token_t*) l1)->f_text;
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(112u, 1u, 13u, 1041u);
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(27u, 0u, 13u, 438u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_pattern(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2413u);
        l3 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(19)) {
        ...
        if (t1) {
            l2 = vader_parser_advance(l0);
            l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2413u);
        ...
        if (!(t2.tag == 0u)) {
            t0 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 1246u);
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 856u) {
            ...
            l11 = concat_3(1044u, l11, 937u);
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(72), l11);
            vader_array_t* _a11_arr = vader_array_new(109u, 0u, 13u, 1026u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l8 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2413u);
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(110u, 0u, 13u, 1034u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(110u, 0u, 13u, 1034u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(68), 1063u);
    l2 = vader_parser_parse_expr(l0, INT32_C(0));
    l3 = -(INT32_C(1));
    l4 = vader_parser_peek_at(l0, l3);
    l4 = vader_parser_span_of(l0, l1, l4);
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(33u, 0u, 13u, 470u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(24u, 0u, 13u, 418u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(21u, 0u, 13u, 403u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(24u, 1u, 13u, 418u);
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(115u, 0u, 13u, 1067u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(29u, 0u, 13u, 460u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
        ...
        loop_7: {
            ...
            if (l3) {
                ...
                if (!(t1.tag == 0u)) {
                    ...
                    vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(79), 1066u);
                    l9 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2137u);
...
static void* vader_parser_parse_tuple_let(void* l0) {
    ...
    if (t0) {
        ...
        if (l6) {
            ...
            vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(64), 1069u);
        }
    }
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(112u, 0u, 13u, 1041u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
...
static vader_box_t vader_parser_parse_type(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 2197u);
...
static vader_box_t vader_parser_parse_type_primary(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(71)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2202u);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(74)) {
        ...
        if (t3 == INT64_C(1)) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(20), l7, 2320u);
            l7 = vader_parser_span_of(l0, l2, l6);
            vader_array_t* _a3_slotarr = ((vader_array_t*) l3);
            if (_a3_slotarr->buf != NULL && _a3_slotarr->buf->header.forward != NULL) { _a3_slotarr->buf = vader_array_buf_forward(_a3_slotarr->buf); }
            if ((size_t) INT32_C(0) >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
