...
static void* vader_parser_consume_closing_angle(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(46)) {
        ...
        vader_obj_header_init(_a3_obj, 715u);
        ...
        vader_obj_header_init(_a5_obj, 715u);
...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(34u, 0u, 13u, 487u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(25u, 0u, 13u, 435u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(22u, 0u, 13u, 420u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(20u, 0u, 13u, 414u);
    l11 = (void*) _a4_arr;
    ...
    vader_obj_header_init(_a5_obj, 415u);
    _a5_obj->f_span = l5;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(22u, 0u, 13u, 420u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(111u, 0u, 13u, 1045u);
    l12 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a9_obj, 420u);
    _a9_obj->f_span = l11;
    ...
    vader_obj_header_init(_a10_obj, 418u);
    _a10_obj->f_span = l9;
...
static void* vader_parser_expect_string_literal(void* l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a3_obj, 879u);
    _a3_obj->f_text = l4;
    _a3_obj->f_span = l2;
    t1 = (void*) _a3_obj;
    { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
...
static void* vader_parser_infix_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(52)) {
        ...
        vader_obj_header_init(_a7_obj, 873u);
        _a7_obj->f_has = true;
    ...
    if (l0 == INT32_C(65)) {
        ...
        vader_obj_header_init(_a10_obj, 873u);
        _a10_obj->f_has = true;
    ...
    if (l0 == INT32_C(66)) {
        ...
        vader_obj_header_init(_a11_obj, 873u);
        _a11_obj->f_has = true;
    ...
    if (l0 == INT32_C(42)) {
        ...
        vader_obj_header_init(_a12_obj, 873u);
        _a12_obj->f_has = true;
    ...
    if (l0 == INT32_C(43)) {
        ...
        vader_obj_header_init(_a13_obj, 873u);
        _a13_obj->f_has = true;
    ...
    if (l0 == INT32_C(41)) {
        ...
        vader_obj_header_init(_a14_obj, 873u);
        _a14_obj->f_has = true;
    ...
    if (l0 == INT32_C(45)) {
        ...
        vader_obj_header_init(_a15_obj, 873u);
        _a15_obj->f_has = true;
    ...
    if (l0 == INT32_C(46)) {
        ...
        vader_obj_header_init(_a16_obj, 873u);
        _a16_obj->f_has = true;
    ...
    if (l0 == INT32_C(36)) {
        ...
        vader_obj_header_init(_a17_obj, 873u);
        _a17_obj->f_has = true;
    ...
    if (l0 == INT32_C(39)) {
        ...
        vader_obj_header_init(_a20_obj, 873u);
        _a20_obj->f_has = true;
    ...
    if (l0 == INT32_C(40)) {
        ...
        vader_obj_header_init(_a21_obj, 873u);
        _a21_obj->f_has = true;
...
static void* vader_parser_lift_trailing_return(void* l0) {
    ...
    if (l4.tag == 470u) {
        ...
        if (!(((vader_struct_toolchain_ast_ReturnStmt_t*) l2)->f_value.tag == 0u)) {
            vader_array_t* _a1_arr = vader_array_new(113u, 0u, 13u, 1058u);
            l5 = (void*) _a1_arr;
            t0 = (l1 - INT64_C(1));
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 4u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(51u, 0u, 13u, 712u);
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1053u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(34u, 0u, 13u, 487u);
    l1 = (void*) _a1_arr;
...
static void* vader_parser_parse_block(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_array_t* _a0_arr = vader_array_new(113u, 0u, 13u, 1058u);
        l5 = (void*) _a0_arr;
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(113u, 0u, 13u, 1058u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(113u, 0u, 13u, 1058u);
    l5 = (void*) _a3_arr;
    ...
    if ((l16 > INT64_C(0))) {
        ...
        if (l18.tag == 437u) {
            ...
            vader_obj_header_init(_a16_obj, 410u);
            _a16_obj->f_span = l9;
            _a16_obj->f_id = l27;
            _a16_obj->f_stmts = l5;
        ...
        if (l18.tag == 412u) {
            ...
            vader_obj_header_init(_a18_obj, 410u);
            _a18_obj->f_span = l9;
            _a18_obj->f_id = l27;
            _a18_obj->f_stmts = l5;
        ...
        if (l18.tag == 419u) {
            ...
            vader_obj_header_init(_a20_obj, 410u);
            _a20_obj->f_span = l9;
            _a20_obj->f_id = l27;
            _a20_obj->f_stmts = l5;
        ...
        if (l18.tag == 422u) {
            ...
            vader_obj_header_init(_a22_obj, 410u);
            _a22_obj->f_span = l9;
            _a22_obj->f_id = l27;
            _a22_obj->f_stmts = l5;
    ...
    vader_obj_header_init(_a24_obj, 410u);
    _a24_obj->f_span = l9;
    _a24_obj->f_id = l27;
    _a24_obj->f_stmts = l5;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(20u, 0u, 13u, 414u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
        ...
        loop_16: {
            ...
            if (t0) {
                ...
                if (l4) {
                    ...
                    _a2_obj->f_name = vader_box_string(163u, l10);
                    _a2_obj->f_value = l6;
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
            ...
            if (l7.tag == 473u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 475u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(22u, 0u, 13u, 420u);
                        l13 = (void*) _a5_arr;
        ...
        vader_array_t* _a8_arr = vader_array_new(22u, 0u, 13u, 420u);
        l13 = (void*) _a8_arr;
        ...
        vader_obj_header_init(_a9_obj, 405u);
        _a9_obj->f_span = l9;
        _a9_obj->f_id = l10;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(22u, 0u, 13u, 420u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(111u, 0u, 13u, 1045u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_defer(void* l0) {
    ...
    if (l4.tag == 423u) {
        ...
        vader_obj_header_init(_a6_obj, 422u);
        _a6_obj->f_span = l7;
        _a6_obj->f_id = l8;
        _a6_obj->f_body = l4;
        t0 = (void*) _a6_obj;
    ...
    if (l4.tag == 421u) {
        ...
        vader_obj_header_init(_a7_obj, 495u);
        _a7_obj->f_start = l3;
        _a7_obj->f_end = l6;
        l7 = (void*) _a7_obj;
        l8 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(23u, 0u, 13u, 429u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                if (!(t0.tag == 0u)) {
                    ...
                    if (l11.tag == 172u) {
                        ...
                        l8 = vader_box_i64(167u, t3);
                    } else {
                        l8 = vader_box_i32(166u, INT32_C(0));
                    }
                ...
                if (l12) {
                    ...
                    if (l18) {
                        if (l2 == INT32_C(20)) {
                            ...
                            vader_obj_header_init(_a4_obj, 408u);
                            _a4_obj->f_span = t1;
                            ...
                            vader_obj_header_init(_a6_obj, 488u);
                            _a6_obj->f_span = t1;
                        ...
                        if (l35) {
                            ...
                            if (l36) {
                                ...
                                if (l43) {
                                    ...
                                    vader_obj_header_init(_a10_obj, 467u);
                                    _a10_obj->f_span = l46;
                                    _a10_obj->f_id = (size_t) (int64_t) INT64_C(0);
                                    ...
                                    vader_obj_header_init(_a11_obj, 495u);
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(111u, 0u, 13u, 1045u);
    l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_for(void* l0, vader_box_t l1, bool l2) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a9_obj, 446u);
    ...
    if (l9.tag == 467u) {
        ...
        vader_obj_header_init(_a12_obj, 426u);
        l6 = (void*) _a12_obj;
        l10 = l9.payload.obj;
        ...
        vader_obj_header_init(_a13_obj, 446u);
        ...
        vader_obj_header_init(_a14_obj, 437u);
        _a14_obj->f_span = l5;
    ...
    vader_obj_header_init(_a16_obj, 489u);
    _a16_obj->f_cond = l9;
    l5 = (void*) _a16_obj;
    ...
    vader_obj_header_init(_a17_obj, 437u);
    _a17_obj->f_span = l3;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    vader_array_t* _a3_arr = vader_array_new(24u, 0u, 13u, 434u);
    l8 = (void*) _a3_arr;
    ...
    if (l13) {
        ...
        vader_obj_header_init(_a5_obj, 443u);
        _a5_obj->f_span = l18;
        _a5_obj->f_id = l9;
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(26u, 0u, 13u, 445u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static vader_box_t vader_parser_parse_let_binding(void* l0) {
    ...
    if (t0) {
        l1 = vader_parser_advance(l0);
        vader_parser_skip_newlines(l0);
        vader_array_t* _a0_arr = vader_array_new(116u, 0u, 13u, 1085u);
        l2 = (void*) _a0_arr;
        ...
        vader_obj_header_init(_a2_obj, 484u);
        _a2_obj->f_span = t3;
        _a2_obj->f_id = (size_t) (int64_t) INT64_C(0);
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(114u, 1u, 13u, 1060u);
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(28u, 0u, 13u, 455u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
vader_box_t vader_parser_parse_module_header(vader_string_t l0, vader_string_t l1) {
    ...
    if ((l3 >= INT64_C(3))) {
        ...
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) INT32_C(0) >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) INT32_C(0), 169u);
    ...
    if (l5) {
        ...
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
        if ((size_t) INT32_C(1) >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) INT32_C(1), 169u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(187);
    } else {
        l5 = false;
    ...
    if (l5) {
        ...
        t0 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) INT32_C(2), 169u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(191);
    } else {
        l5 = false;
    ...
    if (((l4 + INT64_C(1)) < l3)) {
        ...
        t0 = vader_array_read_u8(_a3_slotarr, _a3_slotarr->offset + (size_t) l4, 169u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 == INT32_C(35);
    } else {
        l5 = false;
    ...
    l6 = vader_parser_header_budget(l3);
    {
        loop_101: {
            if ((l4 < l6)) {
                ...
                t0 = vader_array_read_u8(_a5_slotarr, _a5_slotarr->offset + (size_t) l4, 169u);
                ...
                if (l10) {
                    ...
                    t0 = vader_array_read_u8(_a6_slotarr, _a6_slotarr->offset + (size_t) l12, 169u);
                    t1 = ((uint8_t) t0.payload.i);
                    l11 = t1 == INT32_C(47);
                } else {
                    l11 = false;
                ...
                if (l13) {
                    ...
                    t0 = vader_array_read_u8(_a7_slotarr, _a7_slotarr->offset + (size_t) l15, 169u);
                    t1 = ((uint8_t) t0.payload.i);
                    l14 = t1 == INT32_C(42);
                } else {
                    l14 = false;
    ...
    t0 = vader_array_read_u8(_a8_slotarr, _a8_slotarr->offset + (size_t) l4, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(109)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a9_slotarr, _a9_slotarr->offset + (size_t) l6, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(111)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a10_slotarr, _a10_slotarr->offset + (size_t) l6, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(100)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a11_slotarr, _a11_slotarr->offset + (size_t) l6, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(117)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l6, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(108)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    t0 = vader_array_read_u8(_a13_slotarr, _a13_slotarr->offset + (size_t) l6, 169u);
    t1 = ((uint8_t) t0.payload.i);
    if (t1 != INT32_C(101)) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    l4 = (size_t) (int64_t) t2;
    {
        loop_339: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a14_slotarr, _a14_slotarr->offset + (size_t) l4, 169u);
                l7 = ((uint8_t) t0.payload.i);
                if (l7 == INT32_C(32)) {
                    l5 = true;
                } else {
    ...
    if ((l4 >= l3)) {
        ...
        t0 = vader_array_read_u8(_a15_slotarr, _a15_slotarr->offset + (size_t) l4, 169u);
        t1 = ((uint8_t) t0.payload.i);
        l5 = t1 != INT32_C(34);
    }
    if (l5) {
    ...
    l6 = l4;
    {
        loop_399: {
            if ((l4 < l3)) {
                ...
                t0 = vader_array_read_u8(_a16_slotarr, _a16_slotarr->offset + (size_t) l4, 169u);
                t1 = ((uint8_t) t0.payload.i);
                l5 = t1 != INT32_C(34);
            } else {
                l5 = false;
    ...
    vader_obj_header_init(_a18_obj, 875u);
    _a18_obj->f_name = l17;
...
static vader_box_t vader_parser_parse_pattern(void* l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a7_obj, 454u);
        _a7_obj->f_span = t0;
...
static vader_box_t vader_parser_parse_postfix(void* l0, vader_box_t l1, void* l2) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(72)) {
        ...
        vader_obj_header_init(_a7_obj, 415u);
        _a7_obj->f_span = l4;
        _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a7_obj->f_callee = l1;
        _a7_obj->f_args = l5;
    ...
    vader_obj_header_init(_a10_obj, 495u);
    _a10_obj->f_start = l3;
    _a10_obj->f_end = l4;
    t1 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 447u);
    _a11_obj->f_span = t1;
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(31)) {
        ...
        vader_obj_header_init(_a3_obj, 411u);
    ...
    if (l6) {
        ...
        vader_obj_header_init(_a7_obj, 488u);
        _a7_obj->f_span = t0;
        _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a7_obj->f_op = l7;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 874u) {
            ...
            vader_array_t* _a11_arr = vader_array_new(111u, 0u, 13u, 1045u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
                    ...
                    loop_473: {
                        ...
                        if (t2) {
                            ...
                            if ((l14 < l15)) {
                                ...
                                t1 = vader_array_read_u8(_a12_slotarr, _a12_slotarr->offset + (size_t) l14, 169u);
            ...
            vader_obj_header_init(_a13_obj, 450u);
            _a13_obj->f_span = l8;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        ...
        vader_obj_header_init(_a14_obj, 495u);
        _a14_obj->f_start = l9;
        _a14_obj->f_end = l10;
        l9 = (void*) _a14_obj;
        ...
        vader_obj_header_init(_a15_obj, 427u);
        _a15_obj->f_span = l9;
    ...
    vader_obj_header_init(_a16_obj, 462u);
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(112u, 0u, 13u, 1053u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(112u, 0u, 13u, 1053u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(34u, 0u, 13u, 487u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(25u, 0u, 13u, 435u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(22u, 0u, 13u, 420u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(25u, 1u, 13u, 435u);
...
static vader_box_t vader_parser_parse_stmt(void* l0) {
    ...
    if (l1) {
        ...
        t1 = vader_parser_parse_for(l0, vader_box_string(163u, l3), false);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(74));
    if (t0) {
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(117u, 0u, 13u, 1087u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(30u, 0u, 13u, 477u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                l7 = (uint8_t) (int32_t) INT32_C(0);
                vader_array_t* _a1_arr = vader_array_new(19u, 0u, 13u, 413u);
                l8 = (void*) _a1_arr;
...
static void* vader_parser_parse_struct_lit_fields(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(118u, 0u, 13u, 1088u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    {
...
static void* vader_parser_parse_struct_pattern(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(31u, 0u, 13u, 482u);
    l2 = (void*) _a0_arr;
    {
        loop_10: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_trait_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    l4 = vader_parser_parse_struct_type_param_list(l0);
    l5 = vader_box_obj(0u, NULL);
    vader_array_t* _a0_arr = vader_array_new(24u, 0u, 13u, 434u);
    l6 = (void*) _a0_arr;
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
    if (!(t0.tag == 0u)) {
        l5 = vader_parser_parse_type(l0);
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1060u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
...
static vader_box_t vader_parser_parse_type_mut_marker(void* l0) {
    ...
    vader_obj_header_init(_a2_obj, 715u);
...
static vader_box_t vader_parser_parse_type_primary(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(74)) {
        ...
        vader_obj_header_init(_a5_obj, 471u);
        _a5_obj->f_span = t0;
        _a5_obj->f_id = (size_t) (int64_t) INT64_C(0);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(2)) {
        ...
        l5 = vader_ref_box(t0);
        {
            loop_207: {
                ...
                if (t1) {
                    ...
                    vader_obj_header_init(_a7_obj, 432u);
                    _a7_obj->f_span = l8;
                    _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
                    _a7_obj->f_target = l5;
                    _a7_obj->f_field = l4;
        ...
        if (!(t2.tag == 0u)) {
            ...
            vader_obj_header_init(_a8_obj, 438u);
            _a8_obj->f_span = t0;
            _a8_obj->f_id = (size_t) (int64_t) INT64_C(0);
            _a8_obj->f_callee = l5;
    ...
    l4 = INT32_C(1);
    {
        loop_5: {
            ...
            if (l5) {
                ...
                if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
                if ((size_t) l3 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l3, 169u);
                l6 = ((uint8_t) t0.payload.i);
                t1 = (l3 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                if ((size_t) l7 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l7, 169u);
...
static void vader_parser_walk_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 461u) {
        ...
        if ((l5.tag == 412u || l5.tag == 419u || l5.tag == 470u)) {
            vader_parser_walk_stmt(l5, l1);
            return;
        }
        if ((l5.tag == 404u || l5.tag == 407u || l5.tag == 408u || l5.tag == 410u || l5.tag == 411u || l5.tag == 415u || l5.tag == 416u || l5.tag == 417u || l5.tag == 427u || l5.tag == 432u || l5.tag == 433u || l5.tag == 436u || l5.tag == 438u || l5.tag == 439u || l5.tag == 442u || l5.tag == 447u || l5.tag == 449u || l5.tag == 450u || l5.tag == 452u || l5.tag == 456u || l5.tag == 458u || l5.tag == 461u || l5.tag == 462u || l5.tag == 467u || l5.tag == 471u || l5.tag == 473u || l5.tag == 478u || l5.tag == 488u)) {
