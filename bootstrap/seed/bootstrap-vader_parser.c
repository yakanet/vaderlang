...
static void* vader_parser_desugar_comptime_const(void* l0, void* l1, uint8_t l2, void* l3, vader_box_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(34u, 0u, 13u, 468u);
    l13 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(25u, 0u, 13u, 416u);
    l14 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(22u, 0u, 13u, 401u);
    l15 = (void*) _a2_arr;
    ...
    vader_array_t* _a4_arr = vader_array_new(20u, 0u, 13u, 395u);
    l11 = (void*) _a4_arr;
    ...
    l5 = (void*) _a5_obj;
    vader_array_t* _a6_arr = vader_array_new(22u, 0u, 13u, 401u);
    l7 = (void*) _a6_arr;
    l11 = l1;
    ...
    vader_array_t* _a8_arr = vader_array_new(111u, 0u, 13u, 1026u);
    l12 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a10_obj, 399u);
    _a10_obj->f_span = l9;
...
static void* vader_parser_expect_string_literal(void* l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a2_obj, 382u);
    _a2_obj->f_parts = t1;
    l3 = (void*) _a2_obj;
    {
        loop_39: {
...
static void* vader_parser_infix_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(52)) {
        ...
        vader_obj_header_init(_a7_obj, 854u);
        _a7_obj->f_has = true;
    ...
    if (l0 == INT32_C(19)) {
        ...
        vader_obj_header_init(_a8_obj, 854u);
        _a8_obj->f_has = true;
    ...
    if (l0 == INT32_C(21)) {
        ...
        vader_obj_header_init(_a9_obj, 854u);
        _a9_obj->f_has = true;
    ...
    if (l0 == INT32_C(45)) {
        ...
        vader_obj_header_init(_a15_obj, 854u);
        _a15_obj->f_has = true;
    ...
    if (l0 == INT32_C(46)) {
        ...
        vader_obj_header_init(_a16_obj, 854u);
        _a16_obj->f_has = true;
    ...
    if (l0 == INT32_C(36)) {
        ...
        vader_obj_header_init(_a17_obj, 854u);
        _a17_obj->f_has = true;
    ...
    if (l0 == INT32_C(37)) {
        ...
        vader_obj_header_init(_a18_obj, 854u);
        _a18_obj->f_has = true;
    ...
    if (l0 == INT32_C(39)) {
        ...
        vader_obj_header_init(_a20_obj, 854u);
        _a20_obj->f_has = true;
    ...
    if (l0 == INT32_C(40)) {
        ...
        vader_obj_header_init(_a21_obj, 854u);
        _a21_obj->f_has = true;
...
static void* vader_parser_new_parser(void* l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 4u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(51u, 0u, 13u, 693u);
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(112u, 0u, 13u, 1034u);
    l3 = (void*) _a1_arr;
...
static void* vader_parser_parse_angle_type_params(void* l0) {
    ...
    vader_parser_advance(l0);
    vader_array_t* _a1_arr = vader_array_new(34u, 0u, 13u, 468u);
    l1 = (void*) _a1_arr;
...
static void* vader_parser_parse_block(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a2_arr = vader_array_new(113u, 0u, 13u, 1039u);
    l4 = (void*) _a2_arr;
    l6 = vader_box_obj(0u, NULL);
    {
        loop_104: {
    ...
    vader_array_t* _a3_arr = vader_array_new(113u, 0u, 13u, 1039u);
    l5 = (void*) _a3_arr;
    ...
    if ((l16 > INT64_C(0))) {
        ...
        if (l18.tag == 412u) {
            ...
            vader_obj_header_init(_a6_obj, 391u);
            _a6_obj->f_span = l9;
            _a6_obj->f_id = l27;
            _a6_obj->f_stmts = l5;
        ...
        if (l18.tag == 451u) {
            ...
            vader_obj_header_init(_a12_obj, 391u);
            _a12_obj->f_span = l9;
            _a12_obj->f_id = l27;
            _a12_obj->f_stmts = l5;
        ...
        if (l18.tag == 474u) {
            ...
            vader_obj_header_init(_a14_obj, 391u);
            _a14_obj->f_span = l9;
            _a14_obj->f_id = l27;
            _a14_obj->f_stmts = l5;
        ...
        if (l18.tag == 418u) {
            ...
            vader_obj_header_init(_a16_obj, 391u);
            _a16_obj->f_span = l9;
            _a16_obj->f_id = l27;
            _a16_obj->f_stmts = l5;
        ...
        if (l18.tag == 393u) {
            ...
            vader_obj_header_init(_a18_obj, 391u);
            _a18_obj->f_span = l9;
            _a18_obj->f_id = l27;
            _a18_obj->f_stmts = l5;
        ...
        if (l18.tag == 400u) {
            ...
            vader_obj_header_init(_a20_obj, 391u);
            _a20_obj->f_span = l9;
            _a20_obj->f_id = l27;
            _a20_obj->f_stmts = l5;
        ...
        if (l18.tag == 403u) {
            ...
            vader_obj_header_init(_a22_obj, 391u);
            _a22_obj->f_span = l9;
            _a22_obj->f_id = l27;
            _a22_obj->f_stmts = l5;
    ...
    vader_obj_header_init(_a24_obj, 391u);
    _a24_obj->f_span = l9;
    _a24_obj->f_id = l27;
    _a24_obj->f_stmts = l5;
...
static void* vader_parser_parse_call_args(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(20u, 0u, 13u, 395u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
...
static vader_box_t vader_parser_parse_decl(void* l0) {
    ...
    if (l3) {
            ...
            if (l7.tag == 454u) {
                ...
                if (t1 == INT64_C(1)) {
                    ...
                    if (l8.tag == 456u) {
                        ...
                        vader_array_t* _a5_arr = vader_array_new(22u, 0u, 13u, 401u);
                        l13 = (void*) _a5_arr;
                        ...
                        vader_obj_header_init(_a6_obj, 386u);
                        _a6_obj->f_span = l9;
                        _a6_obj->f_id = l10;
        ...
        vader_array_t* _a8_arr = vader_array_new(22u, 0u, 13u, 401u);
        l13 = (void*) _a8_arr;
...
static void* vader_parser_parse_decorators(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(22u, 0u, 13u, 401u);
    l1 = (void*) _a0_arr;
    {
        loop_3: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(70));
            if (t0) {
                ...
                vader_array_t* _a1_arr = vader_array_new(111u, 0u, 13u, 1026u);
                l4 = (void*) _a1_arr;
...
static void* vader_parser_parse_enum_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(23u, 0u, 13u, 410u);
    l5 = (void*) _a0_arr;
    {
        loop_35: {
            t1 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                l7 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2371u);
                l8 = vader_box_obj(0u, NULL);
                ...
                if (l12) {
                    ...
                    if (l18) {
                        ...
                        if (l29) {
                            ...
                            vader_obj_header_init(_a8_obj, 442u);
                            _a8_obj->f_span = t1;
                        ...
                        if (l35) {
                            ...
                            if (l36) {
                                ...
                                if (l43) {
                                    ...
                                    vader_obj_header_init(_a9_obj, 476u);
                                    _a9_obj->f_start = l44;
                                    _a9_obj->f_end = l45;
                                    l46 = (void*) _a9_obj;
                                    ...
                                    vader_obj_header_init(_a11_obj, 476u);
...
static void* vader_parser_parse_fn_type(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(111u, 0u, 13u, 1026u);
    l2 = (void*) _a0_arr;
...
static void* vader_parser_parse_for(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l8) {
        ...
        vader_obj_header_init(_a4_obj, 441u);
        _a4_obj->f_name = l11;
        _a4_obj->f_span = l4;
        t1 = (void*) _a4_obj;
    ...
    if (l9.tag == 448u) {
        ...
        vader_obj_header_init(_a12_obj, 407u);
        l6 = (void*) _a12_obj;
        l10 = l9.payload.obj;
        ...
        vader_obj_header_init(_a13_obj, 427u);
        ...
        vader_obj_header_init(_a14_obj, 418u);
        _a14_obj->f_span = l5;
    ...
    vader_obj_header_init(_a15_obj, 476u);
    _a15_obj->f_start = l3;
    _a15_obj->f_end = l5;
    l3 = (void*) _a15_obj;
    ...
    vader_obj_header_init(_a16_obj, 470u);
    _a16_obj->f_cond = l9;
    l5 = (void*) _a16_obj;
    ...
    vader_obj_header_init(_a17_obj, 418u);
    _a17_obj->f_span = l3;
...
static void* vader_parser_parse_if_expr(void* l0) {
    ...
    if (l5.tag == 0u) {
        ...
        vader_obj_header_init(_a7_obj, 423u);
        _a7_obj->f_span = l9;
        _a7_obj->f_id = l10;
        _a7_obj->f_cond = l3;
...
static void* vader_parser_parse_impl_decl(void* l0, void* l1) {
    ...
    l5 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2153u);
    vader_array_t* _a1_arr = vader_array_new(111u, 0u, 13u, 1026u);
    l6 = (void*) _a1_arr;
    ...
    vader_array_t* _a3_arr = vader_array_new(24u, 0u, 13u, 415u);
    l8 = (void*) _a3_arr;
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a4_obj, 424u);
        _a4_obj->f_span = l18;
        _a4_obj->f_id = l9;
...
static void* vader_parser_parse_import_decl(void* l0, void* l1) {
    ...
    if (t0) {
        l4 = vader_parser_peek(l0);
        l4 = ((vader_struct_vader_lexer_Token_t*) l4)->f_span;
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l4, 2132u);
        vader_parser_advance(l0);
        t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(2));
        if (t0) {
            vader_parser_advance(l0);
...
static void* vader_parser_parse_import_name_list_rest(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(26u, 0u, 13u, 426u);
    l1 = (void*) _a0_arr;
    l2 = false;
    vader_parser_skip_newlines(l0);
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_match_arm(void* l0) {
    ...
    if (t0) {
        vader_array_t* _a0_arr = vader_array_new(114u, 1u, 13u, 1041u);
...
static void* vader_parser_parse_match_expr(void* l0, bool l1, bool l2) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(28u, 0u, 13u, 436u);
    l6 = (void*) _a0_arr;
    {
        loop_26: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_named_import_decl(void* l0, void* l1, void* l2) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(5), l5, 2137u);
...
static vader_box_t vader_parser_parse_pattern(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2372u);
        l3 = ((vader_struct_toolchain_span_Span_t*) ((vader_struct_vader_lexer_Token_t*) l1)->f_span)->f_start;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(19)) {
        ...
        if (t1) {
            l2 = vader_parser_advance(l0);
            l3 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2372u);
    ...
    if (t1) {
        ...
        if (l10) {
            ...
            vader_obj_header_init(_a6_obj, 449u);
            _a6_obj->f_span = t0;
            _a6_obj->f_id = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_parser_parse_postfix(void* l0, vader_box_t l1, void* l2) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l2)->f_kind == INT32_C(72)) {
        ...
        vader_obj_header_init(_a7_obj, 396u);
        _a7_obj->f_span = l4;
        _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a7_obj->f_callee = l1;
        _a7_obj->f_args = l5;
    ...
    vader_obj_header_init(_a10_obj, 476u);
    _a10_obj->f_start = l3;
    _a10_obj->f_end = l4;
    t1 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 428u);
    _a11_obj->f_span = t1;
...
static vader_box_t vader_parser_parse_prefix(void* l0) {
    ...
    if (l6) {
        ...
        vader_obj_header_init(_a7_obj, 469u);
        _a7_obj->f_span = t0;
        _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a7_obj->f_op = l7;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(34)) {
        vader_parser_advance(l0);
        t0 = vader_parser_ident_expr(((vader_struct_vader_lexer_Token_t*) l1)->f_span, 1967u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(70)) {
        ...
        if (l3.tag == 0u) {
            ...
            vader_obj_header_init(_a10_obj, 443u);
            _a10_obj->f_span = t0;
            _a10_obj->f_id = (size_t) (int64_t) INT64_C(0);
            t0 = (void*) _a10_obj;
            { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
        ...
        if (l3.tag == 855u) {
            ...
            vader_array_t* _a11_arr = vader_array_new(111u, 0u, 13u, 1026u);
            l13 = (void*) _a11_arr;
            vader_parser_skip_newlines(l0);
            l6 = false;
            t2 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(73));
            ...
            vader_obj_header_init(_a13_obj, 431u);
            _a13_obj->f_span = l8;
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(79)) {
        vader_parser_advance(l0);
        l8 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2372u);
        ...
        vader_obj_header_init(_a14_obj, 476u);
        _a14_obj->f_start = l9;
        _a14_obj->f_end = l10;
        l9 = (void*) _a14_obj;
        ...
        vader_obj_header_init(_a15_obj, 408u);
        _a15_obj->f_span = l9;
    ...
    vader_obj_header_init(_a16_obj, 443u);
...
static void* vader_parser_parse_program(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_peek(l0);
    vader_array_t* _a0_arr = vader_array_new(112u, 0u, 13u, 1034u);
    l2 = (void*) _a0_arr;
    vader_parser_skip_newlines(l0);
        ...
        loop_13: {
            ...
            if (!(t0)) {
                ...
                if ((t1 > INT64_C(0))) {
                    ...
                    vader_array_t* _a2_arr = vader_array_new(112u, 0u, 13u, 1034u);
                    l9 = (void*) _a2_arr;
...
static void* vader_parser_parse_sam_arrow_member(void* l0) {
    ...
    l5 = (void*) _a1_obj;
    l1 = ((vader_struct_vader_lexer_Token_t*) l1)->f_span;
    vader_array_t* _a2_arr = vader_array_new(34u, 0u, 13u, 468u);
    l6 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(25u, 0u, 13u, 416u);
    l7 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(22u, 0u, 13u, 401u);
    l8 = (void*) _a4_arr;
...
static void* vader_parser_parse_single_param_lambda_tail(void* l0, void* l1) {
    ...
    _a2_obj->f_end = l6;
    l5 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(25u, 1u, 13u, 416u);
    ...
    vader_obj_header_init(_a4_obj, 433u);
    _a4_obj->f_span = l5;
    _a4_obj->f_id = (size_t) (int64_t) INT64_C(0);
    _a4_obj->f_params = l2;
...
static vader_box_t vader_parser_parse_stmt(void* l0) {
    ...
    if (!(t3.tag == 0u)) {
        ...
        vader_obj_header_init(_a0_obj, 387u);
        _a0_obj->f_span = t1;
        _a0_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a0_obj->f_target = l5;
        _a0_obj->f_value = l6;
...
static void* vader_parser_parse_string_lit(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_parser_advance(l0);
    vader_array_t* _a0_arr = vader_array_new(117u, 0u, 13u, 1068u);
    l2 = (void*) _a0_arr;
    {
        loop_6: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(8));
...
static void* vader_parser_parse_struct_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(30u, 0u, 13u, 458u);
    l5 = (void*) _a0_arr;
    {
        loop_20: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
            ...
            if (l6) {
                ...
                l7 = (uint8_t) (int32_t) INT32_C(0);
                vader_array_t* _a1_arr = vader_array_new(19u, 0u, 13u, 394u);
                l8 = (void*) _a1_arr;
        ...
        loop_7: {
            ...
            if (l3) {
                ...
                if (!(t1.tag == 0u)) {
                    ...
                    l9 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2104u);
...
static void* vader_parser_parse_struct_pattern(void* l0) {
    ...
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(31u, 0u, 13u, 463u);
    l2 = (void*) _a0_arr;
    {
        loop_10: {
            t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(77));
...
static void* vader_parser_parse_trait_decl(void* l0, void* l1, uint8_t l2, void* l3) {
    ...
    l4 = vader_parser_parse_struct_type_param_list(l0);
    l5 = vader_box_obj(0u, NULL);
    vader_array_t* _a0_arr = vader_array_new(24u, 0u, 13u, 415u);
    l6 = (void*) _a0_arr;
    t0 = vader_parser_match_kind(l0, (uint8_t) (int32_t) INT32_C(57));
    if (!(t0.tag == 0u)) {
        l5 = vader_parser_parse_type(l0);
...
static void* vader_parser_parse_tuple_pattern(void* l0) {
    ...
    l1 = vader_parser_advance(l0);
    vader_parser_skip_newlines(l0);
    vader_array_t* _a0_arr = vader_array_new(114u, 0u, 13u, 1041u);
    l2 = (void*) _a0_arr;
    t0 = vader_parser_check(l0, (uint8_t) (int32_t) INT32_C(75));
    if (!(t0)) {
        {
...
static vader_box_t vader_parser_parse_type(void* l0) {
    ...
    if ((t0 > INT32_C(256))) {
        ...
        vader_parser_report_nesting_too_deep(l0, 2163u);
...
static vader_box_t vader_parser_parse_type_primary(void* l0) {
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(71)) {
        vader_parser_advance(l0);
        l2 = vader_parser_expect(l0, (uint8_t) (int32_t) INT32_C(2), 2168u);
    ...
    if (((vader_struct_vader_lexer_Token_t*) l1)->f_kind == INT32_C(74)) {
        ...
        if (t3 == INT64_C(1)) {
            ...
            vader_parser_error(l0, (uint8_t) (int32_t) INT32_C(20), l7, 2286u);
            l7 = vader_parser_span_of(l0, l2, l6);
            vader_array_t* _a3_slotarr = ((vader_array_t*) l3);
            if (_a3_slotarr->buf != NULL && _a3_slotarr->buf->header.forward != NULL) { _a3_slotarr->buf = vader_array_buf_forward(_a3_slotarr->buf); }
            if ((size_t) INT32_C(0) >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
        ...
        vader_obj_header_init(_a5_obj, 452u);
        _a5_obj->f_span = t0;
        _a5_obj->f_id = (size_t) (int64_t) INT64_C(0);
        ...
        l5 = vader_ref_box(t0);
        {
            loop_207: {
                ...
                if (t1) {
                    ...
                    vader_obj_header_init(_a7_obj, 413u);
                    _a7_obj->f_span = l8;
                    _a7_obj->f_id = (size_t) (int64_t) INT64_C(0);
                    _a7_obj->f_target = l5;
                    _a7_obj->f_field = l4;
...
static void vader_parser_walk_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 442u) {
        ...
        if ((l5.tag == 393u || l5.tag == 400u || l5.tag == 451u)) {
            vader_parser_walk_stmt(l5, l1);
            return;
        }
        if ((l5.tag == 385u || l5.tag == 388u || l5.tag == 389u || l5.tag == 391u || l5.tag == 392u || l5.tag == 396u || l5.tag == 397u || l5.tag == 398u || l5.tag == 408u || l5.tag == 413u || l5.tag == 414u || l5.tag == 417u || l5.tag == 419u || l5.tag == 420u || l5.tag == 423u || l5.tag == 428u || l5.tag == 430u || l5.tag == 431u || l5.tag == 433u || l5.tag == 437u || l5.tag == 439u || l5.tag == 442u || l5.tag == 443u || l5.tag == 448u || l5.tag == 452u || l5.tag == 454u || l5.tag == 459u || l5.tag == 469u)) {
