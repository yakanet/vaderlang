...
void* vader_midir_annotate_escape(void* l0) {
    ...
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(16u, 0u, 0u, 176u);
    l4 = (void*) _a1_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_30: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a6_obj, 204u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                t1 = (void*) _a6_obj;
...
static void* vader_midir_annotate_function(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(9u, 0u, 7u, 168u);
    l1 = (void*) _a0_arr;
    ...
    _a4_obj->f_inner = t0;
    l1 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a5_arr;
    ...
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 168u);
    l10 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(6u, 0u, 12u, 163u);
    l14 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 168u);
    l15 = (void*) _a10_arr;
    ...
    vader_obj_header_init(_a11_obj, 306u);
    ...
    vader_obj_header_init(_a12_obj, 373u);
    _a12_obj->f_inner = t0;
    l10 = (void*) _a12_obj;
    vader_array_t* _a13_arr = vader_array_new(9u, 0u, 7u, 168u);
    l14 = (void*) _a13_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_329: {
            if ((l5 < l4)) {
                ...
                l20 = false;
                vader_array_t* _a21_arr = vader_array_new(130u, 0u, 13u, 1153u);
                l21 = (void*) _a21_arr;
...
static void vader_midir_append_alias(void* l0, int32_t l1, int32_t l2) {
    ...
    if (l3.tag == 0u) {
        vader_array_t* _a0_arr = vader_array_new(9u, 1u, 7u, 168u);
...
static uint64_t vader_midir_bc_value_bits(vader_box_t l0, vader_string_t l1) {
    ...
    vader_host_std_abort_panic(1843u);
...
static vader_box_t vader_midir_build_array_len(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1782u, l3);
...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1180u, l6);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1996u, l5);
...
static vader_box_t vader_midir_build_call(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 753u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if ((l5.tag == 376u || l5.tag == 373u || l5.tag == 374u || l5.tag == 375u)) {
                l6 = l5.payload.obj;
    ...
    vader_obj_header_init(_a3_obj, 817u);
    _a3_obj->f_span = l6;
    _a3_obj->f_dst = l12;
    _a3_obj->f_callee = l4;
    _a3_obj->f_args = l2;
...
static vader_box_t vader_midir_build_cast(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1338u, l3);
...
static vader_box_t vader_midir_build_cell_get(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1340u, l3);
...
static vader_box_t vader_midir_build_cell_new(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1339u, l3);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a6_obj, 220u);
                _a6_obj->f__0 = l8;
                _a6_obj->f__1 = l3;
                l9 = (void*) _a6_obj;
                ...
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 791u);
                l12 = (void*) _a7_arr;
                vader_array_t* _a8_arr = vader_array_new(69u, 0u, 13u, 790u);
                l13 = (void*) _a8_arr;
                vader_array_t* _a9_arr = vader_array_new(74u, 0u, 13u, 796u);
                l14 = (void*) _a9_arr;
...
static void* vader_midir_build_cfg_signature(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(11u, 0u, 1u, 171u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(8u, 0u, 0u, 165u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(6u, 0u, 12u, 163u);
    l6 = (void*) _a3_arr;
    l7 = l0;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l9 < l8)) {
                ...
                vader_array_push((vader_array_t*) l5, vader_box_string(165u, l13));
    ...
    vader_array_t* _a5_arr = vader_array_new(6u, 0u, 12u, 163u);
    l7 = (void*) _a5_arr;
    ...
    vader_obj_header_init(_a6_obj, 504u);
    _a6_obj->f_params = l3;
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1412u, l2);
...
static void vader_midir_build_expr_into(void* l0, vader_box_t l1, int32_t l2) {
    ...
    if (l1.tag == 754u) {
        l3 = l1.payload.obj;
        vader_midir_build_if(l0, l3, vader_box_i32(168u, l2));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 735u) {
        l3 = l1.payload.obj;
    ...
    if (l1.tag == 734u) {
        ...
        if (t0) {
            vader_midir_build_short_circuit(l0, l3, vader_box_i32(168u, l2));
            { vader_gc_top = gc_frame.prev; return; }
        }
        l4 = l1;
...
static vader_box_t vader_midir_build_extern_args(void* l0, void* l1, void* l2, vader_string_t l3) {
    ...
    vader_box_t l7 = vader_box_null(), l9 = vader_box_null(), l23 = vader_box_null(), l27 = vader_box_null();
    int32_t l8, l24;
    vader_string_t l10 = 0;
    ...
    vader_string_t t3 = 0;
    void* t4 = NULL;
    vader_box_t* gc_roots[5] = { &l7, &l9, &l23, &l27, &t1 };
    void** gc_raw_roots[10] = { &l0, &l1, &l2, &l4, &l12, &l20, &l25, &l26, &l28, &t4 };
    vader_string_t* gc_atom_roots[5] = { &l3, &l10, &l15, &l16, &t3 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 5u, 10u, gc_roots, gc_raw_roots, 0u, NULL, 5u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a0_arr;
        ...
        loop_8: {
            if ((l6 < l5)) {
                ...
                if (!(l7.tag == 753u)) {
                    ...
                    l13 = std_core_write_string_at(l12, l13, 1834u);
                    t2 = (l6 + INT64_C(1));
                    l14 = (uint64_t) (int64_t) t2;
                    l13 = std_core_write_unsigned(l12, l13, l14);
                    l13 = std_core_write_string_at(l12, l13, 146u);
                    l13 = std_core_write_string_at(l12, l13, l10);
                    l13 = std_core_write_string_at(l12, l13, 970u);
                ...
                if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) t4)->f_symbol)->f_kind != INT32_C(0)) {
                    ...
                    l21 = (size_t) (int64_t) INT64_C(0);
                    l21 = std_core_write_string_at(l20, l21, 1834u);
                    t2 = (l6 + INT64_C(1));
                    l22 = (uint64_t) (int64_t) t2;
                    l21 = std_core_write_unsigned(l20, l21, l22);
                    l21 = std_core_write_string_at(l20, l21, 146u);
                    l21 = std_core_write_string_at(l20, l21, l15);
                    l21 = std_core_write_string_at(l20, l21, 1001u);
                    l21 = std_core_write_string_at(l20, l21, l16);
                    l21 = std_core_write_string_at(l20, l21, 1054u);
                    t3 = std_core_finish_buffer(l20, l21);
                    vader_host_std_abort_panic(t3);
                } else {
                }
                t4 = l7.payload.obj;
                l23 = ((vader_struct_vader_lower_LoweredIdent_t*) t4)->f_type;
                l24 = vader_midir_fresh_tmp(l0, 1579u, l23);
                t4 = l7.payload.obj;
                ...
                vader_struct_vader_midir_InstrFnAddr_t* _a2_obj = (vader_struct_vader_midir_InstrFnAddr_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_InstrFnAddr_t));
                vader_obj_header_init(_a2_obj, 828u);
                _a2_obj->f_span = l25;
                _a2_obj->f_dst = l24;
                _a2_obj->f_fn_symbol = l26;
                _a2_obj->f_type = l27;
                l28 = (void*) _a2_obj;
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1550u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        if (l6.tag == 926u) {
            ...
            if (!(t3)) {
                l6 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_type;
                l3 = vader_midir_fresh_tmp(l0, 1868u, l6);
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1580u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
    ...
    if (l4.tag == 710u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1399u, l4);
        vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 168u);
        l8 = (void*) _a3_arr;
        ...
        _a4_obj->f_span = l9;
        _a4_obj->f_dst = vader_box_i32(168u, l3);
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1681u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(168u, t1);
        }
    }
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l7);
    ...
    if (!(l5.tag == 0u)) {
        if (!(((vader_struct_vader_lower_LoweredIf_t*) l1)->f_else_block.tag == 0u)) {
            ...
            ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l3);
            VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l8);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
...
static void* vader_midir_build_impl_table_from_vtable(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 600u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(8u, 0u, 0u, 165u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(6u, 0u, 12u, 163u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a3_arr;
        ...
        loop_23: {
            if ((l8 < l7)) {
                ...
                if ((l12 < l13)) {
                    ...
                    vader_obj_header_init(_a7_obj, 600u);
                ...
                vader_obj_header_init(_a8_obj, 600u);
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_275: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2422u);
                                ...
                                vader_obj_header_init(_a12_obj, 600u);
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1672u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1723u, l4);
        l3 = vader_box_i32(168u, t2);
    }
...
static void vader_midir_build_loop(void* l0, void* l1) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l4);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l5);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_midir_build_make_closure(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1353u, l3);
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l9);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        ...
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1750u, l4);
        l8 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_span;
        vader_struct_vader_midir_ConstBool_t* _a2_obj = (vader_struct_vader_midir_ConstBool_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ConstBool_t));
        vader_obj_header_init(_a2_obj, 798u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l10);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1750u, l4);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(168u, l11);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    t0 = vader_box_i32(168u, l6);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void vader_midir_build_stmt(void* l0, vader_box_t l1) {
    ...
    if ((l1.tag == 733u || l1.tag == 778u)) {
        vader_host_std_abort_panic(1842u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
static vader_box_t vader_midir_build_string_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1406u, l5);
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2108u, l7);
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2185u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2188u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2275u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2276u, l1, vader_box_obj(0u, NULL));
        l5 = vader_box_i32(168u, t2);
    }
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2382u, l5);
        l3 = vader_box_i32(168u, t2);
    }
...
static void* vader_midir_build_vtables_from_entries(void* l0, void* l1) {
    ...
    vader_array_t* _a6_arr = vader_array_new(8u, 0u, 0u, 165u);
    l3 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(15u, 0u, 4u, 175u);
    l4 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 168u);
    l11 = (void*) _a8_arr;
    ...
    l3 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(44u, 0u, 13u, 654u);
    l4 = (void*) _a10_arr;
    l11 = l0;
        ...
        loop_99: {
            if ((l6 < l5)) {
                ...
                if (l18.tag == 175u) {
                    ...
                    vader_obj_header_init(_a13_obj, 653u);
                    ...
                    vader_array_t* _a14_arr = vader_array_new(43u, 0u, 13u, 653u);
                    l21 = (void*) _a14_arr;
                    ...
                    vader_obj_header_init(_a15_obj, 653u);
                    ...
                    vader_obj_header_init(_a16_obj, 654u);
                    _a16_obj->f_key = l14;
...
static void vader_midir_cf_end(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 542u);
    l2 = (void*) _a0_obj;
    l3 = vader_midir_push_op_with_span(l0, vader_ref_box(l2), l1);
    l4 = ((vader_array_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes)->length;
    if (l4 == INT64_C(0)) {
...
static void vader_midir_cf_loop(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 612u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
    l3 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes;
    vader_struct_vader_midir_ScopeFrame_t* _a1_obj = (vader_struct_vader_midir_ScopeFrame_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ScopeFrame_t));
    vader_obj_header_init(_a1_obj, 845u);
    _a1_obj->f_kind = 1806u;
    _a1_obj->f_target_blk = l2;
    _a1_obj->f_opener_pc = l4;
    l5 = (void*) _a1_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l5));
...
static vader_box_t vader_midir_closure_header_type(vader_box_t l0) {
    ...
    if (l0.tag == 913u) {
        ...
        vader_array_t* _a0_arr = vader_array_new(131u, 0u, 13u, 1176u);
        l2 = (void*) _a0_arr;
        vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 163u);
        l3 = (void*) _a1_arr;
...
static void* vader_midir_compact_locals(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 196u);
    _a0_obj->f_value = t0;
    t1 = (void*) _a0_obj;
    l1 = vader_ref_box(t1);
    vader_array_t* _a1_arr = vader_array_new(6u, 1u, 12u, 163u);
    ...
    vader_obj_header_init(_a3_obj, 181u);
    _a3_obj->f_value = t1;
    t1 = (void*) _a3_obj;
    l4 = vader_ref_box(t1);
                ...
                l8 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_82: {
                        if ((l8 < l7)) {
                            ...
                            vader_obj_header_init(_a8_obj, 247u);
                            _a8_obj->f_cap_0 = l1;
                            _a8_obj->f_cap_1 = l4;
                            t1 = (void*) _a8_obj;
    ...
    l5 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_params)->length;
    {
        loop_169: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(163u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l20 = true;
                } else {
    ...
    vader_array_t* _a14_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a14_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    vader_array_t* _a15_arr = vader_array_repeat((vader_array_t*) l2, (size_t) l3);
    l2 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(71u, 0u, 13u, 792u);
    l6 = (void*) _a16_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_220: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(163u, ((uint8_t*) _a18_slotarr->buf->slots)[_a18_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l14 = -(INT32_C(1));
    ...
    vader_array_t* _a20_arr = vader_array_new(73u, 0u, 13u, 794u);
    l9 = (void*) _a20_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_282: {
            if ((l5 < l3)) {
                ...
                vader_obj_header_init(_a24_obj, 794u);
                _a24_obj->f_name = l22;
    ...
    vader_array_t* _a25_arr = vader_array_new(68u, 0u, 13u, 789u);
    l12 = (void*) _a25_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_339: {
            if ((l5 < l3)) {
                ...
                vader_array_t* _a28_arr = vader_array_new(130u, 0u, 13u, 1153u);
                l23 = (void*) _a28_arr;
                ...
                vader_obj_header_init(_a32_obj, 789u);
                _a32_obj->f_id = l21;
    ...
    vader_obj_header_init(_a33_obj, 791u);
...
static void* vader_midir_compute_carried_across_loop_headers(void* l0, void* l1) {
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l9 >= l8)) {
                ...
                vader_obj_header_init(_a8_obj, 207u);
                _a8_obj->f__0 = l10;
                _a8_obj->f__1 = l5;
                t0 = (void*) _a8_obj;
                ...
                l12 = l13.payload.obj;
                vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 168u);
                l14 = (void*) _a9_arr;
                vader_array_t* _a10_arr = vader_array_new(6u, 0u, 12u, 163u);
                l15 = (void*) _a10_arr;
                vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 168u);
                l16 = (void*) _a11_arr;
                ...
                vader_obj_header_init(_a13_obj, 373u);
                _a13_obj->f_inner = t0;
                l17 = (void*) _a13_obj;
                l18 = l12;
    ...
    vader_array_t* _a19_arr = vader_array_new(9u, 0u, 7u, 168u);
    l3 = (void*) _a19_arr;
    l4 = l2;
...
static void* vader_midir_compute_escaping(void* l0, void* l1) {
    ...
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 168u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(16u, 0u, 0u, 176u);
    l4 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 168u);
    l5 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a8_obj, 279u);
    _a8_obj->f_ekeys = l3;
    _a8_obj->f_evals = l4;
    _a8_obj->f_index = l5;
    ...
    vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(16u, 0u, 0u, 176u);
    l5 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a12_obj, 279u);
    _a12_obj->f_ekeys = l4;
    _a12_obj->f_evals = l5;
    _a12_obj->f_index = l6;
    _a12_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 168u);
    l5 = (void*) _a21_arr;
    l6 = l2;
    ...
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 168u);
    l5 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(6u, 0u, 12u, 163u);
    l6 = (void*) _a27_arr;
    vader_array_t* _a28_arr = vader_array_new(9u, 0u, 7u, 168u);
    l9 = (void*) _a28_arr;
    ...
    vader_obj_header_init(_a29_obj, 306u);
    _a29_obj->f_ekeys = l5;
    _a29_obj->f_evals = l6;
    _a29_obj->f_index = l9;
    ...
    vader_obj_header_init(_a30_obj, 373u);
    _a30_obj->f_inner = t0;
    l5 = (void*) _a30_obj;
    l6 = l1;
    l9 = ((vader_struct_std_collections_MutableMap__i32__bool_t*) ((vader_struct_std_collections_MutableSet__i32_t*) l6)->f_inner)->f_ekeys;
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(19u, 0u, 13u, 373u);
    t0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_repeat((vader_array_t*) t0, (size_t) l1);
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(19u, 0u, 13u, 373u);
    t0 = (void*) _a2_arr;
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 168u);
                l6 = (void*) _a5_arr;
                vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 163u);
                l7 = (void*) _a6_arr;
                vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 168u);
                l8 = (void*) _a7_arr;
                ...
                vader_obj_header_init(_a8_obj, 306u);
                _a8_obj->f_ekeys = l6;
                _a8_obj->f_evals = l7;
                _a8_obj->f_index = l8;
                _a8_obj->f_mask = (size_t) (int64_t) INT64_C(0);
                ...
                vader_obj_header_init(_a10_obj, 191u);
                _a10_obj->f_value = t0;
                t0 = (void*) _a10_obj;
                l9 = vader_ref_box(t0);
                vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 168u);
                l10 = (void*) _a11_arr;
                vader_array_t* _a12_arr = vader_array_new(6u, 0u, 12u, 163u);
                l11 = (void*) _a12_arr;
                vader_array_t* _a13_arr = vader_array_new(9u, 0u, 7u, 168u);
                l12 = (void*) _a13_arr;
                ...
                vader_obj_header_init(_a14_obj, 306u);
                ...
                vader_obj_header_init(_a15_obj, 373u);
                _a15_obj->f_inner = t0;
                t0 = (void*) _a15_obj;
                ...
                vader_obj_header_init(_a16_obj, 191u);
                _a16_obj->f_value = t0;
                t0 = (void*) _a16_obj;
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_62: {
                        if ((l16 < l15)) {
                            ...
                            vader_obj_header_init(_a18_obj, 249u);
                ...
                vader_obj_header_init(_a20_obj, 250u);
    ...
    vader_obj_header_init(_a25_obj, 251u);
    t0 = (void*) _a25_obj;
    ...
    vader_obj_header_init(_a27_obj, 252u);
    t0 = (void*) _a27_obj;
    ...
    vader_array_t* _a29_arr = vader_array_new(9u, 0u, 7u, 168u);
    l8 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(6u, 0u, 12u, 163u);
    l10 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 168u);
    l11 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a32_obj, 306u);
    _a32_obj->f_ekeys = l8;
    ...
    vader_obj_header_init(_a33_obj, 373u);
    _a33_obj->f_inner = t0;
    l8 = (void*) _a33_obj;
    vader_array_t* _a34_arr = vader_array_new(9u, 0u, 7u, 168u);
    l10 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(6u, 0u, 12u, 163u);
    l11 = (void*) _a35_arr;
    vader_array_t* _a36_arr = vader_array_new(9u, 0u, 7u, 168u);
    l12 = (void*) _a36_arr;
    ...
    vader_obj_header_init(_a37_obj, 306u);
    ...
    vader_obj_header_init(_a38_obj, 373u);
    _a38_obj->f_inner = t0;
    l10 = (void*) _a38_obj;
    l26 = true;
    {
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    vader_obj_header_init(_a8_obj, 258u);
    t0 = (void*) _a8_obj;
    vader_fn_t* _a9_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    ...
    vader_array_t* _a16_arr = vader_array_new(9u, 0u, 7u, 168u);
    l3 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(6u, 1u, 12u, 163u);
    ...
    vader_array_t* _a19_arr = vader_array_new(9u, 1u, 7u, 168u);
...
static void* vader_midir_convert_data_pool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(120u, 0u, 13u, 1079u);
    l1 = (void*) _a0_arr;
    l2 = l0;
    l3 = ((vader_array_t*) l2)->length;
    l4 = (size_t) (int64_t) INT64_C(0);
        ...
        loop_9: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 782u) {
                    ...
                    vader_obj_header_init(_a2_obj, 505u);
                    _a2_obj->f_values = l7;
                ...
                if (l5.tag == 781u) {
                    l10 = l5.payload.obj;
                    vader_array_t* _a3_arr = vader_array_new(14u, 0u, 4u, 174u);
                    l11 = (void*) _a3_arr;
                    ...
                    vader_obj_header_init(_a5_obj, 501u);
                    _a5_obj->f_kind = l16;
                    _a5_obj->f_items = l11;
                ...
                if (l5.tag == 699u) {
                    l19 = l5.payload.obj;
                    vader_array_t* _a6_arr = vader_array_new(122u, 0u, 13u, 1085u);
                    l20 = (void*) _a6_arr;
                    ...
                    vader_obj_header_init(_a8_obj, 492u);
...
static vader_box_t vader_midir_convert_function(void* l0, void* l1) {
    ...
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(9u, 0u, 7u, 168u);
    l7 = (void*) _a4_arr;
    ...
    vader_obj_header_init(_a5_obj, 307u);
    _a5_obj->f_ekeys = l5;
    _a5_obj->f_evals = l6;
    _a5_obj->f_index = l7;
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l4)->f_current = vader_box_i32(168u, l10);
...
static void* vader_midir_count_uses(void* l0) {
    ...
    vader_obj_header_init(_a3_obj, 307u);
    _a3_obj->f_ekeys = l1;
    _a3_obj->f_evals = l2;
    _a3_obj->f_index = l3;
    _a3_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a5_obj, 259u);
    _a5_obj->f_cap_0 = l4;
    t0 = (void*) _a5_obj;
...
static void* vader_midir_die_once(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(68u, 0u, 13u, 789u);
    l2 = (void*) _a0_arr;
    l3 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a4_obj, 791u);
...
static vader_box_t vader_midir_dst_of(vader_box_t l0) {
    ...
    if (l0.tag == 822u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 832u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 815u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrBinOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 837u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 826u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 809u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 810u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 814u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 833u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrStringSlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 834u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrStructNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 811u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 835u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 836u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrTypeConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 818u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 820u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 819u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 831u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 829u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrFnRef_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 828u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrFnAddr_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 823u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrDataConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 816u) {
        t0 = l0.payload.obj;
...
static int32_t vader_midir_emit_block_contents(void* l0, int32_t l1, int32_t l2) {
    ...
    if (l6.tag == 848u) {
        ...
        if ((t5 > INT64_C(0))) {
            ...
            vader_obj_header_init(_a7_obj, 619u);
            l9 = (void*) _a7_obj;
            l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l9), l15);
            { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
        ...
        vader_obj_header_init(_a8_obj, 619u);
        l9 = (void*) _a8_obj;
        l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l9), l15);
        { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
    ...
    if (l6.tag == 849u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a9_obj, 651u);
            _a9_obj->f_reason = t6;
            l9 = (void*) _a9_obj;
            ...
            vader_obj_header_init(_a10_obj, 619u);
            l9 = (void*) _a10_obj;
...
void* vader_midir_emit_bytecode_from_cfg(void* l0, vader_string_t l1, void* l2) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a2_obj, 204u);
                _a2_obj->f__0 = l9;
                _a2_obj->f__1 = l4;
                t1 = (void*) _a2_obj;
                l10 = ((vader_struct___Tuple_2_62f1db0066dc3143_t*) t1)->f__1;
    ...
    vader_array_t* _a6_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a6_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_260: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a13_obj, 204u);
                _a13_obj->f__0 = l9;
                _a13_obj->f__1 = l5;
                t1 = (void*) _a13_obj;
    ...
    if (t4) {
        ...
        vader_array_t* _a31_arr = vader_array_new(8u, 0u, 0u, 165u);
        l4 = (void*) _a31_arr;
        vader_array_t* _a32_arr = vader_array_new(6u, 0u, 12u, 163u);
        l5 = (void*) _a32_arr;
        vader_array_t* _a33_arr = vader_array_new(9u, 0u, 7u, 168u);
        l6 = (void*) _a33_arr;
        ...
        vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 168u);
        l5 = (void*) _a37_arr;
    ...
    vader_obj_header_init(_a40_obj, 527u);
    _a40_obj->f_name = l1;
    _a40_obj->f_types = l4;
...
static void vader_midir_emit_cfg_function_body(void* l0, int32_t l1, void* l2, void* l3, bool l4) {
    ...
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 168u);
    l24 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(6u, 0u, 12u, 163u);
    l25 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 168u);
    l26 = (void*) _a9_arr;
    ...
    vader_obj_header_init(_a10_obj, 306u);
    ...
    vader_obj_header_init(_a11_obj, 373u);
    _a11_obj->f_inner = t2;
    l24 = (void*) _a11_obj;
...
static int32_t vader_midir_emit_const(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l4 = vader_midir_fresh_tmp(l0, 1750u, l1);
...
static void vader_midir_emit_const_instr(void* l0, void* l1, int64_t l2) {
    ...
    if (l3.tag == 801u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a1_obj, 564u);
        ...
        if (l3.tag == 800u) {
            ...
            vader_obj_header_init(_a2_obj, 545u);
            _a2_obj->f_value = t4;
            l4 = (void*) _a2_obj;
            l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l4), l5);
            ...
            if (l3.tag == 798u) {
                ...
                if (l3.tag == 799u) {
                    ...
                    vader_obj_header_init(_a4_obj, 532u);
                    ...
                    if (l3.tag == 802u) {
                        ...
                        vader_obj_header_init(_a5_obj, 615u);
                        l4 = (void*) _a5_obj;
                        l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
                        vader_midir_push_emit(l0, vader_ref_box(l4), l5);
                    } else {
                        if (l3.tag == 803u) {
                            ...
                            vader_obj_header_init(_a7_obj, 630u);
                            _a7_obj->f_index = t5;
                            l4 = (void*) _a7_obj;
                            l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
                            vader_midir_push_emit(l0, vader_ref_box(l4), l5);
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    vader_string_t* gc_atom_roots[6] = { &l16, &l17, &l21, &l22, &l23, &t3 };
    ...
    if (l1.tag == 816u) {
        ...
        if (((vader_struct_vader_midir_InstrCall_t*) l3)->f_dst.tag == 168u) {
        ...
        if (l7.tag == 168u) {
            ...
            vader_obj_header_init(_a6_obj, 529u);
            ...
            if (l7.tag == 168u) {
                ...
                vader_obj_header_init(_a7_obj, 529u);
                ...
                if (l7.tag == 168u) {
                    ...
                    vader_obj_header_init(_a8_obj, 530u);
                    _a8_obj->f_index = t2;
                    l5 = (void*) _a8_obj;
                    l10 = ((vader_struct_vader_midir_InstrCall_t*) l3)->f_span;
                    vader_midir_push_emit(l0, vader_ref_box(l5), l10);
                    ...
                    if (l7.tag == 168u) {
                        ...
                        vader_obj_header_init(_a9_obj, 530u);
                        _a9_obj->f_index = t2;
                        l5 = (void*) _a9_obj;
                        l10 = ((vader_struct_vader_midir_InstrCall_t*) l3)->f_span;
                        vader_midir_push_emit(l0, vader_ref_box(l5), l10);
                        ...
                        l6 = vader_host_std_core_byte_len(l16);
                        l11 = vader_host_std_core_byte_len(l17);
                        t0 = (l6 + l11);
                        l6 = (size_t) (int64_t) t0;
                        l5 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(117) + l6));
                        l6 = (size_t) (int64_t) INT64_C(0);
                        l6 = std_core_write_string_at(l5, l6, 1838u);
                        l6 = std_core_write_string_at(l5, l6, l16);
                        l6 = std_core_write_string_at(l5, l6, 274u);
                        ...
                        l6 = std_core_write_string_at(l5, l6, 341u);
                        l6 = std_core_write_string_at(l5, l6, l17);
                        l6 = std_core_write_string_at(l5, l6, 286u);
    ...
    if (l1.tag == 817u) {
        ...
        vader_obj_header_init(_a13_obj, 531u);
    ...
    if (l1.tag == 829u) {
        ...
        if (l7.tag == 168u) {
            ...
            vader_obj_header_init(_a14_obj, 558u);
    ...
    if (l1.tag == 828u) {
        l3 = l1.payload.obj;
        l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project)->f_function_index_by_symbol_id;
        l4 = ((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_fn_symbol)->f_id;
        l7 = std_collections_get__i32__i32(l5, l4);
        if (l7.tag == 168u) {
            t2 = ((int32_t) l7.payload.i);
            ...
            vader_obj_header_init(_a15_obj, 557u);
            _a15_obj->f_function_index = t2;
            l5 = (void*) _a15_obj;
            l10 = ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l5), l10);
        } else {
            l16 = ((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_fn_symbol)->f_name;
            l6 = vader_host_std_core_byte_len(l16);
            l5 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(102) + l6));
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1840u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 274u);
            t2 = ((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_fn_symbol)->f_id;
            l18 = ((int64_t) (int32_t) t2);
            l6 = std_core_write_int(l5, l6, l18);
            l6 = std_core_write_string_at(l5, l6, 347u);
            t3 = std_core_finish_buffer(l5, l6);
            vader_host_std_abort_panic(t3);
        }
        l4 = ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_dst;
        l3 = ((vader_struct_vader_midir_InstrFnAddr_t*) l3)->f_span;
        vader_midir_emit_result(l0, l2, l4, l3);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 838u) {
            ...
            loop_761: {
                if ((l11 < l6)) {
                    if (l11 == INT64_C(0)) {
                        ...
                        l4 = ((int32_t*) _a16_slotarr->buf->slots)[_a16_slotarr->offset + (size_t) l11];
                        l5 = ((vader_struct_vader_midir_InstrVirtualCall_t*) l3)->f_span;
                        vader_midir_emit_first_get(l0, l2, l4, l5);
                    } else {
                        vader_array_t* _a17_slotarr = ((vader_array_t*) ((vader_struct_vader_midir_InstrVirtualCall_t*) l3)->f_args);
                        if (_a17_slotarr->buf != NULL && _a17_slotarr->buf->header.forward != NULL) { _a17_slotarr->buf = vader_array_buf_forward(_a17_slotarr->buf); }
                        if ((size_t) l11 >= _a17_slotarr->length) { vader_trap("array index out of bounds"); }
                        l15 = ((int32_t*) _a17_slotarr->buf->slots)[_a17_slotarr->offset + (size_t) l11];
        ...
        vader_obj_header_init(_a18_obj, 652u);
        _a18_obj->f_parameter_count = l4;
        _a18_obj->f_vtable_key = l16;
        l5 = (void*) _a18_obj;
        l10 = ((vader_struct_vader_midir_InstrVirtualCall_t*) l3)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l5), l10);
    ...
    if (l1.tag == 826u) {
        ...
        if (_a19_slotarr->buf != NULL && _a19_slotarr->buf->header.forward != NULL) { _a19_slotarr->buf = vader_array_buf_forward(_a19_slotarr->buf); }
        if ((size_t) l6 >= _a19_slotarr->length) { vader_trap("array index out of bounds"); }
        l5 = vader_array_ref_load_obj(_a19_slotarr->buf, _a19_slotarr->offset + (size_t) l6);
        l7 = ((vader_struct_vader_midir_CFGLocal_t*) l5)->f_type;
        l10 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project;
        l4 = vader_bytecode_intern_type(l7, l10);
        ...
        vader_midir_emit_first_get(l0, l2, l15, l10);
        l10 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project;
        l16 = ((vader_struct_vader_midir_InstrFieldGet_t*) l3)->f_field;
        l20 = vader_midir_find_struct_field_index(l10, l4, l16);
        if (l20.tag == 0u) {
            l16 = ((vader_struct_vader_midir_InstrFieldGet_t*) l3)->f_field;
            l17 = vader_types_display_type(l7);
            l21 = vader_vt_Display__to_string(vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldGet_t*) l3)->f_target));
            l22 = ((vader_struct_vader_midir_CFGLocal_t*) l5)->f_name;
            l23 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_11(1835u, l16, 1007u, l17, 927u, l21, 92u, l22, 1042u, l23, 284u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        ...
        l24 = false;
        if (!(l19)) {
            l24 = vader_midir_try_fuse_local_field(l0, l4, l15);
        } else {
        }
        if (!(l24)) {
            ...
            vader_obj_header_init(_a20_obj, 634u);
            _a20_obj->f_type_id = l4;
            _a20_obj->f_field_index = l15;
            l5 = (void*) _a20_obj;
            l10 = ((vader_struct_vader_midir_InstrFieldGet_t*) l3)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l5), l10);
        } else {
        ...
        if (t5) {
            ...
            vader_obj_header_init(_a21_obj, 616u);
    ...
    if (l1.tag == 827u) {
        ...
        if (_a22_slotarr->buf != NULL && _a22_slotarr->buf->header.forward != NULL) { _a22_slotarr->buf = vader_array_buf_forward(_a22_slotarr->buf); }
        if ((size_t) l6 >= _a22_slotarr->length) { vader_trap("array index out of bounds"); }
        t1 = vader_array_ref_load_obj(_a22_slotarr->buf, _a22_slotarr->offset + (size_t) l6);
        l7 = ((vader_struct_vader_midir_CFGLocal_t*) t1)->f_type;
        l5 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project;
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1835u, l16, 1007u, l17, 963u, l21, 285u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
        ...
        vader_obj_header_init(_a23_obj, 636u);
        _a23_obj->f_type_id = l4;
        _a23_obj->f_field_index = l15;
    ...
    if (l1.tag == 809u) {
        ...
        if (_a24_slotarr->buf != NULL && _a24_slotarr->buf->header.forward != NULL) { _a24_slotarr->buf = vader_array_buf_forward(_a24_slotarr->buf); }
        if ((size_t) l6 >= _a24_slotarr->length) { vader_trap("array index out of bounds"); }
        t1 = vader_array_ref_load_obj(_a24_slotarr->buf, _a24_slotarr->offset + (size_t) l6);
        l7 = ((vader_struct_vader_midir_CFGLocal_t*) t1)->f_type;
        l5 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project;
        l4 = vader_bytecode_intern_type(l7, l5);
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a25_obj, 483u);
            ...
            if (t5) {
                ...
                vader_obj_header_init(_a26_obj, 616u);
    ...
    if (l1.tag == 813u) {
        ...
        l6 = (size_t) (int64_t) t0;
        vader_array_t* _a27_slotarr = ((vader_array_t*) l5);
        if (_a27_slotarr->buf != NULL && _a27_slotarr->buf->header.forward != NULL) { _a27_slotarr->buf = vader_array_buf_forward(_a27_slotarr->buf); }
        if ((size_t) l6 >= _a27_slotarr->length) { vader_trap("array index out of bounds"); }
        t1 = vader_array_ref_load_obj(_a27_slotarr->buf, _a27_slotarr->offset + (size_t) l6);
        l7 = ((vader_struct_vader_midir_CFGLocal_t*) t1)->f_type;
        l5 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_project;
        l4 = vader_bytecode_intern_type(l7, l5);
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a28_obj, 490u);
    ...
    if (l1.tag == 810u) {
        ...
        vader_obj_header_init(_a29_obj, 484u);
    ...
    if (l1.tag == 812u) {
        ...
        l6 = (size_t) (int64_t) t0;
        vader_array_t* _a30_slotarr = ((vader_array_t*) l5);
        if (_a30_slotarr->buf != NULL && _a30_slotarr->buf->header.forward != NULL) { _a30_slotarr->buf = vader_array_buf_forward(_a30_slotarr->buf); }
        if ((size_t) l6 >= _a30_slotarr->length) { vader_trap("array index out of bounds"); }
        t1 = vader_array_ref_load_obj(_a30_slotarr->buf, _a30_slotarr->offset + (size_t) l6);
        l7 = ((vader_struct_vader_midir_CFGLocal_t*) t1)->f_type;
        ...
        vader_obj_header_init(_a31_obj, 486u);
    ...
    if (l1.tag == 833u) {
        ...
        vader_obj_header_init(_a33_obj, 633u);
        l5 = (void*) _a33_obj;
    ...
    if (l1.tag == 834u) {
            ...
            loop_1504: {
                if ((l11 < l6)) {
                    if (l11 == INT64_C(0)) {
                        ...
                        l15 = ((int32_t*) _a34_slotarr->buf->slots)[_a34_slotarr->offset + (size_t) l11];
                        l5 = ((vader_struct_vader_midir_InstrStructNew_t*) l3)->f_span;
                        vader_midir_emit_first_get(l0, l2, l15, l5);
                    } else {
                        vader_array_t* _a35_slotarr = ((vader_array_t*) ((vader_struct_vader_midir_InstrStructNew_t*) l3)->f_fields);
                        if (_a35_slotarr->buf != NULL && _a35_slotarr->buf->header.forward != NULL) { _a35_slotarr->buf = vader_array_buf_forward(_a35_slotarr->buf); }
                        if ((size_t) l11 >= _a35_slotarr->length) { vader_trap("array index out of bounds"); }
                        l25 = ((int32_t*) _a35_slotarr->buf->slots)[_a35_slotarr->offset + (size_t) l11];
                        l10 = ((vader_struct_vader_midir_InstrStructNew_t*) l3)->f_span;
                        vader_midir_emit_get(l0, l25, l10);
                    }
                    t0 = (l11 + INT64_C(1));
                    l11 = (size_t) (int64_t) t0;
                    goto loop_1504;
        ...
        vader_obj_header_init(_a36_obj, 635u);
    ...
    if (l1.tag == 811u) {
            ...
            loop_1589: {
                if ((l11 < l6)) {
                    if (l11 == INT64_C(0)) {
                        ...
                        l15 = ((int32_t*) _a37_slotarr->buf->slots)[_a37_slotarr->offset + (size_t) l11];
                        l5 = ((vader_struct_vader_midir_InstrArrayNew_t*) l3)->f_span;
                        vader_midir_emit_first_get(l0, l2, l15, l5);
                    } else {
                        vader_array_t* _a38_slotarr = ((vader_array_t*) ((vader_struct_vader_midir_InstrArrayNew_t*) l3)->f_elements);
                        if (_a38_slotarr->buf != NULL && _a38_slotarr->buf->header.forward != NULL) { _a38_slotarr->buf = vader_array_buf_forward(_a38_slotarr->buf); }
                        if ((size_t) l11 >= _a38_slotarr->length) { vader_trap("array index out of bounds"); }
                        l25 = ((int32_t*) _a38_slotarr->buf->slots)[_a38_slotarr->offset + (size_t) l11];
        ...
        vader_obj_header_init(_a39_obj, 485u);
        _a39_obj->f_type_id = l4;
        _a39_obj->f_length = l15;
        l5 = (void*) _a39_obj;
        l10 = ((vader_struct_vader_midir_InstrArrayNew_t*) l3)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l5), l10);
    ...
    if (l1.tag == 823u) {
        ...
        vader_obj_header_init(_a40_obj, 534u);
    ...
    if (l1.tag == 835u) {
        ...
        vader_obj_header_init(_a41_obj, 637u);
    ...
    if (l1.tag == 836u) {
        ...
        vader_obj_header_init(_a42_obj, 638u);
    ...
    if (l1.tag == 818u) {
        ...
        l6 = (size_t) (int64_t) t0;
        vader_array_t* _a43_slotarr = ((vader_array_t*) l5);
        if (_a43_slotarr->buf != NULL && _a43_slotarr->buf->header.forward != NULL) { _a43_slotarr->buf = vader_array_buf_forward(_a43_slotarr->buf); }
        if ((size_t) l6 >= _a43_slotarr->length) { vader_trap("array index out of bounds"); }
        t1 = vader_array_ref_load_obj(_a43_slotarr->buf, _a43_slotarr->offset + (size_t) l6);
        l8 = vader_bytecode_val_type_of_type(((vader_struct_vader_midir_CFGLocal_t*) t1)->f_type);
        ...
        if (l4 != l15) {
            ...
            if (l7.tag == 0u) {
                ...
                vader_obj_header_init(_a44_obj, 616u);
                ...
                if (t5) {
                    ...
                    vader_obj_header_init(_a45_obj, 533u);
                    _a45_obj->f_from_name = l16;
                    _a45_obj->f_target = l8;
                    l5 = (void*) _a45_obj;
                    l10 = ((vader_struct_vader_midir_InstrCast_t*) l3)->f_span;
                    vader_midir_push_emit(l0, vader_ref_box(l5), l10);
                } else {
                    ...
                    vader_obj_header_init(_a46_obj, 616u);
    ...
    if (l1.tag == 820u) {
        ...
        vader_obj_header_init(_a47_obj, 635u);
    ...
    if (l1.tag == 819u) {
        ...
        l24 = false;
        if (!(l19)) {
            l24 = vader_midir_try_fuse_local_field(l0, l4, INT32_C(0));
        } else {
        }
        if (!(l24)) {
            ...
            vader_obj_header_init(_a48_obj, 634u);
    ...
    if (l1.tag == 821u) {
        ...
        vader_obj_header_init(_a49_obj, 636u);
    ...
    if (l1.tag == 831u) {
        ...
        if (l7.tag == 168u) {
            ...
            vader_obj_header_init(_a50_obj, 613u);
            ...
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1839u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 274u);
    ...
    if (l1.tag == 830u) {
            ...
            loop_2150: {
                if ((l11 < l6)) {
                    if (l11 == INT64_C(0)) {
                        ...
                        l4 = ((int32_t*) _a51_slotarr->buf->slots)[_a51_slotarr->offset + (size_t) l11];
                        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
                        vader_midir_emit_first_get(l0, l2, l4, l5);
                    } else {
                        vader_array_t* _a52_slotarr = ((vader_array_t*) ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_args);
                        if (_a52_slotarr->buf != NULL && _a52_slotarr->buf->header.forward != NULL) { _a52_slotarr->buf = vader_array_buf_forward(_a52_slotarr->buf); }
                        if ((size_t) l11 >= _a52_slotarr->length) { vader_trap("array index out of bounds"); }
                        l15 = ((int32_t*) _a52_slotarr->buf->slots)[_a52_slotarr->offset + (size_t) l11];
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1837u, l16, 963u, l17, 287u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
    ...
    if (l1.tag == 825u) {
        ...
        vader_obj_header_init(_a53_obj, 537u);
        l5 = (void*) _a53_obj;
    ...
    if (l1.tag == 824u) {
        ...
        vader_obj_header_init(_a54_obj, 536u);
        _a54_obj->f_count = t2;
        l5 = (void*) _a54_obj;
    ...
    vader_host_std_abort_panic(1836u);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_midir_find_loop_exits(void* l0, void* l1, void* l2) {
    ...
    vader_obj_header_init(_a3_obj, 277u);
    _a3_obj->f_ekeys = l3;
    _a3_obj->f_evals = l4;
    _a3_obj->f_index = l5;
    _a3_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a6_obj, 207u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                l10 = (void*) _a6_obj;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_20: {
                if ((l6 < l4)) {
                    ...
                    if (t2 == l2) {
                        t3 = vader_box_i64(175u, (int64_t)(uint64_t) l6);
                        return t3;
                    }
                    t0 = (l6 + INT64_C(1));
                    l6 = (size_t) (int64_t) t0;
...
static vader_box_t vader_midir_first_stack_operand(vader_box_t l0) {
    ...
    if (l0.tag == 832u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrMove_t*) t1)->f_src);
        return t0;
    }
    if (l0.tag == 815u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrBinOp_t*) t1)->f_lhs);
        return t0;
    }
    if (l0.tag == 837u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrUnOp_t*) t1)->f_operand);
        return t0;
    }
    if (l0.tag == 816u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 817u) {
        ...
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l1)->f_callee);
        return t0;
    }
    if (l0.tag == 838u) {
        l1 = l0.payload.obj;
        ...
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l1)->f_receiver);
        return t0;
    }
    if (l0.tag == 826u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 827u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldSet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 809u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 813u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 810u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayLen_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 812u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayPush_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 814u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 833u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrStringSlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 834u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 835u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 818u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCast_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 820u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellNew_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 819u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellGet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 821u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellSet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 831u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t1)->f_env);
        return t0;
    }
    if (l0.tag == 830u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 825u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_InstrDeferPush_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 824u) {
        t0 = vader_box_obj(0u, NULL);
...
static vader_box_t vader_midir_first_terminator_operand(vader_box_t l0) {
    ...
    if (l0.tag == 847u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(168u, ((vader_struct_vader_midir_TermCondBranch_t*) t1)->f_cond);
        return t0;
    }
    if (l0.tag == 848u) {
        t1 = l0.payload.obj;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    l4 = 0u;
    l5 = 0u;
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 416u) {
        l6 = ((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.payload.obj;
        l1 = vader_midir_extern_symbol_name(l6);
        l2 = toolchain_ast_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1514u);
        l3 = toolchain_ast_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1500u);
        l4 = vader_midir_c_header_of(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators);
        l5 = vader_midir_extern_library_name(l6);
    } else {
    }
...
static void* vader_midir_fold_moves_in_block(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(130u, 0u, 13u, 1153u);
    l3 = (void*) _a0_arr;
        ...
        loop_8: {
            if ((l5 < l4)) {
                ...
                if (l6.tag == 832u) {
                    ...
                    vader_obj_header_init(_a2_obj, 195u);
                    _a2_obj->f_value = ((vader_struct_vader_midir_InstrMove_t*) l8)->f_dst;
                    t2 = (void*) _a2_obj;
                    l16 = vader_ref_box(t2);
                    l17 = -(INT64_C(1));
                    l18 = false;
                    vader_array_t* _a3_arr = vader_array_new(6u, 1u, 12u, 163u);
                    ...
                    vader_obj_header_init(_a4_obj, 181u);
                    _a4_obj->f_value = t2;
                    t2 = (void*) _a4_obj;
                                ...
                                if (l23.tag == 168u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            vader_obj_header_init(_a7_obj, 248u);
                                            _a7_obj->f_cap_0 = l16;
                                            _a7_obj->f_cap_1 = l19;
                                            t2 = (void*) _a7_obj;
                                            ...
                                            t4 = vader_box_bool(163u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l34]);
                                            t1 = t4.payload.b;
                                            if (t1) {
                                                l18 = true;
                                            } else {
                                    ...
                                    vader_obj_header_init(_a11_obj, 248u);
                                    ...
                                    t4 = vader_box_bool(163u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l34]);
                                    t1 = t4.payload.b;
                                    if (t1) {
                                        l18 = true;
                                    } else {
...
static void vader_midir_for_each_read_in_terminator(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 847u) {
        ...
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_TermCondBranch_t*) t0)->f_cond));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 848u) {
        l2 = l0.payload.obj;
...
static void vader_midir_for_each_read_local(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 832u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a0_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_src));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 815u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a1_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a1_fnobj->code)(_a1_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_lhs));
        vader_fn_t* _a2_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_rhs));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 837u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a3_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a3_fnobj->code)(_a3_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_operand));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 816u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_61: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a5_fnobj->code)(_a5_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
    ...
    if (l0.tag == 817u) {
        ...
        ((vader_fn_erased_sig_1_t) _a6_fnobj->code)(_a6_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l2)->f_callee));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_98: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a8_fnobj->code)(_a8_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_98;
                } else {
    ...
    if (l0.tag == 838u) {
        ...
        ((vader_fn_erased_sig_1_t) _a9_fnobj->code)(_a9_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l2)->f_receiver));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_135: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a11_fnobj->code)(_a11_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_135;
                } else {
    ...
    if (l0.tag == 826u) {
        ...
        ((vader_fn_erased_sig_1_t) _a12_fnobj->code)(_a12_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 827u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a13_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a13_fnobj->code)(_a13_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_target));
        vader_fn_t* _a14_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 809u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a15_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a15_fnobj->code)(_a15_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_target));
        vader_fn_t* _a16_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a16_fnobj->code)(_a16_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_index));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 813u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a17_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a17_fnobj->code)(_a17_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_target));
        vader_fn_t* _a18_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_index));
        vader_fn_t* _a19_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a19_fnobj->code)(_a19_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 810u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a20_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a20_fnobj->code)(_a20_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 812u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a21_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a21_fnobj->code)(_a21_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_target));
        vader_fn_t* _a22_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a22_fnobj->code)(_a22_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 814u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a23_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a23_fnobj->code)(_a23_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_target));
        vader_fn_t* _a24_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a24_fnobj->code)(_a24_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_lo));
        vader_fn_t* _a25_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a25_fnobj->code)(_a25_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 833u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a26_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a26_fnobj->code)(_a26_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_target));
        vader_fn_t* _a27_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a27_fnobj->code)(_a27_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_lo));
        vader_fn_t* _a28_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a28_fnobj->code)(_a28_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 834u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_281: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a30_fnobj->code)(_a30_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_281;
                } else {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_314: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a32_fnobj->code)(_a32_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_314;
                } else {
    ...
    if (l0.tag == 835u) {
        ...
        ((vader_fn_erased_sig_1_t) _a33_fnobj->code)(_a33_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 836u) {
        { vader_gc_top = gc_frame.prev; return; }
    ...
    if (l0.tag == 818u) {
        ...
        ((vader_fn_erased_sig_1_t) _a34_fnobj->code)(_a34_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 820u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a35_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a35_fnobj->code)(_a35_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 819u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a36_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a36_fnobj->code)(_a36_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_cell));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 821u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a37_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a37_fnobj->code)(_a37_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_cell));
        vader_fn_t* _a38_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a38_fnobj->code)(_a38_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 831u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a39_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a39_fnobj->code)(_a39_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_env));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 830u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_421: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a41_fnobj->code)(_a41_fnobj->env, vader_box_i32(168u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_421;
                } else {
    ...
    if (l0.tag == 825u) {
        ...
        ((vader_fn_erased_sig_1_t) _a42_fnobj->code)(_a42_fnobj->env, vader_box_i32(168u, ((vader_struct_vader_midir_InstrDeferPush_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 824u) {
        { vader_gc_top = gc_frame.prev; return; }
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    l4 = std_core_write_string_at(l5, l4, 253u);
...
static int32_t vader_midir_intern_string_pool(void* l0, vader_string_t l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_midir_ProjectCtx_t*) l0)->f_strings, vader_box_string(165u, l1));
...
static vader_box_t vader_midir_intrinsic_op_for_name(vader_string_t l0) {
    ...
    if (l0 == 1990u) {
        ...
        vader_obj_header_init(_a0_obj, 621u);
        t0 = (void*) _a0_obj;
    ...
    if (l0 == 1206u) {
        ...
        vader_obj_header_init(_a2_obj, 487u);
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1187u) {
    ...
    if (l0 == 1210u) {
        ...
        vader_obj_header_init(_a4_obj, 488u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1184u) {
        ...
        vader_obj_header_init(_a5_obj, 481u);
        t0 = (void*) _a5_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = vader_box_obj(0u, NULL);
...
static bool vader_midir_is_mutable_slot(vader_box_t l0) {
    ...
    if ((l0.tag == 909u || l0.tag == 911u || l0.tag == 912u || l0.tag == 913u || l0.tag == 914u || l0.tag == 915u || l0.tag == 916u || l0.tag == 917u || l0.tag == 919u || l0.tag == 920u || l0.tag == 922u || l0.tag == 924u || l0.tag == 925u || l0.tag == 926u || l0.tag == 927u)) {
        return false;
    }
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l6 >= l5)) {
                ...
                vader_obj_header_init(_a3_obj, 225u);
                _a3_obj->f__0 = l7;
                _a3_obj->f__1 = l8;
                t0 = (void*) _a3_obj;
...
static vader_box_t vader_midir_lowered_to_bc_value(vader_box_t l0) {
    ...
    if (l0.tag == 770u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(122u, 0u, 13u, 1085u);
        l2 = (void*) _a1_arr;
        l3 = ((vader_struct_vader_lower_LoweredStructLit_t*) l1)->f_fields;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
        ...
        vader_obj_header_init(_a3_obj, 511u);
    ...
    if (l0.tag == 729u) {
        l1 = l0.payload.obj;
        vader_array_t* _a4_arr = vader_array_new(122u, 0u, 13u, 1085u);
        l2 = (void*) _a4_arr;
        l3 = ((vader_struct_vader_lower_LoweredArrayLit_t*) l1)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_midir_natural_loop_bodies(void* l0, void* l1, void* l2) {
    ...
    vader_obj_header_init(_a3_obj, 296u);
    _a3_obj->f_ekeys = l3;
    _a3_obj->f_evals = l4;
    _a3_obj->f_index = l5;
    _a3_obj->f_mask = (size_t) (int64_t) INT64_C(0);
...
static void* vader_midir_new_project_ctx(void* l0) {
    ...
    void** gc_raw_roots[14] = { &l0, &l1, &l2, &l3, &l4, &l8, &l9, &l13, &l14, &l15, &l16, &l17, &l18, &t1 };
    vader_string_t* gc_atom_roots[1] = { &l7 };
                ...
                l11 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_57: {
                        if ((l11 < l10)) {
                            ...
                            if (l12.tag == 752u) {
                                l13 = l12.payload.obj;
                                t1 = vader_midir_fn_metadata(l13);
                                t3 = ((vader_struct_vader_midir_FnMetadata_t*) t1)->f_is_extern;
                                if (t3) {
                                    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l13)->f_origin)->f_symbol.tag == 884u) {
                                        l14 = ((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l13)->f_origin)->f_symbol.payload.obj;
                                        vader_array_t* _a8_arr = vader_array_new(15u, 0u, 4u, 175u);
                                        l15 = (void*) _a8_arr;
                                        vader_array_t* _a9_arr = vader_array_new(6u, 0u, 12u, 163u);
                                        l16 = (void*) _a9_arr;
                                        vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 168u);
                                        ...
                                        vader_obj_header_init(_a11_obj, 370u);
                                        ...
                                        vader_obj_header_init(_a12_obj, 376u);
                                        _a12_obj->f_inner = t1;
                                        l18 = (void*) _a12_obj;
                                        l19 = ((vader_array_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l13)->f_params)->length;
                                        l20 = (size_t) (int64_t) INT64_C(0);
                                        {
                                            loop_104: {
                                                if ((l20 < l19)) {
                                                    vader_array_t* _a13_slotarr = ((vader_array_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l13)->f_params);
                                                    if (_a13_slotarr->buf != NULL && _a13_slotarr->buf->header.forward != NULL) { _a13_slotarr->buf = vader_array_buf_forward(_a13_slotarr->buf); }
                                        ...
                                        t4 = ((vader_struct_std_collections_MutableMap__usize__bool_t*) ((vader_struct_std_collections_MutableSet__usize_t*) l18)->f_inner)->f_size;
                                        if ((t4 > INT64_C(0))) {
                                            l21 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l14)->f_id;
                                            std_collections_put__i32__Any(l1, l21, vader_ref_box(l18));
                                        } else {
                                        }
                                    } else {
                                    }
    ...
    vader_array_t* _a14_arr = vader_array_new(8u, 0u, 0u, 165u);
    l2 = (void*) _a14_arr;
    vader_array_t* _a15_arr = vader_array_new(8u, 0u, 0u, 165u);
    l3 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 168u);
    l8 = (void*) _a17_arr;
...
static void* vader_midir_no_hints(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(10u, 0u, 8u, 169u);
    l0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 163u);
    l1 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 168u);
    ...
    _a4_obj->f_inner = t0;
    l0 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(10u, 0u, 8u, 169u);
    l1 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 163u);
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 168u);
    ...
    vader_obj_header_init(_a8_obj, 315u);
    _a8_obj->f_ekeys = l1;
    _a8_obj->f_evals = l2;
    _a8_obj->f_index = l3;
    _a8_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a9_obj, 374u);
    _a9_obj->f_inner = t0;
    l1 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(6u, 0u, 12u, 163u);
    l3 = (void*) _a11_arr;
    vader_array_t* _a12_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a12_arr;
    ...
    vader_obj_header_init(_a14_obj, 373u);
    _a14_obj->f_inner = t0;
    l2 = (void*) _a14_obj;
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 257u);
    t0 = (void*) _a0_obj;
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(6u, 1u, 12u, 163u);
    ...
    vader_obj_header_init(_a2_obj, 181u);
    _a2_obj->f_value = t0;
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    ...
    vader_obj_header_init(_a3_obj, 253u);
    _a3_obj->f_cap_0 = l3;
    t0 = (void*) _a3_obj;
    ...
    vader_obj_header_init(_a5_obj, 185u);
    _a5_obj->f_value = t0;
    t0 = (void*) _a5_obj;
    l4 = vader_ref_box(t0);
    l5 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_22: {
            if ((l8 >= l7)) {
                ...
                ((vader_fn_erased_sig_1_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i32(168u, l9));
    ...
    vader_obj_header_init(_a9_obj, 254u);
    _a9_obj->f_cap_0 = l4;
    _a9_obj->f_cap_1 = l3;
    t0 = (void*) _a9_obj;
    ...
    vader_array_t* _a11_arr = vader_array_new(6u, 1u, 12u, 163u);
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l14.tag == 168u) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(168u, l9));
                    ...
                    t2 = vader_box_bool(163u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l11]);
                    l15 = t2.payload.b;
                } else {
                }
                ...
                if (l17) {
                    ...
                    if (l14.tag == 168u) {
                        ...
                        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(168u, l20));
    ...
    vader_array_t* _a22_arr = vader_array_new(130u, 0u, 13u, 1153u);
    l6 = (void*) _a22_arr;
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_192: {
            if ((l8 < l7)) {
                ...
                if (_a23_slotarr->buf != NULL && _a23_slotarr->buf->header.forward != NULL) { _a23_slotarr->buf = vader_array_buf_forward(_a23_slotarr->buf); }
                if ((size_t) l8 >= _a23_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_box_bool(163u, ((uint8_t*) _a23_slotarr->buf->slots)[_a23_slotarr->offset + (size_t) l8]);
                t3 = t2.payload.b;
                if (t3) {
...
static vader_box_t vader_midir_remap_instr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 828u) {
        l2 = l0.payload.obj;
        l3 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_span;
        l4 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_dst;
        l4 = vader_midir_remap_local(l1, l4);
        l10 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_fn_symbol;
        l5 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_type;
    ...
    if (l0.tag == 811u) {
        ...
        _a18_obj->f_dst = l4;
        _a18_obj->f_type = l5;
        _a18_obj->f_length = l7;
        _a18_obj->f_elements = l10;
    ...
    if (l0.tag == 831u) {
        ...
        _a26_obj->f_span = l3;
        _a26_obj->f_dst = l4;
        _a26_obj->f_fn_symbol = l10;
        _a26_obj->f_env = l7;
        _a26_obj->f_env_type = l5;
        _a26_obj->f_type = l6;
        t0 = (void*) _a26_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_midir_reserve_cfg_extern(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 498u);
...
static void vader_midir_reserve_cfg_function(void* l0, void* l1) {
    ...
    l4 = ((int32_t) (size_t) t0);
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(123u, 0u, 13u, 1097u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 168u);
    l7 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(40u, 0u, 13u, 499u);
    l8 = (void*) _a3_arr;
...
static void vader_midir_reserve_cfg_struct(void* l0, void* l1) {
    ...
    void** gc_raw_roots[11] = { &l0, &l1, &l3, &l4, &l10, &l11, &l13, &l14, &l16, &l20, &t0 };
    vader_string_t* gc_atom_roots[4] = { &l5, &l18, &l19, &t4 };
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 884u) {
        ...
        if (l6.tag == 168u) {
            ...
            l7 = l8;
            vader_array_t* _a1_arr = vader_array_new(37u, 0u, 13u, 495u);
            l10 = (void*) _a1_arr;
            ...
            l12 = (size_t) (int64_t) INT64_C(0);
            {
                loop_69: {
                    if ((l12 < l9)) {
                        ...
                        vader_obj_header_init(_a3_obj, 495u);
                        _a3_obj->f_name = t4;
        ...
        vader_obj_header_init(_a6_obj, 503u);
        _a6_obj->f_trait_name = t4;
        l4 = (void*) _a6_obj;
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
        vader_array_t* _a7_arr = vader_array_new(37u, 0u, 13u, 495u);
        l10 = (void*) _a7_arr;
        l11 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_fields;
        l9 = ((vader_array_t*) l11)->length;
        l12 = (size_t) (int64_t) INT64_C(0);
        {
            loop_146: {
                if ((l12 < l9)) {
                    ...
                    vader_obj_header_init(_a9_obj, 495u);
                    _a9_obj->f_name = t4;
        ...
        vader_obj_header_init(_a10_obj, 506u);
        _a10_obj->f_name = l18;
    ...
    vader_obj_header_init(_a12_obj, 503u);
    _a12_obj->f_trait_name = t4;
    l4 = (void*) _a12_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    vader_array_t* _a13_arr = vader_array_new(37u, 0u, 13u, 495u);
    l3 = (void*) _a13_arr;
    ...
    l12 = (size_t) (int64_t) INT64_C(0);
    {
        loop_223: {
            if ((l12 < l9)) {
                ...
                vader_obj_header_init(_a15_obj, 495u);
                _a15_obj->f_name = t4;
    ...
    vader_obj_header_init(_a16_obj, 506u);
    _a16_obj->f_name = l5;
...
static void* vader_midir_successors_of(void* l0) {
    ...
    if (l1.tag == 847u) {
        ...
        vader_array_t* _a1_arr = vader_array_new(9u, 2u, 7u, 168u);
    ...
    l9 = INT32_C(0);
    {
        loop_53: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a6_arr = vader_array_new(123u, 0u, 13u, 1097u);
                l14 = (void*) _a6_arr;
                ...
                vader_array_t* _a8_arr = vader_array_new(40u, 0u, 13u, 499u);
                l20 = (void*) _a8_arr;
                ...
                vader_obj_header_init(_a9_obj, 497u);
                _a9_obj->f_name = l23;
...
static void vader_midir_walk_rpo(void* l0, int32_t l1, void* l2, void* l3) {
    ...
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    t0 = vader_box_bool(163u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
    t1 = t0.payload.b;
    if (t1) {
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void vader_midir_walk_rpo_reverse(void* l0, int32_t l1, void* l2, void* l3) {
    ...
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    t1 = vader_box_bool(163u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
    t2 = t1.payload.b;
    if (t2) {
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void* vader_midir_with_by_address(void* l0, void* l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(6u, 0u, 12u, 163u);
    l3 = (void*) _a0_arr;
    l4 = false;
    t0 = l2.payload.obj;
...
static vader_box_t vader_midir_with_dst(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 828u) {
        l2 = l0.payload.obj;
        l3 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_span;
        l12 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_fn_symbol;
        l4 = ((vader_struct_vader_midir_InstrFnAddr_t*) l2)->f_type;
