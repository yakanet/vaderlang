...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1168u, l6);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1983u, l5);
    ...
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 752u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if (t1) {
                ...
                t2 = vader_midir_fresh_tmp(l0, 1297u, l5);
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1542u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1569u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
    ...
    if (l4.tag == 709u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1384u, l4);
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1670u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(166u, t1);
        }
    }
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1661u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1712u, l4);
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_62: {
                        if ((l16 < l15)) {
                            ...
                            vader_struct___lambda_env_2894_t* _a18_obj = (vader_struct___lambda_env_2894_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2894_t));
                ...
                vader_struct___lambda_env_2897_t* _a20_obj = (vader_struct___lambda_env_2897_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2897_t));
    ...
    vader_struct___lambda_env_2903_t* _a25_obj = (vader_struct___lambda_env_2903_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2903_t));
    ...
    vader_struct___lambda_env_2906_t* _a27_obj = (vader_struct___lambda_env_2906_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2906_t));
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    t1 = (l1 + INT64_C(1));
    l4 = (size_t) (int64_t) t1;
    vader_struct___lambda_env_1886_t* _a8_obj = (vader_struct___lambda_env_1886_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1886_t));
...
static void* vader_midir_count_uses(void* l0) {
    ...
    t0 = (void*) _a4_obj;
    l4 = vader_ref_box(t0);
    vader_struct___lambda_env_2878_t* _a5_obj = (vader_struct___lambda_env_2878_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2878_t));
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    if (l1.tag == 825u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1824u, l16, 998u, l17, 958u, l21, 298u);
            vader_host_std_abort_panic(t3);
        } else {
        }
    ...
    if (l1.tag == 826u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1824u, l16, 998u, l17, 958u, l21, 299u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
    ...
    if (l1.tag == 828u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1826u, l16, 958u, l17, 301u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 417u) {
        ...
        l2 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1501u);
        l3 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1487u);
                                ...
                                if (l23.tag == 166u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            vader_struct___lambda_env_2887_t* _a7_obj = (vader_struct___lambda_env_2887_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2887_t));
                                    ...
                                    vader_struct___lambda_env_2887_t* _a11_obj = (vader_struct___lambda_env_2887_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2887_t));
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks)->length;
    vader_struct___lambda_env_1868_t* _a0_obj = (vader_struct___lambda_env_1868_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1868_t));
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    vader_struct___lambda_env_2927_t* _a3_obj = (vader_struct___lambda_env_2927_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2927_t));
    ...
    vader_struct___lambda_env_2935_t* _a9_obj = (vader_struct___lambda_env_2935_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2935_t));
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l17) {
                    ...
                    vader_struct___lambda_env_2938_t* _a20_obj = (vader_struct___lambda_env_2938_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2938_t));
