...
static vader_box_t vader_midir_build_array_len(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1751u, l3);
...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1152u, l6);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1962u, l5);
    ...
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 750u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if (t1) {
                ...
                t2 = vader_midir_fresh_tmp(l0, 1278u, l5);
...
static vader_box_t vader_midir_build_cast(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1305u, l3);
...
static vader_box_t vader_midir_build_cell_get(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1308u, l3);
...
static vader_box_t vader_midir_build_cell_new(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1307u, l3);
...
static void* vader_midir_build_cfg_signature(void* l0, vader_box_t l1, void* l2) {
    ...
    _a5_obj->f_params = l3;
    _a5_obj->f_result = l11;
    _a5_obj->f_param_types = l4;
    _a5_obj->f_result_type = l12;
    _a5_obj->f_param_names = l5;
    _a5_obj->f_param_mutable = l6;
    t1 = (void*) _a5_obj;
    { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1380u, l2);
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1521u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        if (l6.tag == 922u) {
            ...
            if (!(t3)) {
                l6 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_type;
                l3 = vader_midir_fresh_tmp(l0, 1835u, l6);
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1548u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
    ...
    if (l4.tag == 707u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1365u, l4);
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1649u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(164u, t1);
        }
    }
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1640u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1691u, l4);
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    if (l5) {
        ...
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1719u, l4);
        l8 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_span;
        vader_struct_vader_midir_ConstBool_t* _a2_obj = (vader_struct_vader_midir_ConstBool_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ConstBool_t));
        vader_obj_header_init(_a2_obj, 795u);
...
static void vader_midir_build_stmt(void* l0, vader_box_t l1) {
    ...
    if ((l1.tag == 730u || l1.tag == 775u)) {
        vader_host_std_abort_panic(1809u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
static vader_box_t vader_midir_build_string_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1373u, l5);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_66: {
            if ((l5 < l3)) {
                ...
                l8 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_82: {
                        if ((l8 < l7)) {
                            ...
                            _a9_closure->code = (void*) &vader_fn_lift_1755;
                            _a9_closure->env = t1;
                ...
                _a12_closure->code = (void*) &vader_fn_lift_1756;
                _a12_closure->env = t1;
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_62: {
                        if ((l16 < l15)) {
                            ...
                            vader_struct___lambda_env_2845_t* _a18_obj = (vader_struct___lambda_env_2845_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2845_t));
                            ...
                            _a19_closure->code = (void*) &vader_fn_lift_1780;
                            _a19_closure->env = t0;
                ...
                vader_struct___lambda_env_2848_t* _a20_obj = (vader_struct___lambda_env_2848_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2848_t));
                ...
                _a21_closure->code = (void*) &vader_fn_lift_1781;
                _a21_closure->env = t0;
    ...
    vader_struct___lambda_env_2854_t* _a25_obj = (vader_struct___lambda_env_2854_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2854_t));
    ...
    _a26_closure->code = (void*) &vader_fn_lift_1782;
    _a26_closure->env = t0;
    l6 = (void*) _a26_closure;
    l6 = std_core_filled__MutableSet_i32_(l1, l6);
    vader_struct___lambda_env_2857_t* _a27_obj = (vader_struct___lambda_env_2857_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2857_t));
    ...
    _a28_closure->code = (void*) &vader_fn_lift_1783;
    _a28_closure->env = t0;
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    t1 = (l1 + INT64_C(1));
    l4 = (size_t) (int64_t) t1;
    vader_struct___lambda_env_1874_t* _a8_obj = (vader_struct___lambda_env_1874_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1874_t));
    vader_obj_header_init(_a8_obj, 238u);
    t0 = (void*) _a8_obj;
    vader_fn_t* _a9_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a9_closure, 130u);
    _a9_closure->code = (void*) &vader_fn_lift_1764;
    _a9_closure->env = t0;
    l2 = (void*) _a9_closure;
...
static void* vader_midir_count_uses(void* l0) {
    ...
    t0 = (void*) _a4_obj;
    l4 = vader_ref_box(t0);
    vader_struct___lambda_env_2829_t* _a5_obj = (vader_struct___lambda_env_2829_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2829_t));
    ...
    _a6_closure->code = (void*) &vader_fn_lift_1776;
    _a6_closure->env = t0;
    l1 = (void*) _a6_closure;
    l2 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
...
static int32_t vader_midir_emit_const(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l4 = vader_midir_fresh_tmp(l0, 1719u, l1);
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
            ...
            if (l7.tag == 164u) {
                ...
                if (l7.tag == 164u) {
                    ...
                    if (l7.tag == 164u) {
                        ...
                        l6 = (size_t) (int64_t) INT64_C(0);
                        l6 = std_core_write_string_at(l5, l6, 1806u);
    ...
    if (l1.tag == 825u) {
        ...
        if (l7.tag == 164u) {
            ...
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1808u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 281u);
    ...
    if (l1.tag == 823u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1803u, l16, 985u, l17, 945u, l21, 291u);
            vader_host_std_abort_panic(t3);
        } else {
        }
    ...
    if (l1.tag == 824u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1803u, l16, 985u, l17, 945u, l21, 292u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
    ...
    if (l1.tag == 827u) {
        ...
        if (l7.tag == 164u) {
            ...
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1807u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 281u);
    ...
    if (l1.tag == 826u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1805u, l16, 945u, l17, 294u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
    ...
    vader_host_std_abort_panic(1804u);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 415u) {
        ...
        l2 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l4)->f_decorators, 1481u);
        l3 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l4)->f_decorators, 1467u);
    } else {
    }
                                ...
                                if (l23.tag == 164u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            vader_struct___lambda_env_2838_t* _a7_obj = (vader_struct___lambda_env_2838_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2838_t));
                                            ...
                                            _a8_closure->code = (void*) &vader_fn_lift_1778;
                                            _a8_closure->env = t2;
                                    ...
                                    vader_struct___lambda_env_2838_t* _a11_obj = (vader_struct___lambda_env_2838_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2838_t));
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    l4 = std_core_write_string_at(l5, l4, 261u);
    l4 = std_core_write_string_at(l5, l4, l3);
    l4 = std_core_write_string_at(l5, l4, 854u);
    t0 = ((vader_array_t*) ((vader_struct_vader_midir_FnCtx_t*) l0)->f_locals)->length;
...
static bool vader_midir_is_mutable_slot(vader_box_t l0) {
    bool t0;
    t0 = vader_types_type_is_immutable(l0);
    return !(t0);
}
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks)->length;
    vader_struct___lambda_env_1856_t* _a0_obj = (vader_struct___lambda_env_1856_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1856_t));
    ...
    _a1_closure->code = (void*) &vader_fn_lift_1761;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    vader_struct___lambda_env_2878_t* _a3_obj = (vader_struct___lambda_env_2878_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2878_t));
    ...
    _a4_closure->code = (void*) &vader_fn_lift_1785;
    _a4_closure->env = t0;
    t0 = (void*) _a4_closure;
    ...
    vader_struct___lambda_env_2886_t* _a9_obj = (vader_struct___lambda_env_2886_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2886_t));
    ...
    _a10_closure->code = (void*) &vader_fn_lift_1786;
    _a10_closure->env = t0;
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l17) {
                    ...
                    vader_struct___lambda_env_2889_t* _a20_obj = (vader_struct___lambda_env_2889_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2889_t));
