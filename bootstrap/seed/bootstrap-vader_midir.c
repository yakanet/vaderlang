...
static void* vader_midir_c_size_of(void* l0, vader_string_t l1);
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_30: {
            if ((l8 >= l7)) {
                ...
                vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t* _a6_obj = (vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) vader_gc_alloc(sizeof(vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t));
                vader_obj_header_init(_a6_obj, 229u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                t1 = (void*) _a6_obj;
                l10 = ((vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) t1)->f__1;
                t2 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t2;
                vader_array_t* _a7_arr = vader_array_new(71u, 0u, 13u, 790u);
                l11 = (void*) _a7_arr;
...
static void* vader_midir_annotate_function(void* l0) {
    ...
    _a4_obj->f_inner = t0;
    l1 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a5_arr;
    ...
    l10 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(6u, 0u, 12u, 162u);
    l14 = (void*) _a9_arr;
    ...
    _a12_obj->f_inner = t0;
    l10 = (void*) _a12_obj;
    vader_array_t* _a13_arr = vader_array_new(9u, 0u, 7u, 167u);
    l14 = (void*) _a13_arr;
    ...
    l17 = false;
    vader_array_t* _a19_arr = vader_array_new(69u, 0u, 13u, 788u);
    l2 = (void*) _a19_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_329: {
            if ((l5 < l4)) {
                ...
                l20 = false;
                vader_array_t* _a21_arr = vader_array_new(131u, 0u, 13u, 1152u);
                l21 = (void*) _a21_arr;
...
static uint64_t vader_midir_bc_value_bits(vader_box_t l0, vader_string_t l1) {
    ...
    vader_host_std_abort_panic(1835u);
...
static vader_box_t vader_midir_build_array_len(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1776u, l3);
...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1176u, l6);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1988u, l5);
...
static vader_box_t vader_midir_build_call(void* l0, void* l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 8u, 6u, gc_roots, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 752u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if (t1) {
                ...
                t2 = vader_midir_fresh_tmp(l0, 1307u, l5);
                l4 = vader_box_i32(167u, t2);
            }
...
static vader_box_t vader_midir_build_cast(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1334u, l3);
...
static vader_box_t vader_midir_build_cell_new(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1335u, l3);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l7 >= l6)) {
                ...
                vader_struct___Tuple_string_Struct_vader_lower_LoweredModule__t* _a6_obj = (vader_struct___Tuple_string_Struct_vader_lower_LoweredModule__t*) vader_gc_alloc(sizeof(vader_struct___Tuple_string_Struct_vader_lower_LoweredModule__t));
                vader_obj_header_init(_a6_obj, 228u);
                _a6_obj->f__0 = l8;
                _a6_obj->f__1 = l3;
                l9 = (void*) _a6_obj;
                l10 = ((vader_struct___Tuple_string_Struct_vader_lower_LoweredModule__t*) l9)->f__0;
                l11 = ((vader_struct___Tuple_string_Struct_vader_lower_LoweredModule__t*) l9)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                vader_array_t* _a7_arr = vader_array_new(71u, 0u, 13u, 790u);
                l12 = (void*) _a7_arr;
                vader_array_t* _a8_arr = vader_array_new(70u, 0u, 13u, 789u);
                l13 = (void*) _a8_arr;
                vader_array_t* _a9_arr = vader_array_new(75u, 0u, 13u, 795u);
                l14 = (void*) _a9_arr;
...
static void* vader_midir_build_cfg_signature(void* l0, vader_box_t l1, void* l2) {
    ...
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(6u, 0u, 12u, 162u);
    l6 = (void*) _a3_arr;
    l7 = l0;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l9 < l8)) {
                ...
                vader_array_push((vader_array_t*) l5, vader_box_string(164u, l13));
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1408u, l2);
...
static void vader_midir_build_expr_into(void* l0, vader_box_t l1, int32_t l2) {
    ...
    if (l1.tag == 753u) {
        l3 = l1.payload.obj;
        vader_midir_build_if(l0, l3, vader_box_i32(167u, l2));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 734u) {
        l3 = l1.payload.obj;
    ...
    if (l1.tag == 733u) {
        ...
        if (t0) {
            vader_midir_build_short_circuit(l0, l3, vader_box_i32(167u, l2));
            { vader_gc_top = gc_frame.prev; return; }
        }
        l4 = l1;
        l5 = vader_midir_build_expr(l0, l4);
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1545u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        if (l6.tag == 924u) {
            ...
            if (!(t3)) {
                l6 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_type;
                l3 = vader_midir_fresh_tmp(l0, 1860u, l6);
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1574u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
    ...
    if (l4.tag == 709u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1395u, l4);
        ...
        _a4_obj->f_span = l9;
        _a4_obj->f_dst = vader_box_i32(167u, l3);
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1675u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(167u, t1);
        }
    }
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l7);
    ...
    if (!(l5.tag == 0u)) {
        if (!(((vader_struct_vader_lower_LoweredIf_t*) l1)->f_else_block.tag == 0u)) {
            ...
            ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l3);
            VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
            ...
            if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
                ...
                vader_obj_header_init(_a2_obj, 844u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l8);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    { vader_box_t __vret = l4; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_midir_build_impl_table_from_vtable(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(42u, 0u, 13u, 599u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(8u, 0u, 0u, 164u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(6u, 0u, 12u, 162u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a3_arr;
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_275: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2416u);
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1666u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1717u, l4);
        l3 = vader_box_i32(167u, t2);
    }
...
static void vader_midir_build_loop(void* l0, void* l1) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l4);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a5_obj, 844u);
    ...
    vader_array_t* _a6_arr = vader_array_new(77u, 0u, 13u, 838u);
    l2 = (void*) _a6_arr;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l5);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l9);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        ...
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1744u, l4);
        l8 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_span;
        vader_struct_vader_midir_ConstBool_t* _a2_obj = (vader_struct_vader_midir_ConstBool_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ConstBool_t));
        vader_obj_header_init(_a2_obj, 797u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l10);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1744u, l4);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a10_obj, 844u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(167u, l11);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    t0 = vader_box_i32(167u, l6);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void vader_midir_build_stmt(void* l0, vader_box_t l1) {
    ...
    if ((l1.tag == 732u || l1.tag == 777u)) {
        vader_host_std_abort_panic(1834u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
static vader_box_t vader_midir_build_string_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1402u, l5);
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2103u, l7);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2183u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2270u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2271u, l1, vader_box_obj(0u, NULL));
        l5 = vader_box_i32(167u, t2);
    }
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2377u, l5);
        l3 = vader_box_i32(167u, t2);
    }
...
static void* vader_midir_build_vtables_from_entries(void* l0, void* l1) {
    ...
    l3 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(15u, 0u, 4u, 174u);
    l4 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 167u);
    l11 = (void*) _a8_arr;
    ...
    l3 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(45u, 0u, 13u, 653u);
    l4 = (void*) _a10_arr;
    l11 = l0;
        ...
        loop_99: {
            if ((l6 < l5)) {
                ...
                if (l18.tag == 174u) {
                    ...
                    vader_array_t* _a14_arr = vader_array_new(44u, 0u, 13u, 652u);
                    l21 = (void*) _a14_arr;
...
static void* vader_midir_c_size_of(void* l0, vader_string_t l1) {
    ...
    uint64_t t4;
    vader_box_t* gc_roots[1] = { &l2 };
    void** gc_raw_roots[4] = { &l0, &l3, &l6, &t0 };
    ...
    vader_gc_top = &gc_frame;
    l2 = ((vader_struct_vader_comptime_MonoEntry_t*) l0)->f_decl;
    if (!(l2.tag == 458u)) {
        vader_struct___Tuple_i64_bool_t* _a0_obj = (vader_struct___Tuple_i64_bool_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i64_bool_t));
        vader_obj_header_init(_a0_obj, 225u);
        _a0_obj->f__0 = -(INT64_C(1));
        _a0_obj->f__1 = false;
        t0 = (void*) _a0_obj;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = l2.payload.obj;
    l3 = ((vader_struct_toolchain_ast_StructDecl_t*) t0)->f_fields;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_20: {
            if ((l5 < l4)) {
                ...
                t1 = ((vader_struct_toolchain_ast_StructField_t*) l6)->f_name;
                if (t1 != l1) {
                    t2 = (l5 + INT64_C(1));
                    l5 = (size_t) (int64_t) t2;
                    goto loop_20;
                }
                t3 = ((vader_array_t*) ((vader_struct_toolchain_ast_StructField_t*) l6)->f_c_sizes)->length;
                if ((t3 > INT64_C(0))) {
                    vader_array_t* _a2_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_StructField_t*) l6)->f_c_sizes);
                    if (_a2_slotarr->buf != NULL && _a2_slotarr->buf->header.forward != NULL) { _a2_slotarr->buf = vader_array_buf_forward(_a2_slotarr->buf); }
                    if ((size_t) INT32_C(0) >= _a2_slotarr->length) { vader_trap("array index out of bounds"); }
                    t0 = vader_array_ref_load_obj(_a2_slotarr->buf, _a2_slotarr->offset + (size_t) INT32_C(0));
                    t4 = ((vader_struct_toolchain_ast_CSizeSelector_t*) t0)->f_bytes;
                    vader_struct___Tuple_i64_bool_t* _a3_obj = (vader_struct___Tuple_i64_bool_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i64_bool_t));
                    vader_obj_header_init(_a3_obj, 225u);
                    _a3_obj->f__0 = ((int64_t) (uint64_t) t4);
                    _a3_obj->f__1 = false;
                    t0 = (void*) _a3_obj;
                    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
                }
                l7 = -(INT64_C(1));
                l8 = ((vader_struct_toolchain_ast_StructField_t*) l6)->f_c_size_missing;
                vader_struct___Tuple_i64_bool_t* _a4_obj = (vader_struct___Tuple_i64_bool_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i64_bool_t));
                vader_obj_header_init(_a4_obj, 225u);
                _a4_obj->f__0 = l7;
                _a4_obj->f__1 = l8;
                t0 = (void*) _a4_obj;
                { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    ...
    vader_struct___Tuple_i64_bool_t* _a5_obj = (vader_struct___Tuple_i64_bool_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i64_bool_t));
    vader_obj_header_init(_a5_obj, 225u);
    _a5_obj->f__0 = -(INT64_C(1));
    _a5_obj->f__1 = false;
    t0 = (void*) _a5_obj;
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void vader_midir_cf_end(void* l0, void* l1) {
    ...
    if ((size_t) l5 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
    l2 = vader_array_ref_load_obj(_a1_slotarr->buf, _a1_slotarr->offset + (size_t) l5);
    vader_array_t* _a2_arr = vader_array_new(80u, 0u, 13u, 843u);
    l6 = (void*) _a2_arr;
    t0 = (l4 - INT64_C(1));
    l4 = (size_t) (int64_t) t0;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_midir_closure_header_type(vader_box_t l0) {
    ...
    if (l0.tag == 911u) {
        ...
        vader_array_t* _a0_arr = vader_array_new(132u, 0u, 13u, 1175u);
        l2 = (void*) _a0_arr;
        vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 162u);
        l3 = (void*) _a1_arr;
        ...
        vader_obj_header_init(_a2_obj, 917u);
        _a2_obj->f_name = 2379u;
        l4 = (void*) _a2_obj;
        ...
        vader_obj_header_init(_a3_obj, 911u);
        _a3_obj->f_params = l2;
...
static void* vader_midir_compact_locals(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 195u);
    _a0_obj->f_value = t0;
    t1 = (void*) _a0_obj;
    l1 = vader_ref_box(t1);
    vader_array_t* _a1_arr = vader_array_new(6u, 1u, 12u, 162u);
    ...
    vader_obj_header_init(_a3_obj, 180u);
    _a3_obj->f_value = t1;
    t1 = (void*) _a3_obj;
    l4 = vader_ref_box(t1);
    ...
    l5 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_params)->length;
    {
        loop_169: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(162u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l20 = true;
                } else {
    ...
    vader_array_t* _a14_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a14_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    vader_array_t* _a15_arr = vader_array_repeat((vader_array_t*) l2, (size_t) l3);
    l2 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(72u, 0u, 13u, 791u);
    l6 = (void*) _a16_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_220: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(162u, ((uint8_t*) _a18_slotarr->buf->slots)[_a18_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l14 = -(INT32_C(1));
    ...
    vader_array_t* _a20_arr = vader_array_new(74u, 0u, 13u, 793u);
    l9 = (void*) _a20_arr;
    ...
    vader_array_t* _a25_arr = vader_array_new(69u, 0u, 13u, 788u);
    l12 = (void*) _a25_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_339: {
            if ((l5 < l3)) {
                ...
                vader_array_t* _a28_arr = vader_array_new(131u, 0u, 13u, 1152u);
                l23 = (void*) _a28_arr;
...
static void* vader_midir_compute_carried_across_loop_headers(void* l0, void* l1) {
    ...
    vader_struct___Tuple_2_201c98d7e7e3e65c_t _a7_storage = {0};
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l9 >= l8)) {
                ...
                vader_struct___Tuple_2_201c98d7e7e3e65c_t* _a8_obj = &_a7_storage;
                vader_obj_header_init(_a8_obj, 197u);
                _a8_obj->f__0 = l10;
                _a8_obj->f__1 = l5;
                t0 = (void*) _a8_obj;
                l11 = ((vader_struct___Tuple_2_201c98d7e7e3e65c_t*) t0)->f__0;
                t2 = (l9 + INT64_C(1));
    ...
    vader_array_t* _a19_arr = vader_array_new(9u, 0u, 7u, 167u);
    l3 = (void*) _a19_arr;
    l4 = l2;
...
static void* vader_midir_compute_escaping(void* l0, void* l1) {
    ...
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 167u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(16u, 0u, 0u, 175u);
    l4 = (void*) _a6_arr;
    ...
    vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 167u);
    l4 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(16u, 0u, 0u, 175u);
    l5 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a11_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l8 < l7)) {
                ...
                if (((vader_struct_vader_midir_BasicBlock_t*) l6)->f_terminator.tag == 846u) {
    ...
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 167u);
    l5 = (void*) _a21_arr;
    l6 = l2;
    ...
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 167u);
    l5 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(6u, 0u, 12u, 162u);
    l6 = (void*) _a27_arr;
    vader_array_t* _a28_arr = vader_array_new(9u, 0u, 7u, 167u);
    l9 = (void*) _a28_arr;
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 167u);
                l6 = (void*) _a5_arr;
                vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 162u);
                l7 = (void*) _a6_arr;
                vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 167u);
                l8 = (void*) _a7_arr;
                ...
                vader_obj_header_init(_a10_obj, 190u);
                _a10_obj->f_value = t0;
                t0 = (void*) _a10_obj;
                l9 = vader_ref_box(t0);
                vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 167u);
                l10 = (void*) _a11_arr;
                vader_array_t* _a12_arr = vader_array_new(6u, 0u, 12u, 162u);
                l11 = (void*) _a12_arr;
                vader_array_t* _a13_arr = vader_array_new(9u, 0u, 7u, 167u);
                l12 = (void*) _a13_arr;
                ...
                vader_obj_header_init(_a16_obj, 190u);
                _a16_obj->f_value = t0;
                t0 = (void*) _a16_obj;
    ...
    vader_array_t* _a29_arr = vader_array_new(9u, 0u, 7u, 167u);
    l8 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(6u, 0u, 12u, 162u);
    l10 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 167u);
    l11 = (void*) _a31_arr;
    ...
    _a33_obj->f_inner = t0;
    l8 = (void*) _a33_obj;
    vader_array_t* _a34_arr = vader_array_new(9u, 0u, 7u, 167u);
    l10 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(6u, 0u, 12u, 162u);
    l11 = (void*) _a35_arr;
    vader_array_t* _a36_arr = vader_array_new(9u, 0u, 7u, 167u);
    l12 = (void*) _a36_arr;
    ...
    vader_obj_header_init(_a51_obj, 837u);
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    vader_array_t* _a16_arr = vader_array_new(9u, 0u, 7u, 167u);
    l3 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(6u, 1u, 12u, 162u);
    ...
    vader_array_t* _a19_arr = vader_array_new(9u, 1u, 7u, 167u);
...
static void* vader_midir_convert_data_pool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(121u, 0u, 13u, 1078u);
    l1 = (void*) _a0_arr;
    l2 = l0;
    l3 = ((vader_array_t*) l2)->length;
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 780u) {
                    l10 = l5.payload.obj;
                    vader_array_t* _a3_arr = vader_array_new(14u, 0u, 4u, 173u);
                    l11 = (void*) _a3_arr;
                ...
                if (l5.tag == 698u) {
                    l19 = l5.payload.obj;
                    vader_array_t* _a6_arr = vader_array_new(123u, 0u, 13u, 1084u);
                    l20 = (void*) _a6_arr;
...
static vader_box_t vader_midir_convert_function(void* l0, void* l1) {
    ...
    l2 = t0.payload.obj;
    vader_array_t* _a0_arr = vader_array_new(74u, 0u, 13u, 793u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(72u, 0u, 13u, 791u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 167u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 167u);
    ...
    vader_array_t* _a9_arr = vader_array_new(78u, 0u, 13u, 839u);
    l7 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(77u, 0u, 13u, 838u);
    l13 = (void*) _a10_arr;
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l4)->f_current = vader_box_i32(167u, l10);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l4)->f_current.tag == 0u)) {
        ...
        if (((vader_struct_vader_midir_MutableBlock_t*) l5)->f_terminator.tag == 0u) {
            ...
            vader_obj_header_init(_a13_obj, 846u);
    ...
    vader_array_t* _a14_arr = vader_array_new(69u, 0u, 13u, 788u);
    l5 = (void*) _a14_arr;
...
static void* vader_midir_die_once(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(69u, 0u, 13u, 788u);
    l2 = (void*) _a0_arr;
    l3 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void vader_midir_drain_pending(void* l0, int32_t l1, bool l2, int32_t l3, int32_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(79u, 0u, 13u, 840u);
    l6 = (void*) _a0_arr;
    l7 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_pending;
    l8 = ((vader_array_t*) l7)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_midir_dst_of(vader_box_t l0) {
    ...
    if (l0.tag == 821u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 830u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 814u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrBinOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 835u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 825u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 808u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 809u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 813u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 831u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrStringSlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 832u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrStructNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 810u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 833u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 834u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrTypeConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 817u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 819u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 818u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 829u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 827u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrFnRef_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 822u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrDataConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 815u) {
        t0 = l0.payload.obj;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l6 >= l5)) {
                ...
                _a6_obj->f__1 = l2;
                l8 = (void*) _a6_obj;
                l9 = ((vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) l8)->f__0;
                l10 = ((vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) l8)->f__1;
                t1 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t1;
                vader_array_t* _a7_arr = vader_array_new(71u, 0u, 13u, 790u);
                l11 = (void*) _a7_arr;
...
void* vader_midir_emit_bytecode_from_cfg(void* l0, vader_string_t l1, void* l2) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l8 >= l7)) {
                ...
                vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t* _a2_obj = (vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) vader_gc_alloc(sizeof(vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t));
                vader_obj_header_init(_a2_obj, 229u);
                _a2_obj->f__0 = l9;
                _a2_obj->f__1 = l4;
                t1 = (void*) _a2_obj;
                l10 = ((vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) t1)->f__1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_260: {
            if ((l8 >= l7)) {
                ...
                if ((size_t) l8 >= _a12_slotarr->length) { vader_trap("array index out of bounds"); }
                l5 = vader_array_ref_load_obj(_a12_slotarr->buf, _a12_slotarr->offset + (size_t) l8);
                vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t* _a13_obj = (vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) vader_gc_alloc(sizeof(vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t));
                vader_obj_header_init(_a13_obj, 229u);
                _a13_obj->f__0 = l9;
                _a13_obj->f__1 = l5;
                t1 = (void*) _a13_obj;
                l11 = ((vader_struct___Tuple_string_Struct_vader_midir_CFGModule__t*) t1)->f__1;
                t2 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t2;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_291: {
                        if ((l13 < l12)) {
                            ...
                            l20 = -(INT32_C(1));
                            if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l17)->f_origin)->f_symbol.tag == 882u) {
    ...
    if (t4) {
        ...
        vader_array_t* _a31_arr = vader_array_new(8u, 0u, 0u, 164u);
        l4 = (void*) _a31_arr;
        vader_array_t* _a32_arr = vader_array_new(6u, 0u, 12u, 162u);
        l5 = (void*) _a32_arr;
        vader_array_t* _a33_arr = vader_array_new(9u, 0u, 7u, 167u);
        l6 = (void*) _a33_arr;
        ...
        vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 167u);
        l5 = (void*) _a37_arr;
...
static void vader_midir_emit_cfg_function_body(void* l0, int32_t l1, void* l2, void* l3, bool l4) {
    ...
    vader_array_t* _a5_arr = vader_array_new(80u, 0u, 13u, 843u);
    l22 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(79u, 0u, 13u, 840u);
    l23 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 167u);
    l24 = (void*) _a7_arr;
...
static int32_t vader_midir_emit_const(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l4 = vader_midir_fresh_tmp(l0, 1744u, l1);
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    vader_string_t* gc_atom_roots[4] = { &l16, &l17, &l21, &t3 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 3u, 7u, gc_roots, gc_raw_roots, 0u, NULL, 4u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    if (l1.tag == 821u) {
        l3 = l1.payload.obj;
    ...
    if (l1.tag == 815u) {
        ...
        if (((vader_struct_vader_midir_InstrCall_t*) l3)->f_dst.tag == 167u) {
            ...
            if (l7.tag == 167u) {
                ...
                if (l7.tag == 167u) {
                    ...
                    if (l7.tag == 167u) {
                        ...
                        l6 = (size_t) (int64_t) INT64_C(0);
                        l6 = std_core_write_string_at(l5, l6, 1831u);
    ...
    if (l1.tag == 827u) {
        ...
        if (l7.tag == 167u) {
            ...
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1833u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 274u);
    ...
    if (l1.tag == 836u) {
        ...
        vader_obj_header_init(_a17_obj, 651u);
    ...
    if (l1.tag == 825u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1828u, l16, 1000u, l17, 959u, l21, 284u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        ...
        if (!(l22)) {
            ...
            vader_obj_header_init(_a19_obj, 633u);
        ...
        if (t5) {
            ...
            vader_obj_header_init(_a20_obj, 615u);
    ...
    if (l1.tag == 826u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1828u, l16, 1000u, l17, 959u, l21, 285u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
        ...
        vader_obj_header_init(_a22_obj, 635u);
    ...
    if (l1.tag == 808u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a24_obj, 483u);
            ...
            if (t5) {
                ...
                vader_obj_header_init(_a25_obj, 615u);
    ...
    if (l1.tag == 812u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a27_obj, 490u);
    ...
    if (l1.tag == 809u) {
        ...
        vader_obj_header_init(_a28_obj, 484u);
    ...
    if (l1.tag == 811u) {
        ...
        vader_obj_header_init(_a30_obj, 486u);
    ...
    if (l1.tag == 831u) {
        ...
        vader_obj_header_init(_a32_obj, 632u);
        l5 = (void*) _a32_obj;
    ...
    if (l1.tag == 832u) {
        ...
        vader_obj_header_init(_a35_obj, 634u);
    ...
    if (l1.tag == 810u) {
        ...
        vader_obj_header_init(_a38_obj, 485u);
    ...
    if (l1.tag == 822u) {
        ...
        vader_obj_header_init(_a39_obj, 534u);
    ...
    if (l1.tag == 833u) {
        ...
        vader_obj_header_init(_a40_obj, 636u);
    ...
    if (l1.tag == 817u) {
        ...
        if (l4 != l15) {
            ...
            if (l7.tag == 0u) {
                ...
                vader_obj_header_init(_a43_obj, 615u);
                ...
                if (t5) {
                    ...
                    vader_obj_header_init(_a44_obj, 533u);
                    ...
                    vader_obj_header_init(_a45_obj, 615u);
    ...
    if (l1.tag == 819u) {
        ...
        vader_obj_header_init(_a46_obj, 634u);
    ...
    if (l1.tag == 818u) {
        ...
        if (!(l22)) {
            ...
            vader_obj_header_init(_a47_obj, 633u);
    ...
    if (l1.tag == 829u) {
        ...
        if (l7.tag == 167u) {
            ...
            vader_obj_header_init(_a49_obj, 612u);
            ...
            l6 = (size_t) (int64_t) INT64_C(0);
            l6 = std_core_write_string_at(l5, l6, 1832u);
            l6 = std_core_write_string_at(l5, l6, l16);
            l6 = std_core_write_string_at(l5, l6, 274u);
    ...
    if (l1.tag == 828u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1830u, l16, 959u, l17, 287u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
    ...
    if (l1.tag == 824u) {
        ...
        vader_obj_header_init(_a52_obj, 537u);
        l5 = (void*) _a52_obj;
    ...
    vader_host_std_abort_panic(1829u);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l8 >= l7)) {
                ...
                if ((size_t) l8 >= _a5_slotarr->length) { vader_trap("array index out of bounds"); }
                l4 = vader_array_ref_load_obj(_a5_slotarr->buf, _a5_slotarr->offset + (size_t) l8);
                vader_struct___Tuple_2_201c98d7e7e3e65c_t* _a6_obj = (vader_struct___Tuple_2_201c98d7e7e3e65c_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_201c98d7e7e3e65c_t));
                vader_obj_header_init(_a6_obj, 197u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                l10 = (void*) _a6_obj;
                l11 = ((vader_struct___Tuple_2_201c98d7e7e3e65c_t*) l10)->f__0;
                l12 = ((vader_struct___Tuple_2_201c98d7e7e3e65c_t*) l10)->f__1;
                t0 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t0;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_20: {
                if ((l6 < l4)) {
                    ...
                    if (t2 == l2) {
                        t3 = vader_box_i64(174u, (int64_t)(uint64_t) l6);
                        return t3;
                    }
                    t0 = (l6 + INT64_C(1));
                    l6 = (size_t) (int64_t) t0;
...
static vader_box_t vader_midir_first_stack_operand(vader_box_t l0) {
    ...
    if (l0.tag == 830u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrMove_t*) t1)->f_src);
        return t0;
    }
    if (l0.tag == 814u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrBinOp_t*) t1)->f_lhs);
        return t0;
    }
    if (l0.tag == 835u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrUnOp_t*) t1)->f_operand);
        return t0;
    }
    if (l0.tag == 815u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 816u) {
        ...
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l1)->f_callee);
        return t0;
    }
    if (l0.tag == 836u) {
        l1 = l0.payload.obj;
        ...
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l1)->f_receiver);
        return t0;
    }
    if (l0.tag == 825u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 826u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldSet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 808u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 812u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 809u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayLen_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 811u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayPush_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 813u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 831u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrStringSlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 832u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 833u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 817u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCast_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 819u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellNew_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 818u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellGet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 820u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellSet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 829u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t1)->f_env);
        return t0;
    }
    if (l0.tag == 828u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 824u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_InstrDeferPush_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 823u) {
        t0 = vader_box_obj(0u, NULL);
...
static vader_box_t vader_midir_first_terminator_operand(vader_box_t l0) {
    ...
    if (l0.tag == 845u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(167u, ((vader_struct_vader_midir_TermCondBranch_t*) t1)->f_cond);
        return t0;
    }
    if (l0.tag == 846u) {
        t1 = l0.payload.obj;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 416u) {
        ...
        l2 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1509u);
        l3 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1495u);
...
static void* vader_midir_fold_moves(void* l0) {
    ...
    vader_array_t* _a6_arr = vader_array_new(69u, 0u, 13u, 788u);
    l3 = (void*) _a6_arr;
...
static void* vader_midir_fold_moves_in_block(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(131u, 0u, 13u, 1152u);
    l3 = (void*) _a0_arr;
        ...
        loop_8: {
            if ((l5 < l4)) {
                ...
                if (l6.tag == 830u) {
                    ...
                    l17 = -(INT64_C(1));
                    l18 = false;
                    vader_array_t* _a3_arr = vader_array_new(6u, 1u, 12u, 162u);
                    ...
                    vader_obj_header_init(_a4_obj, 180u);
                    _a4_obj->f_value = t2;
                    t2 = (void*) _a4_obj;
                                ...
                                if (l23.tag == 167u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            t4 = vader_box_bool(162u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l34]);
                                            t1 = t4.payload.b;
                                            if (t1) {
                                                l18 = true;
                                            } else {
                                    ...
                                    t4 = vader_box_bool(162u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l34]);
                                    t1 = t4.payload.b;
                                    if (t1) {
                                        l18 = true;
                                    } else {
...
static void vader_midir_for_each_read_in_terminator(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 845u) {
        ...
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_TermCondBranch_t*) t0)->f_cond));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 846u) {
        l2 = l0.payload.obj;
...
static void vader_midir_for_each_read_local(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 830u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a0_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_src));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 814u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a1_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a1_fnobj->code)(_a1_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_lhs));
        vader_fn_t* _a2_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_rhs));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 835u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a3_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a3_fnobj->code)(_a3_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_operand));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 815u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_56: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a5_fnobj->code)(_a5_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_56;
                } else {
    ...
    if (l0.tag == 816u) {
        ...
        ((vader_fn_erased_sig_1_t) _a6_fnobj->code)(_a6_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l2)->f_callee));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_93: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a8_fnobj->code)(_a8_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_93;
                } else {
    ...
    if (l0.tag == 836u) {
        ...
        ((vader_fn_erased_sig_1_t) _a9_fnobj->code)(_a9_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l2)->f_receiver));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_130: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a11_fnobj->code)(_a11_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_130;
                } else {
    ...
    if (l0.tag == 825u) {
        ...
        ((vader_fn_erased_sig_1_t) _a12_fnobj->code)(_a12_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 826u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a13_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a13_fnobj->code)(_a13_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_target));
        vader_fn_t* _a14_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 808u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a15_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a15_fnobj->code)(_a15_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_target));
        vader_fn_t* _a16_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a16_fnobj->code)(_a16_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_index));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 812u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a17_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a17_fnobj->code)(_a17_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_target));
        vader_fn_t* _a18_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_index));
        vader_fn_t* _a19_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a19_fnobj->code)(_a19_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 809u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a20_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a20_fnobj->code)(_a20_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 811u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a21_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a21_fnobj->code)(_a21_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_target));
        vader_fn_t* _a22_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a22_fnobj->code)(_a22_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 813u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a23_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a23_fnobj->code)(_a23_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_target));
        vader_fn_t* _a24_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a24_fnobj->code)(_a24_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_lo));
        vader_fn_t* _a25_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a25_fnobj->code)(_a25_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 831u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a26_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a26_fnobj->code)(_a26_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_target));
        vader_fn_t* _a27_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a27_fnobj->code)(_a27_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_lo));
        vader_fn_t* _a28_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a28_fnobj->code)(_a28_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 832u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_276: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a30_fnobj->code)(_a30_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_276;
                } else {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_309: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a32_fnobj->code)(_a32_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_309;
                } else {
    ...
    if (l0.tag == 833u) {
        ...
        ((vader_fn_erased_sig_1_t) _a33_fnobj->code)(_a33_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 834u) {
        { vader_gc_top = gc_frame.prev; return; }
    ...
    if (l0.tag == 817u) {
        ...
        ((vader_fn_erased_sig_1_t) _a34_fnobj->code)(_a34_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 819u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a35_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a35_fnobj->code)(_a35_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 818u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a36_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a36_fnobj->code)(_a36_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_cell));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 820u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a37_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a37_fnobj->code)(_a37_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_cell));
        vader_fn_t* _a38_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a38_fnobj->code)(_a38_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 829u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a39_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a39_fnobj->code)(_a39_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_env));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 828u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_416: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a41_fnobj->code)(_a41_fnobj->env, vader_box_i32(167u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_416;
                } else {
    ...
    if (l0.tag == 824u) {
        ...
        ((vader_fn_erased_sig_1_t) _a42_fnobj->code)(_a42_fnobj->env, vader_box_i32(167u, ((vader_struct_vader_midir_InstrDeferPush_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 823u) {
        { vader_gc_top = gc_frame.prev; return; }
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = std_core_write_string_at(l5, l4, 860u);
    t0 = ((vader_array_t*) ((vader_struct_vader_midir_FnCtx_t*) l0)->f_locals)->length;
...
static bool vader_midir_instruction_has_side_effect(vader_box_t l0) {
    return (l0.tag == 811u || l0.tag == 812u || l0.tag == 815u || l0.tag == 816u || l0.tag == 820u || l0.tag == 826u || l0.tag == 828u || l0.tag == 836u);
}
...
static int32_t vader_midir_intern_string_pool(void* l0, vader_string_t l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_midir_ProjectCtx_t*) l0)->f_strings, vader_box_string(164u, l1));
...
static bool vader_midir_is_mutable_slot(vader_box_t l0) {
    ...
    if ((l0.tag == 907u || l0.tag == 909u || l0.tag == 910u || l0.tag == 911u || l0.tag == 912u || l0.tag == 913u || l0.tag == 914u || l0.tag == 915u || l0.tag == 917u || l0.tag == 918u || l0.tag == 920u || l0.tag == 922u || l0.tag == 923u || l0.tag == 924u || l0.tag == 925u)) {
        return false;
    }
...
static bool vader_midir_loop_exit_present(void* l0, int32_t l1) {
    ...
    void** gc_raw_roots[5] = { &l0, &l2, &l3, &l4, &t0 };
    vader_struct___Tuple_i32_Union_i32_null__t _a2_storage = {0};
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l6 >= l5)) {
                ...
                vader_struct___Tuple_i32_Union_i32_null__t* _a3_obj = &_a2_storage;
                vader_obj_header_init(_a3_obj, 221u);
                _a3_obj->f__0 = l7;
                _a3_obj->f__1 = l8;
                t0 = (void*) _a3_obj;
                l9 = ((vader_struct___Tuple_i32_Union_i32_null__t*) t0)->f__0;
                t1 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t1;
                if (l9 == l1) {
...
static vader_box_t vader_midir_lowered_to_bc_value(vader_box_t l0) {
    ...
    if (l0.tag == 769u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(123u, 0u, 13u, 1084u);
        l2 = (void*) _a1_arr;
        l3 = ((vader_struct_vader_lower_LoweredStructLit_t*) l1)->f_fields;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
    ...
    if (l0.tag == 728u) {
        l1 = l0.payload.obj;
        vader_array_t* _a4_arr = vader_array_new(123u, 0u, 13u, 1084u);
        l2 = (void*) _a4_arr;
        l3 = ((vader_struct_vader_lower_LoweredArrayLit_t*) l1)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_midir_make_struct_decl(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(76u, 0u, 13u, 796u);
    l1 = (void*) _a0_arr;
...
static void* vader_midir_new_project_ctx(void* l0) {
    ...
    vader_obj_header_init(_a5_obj, 841u);
...
static void* vader_midir_no_hints(void) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 6u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(10u, 0u, 8u, 168u);
    l0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 162u);
    l1 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 167u);
    ...
    _a4_obj->f_inner = t0;
    l0 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(10u, 0u, 8u, 168u);
    l1 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 162u);
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 167u);
    ...
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(6u, 0u, 12u, 162u);
    l3 = (void*) _a11_arr;
    vader_array_t* _a12_arr = vader_array_new(9u, 0u, 7u, 167u);
    l4 = (void*) _a12_arr;
    ...
    vader_obj_header_init(_a15_obj, 842u);
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(6u, 1u, 12u, 162u);
    ...
    vader_obj_header_init(_a2_obj, 180u);
    _a2_obj->f_value = t0;
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    ...
    vader_obj_header_init(_a5_obj, 184u);
    _a5_obj->f_value = t0;
    t0 = (void*) _a5_obj;
    l4 = vader_ref_box(t0);
    l5 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_22: {
            if ((l8 >= l7)) {
                ...
                ((vader_fn_erased_sig_1_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i32(167u, l9));
    ...
    vader_array_t* _a11_arr = vader_array_new(6u, 1u, 12u, 162u);
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l14.tag == 167u) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(167u, l9));
                    ...
                    if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                    if ((size_t) l11 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                    t2 = vader_box_bool(162u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l11]);
                    l15 = t2.payload.b;
                } else {
                }
                ...
                if (l17) {
                    ...
                    if (l14.tag == 167u) {
                        ...
                        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(167u, l20));
    ...
    vader_array_t* _a22_arr = vader_array_new(131u, 0u, 13u, 1152u);
    l6 = (void*) _a22_arr;
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_192: {
            if ((l8 < l7)) {
                ...
                if (_a23_slotarr->buf != NULL && _a23_slotarr->buf->header.forward != NULL) { _a23_slotarr->buf = vader_array_buf_forward(_a23_slotarr->buf); }
                if ((size_t) l8 >= _a23_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_box_bool(162u, ((uint8_t*) _a23_slotarr->buf->slots)[_a23_slotarr->offset + (size_t) l8]);
                t3 = t2.payload.b;
                if (t3) {
...
static vader_box_t vader_midir_remap_instr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 835u) {
        ...
        vader_obj_header_init(_a3_obj, 835u);
        _a3_obj->f_span = l3;
        _a3_obj->f_dst = l4;
        _a3_obj->f_op = l8;
    ...
    if (l0.tag == 825u) {
        ...
        vader_obj_header_init(_a8_obj, 825u);
        _a8_obj->f_span = l3;
        _a8_obj->f_dst = l4;
        _a8_obj->f_target = l7;
        _a8_obj->f_field = l13;
    ...
    if (l0.tag == 831u) {
        ...
        vader_obj_header_init(_a15_obj, 831u);
        _a15_obj->f_span = l3;
        _a15_obj->f_dst = l4;
        _a15_obj->f_type = l5;
    ...
    if (l0.tag == 817u) {
        ...
        vader_obj_header_init(_a21_obj, 817u);
        _a21_obj->f_span = l3;
        _a21_obj->f_dst = l4;
        _a21_obj->f_value = l7;
        _a21_obj->f_type = l5;
    ...
    if (l0.tag == 818u) {
        ...
        vader_obj_header_init(_a23_obj, 818u);
        _a23_obj->f_span = l3;
        _a23_obj->f_dst = l4;
        _a23_obj->f_cell = l7;
    ...
    if (l0.tag == 828u) {
        ...
        vader_obj_header_init(_a26_obj, 828u);
        _a26_obj->f_span = l3;
        _a26_obj->f_dst = l5;
        _a26_obj->f_name = l13;
        _a26_obj->f_args = l2;
    ...
    if (l0.tag == 824u) {
        ...
        vader_obj_header_init(_a27_obj, 824u);
        _a27_obj->f_span = l3;
        _a27_obj->f_value = l4;
        t0 = (void*) _a27_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_midir_reserve_cfg_extern(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGExternDecl_t*) l0)->f_origin)->f_symbol.tag == 882u) {
...
static void vader_midir_reserve_cfg_function(void* l0, void* l1) {
    ...
    l4 = ((int32_t) (size_t) t0);
    vader_array_t* _a0_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(124u, 0u, 13u, 1096u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 167u);
    l7 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(41u, 0u, 13u, 499u);
    l8 = (void*) _a3_arr;
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_origin)->f_symbol.tag == 882u) {
...
static void vader_midir_reserve_cfg_struct(void* l0, void* l1) {
    ...
    void** gc_raw_roots[13] = { &l0, &l1, &l3, &l4, &l10, &l11, &l13, &l14, &l16, &l19, &l21, &l25, &t0 };
    vader_string_t* gc_atom_roots[5] = { &l5, &l15, &l23, &l24, &t4 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 13u, gc_roots, gc_raw_roots, 0u, NULL, 5u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l2 = -(INT32_C(1));
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 882u) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 882u) {
        ...
        if (l6.tag == 167u) {
            ...
            l7 = l8;
            vader_array_t* _a1_arr = vader_array_new(38u, 0u, 13u, 495u);
            l10 = (void*) _a1_arr;
            ...
            l12 = (size_t) (int64_t) INT64_C(0);
            {
                loop_69: {
                    if ((l12 < l9)) {
                        ...
                        l14 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin;
                        l15 = ((vader_struct_vader_midir_CFGStructField_t*) l13)->f_name;
                        l16 = vader_midir_c_size_of(l14, l15);
                        l17 = ((vader_struct___Tuple_i64_bool_t*) l16)->f__0;
                        l18 = ((vader_struct___Tuple_i64_bool_t*) l16)->f__1;
                        ...
                        _a3_obj->f_c_size = l17;
                        _a3_obj->f_c_size_missing = l18;
                        l19 = (void*) _a3_obj;
                        vader_array_push((vader_array_t*) l10, vader_ref_box(l19));
            ...
            l21 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_types;
            t3 = ((int64_t) (int32_t) l7);
            l22 = (size_t) (int64_t) t3;
            l23 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_mangled;
            l24 = vader_midir_c_struct_of(((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin);
            ...
            _a4_obj->f_c_name = l24;
            _a4_obj->f_symbol_id = l2;
            l25 = (void*) _a4_obj;
            vader_array_t* _a5_slotarr = ((vader_array_t*) l21);
            if (_a5_slotarr->buf != NULL && _a5_slotarr->buf->header.forward != NULL) { _a5_slotarr->buf = vader_array_buf_forward(_a5_slotarr->buf); }
            if ((size_t) l22 >= _a5_slotarr->length) { vader_trap("array index out of bounds"); }
            vader_array_ref_store(_a5_slotarr->buf, _a5_slotarr->offset + (size_t) l22, l25);
        ...
        l4 = (void*) _a6_obj;
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
        vader_array_t* _a7_arr = vader_array_new(38u, 0u, 13u, 495u);
        l10 = (void*) _a7_arr;
        l11 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_fields;
        l9 = ((vader_array_t*) l11)->length;
        l12 = (size_t) (int64_t) INT64_C(0);
        {
            loop_163: {
                if ((l12 < l9)) {
                    ...
                    _a9_obj->f_c_size = l17;
                    _a9_obj->f_c_size_missing = l18;
                    l19 = (void*) _a9_obj;
                    vader_array_push((vader_array_t*) l10, vader_ref_box(l19));
                    l20 = (size_t) (int64_t) INT64_C(1);
                    t3 = (l12 + l20);
        ...
        _a10_obj->f_c_name = l24;
        _a10_obj->f_symbol_id = l2;
        l25 = (void*) _a10_obj;
        vader_array_t* _a11_slotarr = ((vader_array_t*) l21);
        if (_a11_slotarr->buf != NULL && _a11_slotarr->buf->header.forward != NULL) { _a11_slotarr->buf = vader_array_buf_forward(_a11_slotarr->buf); }
        if ((size_t) l22 >= _a11_slotarr->length) { vader_trap("array index out of bounds"); }
        vader_array_ref_store(_a11_slotarr->buf, _a11_slotarr->offset + (size_t) l22, l25);
    ...
    l4 = (void*) _a12_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    vader_array_t* _a13_arr = vader_array_new(38u, 0u, 13u, 495u);
    l3 = (void*) _a13_arr;
    ...
    l12 = (size_t) (int64_t) INT64_C(0);
    {
        loop_257: {
            if ((l12 < l9)) {
                ...
                l11 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin;
                l5 = ((vader_struct_vader_midir_CFGStructField_t*) l10)->f_name;
                l13 = vader_midir_c_size_of(l11, l5);
                l17 = ((vader_struct___Tuple_i64_bool_t*) l13)->f__0;
                l18 = ((vader_struct___Tuple_i64_bool_t*) l13)->f__1;
                ...
                _a15_obj->f_c_size = l17;
                _a15_obj->f_c_size_missing = l18;
                l14 = (void*) _a15_obj;
                vader_array_push((vader_array_t*) l3, vader_ref_box(l14));
                t3 = (l12 + INT64_C(1));
                l12 = (size_t) (int64_t) t3;
...
static void* vader_midir_successors_of(void* l0) {
    ...
    if (l1.tag == 845u) {
        ...
        vader_array_t* _a1_arr = vader_array_new(9u, 2u, 7u, 167u);
    ...
    l9 = INT32_C(0);
    {
        loop_53: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a6_arr = vader_array_new(124u, 0u, 13u, 1096u);
                l14 = (void*) _a6_arr;
                ...
                vader_array_t* _a8_arr = vader_array_new(41u, 0u, 13u, 499u);
                l20 = (void*) _a8_arr;
...
static void vader_midir_walk_rpo(void* l0, int32_t l1, void* l2, void* l3) {
    ...
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    t0 = vader_box_bool(162u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
    t1 = t0.payload.b;
    if (t1) {
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void vader_midir_walk_rpo_reverse(void* l0, int32_t l1, void* l2, void* l3) {
    ...
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    t1 = vader_box_bool(162u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
    t2 = t1.payload.b;
    if (t2) {
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void* vader_midir_with_by_address(void* l0, void* l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(6u, 0u, 12u, 162u);
    l3 = (void*) _a0_arr;
    l4 = false;
    t0 = l2.payload.obj;
...
static vader_box_t vader_midir_with_dst(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 833u) {
        ...
        vader_obj_header_init(_a12_obj, 833u);
        _a12_obj->f_span = l3;
        _a12_obj->f_dst = l1;
        _a12_obj->f_value = l6;
    ...
    if (l0.tag == 829u) {
        ...
        vader_obj_header_init(_a17_obj, 829u);
        _a17_obj->f_span = l3;
        _a17_obj->f_dst = l1;
    ...
    if (l0.tag == 827u) {
        ...
        vader_obj_header_init(_a18_obj, 827u);
        _a18_obj->f_span = l3;
        _a18_obj->f_dst = l1;
