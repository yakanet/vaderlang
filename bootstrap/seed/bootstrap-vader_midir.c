...
void* vader_midir_annotate_escape(void* l0) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_30: {
            if ((l8 >= l7)) {
                ...
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 785u);
                l11 = (void*) _a7_arr;
                ...
                vader_obj_header_init(_a11_obj, 787u);
    ...
    vader_obj_header_init(_a12_obj, 789u);
    ...
    vader_obj_header_init(_a14_obj, 782u);
...
static void* vader_midir_annotate_function(void* l0) {
    ...
    l17 = false;
    vader_array_t* _a19_arr = vader_array_new(68u, 0u, 13u, 783u);
    l2 = (void*) _a19_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_329: {
            if ((l5 < l4)) {
                ...
                l20 = false;
                vader_array_t* _a21_arr = vader_array_new(130u, 0u, 13u, 1146u);
                l21 = (void*) _a21_arr;
                    ...
                    loop_349: {
                        if ((l8 < l7)) {
                            ...
                            if (l9.tag == 827u) {
                                ...
                                vader_obj_header_init(_a23_obj, 827u);
                                _a23_obj->f_span = l29;
                                _a23_obj->f_dst = l30;
                                _a23_obj->f_type = l16;
                            ...
                            if (l9.tag == 805u) {
                                ...
                                vader_obj_header_init(_a24_obj, 805u);
                                _a24_obj->f_span = l42;
                                _a24_obj->f_dst = l43;
                                _a24_obj->f_type = l44;
                ...
                vader_obj_header_init(_a26_obj, 783u);
                _a26_obj->f_id = l59;
    ...
    vader_obj_header_init(_a27_obj, 785u);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1978u, l5);
...
static vader_box_t vader_midir_build_call(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 747u) {
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l7 >= l6)) {
                ...
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 785u);
                l12 = (void*) _a7_arr;
                vader_array_t* _a8_arr = vader_array_new(69u, 0u, 13u, 784u);
                l13 = (void*) _a8_arr;
                vader_array_t* _a9_arr = vader_array_new(74u, 0u, 13u, 790u);
                l14 = (void*) _a9_arr;
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1398u, l2);
...
static vader_box_t vader_midir_build_expr(void* l0, vader_box_t l1) {
    ...
    if (l1.tag == 760u) {
        ...
        vader_obj_header_init(_a5_obj, 797u);
        _a5_obj->f_index = l6;
        l4 = (void*) _a5_obj;
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1564u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1665u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(166u, t1);
        }
    }
...
static void* vader_midir_build_impl_table_from_vtable(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 594u);
    l3 = (void*) _a0_arr;
        ...
        loop_23: {
            if ((l8 < l7)) {
                ...
                if ((l12 < l13)) {
                    ...
                    vader_obj_header_init(_a7_obj, 594u);
                ...
                vader_obj_header_init(_a8_obj, 594u);
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_275: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2404u);
                                ...
                                vader_obj_header_init(_a12_obj, 594u);
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1656u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1707u, l4);
...
static void vader_midir_build_loop(void* l0, void* l1) {
    ...
    vader_array_t* _a6_arr = vader_array_new(76u, 0u, 13u, 833u);
    l2 = (void*) _a6_arr;
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    if (l5) {
        ...
        vader_obj_header_init(_a6_obj, 792u);
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2090u, l7);
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2167u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2170u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2257u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2258u, l1, vader_box_obj(0u, NULL));
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2364u, l5);
        l3 = vader_box_i32(166u, t2);
    }
...
static void* vader_midir_build_vtables_from_entries(void* l0, void* l1) {
    ...
    l3 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(15u, 0u, 4u, 173u);
    l4 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l11 = (void*) _a8_arr;
    ...
    l3 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(44u, 0u, 13u, 648u);
    l4 = (void*) _a10_arr;
    l11 = l0;
        ...
        loop_99: {
            if ((l6 < l5)) {
                ...
                if (l18.tag == 173u) {
                    ...
                    vader_obj_header_init(_a13_obj, 647u);
                    ...
                    vader_array_t* _a14_arr = vader_array_new(43u, 0u, 13u, 647u);
                    l21 = (void*) _a14_arr;
                    ...
                    vader_obj_header_init(_a15_obj, 647u);
                    ...
                    vader_obj_header_init(_a16_obj, 648u);
                    _a16_obj->f_key = l14;
...
static void vader_midir_cf_end(void* l0, void* l1) {
    ...
    if ((size_t) l5 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
    l2 = vader_array_ref_load_obj(_a1_slotarr->buf, _a1_slotarr->offset + (size_t) l5);
    vader_array_t* _a2_arr = vader_array_new(79u, 0u, 13u, 838u);
    l6 = (void*) _a2_arr;
    t0 = (l4 - INT64_C(1));
    l4 = (size_t) (int64_t) t0;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void vader_midir_cf_loop(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 606u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
    l3 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes;
    vader_struct_vader_midir_ScopeFrame_t* _a1_obj = (vader_struct_vader_midir_ScopeFrame_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ScopeFrame_t));
...
static vader_box_t vader_midir_closure_header_type(vader_box_t l0) {
    ...
    if (l0.tag == 906u) {
        ...
        vader_obj_header_init(_a2_obj, 912u);
        _a2_obj->f_name = 2366u;
        l4 = (void*) _a2_obj;
        ...
        vader_obj_header_init(_a3_obj, 906u);
        _a3_obj->f_params = l2;
...
static void* vader_midir_compact_locals(void* l0) {
    ...
    l2 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(71u, 0u, 13u, 786u);
    l6 = (void*) _a16_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    ...
    vader_array_t* _a20_arr = vader_array_new(73u, 0u, 13u, 788u);
    l9 = (void*) _a20_arr;
    ...
    vader_array_t* _a25_arr = vader_array_new(68u, 0u, 13u, 783u);
    l12 = (void*) _a25_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_339: {
            if ((l5 < l3)) {
                ...
                vader_array_t* _a28_arr = vader_array_new(130u, 0u, 13u, 1146u);
                l23 = (void*) _a28_arr;
                ...
                vader_obj_header_init(_a32_obj, 783u);
                _a32_obj->f_id = l21;
    ...
    vader_obj_header_init(_a33_obj, 785u);
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l9 >= l8)) {
                ...
                vader_obj_header_init(_a8_obj, 205u);
                _a8_obj->f__0 = l10;
                _a8_obj->f__1 = l5;
                t0 = (void*) _a8_obj;
...
static void* vader_midir_compute_escaping(void* l0, void* l1) {
    ...
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(16u, 0u, 0u, 174u);
    l4 = (void*) _a6_arr;
    ...
    vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 166u);
    l4 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(16u, 0u, 0u, 174u);
    l5 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 166u);
    l6 = (void*) _a11_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l8 < l7)) {
                ...
                if (((vader_struct_vader_midir_BasicBlock_t*) l6)->f_terminator.tag == 841u) {
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(19u, 0u, 13u, 370u);
    t0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_repeat((vader_array_t*) t0, (size_t) l1);
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(19u, 0u, 13u, 370u);
    t0 = (void*) _a2_arr;
    ...
    vader_obj_header_init(_a51_obj, 832u);
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    vader_obj_header_init(_a8_obj, 256u);
    t0 = (void*) _a8_obj;
    vader_fn_t* _a9_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 775u) {
                    l10 = l5.payload.obj;
                    vader_array_t* _a3_arr = vader_array_new(14u, 0u, 4u, 172u);
                    l11 = (void*) _a3_arr;
                    ...
                    vader_obj_header_init(_a5_obj, 496u);
                    _a5_obj->f_kind = l16;
                    _a5_obj->f_items = l11;
                ...
                if (l5.tag == 693u) {
                    l19 = l5.payload.obj;
                    vader_array_t* _a6_arr = vader_array_new(122u, 0u, 13u, 1078u);
                    l20 = (void*) _a6_arr;
...
static vader_box_t vader_midir_convert_function(void* l0, void* l1) {
    ...
    l2 = t0.payload.obj;
    vader_array_t* _a0_arr = vader_array_new(73u, 0u, 13u, 788u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(71u, 0u, 13u, 786u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 166u);
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_34: {
            if ((l9 < l8)) {
                ...
                vader_obj_header_init(_a7_obj, 786u);
                _a7_obj->f_name = l11;
                _a7_obj->f_type = l12;
    ...
    vader_array_t* _a9_arr = vader_array_new(77u, 0u, 13u, 834u);
    l7 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(76u, 0u, 13u, 833u);
    l13 = (void*) _a10_arr;
    ...
    vader_array_t* _a14_arr = vader_array_new(68u, 0u, 13u, 783u);
    l5 = (void*) _a14_arr;
    ...
    vader_obj_header_init(_a16_obj, 785u);
...
static void* vader_midir_count_uses(void* l0) {
    ...
    vader_obj_header_init(_a5_obj, 257u);
    _a5_obj->f_cap_0 = l4;
    t0 = (void*) _a5_obj;
...
static void* vader_midir_die_once(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(68u, 0u, 13u, 783u);
    l2 = (void*) _a0_arr;
    l3 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a3_obj, 783u);
                _a3_obj->f_id = l14;
    ...
    vader_obj_header_init(_a4_obj, 785u);
...
static void vader_midir_drain_pending(void* l0, int32_t l1, bool l2, int32_t l3, int32_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(78u, 0u, 13u, 835u);
    l6 = (void*) _a0_arr;
    l7 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_pending;
    l8 = ((vader_array_t*) l7)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
...
void* vader_midir_eliminate_dead_cfg(void* l0) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l6 >= l5)) {
                ...
                vader_obj_header_init(_a9_obj, 787u);
    ...
    vader_obj_header_init(_a10_obj, 789u);
...
static int32_t vader_midir_emit_block_contents(void* l0, int32_t l1, int32_t l2) {
    ...
    if (l6.tag == 841u) {
        ...
        if ((t5 > INT64_C(0))) {
            ...
            vader_obj_header_init(_a7_obj, 613u);
            l9 = (void*) _a7_obj;
            l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l9), l15);
            { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
        ...
        vader_obj_header_init(_a8_obj, 613u);
        l9 = (void*) _a8_obj;
        l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l9), l15);
        { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
    ...
    if (l6.tag == 842u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a9_obj, 645u);
            _a9_obj->f_reason = t6;
            l9 = (void*) _a9_obj;
            ...
            vader_obj_header_init(_a10_obj, 613u);
            l9 = (void*) _a10_obj;
...
void* vader_midir_emit_bytecode_from_cfg(void* l0, vader_string_t l1, void* l2) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_260: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a13_obj, 202u);
                _a13_obj->f__0 = l9;
                _a13_obj->f__1 = l5;
                t1 = (void*) _a13_obj;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_291: {
                        if ((l13 < l12)) {
                            ...
                            l20 = -(INT32_C(1));
                            if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l17)->f_origin)->f_symbol.tag == 877u) {
    ...
    vader_obj_header_init(_a40_obj, 522u);
    _a40_obj->f_name = l1;
    _a40_obj->f_types = l4;
...
static void vader_midir_emit_cfg_function_body(void* l0, int32_t l1, void* l2, void* l3, bool l4) {
    ...
    vader_array_t* _a5_arr = vader_array_new(79u, 0u, 13u, 838u);
    l22 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(78u, 0u, 13u, 835u);
    l23 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 166u);
    l24 = (void*) _a7_arr;
...
static void vader_midir_emit_const_instr(void* l0, void* l1, int64_t l2) {
    ...
    if (l3.tag == 795u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a1_obj, 558u);
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    if (l1.tag == 810u) {
        ...
        if (l7.tag == 166u) {
            ...
            if (l7.tag == 166u) {
                ...
                vader_obj_header_init(_a7_obj, 524u);
                ...
                if (l7.tag == 166u) {
                    ...
                    vader_obj_header_init(_a8_obj, 525u);
                    _a8_obj->f_index = t2;
                    l5 = (void*) _a8_obj;
                    l10 = ((vader_struct_vader_midir_InstrCall_t*) l3)->f_span;
                    vader_midir_push_emit(l0, vader_ref_box(l5), l10);
    ...
    if (l1.tag == 811u) {
        ...
        vader_obj_header_init(_a13_obj, 526u);
    ...
    if (l1.tag == 822u) {
        ...
        if (l7.tag == 166u) {
            ...
            vader_obj_header_init(_a14_obj, 552u);
    ...
    if (l1.tag == 831u) {
        ...
        vader_obj_header_init(_a17_obj, 646u);
    ...
    if (l1.tag == 820u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1818u, l16, 998u, l17, 956u, l21, 282u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        ...
        if (!(l22)) {
            ...
            vader_obj_header_init(_a19_obj, 628u);
        ...
        if (t5) {
            ...
            vader_obj_header_init(_a20_obj, 610u);
    ...
    if (l1.tag == 821u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1818u, l16, 998u, l17, 956u, l21, 283u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
    ...
    if (l1.tag == 803u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a24_obj, 478u);
            ...
            if (t5) {
                ...
                vader_obj_header_init(_a25_obj, 610u);
    ...
    if (l1.tag == 807u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a27_obj, 485u);
    ...
    if (l1.tag == 804u) {
        ...
        vader_obj_header_init(_a28_obj, 479u);
    ...
    if (l1.tag == 806u) {
        ...
        vader_obj_header_init(_a30_obj, 481u);
    ...
    if (l1.tag == 826u) {
        ...
        vader_obj_header_init(_a32_obj, 627u);
        l5 = (void*) _a32_obj;
    ...
    if (l1.tag == 827u) {
        ...
        vader_obj_header_init(_a35_obj, 629u);
    ...
    if (l1.tag == 805u) {
        ...
        vader_obj_header_init(_a38_obj, 480u);
    ...
    if (l1.tag == 817u) {
        ...
        vader_obj_header_init(_a39_obj, 529u);
    ...
    if (l1.tag == 828u) {
        ...
        vader_obj_header_init(_a40_obj, 631u);
    ...
    if (l1.tag == 829u) {
        ...
        vader_obj_header_init(_a41_obj, 632u);
        ...
        if (l4 != l15) {
            ...
            if (l7.tag == 0u) {
                ...
                if (t5) {
                    ...
                    vader_obj_header_init(_a44_obj, 528u);
                    ...
                    vader_obj_header_init(_a45_obj, 610u);
    ...
    if (l1.tag == 814u) {
        ...
        vader_obj_header_init(_a46_obj, 629u);
    ...
    if (l1.tag == 824u) {
        ...
        if (l7.tag == 166u) {
            ...
            vader_obj_header_init(_a49_obj, 607u);
    ...
    if (l1.tag == 823u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1820u, l16, 956u, l17, 285u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
    ...
    if (l1.tag == 819u) {
        ...
        vader_obj_header_init(_a52_obj, 532u);
        l5 = (void*) _a52_obj;
    ...
    if (l1.tag == 818u) {
        ...
        vader_obj_header_init(_a53_obj, 531u);
        _a53_obj->f_count = t2;
        l5 = (void*) _a53_obj;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a6_obj, 205u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                l10 = (void*) _a6_obj;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    l4 = 0u;
    l5 = 0u;
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 411u) {
        ...
        l2 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1500u);
        l3 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1486u);
...
static void* vader_midir_fold_moves(void* l0) {
    ...
    vader_array_t* _a6_arr = vader_array_new(68u, 0u, 13u, 783u);
    l3 = (void*) _a6_arr;
    ...
    vader_obj_header_init(_a9_obj, 785u);
...
static void* vader_midir_fold_moves_in_block(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(130u, 0u, 13u, 1146u);
    l3 = (void*) _a0_arr;
...
static void* vader_midir_freeze_block(void* l0) {
    ...
    if (((vader_struct_vader_midir_MutableBlock_t*) l0)->f_terminator.tag == 0u) {
        ...
        vader_obj_header_init(_a1_obj, 783u);
        _a1_obj->f_id = l1;
...
static bool vader_midir_instruction_has_side_effect(vader_box_t l0) {
    return (l0.tag == 806u || l0.tag == 807u || l0.tag == 810u || l0.tag == 811u || l0.tag == 815u || l0.tag == 821u || l0.tag == 823u || l0.tag == 831u);
}
...
static vader_box_t vader_midir_intrinsic_op_for_name(vader_string_t l0) {
    ...
    if (l0 == 1201u) {
        ...
        vader_obj_header_init(_a1_obj, 484u);
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1194u) {
    ...
    if (l0 == 1172u) {
        ...
        vader_obj_header_init(_a5_obj, 476u);
        t0 = (void*) _a5_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = vader_box_obj(0u, NULL);
...
static bool vader_midir_is_mutable_slot(vader_box_t l0) {
    ...
    if ((l0.tag == 902u || l0.tag == 904u || l0.tag == 905u || l0.tag == 906u || l0.tag == 907u || l0.tag == 908u || l0.tag == 909u || l0.tag == 910u || l0.tag == 912u || l0.tag == 913u || l0.tag == 915u || l0.tag == 917u || l0.tag == 918u || l0.tag == 919u || l0.tag == 920u)) {
        return false;
    }
...
static vader_box_t vader_midir_lowered_to_bc_value(vader_box_t l0) {
    ...
    if (l0.tag == 764u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(122u, 0u, 13u, 1078u);
        l2 = (void*) _a1_arr;
        l3 = ((vader_struct_vader_lower_LoweredStructLit_t*) l1)->f_fields;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
    ...
    if (l0.tag == 723u) {
        l1 = l0.payload.obj;
        vader_array_t* _a4_arr = vader_array_new(122u, 0u, 13u, 1078u);
        l2 = (void*) _a4_arr;
        l3 = ((vader_struct_vader_lower_LoweredArrayLit_t*) l1)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a7_obj, 504u);
    _a7_obj->f_kind = l8;
    _a7_obj->f_bits = l9;
    t0 = (void*) _a7_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void* vader_midir_make_struct_decl(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(75u, 0u, 13u, 791u);
    l1 = (void*) _a0_arr;
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 255u);
    t0 = (void*) _a0_obj;
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    vader_array_t* _a22_arr = vader_array_new(130u, 0u, 13u, 1146u);
    l6 = (void*) _a22_arr;
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_192: {
...
static vader_box_t vader_midir_remap_instr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 831u) {
        ...
        vader_obj_header_init(_a6_obj, 831u);
        _a6_obj->f_span = l3;
        _a6_obj->f_dst = l5;
    ...
    if (l0.tag == 821u) {
        ...
        vader_obj_header_init(_a9_obj, 821u);
        _a9_obj->f_span = l3;
        _a9_obj->f_target = l4;
        _a9_obj->f_field = l13;
        _a9_obj->f_value = l7;
    ...
    if (l0.tag == 803u) {
        ...
        vader_obj_header_init(_a10_obj, 803u);
        _a10_obj->f_span = l3;
        _a10_obj->f_dst = l4;
    ...
    if (l0.tag == 827u) {
        ...
        vader_obj_header_init(_a16_obj, 827u);
        _a16_obj->f_span = l3;
        _a16_obj->f_dst = l4;
        _a16_obj->f_type = l5;
    ...
    if (l0.tag == 805u) {
        ...
        vader_obj_header_init(_a17_obj, 805u);
        _a17_obj->f_span = l3;
        _a17_obj->f_dst = l4;
        _a17_obj->f_type = l5;
    ...
    if (l0.tag == 829u) {
        ...
        vader_obj_header_init(_a20_obj, 829u);
        _a20_obj->f_span = l3;
        _a20_obj->f_dst = l4;
        _a20_obj->f_type = l5;
    ...
    if (l0.tag == 812u) {
        ...
        vader_obj_header_init(_a21_obj, 812u);
        _a21_obj->f_span = l3;
        _a21_obj->f_dst = l4;
        _a21_obj->f_value = l7;
        _a21_obj->f_type = l5;
    ...
    if (l0.tag == 814u) {
        ...
        vader_obj_header_init(_a22_obj, 814u);
        _a22_obj->f_span = l3;
        _a22_obj->f_dst = l4;
        _a22_obj->f_value = l7;
    ...
    if (l0.tag == 823u) {
        ...
        vader_obj_header_init(_a26_obj, 823u);
        _a26_obj->f_span = l3;
        _a26_obj->f_dst = l5;
        _a26_obj->f_name = l13;
        _a26_obj->f_args = l2;
    ...
    if (l0.tag == 819u) {
        ...
        vader_obj_header_init(_a27_obj, 819u);
        _a27_obj->f_span = l3;
        _a27_obj->f_value = l4;
        t0 = (void*) _a27_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_midir_reserve_cfg_extern(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGExternDecl_t*) l0)->f_origin)->f_symbol.tag == 877u) {
...
static void vader_midir_reserve_cfg_function(void* l0, void* l1) {
    ...
    l4 = ((int32_t) (size_t) t0);
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(123u, 0u, 13u, 1090u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    l7 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(40u, 0u, 13u, 494u);
    l8 = (void*) _a3_arr;
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_origin)->f_symbol.tag == 877u) {
...
static void vader_midir_reserve_cfg_struct(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = -(INT32_C(1));
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 877u) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 877u) {
        ...
        if (l6.tag == 166u) {
            ...
            l7 = l8;
            vader_array_t* _a1_arr = vader_array_new(37u, 0u, 13u, 490u);
            l10 = (void*) _a1_arr;
        ...
        l4 = (void*) _a6_obj;
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
        vader_array_t* _a7_arr = vader_array_new(37u, 0u, 13u, 490u);
        l10 = (void*) _a7_arr;
        l11 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_fields;
        l9 = ((vader_array_t*) l11)->length;
        l12 = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a12_obj, 498u);
    _a12_obj->f_trait_name = t4;
    l4 = (void*) _a12_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    vader_array_t* _a13_arr = vader_array_new(37u, 0u, 13u, 490u);
    l3 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a16_obj, 501u);
    _a16_obj->f_name = l5;
    ...
    l9 = INT32_C(0);
    {
        loop_53: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a8_arr = vader_array_new(40u, 0u, 13u, 494u);
                l20 = (void*) _a8_arr;
                ...
                vader_obj_header_init(_a9_obj, 492u);
                _a9_obj->f_name = l23;
...
static bool vader_midir_try_fuse_local_field(void* l0, int32_t l1, int32_t l2) {
    ...
    vader_obj_header_init(_a1_obj, 602u);
    _a1_obj->f_slot = l7;
...
static void* vader_midir_with_by_address(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a3_obj, 499u);
    _a3_obj->f_params = l5;
...
static vader_box_t vader_midir_with_dst(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 805u) {
        ...
        vader_obj_header_init(_a10_obj, 805u);
        _a10_obj->f_span = l3;
        _a10_obj->f_dst = l1;
        _a10_obj->f_type = l4;
    ...
    if (l0.tag == 817u) {
        ...
        vader_obj_header_init(_a11_obj, 817u);
        _a11_obj->f_span = l3;
        _a11_obj->f_dst = l1;
        _a11_obj->f_type = l4;
    ...
    if (l0.tag == 813u) {
        ...
        vader_obj_header_init(_a16_obj, 813u);
        _a16_obj->f_span = l3;
        _a16_obj->f_dst = l1;
        _a16_obj->f_cell = l6;
    ...
    if (l0.tag == 824u) {
        ...
        vader_obj_header_init(_a17_obj, 824u);
        _a17_obj->f_span = l3;
        _a17_obj->f_dst = l1;
...
static void* vader_midir_with_peephole_out(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 492u);
    _a0_obj->f_name = l2;
