...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1994u, l5);
        ...
        loop_8: {
            if ((l6 < l5)) {
                ...
                if (!(l7.tag == 755u)) {
                    ...
                    l13 = std_core_write_string_at(l12, l13, 964u);
                ...
                if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) t4)->f_symbol)->f_kind != INT32_C(0)) {
                    ...
                    l21 = std_core_write_string_at(l20, l21, 997u);
                ...
                _a2_obj->f_name = 561u;
                l23 = (void*) _a2_obj;
                l24 = vader_midir_fresh_tmp(l0, 1581u, vader_ref_box(l23));
                t4 = l7.payload.obj;
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_275: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2399u);
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2085u, l7);
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2162u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2165u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2250u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2251u, l1, vader_box_obj(0u, NULL));
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2357u, l5);
        l3 = vader_box_i32(169u, t2);
    }
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
            ...
            if (l7.tag == 169u) {
                ...
                if (l7.tag == 169u) {
                    ...
                    if (l7.tag == 169u) {
                        ...
                        l6 = std_core_write_string_at(l5, l6, 261u);
                        ...
                        l6 = std_core_write_string_at(l5, l6, 329u);
    ...
    if (l1.tag == 831u) {
        ...
        if (l7.tag == 169u) {
            ...
            l18 = ((int64_t) (int32_t) t2);
            l6 = std_core_write_int(l5, l6, l18);
            l6 = std_core_write_string_at(l5, l6, 336u);
            t3 = std_core_finish_buffer(l5, l6);
            vader_host_std_abort_panic(t3);
        }
    ...
    if (l1.tag == 830u) {
        ...
        if (l7.tag == 169u) {
            ...
            l18 = ((int64_t) (int32_t) t2);
            l6 = std_core_write_int(l5, l6, l18);
            l6 = std_core_write_string_at(l5, l6, 335u);
            t3 = std_core_finish_buffer(l5, l6);
            vader_host_std_abort_panic(t3);
        }
    ...
    if (l1.tag == 828u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_11(1835u, l16, 1004u, l17, 920u, l21, 92u, l22, 1041u, l23, 271u);
            vader_host_std_abort_panic(t3);
        } else {
        }
    ...
    if (l1.tag == 829u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1835u, l16, 1004u, l17, 957u, l21, 272u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
    ...
    if (l1.tag == 832u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1837u, l16, 957u, l17, 274u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    l4 = std_core_write_string_at(l5, l4, 239u);
    l4 = std_core_write_string_at(l5, l4, l3);
    l4 = std_core_write_string_at(l5, l4, 858u);
    t0 = ((vader_array_t*) ((vader_struct_vader_midir_FnCtx_t*) l0)->f_locals)->length;
