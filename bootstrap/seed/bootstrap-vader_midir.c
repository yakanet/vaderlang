...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1162u, l6);
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1977u, l5);
    ...
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 752u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if (t1) {
                ...
                t2 = vader_midir_fresh_tmp(l0, 1291u, l5);
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1393u, l2);
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1536u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (l4.tag == 709u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1378u, l4);
...
static vader_box_t vader_midir_build_string_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1386u, l5);
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2190u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2193u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2280u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2281u, l1, vader_box_obj(0u, NULL));
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2394u, l5);
        l3 = vader_box_i32(166u, t2);
    }
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_62: {
                        if ((l16 < l15)) {
                            ...
                            vader_struct___lambda_env_2868_t* _a18_obj = (vader_struct___lambda_env_2868_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2868_t));
                            ...
                            _a19_closure->code = (void*) &vader_fn_lift_1786;
                            _a19_closure->env = t0;
                ...
                vader_struct___lambda_env_2871_t* _a20_obj = (vader_struct___lambda_env_2871_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2871_t));
                ...
                _a21_closure->code = (void*) &vader_fn_lift_1787;
                _a21_closure->env = t0;
    ...
    vader_struct___lambda_env_2877_t* _a25_obj = (vader_struct___lambda_env_2877_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2877_t));
    ...
    _a26_closure->code = (void*) &vader_fn_lift_1788;
    _a26_closure->env = t0;
    l6 = (void*) _a26_closure;
    l6 = std_core_filled__MutableSet_i32_(l1, l6);
    vader_struct___lambda_env_2880_t* _a27_obj = (vader_struct___lambda_env_2880_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2880_t));
    ...
    _a28_closure->code = (void*) &vader_fn_lift_1789;
    _a28_closure->env = t0;
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    _a9_closure->code = (void*) &vader_fn_lift_1768;
    _a9_closure->env = t0;
    l2 = (void*) _a9_closure;
...
static void* vader_midir_count_uses(void* l0) {
    ...
    t0 = (void*) _a4_obj;
    l4 = vader_ref_box(t0);
    vader_struct___lambda_env_2852_t* _a5_obj = (vader_struct___lambda_env_2852_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2852_t));
    ...
    _a6_closure->code = (void*) &vader_fn_lift_1782;
    _a6_closure->env = t0;
    l1 = (void*) _a6_closure;
    l2 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    if (l1.tag == 825u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1818u, l16, 993u, l17, 953u, l21, 295u);
            vader_host_std_abort_panic(t3);
        } else {
        }
    ...
    if (l1.tag == 826u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1818u, l16, 993u, l17, 953u, l21, 296u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
    ...
    if (l1.tag == 829u) {
        ...
        if (l7.tag == 166u) {
            ...
            l18 = ((int64_t) (int32_t) t2);
            l6 = std_core_write_int(l5, l6, l18);
            l6 = std_core_write_string_at(l5, l6, 357u);
            t3 = std_core_finish_buffer(l5, l6);
            vader_host_std_abort_panic(t3);
        }
    ...
    if (l1.tag == 828u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1820u, l16, 953u, l17, 298u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 417u) {
        ...
        l2 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1495u);
        l3 = vader_midir_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l6)->f_decorators, 1481u);
                                ...
                                if (l23.tag == 166u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            vader_struct___lambda_env_2861_t* _a7_obj = (vader_struct___lambda_env_2861_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2861_t));
                                            ...
                                            _a8_closure->code = (void*) &vader_fn_lift_1784;
                                            _a8_closure->env = t2;
                                    ...
                                    vader_struct___lambda_env_2861_t* _a11_obj = (vader_struct___lambda_env_2861_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2861_t));
                                    ...
                                    vader_fn_t* _a12_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
                                    vader_obj_header_init(_a12_closure, 139u);
                                    _a12_closure->code = (void*) &vader_fn_lift_1784;
                                    _a12_closure->env = t2;
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    _a1_closure->code = (void*) &vader_fn_lift_1765;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    vader_struct___lambda_env_2901_t* _a3_obj = (vader_struct___lambda_env_2901_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2901_t));
    ...
    _a4_closure->code = (void*) &vader_fn_lift_1791;
    _a4_closure->env = t0;
    t0 = (void*) _a4_closure;
    ...
    vader_struct___lambda_env_2909_t* _a9_obj = (vader_struct___lambda_env_2909_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2909_t));
    ...
    _a10_closure->code = (void*) &vader_fn_lift_1792;
    _a10_closure->env = t0;
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l17) {
                    ...
                    vader_struct___lambda_env_2912_t* _a20_obj = (vader_struct___lambda_env_2912_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2912_t));
                    ...
                    vader_fn_t* _a21_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
                    vader_obj_header_init(_a21_closure, 139u);
                    _a21_closure->code = (void*) &vader_fn_lift_1793;
                    _a21_closure->env = t0;
