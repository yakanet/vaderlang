...
void* vader_midir_annotate_escape(void* l0) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_30: {
            if ((l8 >= l7)) {
                ...
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 797u);
                l11 = (void*) _a7_arr;
                ...
                vader_obj_header_init(_a11_obj, 799u);
    ...
    vader_obj_header_init(_a12_obj, 801u);
    ...
    vader_obj_header_init(_a13_obj, 811u);
    ...
    vader_obj_header_init(_a14_obj, 794u);
...
static void* vader_midir_annotate_function(void* l0) {
    ...
    vader_obj_header_init(_a12_obj, 379u);
    _a12_obj->f_inner = t0;
    l13 = (void*) _a12_obj;
    ...
    l17 = false;
    vader_array_t* _a19_arr = vader_array_new(68u, 0u, 13u, 795u);
    l2 = (void*) _a19_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_321: {
            if ((l5 < l4)) {
                ...
                l20 = false;
                vader_array_t* _a21_arr = vader_array_new(133u, 0u, 13u, 1171u);
                l21 = (void*) _a21_arr;
                    ...
                    loop_341: {
                        if ((l8 < l7)) {
                            ...
                            if (l9.tag == 840u) {
                                ...
                                vader_obj_header_init(_a23_obj, 840u);
                                _a23_obj->f_span = l30;
                                _a23_obj->f_dst = l31;
                                _a23_obj->f_type = l16;
                            ...
                            if (l9.tag == 817u) {
                                ...
                                vader_obj_header_init(_a24_obj, 817u);
                                _a24_obj->f_span = l44;
                                _a24_obj->f_dst = l45;
                                _a24_obj->f_type = l46;
                            ...
                            if (l9.tag == 833u) {
                                ...
                                vader_obj_header_init(_a25_obj, 833u);
                                _a25_obj->f_span = l55;
                ...
                vader_obj_header_init(_a26_obj, 795u);
                _a26_obj->f_id = l61;
    ...
    vader_obj_header_init(_a27_obj, 797u);
...
static uint64_t vader_midir_bc_value_bits(vader_box_t l0, vader_string_t l1) {
    ...
    vader_host_std_abort_panic(1874u);
...
static vader_box_t vader_midir_build_array_len(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1810u, l3);
    ...
    vader_obj_header_init(_a0_obj, 816u);
    _a0_obj->f_span = l5;
    _a0_obj->f_dst = l4;
    _a0_obj->f_target = l2;
...
static vader_box_t vader_midir_build_array_lit(void* l0, void* l1) {
    ...
    l7 = vader_midir_fresh_tmp(l0, 1199u, l6);
    ...
    vader_obj_header_init(_a2_obj, 817u);
    _a2_obj->f_span = l3;
    _a2_obj->f_dst = l7;
    _a2_obj->f_type = l6;
    _a2_obj->f_length = l9;
...
static vader_box_t vader_midir_build_array_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2028u, l5);
...
static void vader_midir_build_assign(void* l0, void* l1) {
    ...
    if (l2.tag == 756u) {
        ...
        vader_obj_header_init(_a1_obj, 833u);
        _a1_obj->f_span = l3;
        _a1_obj->f_target = l4;
        _a1_obj->f_field = l8;
        _a1_obj->f_value = l7;
    ...
    if (l2.tag == 761u) {
        ...
        vader_obj_header_init(_a2_obj, 819u);
        _a2_obj->f_span = l3;
        _a2_obj->f_target = l4;
        _a2_obj->f_index = l7;
        _a2_obj->f_value = l10;
...
static vader_box_t vader_midir_build_call(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 759u) {
        ...
        if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l2)->f_symbol)->f_kind == INT32_C(0)) {
            ...
            if ((l5.tag == 382u || l5.tag == 379u || l5.tag == 380u || l5.tag == 381u)) {
                l6 = l5.payload.obj;
            ...
            if (t1) {
                ...
                t2 = vader_midir_fresh_tmp(l0, 1332u, l9);
    ...
    if (t1) {
        ...
        l9 = ((vader_struct_vader_lower_LoweredCall_t*) l1)->f_type;
        t2 = vader_midir_fresh_tmp(l0, 1343u, l9);
        l5 = vader_box_i32(172u, t2);
    }
...
static vader_box_t vader_midir_build_cast(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1361u, l3);
...
static vader_box_t vader_midir_build_cell_get(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1363u, l3);
...
static vader_box_t vader_midir_build_cell_new(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1362u, l3);
...
void* vader_midir_build_cfg_project(void* l0) {
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a4_obj, 801u);
            ...
            vader_array_t* _a8_arr = vader_array_new(70u, 0u, 13u, 797u);
            l12 = (void*) _a8_arr;
            vader_array_t* _a9_arr = vader_array_new(69u, 0u, 13u, 796u);
            l13 = (void*) _a9_arr;
            vader_array_t* _a10_arr = vader_array_new(74u, 0u, 13u, 802u);
            l14 = (void*) _a10_arr;
            ...
            vader_obj_header_init(_a12_obj, 799u);
    ...
    vader_obj_header_init(_a13_obj, 801u);
...
static vader_box_t vader_midir_build_data_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 1435u, l2);
...
static vader_box_t vader_midir_build_expr(void* l0, vader_box_t l1) {
    ...
    if (l1.tag == 762u) {
        ...
        vader_obj_header_init(_a0_obj, 807u);
        _a0_obj->f_value = t2;
        l3 = (void*) _a0_obj;
        t1 = l1.payload.obj;
    ...
    if (l1.tag == 757u) {
        ...
        vader_obj_header_init(_a1_obj, 806u);
        _a1_obj->f_value = t4;
        l3 = (void*) _a1_obj;
        t1 = l1.payload.obj;
    ...
    if (l1.tag == 742u) {
        ...
        vader_obj_header_init(_a2_obj, 804u);
        _a2_obj->f_value = t5;
        l3 = (void*) _a2_obj;
        t1 = l1.payload.obj;
    ...
    if (l1.tag == 768u) {
        ...
        vader_obj_header_init(_a3_obj, 808u);
        l3 = (void*) _a3_obj;
        t1 = l1.payload.obj;
    ...
    if (l1.tag == 749u) {
        ...
        vader_obj_header_init(_a4_obj, 805u);
    ...
    if (l1.tag == 772u) {
        ...
        vader_obj_header_init(_a5_obj, 809u);
        _a5_obj->f_index = l6;
        l3 = (void*) _a5_obj;
        t1 = l1.payload.obj;
        ...
        loop_8: {
            if ((l6 < l5)) {
                ...
                if (!(l7.tag == 759u)) {
                    ...
                    l13 = std_core_write_string_at(l12, l13, 1864u);
                    t2 = (l6 + INT64_C(1));
                    ...
                    l13 = std_core_write_string_at(l12, l13, 978u);
                ...
                if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) t4)->f_symbol)->f_kind != INT32_C(0)) {
                    ...
                    l21 = (size_t) (int64_t) INT64_C(0);
                    l21 = std_core_write_string_at(l20, l21, 1864u);
                    t2 = (l6 + INT64_C(1));
                    ...
                    l21 = std_core_write_string_at(l20, l21, 1011u);
                    l21 = std_core_write_string_at(l20, l21, l16);
                    l21 = std_core_write_string_at(l20, l21, 1068u);
                ...
                vader_obj_header_init(_a2_obj, 926u);
                _a2_obj->f_name = 572u;
                l23 = (void*) _a2_obj;
                l24 = vader_midir_fresh_tmp(l0, 1605u, vader_ref_box(l23));
                t4 = l7.payload.obj;
                ...
                vader_obj_header_init(_a3_obj, 834u);
                _a3_obj->f_span = l25;
                _a3_obj->f_dst = l24;
...
static vader_box_t vader_midir_build_field_access(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1576u, l3);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        if (l6.tag == 933u) {
            ...
            if (!(t3)) {
                l6 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_type;
                l3 = vader_midir_fresh_tmp(l0, 1899u, l6);
                ...
                vader_obj_header_init(_a1_obj, 824u);
                _a1_obj->f_span = l2;
                _a1_obj->f_dst = l3;
                _a1_obj->f_value = l7;
                _a1_obj->f_type = l6;
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_symbol)->f_kind == INT32_C(0)) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1606u, l4);
        l2 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_span;
        ...
        vader_obj_header_init(_a2_obj, 835u);
        _a2_obj->f_span = l2;
        _a2_obj->f_dst = l3;
    ...
    if (l4.tag == 716u) {
        ...
        l3 = vader_midir_fresh_tmp(l0, 1422u, l6);
        ...
        vader_obj_header_init(_a4_obj, 822u);
        _a4_obj->f_span = l8;
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    if (!(l2.tag == 0u)) {
        ...
        if (t2) {
            ...
            t1 = vader_midir_declare_local(l0, 1707u, l5, vader_box_obj(0u, NULL));
            l4 = vader_box_i32(172u, t1);
        }
    }
    ...
    if (!(l5.tag == 0u)) {
        if (!(((vader_struct_vader_lower_LoweredIf_t*) l1)->f_else_block.tag == 0u)) {
            ...
            if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
                ...
                vader_obj_header_init(_a2_obj, 852u);
...
static void* vader_midir_build_impl_table_from_vtable(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 606u);
    l3 = (void*) _a0_arr;
        ...
        loop_23: {
            if ((l8 < l7)) {
                ...
                if ((l12 < l13)) {
                    ...
                    vader_obj_header_init(_a7_obj, 606u);
                ...
                vader_obj_header_init(_a8_obj, 606u);
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_274: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2434u);
                                ...
                                vader_obj_header_init(_a12_obj, 606u);
...
static vader_box_t vader_midir_build_index(void* l0, void* l1) {
    ...
    l5 = vader_midir_fresh_tmp(l0, 1699u, l4);
...
static vader_box_t vader_midir_build_intrinsic_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 1750u, l4);
...
static void vader_midir_build_loop(void* l0, void* l1) {
    ...
    if (!(((vader_struct_vader_lower_LoweredLoop_t*) l1)->f_cond.tag == 0u)) {
        ...
        vader_obj_header_init(_a3_obj, 852u);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a5_obj, 852u);
        _a5_obj->f_span = ((vader_struct_vader_lower_LoweredLoop_t*) l1)->f_span;
        _a5_obj->f_target = l3;
        l2 = (void*) _a5_obj;
        vader_midir_terminate(l0, vader_ref_box(l2));
    }
    vader_array_t* _a6_arr = vader_array_new(76u, 0u, 13u, 846u);
    l2 = (void*) _a6_arr;
...
static vader_box_t vader_midir_build_make_closure(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1376u, l3);
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    if (l5) {
        ...
        if (!(l4.tag == 0u)) {
            if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
                ...
                vader_obj_header_init(_a1_obj, 838u);
                _a1_obj->f_span = l8;
                _a1_obj->f_dst = l6;
                _a1_obj->f_src = l3;
                l8 = (void*) _a1_obj;
        ...
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1778u, l4);
        l8 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_span;
        vader_struct_vader_midir_ConstBool_t* _a2_obj = (vader_struct_vader_midir_ConstBool_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ConstBool_t));
        vader_obj_header_init(_a2_obj, 804u);
        ...
        vader_obj_header_init(_a3_obj, 828u);
        _a3_obj->f_span = l8;
        _a3_obj->f_dst = l3;
        ...
        vader_obj_header_init(_a4_obj, 838u);
    ...
    if (l5) {
        ...
        vader_obj_header_init(_a6_obj, 804u);
        ...
        if (!(l4.tag == 0u)) {
            if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
                ...
                vader_obj_header_init(_a9_obj, 838u);
                _a9_obj->f_span = l8;
                _a9_obj->f_dst = l6;
                _a9_obj->f_src = l3;
                l8 = (void*) _a9_obj;
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a10_obj, 852u);
            ...
            if (l1.tag == 748u) {
                ...
                if (l1.tag == 754u) {
                    ...
                    if (!(l2.tag == 0u)) {
                        ...
                        vader_obj_header_init(_a2_obj, 831u);
                        _a2_obj->f_span = l5;
                        _a2_obj->f_value = l6;
                        l5 = (void*) _a2_obj;
                        vader_midir_emit(l0, vader_ref_box(l5));
                    ...
                    if (l1.tag == 753u) {
                        ...
                        vader_obj_header_init(_a3_obj, 830u);
                        _a3_obj->f_span = l5;
                        _a3_obj->f_count = l6;
                        l5 = (void*) _a3_obj;
                        vader_midir_emit(l0, vader_ref_box(l5));
                                ...
                                if (l1.tag == 765u) {
                                    ...
                                    if (l1.tag == 743u) {
                                        ...
                                        if (l1.tag == 751u) {
                                            ...
                                            if ((l1.tag == 739u || l1.tag == 784u)) {
                                                vader_host_std_abort_panic(1873u);
                                            } else {
                                                { vader_gc_top = gc_frame.prev; return; }
                                            }
                                        }
...
static vader_box_t vader_midir_build_string_slice(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 1429u, l5);
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2119u, l7);
    ...
    vader_obj_header_init(_a2_obj, 840u);
    _a2_obj->f_span = l3;
    _a2_obj->f_dst = l6;
    _a2_obj->f_type = l7;
    _a2_obj->f_fields = l2;
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2196u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2199u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2284u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2285u, l1, vader_box_obj(0u, NULL));
        l5 = vader_box_i32(172u, t2);
    }
...
static vader_box_t vader_midir_build_virtual_call(void* l0, void* l1) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_fresh_tmp(l0, 2391u, l5);
        l3 = vader_box_i32(172u, t2);
    }
...
static void* vader_midir_build_vtables_from_entries(void* l0, void* l1) {
    ...
    l3 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(44u, 0u, 13u, 660u);
    l4 = (void*) _a10_arr;
    l11 = l0;
        ...
        loop_96: {
            if ((l6 < l5)) {
                ...
                if (l18.tag == 179u) {
                    ...
                    vader_array_t* _a14_arr = vader_array_new(43u, 0u, 13u, 659u);
                    l21 = (void*) _a14_arr;
                    ...
                    vader_obj_header_init(_a15_obj, 659u);
                    ...
                    vader_obj_header_init(_a16_obj, 660u);
                    _a16_obj->f_key = l14;
...
static void vader_midir_cf_br(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 528u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
...
static void vader_midir_cf_end(void* l0, void* l1) {
    ...
    if ((size_t) l5 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
    l2 = vader_array_ref_load_obj(_a1_slotarr->buf, _a1_slotarr->offset + (size_t) l5);
    vader_array_t* _a2_arr = vader_array_new(79u, 0u, 13u, 851u);
    l6 = (void*) _a2_arr;
    t0 = (l4 - INT64_C(1));
    l4 = (size_t) (int64_t) t0;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void vader_midir_cf_if(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 605u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
    l3 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes;
    vader_struct_vader_midir_ScopeFrame_t* _a1_obj = (vader_struct_vader_midir_ScopeFrame_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ScopeFrame_t));
    vader_obj_header_init(_a1_obj, 851u);
    _a1_obj->f_kind = 1700u;
    _a1_obj->f_target_blk = l2;
    _a1_obj->f_opener_pc = l4;
    l5 = (void*) _a1_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l5));
...
static void vader_midir_cf_loop(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 618u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
    l3 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes;
    vader_struct_vader_midir_ScopeFrame_t* _a1_obj = (vader_struct_vader_midir_ScopeFrame_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ScopeFrame_t));
    vader_obj_header_init(_a1_obj, 851u);
    _a1_obj->f_kind = 1836u;
    _a1_obj->f_target_blk = l2;
    _a1_obj->f_opener_pc = l4;
    l5 = (void*) _a1_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l5));
...
static vader_box_t vader_midir_closure_header_type(vader_box_t l0) {
    ...
    if (l0.tag == 920u) {
        ...
        vader_array_t* _a0_arr = vader_array_new(134u, 0u, 13u, 1194u);
        l2 = (void*) _a0_arr;
        vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 167u);
        l3 = (void*) _a1_arr;
        vader_struct_vader_types_PrimitiveType_t* _a2_obj = (vader_struct_vader_types_PrimitiveType_t*) vader_gc_alloc(sizeof(vader_struct_vader_types_PrimitiveType_t));
        vader_obj_header_init(_a2_obj, 926u);
        _a2_obj->f_name = 2393u;
        l4 = (void*) _a2_obj;
        ...
        vader_obj_header_init(_a3_obj, 920u);
        _a3_obj->f_params = l2;
...
static void* vader_midir_compact_locals(void* l0) {
    ...
    l2 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(71u, 0u, 13u, 798u);
    l6 = (void*) _a16_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    ...
    vader_array_t* _a20_arr = vader_array_new(73u, 0u, 13u, 800u);
    l9 = (void*) _a20_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_273: {
            if ((l5 < l3)) {
                ...
                vader_obj_header_init(_a24_obj, 800u);
                _a24_obj->f_name = l22;
    ...
    vader_array_t* _a25_arr = vader_array_new(68u, 0u, 13u, 795u);
    l12 = (void*) _a25_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_329: {
            if ((l5 < l3)) {
                ...
                vader_array_t* _a28_arr = vader_array_new(133u, 0u, 13u, 1171u);
                l23 = (void*) _a28_arr;
                ...
                vader_obj_header_init(_a32_obj, 795u);
                _a32_obj->f_id = l20;
    ...
    vader_obj_header_init(_a33_obj, 797u);
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l9 >= l8)) {
                ...
                vader_obj_header_init(_a13_obj, 379u);
                _a13_obj->f_inner = t0;
                l17 = (void*) _a13_obj;
                l18 = l12;
...
static void* vader_midir_compute_escaping(void* l0, void* l1) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l8 < l7)) {
                ...
                if (((vader_struct_vader_midir_BasicBlock_t*) l6)->f_terminator.tag == 854u) {
    ...
    vader_obj_header_init(_a30_obj, 379u);
    _a30_obj->f_inner = t0;
    l5 = (void*) _a30_obj;
    l6 = l1;
    l9 = ((vader_struct_std_collections_MutableMap__i32__bool_t*) ((vader_struct_std_collections_MutableSet__i32_t*) l6)->f_inner)->f_ekeys;
    ...
    vader_obj_header_init(_a32_obj, 810u);
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(19u, 0u, 13u, 379u);
    t0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_repeat((vader_array_t*) t0, (size_t) l1);
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(19u, 0u, 13u, 379u);
    t0 = (void*) _a2_arr;
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                vader_obj_header_init(_a15_obj, 379u);
                _a15_obj->f_inner = t0;
                t0 = (void*) _a15_obj;
    ...
    vader_obj_header_init(_a33_obj, 379u);
    _a33_obj->f_inner = t0;
    l8 = (void*) _a33_obj;
    ...
    vader_obj_header_init(_a38_obj, 379u);
    _a38_obj->f_inner = t0;
    l10 = (void*) _a38_obj;
    l26 = true;
    {
    ...
    vader_obj_header_init(_a51_obj, 845u);
...
static int32_t vader_midir_cond_branch_merge(void* l0, int32_t l1, void* l2, int32_t l3) {
    ...
    if ((l6 >= INT32_C(0))) {
        ...
        if (l8) {
            ...
            l5 = (size_t) (int64_t) INT64_C(0);
            l5 = std_core_write_string_at(l4, l5, 1865u);
...
static void* vader_midir_convert_data_pool(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(123u, 0u, 13u, 1094u);
    l1 = (void*) _a0_arr;
    l2 = l0;
    l3 = ((vader_array_t*) l2)->length;
    l4 = (size_t) (int64_t) INT64_C(0);
            ...
            if ((l4 < l3)) {
                ...
                if (l5.tag == 788u) {
                    ...
                    if (l5.tag == 787u) {
                        ...
                        vader_obj_header_init(_a5_obj, 507u);
                        _a5_obj->f_kind = l14;
                        _a5_obj->f_items = l9;
                        ...
                        if (l5.tag == 705u) {
                            vader_array_t* _a6_arr = vader_array_new(125u, 0u, 13u, 1101u);
                            l17 = (void*) _a6_arr;
                            t0 = l5.payload.obj;
                            ...
                            vader_obj_header_init(_a8_obj, 498u);
...
static vader_box_t vader_midir_convert_function(void* l0, void* l1) {
    ...
    l2 = t0.payload.obj;
    vader_array_t* _a0_arr = vader_array_new(73u, 0u, 13u, 800u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(71u, 0u, 13u, 798u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 172u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 172u);
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_34: {
            if ((l9 < l8)) {
                ...
                vader_obj_header_init(_a7_obj, 798u);
                _a7_obj->f_name = l11;
                _a7_obj->f_type = l12;
                ...
                vader_obj_header_init(_a8_obj, 800u);
                _a8_obj->f_name = l17;
    ...
    vader_array_t* _a9_arr = vader_array_new(77u, 0u, 13u, 847u);
    l7 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(76u, 0u, 13u, 846u);
    l13 = (void*) _a10_arr;
    ...
    vader_obj_header_init(_a11_obj, 812u);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l4)->f_current.tag == 0u)) {
        ...
        if (((vader_struct_vader_midir_MutableBlock_t*) l5)->f_terminator.tag == 0u) {
            ...
            vader_obj_header_init(_a13_obj, 854u);
    ...
    vader_array_t* _a14_arr = vader_array_new(68u, 0u, 13u, 795u);
    l5 = (void*) _a14_arr;
    ...
    vader_obj_header_init(_a16_obj, 797u);
...
static int32_t vader_midir_declare_local(void* l0, vader_string_t l1, vader_box_t l2, vader_box_t l3) {
    ...
    vader_obj_header_init(_a0_obj, 798u);
    _a0_obj->f_name = l1;
    _a0_obj->f_type = l2;
    _a0_obj->f_symbol = l3;
    l6 = (void*) _a0_obj;
        ...
        loop_72: {
            if ((l4 >= INT64_C(0))) {
                ...
                if (l9 == l10) {
                    ...
                    vader_obj_header_init(_a3_obj, 848u);
...
static void* vader_midir_die_once(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(68u, 0u, 13u, 795u);
    l2 = (void*) _a0_arr;
    l3 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a4_obj, 797u);
...
static void vader_midir_drain_pending(void* l0, int32_t l1, bool l2, int32_t l3, int32_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(78u, 0u, 13u, 848u);
    l6 = (void*) _a0_arr;
    l7 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_pending;
    l8 = ((vader_array_t*) l7)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
...
void* vader_midir_eliminate_dead_cfg(void* l0) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l6 >= l5)) {
                ...
                vader_obj_header_init(_a9_obj, 799u);
    ...
    vader_obj_header_init(_a10_obj, 801u);
...
static int32_t vader_midir_emit_block_contents(void* l0, int32_t l1, int32_t l2) {
    ...
    if (l6.tag == 854u) {
        ...
        if (!(((vader_struct_vader_midir_TermReturn_t*) t1)->f_value.tag == 0u)) {
            ...
            if (l12) {
                ...
                vader_obj_header_init(_a3_obj, 527u);
        ...
        if ((t5 > INT64_C(0))) {
            ...
            if (!(l9.tag == 0u)) {
                ...
                vader_obj_header_init(_a5_obj, 626u);
                _a5_obj->f_value = l9;
                l14 = (void*) _a5_obj;
                vader_array_t* _a6_slotarr = ((vader_array_t*) l3);
                if (_a6_slotarr->buf != NULL && _a6_slotarr->buf->header.forward != NULL) { _a6_slotarr->buf = vader_array_buf_forward(_a6_slotarr->buf); }
        ...
        vader_obj_header_init(_a7_obj, 625u);
        l3 = (void*) _a7_obj;
        t1 = l6.payload.obj;
        l14 = ((vader_struct_vader_midir_TermReturn_t*) t1)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l3), l14);
    ...
    if (l6.tag == 855u) {
        ...
        if (t2) {
            ...
            vader_obj_header_init(_a9_obj, 625u);
            l3 = (void*) _a9_obj;
            t1 = l6.payload.obj;
            l14 = ((vader_struct_vader_midir_TermUnreachable_t*) t1)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l3), l14);
...
void* vader_midir_emit_bytecode_from_cfg(void* l0, vader_string_t l1, void* l2) {
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_283: {
                        if ((l13 < l12)) {
                            ...
                            l20 = -(INT32_C(1));
                            if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l17)->f_origin)->f_symbol.tag == 890u) {
    ...
    vader_obj_header_init(_a40_obj, 533u);
    _a40_obj->f_name = l1;
    _a40_obj->f_types = l4;
...
static void vader_midir_emit_cfg_function_body(void* l0, int32_t l1, void* l2, void* l3, bool l4) {
    ...
    vader_array_t* _a5_arr = vader_array_new(79u, 0u, 13u, 851u);
    l22 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(78u, 0u, 13u, 848u);
    l23 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 172u);
    l24 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a11_obj, 379u);
    _a11_obj->f_inner = t2;
    l24 = (void*) _a11_obj;
    ...
    vader_obj_header_init(_a12_obj, 813u);
    _a12_obj->f_fn_ = l0;
...
static int32_t vader_midir_emit_const(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l4 = vader_midir_fresh_tmp(l0, 1778u, l1);
...
static void vader_midir_emit_const_instr(void* l0, void* l1, int64_t l2) {
    ...
    if (l3.tag == 807u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a1_obj, 570u);
        ...
        if (l3.tag == 806u) {
            ...
            if (l3.tag == 804u) {
                ...
                vader_obj_header_init(_a3_obj, 522u);
                _a3_obj->f_value = t1;
                l4 = (void*) _a3_obj;
                l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
                vader_midir_push_emit(l0, vader_ref_box(l4), l5);
                ...
                if (l3.tag == 805u) {
                    ...
                    vader_obj_header_init(_a4_obj, 538u);
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    if (l1.tag == 822u) {
        ...
        if (l6.tag == 172u) {
            ...
            if (l6.tag == 172u) {
                ...
                vader_obj_header_init(_a7_obj, 535u);
                ...
                if (l6.tag == 172u) {
                    ...
                    vader_obj_header_init(_a8_obj, 536u);
                    _a8_obj->f_index = t2;
                    l3 = (void*) _a8_obj;
                    t0 = l1.payload.obj;
                    l9 = ((vader_struct_vader_midir_InstrCall_t*) t0)->f_span;
                    ...
                    if (l6.tag == 172u) {
                        ...
                        vader_obj_header_init(_a9_obj, 536u);
                        _a9_obj->f_index = t2;
                        l3 = (void*) _a9_obj;
                        t0 = l1.payload.obj;
                        l9 = ((vader_struct_vader_midir_InstrCall_t*) t0)->f_span;
    ...
    if (l1.tag == 823u) {
        ...
        vader_obj_header_init(_a13_obj, 537u);
    ...
    if (l1.tag == 835u) {
        ...
        if (l6.tag == 172u) {
            ...
            vader_obj_header_init(_a14_obj, 564u);
            ...
            l5 = (size_t) (int64_t) INT64_C(0);
            l5 = std_core_write_string_at(l3, l5, 1872u);
            l5 = std_core_write_string_at(l3, l5, l15);
            l5 = std_core_write_string_at(l3, l5, 267u);
            t0 = l1.payload.obj;
    ...
    if (l1.tag == 834u) {
        ...
        if (l6.tag == 172u) {
            ...
            vader_obj_header_init(_a15_obj, 563u);
            ...
            l5 = (size_t) (int64_t) INT64_C(0);
            l5 = std_core_write_string_at(l3, l5, 1871u);
            l5 = std_core_write_string_at(l3, l5, l15);
            l5 = std_core_write_string_at(l3, l5, 267u);
            t0 = l1.payload.obj;
    ...
    if (l1.tag == 844u) {
        ...
        vader_obj_header_init(_a18_obj, 658u);
    ...
    if (l1.tag == 832u) {
        ...
        if (l18.tag == 0u) {
            ...
            t3 = concat_11(1866u, l15, 1018u, l16, 934u, l20, 93u, l21, 1056u, l22, 278u);
            vader_host_std_abort_panic(t3);
        }
        ...
        if (!(l23)) {
            ...
            vader_obj_header_init(_a20_obj, 640u);
        ...
        if (t5) {
            ...
            vader_obj_header_init(_a21_obj, 622u);
    ...
    if (l1.tag == 833u) {
        ...
        if (l18.tag == 0u) {
            ...
            t3 = concat_7(1866u, l15, 1018u, l16, 971u, l20, 279u);
            vader_host_std_abort_panic(t3);
        }
        t4 = ((size_t) l18.payload.i);
        l14 = ((int32_t) (size_t) t4);
        ...
        vader_obj_header_init(_a23_obj, 642u);
    ...
    if (l1.tag == 815u) {
        ...
        if (l6.tag == 0u) {
            ...
            vader_obj_header_init(_a25_obj, 489u);
            ...
            if (t5) {
                ...
                vader_obj_header_init(_a26_obj, 622u);
    ...
    if (l1.tag == 816u) {
        ...
        vader_obj_header_init(_a29_obj, 490u);
    ...
    if (l1.tag == 818u) {
        ...
        vader_obj_header_init(_a31_obj, 492u);
    ...
    if (l1.tag == 820u) {
        ...
        vader_obj_header_init(_a32_obj, 497u);
    ...
    if (l1.tag == 839u) {
        ...
        vader_obj_header_init(_a33_obj, 639u);
        l3 = (void*) _a33_obj;
        t0 = l1.payload.obj;
    ...
    if (l1.tag == 840u) {
        ...
        vader_obj_header_init(_a36_obj, 641u);
    ...
    if (l1.tag == 817u) {
        ...
        vader_obj_header_init(_a39_obj, 491u);
    ...
    if (l1.tag == 829u) {
        ...
        vader_obj_header_init(_a40_obj, 540u);
    ...
    if (l1.tag == 841u) {
        ...
        vader_obj_header_init(_a41_obj, 643u);
    ...
    if (l1.tag == 842u) {
        ...
        vader_obj_header_init(_a42_obj, 644u);
    ...
    if (l1.tag == 824u) {
        ...
        if (l4 != l14) {
            ...
            if (l6.tag == 0u) {
                ...
                vader_obj_header_init(_a44_obj, 622u);
                ...
                if (t5) {
                    ...
                    vader_obj_header_init(_a45_obj, 539u);
                    ...
                    vader_obj_header_init(_a46_obj, 622u);
    ...
    if (l1.tag == 826u) {
        ...
        vader_obj_header_init(_a47_obj, 641u);
    ...
    if (l1.tag == 825u) {
        ...
        if (!(l23)) {
            ...
            vader_obj_header_init(_a48_obj, 640u);
    ...
    if (l1.tag == 827u) {
        ...
        vader_obj_header_init(_a49_obj, 642u);
    ...
    if (l1.tag == 837u) {
        ...
        if (l6.tag == 172u) {
            ...
            vader_obj_header_init(_a50_obj, 619u);
            ...
            l5 = (size_t) (int64_t) INT64_C(0);
            l5 = std_core_write_string_at(l3, l5, 1870u);
            l5 = std_core_write_string_at(l3, l5, l15);
            l5 = std_core_write_string_at(l3, l5, 267u);
            t0 = l1.payload.obj;
    ...
    if (l1.tag == 836u) {
        ...
        if (l6.tag == 0u) {
            ...
            l16 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1868u, l15, 971u, l16, 281u);
            vader_host_std_abort_panic(t3);
        }
        t0 = l1.payload.obj;
        l3 = ((vader_struct_vader_midir_InstrIntrinsic_t*) t0)->f_span;
    ...
    if (l1.tag == 831u) {
        ...
        vader_obj_header_init(_a53_obj, 543u);
        l3 = (void*) _a53_obj;
        t0 = l1.payload.obj;
    ...
    if (l1.tag == 830u) {
        ...
        vader_obj_header_init(_a54_obj, 542u);
        _a54_obj->f_count = t2;
        l3 = (void*) _a54_obj;
        t0 = l1.payload.obj;
...
static void vader_midir_emit_set(void* l0, int32_t l1, void* l2) {
    ...
    vader_obj_header_init(_a1_obj, 616u);
    _a1_obj->f_slot = t1;
    l3 = (void*) _a1_obj;
    vader_midir_push_emit(l0, vader_ref_box(l3), l2);
    { vader_gc_top = gc_frame.prev; return; }
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    l5 = 0u;
    l6 = -(INT32_C(1));
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 422u) {
        ...
        l2 = toolchain_ast_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l7)->f_decorators, 1537u);
        l3 = toolchain_ast_decorators_have(((vader_struct_toolchain_ast_FnDecl_t*) l7)->f_decorators, 1523u);
...
static void* vader_midir_fold_moves(void* l0) {
    ...
    vader_array_t* _a6_arr = vader_array_new(68u, 0u, 13u, 795u);
    l3 = (void*) _a6_arr;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_56: {
            if ((l6 < l5)) {
                ...
                vader_obj_header_init(_a8_obj, 795u);
                _a8_obj->f_id = l7;
    ...
    vader_obj_header_init(_a9_obj, 797u);
...
static void* vader_midir_fold_moves_in_block(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(133u, 0u, 13u, 1171u);
    l3 = (void*) _a0_arr;
...
static void* vader_midir_freeze_block(void* l0) {
    ...
    if (((vader_struct_vader_midir_MutableBlock_t*) l0)->f_terminator.tag == 0u) {
        ...
        vader_obj_header_init(_a1_obj, 795u);
        _a1_obj->f_id = l1;
    ...
    vader_obj_header_init(_a2_obj, 795u);
    _a2_obj->f_id = l1;
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = std_core_write_string_at(l5, l4, 870u);
    t0 = ((vader_array_t*) ((vader_struct_vader_midir_FnCtx_t*) l0)->f_locals)->length;
...
static bool vader_midir_instruction_has_side_effect(vader_box_t l0) {
    return (l0.tag == 818u || l0.tag == 819u || l0.tag == 822u || l0.tag == 823u || l0.tag == 827u || l0.tag == 833u || l0.tag == 836u || l0.tag == 844u);
}
...
static vader_box_t vader_midir_intrinsic_op_for_name(vader_string_t l0) {
    ...
    if (l0 == 2022u) {
        ...
        vader_obj_header_init(_a0_obj, 627u);
        t0 = (void*) _a0_obj;
    ...
    if (l0 == 1232u) {
        ...
        vader_obj_header_init(_a1_obj, 495u);
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1225u) {
    ...
    if (l0 == 1206u) {
        ...
        vader_obj_header_init(_a3_obj, 488u);
        t0 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1229u) {
    ...
    if (l0 == 1203u) {
        ...
        vader_obj_header_init(_a5_obj, 487u);
        t0 = (void*) _a5_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = vader_box_obj(0u, NULL);
    ...
    if (l0.tag == 917u) {
        ...
        if (l0.tag == 928u) {
            ...
            if (l0.tag == 930u) {
                ...
                if ((l0.tag == 916u || l0.tag == 918u || l0.tag == 919u || l0.tag == 920u || l0.tag == 921u || l0.tag == 922u || l0.tag == 923u || l0.tag == 924u || l0.tag == 926u || l0.tag == 927u || l0.tag == 929u || l0.tag == 931u || l0.tag == 932u || l0.tag == 933u || l0.tag == 934u)) {
                    l1 = false;
                } else {
...
static bool vader_midir_last_op_exits(void* l0) {
    ...
    return (t2.tag == 528u || t2.tag == 625u || t2.tag == 626u);
}
...
static vader_box_t vader_midir_lowered_to_bc_value(vader_box_t l0) {
    ...
    if (l0.tag == 776u) {
        vader_array_t* _a1_arr = vader_array_new(125u, 0u, 13u, 1101u);
        l1 = (void*) _a1_arr;
        t0 = l0.payload.obj;
        ...
        vader_obj_header_init(_a3_obj, 517u);
    ...
    if (l0.tag == 735u) {
        vader_array_t* _a4_arr = vader_array_new(125u, 0u, 13u, 1101u);
        l1 = (void*) _a4_arr;
        t0 = l0.payload.obj;
        ...
        vader_obj_header_init(_a6_obj, 514u);
    ...
    vader_obj_header_init(_a7_obj, 515u);
    _a7_obj->f_kind = l7;
    _a7_obj->f_bits = l8;
    t0 = (void*) _a7_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void* vader_midir_make_extern_decl(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_11: {
            if ((l4 < l3)) {
                ...
                vader_obj_header_init(_a2_obj, 800u);
                _a2_obj->f_name = l6;
                _a2_obj->f_symbol = l7;
                _a2_obj->f_type = l8;
                _a2_obj->f_local = l9;
    ...
    vader_obj_header_init(_a3_obj, 796u);
...
static void* vader_midir_make_struct_decl(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(75u, 0u, 13u, 803u);
    l1 = (void*) _a0_arr;
    ...
    vader_obj_header_init(_a3_obj, 802u);
    _a3_obj->f_mangled = l6;
    _a3_obj->f_fields = l1;
    _a3_obj->f_origin = l2;
    t1 = (void*) _a3_obj;
...
static int32_t vader_midir_new_block(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a1_obj, 847u);
    _a1_obj->f_id = l2;
...
static void* vader_midir_new_project_ctx(void* l0) {
                    ...
                    loop_57: {
                        if ((l11 < l10)) {
                            ...
                            if (l12.tag == 758u) {
                                ...
                                if (t4) {
                                    t1 = l12.payload.obj;
                                    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) t1)->f_origin)->f_symbol.tag == 890u) {
                                        t1 = l12.payload.obj;
                                        ...
                                        vader_obj_header_init(_a11_obj, 376u);
                                        ...
                                        vader_obj_header_init(_a12_obj, 382u);
                                        _a12_obj->f_inner = t1;
                                        l17 = (void*) _a12_obj;
                                        t1 = l12.payload.obj;
                                        ...
                                        l19 = (size_t) (int64_t) INT64_C(0);
                                        {
                                            loop_109: {
                                                if ((l19 < l18)) {
                                                    ...
                                                    if (((vader_struct_vader_lower_LoweredParam_t*) t1)->f_type.tag == 920u) {
    ...
    vader_obj_header_init(_a19_obj, 849u);
...
static void* vader_midir_no_hints(void) {
    ...
    vader_obj_header_init(_a9_obj, 380u);
    _a9_obj->f_inner = t0;
    l1 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 172u);
    l2 = (void*) _a10_arr;
    ...
    vader_obj_header_init(_a14_obj, 379u);
    _a14_obj->f_inner = t0;
    l2 = (void*) _a14_obj;
    ...
    vader_obj_header_init(_a15_obj, 850u);
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    vader_array_t* _a22_arr = vader_array_new(133u, 0u, 13u, 1171u);
    l6 = (void*) _a22_arr;
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_187: {
...
static vader_box_t vader_midir_remap_instr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 821u) {
        ...
        vader_obj_header_init(_a2_obj, 821u);
        _a2_obj->f_span = l2;
        _a2_obj->f_dst = l3;
        _a2_obj->f_op = l7;
        _a2_obj->f_lhs = l6;
    ...
    if (l0.tag == 843u) {
        ...
        vader_obj_header_init(_a3_obj, 843u);
        _a3_obj->f_span = l2;
        _a3_obj->f_dst = l3;
        _a3_obj->f_op = l7;
    ...
    if (l0.tag == 844u) {
        ...
        vader_obj_header_init(_a6_obj, 844u);
        _a6_obj->f_span = l2;
        _a6_obj->f_dst = l4;
    ...
    if (l0.tag == 835u) {
        ...
        vader_obj_header_init(_a7_obj, 835u);
        _a7_obj->f_span = l2;
        _a7_obj->f_dst = l3;
    ...
    if (l0.tag == 834u) {
        ...
        vader_obj_header_init(_a8_obj, 834u);
        _a8_obj->f_span = l2;
        _a8_obj->f_dst = l3;
    ...
    if (l0.tag == 832u) {
        ...
        vader_obj_header_init(_a9_obj, 832u);
        _a9_obj->f_span = l2;
        _a9_obj->f_dst = l3;
        _a9_obj->f_target = l6;
        _a9_obj->f_field = l12;
    ...
    if (l0.tag == 833u) {
        ...
        vader_obj_header_init(_a10_obj, 833u);
        _a10_obj->f_span = l2;
    ...
    if (l0.tag == 816u) {
        ...
        vader_obj_header_init(_a13_obj, 816u);
        _a13_obj->f_span = l2;
        _a13_obj->f_dst = l3;
    ...
    if (l0.tag == 818u) {
        ...
        vader_obj_header_init(_a14_obj, 818u);
        _a14_obj->f_span = l2;
    ...
    if (l0.tag == 820u) {
        ...
        vader_obj_header_init(_a15_obj, 820u);
        _a15_obj->f_span = l2;
        _a15_obj->f_dst = l3;
        _a15_obj->f_type = l4;
    ...
    if (l0.tag == 839u) {
        ...
        vader_obj_header_init(_a16_obj, 839u);
        _a16_obj->f_span = l2;
        _a16_obj->f_dst = l3;
        _a16_obj->f_type = l4;
    ...
    if (l0.tag == 840u) {
        ...
        vader_obj_header_init(_a17_obj, 840u);
        _a17_obj->f_span = l2;
        _a17_obj->f_dst = l3;
        _a17_obj->f_type = l4;
    ...
    if (l0.tag == 817u) {
        ...
        vader_obj_header_init(_a18_obj, 817u);
        _a18_obj->f_span = l2;
        _a18_obj->f_dst = l3;
        _a18_obj->f_type = l4;
    ...
    if (l0.tag == 829u) {
        ...
        vader_obj_header_init(_a19_obj, 829u);
        _a19_obj->f_span = l2;
        _a19_obj->f_dst = l3;
        _a19_obj->f_type = l4;
    ...
    if (l0.tag == 841u) {
        ...
        vader_obj_header_init(_a20_obj, 841u);
        _a20_obj->f_span = l2;
        _a20_obj->f_dst = l3;
        _a20_obj->f_value = l6;
    ...
    if (l0.tag == 842u) {
        ...
        vader_obj_header_init(_a21_obj, 842u);
        _a21_obj->f_span = l2;
        _a21_obj->f_dst = l3;
        _a21_obj->f_type = l4;
    ...
    if (l0.tag == 824u) {
        ...
        vader_obj_header_init(_a22_obj, 824u);
        _a22_obj->f_span = l2;
        _a22_obj->f_dst = l3;
        _a22_obj->f_value = l6;
        _a22_obj->f_type = l4;
    ...
    if (l0.tag == 826u) {
        ...
        vader_obj_header_init(_a23_obj, 826u);
        _a23_obj->f_span = l2;
        _a23_obj->f_dst = l3;
        _a23_obj->f_value = l6;
    ...
    if (l0.tag == 827u) {
        ...
        vader_obj_header_init(_a25_obj, 827u);
        _a25_obj->f_span = l2;
        _a25_obj->f_cell = l3;
        _a25_obj->f_value = l6;
    ...
    if (l0.tag == 837u) {
        ...
        vader_obj_header_init(_a26_obj, 837u);
        _a26_obj->f_span = l2;
        _a26_obj->f_dst = l3;
    ...
    if (l0.tag == 836u) {
        ...
        vader_obj_header_init(_a27_obj, 836u);
        _a27_obj->f_span = l2;
        _a27_obj->f_dst = l4;
        _a27_obj->f_name = l12;
        _a27_obj->f_args = l9;
    ...
    if (l0.tag == 831u) {
        ...
        vader_obj_header_init(_a28_obj, 831u);
        _a28_obj->f_span = l2;
        _a28_obj->f_value = l3;
        t0 = (void*) _a28_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_midir_reserve_cfg_extern(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGExternDecl_t*) l0)->f_origin)->f_symbol.tag == 890u) {
...
static void vader_midir_reserve_cfg_function(void* l0, void* l1) {
    ...
    l4 = ((int32_t) (size_t) t0);
    vader_array_t* _a0_arr = vader_array_new(121u, 0u, 13u, 1085u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(126u, 0u, 13u, 1115u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 172u);
    l7 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(40u, 0u, 13u, 505u);
    l8 = (void*) _a3_arr;
    ...
    vader_obj_header_init(_a4_obj, 503u);
    _a4_obj->f_name = l10;
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_origin)->f_symbol.tag == 890u) {
...
static void vader_midir_reserve_cfg_struct(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = -(INT32_C(1));
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 890u) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 890u) {
        ...
        l7 = std_collections_get__string__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_key, l6);
        ...
        if (l7.tag == 172u) {
            ...
            std_collections_put__string__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_key, l6, l8);
            ...
            vader_obj_header_init(_a1_obj, 509u);
        ...
        l11 = (size_t) (int64_t) INT64_C(0);
        {
            loop_100: {
                if ((l11 < l9)) {
                    ...
                    vader_obj_header_init(_a4_obj, 501u);
                    _a4_obj->f_name = t5;
        ...
        vader_obj_header_init(_a5_obj, 512u);
        _a5_obj->f_name = l6;
        _a5_obj->f_fields = l3;
    ...
    vader_obj_header_init(_a7_obj, 509u);
    _a7_obj->f_trait_name = t5;
    l4 = (void*) _a7_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    vader_array_t* _a8_arr = vader_array_new(37u, 0u, 13u, 501u);
    l3 = (void*) _a8_arr;
    l4 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_fields;
    l9 = ((vader_array_t*) l4)->length;
    l11 = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a11_obj, 512u);
    _a11_obj->f_name = l6;
    ...
    l6 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_mangled;
    std_collections_put__string__i32(l3, l6, l8);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
    ...
    l9 = INT32_C(0);
    {
        loop_52: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a6_arr = vader_array_new(126u, 0u, 13u, 1115u);
                l14 = (void*) _a6_arr;
                ...
                vader_array_t* _a8_arr = vader_array_new(40u, 0u, 13u, 505u);
                l20 = (void*) _a8_arr;
                ...
                vader_obj_header_init(_a9_obj, 503u);
                _a9_obj->f_name = l23;
...
static void* vader_midir_with_by_address(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a3_obj, 510u);
    _a3_obj->f_params = l5;
...
static vader_box_t vader_midir_with_dst(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 832u) {
        ...
        vader_obj_header_init(_a4_obj, 832u);
        _a4_obj->f_span = l2;
        _a4_obj->f_dst = l1;
        _a4_obj->f_target = l5;
        _a4_obj->f_field = l8;
    ...
    if (l0.tag == 815u) {
        ...
        vader_obj_header_init(_a5_obj, 815u);
        _a5_obj->f_span = l2;
        _a5_obj->f_dst = l1;
        _a5_obj->f_target = l5;
        _a5_obj->f_index = l7;
    ...
    if (l0.tag == 816u) {
        ...
        vader_obj_header_init(_a6_obj, 816u);
        _a6_obj->f_span = l2;
        _a6_obj->f_dst = l1;
        _a6_obj->f_target = l5;
    ...
    if (l0.tag == 820u) {
        ...
        vader_obj_header_init(_a7_obj, 820u);
        _a7_obj->f_span = l2;
        _a7_obj->f_dst = l1;
        _a7_obj->f_type = l3;
        _a7_obj->f_target = l5;
    ...
    if (l0.tag == 839u) {
        ...
        vader_obj_header_init(_a8_obj, 839u);
        _a8_obj->f_span = l2;
        _a8_obj->f_dst = l1;
        _a8_obj->f_type = l3;
        _a8_obj->f_target = l5;
    ...
    if (l0.tag == 817u) {
        ...
        vader_obj_header_init(_a10_obj, 817u);
        _a10_obj->f_span = l2;
        _a10_obj->f_dst = l1;
        _a10_obj->f_type = l3;
    ...
    if (l0.tag == 829u) {
        ...
        vader_obj_header_init(_a11_obj, 829u);
        _a11_obj->f_span = l2;
        _a11_obj->f_dst = l1;
        _a11_obj->f_type = l3;
    ...
    if (l0.tag == 841u) {
        ...
        vader_obj_header_init(_a12_obj, 841u);
        _a12_obj->f_span = l2;
        _a12_obj->f_dst = l1;
        _a12_obj->f_value = l5;
    ...
    if (l0.tag == 842u) {
        ...
        vader_obj_header_init(_a13_obj, 842u);
        _a13_obj->f_span = l2;
        _a13_obj->f_dst = l1;
        _a13_obj->f_type = l3;
    ...
    if (l0.tag == 824u) {
        ...
        vader_obj_header_init(_a14_obj, 824u);
        _a14_obj->f_span = l2;
        _a14_obj->f_dst = l1;
        _a14_obj->f_value = l5;
        _a14_obj->f_type = l3;
    ...
    if (l0.tag == 826u) {
        ...
        vader_obj_header_init(_a15_obj, 826u);
        _a15_obj->f_span = l2;
        _a15_obj->f_dst = l1;
        _a15_obj->f_value = l5;
    ...
    if (l0.tag == 825u) {
        ...
        vader_obj_header_init(_a16_obj, 825u);
        _a16_obj->f_span = l2;
        _a16_obj->f_dst = l1;
        _a16_obj->f_cell = l5;
    ...
    if (l0.tag == 837u) {
        ...
        vader_obj_header_init(_a17_obj, 837u);
        _a17_obj->f_span = l2;
        _a17_obj->f_dst = l1;
    ...
    if (l0.tag == 835u) {
        ...
        vader_obj_header_init(_a18_obj, 835u);
        _a18_obj->f_span = l2;
        _a18_obj->f_dst = l1;
    ...
    if (l0.tag == 834u) {
        ...
        vader_obj_header_init(_a19_obj, 834u);
        _a19_obj->f_span = l2;
        _a19_obj->f_dst = l1;
