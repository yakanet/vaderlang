...
void* vader_midir_annotate_escape(void* l0) {
    ...
    vader_obj_header_init(_a3_obj, 313u);
    _a3_obj->f_ekeys = l3;
    _a3_obj->f_evals = l4;
    _a3_obj->f_index = l5;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_30: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a6_obj, 221u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                t1 = (void*) _a6_obj;
                l10 = ((vader_struct___Tuple_1251_t*) t1)->f__1;
                t2 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t2;
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 786u);
                l11 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a12_obj, 790u);
    ...
    vader_obj_header_init(_a14_obj, 783u);
...
static void* vader_midir_annotate_function(void* l0) {
    ...
    l10 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(6u, 0u, 12u, 161u);
    l14 = (void*) _a9_arr;
    ...
    vader_obj_header_init(_a11_obj, 303u);
    ...
    vader_obj_header_init(_a12_obj, 370u);
    _a12_obj->f_inner = t0;
    l10 = (void*) _a12_obj;
    ...
    l17 = false;
    vader_array_t* _a19_arr = vader_array_new(68u, 0u, 13u, 784u);
    l2 = (void*) _a19_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_329: {
            if ((l5 < l4)) {
                ...
                l20 = false;
                vader_array_t* _a21_arr = vader_array_new(130u, 0u, 13u, 1148u);
                l21 = (void*) _a21_arr;
                    ...
                    loop_349: {
                        if ((l8 < l7)) {
                            ...
                            if (l9.tag == 806u) {
                                ...
                                vader_obj_header_init(_a24_obj, 806u);
                                _a24_obj->f_span = l42;
                                _a24_obj->f_dst = l43;
                                _a24_obj->f_type = l44;
                ...
                vader_obj_header_init(_a26_obj, 784u);
                _a26_obj->f_id = l59;
    ...
    vader_obj_header_init(_a27_obj, 786u);
...
static vader_box_t vader_midir_build_array_len(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 1777u, l3);
...
static vader_box_t vader_midir_build_call(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_lower_LoweredCall_t*) l1)->f_callee.tag == 748u) {
        ...
        vader_obj_header_init(_a1_obj, 812u);
        _a1_obj->f_span = l6;
        _a1_obj->f_dst = l9;
        _a1_obj->f_callee = l7;
        _a1_obj->f_args = l2;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l7 >= l6)) {
                ...
                vader_struct___Tuple_1226_t* _a6_obj = (vader_struct___Tuple_1226_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1226_t));
                vader_obj_header_init(_a6_obj, 218u);
                _a6_obj->f__0 = l8;
                _a6_obj->f__1 = l3;
                l9 = (void*) _a6_obj;
                l10 = ((vader_struct___Tuple_1226_t*) l9)->f__0;
                l11 = ((vader_struct___Tuple_1226_t*) l9)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 786u);
                l12 = (void*) _a7_arr;
                vader_array_t* _a8_arr = vader_array_new(69u, 0u, 13u, 785u);
                l13 = (void*) _a8_arr;
                vader_array_t* _a9_arr = vader_array_new(74u, 0u, 13u, 791u);
                l14 = (void*) _a9_arr;
...
static void* vader_midir_build_cfg_signature(void* l0, vader_box_t l1, void* l2) {
    ...
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(6u, 0u, 12u, 161u);
    l6 = (void*) _a3_arr;
    l7 = l0;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l9 < l8)) {
                ...
                vader_array_push((vader_array_t*) l5, vader_box_string(163u, l13));
    ...
    vader_obj_header_init(_a6_obj, 500u);
    _a6_obj->f_params = l3;
...
static vader_box_t vader_midir_build_expr(void* l0, vader_box_t l1) {
    ...
    if (l1.tag == 761u) {
        ...
        vader_obj_header_init(_a5_obj, 798u);
        _a5_obj->f_index = l6;
        l4 = (void*) _a5_obj;
...
static void vader_midir_build_expr_into(void* l0, vader_box_t l1, int32_t l2) {
    ...
    if (l1.tag == 749u) {
        l3 = l1.payload.obj;
        vader_midir_build_if(l0, l3, vader_box_i32(166u, l2));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 730u) {
        l3 = l1.payload.obj;
    ...
    if (l1.tag == 729u) {
        ...
        if (t0) {
            vader_midir_build_short_circuit(l0, l3, vader_box_i32(166u, l2));
            { vader_gc_top = gc_frame.prev; return; }
        }
        l4 = l1;
        l5 = vader_midir_build_expr(l0, l4);
...
static vader_box_t vader_midir_build_ident(void* l0, void* l1) {
    ...
    if (!(l4.tag == 0u)) {
        ...
        if (l6.tag == 920u) {
            ...
            if (!(t3)) {
                l6 = ((vader_struct_vader_lower_LoweredIdent_t*) l1)->f_type;
                l3 = vader_midir_fresh_tmp(l0, 1861u, l6);
    ...
    if (l4.tag == 705u) {
        ...
        _a4_obj->f_span = l9;
        _a4_obj->f_dst = vader_box_i32(166u, l3);
...
static vader_box_t vader_midir_build_if(void* l0, void* l1, vader_box_t l2) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l7);
    ...
    if (!(l5.tag == 0u)) {
        if (!(((vader_struct_vader_lower_LoweredIf_t*) l1)->f_else_block.tag == 0u)) {
            ...
            ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l3);
            VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l8);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    { vader_box_t __vret = l4; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_midir_build_impl_table_from_vtable(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 595u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(8u, 0u, 0u, 163u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(6u, 0u, 12u, 161u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 166u);
    l6 = (void*) _a3_arr;
        ...
        loop_23: {
            if ((l8 < l7)) {
                ...
                if ((l12 < l13)) {
                    ...
                    vader_obj_header_init(_a7_obj, 595u);
                ...
                vader_obj_header_init(_a8_obj, 595u);
                    ...
                    l13 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_275: {
                            if ((l13 < l12)) {
                                ...
                                l18 = std_core_write_string_at(l6, l18, 2417u);
...
static void vader_midir_build_loop(void* l0, void* l1) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l4);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a5_obj, 840u);
    ...
    vader_array_t* _a6_arr = vader_array_new(76u, 0u, 13u, 834u);
    l2 = (void*) _a6_arr;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l5);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_midir_build_short_circuit(void* l0, void* l1, vader_box_t l2) {
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l9);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        ...
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1745u, l4);
        l8 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_span;
        vader_struct_vader_midir_ConstBool_t* _a2_obj = (vader_struct_vader_midir_ConstBool_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ConstBool_t));
        vader_obj_header_init(_a2_obj, 793u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l10);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    if (l5) {
        l4 = ((vader_struct_vader_lower_LoweredBinary_t*) l1)->f_type;
        l3 = vader_midir_fresh_tmp(l0, 1745u, l4);
        ...
        vader_obj_header_init(_a6_obj, 793u);
        ...
        vader_obj_header_init(_a8_obj, 826u);
    ...
    if (!(((vader_struct_vader_midir_FnCtx_t*) l0)->f_current.tag == 0u)) {
        ...
        vader_obj_header_init(_a10_obj, 840u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l0)->f_current = vader_box_i32(166u, l11);
    VADER_WRITE_BARRIER((vader_struct_vader_midir_FnCtx_t*) l0);
    t0 = vader_box_i32(166u, l6);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static vader_box_t vader_midir_build_struct_lit(void* l0, void* l1) {
    ...
    l6 = vader_midir_fresh_tmp(l0, 2104u, l7);
...
static vader_box_t vader_midir_build_type_check(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2181u, l3);
...
static vader_box_t vader_midir_build_type_const(void* l0, void* l1) {
    ...
    l3 = vader_midir_fresh_tmp(l0, 2184u, l2);
...
static vader_box_t vader_midir_build_unary(void* l0, void* l1) {
    ...
    l4 = vader_midir_fresh_tmp(l0, 2271u, l3);
...
static vader_box_t vader_midir_build_unreachable_type(void* l0, vader_box_t l1, void* l2, vader_string_t l3, bool l4) {
    ...
    if (t1) {
        ...
        t2 = vader_midir_declare_local(l0, 2272u, l1, vader_box_obj(0u, NULL));
        l5 = vader_box_i32(166u, t2);
    }
...
static void* vader_midir_build_vtables_from_entries(void* l0, void* l1) {
    ...
    l3 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(14u, 0u, 4u, 172u);
    l4 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l11 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a9_obj, 358u);
    _a9_obj->f_ekeys = l3;
    _a9_obj->f_evals = l4;
    _a9_obj->f_index = l11;
    ...
    l3 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(44u, 0u, 13u, 649u);
    l4 = (void*) _a10_arr;
    l11 = l0;
        ...
        loop_99: {
            if ((l6 < l5)) {
                ...
                if (l18.tag == 172u) {
                    ...
                    vader_obj_header_init(_a13_obj, 648u);
                    ...
                    vader_array_t* _a14_arr = vader_array_new(43u, 0u, 13u, 648u);
                    l21 = (void*) _a14_arr;
                    ...
                    vader_obj_header_init(_a15_obj, 648u);
                    ...
                    vader_obj_header_init(_a16_obj, 649u);
                    _a16_obj->f_key = l14;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_20: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a4_obj, 233u);
                _a4_obj->f__0 = l7;
                _a4_obj->f__1 = l8;
                t0 = (void*) _a4_obj;
                { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_midir_cf_end(void* l0, void* l1) {
    ...
    if ((size_t) l5 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
    l2 = vader_array_ref_load_obj(_a1_slotarr->buf, _a1_slotarr->offset + (size_t) l5);
    vader_array_t* _a2_arr = vader_array_new(79u, 0u, 13u, 839u);
    l6 = (void*) _a2_arr;
    t0 = (l4 - INT64_C(1));
    l4 = (size_t) (int64_t) t0;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void vader_midir_cf_loop(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a0_obj, 607u);
    l3 = (void*) _a0_obj;
    l4 = vader_midir_push_op_with_span(l0, vader_ref_box(l3), l1);
    l3 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_scopes;
    vader_struct_vader_midir_ScopeFrame_t* _a1_obj = (vader_struct_vader_midir_ScopeFrame_t*) vader_gc_alloc(sizeof(vader_struct_vader_midir_ScopeFrame_t));
    vader_obj_header_init(_a1_obj, 839u);
    _a1_obj->f_kind = 1801u;
    _a1_obj->f_target_blk = l2;
    _a1_obj->f_opener_pc = l4;
    l5 = (void*) _a1_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l5));
...
static vader_box_t vader_midir_closure_header_type(vader_box_t l0) {
    ...
    if (l0.tag == 907u) {
        ...
        vader_array_t* _a0_arr = vader_array_new(131u, 0u, 13u, 1171u);
        l2 = (void*) _a0_arr;
        vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 161u);
        l3 = (void*) _a1_arr;
        ...
        vader_obj_header_init(_a2_obj, 913u);
        ...
        vader_obj_header_init(_a3_obj, 907u);
        _a3_obj->f_params = l2;
...
static void* vader_midir_compact_locals(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 193u);
    _a0_obj->f_value = t0;
    t1 = (void*) _a0_obj;
    l1 = vader_ref_box(t1);
    vader_array_t* _a1_arr = vader_array_new(6u, 1u, 12u, 161u);
    ...
    vader_obj_header_init(_a3_obj, 178u);
    _a3_obj->f_value = t1;
    t1 = (void*) _a3_obj;
    l4 = vader_ref_box(t1);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_66: {
            if ((l5 < l3)) {
                ...
                l8 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_82: {
                        if ((l8 < l7)) {
                            ...
                            vader_struct___lambda_env_1853_t* _a8_obj = (vader_struct___lambda_env_1853_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1853_t));
                            ...
                            _a9_closure->code = (void*) &vader_fn_lift_1773;
                            _a9_closure->env = t1;
                ...
                vader_struct___lambda_env_1856_t* _a11_obj = (vader_struct___lambda_env_1856_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1856_t));
                ...
                _a12_closure->code = (void*) &vader_fn_lift_1774;
                _a12_closure->env = t1;
    ...
    l5 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_params)->length;
    {
        loop_169: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(161u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l20 = true;
                } else {
    ...
    l2 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(71u, 0u, 13u, 787u);
    l6 = (void*) _a16_arr;
    l3 = ((vader_struct__Cell_usize_t*) l1.payload.obj)->f_value;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_220: {
            if ((l5 < l3)) {
                ...
                t4 = vader_box_bool(161u, ((uint8_t*) _a18_slotarr->buf->slots)[_a18_slotarr->offset + (size_t) l5]);
                t3 = t4.payload.b;
                if (!(t3)) {
                    l14 = -(INT32_C(1));
    ...
    vader_array_t* _a20_arr = vader_array_new(73u, 0u, 13u, 789u);
    l9 = (void*) _a20_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_282: {
            if ((l5 < l3)) {
                ...
                vader_obj_header_init(_a24_obj, 789u);
                _a24_obj->f_name = l22;
    ...
    vader_array_t* _a25_arr = vader_array_new(68u, 0u, 13u, 784u);
    l12 = (void*) _a25_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_339: {
            if ((l5 < l3)) {
                ...
                vader_array_t* _a28_arr = vader_array_new(130u, 0u, 13u, 1148u);
                l23 = (void*) _a28_arr;
                ...
                vader_obj_header_init(_a32_obj, 784u);
                _a32_obj->f_id = l21;
    ...
    vader_obj_header_init(_a33_obj, 786u);
...
static void* vader_midir_compute_carried_across_loop_headers(void* l0, void* l1) {
    ...
    vader_struct___Tuple_1257_t _a7_storage = {0};
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l9 >= l8)) {
                ...
                vader_struct___Tuple_1257_t* _a8_obj = &_a7_storage;
                vader_obj_header_init(_a8_obj, 222u);
                _a8_obj->f__0 = l10;
                _a8_obj->f__1 = l5;
                t0 = (void*) _a8_obj;
                l11 = ((vader_struct___Tuple_1257_t*) t0)->f__0;
                t2 = (l9 + INT64_C(1));
                ...
                vader_obj_header_init(_a12_obj, 303u);
                ...
                vader_obj_header_init(_a13_obj, 370u);
                _a13_obj->f_inner = t0;
                l17 = (void*) _a13_obj;
                l18 = l12;
...
static void* vader_midir_compute_escaping(void* l0, void* l1) {
    ...
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(15u, 0u, 0u, 173u);
    l4 = (void*) _a6_arr;
    ...
    vader_array_t* _a9_arr = vader_array_new(9u, 0u, 7u, 166u);
    l4 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(15u, 0u, 0u, 173u);
    l5 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 166u);
    l6 = (void*) _a11_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_50: {
            if ((l8 < l7)) {
                ...
                if (((vader_struct_vader_midir_BasicBlock_t*) l6)->f_terminator.tag == 842u) {
    ...
    l5 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(6u, 0u, 12u, 161u);
    l6 = (void*) _a27_arr;
    ...
    vader_obj_header_init(_a29_obj, 303u);
    _a29_obj->f_ekeys = l5;
    _a29_obj->f_evals = l6;
    _a29_obj->f_index = l9;
    ...
    vader_obj_header_init(_a30_obj, 370u);
    _a30_obj->f_inner = t0;
    l5 = (void*) _a30_obj;
    l6 = l1;
    l9 = ((vader_struct_std_collections_MutableMap__i32__bool_t*) ((vader_struct_std_collections_MutableSet__i32_t*) l6)->f_inner)->f_ekeys;
    ...
    vader_obj_header_init(_a32_obj, 799u);
...
static void* vader_midir_compute_liveness(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(18u, 0u, 13u, 370u);
    t0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_repeat((vader_array_t*) t0, (size_t) l1);
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(18u, 0u, 13u, 370u);
    t0 = (void*) _a2_arr;
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l4 < l1)) {
                ...
                vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
                l6 = (void*) _a5_arr;
                vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 161u);
                l7 = (void*) _a6_arr;
                vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 166u);
                l8 = (void*) _a7_arr;
                ...
                vader_obj_header_init(_a10_obj, 188u);
                _a10_obj->f_value = t0;
                t0 = (void*) _a10_obj;
                l9 = vader_ref_box(t0);
                vader_array_t* _a11_arr = vader_array_new(9u, 0u, 7u, 166u);
                ...
                vader_obj_header_init(_a14_obj, 303u);
                ...
                vader_obj_header_init(_a15_obj, 370u);
                _a15_obj->f_inner = t0;
                t0 = (void*) _a15_obj;
                ...
                vader_obj_header_init(_a16_obj, 188u);
                _a16_obj->f_value = t0;
                t0 = (void*) _a16_obj;
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_62: {
                        if ((l16 < l15)) {
                            ...
                            vader_struct___lambda_env_2997_t* _a18_obj = (vader_struct___lambda_env_2997_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2997_t));
                            vader_obj_header_init(_a18_obj, 250u);
                            ...
                            _a19_closure->code = (void*) &vader_fn_lift_1803;
                            _a19_closure->env = t0;
                ...
                vader_struct___lambda_env_3000_t* _a20_obj = (vader_struct___lambda_env_3000_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3000_t));
                vader_obj_header_init(_a20_obj, 251u);
                ...
                _a21_closure->code = (void*) &vader_fn_lift_1804;
                _a21_closure->env = t0;
    ...
    vader_struct___lambda_env_3006_t* _a25_obj = (vader_struct___lambda_env_3006_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3006_t));
    vader_obj_header_init(_a25_obj, 252u);
    t0 = (void*) _a25_obj;
    vader_fn_t* _a26_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a26_closure, 134u);
    _a26_closure->code = (void*) &vader_fn_lift_1805;
    _a26_closure->env = t0;
    l6 = (void*) _a26_closure;
    l6 = std_core_filled__MutableSet_i32_(l1, l6);
    vader_struct___lambda_env_3009_t* _a27_obj = (vader_struct___lambda_env_3009_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3009_t));
    vader_obj_header_init(_a27_obj, 253u);
    t0 = (void*) _a27_obj;
    vader_fn_t* _a28_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a28_closure, 134u);
    _a28_closure->code = (void*) &vader_fn_lift_1806;
    _a28_closure->env = t0;
    l7 = (void*) _a28_closure;
    l7 = std_core_filled__MutableSet_i32_(l1, l7);
    vader_array_t* _a29_arr = vader_array_new(9u, 0u, 7u, 166u);
    l8 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(6u, 0u, 12u, 161u);
    l10 = (void*) _a30_arr;
    ...
    vader_obj_header_init(_a32_obj, 303u);
    _a32_obj->f_ekeys = l8;
    ...
    vader_obj_header_init(_a33_obj, 370u);
    _a33_obj->f_inner = t0;
    l8 = (void*) _a33_obj;
    vader_array_t* _a34_arr = vader_array_new(9u, 0u, 7u, 166u);
    l10 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(6u, 0u, 12u, 161u);
    l11 = (void*) _a35_arr;
    ...
    vader_obj_header_init(_a37_obj, 303u);
    ...
    vader_obj_header_init(_a38_obj, 370u);
    _a38_obj->f_inner = t0;
    l10 = (void*) _a38_obj;
    l26 = true;
    {
    ...
    vader_obj_header_init(_a51_obj, 833u);
...
static void* vader_midir_compute_post_dominators(void* l0) {
    ...
    t1 = (l1 + INT64_C(1));
    l4 = (size_t) (int64_t) t1;
    vader_struct___lambda_env_1970_t* _a8_obj = (vader_struct___lambda_env_1970_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1970_t));
    vader_obj_header_init(_a8_obj, 241u);
    t0 = (void*) _a8_obj;
    vader_fn_t* _a9_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a9_closure, 133u);
    _a9_closure->code = (void*) &vader_fn_lift_1785;
    _a9_closure->env = t0;
    l2 = (void*) _a9_closure;
    ...
    vader_array_t* _a16_arr = vader_array_new(9u, 0u, 7u, 166u);
    l3 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(6u, 1u, 12u, 161u);
    ...
    vader_array_t* _a19_arr = vader_array_new(9u, 1u, 7u, 166u);
        ...
        loop_9: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 777u) {
                    ...
                    vader_obj_header_init(_a2_obj, 501u);
                    _a2_obj->f_values = l7;
                ...
                if (l5.tag == 776u) {
                    l10 = l5.payload.obj;
                    vader_array_t* _a3_arr = vader_array_new(13u, 0u, 4u, 171u);
                    l11 = (void*) _a3_arr;
                    ...
                    vader_obj_header_init(_a5_obj, 497u);
                    _a5_obj->f_kind = l16;
                    _a5_obj->f_items = l11;
                ...
                if (l5.tag == 694u) {
                    l19 = l5.payload.obj;
                    vader_array_t* _a6_arr = vader_array_new(122u, 0u, 13u, 1080u);
                    l20 = (void*) _a6_arr;
                    ...
                    vader_obj_header_init(_a8_obj, 488u);
...
static vader_box_t vader_midir_convert_function(void* l0, void* l1) {
    ...
    l2 = t0.payload.obj;
    vader_array_t* _a0_arr = vader_array_new(73u, 0u, 13u, 789u);
    l3 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(71u, 0u, 13u, 787u);
    l4 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 166u);
    ...
    vader_obj_header_init(_a5_obj, 304u);
    _a5_obj->f_ekeys = l5;
    _a5_obj->f_evals = l6;
    _a5_obj->f_index = l7;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_34: {
            if ((l9 < l8)) {
                ...
                vader_obj_header_init(_a7_obj, 787u);
                _a7_obj->f_name = l11;
                _a7_obj->f_type = l12;
    ...
    vader_array_t* _a9_arr = vader_array_new(77u, 0u, 13u, 835u);
    l7 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(76u, 0u, 13u, 834u);
    l13 = (void*) _a10_arr;
    ...
    vader_obj_header_init(_a11_obj, 801u);
    ...
    ((vader_struct_vader_midir_FnCtx_t*) l4)->f_current = vader_box_i32(166u, l10);
    ...
    vader_array_t* _a14_arr = vader_array_new(68u, 0u, 13u, 784u);
    l5 = (void*) _a14_arr;
    ...
    vader_obj_header_init(_a16_obj, 786u);
...
static void* vader_midir_count_uses(void* l0) {
    ...
    t0 = (void*) _a4_obj;
    l4 = vader_ref_box(t0);
    vader_struct___lambda_env_2981_t* _a5_obj = (vader_struct___lambda_env_2981_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2981_t));
    vader_obj_header_init(_a5_obj, 248u);
    _a5_obj->f_cap_0 = l4;
    t0 = (void*) _a5_obj;
    vader_fn_t* _a6_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a6_closure, 139u);
    _a6_closure->code = (void*) &vader_fn_lift_1799;
    _a6_closure->env = t0;
    l1 = (void*) _a6_closure;
    l2 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
...
static void* vader_midir_die_once(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(68u, 0u, 13u, 784u);
    l2 = (void*) _a0_arr;
    l3 = ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a3_obj, 784u);
                _a3_obj->f_id = l14;
    ...
    vader_obj_header_init(_a4_obj, 786u);
...
static void vader_midir_drain_pending(void* l0, int32_t l1, bool l2, int32_t l3, int32_t l4) {
    ...
    vader_array_t* _a0_arr = vader_array_new(78u, 0u, 13u, 836u);
    l6 = (void*) _a0_arr;
    l7 = ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_pending;
    l8 = ((vader_array_t*) l7)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_midir_dst_of(vader_box_t l0) {
    ...
    if (l0.tag == 817u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 826u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 810u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrBinOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 831u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 821u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 804u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 805u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 809u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 827u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrStringSlice_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 828u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrStructNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 806u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 829u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 830u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrTypeConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 813u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 815u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 814u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 825u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 823u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrFnRef_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 818u) {
        t0 = l0.payload.obj;
        t1 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrDataConst_t*) t0)->f_dst);
        return t1;
    }
    if (l0.tag == 811u) {
        t0 = l0.payload.obj;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l6 >= l5)) {
                ...
                _a6_obj->f__1 = l2;
                l8 = (void*) _a6_obj;
                l9 = ((vader_struct___Tuple_1251_t*) l8)->f__0;
                l10 = ((vader_struct___Tuple_1251_t*) l8)->f__1;
                t1 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t1;
                vader_array_t* _a7_arr = vader_array_new(70u, 0u, 13u, 786u);
                l11 = (void*) _a7_arr;
...
static int32_t vader_midir_emit_block_contents(void* l0, int32_t l1, int32_t l2) {
    ...
    if (l6.tag == 842u) {
        ...
        if ((t5 > INT64_C(0))) {
            ...
            vader_obj_header_init(_a7_obj, 614u);
            l9 = (void*) _a7_obj;
            l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l9), l15);
            { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
        ...
        vader_obj_header_init(_a8_obj, 614u);
        l9 = (void*) _a8_obj;
        l15 = ((vader_struct_vader_midir_TermReturn_t*) l3)->f_span;
        vader_midir_push_emit(l0, vader_ref_box(l9), l15);
        { int32_t __vret = -(INT32_C(1)); vader_gc_top = gc_frame.prev; return __vret; }
    ...
    if (l6.tag == 843u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a9_obj, 646u);
            _a9_obj->f_reason = t6;
            l9 = (void*) _a9_obj;
            ...
            vader_obj_header_init(_a10_obj, 614u);
            l9 = (void*) _a10_obj;
...
void* vader_midir_emit_bytecode_from_cfg(void* l0, vader_string_t l1, void* l2) {
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l8 >= l7)) {
                ...
                vader_struct___Tuple_1251_t* _a2_obj = (vader_struct___Tuple_1251_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1251_t));
                vader_obj_header_init(_a2_obj, 221u);
                _a2_obj->f__0 = l9;
                _a2_obj->f__1 = l4;
                t1 = (void*) _a2_obj;
                l10 = ((vader_struct___Tuple_1251_t*) t1)->f__1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_260: {
            if ((l8 >= l7)) {
                ...
                if ((size_t) l8 >= _a12_slotarr->length) { vader_trap("array index out of bounds"); }
                l5 = vader_array_ref_load_obj(_a12_slotarr->buf, _a12_slotarr->offset + (size_t) l8);
                vader_struct___Tuple_1251_t* _a13_obj = (vader_struct___Tuple_1251_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1251_t));
                vader_obj_header_init(_a13_obj, 221u);
                _a13_obj->f__0 = l9;
                _a13_obj->f__1 = l5;
                t1 = (void*) _a13_obj;
                l11 = ((vader_struct___Tuple_1251_t*) t1)->f__1;
                t2 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t2;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_291: {
                        if ((l13 < l12)) {
                            ...
                            l20 = -(INT32_C(1));
                            if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l17)->f_origin)->f_symbol.tag == 878u) {
    ...
    if (t4) {
        ...
        vader_array_t* _a31_arr = vader_array_new(8u, 0u, 0u, 163u);
        l4 = (void*) _a31_arr;
        vader_array_t* _a32_arr = vader_array_new(6u, 0u, 12u, 161u);
        l5 = (void*) _a32_arr;
        ...
        vader_obj_header_init(_a34_obj, 352u);
        _a34_obj->f_ekeys = l4;
        _a34_obj->f_evals = l5;
        _a34_obj->f_index = l6;
        ...
        vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 166u);
        l5 = (void*) _a37_arr;
    ...
    vader_obj_header_init(_a40_obj, 523u);
    _a40_obj->f_name = l1;
    _a40_obj->f_types = l4;
...
static void vader_midir_emit_cfg_function_body(void* l0, int32_t l1, void* l2, void* l3, bool l4) {
    ...
    vader_array_t* _a5_arr = vader_array_new(79u, 0u, 13u, 839u);
    l22 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(78u, 0u, 13u, 836u);
    l23 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 166u);
    l24 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a10_obj, 303u);
    ...
    vader_obj_header_init(_a12_obj, 802u);
    _a12_obj->f_fn_ = l0;
...
static int32_t vader_midir_emit_const(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l4 = vader_midir_fresh_tmp(l0, 1745u, l1);
...
static void vader_midir_emit_const_instr(void* l0, void* l1, int64_t l2) {
    ...
    if (l3.tag == 796u) {
        ...
        if (t1) {
            ...
            vader_obj_header_init(_a1_obj, 559u);
        ...
        if (l3.tag == 795u) {
            ...
            vader_obj_header_init(_a2_obj, 541u);
            _a2_obj->f_value = t4;
            l4 = (void*) _a2_obj;
            l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
            vader_midir_push_emit(l0, vader_ref_box(l4), l5);
            ...
            if (l3.tag == 793u) {
                ...
                if (l3.tag == 794u) {
                    ...
                    if (l3.tag == 797u) {
                        ...
                        vader_obj_header_init(_a5_obj, 610u);
                        l4 = (void*) _a5_obj;
                        l5 = ((vader_struct_vader_midir_InstrConst_t*) l1)->f_span;
                        vader_midir_push_emit(l0, vader_ref_box(l4), l5);
                    } else {
...
static void vader_midir_emit_get(void* l0, int32_t l1, void* l2) {
    ...
    vader_obj_header_init(_a1_obj, 604u);
    _a1_obj->f_slot = t1;
    l3 = (void*) _a1_obj;
...
static void vader_midir_emit_instr(void* l0, vader_box_t l1, int64_t l2) {
    ...
    if (l1.tag == 811u) {
        ...
        if (((vader_struct_vader_midir_InstrCall_t*) l3)->f_dst.tag == 166u) {
        ...
        if (l7.tag == 166u) {
            ...
            if (l7.tag == 166u) {
                ...
                vader_obj_header_init(_a7_obj, 525u);
                ...
                if (l7.tag == 166u) {
                    ...
                    vader_obj_header_init(_a8_obj, 526u);
                    _a8_obj->f_index = t2;
                    l5 = (void*) _a8_obj;
                    l10 = ((vader_struct_vader_midir_InstrCall_t*) l3)->f_span;
                    vader_midir_push_emit(l0, vader_ref_box(l5), l10);
                    ...
                    if (l7.tag == 166u) {
                        ...
                        vader_obj_header_init(_a9_obj, 526u);
                        _a9_obj->f_index = t2;
                        l5 = (void*) _a9_obj;
                        l10 = ((vader_struct_vader_midir_InstrCall_t*) l3)->f_span;
                        vader_midir_push_emit(l0, vader_ref_box(l5), l10);
                        ...
                        l6 = std_core_write_string_at(l5, l6, 287u);
    ...
    if (l1.tag == 812u) {
        ...
        vader_obj_header_init(_a13_obj, 527u);
    ...
    if (l1.tag == 823u) {
        ...
        if (l7.tag == 166u) {
            ...
            vader_obj_header_init(_a14_obj, 553u);
    ...
    if (l1.tag == 832u) {
        ...
        vader_obj_header_init(_a17_obj, 647u);
    ...
    if (l1.tag == 821u) {
        ...
        if (l20.tag == 0u) {
            ...
            t3 = concat_7(1829u, l16, 1000u, l17, 959u, l21, 285u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        ...
        if (!(l22)) {
            ...
            vader_obj_header_init(_a19_obj, 629u);
        ...
        if (t5) {
            ...
            vader_obj_header_init(_a20_obj, 611u);
    ...
    if (l1.tag == 822u) {
        ...
        if (l20.tag == 0u) {
            ...
            l17 = vader_types_display_type(l7);
            l21 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_7(1829u, l16, 1000u, l17, 959u, l21, 286u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        t4 = ((size_t) l20.payload.i);
        ...
        vader_obj_header_init(_a22_obj, 631u);
    ...
    if (l1.tag == 804u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a24_obj, 479u);
            ...
            if (t5) {
                ...
                vader_obj_header_init(_a25_obj, 611u);
    ...
    if (l1.tag == 808u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a27_obj, 486u);
    ...
    if (l1.tag == 807u) {
        ...
        vader_obj_header_init(_a30_obj, 482u);
    ...
    if (l1.tag == 827u) {
        ...
        vader_obj_header_init(_a32_obj, 628u);
        l5 = (void*) _a32_obj;
    ...
    if (l1.tag == 828u) {
        ...
        vader_obj_header_init(_a35_obj, 630u);
    ...
    if (l1.tag == 806u) {
        ...
        vader_obj_header_init(_a38_obj, 481u);
    ...
    if (l1.tag == 818u) {
        ...
        vader_obj_header_init(_a39_obj, 530u);
    ...
    if (l1.tag == 829u) {
        ...
        vader_obj_header_init(_a40_obj, 632u);
    ...
    if (l1.tag == 830u) {
        ...
        vader_obj_header_init(_a41_obj, 633u);
        ...
        if (l4 != l15) {
            ...
            if (l7.tag == 0u) {
                ...
                if (t5) {
                    ...
                    vader_obj_header_init(_a44_obj, 529u);
                    ...
                    vader_obj_header_init(_a45_obj, 611u);
    ...
    if (l1.tag == 815u) {
        ...
        vader_obj_header_init(_a46_obj, 630u);
    ...
    if (l1.tag == 814u) {
        ...
        if (!(l22)) {
            ...
            vader_obj_header_init(_a47_obj, 629u);
    ...
    if (l1.tag == 816u) {
        ...
        vader_obj_header_init(_a48_obj, 631u);
    ...
    if (l1.tag == 825u) {
        ...
        if (l7.tag == 166u) {
            ...
            vader_obj_header_init(_a49_obj, 608u);
            ...
            l18 = ((int64_t) (int32_t) t2);
            l6 = std_core_write_int(l5, l6, l18);
            l6 = std_core_write_string_at(l5, l6, 350u);
            t3 = std_core_finish_buffer(l5, l6);
            vader_host_std_abort_panic(t3);
        }
    ...
    if (l1.tag == 824u) {
        ...
        if (l7.tag == 0u) {
            ...
            l17 = ((vader_struct_vader_midir_CFGFunction_t*) ((vader_struct_vader_midir_FnEmitCfg_t*) l0)->f_fn_)->f_mangled;
            t3 = concat_5(1831u, l16, 959u, l17, 288u);
            vader_host_std_abort_panic(t3);
        } else {
        }
        l5 = ((vader_struct_vader_midir_InstrIntrinsic_t*) l3)->f_span;
    ...
    if (l1.tag == 820u) {
        ...
        vader_obj_header_init(_a52_obj, 533u);
        l5 = (void*) _a52_obj;
    ...
    if (l1.tag == 819u) {
        ...
        vader_obj_header_init(_a53_obj, 532u);
        _a53_obj->f_count = t2;
        l5 = (void*) _a53_obj;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_29: {
            if ((l8 >= l7)) {
                ...
                if ((size_t) l8 >= _a5_slotarr->length) { vader_trap("array index out of bounds"); }
                l4 = vader_array_ref_load_obj(_a5_slotarr->buf, _a5_slotarr->offset + (size_t) l8);
                vader_struct___Tuple_1257_t* _a6_obj = (vader_struct___Tuple_1257_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1257_t));
                vader_obj_header_init(_a6_obj, 222u);
                _a6_obj->f__0 = l9;
                _a6_obj->f__1 = l4;
                l10 = (void*) _a6_obj;
                l11 = ((vader_struct___Tuple_1257_t*) l10)->f__0;
                l12 = ((vader_struct___Tuple_1257_t*) l10)->f__1;
                t0 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t0;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_20: {
                if ((l6 < l4)) {
                    ...
                    if (t2 == l2) {
                        t3 = vader_box_i64(172u, (int64_t)(uint64_t) l6);
                        return t3;
                    }
                    t0 = (l6 + INT64_C(1));
                    l6 = (size_t) (int64_t) t0;
...
static vader_box_t vader_midir_first_stack_operand(vader_box_t l0) {
    ...
    if (l0.tag == 826u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrMove_t*) t1)->f_src);
        return t0;
    }
    if (l0.tag == 810u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrBinOp_t*) t1)->f_lhs);
        return t0;
    }
    if (l0.tag == 831u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrUnOp_t*) t1)->f_operand);
        return t0;
    }
    if (l0.tag == 811u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 812u) {
        ...
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l1)->f_callee);
        return t0;
    }
    if (l0.tag == 832u) {
        l1 = l0.payload.obj;
        ...
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l1)->f_receiver);
        return t0;
    }
    if (l0.tag == 821u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 822u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldSet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 804u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayGet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 808u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySet_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 805u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayLen_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 807u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayPush_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 809u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 827u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrStringSlice_t*) t1)->f_target);
        return t0;
    }
    if (l0.tag == 828u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 829u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 813u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCast_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 815u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellNew_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 814u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellGet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 816u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellSet_t*) t1)->f_cell);
        return t0;
    }
    if (l0.tag == 825u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t1)->f_env);
        return t0;
    }
    if (l0.tag == 824u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 820u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_InstrDeferPush_t*) t1)->f_value);
        return t0;
    }
    if (l0.tag == 819u) {
        t0 = vader_box_obj(0u, NULL);
...
static vader_box_t vader_midir_first_terminator_operand(vader_box_t l0) {
    ...
    if (l0.tag == 841u) {
        t1 = l0.payload.obj;
        t0 = vader_box_i32(166u, ((vader_struct_vader_midir_TermCondBranch_t*) t1)->f_cond);
        return t0;
    }
    if (l0.tag == 842u) {
        t1 = l0.payload.obj;
...
static void* vader_midir_fn_metadata(void* l0) {
    ...
    l4 = 0u;
    l5 = 0u;
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_lower_LoweredFnDecl_t*) l0)->f_origin)->f_decl.tag == 412u) {
...
static void* vader_midir_fold_moves(void* l0) {
    ...
    vader_array_t* _a6_arr = vader_array_new(68u, 0u, 13u, 784u);
    l3 = (void*) _a6_arr;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_57: {
            if ((l6 < l5)) {
                ...
                vader_obj_header_init(_a8_obj, 784u);
                _a8_obj->f_id = l7;
    ...
    vader_obj_header_init(_a9_obj, 786u);
...
static void* vader_midir_fold_moves_in_block(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(130u, 0u, 13u, 1148u);
    l3 = (void*) _a0_arr;
        ...
        loop_8: {
            if ((l5 < l4)) {
                ...
                if (l6.tag == 826u) {
                    ...
                    l17 = -(INT64_C(1));
                    l18 = false;
                    vader_array_t* _a3_arr = vader_array_new(6u, 1u, 12u, 161u);
                    ...
                    vader_obj_header_init(_a4_obj, 178u);
                    _a4_obj->f_value = t2;
                    t2 = (void*) _a4_obj;
                                ...
                                if (l23.tag == 166u) {
                                    ...
                                    if (l25 == l26) {
                                        ...
                                        if (l27 == l28) {
                                            ...
                                            vader_struct___lambda_env_2990_t* _a7_obj = (vader_struct___lambda_env_2990_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2990_t));
                                            vader_obj_header_init(_a7_obj, 249u);
                                            _a7_obj->f_cap_0 = l16;
                                            _a7_obj->f_cap_1 = l19;
                                            t2 = (void*) _a7_obj;
                                            vader_fn_t* _a8_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
                                            vader_obj_header_init(_a8_closure, 139u);
                                            _a8_closure->code = (void*) &vader_fn_lift_1801;
                                            _a8_closure->env = t2;
                                            ...
                                            t4 = vader_box_bool(161u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l34]);
                                            t1 = t4.payload.b;
                                            if (t1) {
                                                l18 = true;
                                            } else {
                                    ...
                                    vader_struct___lambda_env_2990_t* _a11_obj = (vader_struct___lambda_env_2990_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2990_t));
                                    vader_obj_header_init(_a11_obj, 249u);
                                    _a11_obj->f_cap_0 = l16;
                                    _a11_obj->f_cap_1 = l19;
                                    t2 = (void*) _a11_obj;
                                    vader_fn_t* _a12_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
                                    vader_obj_header_init(_a12_closure, 139u);
                                    _a12_closure->code = (void*) &vader_fn_lift_1801;
                                    _a12_closure->env = t2;
                                    ...
                                    t4 = vader_box_bool(161u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l34]);
                                    t1 = t4.payload.b;
                                    if (t1) {
                                        l18 = true;
                                    } else {
...
static void vader_midir_for_each_read_in_terminator(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 841u) {
        ...
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_TermCondBranch_t*) t0)->f_cond));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 842u) {
        l2 = l0.payload.obj;
...
static void vader_midir_for_each_read_local(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 826u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a0_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrMove_t*) t0)->f_src));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 810u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a1_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a1_fnobj->code)(_a1_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_lhs));
        vader_fn_t* _a2_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrBinOp_t*) l2)->f_rhs));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 831u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a3_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a3_fnobj->code)(_a3_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrUnOp_t*) t0)->f_operand));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 811u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_56: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a5_fnobj->code)(_a5_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_56;
                } else {
    ...
    if (l0.tag == 812u) {
        ...
        ((vader_fn_erased_sig_1_t) _a6_fnobj->code)(_a6_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCallIndirect_t*) l2)->f_callee));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_93: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a8_fnobj->code)(_a8_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_93;
                } else {
    ...
    if (l0.tag == 832u) {
        ...
        ((vader_fn_erased_sig_1_t) _a9_fnobj->code)(_a9_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrVirtualCall_t*) l2)->f_receiver));
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_130: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a11_fnobj->code)(_a11_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_130;
                } else {
    ...
    if (l0.tag == 821u) {
        ...
        ((vader_fn_erased_sig_1_t) _a12_fnobj->code)(_a12_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldGet_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 822u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a13_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a13_fnobj->code)(_a13_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_target));
        vader_fn_t* _a14_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrFieldSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 804u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a15_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a15_fnobj->code)(_a15_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_target));
        vader_fn_t* _a16_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a16_fnobj->code)(_a16_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayGet_t*) l2)->f_index));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 808u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a17_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a17_fnobj->code)(_a17_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_target));
        vader_fn_t* _a18_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_index));
        vader_fn_t* _a19_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a19_fnobj->code)(_a19_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 805u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a20_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a20_fnobj->code)(_a20_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayLen_t*) t0)->f_target));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 807u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a21_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a21_fnobj->code)(_a21_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_target));
        vader_fn_t* _a22_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a22_fnobj->code)(_a22_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArrayPush_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 809u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a23_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a23_fnobj->code)(_a23_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_target));
        vader_fn_t* _a24_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a24_fnobj->code)(_a24_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_lo));
        vader_fn_t* _a25_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a25_fnobj->code)(_a25_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrArraySlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 827u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a26_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a26_fnobj->code)(_a26_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_target));
        vader_fn_t* _a27_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a27_fnobj->code)(_a27_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_lo));
        vader_fn_t* _a28_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a28_fnobj->code)(_a28_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrStringSlice_t*) l2)->f_hi));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 828u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_276: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a30_fnobj->code)(_a30_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_276;
                } else {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_309: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a32_fnobj->code)(_a32_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_309;
                } else {
    ...
    if (l0.tag == 829u) {
        ...
        ((vader_fn_erased_sig_1_t) _a33_fnobj->code)(_a33_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrTypeCheck_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 830u) {
        { vader_gc_top = gc_frame.prev; return; }
    ...
    if (l0.tag == 813u) {
        ...
        ((vader_fn_erased_sig_1_t) _a34_fnobj->code)(_a34_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCast_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 815u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a35_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a35_fnobj->code)(_a35_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellNew_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 814u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a36_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a36_fnobj->code)(_a36_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellGet_t*) t0)->f_cell));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 816u) {
        l2 = l0.payload.obj;
        vader_fn_t* _a37_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a37_fnobj->code)(_a37_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_cell));
        vader_fn_t* _a38_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a38_fnobj->code)(_a38_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrCellSet_t*) l2)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 825u) {
        t0 = l0.payload.obj;
        vader_fn_t* _a39_fnobj = (vader_fn_t*) l1;
        ((vader_fn_erased_sig_1_t) _a39_fnobj->code)(_a39_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrMakeClosure_t*) t0)->f_env));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 824u) {
        t0 = l0.payload.obj;
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            loop_416: {
                if ((l4 < l3)) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a41_fnobj->code)(_a41_fnobj->env, vader_box_i32(166u, t1));
                    t2 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t2;
                    goto loop_416;
                } else {
    ...
    if (l0.tag == 820u) {
        ...
        ((vader_fn_erased_sig_1_t) _a42_fnobj->code)(_a42_fnobj->env, vader_box_i32(166u, ((vader_struct_vader_midir_InstrDeferPush_t*) t0)->f_value));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l0.tag == 819u) {
        { vader_gc_top = gc_frame.prev; return; }
...
static void* vader_midir_freeze_block(void* l0) {
    ...
    if (((vader_struct_vader_midir_MutableBlock_t*) l0)->f_terminator.tag == 0u) {
        ...
        vader_obj_header_init(_a1_obj, 784u);
        _a1_obj->f_id = l1;
    ...
    vader_obj_header_init(_a2_obj, 784u);
    _a2_obj->f_id = l1;
...
static int32_t vader_midir_fresh_tmp(void* l0, vader_string_t l1, vader_box_t l2) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    l4 = std_core_write_string_at(l5, l4, 254u);
...
static bool vader_midir_instruction_has_side_effect(vader_box_t l0) {
    return (l0.tag == 807u || l0.tag == 808u || l0.tag == 811u || l0.tag == 812u || l0.tag == 816u || l0.tag == 822u || l0.tag == 824u || l0.tag == 832u);
}
...
static int32_t vader_midir_intern_string_pool(void* l0, vader_string_t l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_midir_ProjectCtx_t*) l0)->f_strings, vader_box_string(163u, l1));
...
static bool vader_midir_is_mutable_slot(vader_box_t l0) {
    ...
    if ((l0.tag == 903u || l0.tag == 905u || l0.tag == 906u || l0.tag == 907u || l0.tag == 908u || l0.tag == 909u || l0.tag == 910u || l0.tag == 911u || l0.tag == 913u || l0.tag == 914u || l0.tag == 916u || l0.tag == 918u || l0.tag == 919u || l0.tag == 920u || l0.tag == 921u)) {
        return false;
    }
...
static bool vader_midir_loop_exit_present(void* l0, int32_t l1) {
    ...
    void** gc_raw_roots[5] = { &l0, &l2, &l3, &l4, &t0 };
    vader_struct___Tuple_1267_t _a2_storage = {0};
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l6 >= l5)) {
                ...
                vader_struct___Tuple_1267_t* _a3_obj = &_a2_storage;
                vader_obj_header_init(_a3_obj, 223u);
                _a3_obj->f__0 = l7;
                _a3_obj->f__1 = l8;
                t0 = (void*) _a3_obj;
                l9 = ((vader_struct___Tuple_1267_t*) t0)->f__0;
                t1 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t1;
                if (l9 == l1) {
...
static vader_box_t vader_midir_lowered_to_bc_value(vader_box_t l0) {
    ...
    if (l0.tag == 765u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(122u, 0u, 13u, 1080u);
        l2 = (void*) _a1_arr;
        l3 = ((vader_struct_vader_lower_LoweredStructLit_t*) l1)->f_fields;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
    ...
    if (l0.tag == 724u) {
        l1 = l0.payload.obj;
        vader_array_t* _a4_arr = vader_array_new(122u, 0u, 13u, 1080u);
        l2 = (void*) _a4_arr;
        l3 = ((vader_struct_vader_lower_LoweredArrayLit_t*) l1)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
        l5 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_midir_make_extern_decl(void* l0) {
    ...
    vader_obj_header_init(_a3_obj, 785u);
...
static void* vader_midir_make_struct_decl(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(75u, 0u, 13u, 792u);
    l1 = (void*) _a0_arr;
...
static void* vader_midir_new_project_ctx(void* l0) {
    ...
    vader_obj_header_init(_a4_obj, 353u);
    _a4_obj->f_ekeys = l2;
    _a4_obj->f_evals = l3;
    _a4_obj->f_index = l4;
    _a4_obj->f_mask = (size_t) (int64_t) INT64_C(0);
...
static void* vader_midir_no_hints(void) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 6u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(10u, 0u, 8u, 167u);
    l0 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 161u);
    l1 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    ...
    vader_obj_header_init(_a4_obj, 371u);
    _a4_obj->f_inner = t0;
    l0 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(10u, 0u, 8u, 167u);
    l1 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(6u, 0u, 12u, 161u);
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 166u);
    ...
    vader_obj_header_init(_a8_obj, 312u);
    _a8_obj->f_ekeys = l1;
    _a8_obj->f_evals = l2;
    _a8_obj->f_index = l3;
    _a8_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a9_obj, 371u);
    _a9_obj->f_inner = t0;
    l1 = (void*) _a9_obj;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 166u);
    l2 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(6u, 0u, 12u, 161u);
    l3 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a13_obj, 303u);
    _a13_obj->f_ekeys = l2;
    _a13_obj->f_evals = l3;
    _a13_obj->f_index = l4;
    ...
    vader_obj_header_init(_a14_obj, 370u);
    _a14_obj->f_inner = t0;
    l2 = (void*) _a14_obj;
    ...
    vader_obj_header_init(_a15_obj, 838u);
...
static void* vader_midir_predecessors_of(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = ((vader_array_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_blocks)->length;
    vader_struct___lambda_env_1952_t* _a0_obj = (vader_struct___lambda_env_1952_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_1952_t));
    ...
    _a1_closure->code = (void*) &vader_fn_lift_1782;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
...
static void* vader_midir_prune_block(void* l0, void* l1, size_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 178u);
    _a2_obj->f_value = t0;
    t0 = (void*) _a2_obj;
    l3 = vader_ref_box(t0);
    vader_struct___lambda_env_3030_t* _a3_obj = (vader_struct___lambda_env_3030_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3030_t));
    vader_obj_header_init(_a3_obj, 254u);
    _a3_obj->f_cap_0 = l3;
    t0 = (void*) _a3_obj;
    vader_fn_t* _a4_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a4_closure, 139u);
    _a4_closure->code = (void*) &vader_fn_lift_1808;
    _a4_closure->env = t0;
    t0 = (void*) _a4_closure;
    ...
    vader_obj_header_init(_a5_obj, 182u);
    _a5_obj->f_value = t0;
    t0 = (void*) _a5_obj;
    l4 = vader_ref_box(t0);
    l5 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_22: {
            if ((l8 >= l7)) {
                ...
                ((vader_fn_erased_sig_1_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i32(166u, l9));
    ...
    vader_struct___lambda_env_3038_t* _a9_obj = (vader_struct___lambda_env_3038_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3038_t));
    vader_obj_header_init(_a9_obj, 255u);
    _a9_obj->f_cap_0 = l4;
    _a9_obj->f_cap_1 = l3;
    t0 = (void*) _a9_obj;
    vader_fn_t* _a10_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a10_closure, 139u);
    _a10_closure->code = (void*) &vader_fn_lift_1809;
    _a10_closure->env = t0;
    ...
    vader_array_t* _a11_arr = vader_array_new(6u, 1u, 12u, 161u);
        ...
        loop_78: {
            if ((l13 >= INT64_C(0))) {
                ...
                if (l14.tag == 166u) {
                    ...
                    ((vader_fn_erased_sig_1_t) _a14_fnobj->code)(_a14_fnobj->env, vader_box_i32(166u, l9));
                    ...
                    if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                    if ((size_t) l11 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                    t2 = vader_box_bool(161u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l11]);
                    l15 = t2.payload.b;
                } else {
                }
                ...
                if (l17) {
                    ...
                    if (l14.tag == 166u) {
                        ...
                        ((vader_fn_erased_sig_1_t) _a18_fnobj->code)(_a18_fnobj->env, vader_box_i32(166u, l20));
                    ...
                    vader_struct___lambda_env_3041_t* _a20_obj = (vader_struct___lambda_env_3041_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3041_t));
                    ...
                    vader_fn_t* _a21_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
                    vader_obj_header_init(_a21_closure, 139u);
                    _a21_closure->code = (void*) &vader_fn_lift_1810;
                    _a21_closure->env = t0;
    ...
    vader_array_t* _a22_arr = vader_array_new(130u, 0u, 13u, 1148u);
    l6 = (void*) _a22_arr;
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_192: {
            if ((l8 < l7)) {
                ...
                if (_a23_slotarr->buf != NULL && _a23_slotarr->buf->header.forward != NULL) { _a23_slotarr->buf = vader_array_buf_forward(_a23_slotarr->buf); }
                if ((size_t) l8 >= _a23_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_box_bool(161u, ((uint8_t*) _a23_slotarr->buf->slots)[_a23_slotarr->offset + (size_t) l8]);
                t3 = t2.payload.b;
                if (t3) {
...
static vader_box_t vader_midir_remap_instr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 832u) {
        ...
        vader_obj_header_init(_a6_obj, 832u);
        _a6_obj->f_span = l3;
        _a6_obj->f_dst = l5;
    ...
    if (l0.tag == 821u) {
        ...
        vader_obj_header_init(_a8_obj, 821u);
        _a8_obj->f_span = l3;
        _a8_obj->f_dst = l4;
        _a8_obj->f_target = l7;
        _a8_obj->f_field = l13;
    ...
    if (l0.tag == 822u) {
        ...
        vader_obj_header_init(_a9_obj, 822u);
        _a9_obj->f_span = l3;
        _a9_obj->f_target = l4;
        _a9_obj->f_field = l13;
        _a9_obj->f_value = l7;
    ...
    if (l0.tag == 805u) {
        ...
        vader_obj_header_init(_a12_obj, 805u);
        _a12_obj->f_span = l3;
        _a12_obj->f_dst = l4;
    ...
    if (l0.tag == 809u) {
        ...
        vader_obj_header_init(_a14_obj, 809u);
        _a14_obj->f_span = l3;
        _a14_obj->f_dst = l4;
        _a14_obj->f_type = l5;
    ...
    if (l0.tag == 806u) {
        ...
        vader_obj_header_init(_a17_obj, 806u);
        _a17_obj->f_span = l3;
        _a17_obj->f_dst = l4;
        _a17_obj->f_type = l5;
    ...
    if (l0.tag == 818u) {
        ...
        vader_obj_header_init(_a18_obj, 818u);
        _a18_obj->f_span = l3;
        _a18_obj->f_dst = l4;
        _a18_obj->f_type = l5;
    ...
    if (l0.tag == 830u) {
        ...
        vader_obj_header_init(_a20_obj, 830u);
        _a20_obj->f_span = l3;
        _a20_obj->f_dst = l4;
        _a20_obj->f_type = l5;
    ...
    if (l0.tag == 813u) {
        ...
        vader_obj_header_init(_a21_obj, 813u);
        _a21_obj->f_span = l3;
        _a21_obj->f_dst = l4;
        _a21_obj->f_value = l7;
        _a21_obj->f_type = l5;
    ...
    if (l0.tag == 815u) {
        ...
        vader_obj_header_init(_a22_obj, 815u);
        _a22_obj->f_span = l3;
        _a22_obj->f_dst = l4;
        _a22_obj->f_value = l7;
    ...
    if (l0.tag == 814u) {
        ...
        vader_obj_header_init(_a23_obj, 814u);
        _a23_obj->f_span = l3;
        _a23_obj->f_dst = l4;
        _a23_obj->f_cell = l7;
    ...
    if (l0.tag == 824u) {
        ...
        vader_obj_header_init(_a26_obj, 824u);
        _a26_obj->f_span = l3;
        _a26_obj->f_dst = l5;
        _a26_obj->f_name = l13;
        _a26_obj->f_args = l2;
    ...
    if (l0.tag == 820u) {
        ...
        vader_obj_header_init(_a27_obj, 820u);
        _a27_obj->f_span = l3;
        _a27_obj->f_value = l4;
        t0 = (void*) _a27_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_midir_reserve_cfg_extern(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 494u);
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGExternDecl_t*) l0)->f_origin)->f_symbol.tag == 878u) {
...
static void vader_midir_reserve_cfg_function(void* l0, void* l1) {
    ...
    l4 = ((int32_t) (size_t) t0);
    vader_array_t* _a0_arr = vader_array_new(119u, 0u, 13u, 1068u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(123u, 0u, 13u, 1092u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    l7 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(40u, 0u, 13u, 495u);
    l8 = (void*) _a3_arr;
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGFunction_t*) l0)->f_origin)->f_symbol.tag == 878u) {
...
static void vader_midir_reserve_cfg_struct(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = -(INT32_C(1));
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 878u) {
    ...
    if (((vader_struct_vader_comptime_MonoEntry_t*) ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_origin)->f_symbol.tag == 878u) {
        ...
        if (l6.tag == 166u) {
            ...
            l7 = l8;
            vader_array_t* _a1_arr = vader_array_new(37u, 0u, 13u, 491u);
            l10 = (void*) _a1_arr;
        ...
        l4 = (void*) _a6_obj;
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
        vader_array_t* _a7_arr = vader_array_new(37u, 0u, 13u, 491u);
        l10 = (void*) _a7_arr;
        l11 = ((vader_struct_vader_midir_CFGStructDecl_t*) l0)->f_fields;
        l9 = ((vader_array_t*) l11)->length;
        l12 = (size_t) (int64_t) INT64_C(0);
        ...
        vader_obj_header_init(_a10_obj, 502u);
        _a10_obj->f_name = l23;
    ...
    vader_obj_header_init(_a12_obj, 499u);
    _a12_obj->f_trait_name = t4;
    l4 = (void*) _a12_obj;
    vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    vader_array_t* _a13_arr = vader_array_new(37u, 0u, 13u, 491u);
    l3 = (void*) _a13_arr;
    ...
    l12 = (size_t) (int64_t) INT64_C(0);
    {
        loop_257: {
            if ((l12 < l9)) {
                ...
                vader_obj_header_init(_a15_obj, 491u);
                _a15_obj->f_name = t4;
    ...
    vader_obj_header_init(_a16_obj, 502u);
    _a16_obj->f_name = l5;
...
static void* vader_midir_successors_of(void* l0) {
    ...
    if (l1.tag == 841u) {
        ...
        vader_array_t* _a1_arr = vader_array_new(9u, 2u, 7u, 166u);
    ...
    l9 = INT32_C(0);
    {
        loop_53: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a6_arr = vader_array_new(123u, 0u, 13u, 1092u);
                l14 = (void*) _a6_arr;
                ...
                vader_array_t* _a8_arr = vader_array_new(40u, 0u, 13u, 495u);
                l20 = (void*) _a8_arr;
...
static bool vader_midir_try_fuse_local_field(void* l0, int32_t l1, int32_t l2) {
    ...
    vader_obj_header_init(_a1_obj, 603u);
    _a1_obj->f_slot = l7;
...
static void vader_midir_walk_rpo(void* l0, int32_t l1, void* l2, void* l3) {
    ...
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
    t0 = vader_box_bool(161u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
    t1 = t0.payload.b;
    if (t1) {
        { vader_gc_top = gc_frame.prev; return; }
    }
...
static void* vader_midir_with_by_address(void* l0, void* l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(6u, 0u, 12u, 161u);
    l3 = (void*) _a0_arr;
    l4 = false;
    t0 = l2.payload.obj;
...
static vader_box_t vader_midir_with_dst(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 805u) {
        ...
        vader_obj_header_init(_a6_obj, 805u);
        _a6_obj->f_span = l3;
        _a6_obj->f_dst = l1;
        _a6_obj->f_target = l6;
    ...
    if (l0.tag == 809u) {
        ...
        vader_obj_header_init(_a7_obj, 809u);
        _a7_obj->f_span = l3;
        _a7_obj->f_dst = l1;
        _a7_obj->f_type = l4;
        _a7_obj->f_target = l6;
    ...
    if (l0.tag == 829u) {
        ...
        vader_obj_header_init(_a12_obj, 829u);
        _a12_obj->f_span = l3;
        _a12_obj->f_dst = l1;
        _a12_obj->f_value = l6;
    ...
    if (l0.tag == 830u) {
        ...
        vader_obj_header_init(_a13_obj, 830u);
        _a13_obj->f_span = l3;
        _a13_obj->f_dst = l1;
        _a13_obj->f_type = l4;
    ...
    if (l0.tag == 814u) {
        ...
        vader_obj_header_init(_a16_obj, 814u);
        _a16_obj->f_span = l3;
        _a16_obj->f_dst = l1;
        _a16_obj->f_cell = l6;
    ...
    if (l0.tag == 825u) {
        ...
        vader_obj_header_init(_a17_obj, 825u);
        _a17_obj->f_span = l3;
        _a17_obj->f_dst = l1;
...
static void* vader_midir_with_peephole_out(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a0_obj, 493u);
    _a0_obj->f_name = l2;
