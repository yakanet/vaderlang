...
static void std_sort_merge_sort_range__Diagnostic(void* l0, void* l1, size_t l2, size_t l3, void* l4);
    ...
    while ((l4 < l2)) {
        ...
        for (;;) {
            if ((l6 > l1)) {
                ...
                vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(193u, l5), vader_box_i32(193u, l9));
                l7 = t1.payload.b;
            } else {
                l7 = false;
            }
    ...
    while ((l4 < l2)) {
        ...
        for (;;) {
            if ((l6 > l1)) {
                ...
                l9 = t1.payload.s;
                vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_string(190u, l5), vader_box_string(190u, l9));
                l7 = t1.payload.b;
            } else {
                l7 = false;
            }
            if (l7) {
                ...
                l11 = t1.payload.s;
                VADER_ARRAY_CHECK_INDEX(_a3_slotarr, l6)
                vader_array_box_slots(_a3_slotarr->buf)[_a3_slotarr->offset + (size_t) l6] = vader_box_string(190u, l11);
                VADER_WRITE_BARRIER(_a3_slotarr->buf);
                t0 = (l6 - INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                continue;
        ...
        VADER_ARRAY_RESOLVE_BUF(_a4_slotarr)
        VADER_ARRAY_CHECK_INDEX(_a4_slotarr, l6)
        vader_array_box_slots(_a4_slotarr->buf)[_a4_slotarr->offset + (size_t) l6] = vader_box_string(190u, l5);
        VADER_WRITE_BARRIER(_a4_slotarr->buf);
        t0 = (l4 + INT64_C(1));
        l4 = (size_t) (int64_t) t0;
    }
    ...
    while ((l4 < l2)) {
        ...
        for (;;) {
            if ((l6 > l1)) {
                ...
                vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i64(200u, (int64_t)(uint64_t) l5), vader_box_i64(200u, (int64_t)(uint64_t) l9));
                l7 = t1.payload.b;
            } else {
                l7 = false;
            }
...
static void std_sort_merge_sort_range__Diagnostic(void* l0, void* l1, size_t l2, size_t l3, void* l4) {
    ...
    t0 = (l2 + l5);
    l5 = (size_t) (int64_t) t0;
    std_sort_merge_sort_range__Diagnostic(l0, l1, l2, l5, l4);
    std_sort_merge_sort_range__Diagnostic(l0, l1, l5, l3, l4);
    l6 = l2;
    while ((l6 < l3)) {
        vader_array_t* _a0_slotarr = ((vader_array_t*) l0);
        VADER_ARRAY_RESOLVE_BUF(_a0_slotarr)
    ...
    while ((l9 < l3)) {
        if ((l6 >= l5)) {
            ...
            if (t3) {
                ...
                VADER_ARRAY_CHECK_INDEX(_a8_slotarr, l8)
...
static void std_sort_merge_sort_range__i32(void* l0, void* l1, size_t l2, size_t l3, void* l4) {
    ...
    while ((l9 < l3)) {
        if ((l6 >= l5)) {
            ...
            vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
            t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i32(193u, l11), vader_box_i32(193u, l12));
            t3 = t2.payload.b;
            if (t3) {
                vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                VADER_ARRAY_RESOLVE_BUF(_a8_slotarr)
...
static void std_sort_merge_sort_range__string(void* l0, void* l1, size_t l2, size_t l3, void* l4) {
    ...
    vader_gc_frame_t gc_frame = {
        vader_gc_top, 1u, 3u, gc_roots, gc_raw_roots, 0u, NULL, 6u, gc_atom_roots,
    };
    vader_gc_top = &gc_frame;
    t0 = (l3 - l2);
    l5 = (size_t) (int64_t) t0;
    ...
    while ((l6 < l3)) {
        ...
        VADER_ARRAY_RESOLVE_BUF(_a1_slotarr)
        VADER_ARRAY_CHECK_INDEX(_a1_slotarr, l6)
        vader_array_box_slots(_a1_slotarr->buf)[_a1_slotarr->offset + (size_t) l6] = vader_box_string(190u, l7);
        VADER_WRITE_BARRIER(_a1_slotarr->buf);
        t0 = (l6 + INT64_C(1));
        l6 = (size_t) (int64_t) t0;
    }
    ...
    while ((l9 < l3)) {
        if ((l6 >= l5)) {
            ...
            VADER_ARRAY_RESOLVE_BUF(_a3_slotarr)
            VADER_ARRAY_CHECK_INDEX(_a3_slotarr, l9)
            vader_array_box_slots(_a3_slotarr->buf)[_a3_slotarr->offset + (size_t) l9] = vader_box_string(190u, l7);
            VADER_WRITE_BARRIER(_a3_slotarr->buf);
            t0 = (l8 + INT64_C(1));
            l8 = (size_t) (int64_t) t0;
        } else if ((l8 >= l3)) {
            ...
            VADER_ARRAY_RESOLVE_BUF(_a5_slotarr)
            VADER_ARRAY_CHECK_INDEX(_a5_slotarr, l9)
            vader_array_box_slots(_a5_slotarr->buf)[_a5_slotarr->offset + (size_t) l9] = vader_box_string(190u, l10);
            VADER_WRITE_BARRIER(_a5_slotarr->buf);
            t0 = (l6 + INT64_C(1));
            l6 = (size_t) (int64_t) t0;
        } else {
            ...
            l12 = t2.payload.s;
            vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
            t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_string(190u, l11), vader_box_string(190u, l12));
            t3 = t2.payload.b;
            if (t3) {
                vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                VADER_ARRAY_RESOLVE_BUF(_a8_slotarr)
                ...
                VADER_ARRAY_RESOLVE_BUF(_a9_slotarr)
                VADER_ARRAY_CHECK_INDEX(_a9_slotarr, l9)
                vader_array_box_slots(_a9_slotarr->buf)[_a9_slotarr->offset + (size_t) l9] = vader_box_string(190u, l13);
                VADER_WRITE_BARRIER(_a9_slotarr->buf);
                t0 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t0;
            } else {
                ...
                VADER_ARRAY_RESOLVE_BUF(_a11_slotarr)
                VADER_ARRAY_CHECK_INDEX(_a11_slotarr, l9)
                vader_array_box_slots(_a11_slotarr->buf)[_a11_slotarr->offset + (size_t) l9] = vader_box_string(190u, l14);
                VADER_WRITE_BARRIER(_a11_slotarr->buf);
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
            }
...
static void std_sort_merge_sort_range__usize(void* l0, void* l1, size_t l2, size_t l3, void* l4) {
    ...
    while ((l8 < l3)) {
        if ((l6 >= l5)) {
            ...
            vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
            t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i64(200u, (int64_t)(uint64_t) l11), vader_box_i64(200u, (int64_t)(uint64_t) l12));
            t3 = t2.payload.b;
            if (t3) {
                vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                VADER_ARRAY_RESOLVE_BUF(_a8_slotarr)
...
void* std_sort_sort__Diagnostic(void* l0, void* l1) {
    ...
    std_sort_merge_sort_range__Diagnostic(l3, l4, (size_t) 0, l2, l1);
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
}
...
void* std_sort_sort__i32(void* l0, void* l1) {
    ...
    std_sort_merge_sort_range__i32(l3, l4, (size_t) 0, l2, l1);
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
}
...
void* std_sort_sort__string(void* l0, void* l1) {
    ...
    std_sort_merge_sort_range__string(l3, l4, (size_t) 0, l2, l1);
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
}
...
void* std_sort_sort__usize(void* l0, void* l1) {
    ...
    std_sort_merge_sort_range__usize(l3, l4, (size_t) 0, l2, l1);
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
}
