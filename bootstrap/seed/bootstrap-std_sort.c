                ...
                l6 = l4;
                {
                    loop_17: {
                        if ((l6 > l1)) {
                            ...
                            vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                            t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(174u, l5), vader_box_i32(174u, l9));
                            l7 = t1.payload.b;
                        } else {
                            l7 = false;
                        }
    ...
    l4 = (size_t) (int64_t) t0;
    {
        loop_5: {
            if ((l4 < l2)) {
                ...
                l6 = l4;
                {
                    loop_18: {
                        if ((l6 > l1)) {
                            ...
                            l9 = t1.payload.s;
                            vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                            t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_string(171u, l5), vader_box_string(171u, l9));
                            l7 = t1.payload.b;
                        } else {
                            l7 = false;
                        }
                        if (l7) {
                            ...
                            l11 = t1.payload.s;
                            if ((size_t) l6 >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
                            vader_array_box_slots(_a3_slotarr->buf)[_a3_slotarr->offset + (size_t) l6] = vader_box_string(171u, l11);
                            VADER_WRITE_BARRIER(_a3_slotarr->buf);
                            t0 = (l6 - INT64_C(1));
                            l6 = (size_t) (int64_t) t0;
                            goto loop_18;
                ...
                if (_a4_slotarr->buf != NULL && _a4_slotarr->buf->header.forward != NULL) { _a4_slotarr->buf = vader_array_buf_forward(_a4_slotarr->buf); }
                if ((size_t) l6 >= _a4_slotarr->length) { vader_trap("array index out of bounds"); }
                vader_array_box_slots(_a4_slotarr->buf)[_a4_slotarr->offset + (size_t) l6] = vader_box_string(171u, l5);
                VADER_WRITE_BARRIER(_a4_slotarr->buf);
                t0 = (l4 + INT64_C(1));
                l4 = (size_t) (int64_t) t0;
                goto loop_5;
                ...
                l6 = l4;
                {
                    loop_17: {
                        if ((l6 > l1)) {
                            ...
                            vader_fn_t* _a2_fnobj = (vader_fn_t*) l3;
                            t1 = ((vader_fn_erased_sig_2_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i64(181u, (int64_t)(uint64_t) l5), vader_box_i64(181u, (int64_t)(uint64_t) l9));
                            l7 = t1.payload.b;
                        } else {
                            l7 = false;
                        }
            ...
            if ((l9 < l3)) {
                if ((l6 >= l5)) {
                    ...
                    if ((l8 >= l3)) {
                        ...
                        vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
                        t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i32(174u, l11), vader_box_i32(174u, l12));
                        t3 = t2.payload.b;
                        if (t3) {
                            vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                            if (_a8_slotarr->buf != NULL && _a8_slotarr->buf->header.forward != NULL) { _a8_slotarr->buf = vader_array_buf_forward(_a8_slotarr->buf); }
    ...
    l6 = l2;
    {
        loop_43: {
            if ((l6 < l3)) {
                ...
                if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
                if ((size_t) l6 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
                vader_array_box_slots(_a1_slotarr->buf)[_a1_slotarr->offset + (size_t) l6] = vader_box_string(171u, l7);
                VADER_WRITE_BARRIER(_a1_slotarr->buf);
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                goto loop_43;
        ...
        loop_72: {
            if ((l9 < l3)) {
                if ((l6 >= l5)) {
                    ...
                    if (_a3_slotarr->buf != NULL && _a3_slotarr->buf->header.forward != NULL) { _a3_slotarr->buf = vader_array_buf_forward(_a3_slotarr->buf); }
                    if ((size_t) l9 >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
                    vader_array_box_slots(_a3_slotarr->buf)[_a3_slotarr->offset + (size_t) l9] = vader_box_string(171u, l7);
                    VADER_WRITE_BARRIER(_a3_slotarr->buf);
                    t0 = (l8 + INT64_C(1));
                    l8 = (size_t) (int64_t) t0;
                } else {
                    if ((l8 >= l3)) {
                        ...
                        if (_a5_slotarr->buf != NULL && _a5_slotarr->buf->header.forward != NULL) { _a5_slotarr->buf = vader_array_buf_forward(_a5_slotarr->buf); }
                        if ((size_t) l9 >= _a5_slotarr->length) { vader_trap("array index out of bounds"); }
                        vader_array_box_slots(_a5_slotarr->buf)[_a5_slotarr->offset + (size_t) l9] = vader_box_string(171u, l10);
                        VADER_WRITE_BARRIER(_a5_slotarr->buf);
                        t0 = (l6 + INT64_C(1));
                        l6 = (size_t) (int64_t) t0;
                    } else {
                        ...
                        l12 = t2.payload.s;
                        vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
                        t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_string(171u, l11), vader_box_string(171u, l12));
                        t3 = t2.payload.b;
                        if (t3) {
                            vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                            if (_a8_slotarr->buf != NULL && _a8_slotarr->buf->header.forward != NULL) { _a8_slotarr->buf = vader_array_buf_forward(_a8_slotarr->buf); }
                            ...
                            if (_a9_slotarr->buf != NULL && _a9_slotarr->buf->header.forward != NULL) { _a9_slotarr->buf = vader_array_buf_forward(_a9_slotarr->buf); }
                            if ((size_t) l9 >= _a9_slotarr->length) { vader_trap("array index out of bounds"); }
                            vader_array_box_slots(_a9_slotarr->buf)[_a9_slotarr->offset + (size_t) l9] = vader_box_string(171u, l13);
                            VADER_WRITE_BARRIER(_a9_slotarr->buf);
                            t0 = (l8 + INT64_C(1));
                            l8 = (size_t) (int64_t) t0;
                        } else {
                            ...
                            if (_a11_slotarr->buf != NULL && _a11_slotarr->buf->header.forward != NULL) { _a11_slotarr->buf = vader_array_buf_forward(_a11_slotarr->buf); }
                            if ((size_t) l9 >= _a11_slotarr->length) { vader_trap("array index out of bounds"); }
                            vader_array_box_slots(_a11_slotarr->buf)[_a11_slotarr->offset + (size_t) l9] = vader_box_string(171u, l14);
                            VADER_WRITE_BARRIER(_a11_slotarr->buf);
                            t0 = (l6 + INT64_C(1));
                            l6 = (size_t) (int64_t) t0;
                        }
            ...
            if ((l8 < l3)) {
                if ((l6 >= l5)) {
                    ...
                    if ((l7 >= l3)) {
                        ...
                        vader_fn_t* _a7_fnobj = (vader_fn_t*) l4;
                        t2 = ((vader_fn_erased_sig_2_t) _a7_fnobj->code)(_a7_fnobj->env, vader_box_i64(181u, (int64_t)(uint64_t) l11), vader_box_i64(181u, (int64_t)(uint64_t) l12));
                        t3 = t2.payload.b;
                        if (t3) {
                            vader_array_t* _a8_slotarr = ((vader_array_t*) l1);
                            if (_a8_slotarr->buf != NULL && _a8_slotarr->buf->header.forward != NULL) { _a8_slotarr->buf = vader_array_buf_forward(_a8_slotarr->buf); }
