...
vader_box_t std_string_StringChars_Iterator_next(void* l0) {
    ...
    l4 = ((vader_struct___Tuple_254_t*) l3)->f__0;
    l1 = ((vader_struct___Tuple_254_t*) l3)->f__1;
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_3: {
            if ((l4 < l3)) {
                ...
                t1 = vader_array_read_u8(_a0_slotarr, _a0_slotarr->offset + (size_t) l5, 169u);
                ...
                t1 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 169u);
    ...
    l5 = l2;
    {
        loop_8: {
            if ((l5 < l4)) {
                ...
                l7 = ((vader_struct___Tuple_254_t*) l6)->f__0;
                l8 = ((vader_struct___Tuple_254_t*) l6)->f__1;
                if (l7 == l1) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_11: {
            if ((l6 < l4)) {
                ...
                l8 = ((vader_struct___Tuple_254_t*) l7)->f__0;
                l9 = ((vader_struct___Tuple_254_t*) l7)->f__1;
    ...
    l4 = std_string_chars(l0);
    {
        loop_7: {
            ...
            if (l5.tag == 0u) {
                ...
                t1 = ((vader_fn_erased_sig_1_t) _a2_fnobj->code)(_a2_fnobj->env, vader_box_i32(162u, (int32_t) l6));
                t2 = t1.payload.b;
                if (t2) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_11: {
            if ((l4 < l3)) {
                ...
                l6 = ((vader_struct___Tuple_254_t*) l5)->f__0;
                l7 = ((vader_struct___Tuple_254_t*) l5)->f__1;
...
uint32_t std_string_utf8_decode(void* l0, size_t l1) {
    ...
    if ((l3 < INT32_C(224))) {
        ...
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
        if ((size_t) l4 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l4, 169u);
    ...
    if ((l3 < INT32_C(240))) {
        ...
        if (_a2_slotarr->buf != NULL && _a2_slotarr->buf->header.forward != NULL) { _a2_slotarr->buf = vader_array_buf_forward(_a2_slotarr->buf); }
        if ((size_t) l4 >= _a2_slotarr->length) { vader_trap("array index out of bounds"); }
        t0 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l4, 169u);
        l5 = ((uint8_t) t0.payload.i);
        t2 = (l1 + INT64_C(2));
        l4 = (size_t) (int64_t) t2;
        if ((size_t) l4 >= _a2_slotarr->length) { vader_trap("array index out of bounds"); }
    ...
    t0 = vader_array_read_u8(_a3_slotarr, _a3_slotarr->offset + (size_t) l2, 169u);
    l5 = ((uint8_t) t0.payload.i);
    t2 = (l1 + INT64_C(2));
    l2 = (size_t) (int64_t) t2;
    if ((size_t) l2 >= _a3_slotarr->length) { vader_trap("array index out of bounds"); }
...
void* std_string_utf8_decode_len(void* l0, size_t l1) {
    ...
    vader_struct___Tuple_254_t* _a0_obj = (vader_struct___Tuple_254_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_254_t));
