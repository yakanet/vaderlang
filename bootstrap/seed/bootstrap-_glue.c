...
vader_string_t vader_vt_Display__to_string(vader_box_t recv) {
    switch (recv.tag) {
        ...
        case 384u: return std_string_builder_StringBuilder_Display_to_string(recv.payload.obj);
        case 475u: return toolchain_span_Span_Display_to_string(recv.payload.obj);
        case 933u: return vader_vm_I32Val_Display_to_string(recv.payload.obj);
        case 929u: return vader_vm_F64Val_Display_to_string(recv.payload.obj);
        case 934u: return vader_vm_I64Val_Display_to_string(recv.payload.obj);
        case 943u: return vader_vm_StringVal_Display_to_string(recv.payload.obj);
        case 930u: return vader_vm_FnVal_Display_to_string(recv.payload.obj);
        case 937u: return vader_vm_NullVal_Display_to_string(recv.payload.obj);
        case 925u: return vader_vm_BoolVal_Display_to_string(recv.payload.obj);
        case 926u: return vader_vm_CharVal_Display_to_string(recv.payload.obj);
        case 928u: return vader_vm_ErrorVal_Display_to_string(recv.payload.obj);
        case 946u: return vader_vm_TypeVal_Display_to_string(recv.payload.obj);
        case 938u: return vader_vm_ObjVal_Display_to_string(recv.payload.obj);
        case 944u: return vader_vm_StructVal_Display_to_string(recv.payload.obj);
        case 924u: return vader_vm_ArrayVal_Display_to_string(recv.payload.obj);
