...
vader_fn_t vader_fn_static_2380 = { { 150u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_2380, NULL };
...
vader_box_t vader_fn_lift_565(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(159u, __lambda_3716(env, a0, a1));
}
...
vader_box_t vader_fn_lift_1068(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(159u, __lambda_5217(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_1284(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(159u, __lambda_4139(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_2128(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(159u, __lambda_3325(env, ((size_t) a0.payload.i), ((size_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2451(void* env, vader_box_t a0) {
    return vader_box_bool(159u, __lambda_5796(env, ((uint32_t) a0.payload.i)));
}
...
void* vader_import_3(vader_string_t a0) { return (void*) vader_string_bytes_view(a0, 11u, 166u); }
...
vader_box_t vader_import_6(vader_string_t a0) { vader_box_t r = vader_read_file_bytes(a0, 11u, 166u, 395u); if (r.tag == 395u) { vader_struct_std_io_IOError_t* e = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t)); vader_obj_header_init(e, 395u); e->f_msg = r.payload.s; return vader_box_obj(395u, e); } return r; }
vader_box_t vader_import_7(vader_string_t a0, void* a1) { vader_box_t r = vader_write_file_bytes(a0, (vader_array_t*) a1, 395u); if (r.tag == 395u) { vader_struct_std_io_IOError_t* e = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t)); vader_obj_header_init(e, 395u); e->f_msg = r.payload.s; return vader_box_obj(395u, e); } return r; }
vader_box_t vader_import_8(vader_string_t a0) { vader_box_t r = vader_create_dir(a0, 395u); if (r.tag == 395u) { vader_struct_std_io_IOError_t* e = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t)); vader_obj_header_init(e, 395u); e->f_msg = r.payload.s; return vader_box_obj(395u, e); } return r; }
vader_box_t vader_import_9(vader_string_t a0) { vader_box_t r = vader_remove_file(a0, 395u); if (r.tag == 395u) { vader_struct_std_io_IOError_t* e = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t)); vader_obj_header_init(e, 395u); e->f_msg = r.payload.s; return vader_box_obj(395u, e); } return r; }
...
vader_box_t vader_import_12(vader_string_t a0) { vader_box_t r = vader_read_dir(a0, 8u, 161u, 395u); if (r.tag == 395u) { vader_struct_std_io_IOError_t* e = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t)); vader_obj_header_init(e, 395u); e->f_msg = r.payload.s; return vader_box_obj(395u, e); } return r; }
...
vader_box_t vader_import_29(vader_string_t a0) { return vader_get_env(a0, 161u); }
