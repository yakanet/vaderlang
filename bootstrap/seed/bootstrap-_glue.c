...
vader_box_t vader_fn_tramp_2418(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_types_mk_trait(a0.payload.obj, a1.payload.obj);
}
vader_fn_t vader_fn_static_2418 = { { 152u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_2418, NULL };
...
vader_box_t vader_fn_lift_288(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_1999(env, a0.payload.obj, a1.payload.obj));
}
vader_box_t vader_fn_lift_302(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_2970(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_455(void* env, vader_box_t a0, vader_box_t a1) {
    return __lambda_2049(env, a0.payload.obj, a1.payload.obj);
}
vader_box_t vader_fn_lift_568(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_3871(env, a0, a1));
}
vader_box_t vader_fn_lift_965(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_2250(env, a0.payload.obj, a1.payload.obj));
}
vader_box_t vader_fn_lift_1074(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_5381(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_1291(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_4352(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_1765(void* env) {
    return vader_ref_box(__lambda_1867(env));
}
vader_box_t vader_fn_lift_1768(void* env) {
    return vader_ref_box(__lambda_1885(env));
}
vader_box_t vader_fn_lift_1782(void* env, vader_box_t a0) {
    __lambda_2851(env, ((int32_t) a0.payload.i));
    return vader_box_null();
}
vader_box_t vader_fn_lift_1784(void* env, vader_box_t a0) {
    __lambda_2860(env, ((int32_t) a0.payload.i));
    return vader_box_null();
}
...
vader_box_t vader_fn_lift_1787(void* env, vader_box_t a0) {
    __lambda_2870(env, ((int32_t) a0.payload.i));
    return vader_box_null();
}
...
vader_box_t vader_fn_lift_1789(void* env) {
    return vader_ref_box(__lambda_2879(env));
}
vader_box_t vader_fn_lift_1791(void* env, vader_box_t a0) {
    __lambda_2900(env, ((int32_t) a0.payload.i));
    return vader_box_null();
}
...
vader_box_t vader_fn_lift_1793(void* env, vader_box_t a0) {
    __lambda_2911(env, ((int32_t) a0.payload.i));
    return vader_box_null();
}
vader_box_t vader_fn_lift_2005(void* env, vader_box_t a0, vader_box_t a1) {
...
vader_box_t vader_fn_lift_2160(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_2705(env, ((size_t) a0.payload.i), ((size_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2489(void* env, vader_box_t a0) {
    return vader_box_bool(161u, __lambda_5955(env, ((uint32_t) a0.payload.i)));
}
vader_box_t vader_fn_lift_2558(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_f64(160u, __lambda_3341(env, ((double) a0.payload.f), ((double) a1.payload.f)));
}
vader_box_t vader_fn_lift_2559(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3344(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2560(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3347(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2561(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3350(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2562(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3353(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2563(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3356(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2564(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3359(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2565(void* env, vader_box_t a0) {
    return vader_box_f64(160u, __lambda_3362(env, ((double) a0.payload.f)));
}
vader_box_t vader_fn_lift_2566(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_3370(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2567(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_3373(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2568(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_3376(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_2569(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(161u, __lambda_3379(env, a0.payload.s, a1.payload.s));
}
