...
vader_string_t vader_vt_Display__to_string(vader_box_t recv) {
    switch (recv.tag) {
        ...
        case 985u: return vader_vm_I32Val_Display_to_string(recv.payload.obj);
        case 978u: return vader_vm_F64Val_Display_to_string(recv.payload.obj);
        case 986u: return vader_vm_I64Val_Display_to_string(recv.payload.obj);
        case 996u: return vader_vm_StringVal_Display_to_string(recv.payload.obj);
        case 979u: return vader_vm_FnVal_Display_to_string(recv.payload.obj);
        case 989u: return vader_vm_NullVal_Display_to_string(recv.payload.obj);
        case 974u: return vader_vm_BoolVal_Display_to_string(recv.payload.obj);
        case 975u: return vader_vm_CharVal_Display_to_string(recv.payload.obj);
        case 977u: return vader_vm_ErrorVal_Display_to_string(recv.payload.obj);
        case 999u: return vader_vm_TypeVal_Display_to_string(recv.payload.obj);
        case 990u: return vader_vm_ObjVal_Display_to_string(recv.payload.obj);
        case 997u: return vader_vm_StructVal_Display_to_string(recv.payload.obj);
        case 973u: return vader_vm_ArrayVal_Display_to_string(recv.payload.obj);
