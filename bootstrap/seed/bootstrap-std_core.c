...
static void* std_core_BigInt_Div_div(void* l0, uint32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(13u, 0u, 3u, 179u);
    l2 = (void*) _a0_arr;
    ...
    l4 = (((int32_t) (size_t) t0) - INT32_C(1));
    {
        ...
        loop_11: {
            if ((l4 >= INT32_C(0))) {
                ...
                t2 = vader_box_i32(179u, ((int32_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l6]);
                ...
                if (VADER_LIKELY(_pc11_len < _pc11_cap)) {
                    ...
                    if (_pc11_hdr->buf->length < _pc11_len) { _pc11_hdr->buf->length = _pc11_len; }
    ...
    vader_array_t* _a2_arr = vader_array_new(13u, 0u, 3u, 179u);
    l12 = (void*) _a2_arr;
    ...
    l4 = (((int32_t) (size_t) t0) - INT32_C(1));
    {
        ...
        loop_68: {
            if ((l4 >= INT32_C(0))) {
                ...
                t2 = vader_box_i32(179u, ((int32_t*) _a3_slotarr->buf->slots)[_a3_slotarr->offset + (size_t) l6]);
                ...
                if (VADER_LIKELY(_pc68_len < _pc68_cap)) {
                    ...
                    if (_pc68_hdr->buf->length < _pc68_len) { _pc68_hdr->buf->length = _pc68_len; }
...
static void* std_core_BigInt_Mul_mul(void* l0, uint32_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_core_mul_add_small(l0, l1, (uint32_t) (int32_t) INT32_C(0));
...
static bool std_core_any_below(void* l0, int32_t l1) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_14: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_i32(179u, ((int32_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l5]);
    ...
    if (l6) {
        ...
        t1 = vader_box_i32(179u, ((int32_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l4]);
        t2 = ((uint32_t) t1.payload.i);
        if ((t2 & l7) != INT32_C(0)) {
            return true;
        }
...
static uint32_t std_core_b2u32(bool l0) {
    uint32_t l1;
    if (l0) {
        l1 = (uint32_t) (int32_t) INT32_C(1);
    } else {
        l1 = (uint32_t) (int32_t) INT32_C(0);
    }
    return l1;
}
    ...
    l1 = (((int32_t) (size_t) t0) - INT32_C(1));
    {
        loop_7: {
            if ((l1 >= INT32_C(0))) {
                ...
                t2 = vader_box_i32(179u, ((int32_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l2]);
                t3 = ((uint32_t) t2.payload.i);
                if (t3 != INT32_C(0)) {
                    l3 = (l1 * INT32_C(32));
                    t1 = ((int64_t) (int32_t) l1);
                    l4 = (size_t) (int64_t) t1;
                    if ((size_t) l4 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                    t2 = vader_box_i32(179u, ((int32_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l4]);
                    t3 = ((uint32_t) t2.payload.i);
...
static void* std_core_d2d(uint64_t l0, uint64_t l1) {
    ...
    l7 = std_core_b2u(l6);
    l8 = (uint64_t) (int64_t) INT64_C(0);
    l9 = (uint64_t) (int64_t) INT64_C(0);
    l10 = (uint64_t) (int64_t) INT64_C(0);
    l11 = INT32_C(0);
    l6 = false;
    l12 = false;
    if ((l2 >= INT32_C(0))) {
...
static uint64_t std_core_eisel_lemire(uint64_t l0, int32_t l1) {
    ...
    l3 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__0;
    l4 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__1;
...
static void* std_core_f2d(uint32_t l0, uint32_t l1) {
    ...
    l3 = (uint32_t) (int32_t) t0;
    l9 = (uint32_t) (int32_t) INT32_C(0);
    l10 = (uint32_t) (int32_t) INT32_C(0);
    l11 = (uint32_t) (int32_t) INT32_C(0);
    l12 = INT32_C(0);
    l7 = false;
    l13 = false;
    l14 = (uint32_t) (int32_t) INT32_C(0);
    if ((l2 >= INT32_C(0))) {
    ...
    if (l17) {
        ...
        if (l13) {
            l14 = (uint32_t) (int32_t) INT32_C(4);
        }
        if (l9 == l11) {
            if (!(l4)) {
                l13 = true;
...
static vader_string_t std_core_format_f32(float l0) {
    ...
    if (l1 == INT32_C(255)) {
        if (l3 != INT32_C(0)) {
            { vader_gc_top = gc_frame.prev; return 1919u; }
        }
        if (l2) {
            l4 = 418u;
        } else {
...
static vader_string_t std_core_format_signed(int64_t l0) {
    ...
    if (l1) {
        std_core_Buffer_ByteAccess_store_u8_vt(l5, (size_t) (int64_t) INT64_C(0), (uint8_t) (int32_t) INT32_C(45));
    }
...
static size_t std_core_insert_point(void* l0, size_t l1, int32_t l2, int32_t l3) {
    ...
    std_core_Buffer_ByteAccess_store_u8_vt(l0, l4, (uint8_t) (int32_t) INT32_C(46));
    t0 = ((int64_t) (int32_t) l2);
    l4 = (size_t) (int64_t) t0;
...
static bool std_core_is_zero(void* l0) {
    ...
    l2 = (size_t) (int64_t) INT64_C(0);
    {
        loop_6: {
            if ((l2 < l1)) {
                if ((size_t) l2 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
                t0 = vader_box_i32(179u, ((int32_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l2]);
...
static uint64_t std_core_limb(void* l0, size_t l1) {
    ...
    if ((l1 < l2)) {
        ...
        t0 = vader_box_i32(179u, ((int32_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l1]);
        t1 = ((uint32_t) t0.payload.i);
        t2 = ((int64_t) (uint32_t) t1);
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        ...
        loop_11: {
            if ((l6 < l5)) {
                ...
                if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
                if ((size_t) l6 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
                t1 = vader_box_i32(179u, ((int32_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l6]);
                t2 = ((uint32_t) t1.payload.i);
...
static void* std_core_mul_shift_all_64(uint64_t l0, uint64_t l1, uint64_t l2, int32_t l3, uint64_t l4) {
    ...
    l7 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__0;
    l8 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__1;
    l6 = std_core_umul128(l5, l2);
    l5 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__0;
    l9 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l6)->f__1;
    t0 = (l7 + l9);
    l9 = (uint64_t) (int64_t) t0;
    ...
    if ((t2 >= INT32_C(0))) {
        l7 = INT32_C(0);
        {
            loop_32: {
                ...
                if ((l7 < l8)) {
                    l4 = std_core_BigInt_Mul_mul(l4, (uint32_t) (int32_t) INT32_C(5));
                    l7 = (l7 + INT32_C(1));
                    goto loop_32;
                }
            }
...
static void* std_core_pf_product(int32_t l0, uint64_t l1) {
    ...
    l4 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l5)->f__0;
    l6 = ((vader_struct___Tuple_u64_u64_2959d966_t*) l5)->f__1;
    if ((l4 & INT64_C(511)) == INT64_C(511)) {
        ...
        l7 = ((vader_struct___Tuple_u64_u64_2959d966_t*) t1)->f__0;
        t0 = (l6 + l7);
    ...
    vader_struct___Tuple_u64_u64_2959d966_t* _a2_obj = (vader_struct___Tuple_u64_u64_2959d966_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_u64_u64_2959d966_t));
...
static vader_string_t std_core_render(uint64_t l0, int32_t l1, bool l2) {
    ...
    l5 = std_core_usize_BufferAlloc_new_buffer_vt((size_t) (int64_t) INT64_C(25));
    l6 = (size_t) (int64_t) INT64_C(0);
    if (l2) {
        std_core_Buffer_ByteAccess_store_u8_vt(l5, (size_t) (int64_t) INT64_C(0), (uint8_t) (int32_t) INT32_C(45));
...
static void* std_core_sd_scan(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(13u, 1u, 3u, 179u);
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        {
            ...
            loop_39: {
                if ((l4 < l3)) {
                    ...
                    if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
                    if ((size_t) l4 >= _a1_slotarr->length) { vader_trap("array index out of bounds"); }
                    t2 = vader_box_i32(179u, ((int32_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l4]);
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_71: {
            if ((l4 < l3)) {
                ...
                t2 = vader_box_i32(179u, ((int32_t*) _a2_slotarr->buf->slots)[_a2_slotarr->offset + (size_t) l4]);
                t3 = ((uint32_t) t2.payload.i);
                t1 = ((int64_t) (uint32_t) t3);
                l7 = (uint64_t) (int64_t) t1;
...
static void* std_core_umul128(uint64_t l0, uint64_t l1) {
    ...
    t0 = (l2 | l4);
    l2 = (uint64_t) (int64_t) t0;
    vader_struct___Tuple_u64_u64_2959d966_t* _a0_obj = (vader_struct___Tuple_u64_u64_2959d966_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_u64_u64_2959d966_t));
...
size_t std_core_write_bool(void* l0, size_t l1, bool l2) {
    ...
    vader_gc_top = &gc_frame;
    if (l2) {
        t0 = std_core_write_string_at(l0, l1, 2200u);
        { size_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = std_core_write_string_at(l0, l1, 1583u);
    { size_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static size_t std_core_write_decimal(void* l0, size_t l1, uint64_t l2, int32_t l3) {
    ...
    if (l6) {
        ...
        std_core_Buffer_ByteAccess_store_u8_vt(l0, l7, (uint8_t) (int32_t) INT32_C(46));
        t0 = (l1 + INT64_C(2));
        l7 = (size_t) (int64_t) t0;
        l8 = -(l5);
    ...
    if (l6) {
        ...
        std_core_Buffer_ByteAccess_store_u8_vt(l0, l9, (uint8_t) (int32_t) INT32_C(46));
        t0 = (l9 + INT64_C(1));
        l10 = (size_t) (int64_t) t0;
        std_core_Buffer_ByteAccess_store_u8_vt(l0, l10, (uint8_t) (int32_t) INT32_C(48));
    ...
    l4 = (l5 - INT32_C(1));
    std_core_Buffer_ByteAccess_store_u8_vt(l0, l9, (uint8_t) (int32_t) INT32_C(101));
    t0 = (l9 + INT64_C(1));
    l7 = (size_t) (int64_t) t0;
    if ((l4 < INT32_C(0))) {
        l11 = (uint8_t) (int32_t) INT32_C(45);
    } else {
        l11 = (uint8_t) (int32_t) INT32_C(43);
    }
    ...
    l3 = INT32_C(0);
    {
        loop_3: {
            if ((l3 < l2)) {
                ...
                t0 = (l1 + l4);
                l5 = (size_t) (int64_t) t0;
                std_core_Buffer_ByteAccess_store_u8_vt(l0, l5, (uint8_t) (int32_t) INT32_C(48));
                l3 = (l3 + INT32_C(1));
                goto loop_3;
            }
        }
