...
static void* std_core_digits_of(uint64_t l0) {
    ...
    if (l0 == INT64_C(0)) {
        ...
        vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 0u] = vader_box_string(163u, 467u);
        t0 = (void*) _a0_arr;
...
size_t std_core_write_bool(void* l0, size_t l1, bool l2) {
    ...
    vader_gc_top = &gc_frame;
    if (l2) {
        t0 = std_core_write_string_at(l0, l1, 2191u);
        { size_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = std_core_write_string_at(l0, l1, 1542u);
    { size_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
