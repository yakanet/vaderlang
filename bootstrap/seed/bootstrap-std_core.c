...
static void* std_core_BigInt_Div_div(void* l0, uint32_t l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 3u, 171u);
    l2 = (void*) _a0_arr;
    ...
    vader_array_t* _a2_arr = vader_array_new(12u, 0u, 3u, 171u);
    l12 = (void*) _a2_arr;
...
static void* std_core_digits_of(uint64_t l0) {
    ...
    if (l0 == INT64_C(0)) {
        ...
        vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 0u] = vader_box_string(163u, 451u);
        t0 = (void*) _a0_arr;
...
static void* std_core_sd_scan(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 3u, 171u);
