...
vader_box_t vader_c_emit_c_ast_array_declaration(vader_string_t l0, vader_string_t l1, void* l2) {
    ...
    t1 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(51u, 1u, 13u, 671u);
...
vader_box_t vader_c_emit_c_ast_declaration(vader_string_t l0, vader_string_t l1, vader_box_t l2) {
    ...
    _a0_obj->f_value = l2;
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(51u, 1u, 13u, 671u);
...
static vader_box_t vader_c_emit_c_ast_fused_copy(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    t1 = l1.payload.obj;
    if (!(((vader_struct_vader_c_emit_c_ast_CAssign_t*) t1)->f_target.tag == 686u)) {
        l3 = true;
    } else {
        l3 = !(l7.tag == 705u);
    }
...
bool vader_c_emit_c_ast_mentions_local(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 686u) {
        ...
        l2 = t1 == l1;
    } else if ((l0.tag == 685u || l0.tag == 705u || l0.tag == 708u)) {
        l2 = false;
    } else if (l0.tag == 664u) {
        t0 = l0.payload.obj;
    ...
    } else if ((l0.tag == 689u || l0.tag == 701u)) {
        l2 = false;
    } else if (l0.tag == 698u) {
        t0 = l0.payload.obj;
...
void vader_c_emit_c_ast_print_item(void* l0, vader_box_t l1) {
    ...
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(147u, 1u, 13u, 1208u);
...
static void vader_c_emit_c_ast_scan_expression(vader_box_t l0, void* l1) {
    ...
    } else if ((l0.tag == 685u || l0.tag == 686u || l0.tag == 708u)) {
    } else if (l0.tag == 664u) {
        t0 = l0.payload.obj;
...
static void vader_c_emit_c_ast_scan_statements(void* l0, void* l1) {
    ...
    void* l17;
    void* l20;
    size_t l3, l4, l8, l9, l12, l13, l18, l19;
    vader_box_t l5, l10, l14, l15, l16, l21;
    int32_t l6;
    int32_t t0;
    void* t1;
    int64_t t2;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 674u) {
                    ...
                    t1 = l5.payload.obj;
                    l17 = ((vader_struct_vader_c_emit_c_ast_CReturn_t*) t1)->f_stores;
                    ...
                    l19 = (size_t) 0;
                    {
                        loop_209: {
                            if ((l19 < l18)) {
                                ...
                                VADER_ARRAY_RESOLVE_BUF(_a3_slotarr)
                                VADER_ARRAY_CHECK_INDEX(_a3_slotarr, l19)
                                l20 = vader_array_ref_load_obj(_a3_slotarr->buf, _a3_slotarr->offset + (size_t) l19);
                                vader_c_emit_c_ast_scan_expression(((vader_struct_vader_c_emit_c_ast_CAssign_t*) l20)->f_target, l1);
                                vader_c_emit_c_ast_scan_expression(((vader_struct_vader_c_emit_c_ast_CAssign_t*) l20)->f_value, l1);
                                t2 = (l19 + INT64_C(1));
                    ...
                    t1 = l5.payload.obj;
                    l21 = ((vader_struct_vader_c_emit_c_ast_CReturn_t*) t1)->f_value;
                    if (!(l21.tag == 0u)) {
                        vader_c_emit_c_ast_scan_expression(l21, l1);
                    }
                } else {
                    return;
                }
...
static void vader_c_emit_c_ast_write_declarator(void* l0, void* l1, size_t l2, int32_t l3) {
    ...
    if (l4.tag == 193u) {
        ...
        l7 = (size_t) 0;
        l7 = std_core_write_string_at(l6, l7, 707u);
        t0 = ((int32_t) l4.payload.i);
        l8 = ((int64_t) (int32_t) t0);
        l7 = std_core_write_int(l6, l7, l8);
        l7 = std_core_write_string_at(l6, l7, 711u);
...
static void vader_c_emit_c_ast_write_else_chain(void* l0, void* l1, vader_string_t l2, int32_t l3) {
    ...
    if (l9) {
        ...
        vader_c_emit_c_ast_write_if_head(l0, 2379u, l10, l3);
        t0 = l4.payload.obj;
    ...
    vader_c_emit_c_ast_write_line(l0, 2380u, l3);
    l7 = ((vader_array_t*) l5)->length;
    l12 = (l3 + INT32_C(1));
...
static void vader_c_emit_c_ast_write_expression(void* l0, vader_box_t l1) {
    ...
    if (l1.tag == 705u) {
        ...
        std_string_builder_append(l0, 2052u);
        ...
        std_string_builder_append(l0, 1689u);
        l2 = std_core_new_byte_buffer((size_t) 20);
        l3 = (size_t) 0;
        t0 = l1.payload.obj;
        t1 = ((vader_struct_vader_c_emit_c_ast_CLocal_t*) t0)->f_slot;
        ...
        if (t3) {
            std_string_builder_append(l0, 2132u);
        }
    } else if (l1.tag == 664u) {
        t0 = l1.payload.obj;
        l5 = ((vader_struct_vader_c_emit_c_ast_CCall_t*) t0)->f_callee;
        ...
        vader_c_emit_c_ast_write_expression(l0, l6);
        std_string_builder_append(l0, 711u);
    } else if (l1.tag == 669u) {
        t0 = l1.payload.obj;
        ...
        if (t6 == INT64_C(0)) {
            std_string_builder_append(l0, 2370u);
        } else {
            std_string_builder_append(l0, 2369u);
            t0 = l1.payload.obj;
...
static void vader_c_emit_c_ast_write_function(void* l0, void* l1) {
    ...
    vader_c_emit_c_ast_write_line(l0, 2377u, INT32_C(0));
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_c_ast_write_goto(void* l0, void* l1) {
    ...
    if (!(l2.tag == 0u)) {
        std_string_builder_append(l0, 1585u);
        vader_c_emit_c_ast_write_expression(l0, l2);
        std_string_builder_append(l0, 207u);
    }
    std_string_builder_append(l0, 1523u);
...
static void vader_c_emit_c_ast_write_if(void* l0, void* l1, int32_t l2) {
    ...
    vader_c_emit_c_ast_write_if_head(l0, 1585u, l3, l2);
...
static void vader_c_emit_c_ast_write_laid_out(void* l0, vader_box_t l1, vader_string_t l2, size_t l3, int32_t l4) {
    ...
    std_string_builder_append(l0, 2368u);
    t0 = l1.payload.obj;
...
static void vader_c_emit_c_ast_write_parameters(void* l0, void* l1) {
    ...
    if (t0 == INT64_C(0)) {
        std_string_builder_append(l0, 2334u);
    }
    l2 = ((vader_array_t*) l1)->length;
    l3 = (size_t) 0;
    {
...
static void vader_c_emit_c_ast_write_return_text(void* l0, void* l1) {
    ...
    if (l8) {
        ...
        std_string_builder_append(l0, 328u);
    }
    t0 = ((vader_struct_vader_c_emit_c_ast_CReturn_t*) l1)->f_pops_frame;
    if (t0) {
        ...
        vader_obj_header_init(_a1_obj, 708u);
        _a1_obj->f_text = 2282u;
        l2 = (void*) _a1_obj;
        ...
        vader_obj_header_init(_a2_obj, 708u);
        _a2_obj->f_text = 1510u;
        l5 = (void*) _a2_obj;
    ...
    if (l7.tag == 0u) {
        std_string_builder_append(l0, 1901u);
    } else {
        std_string_builder_append(l0, 1895u);
        if (l6) {
            std_string_builder_append(l0, 751u);
        } else {
            vader_c_emit_c_ast_write_expression(l0, l7);
        }
        std_string_builder_append(l0, 326u);
...
static void vader_c_emit_c_ast_write_signature(void* l0, void* l1) {
    ...
    if (t0) {
        std_string_builder_append(l0, 1612u);
    }
...
static void vader_c_emit_c_ast_write_statements(void* l0, void* l1, size_t l2, size_t l3, int32_t l4) {
    ...
    vader_string_t t1 = 0;
    int64_t t2;
    vader_box_t* gc_roots[2] = { &l6, &l9 };
    void** gc_raw_roots[11] = { &l0, &l1, &l8, &l10, &l11, &l12, &l13, &l14, &l15, &l17, &t0 };
    vader_string_t* gc_atom_roots[4] = { &l7, &l16, &l19, &t1 };
    vader_gc_frame_t gc_frame = {
        vader_gc_top, 2u, 11u, gc_roots, gc_raw_roots, 0u, NULL, 4u, gc_atom_roots,
    };
    vader_gc_top = &gc_frame;
    l5 = l2;
    {
...
static void vader_c_emit_c_ast_write_switch(void* l0, void* l1, int32_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_c_emit_c_ast_indent(l0, l2);
    std_string_builder_append(l0, 2044u);
    ...
    if (!(l3.tag == 0u)) {
        l7 = (l2 + INT32_C(1));
        vader_c_emit_c_ast_indent(l0, l7);
        std_string_builder_append(l0, 1322u);
        l6 = l3.payload.obj;
        vader_c_emit_c_ast_write_case_body(l0, l6, true);
    }
    vader_c_emit_c_ast_write_line(l0, 2377u, l2);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_c_ast_write_top_level(void* l0, vader_box_t l1) {
    ...
    if (l1.tag == 682u) {
        ...
        std_string_builder_append(l0, 2381u);
    } else if (l1.tag == 679u) {
        t0 = l1.payload.obj;
        ...
        l2 = concat_5(2130u, l2, 21u, l4, 223u);
        std_string_builder_append(l0, l2);
        t0 = l1.payload.obj;
        ...
        std_string_builder_append(l0, 729u);
        t0 = l1.payload.obj;
