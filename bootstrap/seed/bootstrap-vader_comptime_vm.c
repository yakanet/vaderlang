...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 929u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 937u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_array_t* _a2_arr = vader_array_new(52u, 0u, 13u, 708u);
    l5 = (void*) _a2_arr;
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1441u, l5);
                        ...
                        if (l0.tag == 969u) {
                            ...
                            if (l0.tag == 962u) {
                                ...
                                if (l0.tag == 946u) {
                                    ...
                                    if (l0.tag == 970u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2184u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 952u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1677u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 972u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2260u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 950u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1546u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 963u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1702u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
