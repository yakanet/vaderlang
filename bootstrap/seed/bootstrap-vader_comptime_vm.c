...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1451u, l5);
                        ...
                        if (l0.tag == 968u) {
                            ...
                            if (l0.tag == 961u) {
                                ...
                                if (l0.tag == 945u) {
                                    ...
                                    if (l0.tag == 969u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2196u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 951u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1687u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 971u) {
                                                ...
                                                if (l0.tag == 949u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1556u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 962u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1712u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
