...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 928u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 936u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1449u, l5);
                        ...
                        if (l0.tag == 968u) {
                            ...
                            if (l0.tag == 961u) {
                                ...
                                if (l0.tag == 945u) {
                                    ...
                                    if (l0.tag == 969u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2194u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 951u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1685u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 971u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2270u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 949u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1554u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 962u) {
