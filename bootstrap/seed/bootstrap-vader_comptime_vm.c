...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1385u, l5);
                        ...
                        if (l0.tag == 958u) {
                            ...
                            if (l0.tag == 951u) {
                                ...
                                if (l0.tag == 935u) {
                                    ...
                                    if (l0.tag == 959u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2116u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 941u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1618u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 961u) {
                                                ...
                                                if (l0.tag == 939u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1489u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 952u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1643u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
