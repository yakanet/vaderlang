...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 894u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 902u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(177u, l10));
                }
                t1 = (l7 + INT64_C(1));
    ...
    vader_array_t* _a2_arr = vader_array_new(52u, 0u, 13u, 670u);
    l5 = (void*) _a2_arr;
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1468u, l5);
                        ...
                        if (l0.tag == 934u) {
                            ...
                            if (l0.tag == 927u) {
                                ...
                                if (l0.tag == 911u) {
                                    ...
                                    if (l0.tag == 935u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2219u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 917u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1708u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 937u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2298u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 915u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1576u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 928u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1733u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
