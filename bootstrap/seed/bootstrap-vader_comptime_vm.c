...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 917u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 925u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1407u, l5);
                        ...
                        if (l0.tag == 957u) {
                            ...
                            if (l0.tag == 950u) {
                                ...
                                if (l0.tag == 934u) {
                                    ...
                                    if (l0.tag == 958u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2140u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 940u) {
                                            ...
                                            if (l0.tag == 960u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2212u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 938u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1510u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 951u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1664u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
