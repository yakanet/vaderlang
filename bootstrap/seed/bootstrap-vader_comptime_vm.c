...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1348u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 925u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1606u);
    ...
    if (l0.tag == 926u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1628u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 921u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1508u);
    ...
    if (l0.tag == 922u) {
        t0 = vader_comptime_vm_unsupported(l2, 1575u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 937u) {
    ...
    if (l0.tag == 920u) {
        t0 = vader_comptime_vm_unsupported(l2, 1452u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 929u) {
        t0 = vader_comptime_vm_unsupported(l2, 1601u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
