...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 913u) {
        l2 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) l2)->f_backing.tag == 921u) {
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1370u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 939u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1632u);
    ...
    if (l0.tag == 940u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1654u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 935u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1531u);
    ...
    if (l0.tag == 950u) {
        t0 = vader_comptime_vm_unsupported(l2, 2101u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 936u) {
        t0 = vader_comptime_vm_unsupported(l2, 1602u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 952u) {
        t0 = vader_comptime_vm_unsupported(l2, 2169u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 934u) {
        t0 = vader_comptime_vm_unsupported(l2, 1473u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 944u) {
        t0 = vader_comptime_vm_unsupported(l2, 1627u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
