...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 940u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1649u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 935u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1526u);
    ...
    if (l0.tag == 950u) {
        t0 = vader_comptime_vm_unsupported(l2, 2085u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 936u) {
    ...
    if (l0.tag == 952u) {
        t0 = vader_comptime_vm_unsupported(l2, 2153u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 934u) {
        t0 = vader_comptime_vm_unsupported(l2, 1468u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 944u) {
        t0 = vader_comptime_vm_unsupported(l2, 1622u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
