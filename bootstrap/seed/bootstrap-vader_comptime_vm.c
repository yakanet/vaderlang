...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(164u, l10));
                } else {
                }
                t1 = (l7 + INT64_C(1));
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1360u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 935u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1618u);
    ...
    if (l0.tag == 936u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1640u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 931u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1518u);
    ...
    if (l0.tag == 946u) {
        t0 = vader_comptime_vm_unsupported(l2, 2099u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 932u) {
    ...
    if (l0.tag == 948u) {
        t0 = vader_comptime_vm_unsupported(l2, 2167u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 930u) {
        t0 = vader_comptime_vm_unsupported(l2, 1463u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 940u) {
