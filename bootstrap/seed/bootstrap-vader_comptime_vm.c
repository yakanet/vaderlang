...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1446u, l5);
                            ...
                            if (l0.tag == 960u) {
                                ...
                                if (l0.tag == 944u) {
                                    ...
                                    if (l0.tag == 968u) {
                                        ...
                                        if (l0.tag == 950u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1682u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 970u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2267u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 948u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1551u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 961u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1707u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
