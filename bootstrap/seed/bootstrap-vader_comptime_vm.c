...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1358u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 934u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1617u);
    ...
    if (l0.tag == 935u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1639u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 930u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1517u);
    ...
    if (l0.tag == 945u) {
        t0 = vader_comptime_vm_unsupported(l2, 2098u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 931u) {
        t0 = vader_comptime_vm_unsupported(l2, 1587u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 947u) {
        t0 = vader_comptime_vm_unsupported(l2, 2166u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 929u) {
        t0 = vader_comptime_vm_unsupported(l2, 1462u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 939u) {
        t0 = vader_comptime_vm_unsupported(l2, 1612u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
