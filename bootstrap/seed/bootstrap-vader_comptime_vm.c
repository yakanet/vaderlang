...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 931u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 939u) {
            t0 = l0.payload.obj;
...
void vader_comptime_vm_resolve_vm_required_decls(void* l0, void* l1, void* l2, void* l3) {
    ...
    void** gc_raw_roots[15] = { &l0, &l1, &l2, &l3, &l4, &l5, &l6, &l9, &l13, &l15, &l16, &l18, &l21, &l23, &t2 };
    vader_string_t* gc_atom_roots[5] = { &l10, &l11, &l14, &l17, &t3 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 5u, 15u, gc_roots, gc_raw_roots, 0u, NULL, 5u, gc_atom_roots };
    vader_gc_top = &gc_frame;
            ...
            if ((l8 < l7)) {
                ...
                if (l12.tag == 973u) {
                    ...
                    if (t4) {
                        ...
                        l15 = vader_diagnostics_comptime_error((uint8_t) (int32_t) INT32_C(15), l13, l14);
                        ...
                        l18 = vader_diagnostics_comptime_error((uint8_t) (int32_t) INT32_C(1), l16, l17);
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(176u, l10));
                }
                t1 = (l7 + INT64_C(1));
    ...
    vader_array_t* _a2_arr = vader_array_new(52u, 0u, 13u, 710u);
    l5 = (void*) _a2_arr;
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1445u, l5);
                        ...
                        if (l0.tag == 971u) {
                            ...
                            if (l0.tag == 964u) {
                                ...
                                if (l0.tag == 948u) {
                                    ...
                                    if (l0.tag == 972u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2190u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 954u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1681u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 974u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2266u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 952u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1550u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 965u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1706u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
