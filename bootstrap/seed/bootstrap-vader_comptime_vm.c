...
vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 920u) {
        l2 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) l2)->f_backing.tag == 928u) {
...
void vader_comptime_vm_resolve_vm_required_decls(void* l0, void* l1, void* l2, void* l3) {
    ...
    void* l24 = NULL;
    size_t l7, l8, l26;
    vader_string_t l10, l11, l15, l18;
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 5u, 16u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
...
void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(161u, l10));
                } else {
                }
                t1 = (l7 + INT64_C(1));
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1285u, l5);
...
vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 946u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1528u);
    ...
    if (l0.tag == 947u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1550u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 942u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1439u);
    ...
    if (l0.tag == 955u) {
        t0 = vader_comptime_vm_unsupported(l2, 2025u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 943u) {
        t0 = vader_comptime_vm_unsupported(l2, 1498u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 957u) {
        t0 = vader_comptime_vm_unsupported(l2, 2087u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 941u) {
        t0 = vader_comptime_vm_unsupported(l2, 1387u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 949u) {
        t0 = vader_comptime_vm_unsupported(l2, 1523u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
