...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1418u, l5);
                        ...
                        if (l0.tag == 956u) {
                            ...
                            if (l0.tag == 949u) {
                                ...
                                if (l0.tag == 933u) {
                                    ...
                                    if (l0.tag == 957u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2151u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 939u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1650u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 959u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2223u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 937u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1521u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 950u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1675u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
