...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(178u, l10));
                }
                t1 = (l7 + INT64_C(1));
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1470u, l5);
                        ...
                        if (l0.tag == 934u) {
                            ...
                            if (l0.tag == 927u) {
                                ...
                                if (l0.tag == 911u) {
                                    ...
                                    if (l0.tag == 935u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2222u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 917u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1710u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 937u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2301u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 915u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1578u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 928u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1735u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
