...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1421u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 955u) {
        ...
        l5 = vader_comptime_vm_prim_name(l1, 1685u);
        ...
        if (l0.tag == 956u) {
            ...
            if (l0.tag == 948u) {
                ...
                l5 = vader_comptime_vm_prim_name(l1, 1583u);
                        ...
                        if (l0.tag == 966u) {
                            ...
                            if (l0.tag == 959u) {
                                ...
                                if (l0.tag == 943u) {
                                    ...
                                    if (l0.tag == 967u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2161u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 949u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1655u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 969u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2237u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 947u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1524u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 960u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1680u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
