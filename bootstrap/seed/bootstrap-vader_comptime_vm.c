...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 911u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 919u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1388u, l5);
                        ...
                        if (l0.tag == 951u) {
                            ...
                            if (l0.tag == 944u) {
                                ...
                                if (l0.tag == 928u) {
                                    ...
                                    if (l0.tag == 952u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2119u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 934u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1621u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 954u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2191u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 932u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1492u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 945u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1646u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
