...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 919u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 927u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(172u, l10));
                }
                t1 = (l7 + INT64_C(1));
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1412u, l5);
                        ...
                        if (l0.tag == 959u) {
                            ...
                            if (l0.tag == 952u) {
                                ...
                                if (l0.tag == 936u) {
                                    ...
                                    if (l0.tag == 960u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2148u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 942u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1645u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 962u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2220u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 940u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1515u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 953u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1670u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
