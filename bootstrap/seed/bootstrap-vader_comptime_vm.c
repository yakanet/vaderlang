...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 911u) {
        l2 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) l2)->f_backing.tag == 919u) {
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
        ...
        loop_9: {
            if ((l7 < l6)) {
                ...
                if (!(t0)) {
                    ...
                    vader_array_push((vader_array_t*) l4, vader_box_string(165u, l10));
                } else {
                }
                t1 = (l7 + INT64_C(1));
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1365u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 937u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1625u);
    ...
    if (l0.tag == 938u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1647u);
        t2 = vader_comptime_vm_int_scalar(l3, l4);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 933u) {
        ...
        l4 = vader_comptime_vm_prim_name(l1, 1524u);
    ...
    if (l0.tag == 934u) {
        t0 = vader_comptime_vm_unsupported(l2, 1595u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 950u) {
    ...
    if (l0.tag == 932u) {
        t0 = vader_comptime_vm_unsupported(l2, 1469u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 942u) {
        t0 = vader_comptime_vm_unsupported(l2, 1620u);
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
