...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 927u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 935u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1448u, l5);
                        ...
                        if (l0.tag == 967u) {
                            ...
                            if (l0.tag == 960u) {
                                ...
                                if (l0.tag == 944u) {
                                    ...
                                    if (l0.tag == 968u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2193u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 950u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1684u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 970u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2269u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 948u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1553u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 961u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1709u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
