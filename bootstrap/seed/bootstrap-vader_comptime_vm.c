...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 891u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 899u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1452u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 920u) {
        ...
        l5 = vader_comptime_vm_prim_name(l1, 1718u);
        ...
        if (l0.tag == 921u) {
            ...
            if (l0.tag == 913u) {
                ...
                l5 = vader_comptime_vm_prim_name(l1, 1616u);
                        ...
                        if (l0.tag == 931u) {
                            ...
                            if (l0.tag == 924u) {
                                ...
                                if (l0.tag == 908u) {
                                    ...
                                    if (l0.tag == 932u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2198u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 914u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1688u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 934u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2276u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 912u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1557u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 925u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1713u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
