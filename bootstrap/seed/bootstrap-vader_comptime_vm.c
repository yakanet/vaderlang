...
static vader_string_t vader_comptime_vm_prim_name(vader_box_t l0, vader_string_t l1) {
    ...
    if (l0.tag == 912u) {
        t0 = l0.payload.obj;
        if (((vader_struct_vader_types_DistinctType_t*) t0)->f_backing.tag == 920u) {
            t0 = l0.payload.obj;
...
static void* vader_comptime_vm_stage_to_bytecode(void* l0, void* l1, void* l2, void* l3) {
    ...
    t2 = vader_midir_emit_bytecode_from_cfg(l4, 1390u, l5);
...
static vader_box_t vader_comptime_vm_value_to_comptime(vader_box_t l0, vader_box_t l1, void* l2) {
    ...
    if (l0.tag == 941u) {
        ...
        l5 = vader_comptime_vm_prim_name(l1, 1653u);
        ...
        if (l0.tag == 942u) {
            ...
            if (l0.tag == 934u) {
                ...
                l5 = vader_comptime_vm_prim_name(l1, 1552u);
                        ...
                        if (l0.tag == 952u) {
                            ...
                            if (l0.tag == 945u) {
                                ...
                                if (l0.tag == 929u) {
                                    ...
                                    if (l0.tag == 953u) {
                                        t0 = vader_comptime_vm_unsupported(l2, 2120u);
                                        l3 = vader_ref_box(t0);
                                    } else {
                                        if (l0.tag == 935u) {
                                            t0 = vader_comptime_vm_unsupported(l2, 1623u);
                                            l3 = vader_ref_box(t0);
                                        } else {
                                            if (l0.tag == 955u) {
                                                t0 = vader_comptime_vm_unsupported(l2, 2192u);
                                                l3 = vader_ref_box(t0);
                                            } else {
                                                if (l0.tag == 933u) {
                                                    t0 = vader_comptime_vm_unsupported(l2, 1494u);
                                                    l3 = vader_ref_box(t0);
                                                } else {
                                                    if (l0.tag == 946u) {
                                                        t0 = vader_comptime_vm_unsupported(l2, 1648u);
                                                        l3 = vader_ref_box(t0);
                                                    } else {
