...
void* vader_comptime_arg_count_error(void* l0, vader_string_t l1, size_t l2) {
    ...
    l5 = std_core_write_string_at(l6, l5, 101u);
...
void* vader_comptime_arithmetic(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 405u) {
        ...
        if (l2.tag == 405u) {
            ...
            t0 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i64(22u, l6), vader_box_i64(22u, l7));
...
void* vader_comptime_arithmetic_or_concat(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 407u) {
        ...
        t2 = vader_comptime_type_mismatch(l0, 2009u);
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l8 = l1;
...
void vader_comptime_bake_file_exprs(void* l0, void* l1, void* l2, void* l3, void* l4) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(399u, 0u, 13u, 247u);
    l5 = (void*) _a0_arr;
    l6 = l0;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_70: {
            if ((l8 < l7)) {
                ...
                if (l9.tag == 213u) {
                    l6 = l9.payload.obj;
                    if (((vader_struct_toolchain_ast_ConstDecl_t*) l6)->f_value.tag == 247u) {
...
void* vader_comptime_bool_op(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 402u) {
        ...
        if (l2.tag == 402u) {
            ...
            vader_fn_t* _a0_fnobj = (vader_fn_t*) l3;
            t0 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_bool(7u, l6), vader_box_bool(7u, l7));
            t1 = t0.payload.b;
            if (t1) {
...
vader_string_t vader_comptime_build_display_key(void* l0, void* l1) {
    ...
    l3 = std_core_write_string_at(l4, l3, 284u);
    l3 = std_core_write_string_at(l4, l3, l2);
    l3 = std_core_write_string_at(l4, l3, 320u);
...
vader_box_t vader_comptime_build_vm_required(void* l0, void* l1, void* l2, vader_string_t l3) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.tag == 235u) {
        l4 = ((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.payload.obj;
        if (((vader_struct_toolchain_ast_CallExpr_t*) l4)->f_callee.tag == 243u) {
...
int64_t vader_comptime_byte_align(vader_box_t l0) {
    ...
    if (l0.tag == 311u) {
        ...
        if (l0.tag == 304u) {
            ...
            if ((l0.tag == 302u || l0.tag == 303u || l0.tag == 305u || l0.tag == 306u || l0.tag == 313u || l0.tag == 314u || l0.tag == 315u || l0.tag == 318u)) {
                l1 = INT64_C(8);
            } else {
                l1 = INT64_C(0);
            }
...
vader_string_t vader_comptime_canonical_type_key(vader_box_t l0) {
    ...
    if (l0.tag == 313u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 693u);
    ...
    if (l0.tag == 305u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 549u);
    ...
    if (l0.tag == 314u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(24) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 770u);
    ...
    if (l0.tag == 317u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(22));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 797u);
    ...
    if (l0.tag == 312u) {
        { vader_gc_top = gc_frame.prev; return 696u; }
    }
    if (l0.tag == 319u) {
        { vader_gc_top = gc_frame.prev; return 779u; }
    }
    if (l0.tag == 309u) {
        { vader_gc_top = gc_frame.prev; return 561u; }
    }
    if (l0.tag == 307u) {
        { vader_gc_top = gc_frame.prev; return 559u; }
    }
    if (l0.tag == 308u) {
        { vader_gc_top = gc_frame.prev; return 560u; }
    }
    if (l0.tag == 310u) {
        { vader_gc_top = gc_frame.prev; return 617u; }
    }
    if (l0.tag == 302u) {
        { vader_gc_top = gc_frame.prev; return 798u; }
    }
...
void* vader_comptime_collect_nodes(void* l0) {
    ...
    vader_obj_header_init(_a3_obj, 81u);
    _a3_obj->f_ekeys = l1;
    _a3_obj->f_evals = l2;
    _a3_obj->f_index = l3;
    ...
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(102u, 0u, 4u, 20u);
    l2 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(38u, 0u, 7u, 3u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(102u, 0u, 4u, 20u);
    l4 = (void*) _a6_arr;
    ...
    vader_obj_header_init(_a8_obj, 60u);
    _a8_obj->f_ekeys = l3;
    _a8_obj->f_evals = l4;
    _a8_obj->f_index = l5;
    ...
    vader_obj_header_init(_a9_obj, 413u);
    _a9_obj->f_by_id = l1;
    _a9_obj->f_order = l2;
        ...
        loop_42: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 213u) {
                    ...
                    vader_array_t* _a11_arr = vader_array_new(102u, 0u, 4u, 20u);
                    l4 = (void*) _a11_arr;
                    ...
                    vader_obj_header_init(_a12_obj, 415u);
                    _a12_obj->f_decl = l3;
...
void* vader_comptime_combine_binary(void* l0, vader_box_t l1, vader_box_t l2) {
    ...
    if (l3 == INT32_C(0)) {
        l4 = (void*) &vader_fn_static_1048;
        t0 = vader_comptime_arithmetic_or_concat(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(1)) {
        l4 = (void*) &vader_fn_static_1046;
    ...
    if (l3 == INT32_C(7)) {
        l4 = (void*) &vader_fn_static_1037;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(8)) {
        l4 = (void*) &vader_fn_static_1036;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(9)) {
        l4 = (void*) &vader_fn_static_1035;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(10)) {
        l4 = (void*) &vader_fn_static_1033;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(11)) {
        l4 = (void*) &vader_fn_static_1032;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(12)) {
    ...
    if (l3 == INT32_C(18)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_BinaryExpr_t*) l0)->f_span, 511u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(19)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_BinaryExpr_t*) l0)->f_span, 510u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(20)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_BinaryExpr_t*) l0)->f_span, 512u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_comptime_compare(void* l0, vader_box_t l1, vader_box_t l2, uint8_t l3) {
    ...
    if (l1.tag == 402u) {
        ...
        if (l2.tag == 402u) {
            ...
            l10 = l10 == l11;
            t2 = vader_comptime_equality_only(l0, l10, l3, 1178u);
            { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l14 = 1282u;
        t2 = vader_comptime_type_mismatch(l0, l14);
    ...
    if (l1.tag == 407u) {
        ...
        if (l2.tag == 407u) {
            ...
            l10 = l12 == l13;
            t2 = vader_comptime_equality_only(l0, l10, l3, 2008u);
            { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l14 = 1282u;
        t2 = vader_comptime_type_mismatch(l0, l14);
...
vader_string_t vader_comptime_display_value(vader_box_t l0) {
    ...
    if (l0.tag == 403u) {
        ...
        t0 = concat_3(283u, l2, 268u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 407u) {
        l1 = l0.payload.obj;
        l2 = ((vader_struct_vader_comptime_StringValue_t*) l1)->f_value;
        t0 = concat_3(235u, l2, 235u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 406u) {
        { vader_gc_top = gc_frame.prev; return 1787u; }
    }
    if (l0.tag == 410u) {
        { vader_gc_top = gc_frame.prev; return 2292u; }
    }
    if (l0.tag == 401u) {
        t3 = l0.payload.obj;
        ...
        loop_12: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 212u) {
                    ...
                    if (l11.tag == 0u) {
                        if (((vader_struct_vader_comptime_EvalResult_t*) l10)->f_value.tag == 402u) {
...
void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (!(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee.tag == 243u)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_span, 539u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = ((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee;
    l2 = t1.payload.obj;
    if (((vader_obj_header_t*) l2)->type_index == 243u) {
        l3 = l2;
        ...
        if (l4) {
            ...
            vader_array_t* _a2_arr = vader_array_new(38u, 0u, 7u, 3u);
            l19 = (void*) _a2_arr;
            vader_array_t* _a3_arr = vader_array_new(94u, 0u, 0u, 48u);
            l20 = (void*) _a3_arr;
            ...
            vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a5_obj = (vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
            vader_obj_header_init(_a5_obj, 168u);
            _a5_obj->f_ekeys = l19;
            _a5_obj->f_evals = l20;
            _a5_obj->f_index = l21;
            _a5_obj->f_mask = l22;
            ...
            l30 = (size_t) (int64_t) INT64_C(0);
            {
                loop_159: {
                    if ((l30 >= l29)) {
                        ...
                        _a8_obj->f__1 = l32;
                        l33 = (void*) _a8_obj;
                        l34 = ((vader_struct___Tuple_1239_t*) l33)->f__0;
                        l35 = ((vader_struct___Tuple_1239_t*) l33)->f__1;
        ...
        l24 = (size_t) (int64_t) INT64_C(0);
        vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a15_obj = (vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
        vader_obj_header_init(_a15_obj, 168u);
        ...
        l30 = (size_t) (int64_t) INT64_C(0);
        {
            loop_389: {
                if ((l30 >= l29)) {
                    ...
                    vader_struct___Tuple_1239_t* _a18_obj = (vader_struct___Tuple_1239_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1239_t));
                    vader_obj_header_init(_a18_obj, 1138u);
                    _a18_obj->f__0 = l31;
                    _a18_obj->f__1 = l32;
                    l33 = (void*) _a18_obj;
                    l34 = ((vader_struct___Tuple_1239_t*) l33)->f__0;
        ...
        vader_obj_header_init(_a21_obj, 395u);
    ...
    l19 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(94u, 0u, 0u, 48u);
    l20 = (void*) _a23_arr;
    ...
    l23 = (size_t) (int64_t) INT64_C(0);
    l24 = (size_t) (int64_t) INT64_C(0);
    vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a25_obj = (vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
    vader_obj_header_init(_a25_obj, 168u);
    ...
    l30 = (size_t) (int64_t) INT64_C(0);
    {
        loop_619: {
            if ((l30 >= l29)) {
                ...
                vader_struct___Tuple_1239_t* _a28_obj = (vader_struct___Tuple_1239_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1239_t));
                vader_obj_header_init(_a28_obj, 1138u);
                _a28_obj->f__0 = l31;
                _a28_obj->f__1 = l32;
                l33 = (void*) _a28_obj;
                l34 = ((vader_struct___Tuple_1239_t*) l33)->f__0;
    ...
    vader_obj_header_init(_a31_obj, 395u);
...
void* vader_comptime_evaluate_expr(vader_box_t l0, void* l1) {
    ...
    if ((t0 >= INT64_C(2000))) {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        l4 = std_core_write_string_at(l3, l4, 1070u);
        l4 = std_core_write_int(l3, l4, INT64_C(2000));
        l4 = std_core_write_string_at(l3, l4, 127u);
...
void* vader_comptime_evaluate_fn_body(void* l0, void* l1, void* l2) {
    ...
    if (((vader_struct_toolchain_ast_FnDecl_t*) l0)->f_body.tag == 0u) {
        t0 = vader_comptime_vm_required(l2, 536u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (!(((vader_struct_toolchain_ast_BlockExpr_t*) l3)->f_trailing.tag == 0u)) {
        ...
        t0 = vader_comptime_vm_required(l2, 534u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t2 = ((vader_array_t*) ((vader_struct_toolchain_ast_BlockExpr_t*) l3)->f_stmts)->length;
    if (t2 == INT64_C(1)) {
...
void* vader_comptime_evaluate_ident(void* l0, void* l1) {
    ...
    if (l4.tag == 0u) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_IdentExpr_t*) l0)->f_span, 575u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_184: {
            if ((l9 < l8)) {
                ...
                if (l12.tag == 213u) {
                    ...
                    l11 = l14.payload.obj;
                    if (((vader_obj_header_t*) l11)->type_index == 91u) {
                        l13 = l11;
...
void* vader_comptime_evaluate_seq_lit(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(421u, 0u, 13u, 400u);
    l3 = (void*) _a0_arr;
    ...
    if (l8.tag == 315u) {
        vader_array_t* _a3_arr = vader_array_new(1u, 0u, 0u, 2u);
        l4 = (void*) _a3_arr;
        vader_array_t* _a4_arr = vader_array_new(94u, 0u, 0u, 48u);
        l7 = (void*) _a4_arr;
        vader_array_t* _a5_arr = vader_array_new(38u, 0u, 7u, 3u);
        l9 = (void*) _a5_arr;
        vader_struct_std_collections_MutableMap__string__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a6_obj = (vader_struct_std_collections_MutableMap__string__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__string__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_73: {
                if ((l6 < l5)) {
                    ...
                    l10 = std_core_write_string_at(l7, l10, 818u);
...
void* vader_comptime_harvest_instances(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(392u, 0u, 13u, 393u);
    l2 = (void*) _a4_arr;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_32: {
            if ((l6 >= l5)) {
                ...
                vader_struct___Tuple_1170_t* _a8_obj = (vader_struct___Tuple_1170_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1170_t));
                vader_obj_header_init(_a8_obj, 1069u);
                _a8_obj->f__0 = l7;
                _a8_obj->f__1 = l2;
                t1 = (void*) _a8_obj;
                l8 = ((vader_struct___Tuple_1170_t*) t1)->f__1;
                t2 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t2;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_68: {
                        if ((l13 >= l12)) {
                            ...
                            vader_struct___Tuple_1171_t* _a11_obj = (vader_struct___Tuple_1171_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1171_t));
                            vader_obj_header_init(_a11_obj, 1070u);
                            _a11_obj->f__0 = l14;
                            _a11_obj->f__1 = l15;
                            t1 = (void*) _a11_obj;
                            l16 = ((vader_struct___Tuple_1171_t*) t1)->f__1;
                            t2 = (l13 + INT64_C(1));
                ...
                l21 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_110: {
                        if ((l21 >= l20)) {
                            ...
                            vader_struct___Tuple_1234_t* _a14_obj = (vader_struct___Tuple_1234_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1234_t));
                            vader_obj_header_init(_a14_obj, 1133u);
                            _a14_obj->f__0 = l22;
                            _a14_obj->f__1 = l23;
                            t1 = (void*) _a14_obj;
                            l24 = ((vader_struct___Tuple_1234_t*) t1)->f__1;
                            t2 = (l21 + INT64_C(1));
                ...
                l29 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_152: {
                        if ((l29 >= l28)) {
                            ...
                            vader_struct___Tuple_1235_t* _a17_obj = (vader_struct___Tuple_1235_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1235_t));
                            vader_obj_header_init(_a17_obj, 1134u);
                            _a17_obj->f__0 = l30;
                            _a17_obj->f__1 = l31;
                            t1 = (void*) _a17_obj;
                            l32 = ((vader_struct___Tuple_1235_t*) t1)->f__1;
                            t2 = (l29 + INT64_C(1));
                ...
                l37 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_194: {
                        if ((l37 >= l36)) {
                            ...
                            vader_struct___Tuple_1235_t* _a20_obj = (vader_struct___Tuple_1235_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1235_t));
                            vader_obj_header_init(_a20_obj, 1134u);
                            _a20_obj->f__0 = l38;
                            _a20_obj->f__1 = l39;
                            t1 = (void*) _a20_obj;
                            l40 = ((vader_struct___Tuple_1235_t*) t1)->f__1;
                            t2 = (l37 + INT64_C(1));
                ...
                l45 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l45 >= l44)) {
                            ...
                            vader_struct___Tuple_1235_t* _a23_obj = (vader_struct___Tuple_1235_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1235_t));
                            vader_obj_header_init(_a23_obj, 1134u);
                            _a23_obj->f__0 = l46;
                            _a23_obj->f__1 = l47;
                            t1 = (void*) _a23_obj;
                            l48 = ((vader_struct___Tuple_1235_t*) t1)->f__1;
                            t2 = (l45 + INT64_C(1));
                ...
                l53 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_278: {
                        if ((l53 >= l52)) {
                            ...
                            vader_struct___Tuple_1237_t* _a26_obj = (vader_struct___Tuple_1237_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1237_t));
                            vader_obj_header_init(_a26_obj, 1136u);
                            _a26_obj->f__0 = l54;
                            _a26_obj->f__1 = l55;
                            t1 = (void*) _a26_obj;
                            l56 = ((vader_struct___Tuple_1237_t*) t1)->f__1;
                            t2 = (l53 + INT64_C(1));
                ...
                l62 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_323: {
                        if ((l62 >= l61)) {
                            ...
                            vader_struct___Tuple_1235_t* _a29_obj = (vader_struct___Tuple_1235_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1235_t));
                            vader_obj_header_init(_a29_obj, 1134u);
                            _a29_obj->f__0 = l63;
                            _a29_obj->f__1 = l64;
                            t1 = (void*) _a29_obj;
                            l65 = ((vader_struct___Tuple_1235_t*) t1)->f__1;
                            t2 = (l62 + INT64_C(1));
...
void* vader_comptime_int_div_check(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l2.tag == 405u) {
        ...
        if (t1 == INT64_C(0)) {
            t0 = vader_comptime_division_by_zero(l0, 411u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
...
void* vader_comptime_int_mod_check(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l2.tag == 405u) {
        ...
        t1 = ((vader_struct_vader_comptime_IntValue_t*) t0)->f_value;
        if (t1 == INT64_C(0)) {
            t0 = vader_comptime_division_by_zero(l0, 262u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
...
void* vader_comptime_intrinsic_align_of(void* l0, void* l1) {
    ...
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1087u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1088u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t3 = vader_comptime_byte_align(l2);
    t2 = vader_comptime_int_val_typed(t3, 2202u);
...
void* vader_comptime_intrinsic_field_count(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1465u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1466u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_comptime_intrinsic_field_index(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(2)) {
        t1 = vader_comptime_arg_count_error(l0, 1467u, (size_t) (int64_t) INT64_C(2));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1470u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l3.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1469u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l2.tag == 313u) {
        l4 = l2.payload.obj;
        ...
        if (l7.tag == 217u) {
            ...
            l9 = (size_t) (int64_t) INT64_C(0);
            {
                loop_64: {
                    if ((l9 < l8)) {
                        ...
                        l11 = l3.payload.s;
                        if (l10 == l11) {
                            t2 = vader_comptime_int_val_typed(((int64_t) (size_t) l9), 2202u);
                            t1 = vader_comptime_ok(t2);
                            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
                        }
                        t3 = (l9 + INT64_C(1));
            ...
            l11 = l3.payload.s;
            l10 = concat_5(1468u, l10, 897u, l11, 872u);
            t1 = vader_comptime_arg_error(l0, l10);
            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t1 = l2.payload.obj;
        l10 = vader_types_display_type(vader_ref_box(t1));
        l10 = concat_3(1471u, l10, 938u);
        t1 = vader_comptime_arg_error(l0, l10);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l10 = vader_types_display_type(l2);
    l10 = concat_3(1468u, l10, 919u);
    t1 = vader_comptime_arg_error(l0, l10);
    { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_comptime_intrinsic_size_of(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1884u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1886u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_comptime_intrinsic_type_kind(void* l0, void* l1) {
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2101u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_comptime_intrinsic_type_name(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2102u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2103u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
bool vader_comptime_is_concrete_enough(vader_box_t l0) {
    if ((l0.tag == 307u || l0.tag == 308u || l0.tag == 309u || l0.tag == 312u || l0.tag == 319u)) {
        return false;
    }
    return true;
}
...
void* vader_comptime_new_evaluated_program(void* l0) {
    ...
    vader_array_t* _a2_arr = vader_array_new(38u, 0u, 7u, 3u);
    l3 = (void*) _a2_arr;
    vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a3_obj = (vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
    vader_obj_header_init(_a3_obj, 168u);
    _a3_obj->f_ekeys = l1;
    _a3_obj->f_evals = l2;
    _a3_obj->f_index = l3;
    _a3_obj->f_mask = (size_t) (int64_t) INT64_C(0);
...
void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l4 = (void*) _a6_arr;
    vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t* _a7_obj = (vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___Any___Any___Any___Any___Any___Any___Any___Any___Any_t));
    vader_obj_header_init(_a7_obj, 168u);
    _a7_obj->f_ekeys = l2;
    _a7_obj->f_evals = l3;
    _a7_obj->f_index = l4;
    ...
    l2 = (void*) _a7_obj;
    vader_array_t* _a8_arr = vader_array_new(102u, 0u, 4u, 20u);
    l3 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a11_obj, 73u);
    _a11_obj->f_ekeys = l3;
    _a11_obj->f_evals = l4;
    _a11_obj->f_index = l5;
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(392u, 0u, 13u, 393u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(420u, 0u, 13u, 398u);
    l5 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a14_obj, 16u);
    _a14_obj->f_typed = l0;
...
void* vader_comptime_normalize_int_result(void* l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 1u, 3u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_comptime_EvalResult_t*) l0)->f_value.tag == 405u) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_71: {
            if ((l4 < l3)) {
                ...
                l6 = l7.payload.obj;
                vader_array_t* _a2_arr = vader_array_new(102u, 0u, 4u, 20u);
                l8 = (void*) _a2_arr;
                ...
                vader_obj_header_init(_a5_obj, 71u);
                _a5_obj->f_ekeys = l8;
                _a5_obj->f_evals = l10;
                _a5_obj->f_index = l12;
...
vader_box_t vader_comptime_read_relative_file(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 0u, gc_roots, NULL, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 411u);
    if (t0) {
        l2 = l0;
    } else {
        if (l1 == 0u) {
...
vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_struct___lambda_env_5218_t* _a2_obj = (vader_struct___lambda_env_5218_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5218_t));
    vader_obj_header_init(_a2_obj, 419u);
    t0 = (void*) _a2_obj;
    vader_fn_t* _a3_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a3_closure, 921u);
    _a3_closure->code = (void*) &vader_fn_lift_1068;
    _a3_closure->env = t0;
    l4 = (void*) _a3_closure;
    ...
    std_string_builder_append(l1, 214u);
    t3 = std_string_builder_StringBuilder_Display_to_string(l1);
    { vader_string_t __vret = t3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_comptime_sorted_instances(void* l0) {
    ...
    vader_struct___lambda_env_2125_t* _a0_obj = (vader_struct___lambda_env_2125_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2125_t));
    vader_obj_header_init(_a0_obj, 412u);
    t0 = (void*) _a0_obj;
    vader_fn_t* _a1_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a1_closure, 918u);
    _a1_closure->code = (void*) &vader_fn_lift_959;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
...
bool vader_comptime_symbol_defines_span(void* l0, void* l1) {
    ...
    bool l5;
    vader_string_t l6, l7;
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_defined_at.tag == 184u) {
...
void* vader_comptime_topo_sort(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(416u, 0u, 13u, 213u);
    l1 = (void*) _a0_arr;
    ...
    vader_obj_header_init(_a5_obj, 72u);
    _a5_obj->f_ekeys = l3;
    _a5_obj->f_evals = l4;
    _a5_obj->f_index = l5;
    _a5_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_array_t* _a6_arr = vader_array_new(102u, 0u, 4u, 20u);
    l4 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(101u, 0u, 12u, 7u);
    l5 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a9_obj, 71u);
    _a9_obj->f_ekeys = l4;
    _a9_obj->f_evals = l5;
    _a9_obj->f_index = l6;
    ...
    vader_obj_header_init(_a13_obj, 394u);
    _a13_obj->f_order = l1;
...
void* vader_comptime_unary_bit_not(void* l0, vader_box_t l1) {
    ...
    t2 = vader_comptime_unary_type_mismatch(l0, 1064u);
    { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_comptime_unary_neg(void* l0, vader_box_t l1) {
    ...
    t2 = vader_comptime_unary_type_mismatch(l0, 990u);
    { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_comptime_unary_not(void* l0, vader_box_t l1) {
    ...
    t0 = vader_comptime_unary_type_mismatch(l0, 968u);
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
    ...
    l2 = INT32_C(1);
    {
        loop_15: {
            if ((l2 < INT32_C(1000000))) {
                ...
                l7 = std_core_write_string_at(l6, l7, 818u);
