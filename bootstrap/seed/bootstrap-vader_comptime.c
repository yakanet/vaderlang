...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_struct___lambda_env_5292_t* _a2_obj = (vader_struct___lambda_env_5292_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5292_t));
...
static void* vader_comptime_sorted_instances(void* l0) {
    ...
    vader_struct___lambda_env_2236_t* _a0_obj = (vader_struct___lambda_env_2236_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2236_t));
