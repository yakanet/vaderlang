...
static void* vader_comptime_arg_count_error(void* l0, vader_string_t l1, size_t l2) {
    ...
    l5 = std_core_write_string_at(l6, l5, 526u);
    l5 = std_core_write_string_at(l6, l5, l4);
    l5 = std_core_write_string_at(l6, l5, 110u);
    t0 = ((int64_t) (size_t) l2);
    l7 = (uint64_t) (int64_t) t0;
    l5 = std_core_write_unsigned(l6, l5, l7);
    l5 = std_core_write_string_at(l6, l5, 100u);
...
static void* vader_comptime_arithmetic(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 689u) {
        if (l2.tag == 689u) {
            ...
            t1 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i64(173u, l4), vader_box_i64(173u, l5));
        ...
        l10 = 1919u;
        t0 = vader_comptime_type_mismatch(l0, l10);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1.tag == 686u) {
        if (l2.tag == 686u) {
...
static void* vader_comptime_arithmetic_int(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 689u) {
        ...
        l6 = 1920u;
        t0 = vader_comptime_type_mismatch(l0, l6);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l6 = 1920u;
    t0 = vader_comptime_type_mismatch(l0, l6);
...
static void* vader_comptime_arithmetic_or_concat(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 694u) {
        ...
        t0 = vader_comptime_type_mismatch(l0, 2096u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l6 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_70: {
            if ((l8 < l7)) {
                ...
                if (l9.tag == 405u) {
                    t2 = l9.payload.obj;
                    if (((vader_struct_toolchain_ast_ConstDecl_t*) t2)->f_value.tag == 437u) {
                        t2 = l9.payload.obj;
                        ...
                        if (t3 == 1587u) {
                            ...
                            l12 = std_collections_get__usize__string(l10, l11);
                            if (l12.tag == 169u) {
                                t2 = l9.payload.obj;
...
static void* vader_comptime_bool_op(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 679u) {
        if (l2.tag == 679u) {
            ...
            vader_fn_t* _a0_fnobj = (vader_fn_t*) l3;
            t1 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_bool(167u, l4), vader_box_bool(167u, l5));
            t2 = t1.payload.b;
            if (t2) {
            ...
            vader_obj_header_init(_a2_obj, 679u);
...
static vader_string_t vader_comptime_build_display_key(void* l0, void* l1) {
    ...
    l3 = std_core_write_string_at(l4, l3, 280u);
    l3 = std_core_write_string_at(l4, l3, l2);
    l3 = std_core_write_string_at(l4, l3, 321u);
...
static vader_box_t vader_comptime_build_vm_required(void* l0, void* l1, void* l2, vader_string_t l3) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.tag == 402u) {
        l4 = ((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.payload.obj;
        if (((vader_struct_toolchain_ast_CallExpr_t*) l4)->f_callee.tag == 426u) {
...
int64_t vader_comptime_byte_align(vader_box_t l0) {
    ...
    if (l0.tag == 925u) {
        ...
        if (l0.tag == 917u) {
            ...
            if ((l0.tag == 915u || l0.tag == 916u || l0.tag == 918u || l0.tag == 919u || l0.tag == 927u || l0.tag == 928u || l0.tag == 929u || l0.tag == 932u)) {
                l1 = INT64_C(8);
            } else {
                l1 = INT64_C(0);
            }
...
static vader_string_t vader_comptime_canonical_type_key(vader_box_t l0) {
    ...
    if (l0.tag == 927u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_instance_args_key(((vader_struct_vader_types_StructType_t*) t0)->f_args);
        l2 = vader_host_std_core_byte_len(l1);
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(24) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 735u);
        t0 = l0.payload.obj;
        ...
        l2 = std_core_write_string_at(l3, l2, 280u);
        l2 = std_core_write_string_at(l3, l2, l1);
        l2 = std_core_write_string_at(l3, l2, 321u);
        t1 = std_core_finish_buffer(l3, l2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 918u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(22));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 586u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 917u) {
        t0 = l0.payload.obj;
        t1 = vader_comptime_canonical_type_key(((vader_struct_vader_types_DistinctType_t*) t0)->f_backing);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 928u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_instance_args_key(((vader_struct_vader_types_TraitType_t*) t0)->f_args);
        l2 = vader_host_std_core_byte_len(l1);
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(24) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 814u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 916u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_canonical_type_key(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
        t1 = concat_2(536u, l1);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 929u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_instance_args_key(((vader_struct_vader_types_TupleType_t*) t0)->f_elements);
        t1 = concat_3(819u, l1, 321u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 919u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_instance_args_key(((vader_struct_vader_types_FnType_t*) t0)->f_params);
        t0 = l0.payload.obj;
        l5 = vader_comptime_canonical_type_key(((vader_struct_vader_types_FnType_t*) t0)->f_return_type);
        t1 = concat_4(591u, l1, 349u, l5);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 931u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(22));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 844u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 932u) {
        t0 = l0.payload.obj;
        l1 = vader_comptime_instance_args_key(((vader_struct_vader_types_UnionType_t*) t0)->f_variants);
        t1 = concat_3(652u, l1, 321u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 930u) {
        { vader_gc_top = gc_frame.prev; return 646u; }
    }
    if (l0.tag == 926u) {
        { vader_gc_top = gc_frame.prev; return 738u; }
    }
    if (l0.tag == 933u) {
        { vader_gc_top = gc_frame.prev; return 823u; }
    }
    if (l0.tag == 922u) {
    ...
    if (l0.tag == 923u) {
        { vader_gc_top = gc_frame.prev; return 657u; }
    }
    if (l0.tag == 915u) {
...
static void vader_comptime_collect_expr_deps(vader_box_t l0, void* l1, void* l2, void* l3, void* l4) {
    ...
    if (l0.tag == 426u) {
        ...
        l7 = std_collections_get__u64__Any(l5, l6);
        if (l7.tag == 0u) {
            { vader_gc_top = gc_frame.prev; return; }
        }
        l5 = l7.payload.obj;
        ...
        l7 = std_collections_get__i32__usize(l9, l10);
        if (l7.tag == 0u) {
            { vader_gc_top = gc_frame.prev; return; }
        }
        l8 = ((size_t) l7.payload.i);
        t1 = std_collections_get__usize__bool(l3, l8);
        if (t1.tag == 167u) {
            { vader_gc_top = gc_frame.prev; return; }
        }
        std_collections_put__usize__bool(l3, l8, true);
...
static void* vader_comptime_collect_nodes(void* l0) {
    ...
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(15u, 0u, 4u, 179u);
    l2 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 172u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(15u, 0u, 4u, 179u);
    l4 = (void*) _a6_arr;
    ...
    vader_obj_header_init(_a9_obj, 692u);
    _a9_obj->f_by_id = l1;
    _a9_obj->f_order = l2;
        ...
        loop_42: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 405u) {
                    ...
                    vader_array_t* _a11_arr = vader_array_new(15u, 0u, 4u, 179u);
                    l3 = (void*) _a11_arr;
                    ...
                    l5 = (void*) _a12_obj;
                    std_collections_put__usize__Any(l4, l9, vader_ref_box(l5));
...
static void* vader_comptime_combine_binary(void* l0, vader_box_t l1, vader_box_t l2) {
    ...
    if (l3 == INT32_C(1)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_sub;
        t0 = vader_comptime_arithmetic(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(2)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_mul;
        t0 = vader_comptime_arithmetic(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(3)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_div;
        t0 = vader_comptime_int_div_check(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(4)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_mod;
        t0 = vader_comptime_int_mod_check(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(5)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_shl;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(6)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_shr;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(7)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_bit_and;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(8)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_bit_or;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(9)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_bit_xor;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(10)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_and;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(11)) {
        l4 = (void*) &vader_fn_static_vader_comptime_op_or;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(12)) {
    ...
    if (l3 == INT32_C(18)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_BinaryExpr_t*) l0)->f_span, 547u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(19)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_BinaryExpr_t*) l0)->f_span, 546u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(20)) {
...
static void* vader_comptime_compare(void* l0, vader_box_t l1, vader_box_t l2, uint8_t l3) {
    ...
    vader_string_t* gc_atom_roots[3] = { &l10, &l11, &l12 };
    ...
    if (l1.tag == 689u) {
        ...
        l12 = 1379u;
        t0 = vader_comptime_type_mismatch(l0, l12);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1.tag == 686u) {
        if (l2.tag == 686u) {
    ...
    if (l1.tag == 679u) {
        if (l2.tag == 679u) {
            ...
            l8 = l8 == l9;
            t0 = vader_comptime_equality_only(l0, l8, l3, 1266u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l12 = 1379u;
        t0 = vader_comptime_type_mismatch(l0, l12);
    ...
    if (l1.tag == 694u) {
        if (l2.tag == 694u) {
            ...
            l8 = l10 == l11;
            t0 = vader_comptime_equality_only(l0, l8, l3, 2095u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l12 = 1379u;
        t0 = vader_comptime_type_mismatch(l0, l12);
    ...
    l6 = l0;
    {
        loop_5: {
            if ((l6 < l1)) {
                ...
                vader_array_push((vader_array_t*) l5, vader_box_string(169u, l11));
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                goto loop_5;
            } else {
...
static vader_string_t vader_comptime_display_value(vader_box_t l0) {
    ...
    if (l0.tag == 689u) {
        ...
        l4 = ((vader_struct_vader_comptime_IntValue_t*) t0)->f_value;
        l2 = std_core_write_int(l3, l2, l4);
        l2 = std_core_write_string_at(l3, l2, 866u);
        l2 = std_core_write_string_at(l3, l2, l1);
        t1 = std_core_finish_buffer(l3, l2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 686u) {
        t0 = l0.payload.obj;
        t2 = ((vader_struct_vader_comptime_FloatValue_t*) t0)->f_value;
        l1 = std_core_format_f64(t2);
        t0 = l0.payload.obj;
        l5 = ((vader_struct_vader_comptime_FloatValue_t*) t0)->f_type_name;
    ...
    if (l0.tag == 679u) {
        ...
        l2 = (size_t) (int64_t) INT64_C(0);
        t0 = l0.payload.obj;
        l6 = ((vader_struct_vader_comptime_BoolValue_t*) t0)->f_value;
        l2 = std_core_write_bool(l3, l2, l6);
        t1 = std_core_finish_buffer(l3, l2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 680u) {
        t0 = l0.payload.obj;
        t3 = ((vader_struct_vader_comptime_CharValue_t*) t0)->f_value;
        t1 = std_numbers_to_hex((uint64_t) (int64_t) ((int64_t) (uint32_t) t3));
        l1 = std_string_pad_start(t1, (size_t) (int64_t) INT64_C(4), 48u);
        t1 = concat_3(279u, l1, 264u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 694u) {
        t0 = l0.payload.obj;
        l1 = ((vader_struct_vader_comptime_StringValue_t*) t0)->f_value;
        t1 = concat_3(225u, l1, 225u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 693u) {
        { vader_gc_top = gc_frame.prev; return 1912u; }
    }
    if (l0.tag == 698u) {
        { vader_gc_top = gc_frame.prev; return 2386u; }
    }
    if (l0.tag == 678u) {
        t0 = l0.payload.obj;
        t1 = vader_comptime_render_array(t0);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 695u) {
        t0 = l0.payload.obj;
        t1 = vader_comptime_render_struct(t0);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 696u) {
        t0 = l0.payload.obj;
        t1 = vader_types_display_type_key(((vader_struct_vader_comptime_TypeValue_t*) t0)->f_value);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_comptime_evaluate_assert_decls(void* l0, void* l1, void* l2, void* l3) {
    ...
    void** gc_raw_roots[11] = { &l0, &l1, &l2, &l3, &l4, &l5, &l9, &l11, &l13, &l15, &t0 };
        ...
        loop_12: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 393u) {
                    ...
                    if (l10.tag == 0u) {
                        if (((vader_struct_vader_comptime_EvalResult_t*) l9)->f_value.tag == 679u) {
                            t0 = ((vader_struct_vader_comptime_EvalResult_t*) l9)->f_value.payload.obj;
                            t1 = ((vader_struct_vader_comptime_BoolValue_t*) t0)->f_value;
                            if (!(t1)) {
                                l12 = (uint8_t) (int32_t) INT32_C(14);
                                t0 = l8.payload.obj;
                                l13 = ((vader_struct_toolchain_ast_AssertDecl_t*) t0)->f_span;
                                t0 = l8.payload.obj;
                                l14 = vader_comptime_assert_message(t0);
                                l15 = vader_diagnostics_comptime_error(l12, l13, l14);
                    ...
                    if (l10.tag == 700u) {
                        l11 = l10.payload.obj;
                        t3 = ((vader_struct_vader_diagnostics_CodeInfo_t*) ((vader_struct_vader_diagnostics_Diagnostic_t*) l11)->f_code)->f_id;
                        if (t3 != 552u) {
...
static void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    void* l52 = NULL;
    bool l3;
    vader_box_t l5 = vader_box_null(), l12 = vader_box_null(), l32 = vader_box_null(), l35 = vader_box_null(), l43 = vader_box_null(), l47 = vader_box_null();
    int64_t l6;
    vader_string_t l7 = 0;
    vader_string_t l14 = 0;
    ...
    vader_string_t t3 = 0;
    int64_t t5;
    vader_box_t* gc_roots[7] = { &l5, &l12, &l32, &l35, &l43, &l47, &t1 };
    void** gc_raw_roots[26] = { &l0, &l1, &l2, &l4, &l9, &l10, &l13, &l17, &l19, &l20, &l21, &l25, &l26, &l27, &l28, &l33, &l39, &l40, &l41, &l44, &l49, &l50, &l51, &l52, &t0, &t4 };
    vader_string_t* gc_atom_roots[5] = { &l7, &l14, &l18, &l45, &t3 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 7u, 26u, gc_roots, gc_raw_roots, 0u, NULL, 5u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    if (!(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee.tag == 426u)) {
        t0 = vader_comptime_vm_required(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_span, 576u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = ((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee;
    l2 = t1.payload.obj;
    if (((vader_obj_header_t*) l2)->type_index == 426u) {
        ...
        if (l3) {
            ...
            l5 = std_collections_get__u64__Any(l4, l8);
            if (l5.tag == 0u) {
                l9 = ((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_span;
                l7 = 574u;
                t0 = vader_comptime_vm_required(l9, l7);
                { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
            }
            ...
            vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 172u);
            l19 = (void*) _a2_arr;
            vader_array_t* _a3_arr = vader_array_new(16u, 0u, 0u, 180u);
            l20 = (void*) _a3_arr;
            ...
            vader_obj_header_init(_a5_obj, 283u);
            _a5_obj->f_ekeys = l19;
            _a5_obj->f_evals = l20;
            _a5_obj->f_index = l21;
            _a5_obj->f_mask = l22;
            ...
            l30 = (size_t) (int64_t) INT64_C(0);
            {
                loop_157: {
                    if ((l30 >= l29)) {
                        ...
                        vader_struct___Tuple_2_8b0ac59749226df8_t* _a8_obj = (vader_struct___Tuple_2_8b0ac59749226df8_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_8b0ac59749226df8_t));
                        vader_obj_header_init(_a8_obj, 214u);
                        _a8_obj->f__0 = l31;
                        _a8_obj->f__1 = l32;
                        l33 = (void*) _a8_obj;
                        l34 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__0;
                        l35 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__1;
        ...
        l30 = (size_t) (int64_t) INT64_C(0);
        {
            loop_387: {
                if ((l30 >= l29)) {
                    ...
                    vader_struct___Tuple_2_8b0ac59749226df8_t* _a18_obj = (vader_struct___Tuple_2_8b0ac59749226df8_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_8b0ac59749226df8_t));
                    vader_obj_header_init(_a18_obj, 214u);
                    _a18_obj->f__0 = l31;
                    _a18_obj->f__1 = l32;
                    l33 = (void*) _a18_obj;
                    l34 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__0;
        ...
        vader_obj_header_init(_a21_obj, 681u);
    ...
    l19 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(16u, 0u, 0u, 180u);
    l20 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a25_obj, 283u);
    ...
    l30 = (size_t) (int64_t) INT64_C(0);
    {
        loop_617: {
            if ((l30 >= l29)) {
                ...
                vader_struct___Tuple_2_8b0ac59749226df8_t* _a28_obj = (vader_struct___Tuple_2_8b0ac59749226df8_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_8b0ac59749226df8_t));
                vader_obj_header_init(_a28_obj, 214u);
                _a28_obj->f__0 = l31;
                _a28_obj->f__1 = l32;
                l33 = (void*) _a28_obj;
                l34 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__0;
    ...
    vader_obj_header_init(_a31_obj, 681u);
...
void* vader_comptime_evaluate_expr(vader_box_t l0, void* l1) {
    ...
    if ((t0 >= INT64_C(2000))) {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        l4 = std_core_write_string_at(l3, l4, 1153u);
        l4 = std_core_write_int(l3, l4, INT64_C(2000));
        l4 = std_core_write_string_at(l3, l4, 141u);
...
static void* vader_comptime_evaluate_fn_body(void* l0, void* l1, void* l2) {
    ...
    if (!(((vader_struct_toolchain_ast_BlockExpr_t*) l3)->f_trailing.tag == 0u)) {
        ...
        t0 = vader_comptime_vm_required(l2, 571u);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t2 = ((vader_array_t*) ((vader_struct_toolchain_ast_BlockExpr_t*) l3)->f_stmts)->length;
    if (t2 == INT64_C(1)) {
...
static void* vader_comptime_evaluate_ident(void* l0, void* l1) {
    ...
    vader_string_t* gc_atom_roots[4] = { &l7, &l8, &l9, &l10 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 3u, 4u, gc_roots, gc_raw_roots, 0u, NULL, 4u, gc_atom_roots };
    vader_gc_top = &gc_frame;
            ...
            if ((l9 < l8)) {
                ...
                if (!(((vader_struct_vader_comptime_EvalResult_t*) l11)->f_value.tag == 0u)) {
                    ...
                    if (!(l19.tag == 0u)) {
                        ...
                        std_collections_put__i32__Any(l20, l21, l22);
                    } else {
                    }
                } else {
                }
        ...
        loop_186: {
            if ((l9 < l8)) {
                ...
                if (l12.tag == 405u) {
                    ...
                    l10 = l14.payload.obj;
                    if (((vader_obj_header_t*) l10)->type_index == 889u) {
                        ...
                        t2 = std_collections_get__i32__Any(l11, l21);
                        if (!(t2.tag == 0u)) {
                            t0 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t0;
                            goto loop_186;
                        ...
                        if (!(((vader_struct_vader_comptime_EvalResult_t*) l13)->f_value.tag == 0u)) {
                            ...
                            std_collections_put__i32__Any(l15, l24, l19);
                        } else {
                        }
                        l18 = (size_t) (int64_t) INT64_C(1);
                        t0 = (l9 + l18);
...
void* vader_comptime_evaluate_project(void* l0, void* l1, void* l2) {
    ...
    vader_string_t* gc_atom_roots[2] = { &l9, &l11 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 13u, gc_roots, gc_raw_roots, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l8 >= l7)) {
                ...
                vader_struct___Tuple_2_9e32263671f4123c_t* _a2_obj = (vader_struct___Tuple_2_9e32263671f4123c_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_9e32263671f4123c_t));
                vader_obj_header_init(_a2_obj, 217u);
                _a2_obj->f__0 = l9;
                _a2_obj->f__1 = l4;
                l10 = (void*) _a2_obj;
                l11 = ((vader_struct___Tuple_2_9e32263671f4123c_t*) l10)->f__0;
                l12 = ((vader_struct___Tuple_2_9e32263671f4123c_t*) l10)->f__1;
                t1 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t1;
...
static void* vader_comptime_evaluate_seq_lit(void* l0, void* l1, void* l2) {
    ...
    if (l8.tag == 929u) {
        ...
        l4 = (void*) _a3_arr;
        vader_array_t* _a4_arr = vader_array_new(16u, 0u, 0u, 180u);
        l7 = (void*) _a4_arr;
        vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 172u);
        l9 = (void*) _a5_arr;
        ...
        vader_obj_header_init(_a6_obj, 321u);
        _a6_obj->f_ekeys = l4;
        _a6_obj->f_evals = l7;
        _a6_obj->f_index = l9;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_73: {
                if ((l6 < l5)) {
                    ...
                    l10 = std_core_write_string_at(l7, l10, 866u);
    ...
    vader_obj_header_init(_a9_obj, 678u);
...
static void* vader_comptime_harvest_instances(void* l0) {
    ...
    vader_string_t* gc_atom_roots[2] = { &l7, &l54 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 14u, 30u, gc_roots, gc_raw_roots, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 169u);
    l1 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(16u, 0u, 0u, 180u);
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(49u, 0u, 13u, 687u);
    l2 = (void*) _a4_arr;
    ...
    vader_obj_header_init(_a5_obj, 688u);
    _a5_obj->f_by_key = l1;
    _a5_obj->f_order = l2;
    l1 = (void*) _a5_obj;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_32: {
            if ((l6 >= l5)) {
                ...
                vader_struct___Tuple_2_9e32263671f4123c_t* _a8_obj = (vader_struct___Tuple_2_9e32263671f4123c_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_9e32263671f4123c_t));
                vader_obj_header_init(_a8_obj, 217u);
                _a8_obj->f__0 = l7;
                _a8_obj->f__1 = l2;
                t1 = (void*) _a8_obj;
                l8 = ((vader_struct___Tuple_2_9e32263671f4123c_t*) t1)->f__1;
                t2 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t2;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_68: {
                        if ((l13 >= l12)) {
                            ...
                            vader_struct___Tuple_2_1516d310bf336b1c_t* _a11_obj = (vader_struct___Tuple_2_1516d310bf336b1c_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_1516d310bf336b1c_t));
                            vader_obj_header_init(_a11_obj, 203u);
                            _a11_obj->f__0 = l14;
                            _a11_obj->f__1 = l15;
                            t1 = (void*) _a11_obj;
                            l16 = ((vader_struct___Tuple_2_1516d310bf336b1c_t*) t1)->f__1;
                            t2 = (l13 + INT64_C(1));
                ...
                l21 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_110: {
                        if ((l21 >= l20)) {
                            ...
                            vader_struct___Tuple_2_a5cc718b72351ab0_t* _a14_obj = (vader_struct___Tuple_2_a5cc718b72351ab0_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_a5cc718b72351ab0_t));
                            vader_obj_header_init(_a14_obj, 219u);
                            _a14_obj->f__0 = l22;
                            _a14_obj->f__1 = l23;
                            t1 = (void*) _a14_obj;
                            l24 = ((vader_struct___Tuple_2_a5cc718b72351ab0_t*) t1)->f__1;
                            t2 = (l21 + INT64_C(1));
                ...
                l29 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_152: {
                        if ((l29 >= l28)) {
                            ...
                            vader_struct___Tuple_2_489e9ee29746ed51_t* _a17_obj = (vader_struct___Tuple_2_489e9ee29746ed51_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_489e9ee29746ed51_t));
                            vader_obj_header_init(_a17_obj, 205u);
                            _a17_obj->f__0 = l30;
                            _a17_obj->f__1 = l31;
                            t1 = (void*) _a17_obj;
                            l32 = ((vader_struct___Tuple_2_489e9ee29746ed51_t*) t1)->f__1;
                            t2 = (l29 + INT64_C(1));
                ...
                l37 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_194: {
                        if ((l37 >= l36)) {
                            ...
                            vader_struct___Tuple_2_489e9ee29746ed51_t* _a20_obj = (vader_struct___Tuple_2_489e9ee29746ed51_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_489e9ee29746ed51_t));
                            vader_obj_header_init(_a20_obj, 205u);
                            _a20_obj->f__0 = l38;
                            _a20_obj->f__1 = l39;
                            t1 = (void*) _a20_obj;
                            l40 = ((vader_struct___Tuple_2_489e9ee29746ed51_t*) t1)->f__1;
                            t2 = (l37 + INT64_C(1));
                ...
                l45 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l45 >= l44)) {
                            ...
                            vader_struct___Tuple_2_489e9ee29746ed51_t* _a23_obj = (vader_struct___Tuple_2_489e9ee29746ed51_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_489e9ee29746ed51_t));
                            vader_obj_header_init(_a23_obj, 205u);
                            _a23_obj->f__0 = l46;
                            _a23_obj->f__1 = l47;
                            t1 = (void*) _a23_obj;
                            l48 = ((vader_struct___Tuple_2_489e9ee29746ed51_t*) t1)->f__1;
                            t2 = (l45 + INT64_C(1));
                ...
                l53 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_278: {
                        if ((l53 >= l52)) {
                            ...
                            vader_struct___Tuple_2_667d1172be64a7cb_t* _a26_obj = (vader_struct___Tuple_2_667d1172be64a7cb_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_667d1172be64a7cb_t));
                            vader_obj_header_init(_a26_obj, 210u);
                            _a26_obj->f__0 = l54;
                            _a26_obj->f__1 = l55;
                            t1 = (void*) _a26_obj;
                            l56 = ((vader_struct___Tuple_2_667d1172be64a7cb_t*) t1)->f__1;
                            t2 = (l53 + INT64_C(1));
                ...
                l62 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_323: {
                        if ((l62 >= l61)) {
                            ...
                            vader_struct___Tuple_2_489e9ee29746ed51_t* _a29_obj = (vader_struct___Tuple_2_489e9ee29746ed51_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_2_489e9ee29746ed51_t));
                            vader_obj_header_init(_a29_obj, 205u);
                            _a29_obj->f__0 = l63;
                            _a29_obj->f__1 = l64;
                            t1 = (void*) _a29_obj;
                            l65 = ((vader_struct___Tuple_2_489e9ee29746ed51_t*) t1)->f__1;
                            t2 = (l62 + INT64_C(1));
...
static void* vader_comptime_int_div_check(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l2.tag == 689u) {
        ...
        if (t1 == INT64_C(0)) {
            t0 = vader_comptime_division_by_zero(l0, 433u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
...
static void* vader_comptime_int_mod_check(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l2.tag == 689u) {
        ...
        t1 = ((vader_struct_vader_comptime_IntValue_t*) t0)->f_value;
        if (t1 == INT64_C(0)) {
            t0 = vader_comptime_division_by_zero(l0, 256u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
...
static vader_string_t vader_comptime_interp_value(vader_box_t l0) {
    ...
    vader_gc_top = &gc_frame;
    if (l0.tag == 689u) {
        l1 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(20));
        l2 = (size_t) (int64_t) INT64_C(0);
        t0 = l0.payload.obj;
        l3 = ((vader_struct_vader_comptime_IntValue_t*) t0)->f_value;
    ...
    if (l0.tag == 686u) {
        t0 = l0.payload.obj;
        t2 = ((vader_struct_vader_comptime_FloatValue_t*) t0)->f_value;
        t1 = std_core_format_f64(t2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 679u) {
        l1 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(5));
        l2 = (size_t) (int64_t) INT64_C(0);
        t0 = l0.payload.obj;
        l4 = ((vader_struct_vader_comptime_BoolValue_t*) t0)->f_value;
        l2 = std_core_write_bool(l1, l2, l4);
        t1 = std_core_finish_buffer(l1, l2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 694u) {
        t0 = l0.payload.obj;
        t1 = ((vader_struct_vader_comptime_StringValue_t*) t0)->f_value;
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 680u) {
        t0 = l0.payload.obj;
        t3 = ((vader_struct_vader_comptime_CharValue_t*) t0)->f_value;
        t0 = std_core_utf8_encode(((uint32_t) (uint32_t) t3));
    ...
    if (l0.tag == 678u) {
        t0 = l0.payload.obj;
        t1 = vader_comptime_display_value(vader_ref_box(t0));
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 695u) {
        t0 = l0.payload.obj;
...
static void* vader_comptime_intrinsic_align_of(void* l0, void* l1) {
    ...
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1172u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1173u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_field_count(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1579u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1580u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_field_index(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(2)) {
        t1 = vader_comptime_arg_count_error(l0, 1581u, (size_t) (int64_t) INT64_C(2));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1584u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l3.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1583u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l2.tag == 927u) {
        ...
        l6 = std_collections_get__i32__Any(l4, l5);
        if (l6.tag == 463u) {
            t1 = l6.payload.obj;
            ...
            l8 = (size_t) (int64_t) INT64_C(0);
            {
                loop_62: {
                    if ((l8 < l7)) {
                        ...
                        l10 = l3.payload.s;
                        if (l9 == l10) {
                            t2 = vader_comptime_int_val_typed(((int64_t) (size_t) l8), 2296u);
                            t1 = vader_comptime_ok(t2);
                            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
                        }
                        t3 = (l8 + INT64_C(1));
            ...
            l10 = l3.payload.s;
            l9 = concat_5(1582u, l9, 961u, l10, 927u);
            t1 = vader_comptime_arg_error(l0, l9);
            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t1 = l2.payload.obj;
        l9 = vader_types_display_type(vader_ref_box(t1));
        l9 = concat_3(1585u, l9, 1009u);
        t1 = vader_comptime_arg_error(l0, l9);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l9 = vader_types_display_type(l2);
    l9 = concat_3(1582u, l9, 987u);
    t1 = vader_comptime_arg_error(l0, l9);
    { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_intrinsic_size_of(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2014u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2016u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_type_name(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2195u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2196u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_variant_count(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2382u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2383u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static bool vader_comptime_is_concrete_enough(vader_box_t l0) {
    if ((l0.tag == 920u || l0.tag == 921u || l0.tag == 922u || l0.tag == 926u || l0.tag == 933u)) {
        return false;
    }
    return true;
}
...
static void* vader_comptime_new_evaluated_program(void* l0) {
    ...
    vader_obj_header_init(_a4_obj, 684u);
    _a4_obj->f_typed = l0;
...
static void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(49u, 0u, 13u, 687u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(50u, 0u, 13u, 697u);
    l5 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a14_obj, 685u);
    _a14_obj->f_typed = l0;
...
static void* vader_comptime_normalize_int_result(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_comptime_EvalResult_t*) l0)->f_value.tag == 689u) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_71: {
            if ((l4 < l3)) {
                ...
                l6 = l7.payload.obj;
                vader_array_t* _a2_arr = vader_array_new(15u, 0u, 4u, 179u);
                l8 = (void*) _a2_arr;
...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    std_string_builder_append(l1, 176u);
    ...
    vader_obj_header_init(_a2_obj, 248u);
    t0 = (void*) _a2_obj;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_27: {
            if ((l6 < l5)) {
                ...
                std_string_builder_append(l1, l2);
                std_string_builder_append(l1, 61u);
    ...
    std_string_builder_append(l1, 201u);
    t3 = std_string_builder_StringBuilder_Display_to_string(l1);
    { vader_string_t __vret = t3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static bool vader_comptime_symbol_defines_span(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_defined_at.tag == 482u) {
...
static void* vader_comptime_topo_sort(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 405u);
    l1 = (void*) _a0_arr;
    ...
    vader_array_t* _a6_arr = vader_array_new(15u, 0u, 4u, 179u);
    l4 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(6u, 0u, 12u, 167u);
    l5 = (void*) _a7_arr;
    ...
    vader_obj_header_init(_a13_obj, 682u);
    _a13_obj->f_order = l1;
...
static void* vader_comptime_unary_bit_not(void* l0, vader_box_t l1) {
    ...
    t0 = vader_comptime_unary_type_mismatch(l0, 1147u);
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_unary_neg(void* l0, vader_box_t l1) {
    ...
    t0 = vader_comptime_unary_type_mismatch(l0, 1067u);
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_unary_not(void* l0, vader_box_t l1) {
    ...
    t0 = vader_comptime_unary_type_mismatch(l0, 1043u);
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
    ...
    l2 = INT32_C(1);
    {
        loop_15: {
            if ((l2 < INT32_C(1000000))) {
                ...
                l7 = std_core_write_string_at(l6, l7, 866u);
