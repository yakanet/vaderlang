...
static void* vader_comptime_arithmetic_or_concat(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 684u) {
        ...
        t2 = vader_comptime_type_mismatch(l0, 2088u);
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l8 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_70: {
            if ((l8 < l7)) {
                ...
                if (l9.tag == 396u) {
                    l6 = l9.payload.obj;
                    if (((vader_struct_toolchain_ast_ConstDecl_t*) l6)->f_value.tag == 428u) {
...
static vader_box_t vader_comptime_build_vm_required(void* l0, void* l1, void* l2, vader_string_t l3) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.tag == 393u) {
        l4 = ((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.payload.obj;
        if (((vader_struct_toolchain_ast_CallExpr_t*) l4)->f_callee.tag == 417u) {
...
int64_t vader_comptime_byte_align(vader_box_t l0) {
    ...
    if (l0.tag == 913u) {
        ...
        if (l0.tag == 905u) {
            ...
            if ((l0.tag == 903u || l0.tag == 904u || l0.tag == 906u || l0.tag == 907u || l0.tag == 915u || l0.tag == 916u || l0.tag == 917u || l0.tag == 920u)) {
                l1 = INT64_C(8);
            } else {
                l1 = INT64_C(0);
            }
        ...
        loop_42: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 396u) {
                    ...
                    vader_obj_header_init(_a12_obj, 681u);
                    _a12_obj->f_decl = l3;
...
static void* vader_comptime_compare(void* l0, vader_box_t l1, vader_box_t l2, uint8_t l3) {
    ...
    if (l1.tag == 684u) {
        ...
        if (l2.tag == 684u) {
            ...
            l10 = l12 == l13;
            t2 = vader_comptime_equality_only(l0, l10, l3, 2087u);
            { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l14 = 1358u;
        t2 = vader_comptime_type_mismatch(l0, l14);
        ...
        loop_12: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 383u) {
                    ...
                    if (l11.tag == 0u) {
                        if (((vader_struct_vader_comptime_EvalResult_t*) l10)->f_value.tag == 669u) {
...
static void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (!(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee.tag == 417u)) {
    ...
    l2 = t1.payload.obj;
    if (((vader_obj_header_t*) l2)->type_index == 417u) {
        l3 = l2;
            ...
            l30 = (size_t) (int64_t) INT64_C(0);
            {
                loop_159: {
                    if ((l30 >= l29)) {
                        ...
                        vader_struct___Tuple_1215_t* _a8_obj = (vader_struct___Tuple_1215_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1215_t));
                        vader_obj_header_init(_a8_obj, 217u);
                        _a8_obj->f__0 = l31;
                        _a8_obj->f__1 = l32;
                        l33 = (void*) _a8_obj;
                        l34 = ((vader_struct___Tuple_1215_t*) l33)->f__0;
                        l35 = ((vader_struct___Tuple_1215_t*) l33)->f__1;
        ...
        l30 = (size_t) (int64_t) INT64_C(0);
        {
            loop_389: {
                if ((l30 >= l29)) {
                    ...
                    vader_struct___Tuple_1215_t* _a18_obj = (vader_struct___Tuple_1215_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1215_t));
        ...
        vader_obj_header_init(_a21_obj, 671u);
    ...
    l30 = (size_t) (int64_t) INT64_C(0);
    {
        loop_619: {
            if ((l30 >= l29)) {
                ...
                vader_struct___Tuple_1215_t* _a28_obj = (vader_struct___Tuple_1215_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1215_t));
    ...
    vader_obj_header_init(_a31_obj, 671u);
        ...
        loop_184: {
            if ((l9 < l8)) {
                ...
                if (l12.tag == 396u) {
                    ...
                    l11 = l14.payload.obj;
                    if (((vader_obj_header_t*) l11)->type_index == 878u) {
                        l13 = l11;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l8 >= l7)) {
                ...
                vader_struct___Tuple_1146_t* _a2_obj = (vader_struct___Tuple_1146_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1146_t));
                vader_obj_header_init(_a2_obj, 200u);
                _a2_obj->f__0 = l9;
                _a2_obj->f__1 = l4;
                l10 = (void*) _a2_obj;
                l11 = ((vader_struct___Tuple_1146_t*) l10)->f__0;
                l12 = ((vader_struct___Tuple_1146_t*) l10)->f__1;
                t1 = (l8 + INT64_C(1));
                l8 = (size_t) (int64_t) t1;
...
static void* vader_comptime_harvest_instances(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(49u, 0u, 13u, 677u);
    l2 = (void*) _a4_arr;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_32: {
            if ((l6 >= l5)) {
                ...
                vader_struct___Tuple_1146_t* _a8_obj = (vader_struct___Tuple_1146_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1146_t));
                vader_obj_header_init(_a8_obj, 200u);
                _a8_obj->f__0 = l7;
                _a8_obj->f__1 = l2;
                t1 = (void*) _a8_obj;
                l8 = ((vader_struct___Tuple_1146_t*) t1)->f__1;
                t2 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t2;
                ...
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_68: {
                        if ((l13 >= l12)) {
                            ...
                            vader_struct___Tuple_1147_t* _a11_obj = (vader_struct___Tuple_1147_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1147_t));
                            vader_obj_header_init(_a11_obj, 201u);
                            _a11_obj->f__0 = l14;
                            _a11_obj->f__1 = l15;
                            t1 = (void*) _a11_obj;
                            l16 = ((vader_struct___Tuple_1147_t*) t1)->f__1;
                            t2 = (l13 + INT64_C(1));
                ...
                l21 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_110: {
                        if ((l21 >= l20)) {
                            ...
                            vader_struct___Tuple_1210_t* _a14_obj = (vader_struct___Tuple_1210_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1210_t));
                            vader_obj_header_init(_a14_obj, 214u);
                            _a14_obj->f__0 = l22;
                            _a14_obj->f__1 = l23;
                            t1 = (void*) _a14_obj;
                            l24 = ((vader_struct___Tuple_1210_t*) t1)->f__1;
                            t2 = (l21 + INT64_C(1));
                ...
                l29 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_152: {
                        if ((l29 >= l28)) {
                            ...
                            vader_struct___Tuple_1211_t* _a17_obj = (vader_struct___Tuple_1211_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1211_t));
                            vader_obj_header_init(_a17_obj, 215u);
                            _a17_obj->f__0 = l30;
                            _a17_obj->f__1 = l31;
                            t1 = (void*) _a17_obj;
                            l32 = ((vader_struct___Tuple_1211_t*) t1)->f__1;
                            t2 = (l29 + INT64_C(1));
                ...
                l37 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_194: {
                        if ((l37 >= l36)) {
                            ...
                            vader_struct___Tuple_1211_t* _a20_obj = (vader_struct___Tuple_1211_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1211_t));
                            vader_obj_header_init(_a20_obj, 215u);
                            _a20_obj->f__0 = l38;
                            _a20_obj->f__1 = l39;
                            t1 = (void*) _a20_obj;
                            l40 = ((vader_struct___Tuple_1211_t*) t1)->f__1;
                            t2 = (l37 + INT64_C(1));
                ...
                l45 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l45 >= l44)) {
                            ...
                            vader_struct___Tuple_1211_t* _a23_obj = (vader_struct___Tuple_1211_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1211_t));
                            vader_obj_header_init(_a23_obj, 215u);
                            _a23_obj->f__0 = l46;
                            _a23_obj->f__1 = l47;
                            t1 = (void*) _a23_obj;
                            l48 = ((vader_struct___Tuple_1211_t*) t1)->f__1;
                            t2 = (l45 + INT64_C(1));
                ...
                l53 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_278: {
                        if ((l53 >= l52)) {
                            ...
                            vader_struct___Tuple_1213_t* _a26_obj = (vader_struct___Tuple_1213_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1213_t));
                            vader_obj_header_init(_a26_obj, 216u);
                            _a26_obj->f__0 = l54;
                            _a26_obj->f__1 = l55;
                            t1 = (void*) _a26_obj;
                            l56 = ((vader_struct___Tuple_1213_t*) t1)->f__1;
                            t2 = (l53 + INT64_C(1));
                ...
                l62 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_323: {
                        if ((l62 >= l61)) {
                            ...
                            vader_struct___Tuple_1211_t* _a29_obj = (vader_struct___Tuple_1211_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1211_t));
                            vader_obj_header_init(_a29_obj, 215u);
                            _a29_obj->f__0 = l63;
                            _a29_obj->f__1 = l64;
                            t1 = (void*) _a29_obj;
                            l65 = ((vader_struct___Tuple_1211_t*) t1)->f__1;
                            t2 = (l62 + INT64_C(1));
...
static void* vader_comptime_int_mod_check(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l2.tag == 679u) {
        ...
        t1 = ((vader_struct_vader_comptime_IntValue_t*) t0)->f_value;
        if (t1 == INT64_C(0)) {
            t0 = vader_comptime_division_by_zero(l0, 267u);
            { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
...
static void* vader_comptime_intrinsic_align_of(void* l0, void* l1) {
    ...
    t2 = vader_comptime_int_val_typed(t3, 2290u);
            ...
            l9 = (size_t) (int64_t) INT64_C(0);
            {
                loop_64: {
                    if ((l9 < l8)) {
                        ...
                        l11 = l3.payload.s;
                        if (l10 == l11) {
                            t2 = vader_comptime_int_val_typed(((int64_t) (size_t) l9), 2290u);
                            t1 = vader_comptime_ok(t2);
                            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
                        }
                        t3 = (l9 + INT64_C(1));
...
static bool vader_comptime_is_concrete_enough(vader_box_t l0) {
    if ((l0.tag == 908u || l0.tag == 909u || l0.tag == 910u || l0.tag == 914u || l0.tag == 921u)) {
        return false;
    }
    return true;
}
...
static void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(49u, 0u, 13u, 677u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(50u, 0u, 13u, 687u);
    l5 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a14_obj, 675u);
    _a14_obj->f_typed = l0;
...
static void* vader_comptime_normalize_int_result(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_comptime_EvalResult_t*) l0)->f_value.tag == 679u) {
...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_struct___lambda_env_5516_t* _a2_obj = (vader_struct___lambda_env_5516_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5516_t));
    ...
    _a3_closure->code = (void*) &vader_fn_lift_1090;
    _a3_closure->env = t0;
    l4 = (void*) _a3_closure;
...
static void* vader_comptime_sorted_instances(void* l0) {
    ...
    vader_struct___lambda_env_2331_t* _a0_obj = (vader_struct___lambda_env_2331_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2331_t));
    ...
    _a1_closure->code = (void*) &vader_fn_lift_981;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
...
static bool vader_comptime_symbol_defines_span(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_defined_at.tag == 473u) {
...
static void* vader_comptime_topo_sort(void* l0) {
    ...
    vader_obj_header_init(_a13_obj, 672u);
    _a13_obj->f_order = l1;
