...
static void* vader_comptime_arithmetic(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 678u) {
        ...
        if (l2.tag == 678u) {
            ...
            t0 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i64(167u, l6), vader_box_i64(167u, l7));
...
static void* vader_comptime_arithmetic_or_concat(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 683u) {
        ...
        t2 = vader_comptime_type_mismatch(l0, 2074u);
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l8 = l1;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_70: {
            if ((l8 < l7)) {
                ...
                if (l9.tag == 395u) {
                    l6 = l9.payload.obj;
                    if (((vader_struct_toolchain_ast_ConstDecl_t*) l6)->f_value.tag == 427u) {
...
static void* vader_comptime_bool_op(void* l0, vader_box_t l1, vader_box_t l2, void* l3) {
    ...
    if (l1.tag == 668u) {
        ...
        if (l2.tag == 668u) {
            ...
            vader_fn_t* _a0_fnobj = (vader_fn_t*) l3;
            t0 = ((vader_fn_erased_sig_2_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_bool(161u, l6), vader_box_bool(161u, l7));
            t1 = t0.payload.b;
            if (t1) {
...
static vader_box_t vader_comptime_build_vm_required(void* l0, void* l1, void* l2, vader_string_t l3) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.tag == 392u) {
        l4 = ((vader_struct_toolchain_ast_ConstDecl_t*) l0)->f_value.payload.obj;
        if (((vader_struct_toolchain_ast_CallExpr_t*) l4)->f_callee.tag == 416u) {
...
int64_t vader_comptime_byte_align(vader_box_t l0) {
    ...
    if (l0.tag == 912u) {
        ...
        if (l0.tag == 904u) {
            ...
            if ((l0.tag == 902u || l0.tag == 903u || l0.tag == 905u || l0.tag == 906u || l0.tag == 914u || l0.tag == 915u || l0.tag == 916u || l0.tag == 919u)) {
                l1 = INT64_C(8);
            } else {
                l1 = INT64_C(0);
            }
...
static void* vader_comptime_collect_nodes(void* l0) {
    ...
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(15u, 0u, 4u, 173u);
    l2 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(15u, 0u, 4u, 173u);
    l4 = (void*) _a6_arr;
        ...
        loop_42: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 395u) {
                    ...
                    vader_array_t* _a11_arr = vader_array_new(15u, 0u, 4u, 173u);
                    l4 = (void*) _a11_arr;
                    ...
                    vader_obj_header_init(_a12_obj, 680u);
                    _a12_obj->f_decl = l3;
...
static void* vader_comptime_compare(void* l0, vader_box_t l1, vader_box_t l2, uint8_t l3) {
    ...
    if (l1.tag == 668u) {
        ...
        if (l2.tag == 668u) {
            ...
            l10 = l10 == l11;
            t2 = vader_comptime_equality_only(l0, l10, l3, 1240u);
            { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l14 = 1348u;
        t2 = vader_comptime_type_mismatch(l0, l14);
    ...
    if (l1.tag == 683u) {
        ...
        if (l2.tag == 683u) {
            ...
            l10 = l12 == l13;
            t2 = vader_comptime_equality_only(l0, l10, l3, 2073u);
            { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l14 = 1348u;
        t2 = vader_comptime_type_mismatch(l0, l14);
...
static vader_string_t vader_comptime_display_value(vader_box_t l0) {
    ...
    if (l0.tag == 682u) {
        { vader_gc_top = gc_frame.prev; return 1868u; }
    }
    if (l0.tag == 687u) {
        { vader_gc_top = gc_frame.prev; return 2366u; }
    }
    if (l0.tag == 667u) {
        t3 = l0.payload.obj;
        ...
        loop_12: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 383u) {
                    ...
                    if (l11.tag == 0u) {
                        if (((vader_struct_vader_comptime_EvalResult_t*) l10)->f_value.tag == 668u) {
...
static void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if (!(((vader_struct_toolchain_ast_CallExpr_t*) l0)->f_callee.tag == 416u)) {
    ...
    l2 = t1.payload.obj;
    if (((vader_obj_header_t*) l2)->type_index == 416u) {
        l3 = l2;
        ...
        if (l4) {
            ...
            vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
            l19 = (void*) _a2_arr;
            vader_array_t* _a3_arr = vader_array_new(16u, 0u, 0u, 174u);
            l20 = (void*) _a3_arr;
            ...
            vader_obj_header_init(_a5_obj, 275u);
            _a5_obj->f_ekeys = l19;
            _a5_obj->f_evals = l20;
            _a5_obj->f_index = l21;
            _a5_obj->f_mask = l22;
        ...
        l30 = (size_t) (int64_t) INT64_C(0);
        {
            loop_389: {
                if ((l30 >= l29)) {
                    ...
                    vader_obj_header_init(_a18_obj, 207u);
                    _a18_obj->f__0 = l31;
                    _a18_obj->f__1 = l32;
                    l33 = (void*) _a18_obj;
                    l34 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__0;
        ...
        vader_obj_header_init(_a21_obj, 670u);
    ...
    l19 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(16u, 0u, 0u, 174u);
    l20 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a25_obj, 275u);
    ...
    l30 = (size_t) (int64_t) INT64_C(0);
    {
        loop_619: {
            if ((l30 >= l29)) {
                ...
                vader_obj_header_init(_a28_obj, 207u);
                _a28_obj->f__0 = l31;
                _a28_obj->f__1 = l32;
                l33 = (void*) _a28_obj;
                l34 = ((vader_struct___Tuple_2_8b0ac59749226df8_t*) l33)->f__0;
    ...
    vader_obj_header_init(_a31_obj, 670u);
...
void* vader_comptime_evaluate_expr(vader_box_t l0, void* l1) {
    ...
    if ((t0 >= INT64_C(2000))) {
        ...
        l4 = (size_t) (int64_t) INT64_C(0);
        l4 = std_core_write_string_at(l3, l4, 1131u);
        ...
        loop_184: {
            if ((l9 < l8)) {
                ...
                if (l12.tag == 395u) {
                    ...
                    l11 = l14.payload.obj;
                    if (((vader_obj_header_t*) l11)->type_index == 877u) {
                        l13 = l11;
...
static void* vader_comptime_evaluate_seq_lit(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(125u, 0u, 13u, 1110u);
    l3 = (void*) _a0_arr;
    ...
    if (l8.tag == 916u) {
        ...
        l4 = (void*) _a3_arr;
        vader_array_t* _a4_arr = vader_array_new(16u, 0u, 0u, 174u);
        l7 = (void*) _a4_arr;
        vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
        l9 = (void*) _a5_arr;
        ...
        vader_obj_header_init(_a6_obj, 313u);
        _a6_obj->f_ekeys = l4;
        _a6_obj->f_evals = l7;
        _a6_obj->f_index = l9;
        ...
        vader_obj_header_init(_a8_obj, 684u);
...
static void* vader_comptime_harvest_instances(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(49u, 0u, 13u, 676u);
    l2 = (void*) _a4_arr;
                ...
                l21 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_110: {
                        if ((l21 >= l20)) {
                            ...
                            vader_obj_header_init(_a14_obj, 212u);
                            _a14_obj->f__0 = l22;
                            _a14_obj->f__1 = l23;
                            t1 = (void*) _a14_obj;
                ...
                l37 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_194: {
                        if ((l37 >= l36)) {
                            ...
                            vader_obj_header_init(_a20_obj, 198u);
                            _a20_obj->f__0 = l38;
                            _a20_obj->f__1 = l39;
                            t1 = (void*) _a20_obj;
                ...
                l45 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l45 >= l44)) {
                            ...
                            vader_obj_header_init(_a23_obj, 198u);
                            _a23_obj->f__0 = l46;
                            _a23_obj->f__1 = l47;
                            t1 = (void*) _a23_obj;
                ...
                l53 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_278: {
                        if ((l53 >= l52)) {
                            ...
                            vader_obj_header_init(_a26_obj, 203u);
                            _a26_obj->f__0 = l54;
                            _a26_obj->f__1 = l55;
                            t1 = (void*) _a26_obj;
                ...
                l62 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_323: {
                        if ((l62 >= l61)) {
                            ...
                            vader_obj_header_init(_a29_obj, 198u);
                            _a29_obj->f__0 = l63;
                            _a29_obj->f__1 = l64;
                            t1 = (void*) _a29_obj;
...
static void* vader_comptime_intrinsic_align_of(void* l0, void* l1) {
    ...
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1149u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1150u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    t3 = vader_comptime_byte_align(l2);
    t2 = vader_comptime_int_val_typed(t3, 2276u);
...
static void* vader_comptime_intrinsic_field_count(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1545u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1546u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_field_index(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(2)) {
        t1 = vader_comptime_arg_count_error(l0, 1547u, (size_t) (int64_t) INT64_C(2));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1550u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l3.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1549u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l2.tag == 914u) {
        l4 = l2.payload.obj;
        ...
        if (l7.tag == 453u) {
            ...
            l9 = (size_t) (int64_t) INT64_C(0);
            {
                loop_64: {
                    if ((l9 < l8)) {
                        ...
                        l11 = l3.payload.s;
                        if (l10 == l11) {
                            t2 = vader_comptime_int_val_typed(((int64_t) (size_t) l9), 2276u);
                            t1 = vader_comptime_ok(t2);
                            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
                        }
                        t3 = (l9 + INT64_C(1));
            ...
            l11 = l3.payload.s;
            l10 = concat_5(1548u, l10, 951u, l11, 919u);
            t1 = vader_comptime_arg_error(l0, l10);
            { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t1 = l2.payload.obj;
        l10 = vader_types_display_type(vader_ref_box(t1));
        l10 = concat_3(1551u, l10, 995u);
        t1 = vader_comptime_arg_error(l0, l10);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l10 = vader_types_display_type(l2);
    l10 = concat_3(1548u, l10, 975u);
    t1 = vader_comptime_arg_error(l0, l10);
    { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_intrinsic_size_of(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 1971u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 1973u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_type_kind(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2171u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2172u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_comptime_intrinsic_variant_count(void* l0, void* l1) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args)->length;
    if (t0 != INT64_C(1)) {
        t1 = vader_comptime_arg_count_error(l0, 2362u, (size_t) (int64_t) INT64_C(1));
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_toolchain_ast_IntrinsicCallExpr_t*) l0)->f_args);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    ...
    l2 = vader_comptime_resolve_type_arg(t2, l1);
    if (l2.tag == 0u) {
        t1 = vader_comptime_arg_error(l0, 2363u);
        { void* __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static bool vader_comptime_is_concrete_enough(vader_box_t l0) {
    if ((l0.tag == 907u || l0.tag == 908u || l0.tag == 909u || l0.tag == 913u || l0.tag == 920u)) {
        return false;
    }
    return true;
}
...
static void* vader_comptime_new_evaluated_program(void* l0) {
    ...
    vader_obj_header_init(_a4_obj, 673u);
    _a4_obj->f_typed = l0;
...
static void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l2 = (void*) _a7_obj;
    vader_array_t* _a8_arr = vader_array_new(15u, 0u, 4u, 173u);
    l3 = (void*) _a8_arr;
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(49u, 0u, 13u, 676u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(50u, 0u, 13u, 686u);
    l5 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a14_obj, 674u);
    _a14_obj->f_typed = l0;
...
static void* vader_comptime_normalize_int_result(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_comptime_EvalResult_t*) l0)->f_value.tag == 678u) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_71: {
            if ((l4 < l3)) {
                ...
                l6 = l7.payload.obj;
                vader_array_t* _a2_arr = vader_array_new(15u, 0u, 4u, 173u);
                l8 = (void*) _a2_arr;
...
static bool vader_comptime_symbol_defines_span(void* l0, void* l1) {
    ...
    if (((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_defined_at.tag == 472u) {
...
static void* vader_comptime_topo_sort(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 395u);
    l1 = (void*) _a0_arr;
    ...
    vader_obj_header_init(_a5_obj, 368u);
    _a5_obj->f_ekeys = l3;
    _a5_obj->f_evals = l4;
    _a5_obj->f_index = l5;
    _a5_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_array_t* _a6_arr = vader_array_new(15u, 0u, 4u, 173u);
    l4 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(6u, 0u, 12u, 161u);
    l5 = (void*) _a7_arr;
...
static void* vader_comptime_unary_bit_not(void* l0, vader_box_t l1) {
    ...
    t2 = vader_comptime_unary_type_mismatch(l0, 1125u);
    { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_unary_neg(void* l0, vader_box_t l1) {
    ...
    t2 = vader_comptime_unary_type_mismatch(l0, 1048u);
    { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* vader_comptime_unary_not(void* l0, vader_box_t l1) {
    ...
    t0 = vader_comptime_unary_type_mismatch(l0, 1026u);
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
