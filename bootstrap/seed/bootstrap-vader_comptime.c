...
static void vader_comptime_bake_file_exprs(void* l0, void* l1, void* l2, void* l3, void* l4) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(28u, 0u, 13u, 434u);
    l5 = (void*) _a0_arr;
    l6 = l0;
...
static void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    if (((vader_obj_header_t*) l2)->type_index == 423u) {
        ...
        if (l4) {
            ...
            vader_obj_header_init(_a5_obj, 279u);
            _a5_obj->f_ekeys = l19;
            _a5_obj->f_evals = l20;
            _a5_obj->f_index = l21;
            _a5_obj->f_mask = l22;
    ...
    vader_obj_header_init(_a25_obj, 279u);
...
static void* vader_comptime_evaluate_seq_lit(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(126u, 0u, 13u, 1118u);
    l3 = (void*) _a0_arr;
    ...
    if (l8.tag == 923u) {
        ...
        vader_obj_header_init(_a6_obj, 317u);
        _a6_obj->f_ekeys = l4;
        _a6_obj->f_evals = l7;
        _a6_obj->f_index = l9;
...
static void* vader_comptime_harvest_instances(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(50u, 0u, 13u, 683u);
    l2 = (void*) _a4_arr;
...
static void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(50u, 0u, 13u, 683u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(51u, 0u, 13u, 693u);
    l5 = (void*) _a13_arr;
