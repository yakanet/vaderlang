...
static vader_string_t vader_bytecode_bare_intern_name(vader_box_t l0) {
    ...
    } else if ((l0.tag == 959u || l0.tag == 960u || l0.tag == 962u || l0.tag == 970u || l0.tag == 971u || l0.tag == 972u || l0.tag == 975u)) {
        l1 = 0u;
    } else {
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 489u) {
        ...
        l3 = (size_t) 0;
        l3 = std_core_write_string_at(l8, l3, 1842u);
        t1 = l6.payload.obj;
        ...
        l7 = concat_4(1443u, l10, 225u, l12);
    } else {
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 972u) {
        ...
        while ((l6 < l5)) {
            ...
            l8 = (size_t) 0;
            l8 = std_core_write_string_at(l4, l8, 716u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        l2 = vader_bytecode_arith_op(l1, 1039u);
    } else if (l0 == INT32_C(1)) {
        l2 = vader_bytecode_arith_op(l1, 2043u);
    } else if (l0 == INT32_C(2)) {
        l2 = vader_bytecode_arith_op(l1, 1784u);
    } else if (l0 == INT32_C(3)) {
        ...
        l2 = vader_bytecode_bit_op(l1, 1057u);
    } else if (l0 == INT32_C(8)) {
        l2 = vader_bytecode_bit_op(l1, 1835u);
    } else if (l0 == INT32_C(9)) {
        l2 = vader_bytecode_bit_op(l1, 2366u);
    } else if (l0 == INT32_C(10)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a31_arr = vader_array_new(138u, 0u, 13u, 1152u);
    l5 = (void*) _a31_arr;
    l1 = (size_t) 0;
    while ((l1 < l4)) {
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1335u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
}
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(138u, 0u, 13u, 1152u);
    l15 = (void*) _a10_arr;
...
static void* vader_bytecode_find_loop_ranges(void* l0) {
    ...
    while ((l6 < l5)) {
        ...
        if (l7.tag == 501u) {
            ...
            vader_bytecode_push_scope(l2, l3, l4, 1142u, l8);
            t0 = (l4 + INT64_C(1));
            l4 = (size_t) (int64_t) t0;
        } else if (l7.tag == 599u) {
            l9 = ((int32_t) (size_t) l6);
            vader_bytecode_push_scope(l2, l3, l4, 1725u, l9);
            t0 = (l4 + INT64_C(1));
            l4 = (size_t) (int64_t) t0;
        } else if (l7.tag == 586u) {
            l10 = ((int32_t) (size_t) l6);
            vader_bytecode_push_scope(l2, l3, l4, 1586u, l10);
            t0 = (l4 + INT64_C(1));
            l4 = (size_t) (int64_t) t0;
        } else if (l7.tag == 529u) {
            if ((l4 > INT64_C(0))) {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1372u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2010u, 451u, 1122u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) 5; }
    }
    l1 = vader_bytecode_primitive_member_mangle(2010u, 441u, 1528u);
    if (l0 == l1) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(141u, 0u, 13u, 1162u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 489u);
    ...
    l1 = (void*) _a5_obj;
    std_collections_MutableMap_IndexSet_set_at__string__i32(l1, 1817u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 968u);
    _a10_obj->f_name = 1817u;
    t0 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 968u);
    _a11_obj->f_name = 1817u;
    t0 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(156u, 1u, 13u, 1307u);
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1039u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2043u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1784u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_6(1959u, l0, 155u, l1, 155u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(138u, 0u, 13u, 1152u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(143u, 0u, 13u, 1185u);
    l4 = (void*) _a27_arr;
    vader_array_t* _a28_arr = vader_array_new(9u, 0u, 7u, 193u);
    l5 = (void*) _a28_arr;
    l1 = (size_t) 0;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a16_arr = vader_array_new(9u, 0u, 7u, 193u);
    l2 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(141u, 0u, 13u, 1162u);
    l3 = (void*) _a17_arr;
    l5 = (size_t) 0;
    while ((l5 < l4)) {
    ...
    vader_array_t* _a19_arr = vader_array_new(141u, 0u, 13u, 1162u);
    l1 = (void*) _a19_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) 0;
    while ((l5 < l4)) {
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 4u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(143u, 1u, 13u, 1185u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(138u, 0u, 13u, 1152u);
    l20 = (void*) _a7_arr;
    l4 = (size_t) 0;
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 193u);
    l21 = (void*) _a8_arr;
...
static bool vader_bytecode_same_intern_class(vader_box_t l0, vader_box_t l1) {
    ...
    if ((l0.tag == 961u || l0.tag == 968u)) {
        l4 = true;
    } else {
        l4 = (l1.tag == 961u || l1.tag == 968u);
    }
    if (l4) {
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 1959u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(1959u);
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = (size_t) 0;
        l2 = std_core_write_string_at(l1, l2, 1582u);
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_id;
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 716u);
    ...
    l3 = std_core_write_string_at(l6, l3, 716u);
...
uint64_t vader_bytecode_type_intern_hash(vader_box_t l0) {
    ...
    if (l0.tag == 968u) {
        ...
        l1 = vader_bytecode_bare_hash(367u);
    } else if ((l0.tag == 963u || l0.tag == 964u || l0.tag == 965u || l0.tag == 966u || l0.tag == 969u || l0.tag == 973u || l0.tag == 974u || l0.tag == 976u)) {
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 968u) {
        ...
        t0 = l0.payload.obj;
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2378u);
        l1 = concat_5(580u, l2, 328u, l3, 348u);
    } else if (l0.tag == 971u) {
        t0 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) t0)->f_symbol);
        t0 = l0.payload.obj;
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2378u);
        l1 = concat_5(662u, l2, 328u, l3, 348u);
    } else if (l0.tag == 961u) {
        t0 = l0.payload.obj;
        l1 = ((vader_struct_vader_types_EnumType_t*) t0)->f_repr;
    } else if (l0.tag == 960u) {
        ...
        l1 = concat_3(369u, l2, 348u);
    } else if (l0.tag == 975u) {
        t0 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2378u);
        l1 = concat_3(669u, l2, 348u);
    } else if (l0.tag == 972u) {
        t0 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2378u);
        l1 = concat_3(664u, l2, 348u);
    } else if (l0.tag == 962u) {
        t0 = l0.payload.obj;
