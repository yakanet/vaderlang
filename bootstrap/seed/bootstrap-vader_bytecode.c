...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 514u) {
        ...
        l3 = std_core_write_string_at(l8, l3, 2005u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    if (l0 == INT32_C(0)) {
        ...
        if (l0 == INT32_C(1)) {
            ...
            if (l0 == INT32_C(2)) {
                l2 = vader_bytecode_arith_op(l1, 1955u);
            } else {
                if (l0 == INT32_C(3)) {
                        ...
                        if (l0 == INT32_C(5)) {
                            ...
                            if (l0 == INT32_C(6)) {
                                ...
                                if (l0 == INT32_C(7)) {
                                    ...
                                    if (l0 == INT32_C(8)) {
                                        l2 = vader_bytecode_bit_op(l1, 1999u);
                                    } else {
                                        if (l0 == INT32_C(9)) {
            ...
            if ((l6 < l5)) {
                ...
                if (l7.tag == 526u) {
                    ...
                    if (l7.tag == 624u) {
                        ...
                        vader_bytecode_push_scope(l2, l3, l4, 1897u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 611u) {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1983u; }
    }
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_MutableMap_IndexSet_set_at__string__i32(l1, 1984u, INT32_C(0));
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1955u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_6(2118u, l0, 259u, l1, 259u, l2);
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2118u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2118u);
