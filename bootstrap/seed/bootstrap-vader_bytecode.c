...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 507u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1932u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1169u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2127u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1886u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1185u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1926u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2416u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a31_arr = vader_array_new(121u, 0u, 13u, 1084u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_convert_target_of(uint8_t l0) {
    if (l0 == INT32_C(0)) {
        return vader_box_i32(172u, INT32_C(0));
    }
    if (l0 == INT32_C(1)) {
        return vader_box_i32(172u, INT32_C(0));
    }
    ...
    if (l0 == INT32_C(3)) {
        return vader_box_i32(172u, INT32_C(1));
    }
    if (l0 == INT32_C(8)) {
        return vader_box_i32(172u, INT32_C(1));
    }
    ...
    if (l0 == INT32_C(10)) {
        return vader_box_i32(172u, INT32_C(2));
    }
    if (l0 == INT32_C(11)) {
        return vader_box_i32(172u, INT32_C(2));
    }
    if (l0 == INT32_C(13)) {
        return vader_box_i32(172u, INT32_C(3));
    }
    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1448u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(121u, 0u, 13u, 1084u);
    l15 = (void*) _a10_arr;
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 519u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1265u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 617u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1830u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 604u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1694u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 547u) {
    ...
    l6 = INT32_C(0);
    {
        loop_38: {
            if ((l6 < INT32_C(16))) {
                ...
                l3 = (size_t) (int64_t) t1;
                l8 = vader_string_slice_codepoints(451u, l2, l3);
                l5 = concat_2(l5, l8);
                l6 = (l6 + INT32_C(1));
                goto loop_38;
            } else {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1911u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2095u, 616u, 1247u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(5); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2095u, 607u, 1638u);
    if (l0 == l1) {
...
static bool vader_bytecode_is_display_to_string(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 1u, 0u, gc_roots, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 247u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1912u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 360u);
    _a10_obj->f_ekeys = l3;
    _a10_obj->f_evals = l4;
    _a10_obj->f_index = l5;
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 502u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 312u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    l5 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(8u, 0u, 0u, 169u);
    l6 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a19_obj, 360u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(39u, 0u, 13u, 503u);
    l7 = (void*) _a20_arr;
    ...
    vader_obj_header_init(_a24_obj, 312u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    l8 = (void*) _a24_obj;
    vader_array_t* _a25_arr = vader_array_new(8u, 0u, 0u, 169u);
    l9 = (void*) _a25_arr;
    ...
    vader_obj_header_init(_a28_obj, 360u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(36u, 0u, 13u, 499u);
    l10 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 172u);
    l11 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 172u);
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(16u, 0u, 0u, 180u);
    l13 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a34_obj, 285u);
    ...
    vader_obj_header_init(_a35_obj, 546u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 244u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1169u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2127u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1886u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l1 = vader_bytecode_strip_core_member(l0, 248u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
        l2 = vader_types_is_numeric_name(t0);
    } else {
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2046u, 243u, l0, 243u, l1, 243u, l2);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(121u, 0u, 13u, 1084u);
    l19 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 172u);
    l20 = (void*) _a8_arr;
...
static vader_box_t vader_bytecode_slot_width_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(14)) {
        return vader_box_i32(172u, INT32_C(4));
    }
    if (l0 == INT32_C(15)) {
        return vader_box_i32(172u, INT32_C(4));
    }
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2047u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2047u);
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(121u, 0u, 13u, 1084u);
    l6 = (void*) _a1_arr;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1690u);
        ...
        if (l4.tag == 569u) {
            ...
            if (l5.tag == 589u) {
                if (l4.tag == 589u) {
                    ...
                    if (l0.tag == 603u) {
                        t2 = l5.payload.obj;
                        l10 = ((vader_struct_vader_bytecode_I64Const_t*) t2)->f_value;
                        t2 = l4.payload.obj;
                        l11 = ((vader_struct_vader_bytecode_I64Const_t*) t2)->f_value;
                        ...
                        _a5_obj->f_value = (l10 - l11);
                        t2 = (void*) _a5_obj;
                        { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
                    }
                    if (l0.tag == 597u) {
                        t2 = l5.payload.obj;
                        l12 = ((vader_struct_vader_bytecode_I64Const_t*) t2)->f_value;
                        t2 = l4.payload.obj;
                        l13 = ((vader_struct_vader_bytecode_I64Const_t*) t2)->f_value;
        ...
        if (l5.tag == 589u) {
            if (l4.tag == 589u) {
                ...
                if (l0.tag == 597u) {
                    ...
                    vader_obj_header_init(_a9_obj, 589u);
                    _a9_obj->f_value = (l12 * l13);
                    t2 = (void*) _a9_obj;
                    { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
                }
                t0 = vader_box_obj(0u, NULL);
    ...
    if (l5.tag == 589u) {
        if (l4.tag == 589u) {
            if (l0.tag == 584u) {
                ...
                vader_obj_header_init(_a10_obj, 589u);
                _a10_obj->f_value = (l8 + l9);
                t2 = (void*) _a10_obj;
                { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
            }
            if (l0.tag == 603u) {
                ...
                vader_obj_header_init(_a11_obj, 589u);
                _a11_obj->f_value = (l10 - l11);
                t2 = (void*) _a11_obj;
                { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
            }
            if (l0.tag == 597u) {
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 927u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_symbol_key(((vader_struct_vader_types_StructType_t*) t0)->f_symbol);
        t0 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2427u);
        t1 = concat_5(740u, l1, 501u, l2, 520u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 928u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) t0)->f_symbol);
        t0 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2427u);
        t1 = concat_5(816u, l1, 501u, l2, 520u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 918u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 916u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_type_intern_key(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
        t1 = concat_3(540u, l1, 520u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 932u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2427u);
        t1 = concat_3(822u, l1, 520u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 929u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2427u);
        t1 = concat_3(818u, l1, 520u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 919u) {
        t0 = l0.payload.obj;
        l1 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) t0)->f_params, 367u);
        t0 = l0.payload.obj;
        l2 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) t0)->f_return_type);
        t1 = concat_4(602u, l1, 349u, l2);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 931u) {
        t0 = l0.payload.obj;
