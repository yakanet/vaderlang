...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 536u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l1 == 2115u) {
        ...
        vader_obj_header_init(_a9_obj, 567u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1844u) {
        ...
        vader_obj_header_init(_a10_obj, 561u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a11_obj, 554u);
    t1 = (void*) _a11_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 493u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1887u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 911u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(36u, 0u, 13u, 486u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    vader_obj_header_init(_a13_obj, 486u);
                    _a13_obj->f_name = l11;
        ...
        l5 = std_core_write_string_at(l3, l5, 881u);
        ...
        vader_obj_header_init(_a14_obj, 497u);
        _a14_obj->f_name = l11;
    ...
    if (l0.tag == 912u) {
        ...
        vader_obj_header_init(_a16_obj, 494u);
    ...
    if (l0.tag == 908u) {
        ...
        vader_obj_header_init(_a17_obj, 494u);
    ...
    if (l0.tag == 915u) {
        ...
        vader_obj_header_init(_a18_obj, 494u);
    ...
    if (l0.tag == 904u) {
        ...
        vader_obj_header_init(_a19_obj, 494u);
    ...
    if (l0.tag == 902u) {
        ...
        vader_obj_header_init(_a20_obj, 494u);
    ...
    if (l0.tag == 903u) {
        ...
        vader_obj_header_init(_a21_obj, 494u);
    ...
    if (l0.tag == 905u) {
        ...
        vader_obj_header_init(_a22_obj, 494u);
    ...
    if (l0.tag == 897u) {
        ...
        vader_obj_header_init(_a23_obj, 494u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1147u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2115u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1844u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1162u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1881u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2409u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (l1 == 1881u) {
        ...
        vader_obj_header_init(_a4_obj, 551u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 552u);
    t1 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 606u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 555u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 611u);
    l5 = (void*) _a0_arr;
            ...
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a9_obj, 611u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 611u);
    ...
    vader_array_t* _a14_arr = vader_array_new(39u, 0u, 13u, 490u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(41u, 0u, 13u, 611u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
        ...
        loop_269: {
            if ((l7 < l2)) {
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 611u);
    ...
    vader_array_t* _a31_arr = vader_array_new(117u, 0u, 13u, 1059u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 488u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 507u || l0.tag == 522u || l0.tag == 535u || l0.tag == 553u || l0.tag == 573u || l0.tag == 604u || l0.tag == 619u)) {
        return l0;
    }
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1416u);
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(117u, 0u, 13u, 1059u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 599u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a15_obj, 528u);
                        l18 = (void*) _a15_obj;
                        ...
                        vader_obj_header_init(_a18_obj, 599u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 600u) {
                    ...
                    vader_obj_header_init(_a22_obj, 600u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 598u) {
                    ...
                    vader_obj_header_init(_a25_obj, 598u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 597u) {
                    ...
                    vader_obj_header_init(_a28_obj, 597u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 490u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
    ...
    vader_obj_header_init(_a33_obj, 488u);
    _a33_obj->f_name = l36;
                            ...
                            if ((l9 < l8)) {
                                ...
                                if (l13) {
                                    ...
                                    if ((l20 < l21)) {
                                        ...
                                        vader_obj_header_init(_a4_obj, 611u);
                                        _a4_obj->f_first = l22;
                                        _a4_obj->f_last = l23;
                                        l6 = (void*) _a4_obj;
                                        l4 = true;
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 505u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1240u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 601u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1790u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 588u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1656u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 532u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1790u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 611u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2083u, 619u, 1223u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(19); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2083u, 610u, 1601u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2021u) {
        ...
        vader_obj_header_init(_a10_obj, 533u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2027u) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1868u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 349u);
    _a10_obj->f_ekeys = l3;
    _a10_obj->f_evals = l4;
    _a10_obj->f_index = l5;
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 488u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 300u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    vader_obj_header_init(_a19_obj, 349u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(38u, 0u, 13u, 489u);
    l7 = (void*) _a20_arr;
    ...
    vader_obj_header_init(_a24_obj, 300u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    vader_obj_header_init(_a28_obj, 349u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(35u, 0u, 13u, 485u);
    l10 = (void*) _a29_arr;
    ...
    vader_obj_header_init(_a34_obj, 274u);
    ...
    vader_obj_header_init(_a35_obj, 531u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1147u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2115u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1844u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2010u, 260u, l0, 260u, l1, 260u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_obj_header_init(_a18_obj, 272u);
    ...
    vader_array_t* _a26_arr = vader_array_new(117u, 0u, 13u, 1059u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(121u, 0u, 13u, 1083u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_struct___Tuple_1263_t _a10_storage = {0};
    vader_struct___Tuple_1264_t _a56_storage = {0};
    vader_struct___Tuple_1265_t _a65_storage = {0};
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                l12 = t3.payload.b;
                vader_struct___Tuple_1263_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 222u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
                l10 = ((vader_struct___Tuple_1263_t*) t2)->f__0;
                t1 = (l11 + INT64_C(1));
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a20_obj, 349u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_obj_header_init(_a29_obj, 300u);
    _a29_obj->f_ekeys = l5;
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(37u, 0u, 13u, 488u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 519u) {
                                ...
                                vader_obj_header_init(_a38_obj, 519u);
                            ...
                            if (l19.tag == 547u) {
                                ...
                                vader_obj_header_init(_a41_obj, 547u);
                            ...
                            if (l19.tag == 602u) {
                                ...
                                vader_obj_header_init(_a44_obj, 602u);
    ...
    vader_array_t* _a46_arr = vader_array_new(35u, 0u, 13u, 485u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
    ...
    vader_obj_header_init(_a53_obj, 300u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_890: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1264_t* _a57_obj = &_a56_storage;
                vader_obj_header_init(_a57_obj, 223u);
                _a57_obj->f__0 = l8;
                _a57_obj->f__1 = l10;
                l5 = (void*) _a57_obj;
                l20 = ((vader_struct___Tuple_1264_t*) l5)->f__0;
                l24 = ((vader_struct___Tuple_1264_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a62_obj, 349u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1265_t* _a66_obj = &_a65_storage;
                vader_obj_header_init(_a66_obj, 224u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
                l34 = ((vader_struct___Tuple_1265_t*) l5)->f__0;
                l10 = ((vader_struct___Tuple_1265_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a71_obj, 274u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1266_t* _a74_obj = (vader_struct___Tuple_1266_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1266_t));
                vader_obj_header_init(_a74_obj, 225u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
                l10 = ((vader_struct___Tuple_1266_t*) l27)->f__0;
                l28 = ((vader_struct___Tuple_1266_t*) l27)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_82: {
            if ((l5 < l4)) {
                vader_array_t* _a6_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports);
                if (_a6_slotarr->buf != NULL && _a6_slotarr->buf->header.forward != NULL) { _a6_slotarr->buf = vader_array_buf_forward(_a6_slotarr->buf); }
                ...
                t2 = ((vader_struct_vader_bytecode_BcImport_t*) t0)->f_vm_callable;
                if (t2) {
    ...
    vader_array_t* _a7_arr = vader_array_new(9u, 0u, 7u, 164u);
    l2 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(38u, 0u, 13u, 489u);
    l3 = (void*) _a8_arr;
    l4 = ((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_133: {
            if ((l5 < l4)) {
                l9 = ((int32_t) (size_t) l5);
                t3 = std_collections_get__i32__bool(l1, l9);
                if (t3.tag == 159u) {
                    t4 = ((vader_array_t*) l3)->length;
                    l10 = ((int32_t) (size_t) t4);
                    vader_array_push_i32((vader_array_t*) l2, l10);
                    vader_array_t* _a9_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports);
                    if (_a9_slotarr->buf != NULL && _a9_slotarr->buf->header.forward != NULL) { _a9_slotarr->buf = vader_array_buf_forward(_a9_slotarr->buf); }
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_184: {
            if ((l5 < l4)) {
                ...
                l11 = vader_array_ref_load_obj(_a10_slotarr->buf, _a10_slotarr->offset + (size_t) l5);
                l6 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l11)->f_body)->length;
                l7 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_199: {
                        if ((l7 < l6)) {
                            vader_array_t* _a11_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l11)->f_body);
                            if (_a11_slotarr->buf != NULL && _a11_slotarr->buf->header.forward != NULL) { _a11_slotarr->buf = vader_array_buf_forward(_a11_slotarr->buf); }
                            if ((size_t) l7 >= _a11_slotarr->length) { vader_trap("array index out of bounds"); }
                            l8 = vader_array_ref_load_box(_a11_slotarr->buf, _a11_slotarr->offset + (size_t) l7);
                            if (l8.tag == 520u) {
                                l13 = l8.payload.obj;
                                l14 = ((vader_struct_vader_bytecode_BcFunction_t*) l11)->f_body;
                                t5 = ((vader_struct_vader_bytecode_CallImport_t*) l13)->f_index;
                                t1 = ((int64_t) (int32_t) t5);
                                l15 = (size_t) (int64_t) t1;
                                vader_array_t* _a12_slotarr = ((vader_array_t*) l2);
                                if (_a12_slotarr->buf != NULL && _a12_slotarr->buf->header.forward != NULL) { _a12_slotarr->buf = vader_array_buf_forward(_a12_slotarr->buf); }
                                if ((size_t) l15 >= _a12_slotarr->length) { vader_trap("array index out of bounds"); }
                                t5 = ((int32_t*) _a12_slotarr->buf->slots)[_a12_slotarr->offset + (size_t) l15];
                                vader_struct_vader_bytecode_CallImport_t* _a13_obj = (vader_struct_vader_bytecode_CallImport_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_CallImport_t));
                                vader_obj_header_init(_a13_obj, 520u);
                                _a13_obj->f_index = t5;
                                l16 = (void*) _a13_obj;
                                vader_array_t* _a14_slotarr = ((vader_array_t*) l14);
                                if (_a14_slotarr->buf != NULL && _a14_slotarr->buf->header.forward != NULL) { _a14_slotarr->buf = vader_array_buf_forward(_a14_slotarr->buf); }
                                if ((size_t) l7 >= _a14_slotarr->length) { vader_trap("array index out of bounds"); }
                                vader_array_ref_store(_a14_slotarr->buf, _a14_slotarr->offset + (size_t) l7, l16);
                                VADER_WRITE_BARRIER(_a14_slotarr->buf);
                            } else {
                            }
                            t1 = (l7 + INT64_C(1));
                            l7 = (size_t) (int64_t) t1;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_struct___Tuple_1266_t _a14_storage = {0};
    vader_struct___Tuple_1265_t _a40_storage = {0};
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1266_t* _a15_obj = &_a14_storage;
                vader_obj_header_init(_a15_obj, 225u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
                l12 = ((vader_struct___Tuple_1266_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 164u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 497u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(36u, 0u, 13u, 486u);
                    l8 = (void*) _a23_arr;
                    ...
                    vader_obj_header_init(_a26_obj, 497u);
                    _a26_obj->f_name = l20;
                    ...
                    if (l16.tag == 498u) {
                        ...
                        vader_obj_header_init(_a29_obj, 498u);
                        ...
                        if (l16.tag == 484u) {
                            ...
                            if (l16.tag == 487u) {
                                ...
                                vader_obj_header_init(_a33_obj, 487u);
    ...
    vader_obj_header_init(_a37_obj, 349u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_615: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1265_t* _a41_obj = &_a40_storage;
                vader_obj_header_init(_a41_obj, 224u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l20 = ((vader_struct___Tuple_1265_t*) l3)->f__0;
                l11 = ((vader_struct___Tuple_1265_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_671: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a45_obj, 495u);
    ...
    vader_array_t* _a48_arr = vader_array_new(38u, 0u, 13u, 489u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_800: {
            if ((l5 < l4)) {
                ...
                l45 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_vm_callable;
                ...
                vader_obj_header_init(_a53_obj, 489u);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(121u, 1u, 13u, 1083u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 626u) {
        ...
        vader_obj_header_init(_a7_obj, 626u);
    ...
    if (l0.tag == 627u) {
        ...
        vader_obj_header_init(_a8_obj, 627u);
    ...
    if (l0.tag == 521u) {
        ...
        vader_obj_header_init(_a9_obj, 521u);
    ...
    if (l0.tag == 602u) {
        ...
        vader_obj_header_init(_a10_obj, 602u);
    ...
    if (l0.tag == 547u) {
        ...
        vader_obj_header_init(_a11_obj, 547u);
    ...
    if (l0.tag == 605u) {
        ...
        vader_obj_header_init(_a14_obj, 605u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(117u, 0u, 13u, 1059u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 164u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 598u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (!(l26)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 600u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 608u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 609u);
                                        ...
                                        if (l9.tag == 510u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 507u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 507u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 510u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 507u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 507u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 510u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 507u) {
                                            ...
                                            vader_obj_header_init(_a40_obj, 507u);
                                            _a40_obj->f_value = !(t5);
                                            l47 = (void*) _a40_obj;
                            ...
                            if (l9.tag == 608u) {
                                ...
                                if ((l20 > l30)) {
                                    ...
                                    if (!(l33.tag == 0u)) {
                                        ...
                                        vader_obj_header_init(_a47_obj, 609u);
                                ...
                                if (l9.tag == 510u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 507u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 507u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 510u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 507u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 507u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 608u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 609u);
                                ...
                                if (l9.tag == 510u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 507u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 507u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 510u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 507u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 507u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 510u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 507u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 507u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 608u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 609u);
                            ...
                            if (l9.tag == 510u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 507u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 507u);
                        ...
                        if (l9.tag == 510u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 507u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 507u);
                    ...
                    if (l9.tag == 510u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 507u) {
                                ...
                                vader_obj_header_init(_a124_obj, 507u);
                ...
                if (l9.tag == 608u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 609u);
                        ...
                        if (l9.tag == 510u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 507u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 507u);
                    ...
                    if (l9.tag == 510u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 507u) {
                                ...
                                vader_obj_header_init(_a144_obj, 507u);
                ...
                if (l9.tag == 510u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 507u) {
                            ...
                            vader_obj_header_init(_a152_obj, 507u);
    ...
    vader_obj_header_init(_a159_obj, 491u);
    _a159_obj->f_body = l1;
...
void* vader_bytecode_run_bc_return_lit_fold(void* l0) {
    ...
    vader_obj_header_init(_a11_obj, 491u);
    _a11_obj->f_body = l1;
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2011u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2011u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(117u, 0u, 13u, 1059u);
    l6 = (void*) _a1_arr;
    ...
    vader_obj_header_init(_a10_obj, 491u);
    _a10_obj->f_body = l6;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1653u);
    ...
    if (l5.tag == 553u) {
        ...
        if (l4.tag == 553u) {
            ...
            if (l0.tag == 561u) {
                ...
                vader_obj_header_init(_a3_obj, 553u);
            ...
            if (l5.tag == 573u) {
                ...
                if (l4.tag == 573u) {
                    ...
                    if (l0.tag == 581u) {
                        ...
                        vader_obj_header_init(_a6_obj, 573u);
        ...
        if (l5.tag == 573u) {
            ...
            if (l4.tag == 573u) {
                ...
                if (l0.tag == 581u) {
                    ...
                    vader_obj_header_init(_a9_obj, 573u);
    ...
    if (l5.tag == 573u) {
        ...
        if (l4.tag == 573u) {
            ...
            if (l0.tag == 587u) {
                ...
                vader_obj_header_init(_a11_obj, 573u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 909u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2420u);
        t1 = concat_5(740u, l2, 504u, l3, 523u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 910u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) l1)->f_symbol);
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2420u);
        t1 = concat_5(815u, l2, 504u, l3, 523u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 900u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 914u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2420u);
        t1 = concat_3(821u, l2, 523u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 911u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2420u);
        t1 = concat_3(817u, l2, 523u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 901u) {
        l1 = l0.payload.obj;
