...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 509u; }
    }
    t0 = ((int64_t) (int32_t) l1);
    l3 = (size_t) (int64_t) t0;
    ...
    if (l5.tag == 501u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1848u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 922u) {
        ...
        vader_obj_header_init(_a7_obj, 506u);
    ...
    if (l0.tag == 919u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(36u, 0u, 13u, 494u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    l9 = std_core_write_string_at(l8, l9, 840u);
        ...
        l5 = std_core_write_string_at(l3, l5, 856u);
    ...
    if (l0.tag == 921u) {
        ...
        vader_obj_header_init(_a15_obj, 502u);
    ...
    if (l0.tag == 916u) {
        ...
        vader_obj_header_init(_a17_obj, 502u);
    ...
    if (l0.tag == 923u) {
        ...
        vader_obj_header_init(_a18_obj, 502u);
    ...
    if (l0.tag == 912u) {
        ...
        vader_obj_header_init(_a19_obj, 502u);
    ...
    if (l0.tag == 910u) {
        ...
        vader_obj_header_init(_a20_obj, 502u);
    ...
    if (l0.tag == 911u) {
        ...
        vader_obj_header_init(_a21_obj, 502u);
    ...
    if (l0.tag == 913u) {
        ...
        vader_obj_header_init(_a22_obj, 502u);
    ...
    if (l0.tag == 905u) {
        ...
        vader_obj_header_init(_a23_obj, 502u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1112u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2089u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1805u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1127u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1842u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2381u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
    ...
    if (l0 == INT32_C(11)) {
        ...
        vader_obj_header_init(_a1_obj, 519u);
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(12)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 619u);
    l5 = (void*) _a0_arr;
    ...
    vader_array_t* _a14_arr = vader_array_new(39u, 0u, 13u, 498u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(41u, 0u, 13u, 619u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    vader_array_t* _a31_arr = vader_array_new(116u, 0u, 13u, 1066u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 496u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 515u || l0.tag == 530u || l0.tag == 543u || l0.tag == 561u || l0.tag == 581u || l0.tag == 612u || l0.tag == 627u)) {
        return l0;
    }
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1378u);
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(116u, 0u, 13u, 1066u);
    l8 = (void*) _a10_arr;
    ...
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 498u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 513u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1205u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 609u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1751u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 596u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1617u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 540u) {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1415u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1828u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    if (l0 == 2336u) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(58); }
    }
    if (l0 == 2337u) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(59); }
    }
    if (l0 == 2334u) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(60); }
    }
    if (l0 == 2335u) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(61); }
    }
    if (l0 == 2333u) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(62); }
    }
    if (l0 == 2007u) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2057u, 599u, 1188u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(20); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2057u, 590u, 1562u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 1990u) {
        ...
        vader_obj_header_init(_a9_obj, 512u);
        t0 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1983u) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1829u, INT32_C(0));
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 496u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 308u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    vader_obj_header_init(_a19_obj, 357u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(38u, 0u, 13u, 497u);
    l7 = (void*) _a20_arr;
    ...
    vader_obj_header_init(_a24_obj, 308u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    vader_obj_header_init(_a28_obj, 357u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(35u, 0u, 13u, 493u);
    l10 = (void*) _a29_arr;
...
static vader_box_t vader_bytecode_parse_val_type(vader_string_t l0) {
    ...
    if (l0 == 1130u) {
        t0 = vader_box_i32(167u, INT32_C(19));
        return t0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1112u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2089u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1805u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = concat_7(1972u, 259u, l0, 259u, l1, 259u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(116u, 0u, 13u, 1066u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(120u, 0u, 13u, 1090u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_struct___Tuple_1271_t _a10_storage = {0};
    vader_struct___Tuple_1272_t _a56_storage = {0};
    vader_struct___Tuple_1273_t _a65_storage = {0};
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                l12 = t3.payload.b;
                vader_struct___Tuple_1271_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 222u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
                l10 = ((vader_struct___Tuple_1271_t*) t2)->f__0;
                t1 = (l11 + INT64_C(1));
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a20_obj, 357u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(37u, 0u, 13u, 496u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
    ...
    vader_array_t* _a46_arr = vader_array_new(35u, 0u, 13u, 493u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 493u);
    ...
    vader_obj_header_init(_a53_obj, 308u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_890: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1272_t* _a57_obj = &_a56_storage;
                vader_obj_header_init(_a57_obj, 223u);
                _a57_obj->f__0 = l8;
                _a57_obj->f__1 = l10;
                l5 = (void*) _a57_obj;
                l20 = ((vader_struct___Tuple_1272_t*) l5)->f__0;
                l24 = ((vader_struct___Tuple_1272_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a62_obj, 357u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1273_t* _a66_obj = &_a65_storage;
                vader_obj_header_init(_a66_obj, 224u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
                l34 = ((vader_struct___Tuple_1273_t*) l5)->f__0;
                l10 = ((vader_struct___Tuple_1273_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1274_t* _a74_obj = (vader_struct___Tuple_1274_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1274_t));
                vader_obj_header_init(_a74_obj, 225u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
                l10 = ((vader_struct___Tuple_1274_t*) l27)->f__0;
                l28 = ((vader_struct___Tuple_1274_t*) l27)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_struct___Tuple_1274_t _a14_storage = {0};
    vader_struct___Tuple_1273_t _a40_storage = {0};
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1274_t* _a15_obj = &_a14_storage;
                vader_obj_header_init(_a15_obj, 225u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
                l12 = ((vader_struct___Tuple_1274_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 164u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(118u, 0u, 13u, 1073u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(118u, 0u, 13u, 1073u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 505u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(36u, 0u, 13u, 494u);
                    l8 = (void*) _a23_arr;
                    ...
                    l10 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_395: {
                            if ((l10 < l9)) {
                                ...
                                vader_obj_header_init(_a25_obj, 494u);
                                _a25_obj->f_name = l18;
                    ...
                    vader_obj_header_init(_a26_obj, 505u);
                    _a26_obj->f_name = l20;
                    ...
                    if (l16.tag == 506u) {
                        ...
                        vader_obj_header_init(_a29_obj, 506u);
                        ...
                        if (l16.tag == 492u) {
                            ...
                            vader_obj_header_init(_a30_obj, 492u);
    ...
    vader_obj_header_init(_a37_obj, 357u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_611: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1273_t* _a41_obj = &_a40_storage;
                vader_obj_header_init(_a41_obj, 224u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l20 = ((vader_struct___Tuple_1273_t*) l3)->f__0;
                l11 = ((vader_struct___Tuple_1273_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_667: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a45_arr = vader_array_new(6u, 0u, 12u, 160u);
                l19 = (void*) _a45_arr;
                vader_struct_vader_bytecode_BcSignature_t* _a46_obj = (vader_struct_vader_bytecode_BcSignature_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcSignature_t));
                vader_obj_header_init(_a46_obj, 503u);
                _a46_obj->f_params = l12;
                _a46_obj->f_result = l41;
                _a46_obj->f_param_types = l6;
                _a46_obj->f_result_type = l25;
                _a46_obj->f_param_names = l17;
                _a46_obj->f_param_mutable = l19;
                l21 = (void*) _a46_obj;
                ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature = l21;
                ...
                l14 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_747: {
                        if ((l14 < l13)) {
                            l22 = ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_body;
                            vader_array_t* _a47_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_body);
                            if (_a47_slotarr->buf != NULL && _a47_slotarr->buf->header.forward != NULL) { _a47_slotarr->buf = vader_array_buf_forward(_a47_slotarr->buf); }
                            if ((size_t) l14 >= _a47_slotarr->length) { vader_trap("array index out of bounds"); }
                            t2 = vader_array_ref_load_box(_a47_slotarr->buf, _a47_slotarr->offset + (size_t) l14);
                            l16 = vader_bytecode_remap_type_in_op(t2, l2);
                            vader_array_t* _a48_slotarr = ((vader_array_t*) l22);
                            if (_a48_slotarr->buf != NULL && _a48_slotarr->buf->header.forward != NULL) { _a48_slotarr->buf = vader_array_buf_forward(_a48_slotarr->buf); }
                            if ((size_t) l14 >= _a48_slotarr->length) { vader_trap("array index out of bounds"); }
                            vader_array_ref_store(_a48_slotarr->buf, _a48_slotarr->offset + (size_t) l14, l16.payload.obj);
    ...
    vader_array_t* _a49_arr = vader_array_new(38u, 0u, 13u, 497u);
    l1 = (void*) _a49_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_791: {
            if ((l5 < l4)) {
                vader_array_t* _a50_slotarr = ((vader_array_t*) l3);
                if (_a50_slotarr->buf != NULL && _a50_slotarr->buf->header.forward != NULL) { _a50_slotarr->buf = vader_array_buf_forward(_a50_slotarr->buf); }
                if ((size_t) l5 >= _a50_slotarr->length) { vader_trap("array index out of bounds"); }
                l6 = vader_array_ref_load_obj(_a50_slotarr->buf, _a50_slotarr->offset + (size_t) l5);
                vader_array_t* _a51_arr = vader_array_new(9u, 0u, 7u, 164u);
                l8 = (void*) _a51_arr;
                ...
                l10 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_810: {
                        if ((l10 < l9)) {
                            vader_array_t* _a52_slotarr = ((vader_array_t*) l12);
                            ...
                            l7 = ((int32_t*) _a52_slotarr->buf->slots)[_a52_slotarr->offset + (size_t) l10];
                            l11 = vader_bytecode_remap_idx(l2, l7);
                ...
                l21 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_mutable;
                vader_struct_vader_bytecode_BcSignature_t* _a53_obj = (vader_struct_vader_bytecode_BcSignature_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcSignature_t));
                vader_obj_header_init(_a53_obj, 503u);
                _a53_obj->f_params = l17;
                _a53_obj->f_result = l41;
                _a53_obj->f_param_types = l8;
                _a53_obj->f_result_type = l25;
                _a53_obj->f_param_names = l19;
                _a53_obj->f_param_mutable = l21;
                l22 = (void*) _a53_obj;
                l42 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_is_extern;
                vader_struct_vader_bytecode_BcImport_t* _a54_obj = (vader_struct_vader_bytecode_BcImport_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcImport_t));
                vader_obj_header_init(_a54_obj, 497u);
                _a54_obj->f_extern_name = l18;
                _a54_obj->f_mangled_name = l20;
                _a54_obj->f_signature = l22;
                _a54_obj->f_is_extern = l42;
                l23 = (void*) _a54_obj;
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(120u, 1u, 13u, 1090u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 485u) {
        ...
        vader_obj_header_init(_a6_obj, 485u);
    ...
    if (l0.tag == 490u) {
        ...
        vader_obj_header_init(_a13_obj, 490u);
    ...
    if (l0.tag == 520u) {
        ...
        vader_obj_header_init(_a15_obj, 520u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(116u, 0u, 13u, 1066u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 164u);
    l14 = (void*) _a8_arr;
                                        ...
                                        if (l9.tag == 518u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 515u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 515u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 518u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 515u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 515u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 518u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 515u) {
                                            ...
                                            vader_obj_header_init(_a40_obj, 515u);
                                            _a40_obj->f_value = !(t5);
                                            l47 = (void*) _a40_obj;
                                    ...
                                    if (l9.tag == 518u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 515u) {
                                                ...
                                                vader_obj_header_init(_a52_obj, 515u);
                                                _a52_obj->f_value = !(t5);
                                                l47 = (void*) _a52_obj;
                                ...
                                if (l9.tag == 518u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 515u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 515u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 518u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 515u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 515u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                                ...
                                if (l9.tag == 518u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 515u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 515u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 518u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 515u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 515u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 518u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 515u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 515u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                            ...
                            if (l9.tag == 518u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 515u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 515u);
                        ...
                        if (l9.tag == 518u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 515u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 515u);
                    ...
                    if (l9.tag == 518u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 515u) {
                                ...
                                vader_obj_header_init(_a124_obj, 515u);
                        ...
                        if (l9.tag == 518u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 515u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 515u);
                    ...
                    if (l9.tag == 518u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 515u) {
                                ...
                                vader_obj_header_init(_a144_obj, 515u);
                ...
                if (l9.tag == 518u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 515u) {
                            ...
                            vader_obj_header_init(_a152_obj, 515u);
    ...
    vader_obj_header_init(_a159_obj, 499u);
    _a159_obj->f_body = l1;
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 1973u);
    if (!(t0)) {
        l2 = true;
    } else {
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(116u, 0u, 13u, 1066u);
    l6 = (void*) _a1_arr;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (l1.tag == 0u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l2, l3, 1614u);
    ...
    if (l1.tag == 476u) {
        ...
        l3 = std_core_write_string_at(l6, l3, 458u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2392u);
        t1 = concat_5(720u, l2, 486u, l3, 505u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 918u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) l1)->f_symbol);
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2392u);
        t1 = concat_5(794u, l2, 486u, l3, 505u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 908u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 906u) {
        ...
        t1 = concat_3(525u, l2, 505u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 922u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2392u);
        t1 = concat_3(800u, l2, 505u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 919u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2392u);
        t1 = concat_3(796u, l2, 505u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 909u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) l1)->f_params, 370u);
        l3 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) l1)->f_return_type);
        t1 = concat_4(587u, l2, 353u, l3);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 921u) {
        t0 = l0.payload.obj;
