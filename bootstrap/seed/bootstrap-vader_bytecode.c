...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 507u) {
        ...
        l9 = vader_bytecode_key_join(l0, l6, 2407u);
    ...
    if (l5.tag == 496u) {
        ...
        l9 = vader_bytecode_key_join(l0, l7, 2407u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2396u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(43u, 0u, 13u, 621u);
    l5 = (void*) _a0_arr;
    ...
    vader_array_t* _a14_arr = vader_array_new(41u, 0u, 13u, 499u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(43u, 0u, 13u, 621u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    vader_array_t* _a31_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 516u || l0.tag == 532u || l0.tag == 545u || l0.tag == 563u || l0.tag == 583u || l0.tag == 614u || l0.tag == 629u)) {
        return l0;
    }
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l8 = (void*) _a10_arr;
    ...
    vader_array_t* _a30_arr = vader_array_new(41u, 0u, 13u, 499u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(122u, 0u, 13u, 1079u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 502u);
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(39u, 0u, 13u, 497u);
    l4 = (void*) _a11_arr;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(40u, 0u, 13u, 498u);
    l7 = (void*) _a20_arr;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(37u, 0u, 13u, 494u);
    l10 = (void*) _a29_arr;
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(124u, 0u, 13u, 1096u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 497u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
    ...
    vader_array_t* _a46_arr = vader_array_new(37u, 0u, 13u, 494u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(40u, 0u, 13u, 498u);
    l3 = (void*) _a7_arr;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(122u, 0u, 13u, 1079u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(122u, 0u, 13u, 1079u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 506u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(38u, 0u, 13u, 495u);
                    l8 = (void*) _a23_arr;
    ...
    vader_array_t* _a48_arr = vader_array_new(40u, 0u, 13u, 498u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(124u, 1u, 13u, 1096u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 167u);
    l14 = (void*) _a8_arr;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(120u, 0u, 13u, 1072u);
    l6 = (void*) _a1_arr;
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 919u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2407u);
    ...
    if (l0.tag == 920u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2407u);
    ...
    if (l0.tag == 924u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2407u);
        t1 = concat_3(816u, l2, 517u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 921u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2407u);
