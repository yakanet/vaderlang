...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 544u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l1 == 1152u) {
        ...
        vader_obj_header_init(_a8_obj, 557u);
        t1 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 2113u) {
        ...
        vader_obj_header_init(_a9_obj, 576u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1852u) {
        ...
        vader_obj_header_init(_a10_obj, 570u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 526u; }
    }
    t0 = ((int64_t) (int32_t) l1);
    l3 = (size_t) (int64_t) t0;
    ...
    if (l5.tag == 500u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1896u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 909u) {
        ...
        vader_obj_header_init(_a1_obj, 500u);
        _a1_obj->f_val = t2;
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l0.tag == 919u) {
        ...
        vader_obj_header_init(_a3_obj, 501u);
    ...
    if (l0.tag == 910u) {
        ...
        vader_obj_header_init(_a10_obj, 494u);
    ...
    if (l0.tag == 920u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 493u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    l9 = std_core_write_string_at(l8, l9, 863u);
    ...
    if (l0.tag == 922u) {
        ...
        vader_obj_header_init(_a15_obj, 501u);
    ...
    if (l0.tag == 917u) {
        ...
        vader_obj_header_init(_a17_obj, 501u);
    ...
    if (l0.tag == 924u) {
        ...
        vader_obj_header_init(_a18_obj, 501u);
    ...
    if (l0.tag == 913u) {
        ...
        vader_obj_header_init(_a19_obj, 501u);
    ...
    if (l0.tag == 911u) {
        ...
        vader_obj_header_init(_a20_obj, 501u);
    ...
    if (l0.tag == 912u) {
        ...
        vader_obj_header_init(_a21_obj, 501u);
    ...
    if (l0.tag == 914u) {
        ...
        vader_obj_header_init(_a22_obj, 501u);
    ...
    if (l0.tag == 906u) {
        ...
        vader_obj_header_init(_a23_obj, 501u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1152u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2113u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1852u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1167u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1890u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2401u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
    ...
    if (l0 == INT32_C(11)) {
        ...
        vader_obj_header_init(_a1_obj, 518u);
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (l1 == 1890u) {
        ...
        vader_obj_header_init(_a4_obj, 560u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 561u);
    t1 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
vader_box_t vader_bytecode_c_field_val_type(void* l0, void* l1) {
    ...
    if (l5.tag == 500u) {
        t3 = l5.payload.obj;
        t2 = vader_box_i32(171u, (int32_t)(uint32_t) ((vader_struct_vader_bytecode_BcPrimitive_t*) t3)->f_val);
        return t2;
    }
    t2 = vader_box_obj(0u, NULL);
    return t2;
...
vader_box_t vader_bytecode_c_field_width(void* l0, void* l1) {
    ...
    uint8_t t1;
    int32_t t2;
    l2 = vader_bytecode_c_field_val_type(l0, l1);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        return t0;
    }
    t1 = ((uint8_t) l2.payload.i);
    t2 = vader_bytecode_size_of_val_type(t1);
    t0 = vader_box_i64(169u, ((int64_t) (int32_t) t2));
    return t0;
}
...
void* vader_bytecode_c_struct_layout(void* l0, void* l1) {
    ...
    void* l6 = NULL;
    void* l9 = NULL;
    int64_t l3, l4, l11, l12, l13, l14;
    vader_box_t l5 = vader_box_null(), l10 = vader_box_null();
    size_t l7, l8;
    vader_string_t t0 = 0;
    int64_t t1;
    void* t2 = NULL;
    vader_box_t* gc_roots[2] = { &l5, &l10 };
    void** gc_raw_roots[6] = { &l0, &l1, &l2, &l6, &l9, &t2 };
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_15: {
            if ((l8 < l7)) {
                ...
                l10 = vader_bytecode_c_field_width(l9, l1);
                if (l10.tag == 0u) {
                    if (l5.tag == 0u) {
                        t0 = ((vader_struct_vader_bytecode_BcField_t*) l9)->f_name;
                        l5 = vader_box_string(165u, t0);
                    } else {
                    }
                    vader_array_push_i64((vader_array_t*) l2, l3);
                    t1 = (l8 + INT64_C(1));
                    l8 = (size_t) (int64_t) t1;
                    goto loop_15;
                }
                l11 = ((int64_t) l10.payload.i);
                if ((l11 > l4)) {
                    l4 = l11;
                } else {
                }
                l12 = vader_mod_i64(l3, l11);
                if (l12 != INT64_C(0)) {
                    l13 = (l11 - l12);
                    l3 = (l3 + l13);
                } else {
    ...
    _a2_obj->f_offsets = l2;
    _a2_obj->f_size = l12;
    _a2_obj->f_unknown_field = l5;
    t2 = (void*) _a2_obj;
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a3_obj, 584u);
        t0 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 615u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 564u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_ge(uint8_t l0) {
    ...
    vader_obj_header_init(_a4_obj, 565u);
    t1 = (void*) _a4_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_28: {
            if ((l7 < l2)) {
                ...
                vader_obj_header_init(_a2_obj, 620u);
                _a2_obj->f_first = l8;
                _a2_obj->f_last = l9;
                l10 = (void*) _a2_obj;
        ...
        loop_61: {
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    t1 = vader_box_bool(163u, ((uint8_t*) _a4_slotarr->buf->slots)[_a4_slotarr->offset + (size_t) l11]);
                    t2 = t1.payload.b;
                    if (!(t2)) {
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 620u);
    ...
    vader_array_t* _a14_arr = vader_array_new(40u, 0u, 13u, 497u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(42u, 0u, 13u, 620u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    l7 = l1;
    {
        loop_269: {
            if ((l7 < l2)) {
                ...
                t1 = vader_box_bool(163u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l7]);
                t2 = t1.payload.b;
                if (!(t2)) {
                    l8 = -(INT32_C(1));
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 620u);
    ...
    vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1070u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 495u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 514u || l0.tag == 530u || l0.tag == 543u || l0.tag == 562u || l0.tag == 582u || l0.tag == 613u || l0.tag == 628u)) {
        return l0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
vader_box_t vader_bytecode_convert_target_of(uint8_t l0) {
    if (l0 == INT32_C(0)) {
        return vader_box_i32(168u, INT32_C(0));
    }
    if (l0 == INT32_C(1)) {
        return vader_box_i32(168u, INT32_C(0));
    }
    ...
    if (l0 == INT32_C(3)) {
        return vader_box_i32(168u, INT32_C(1));
    }
    if (l0 == INT32_C(8)) {
        return vader_box_i32(168u, INT32_C(1));
    }
    ...
    if (l0 == INT32_C(10)) {
        return vader_box_i32(168u, INT32_C(2));
    }
    if (l0 == INT32_C(11)) {
        return vader_box_i32(168u, INT32_C(2));
    }
    if (l0 == INT32_C(13)) {
        return vader_box_i32(168u, INT32_C(3));
    }
    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1423u);
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_200: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(163u, ((uint8_t*) _a8_slotarr->buf->slots)[_a8_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    vader_array_t* _a10_arr = vader_array_new(119u, 0u, 13u, 1070u);
    l8 = (void*) _a10_arr;
        ...
        loop_263: {
            if ((l6 < l4)) {
                ...
                if (l7.tag == 608u) {
                    ...
                    t2 = vader_box_bool(163u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l9]);
                    t3 = t2.payload.b;
                    if (t3) {
                        ...
                        vader_obj_header_init(_a15_obj, 536u);
                        l18 = (void*) _a15_obj;
                        ...
                        vader_obj_header_init(_a18_obj, 608u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 609u) {
                    ...
                    t2 = vader_box_bool(163u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l13]);
                    t3 = t2.payload.b;
                    if (t3) {
                        t0 = (l6 + INT64_C(1));
                        l6 = (size_t) (int64_t) t0;
                    ...
                    vader_obj_header_init(_a22_obj, 609u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 607u) {
                    ...
                    vader_obj_header_init(_a25_obj, 607u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 606u) {
                    ...
                    vader_obj_header_init(_a28_obj, 606u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(40u, 0u, 13u, 497u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(163u, ((uint8_t*) _a31_slotarr->buf->slots)[_a31_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_5: {
            if ((l5 < l2)) {
                ...
                t0 = vader_box_bool(163u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l5]);
                t1 = t0.payload.b;
                if (t1) {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 512u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1245u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 610u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1798u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 597u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1665u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 540u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1798u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 620u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 1u, 0u, gc_roots, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 259u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1460u; }
    }
...
int32_t vader_bytecode_intern_string(vader_string_t l0, void* l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_strings, vader_box_string(165u, l0));
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2081u, 618u, 1228u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(7); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2081u, 609u, 1610u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2039u) {
        ...
        vader_obj_header_init(_a2_obj, 522u);
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2023u) {
    ...
    if (l0 == 2022u) {
        ...
        vader_obj_header_init(_a6_obj, 523u);
        t0 = (void*) _a6_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2026u) {
    ...
    if (l0 == 2032u) {
        ...
        vader_obj_header_init(_a8_obj, 554u);
        t0 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2038u) {
        ...
        vader_obj_header_init(_a9_obj, 511u);
        t0 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2031u) {
        ...
        vader_obj_header_init(_a10_obj, 541u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2037u) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l6 < l5)) {
                ...
                vader_array_push((vader_array_t*) l3, vader_box_string(165u, l8));
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                goto loop_9;
            } else {
...
static vader_box_t vader_bytecode_neg_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a2_obj, 572u);
    t1 = (void*) _a2_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(121u, 0u, 13u, 1077u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 500u);
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1876u, INT32_C(0));
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 495u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 306u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    l5 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(8u, 0u, 0u, 165u);
    l6 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 168u);
    l7 = (void*) _a17_arr;
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 168u);
    l8 = (void*) _a18_arr;
    ...
    vader_obj_header_init(_a19_obj, 355u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(39u, 0u, 13u, 496u);
    l7 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 168u);
    l8 = (void*) _a21_arr;
    vader_array_t* _a22_arr = vader_array_new(9u, 0u, 7u, 168u);
    l9 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(9u, 0u, 7u, 168u);
    l10 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a24_obj, 306u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    l8 = (void*) _a24_obj;
    vader_array_t* _a25_arr = vader_array_new(8u, 0u, 0u, 165u);
    l9 = (void*) _a25_arr;
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 168u);
    l10 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(9u, 0u, 7u, 168u);
    l11 = (void*) _a27_arr;
    ...
    vader_obj_header_init(_a28_obj, 355u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(36u, 0u, 13u, 492u);
    l10 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 168u);
    l11 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 168u);
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(16u, 0u, 0u, 176u);
    l13 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a34_obj, 279u);
    ...
    vader_obj_header_init(_a35_obj, 539u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_parse_val_type(vader_string_t l0) {
    vader_box_t t0;
    if (l0 == 1661u) {
        t0 = vader_box_i32(171u, INT32_C(0));
        return t0;
    }
    if (l0 == 1616u) {
        t0 = vader_box_i32(171u, INT32_C(1));
        return t0;
    }
    if (l0 == 1617u) {
        t0 = vader_box_i32(171u, INT32_C(2));
        return t0;
    }
    if (l0 == 1639u) {
        t0 = vader_box_i32(171u, INT32_C(3));
        return t0;
    }
    if (l0 == 1734u) {
        t0 = vader_box_i32(171u, INT32_C(4));
        return t0;
    }
    if (l0 == 2240u) {
        t0 = vader_box_i32(171u, INT32_C(5));
        return t0;
    }
    if (l0 == 2221u) {
        t0 = vader_box_i32(171u, INT32_C(6));
        return t0;
    }
    if (l0 == 2222u) {
        t0 = vader_box_i32(171u, INT32_C(7));
        return t0;
    }
    if (l0 == 2231u) {
        t0 = vader_box_i32(171u, INT32_C(8));
        return t0;
    }
    if (l0 == 2284u) {
        t0 = vader_box_i32(171u, INT32_C(9));
        return t0;
    }
    if (l0 == 1514u) {
        t0 = vader_box_i32(171u, INT32_C(10));
        return t0;
    }
    if (l0 == 1517u) {
        t0 = vader_box_i32(171u, INT32_C(11));
        return t0;
    }
    if (l0 == 1246u) {
        t0 = vader_box_i32(171u, INT32_C(12));
        return t0;
    }
    if (l0 == 1337u) {
        t0 = vader_box_i32(171u, INT32_C(13));
        return t0;
    }
    if (l0 == 2081u) {
        t0 = vader_box_i32(171u, INT32_C(14));
        return t0;
    }
    if (l0 == 1876u) {
        t0 = vader_box_i32(171u, INT32_C(15));
        return t0;
    }
    if (l0 == 2374u) {
        t0 = vader_box_i32(171u, INT32_C(16));
        return t0;
    }
    if (l0 == 1909u) {
        t0 = vader_box_i32(171u, INT32_C(17));
        return t0;
    }
    if (l0 == 1931u) {
        t0 = vader_box_i32(171u, INT32_C(18));
        return t0;
    }
    if (l0 == 1170u) {
        t0 = vader_box_i32(171u, INT32_C(19));
        return t0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1152u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2113u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1852u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2020u, 253u, l0, 253u, l1, 253u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 168u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(16u, 0u, 0u, 176u);
    l23 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 168u);
    l24 = (void*) _a17_arr;
    ...
    vader_obj_header_init(_a18_obj, 277u);
    ...
    vader_array_t* _a26_arr = vader_array_new(119u, 0u, 13u, 1070u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(123u, 0u, 13u, 1094u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    size_t l3, l7, l11, l15, l16, l17, l18, l36;
    void* l4 = NULL;
    void* l5 = NULL;
    void* l6 = NULL;
    void* l13 = NULL;
    ...
    void** gc_raw_roots[20] = { &l0, &l1, &l2, &l4, &l5, &l6, &l13, &l14, &l26, &l27, &l28, &l29, &l30, &l31, &l32, &l33, &l34, &l35, &l37, &t2 };
    ...
    vader_string_t* gc_atom_roots[3] = { &l9, &l38, &t6 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 20u, gc_roots, gc_raw_roots, 3u, gc_stack_objs, 3u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                t3 = vader_box_bool(163u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l11]);
                l12 = t3.payload.b;
                vader_struct___Tuple_i32_bool_cd1657f9_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 226u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
    ...
    l12 = t4 == INT64_C(0);
    vader_array_t* _a17_arr = vader_array_new(8u, 0u, 0u, 165u);
    l5 = (void*) _a17_arr;
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a18_arr;
    ...
    vader_obj_header_init(_a20_obj, 355u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_array_t* _a24_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a24_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_507: {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(38u, 0u, 13u, 495u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_569: {
                    ...
                    loop_716: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 527u) {
                                ...
                                vader_obj_header_init(_a38_obj, 527u);
                            ...
                            if (l19.tag == 556u) {
                                ...
                                vader_obj_header_init(_a41_obj, 556u);
                            ...
                            if (l19.tag == 555u) {
                                ...
                                t5 = ((vader_struct_vader_bytecode_FnAddr_t*) l31)->f_function_index;
                                t1 = ((int64_t) (int32_t) t5);
                                l18 = (size_t) (int64_t) t1;
                                ...
                                vader_obj_header_init(_a44_obj, 555u);
                            ...
                            if (l19.tag == 611u) {
                                l34 = l19.payload.obj;
                                l35 = ((vader_struct_vader_bytecode_BcFunction_t*) l5)->f_body;
                                t5 = ((vader_struct_vader_bytecode_MakeClosure_t*) l34)->f_function_index;
                                t1 = ((int64_t) (int32_t) t5);
                                ...
                                l20 = ((int32_t*) _a46_slotarr->buf->slots)[_a46_slotarr->offset + (size_t) l36];
                                l24 = ((vader_struct_vader_bytecode_MakeClosure_t*) l34)->f_env_type_id;
                                ...
                                vader_obj_header_init(_a47_obj, 611u);
                                _a47_obj->f_function_index = l20;
                                _a47_obj->f_env_type_id = l24;
                                l37 = (void*) _a47_obj;
                                vader_array_t* _a48_slotarr = ((vader_array_t*) l35);
                                ...
                                vader_array_ref_store(_a48_slotarr->buf, _a48_slotarr->offset + (size_t) l15, l37);
    ...
    vader_array_t* _a49_arr = vader_array_new(36u, 0u, 13u, 492u);
    l4 = (void*) _a49_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_855: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a52_obj, 492u);
    ...
    vader_array_t* _a53_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a53_arr;
    vader_array_t* _a54_arr = vader_array_new(9u, 0u, 7u, 168u);
    l5 = (void*) _a54_arr;
    vader_array_t* _a55_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a55_arr;
    ...
    vader_obj_header_init(_a56_obj, 306u);
    _a56_obj->f_ekeys = l4;
    _a56_obj->f_evals = l5;
    _a56_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_923: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a60_obj, 227u);
                _a60_obj->f__0 = l8;
                _a60_obj->f__1 = l10;
                l5 = (void*) _a60_obj;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a62_arr = vader_array_new(8u, 0u, 0u, 165u);
    l4 = (void*) _a62_arr;
    vader_array_t* _a63_arr = vader_array_new(9u, 0u, 7u, 168u);
    l5 = (void*) _a63_arr;
    vader_array_t* _a64_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a64_arr;
    ...
    vader_obj_header_init(_a65_obj, 355u);
    _a65_obj->f_ekeys = l4;
    _a65_obj->f_evals = l5;
    _a65_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1000: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a69_obj, 231u);
                _a69_obj->f__0 = l9;
                _a69_obj->f__1 = l8;
                l5 = (void*) _a69_obj;
                l38 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l5)->f__0;
                ...
                if ((l20 >= INT32_C(0))) {
                    std_collections_put__string__i32(l4, l38, l20);
                } else {
                }
                goto loop_1000;
            }
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a71_arr = vader_array_new(9u, 0u, 7u, 168u);
    l4 = (void*) _a71_arr;
    vader_array_t* _a72_arr = vader_array_new(16u, 0u, 0u, 176u);
    l5 = (void*) _a72_arr;
    vader_array_t* _a73_arr = vader_array_new(9u, 0u, 7u, 168u);
    l6 = (void*) _a73_arr;
    ...
    vader_obj_header_init(_a74_obj, 279u);
    _a74_obj->f_ekeys = l4;
    _a74_obj->f_evals = l5;
    _a74_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1078: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a77_obj, 224u);
                _a77_obj->f__0 = l8;
                _a77_obj->f__1 = l5;
                l27 = (void*) _a77_obj;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(39u, 0u, 13u, 496u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_164: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 528u) {
                                ...
                                vader_obj_header_init(_a12_obj, 528u);
                                _a12_obj->f_index = t4;
                                l16 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a15_obj, 224u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(121u, 0u, 13u, 1077u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1077u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 504u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(37u, 0u, 13u, 493u);
                    l8 = (void*) _a23_arr;
                    ...
                    vader_obj_header_init(_a26_obj, 504u);
                    _a26_obj->f_name = l20;
                    ...
                    if (l16.tag == 505u) {
                        ...
                        vader_obj_header_init(_a29_obj, 505u);
                        ...
                        if (l16.tag == 491u) {
                            ...
                            vader_obj_header_init(_a30_obj, 491u);
                            ...
                            if (l16.tag == 494u) {
                                ...
                                vader_obj_header_init(_a33_obj, 494u);
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a34_arr = vader_array_new(8u, 0u, 0u, 165u);
    l1 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(9u, 0u, 7u, 168u);
    l3 = (void*) _a35_arr;
    ...
    vader_obj_header_init(_a37_obj, 355u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_615: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a41_obj, 231u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l20 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__0;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_671: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a43_arr = vader_array_new(9u, 0u, 7u, 168u);
                l6 = (void*) _a43_arr;
                ...
                vader_obj_header_init(_a45_obj, 502u);
    ...
    vader_array_t* _a48_arr = vader_array_new(39u, 0u, 13u, 496u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_800: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a50_arr = vader_array_new(9u, 0u, 7u, 168u);
                l8 = (void*) _a50_arr;
                ...
                vader_obj_header_init(_a52_obj, 502u);
                ...
                vader_obj_header_init(_a53_obj, 496u);
...
static void vader_bytecode_push_scope(void* l0, void* l1, size_t l2, vader_string_t l3, int32_t l4) {
    ...
    l5 = ((vader_array_t*) l0)->length;
    if (l2 == l5) {
        vader_array_push((vader_array_t*) l0, vader_box_string(165u, l3));
        vader_array_push_i32((vader_array_t*) l1, l4);
    } else {
        vader_array_t* _a0_slotarr = ((vader_array_t*) l0);
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) l2 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        vader_array_box_slots(_a0_slotarr->buf)[_a0_slotarr->offset + (size_t) l2] = vader_box_string(165u, l3);
        VADER_WRITE_BARRIER(_a0_slotarr->buf);
        vader_array_t* _a1_slotarr = ((vader_array_t*) l1);
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(123u, 1u, 13u, 1094u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 611u) {
        ...
        vader_obj_header_init(_a10_obj, 611u);
    ...
    if (l0.tag == 556u) {
        ...
        vader_obj_header_init(_a11_obj, 556u);
    ...
    if (l0.tag == 489u) {
        ...
        vader_obj_header_init(_a13_obj, 489u);
    ...
    if (l0.tag == 614u) {
        ...
        vader_obj_header_init(_a14_obj, 614u);
    ...
    if (l0.tag == 519u) {
        ...
        vader_obj_header_init(_a15_obj, 519u);
    ...
    if (l0.tag == 532u) {
        ...
        vader_obj_header_init(_a16_obj, 532u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(119u, 0u, 13u, 1070u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 168u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 607u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (l27) {
                                    ...
                                    if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                                    if ((size_t) l16 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                                    t3 = vader_box_bool(163u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l16]);
                                    l26 = t3.payload.b;
                                }
                                if (!(l26)) {
                                    t1 = ((vader_struct_vader_bytecode_LocalSet_t*) l18)->f_slot;
                                    ...
                                    vader_obj_header_init(_a16_obj, 609u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 617u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 618u);
                                        ...
                                        if (l9.tag == 517u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 514u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 514u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 517u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 514u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 514u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 517u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 514u) {
                                            ...
                                            vader_obj_header_init(_a40_obj, 514u);
                                            _a40_obj->f_value = !(t5);
                                            l47 = (void*) _a40_obj;
                                ...
                                if (l9.tag == 517u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 514u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 514u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 517u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 514u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 514u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 617u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 618u);
                                ...
                                if (l9.tag == 517u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 514u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 514u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 517u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 514u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 514u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 517u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 514u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 514u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 617u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 618u);
                            ...
                            if (l9.tag == 517u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 514u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 514u);
                        ...
                        if (l9.tag == 517u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 514u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 514u);
                    ...
                    if (l9.tag == 517u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 514u) {
                                ...
                                vader_obj_header_init(_a124_obj, 514u);
                ...
                if (l9.tag == 617u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 618u);
                        ...
                        if (l9.tag == 517u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 514u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 514u);
                    ...
                    if (l9.tag == 517u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 514u) {
                                ...
                                vader_obj_header_init(_a144_obj, 514u);
                ...
                if (l9.tag == 517u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 514u) {
                            ...
                            vader_obj_header_init(_a152_obj, 514u);
    ...
    vader_obj_header_init(_a159_obj, 498u);
    _a159_obj->f_body = l1;
                ...
                if (l8.tag == 617u) {
                    ...
                    if ((l9 > INT64_C(0))) {
                        ...
                        if (!(l11.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a4_obj, 618u);
                            _a4_obj->f_value = l11;
                            l13 = (void*) _a4_obj;
                            vader_array_t* _a5_slotarr = ((vader_array_t*) l3);
                            if (_a5_slotarr->buf != NULL && _a5_slotarr->buf->header.forward != NULL) { _a5_slotarr->buf = vader_array_buf_forward(_a5_slotarr->buf); }
...
static vader_box_t vader_bytecode_shr_op(uint8_t l0) {
    ...
    if (l1) {
        ...
        vader_obj_header_init(_a2_obj, 575u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_box_t vader_bytecode_slot_load_op_for(uint8_t l0, bool l1) {
    ...
    if (l2 == INT32_C(3)) {
        ...
        vader_obj_header_init(_a2_obj, 602u);
...
static vader_box_t vader_bytecode_slot_width_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(14)) {
        return vader_box_i32(168u, INT32_C(4));
    }
    if (l0 == INT32_C(15)) {
        return vader_box_i32(168u, INT32_C(4));
    }
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2021u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2021u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(119u, 0u, 13u, 1070u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 1u, 7u, 168u);
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1662u);
            ...
            if (l5.tag == 582u) {
                ...
                if (l4.tag == 582u) {
                    ...
                    if (l0.tag == 596u) {
                        ...
                        vader_obj_header_init(_a5_obj, 582u);
                    ...
                    if (l0.tag == 590u) {
                        ...
                        vader_obj_header_init(_a6_obj, 582u);
        ...
        if (l5.tag == 582u) {
            ...
            if (l4.tag == 582u) {
                ...
                if (l0.tag == 577u) {
                    ...
                    vader_obj_header_init(_a7_obj, 582u);
                ...
                if (l0.tag == 596u) {
                    ...
                    vader_obj_header_init(_a8_obj, 582u);
    ...
    if (l5.tag == 582u) {
        ...
        if (l4.tag == 582u) {
            ...
            if (l0.tag == 596u) {
                ...
                vader_obj_header_init(_a11_obj, 582u);
            ...
            if (l0.tag == 590u) {
                ...
                vader_obj_header_init(_a12_obj, 582u);
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 863u);
    ...
    l3 = std_core_write_string_at(l6, l3, 863u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 918u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2412u);
        t1 = concat_5(741u, l2, 503u, l3, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 919u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) l1)->f_symbol);
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2412u);
        t1 = concat_5(816u, l2, 503u, l3, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 909u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 907u) {
        ...
        t1 = concat_3(542u, l2, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 923u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2412u);
        t1 = concat_3(822u, l2, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 920u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2412u);
        t1 = concat_3(818u, l2, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 910u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) l1)->f_params, 372u);
        l3 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) l1)->f_return_type);
        t1 = concat_4(604u, l2, 353u, l3);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 922u) {
        t0 = l0.payload.obj;
