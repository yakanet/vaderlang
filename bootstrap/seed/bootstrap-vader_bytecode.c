...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        if (l1 == 1959u) {
            ...
            vader_obj_header_init(_a2_obj, 566u);
            t1 = (void*) _a2_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        ...
        vader_obj_header_init(_a3_obj, 560u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (t0) {
        if (l1 == 1226u) {
            ...
            vader_obj_header_init(_a4_obj, 593u);
            t1 = (void*) _a4_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 2205u) {
            ...
            vader_obj_header_init(_a5_obj, 612u);
            t1 = (void*) _a5_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1959u) {
    ...
    if (l1 == 1226u) {
        ...
        vader_obj_header_init(_a8_obj, 573u);
        t1 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 2205u) {
        ...
        vader_obj_header_init(_a9_obj, 592u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1959u) {
        ...
        vader_obj_header_init(_a10_obj, 586u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a11_obj, 579u);
    t1 = (void*) _a11_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
...
static uint64_t vader_bytecode_bare_hash(vader_string_t l0) {
    ...
    t0 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), l1);
    ...
    if (l0.tag == 939u) {
        ...
        if (l0.tag == 932u) {
            ...
            if (l0.tag == 929u) {
                ...
                if ((l0.tag == 934u || l0.tag == 935u || l0.tag == 936u || l0.tag == 937u || l0.tag == 940u || l0.tag == 944u || l0.tag == 945u || l0.tag == 947u)) {
                    l1 = vader_types_display_type(l0);
                } else {
                    if ((l0.tag == 930u || l0.tag == 931u || l0.tag == 933u || l0.tag == 941u || l0.tag == 942u || l0.tag == 943u || l0.tag == 946u)) {
                        l1 = 0u;
                    } else {
...
size_t vader_bytecode_bc_result_arity(void* l0) {
    ...
    if (l1) {
        return (size_t) (int64_t) INT64_C(0);
    }
    t0 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcSignature_t*) l0)->f_results)->length;
    return t0;
}

void* vader_bytecode_bc_result_slots(uint8_t l0, int32_t l1) {
    void* l2 = NULL;
    void* l3 = NULL;
    void* t0 = NULL;
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 182u);
    ((uint8_t*) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = (uint8_t) (int32_t) (uint8_t) l0;
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(9u, 1u, 7u, 179u);
    ((int32_t*) _a1_arr->buf->slots)[_a1_arr->offset + 0u] = (int32_t) l1;
    l3 = (void*) _a1_arr;
    vader_struct_vader_bytecode_BcResultSlots_t* _a2_obj = (vader_struct_vader_bytecode_BcResultSlots_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcResultSlots_t));
    vader_obj_header_init(_a2_obj, 517u);
    _a2_obj->f_results = l2;
    _a2_obj->f_result_types = l3;
    t0 = (void*) _a2_obj;
...
uint8_t vader_bytecode_bc_single_result(void* l0) {
    ...
    t0 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcSignature_t*) l0)->f_results)->length;
    if ((t0 > INT64_C(1))) {
        vader_host_std_abort_panic(1373u);
    }
    vader_array_t* _a0_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_BcSignature_t*) l0)->f_results);
    if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
    if ((size_t) INT32_C(0) >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    void** gc_raw_roots[3] = { &l0, &l7, &l8 };
    vader_string_t* gc_atom_roots[3] = { &l6, &l10, &l12 };
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 540u; }
    }
    t0 = ((int64_t) (int32_t) l1);
    l3 = (size_t) (int64_t) t0;
    ...
    if (l5.tag == 515u) {
        ...
        l3 = std_core_write_string_at(l8, l3, 2009u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 932u) {
        ...
        vader_obj_header_init(_a1_obj, 515u);
        _a1_obj->f_val = t2;
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l0.tag == 943u) {
        vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 508u);
        l3 = (void*) _a11_arr;
        t0 = l0.payload.obj;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_166: {
                if ((l6 < l5)) {
                    ...
                    l8 = std_core_write_string_at(l4, l8, 887u);
                    ...
                    vader_obj_header_init(_a13_obj, 508u);
                    _a13_obj->f_name = l10;
        ...
        vader_obj_header_init(_a14_obj, 520u);
        _a14_obj->f_name = l10;
    ...
    if (l0.tag == 945u) {
        ...
        vader_obj_header_init(_a15_obj, 516u);
    ...
    if (l0.tag == 944u) {
        ...
        vader_obj_header_init(_a16_obj, 516u);
    ...
    if (l0.tag == 940u) {
        ...
        vader_obj_header_init(_a17_obj, 516u);
    ...
    if (l0.tag == 947u) {
        ...
        vader_obj_header_init(_a18_obj, 516u);
    ...
    if (l0.tag == 936u) {
        ...
        vader_obj_header_init(_a19_obj, 516u);
    ...
    if (l0.tag == 934u) {
        ...
        vader_obj_header_init(_a20_obj, 516u);
    ...
    if (l0.tag == 935u) {
        ...
        vader_obj_header_init(_a21_obj, 516u);
    ...
    if (l0.tag == 937u) {
        ...
        vader_obj_header_init(_a22_obj, 516u);
    ...
    if (l0.tag == 929u) {
        ...
        vader_obj_header_init(_a23_obj, 516u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        l2 = vader_bytecode_arith_op(l1, 1226u);
    } else {
        if (l0 == INT32_C(1)) {
            l2 = vader_bytecode_arith_op(l1, 2205u);
        } else {
            if (l0 == INT32_C(2)) {
                l2 = vader_bytecode_arith_op(l1, 1959u);
            } else {
                if (l0 == INT32_C(3)) {
                    ...
                    if (l0 == INT32_C(4)) {
                        ...
                        if (l0 == INT32_C(5)) {
                            ...
                            if (l0 == INT32_C(6)) {
                                ...
                                if (l0 == INT32_C(7)) {
                                    l2 = vader_bytecode_bit_op(l1, 1244u);
                                } else {
                                    if (l0 == INT32_C(8)) {
                                        l2 = vader_bytecode_bit_op(l1, 2003u);
                                    } else {
                                        if (l0 == INT32_C(9)) {
                                            l2 = vader_bytecode_bit_op(l1, 2506u);
                                        } else {
                                            if (l0 == INT32_C(10)) {
                                                ...
                                                if (l0 == INT32_C(11)) {
                                                    ...
                                                    vader_obj_header_init(_a1_obj, 534u);
                                                    t0 = (void*) _a1_obj;
                                                    l2 = vader_ref_box(t0);
                                                } else {
                                                    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 597u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1244u) {
    ...
    if (l1 == 2003u) {
        ...
        vader_obj_header_init(_a4_obj, 576u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 577u);
    t1 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_bitnot_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a1_obj, 575u);
    t1 = (void*) _a1_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_build_intrinsic_wrapper_body(void* l0, int32_t l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l2 = (void*) _a0_arr;
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l4 < l3)) {
                ...
                vader_obj_header_init(_a1_obj, 623u);
    ...
    vader_obj_header_init(_a3_obj, 633u);
    l5 = (void*) _a3_obj;
    vader_array_push((vader_array_t*) l2, vader_ref_box(l5));
...
static vader_box_t vader_bytecode_c_field_align_at(void* l0, void* l1, int32_t l2) {
    ...
    if (!(l3.tag == 0u)) {
        ...
        t2 = vader_box_i64(180u, ((int64_t) (int32_t) t1));
        return t2;
    }
    if ((l2 >= INT32_C(16))) {
...
vader_box_t vader_bytecode_c_field_val_type(void* l0, void* l1) {
    ...
    if (l5.tag == 515u) {
        t3 = l5.payload.obj;
        t2 = vader_box_i32(182u, (int32_t)(uint32_t) ((vader_struct_vader_bytecode_BcPrimitive_t*) t3)->f_val);
        return t2;
    }
    t2 = vader_box_obj(0u, NULL);
    return t2;
...
static void* vader_bytecode_c_struct_layout_at(void* l0, void* l1, int32_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 542u);
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a3_obj, 600u);
        t0 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 631u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 580u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_ge(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a0_obj, 562u);
        t1 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 601u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a4_obj, 581u);
    t1 = (void*) _a4_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_gt(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a0_obj, 563u);
        t1 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_u64_class(l0);
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 655u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_64_bit_int_val(l0);
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 602u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a4_obj, 582u);
    t1 = (void*) _a4_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_le(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a0_obj, 564u);
        t1 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_u64_class(l0);
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 656u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_64_bit_int_val(l0);
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 603u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_cmp_lt(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 604u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a4_obj, 584u);
    t1 = (void*) _a4_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_ne(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a2_obj, 567u);
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t1 = vader_bytecode_is_64_bit_int_val(l0);
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 632u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 587u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 4u, 14u, gc_roots, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    ...
    vader_array_t* _a0_arr = vader_array_new(42u, 0u, 13u, 636u);
    l5 = (void*) _a0_arr;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_28: {
            if ((l7 < l2)) {
                ...
                vader_obj_header_init(_a2_obj, 636u);
                _a2_obj->f_first = l8;
                _a2_obj->f_last = l9;
                l10 = (void*) _a2_obj;
        ...
        loop_60: {
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    t1 = vader_box_bool(174u, ((uint8_t*) _a4_slotarr->buf->slots)[_a4_slotarr->offset + (size_t) l11]);
                    t2 = t1.payload.b;
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a5_obj, 636u);
                        _a5_obj->f_first = l9;
                        _a5_obj->f_last = l12;
                        l10 = (void*) _a5_obj;
                        ...
                        vader_obj_header_init(_a9_obj, 636u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_155: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 636u);
    ...
    vader_array_t* _a14_arr = vader_array_new(40u, 0u, 13u, 512u);
    l10 = (void*) _a14_arr;
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 179u);
    l15 = (void*) _a15_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        ...
        loop_190: {
            if ((l7 < l2)) {
                ...
                if (VADER_LIKELY(_pc190_len < _pc190_cap)) {
                    ...
                    if (_pc190_hdr->buf->length < _pc190_len) { _pc190_hdr->buf->length = _pc190_len; }
    ...
    vader_array_t* _a17_arr = vader_array_new(42u, 0u, 13u, 636u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_237: {
    ...
    l7 = l1;
    {
        loop_260: {
            if ((l7 < l2)) {
                ...
                t1 = vader_box_bool(174u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l7]);
                t2 = t1.payload.b;
                if (!(t2)) {
                    l8 = -(INT32_C(1));
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 636u);
    ...
    vader_array_t* _a31_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 510u);
    _a34_obj->f_name = l38;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 530u || l0.tag == 546u || l0.tag == 559u || l0.tag == 578u || l0.tag == 598u || l0.tag == 629u || l0.tag == 644u)) {
        return l0;
    }
...
void* vader_bytecode_default_emit_options(void) {
    ...
    vader_obj_header_init(_a1_obj, 554u);
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1513u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_drop_dead_stores(void* l0) {
        ...
        loop_16: {
            if ((l4 < l2)) {
                if (VADER_LIKELY(_pc16_len < _pc16_cap)) {
                    ...
                    if (_pc16_hdr->buf->length < _pc16_len) { _pc16_hdr->buf->length = _pc16_len; }
    ...
    vader_array_t* _a4_arr = vader_array_new(6u, 0u, 12u, 174u);
    l5 = (void*) _a4_arr;
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        ...
        loop_112: {
            if ((l4 < l2)) {
                if (VADER_LIKELY(_pc112_len < _pc112_cap)) {
                    ...
                    if (_pc112_hdr->buf->length < _pc112_len) { _pc112_hdr->buf->length = _pc112_len; }
        ...
        loop_170: {
            if ((l4 < l2)) {
                ...
                if (VADER_LIKELY(_pc170_len < _pc170_cap)) {
                    ...
                    if (_pc170_hdr->buf->length < _pc170_len) { _pc170_hdr->buf->length = _pc170_len; }
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_194: {
            if ((l4 < l2)) {
                ...
                t3 = vader_box_bool(174u, ((uint8_t*) _a8_slotarr->buf->slots)[_a8_slotarr->offset + (size_t) l4]);
                t4 = t3.payload.b;
                if (!(t4)) {
    ...
    vader_array_t* _a10_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l15 = (void*) _a10_arr;
        ...
        loop_232: {
            if ((l6 < l4)) {
                ...
                if (VADER_LIKELY(_pc232_len < _pc232_cap)) {
                    ...
                    if (_pc232_hdr->buf->length < _pc232_len) { _pc232_hdr->buf->length = _pc232_len; }
        ...
        loop_254: {
            if ((l6 < l4)) {
                ...
                if (l7.tag == 624u) {
                    ...
                    t3 = vader_box_bool(174u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l8]);
                    t4 = t3.payload.b;
                    if (t4) {
                        ...
                        vader_obj_header_init(_a15_obj, 552u);
                        l17 = (void*) _a15_obj;
                        ...
                        vader_obj_header_init(_a18_obj, 624u);
                        _a18_obj->f_slot = t2;
                        l18 = (void*) _a18_obj;
                ...
                if (l7.tag == 625u) {
                    ...
                    t3 = vader_box_bool(174u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l11]);
                    t4 = t3.payload.b;
                    if (t4) {
                        t0 = (l6 + INT64_C(1));
                        l6 = (size_t) (int64_t) t0;
                    ...
                    vader_obj_header_init(_a22_obj, 625u);
                    _a22_obj->f_slot = t2;
                    l20 = (void*) _a22_obj;
                ...
                if (l7.tag == 623u) {
                    ...
                    if (_a24_slotarr->buf != NULL && _a24_slotarr->buf->header.forward != NULL) { _a24_slotarr->buf = vader_array_buf_forward(_a24_slotarr->buf); }
                    if ((size_t) l22 >= _a24_slotarr->length) { vader_trap("array index out of bounds"); }
                    ...
                    vader_obj_header_init(_a25_obj, 623u);
                    _a25_obj->f_slot = t2;
                    l23 = (void*) _a25_obj;
                ...
                if (l7.tag == 622u) {
                    ...
                    vader_obj_header_init(_a28_obj, 622u);
                    _a28_obj->f_slot = l26;
    ...
    vader_array_t* _a30_arr = vader_array_new(40u, 0u, 13u, 512u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_491: {
            if ((l4 < l2)) {
                ...
                t3 = vader_box_bool(174u, ((uint8_t*) _a31_slotarr->buf->slots)[_a31_slotarr->offset + (size_t) l4]);
                t4 = t3.payload.b;
                if (!(t4)) {
    ...
    vader_obj_header_init(_a33_obj, 510u);
    _a33_obj->f_name = l32;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_5: {
            if ((l5 < l2)) {
                ...
                t0 = vader_box_bool(174u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l5]);
                t1 = t0.payload.b;
                if (t1) {
                            ...
                            if ((l9 < l8)) {
                                ...
                                if (l13) {
                                    ...
                                    if ((l16 > l17)) {
                                        ...
                                        vader_obj_header_init(_a3_obj, 636u);
                                        _a3_obj->f_first = l18;
                                        _a3_obj->f_last = l19;
                                        l6 = (void*) _a3_obj;
                                        l4 = true;
                                    ...
                                    if ((l20 < l21)) {
                                        ...
                                        vader_obj_header_init(_a4_obj, 636u);
                                        _a4_obj->f_first = l22;
                                        _a4_obj->f_last = l23;
                                        l6 = (void*) _a4_obj;
                                        l4 = true;
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 528u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1325u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 626u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1901u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 613u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1760u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 556u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1901u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 636u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_string_t vader_bytecode_fnv1a_hex(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 3u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = (uint64_t) (int64_t) INT64_C(-3750763034362895579);
    ...
    l6 = INT32_C(0);
    {
        loop_37: {
            if ((l6 < INT32_C(16))) {
                ...
                l3 = (size_t) (int64_t) t1;
                l8 = vader_string_slice_codepoints(474u, l2, l3);
                l5 = concat_2(l5, l8);
                l6 = (l6 + INT32_C(1));
                goto loop_37;
            }
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1548u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1987u; }
    }
...
int32_t vader_bytecode_intern_cell_type(vader_box_t l0, void* l1) {
    ...
    _a0_obj->f_name = 2463u;
    _a0_obj->f_type_index = l2;
    l6 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(37u, 0u, 13u, 508u);
    l7 = (void*) _a1_arr;
    ...
    vader_obj_header_init(_a2_obj, 520u);
    _a2_obj->f_name = l8;
    _a2_obj->f_fields = l7;
    _a2_obj->f_c_name = 0u;
...
int32_t vader_bytecode_intern_string(vader_string_t l0, void* l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_strings, vader_box_string(176u, l0));
...
int32_t vader_bytecode_intern_type(vader_box_t l0, void* l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 4u, 3u, gc_roots, gc_raw_roots, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    ...
    vader_obj_header_init(_a1_obj, 516u);
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2173u, 631u, 1307u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(5); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2173u, 622u, 1704u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2137u) {
        ...
        vader_obj_header_init(_a1_obj, 600u);
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l0 == 2142u) {
        ...
        vader_obj_header_init(_a2_obj, 538u);
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2126u) {
    ...
    if (l0 == 2128u) {
        ...
        vader_obj_header_init(_a4_obj, 643u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2127u) {
        ...
        vader_obj_header_init(_a5_obj, 628u);
        t0 = (void*) _a5_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2125u) {
    ...
    if (l0 == 2135u) {
        ...
        vader_obj_header_init(_a8_obj, 570u);
        t0 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2141u) {
        ...
        vader_obj_header_init(_a9_obj, 527u);
        t0 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2134u) {
        ...
        vader_obj_header_init(_a10_obj, 557u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2140u) {
        ...
        vader_obj_header_init(_a11_obj, 526u);
        t0 = (void*) _a11_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static bool vader_bytecode_is_display_to_string(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 1u, 0u, gc_roots, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 264u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l6 < l5)) {
                ...
                vader_array_push((vader_array_t*) l3, vader_box_string(176u, l8));
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                goto loop_9;
            }
...
void* vader_bytecode_mark_jump_targets(void* l0, size_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 3u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(6u, 1u, 12u, 174u);
...
static vader_box_t vader_bytecode_mod_op(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 605u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_neg_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a2_obj, 588u);
    t1 = (void*) _a2_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    uint64_t l5;
    void* t0 = NULL;
    void** gc_raw_roots[18] = { &l0, &l1, &l2, &l3, &l4, &l6, &l7, &l8, &l9, &l10, &l11, &l12, &l13, &l14, &l15, &l16, &l17, &t0 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 18u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(132u, 0u, 13u, 1127u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 515u);
    ...
    vader_obj_header_init(_a5_obj, 367u);
    _a5_obj->f_ekeys = l1;
    _a5_obj->f_evals = l2;
    _a5_obj->f_index = l3;
    ...
    l1 = (void*) _a5_obj;
    std_collections_MutableMap_IndexSet_set_at__string__i32(l1, 1988u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 939u);
    _a10_obj->f_name = 1988u;
    t0 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 939u);
    _a11_obj->f_name = 1988u;
    t0 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(142u, 1u, 13u, 1250u);
    ((void**) _a12_arr->buf->slots)[_a12_arr->offset + 0u] = t0;
    l3 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(8u, 0u, 0u, 176u);
    l4 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a17_obj, 367u);
    _a17_obj->f_ekeys = l6;
    _a17_obj->f_evals = l7;
    _a17_obj->f_index = l8;
    ...
    l6 = (void*) _a17_obj;
    vader_array_t* _a18_arr = vader_array_new(38u, 0u, 13u, 510u);
    l7 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(9u, 0u, 7u, 179u);
    l8 = (void*) _a19_arr;
    vader_array_t* _a20_arr = vader_array_new(9u, 0u, 7u, 179u);
    l9 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 179u);
    l10 = (void*) _a21_arr;
    ...
    vader_obj_header_init(_a22_obj, 319u);
    _a22_obj->f_ekeys = l8;
    _a22_obj->f_evals = l9;
    ...
    l8 = (void*) _a22_obj;
    vader_array_t* _a23_arr = vader_array_new(8u, 0u, 0u, 176u);
    l9 = (void*) _a23_arr;
    vader_array_t* _a24_arr = vader_array_new(9u, 0u, 7u, 179u);
    l10 = (void*) _a24_arr;
    vader_array_t* _a25_arr = vader_array_new(9u, 0u, 7u, 179u);
    l11 = (void*) _a25_arr;
    ...
    vader_obj_header_init(_a26_obj, 367u);
    _a26_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a26_obj;
    vader_array_t* _a27_arr = vader_array_new(39u, 0u, 13u, 511u);
    l10 = (void*) _a27_arr;
    ...
    vader_obj_header_init(_a31_obj, 319u);
    _a31_obj->f_ekeys = l11;
    _a31_obj->f_evals = l12;
    _a31_obj->f_index = l13;
    _a31_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a31_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a31_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l11 = (void*) _a31_obj;
    vader_array_t* _a32_arr = vader_array_new(8u, 0u, 0u, 176u);
    l12 = (void*) _a32_arr;
    vader_array_t* _a33_arr = vader_array_new(9u, 0u, 7u, 179u);
    l13 = (void*) _a33_arr;
    vader_array_t* _a34_arr = vader_array_new(9u, 0u, 7u, 179u);
    l14 = (void*) _a34_arr;
    ...
    vader_obj_header_init(_a35_obj, 367u);
    _a35_obj->f_ekeys = l12;
    _a35_obj->f_evals = l13;
    _a35_obj->f_index = l14;
    _a35_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a35_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a35_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l12 = (void*) _a35_obj;
    vader_array_t* _a36_arr = vader_array_new(36u, 0u, 13u, 507u);
    l13 = (void*) _a36_arr;
    vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 179u);
    l14 = (void*) _a37_arr;
    vader_array_t* _a38_arr = vader_array_new(9u, 0u, 7u, 179u);
    l15 = (void*) _a38_arr;
    vader_array_t* _a39_arr = vader_array_new(16u, 0u, 0u, 187u);
    l16 = (void*) _a39_arr;
    vader_array_t* _a40_arr = vader_array_new(9u, 0u, 7u, 179u);
    l17 = (void*) _a40_arr;
    ...
    vader_obj_header_init(_a41_obj, 291u);
    _a41_obj->f_ekeys = l15;
    _a41_obj->f_evals = l16;
    _a41_obj->f_index = l17;
    _a41_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a42_obj, 555u);
    _a42_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 260u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1226u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2205u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1959u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_6(2124u, l0, 259u, l1, 259u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
        ...
        loop_71: {
            if ((l12 < l8)) {
                ...
                if (l13.tag == 625u) {
                    ...
                    l17 = (t2 + INT32_C(1));
                    if ((size_t) l15 >= _a8_slotarr->length) { vader_trap("array index out of bounds"); }
    ...
    vader_obj_header_init(_a14_obj, 318u);
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 179u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(16u, 0u, 0u, 187u);
    l23 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a18_obj, 289u);
    ...
    vader_array_t* _a26_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(134u, 0u, 13u, 1149u);
    l4 = (void*) _a27_arr;
    vader_array_t* _a28_arr = vader_array_new(9u, 0u, 7u, 179u);
    l5 = (void*) _a28_arr;
    l1 = (size_t) (int64_t) INT64_C(0);
        ...
        loop_342: {
            if ((l1 < l8)) {
                ...
                if (VADER_LIKELY(_pc342_len < _pc342_cap)) {
                    ...
                    if (_pc342_hdr->buf->length < _pc342_len) { _pc342_hdr->buf->length = _pc342_len; }
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    void** gc_raw_roots[16] = { &l0, &l1, &l2, &l4, &l5, &l6, &l13, &l14, &l26, &l27, &l28, &l29, &l30, &l31, &l33, &t2 };
    vader_struct___Tuple_i32_bool_cd1657f9_t _a10_storage = {0};
    vader_struct___Tuple_i32_i32_3103e027_t _a59_storage = {0};
    vader_struct___Tuple_string_i32_4ccf6d4f_t _a68_storage = {0};
    void* gc_stack_objs[3] = { (void*) &_a10_storage, (void*) &_a59_storage, (void*) &_a68_storage };
    vader_string_t* gc_atom_roots[3] = { &l9, &l34, &t6 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 16u, gc_roots, gc_raw_roots, 3u, gc_stack_objs, 3u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_152: {
            if ((l11 >= l7)) {
                ...
                t3 = vader_box_bool(174u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l11]);
                l12 = t3.payload.b;
                vader_struct___Tuple_i32_bool_cd1657f9_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 237u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
                l10 = ((vader_struct___Tuple_i32_bool_cd1657f9_t*) t2)->f__0;
                t1 = (l11 + INT64_C(1));
                l11 = (size_t) (int64_t) t1;
    ...
    }
    {
        loop_185: {
            ...
            if ((t4 > INT64_C(0))) {
                ...
                {
                    vader_array_t* _pc210_hdr = (vader_array_t*) l6;
                    size_t _pc210_len = _pc210_hdr->length;
                    size_t _pc210_cap = (_pc210_hdr->offset == 0 && !vader_array_is_borrowed(_pc210_hdr) && _pc210_hdr->length >= _pc210_hdr->buf->length) ? _pc210_hdr->capacity : (size_t) 0;
                    void* _pc210_slots = _pc210_hdr->buf->slots;
                    loop_210: {
                        if ((l15 < l11)) {
                            ...
                            if (VADER_LIKELY(_pc210_len < _pc210_cap)) {
                                ((int32_t*) _pc210_slots)[_pc210_len] = (int32_t) (l10);
                                _pc210_len += 1;
                            } else {
                                _pc210_hdr->length = _pc210_len;
                                if (_pc210_hdr->buf->length < _pc210_len) { _pc210_hdr->buf->length = _pc210_len; }
                                vader_array_push_i32((vader_array_t*) l6, l10);
                                _pc210_hdr = (vader_array_t*) l6;
                                _pc210_len = _pc210_hdr->length;
                                _pc210_cap = (_pc210_hdr->offset == 0 && !vader_array_is_borrowed(_pc210_hdr) && _pc210_hdr->length >= _pc210_hdr->buf->length) ? _pc210_hdr->capacity : (size_t) 0;
                                _pc210_slots = _pc210_hdr->buf->slots;
                            }
                            t1 = (l15 + INT64_C(1));
    ...
    vader_array_t* _a17_arr = vader_array_new(8u, 0u, 0u, 176u);
    l5 = (void*) _a17_arr;
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 179u);
    l6 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(9u, 0u, 7u, 179u);
    l13 = (void*) _a19_arr;
    ...
    vader_obj_header_init(_a20_obj, 367u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 179u);
    l5 = (void*) _a26_arr;
    ...
    vader_obj_header_init(_a29_obj, 319u);
    _a29_obj->f_ekeys = l5;
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(38u, 0u, 13u, 510u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_545: {
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        vader_array_t* _pc615_hdr = (vader_array_t*) l14;
        size_t _pc615_len = _pc615_hdr->length;
        size_t _pc615_cap = (_pc615_hdr->offset == 0 && !vader_array_is_borrowed(_pc615_hdr) && _pc615_hdr->length >= _pc615_hdr->buf->length) ? _pc615_hdr->capacity : (size_t) 0;
        void* _pc615_slots = _pc615_hdr->buf->slots;
        loop_615: {
            if ((l7 < l3)) {
                l8 = -(INT32_C(1));
                if (l12) {
                ...
                if (VADER_LIKELY(_pc615_len < _pc615_cap)) {
                    ((int32_t*) _pc615_slots)[_pc615_len] = (int32_t) (l8);
                    _pc615_len += 1;
                } else {
                    _pc615_hdr->length = _pc615_len;
                    if (_pc615_hdr->buf->length < _pc615_len) { _pc615_hdr->buf->length = _pc615_len; }
                    vader_array_push_i32((vader_array_t*) l14, l8);
                    _pc615_hdr = (vader_array_t*) l14;
                    _pc615_len = _pc615_hdr->length;
                    _pc615_cap = (_pc615_hdr->offset == 0 && !vader_array_is_borrowed(_pc615_hdr) && _pc615_hdr->length >= _pc615_hdr->buf->length) ? _pc615_hdr->capacity : (size_t) 0;
                    _pc615_slots = _pc615_hdr->buf->slots;
                }
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                goto loop_615;
                    ...
                    loop_687: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 543u) {
                                ...
                                vader_obj_header_init(_a38_obj, 543u);
                                ...
                                vader_array_ref_store(_a39_slotarr->buf, _a39_slotarr->offset + (size_t) l15, l26);
                            ...
                            if (l19.tag == 572u) {
                                ...
                                vader_obj_header_init(_a41_obj, 572u);
                                _a41_obj->f_function_index = l8;
                                _a41_obj->f_type_id = l10;
                                l28 = (void*) _a41_obj;
                                vader_array_t* _a42_slotarr = ((vader_array_t*) l27);
                                ...
                                vader_array_ref_store(_a42_slotarr->buf, _a42_slotarr->offset + (size_t) l15, l28);
                            ...
                            if (l19.tag == 571u) {
                                ...
                                t5 = ((int32_t*) _a43_slotarr->buf->slots)[_a43_slotarr->offset + (size_t) l18];
                                vader_struct_vader_bytecode_FnAddr_t* _a44_obj = (vader_struct_vader_bytecode_FnAddr_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_FnAddr_t));
                                vader_obj_header_init(_a44_obj, 571u);
                                _a44_obj->f_function_index = t5;
                                l30 = (void*) _a44_obj;
                                vader_array_t* _a45_slotarr = ((vader_array_t*) l29);
                                ...
                                vader_array_ref_store(_a45_slotarr->buf, _a45_slotarr->offset + (size_t) l15, l30);
                            ...
                            if (l19.tag == 627u) {
                                ...
                                vader_array_t* _a46_slotarr = ((vader_array_t*) l14);
                                ...
                                l20 = ((int32_t*) _a46_slotarr->buf->slots)[_a46_slotarr->offset + (size_t) l32];
                                t2 = l19.payload.obj;
                                l24 = ((vader_struct_vader_bytecode_MakeClosure_t*) t2)->f_env_type_id;
                                vader_struct_vader_bytecode_MakeClosure_t* _a47_obj = (vader_struct_vader_bytecode_MakeClosure_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_MakeClosure_t));
                                vader_obj_header_init(_a47_obj, 627u);
                                _a47_obj->f_function_index = l20;
                                _a47_obj->f_env_type_id = l24;
                                l33 = (void*) _a47_obj;
                                vader_array_t* _a48_slotarr = ((vader_array_t*) l31);
                                if (_a48_slotarr->buf != NULL && _a48_slotarr->buf->header.forward != NULL) { _a48_slotarr->buf = vader_array_buf_forward(_a48_slotarr->buf); }
                                if ((size_t) l15 >= _a48_slotarr->length) { vader_trap("array index out of bounds"); }
                                vader_array_ref_store(_a48_slotarr->buf, _a48_slotarr->offset + (size_t) l15, l33);
    ...
    vader_array_t* _a49_arr = vader_array_new(36u, 0u, 13u, 507u);
    l4 = (void*) _a49_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_820: {
            if ((l7 < l3)) {
                vader_array_t* _a50_slotarr = ((vader_array_t*) l5);
                if (_a50_slotarr->buf != NULL && _a50_slotarr->buf->header.forward != NULL) { _a50_slotarr->buf = vader_array_buf_forward(_a50_slotarr->buf); }
                if ((size_t) l7 >= _a50_slotarr->length) { vader_trap("array index out of bounds"); }
                l6 = vader_array_ref_load_obj(_a50_slotarr->buf, _a50_slotarr->offset + (size_t) l7);
                ...
                l8 = ((int32_t*) _a51_slotarr->buf->slots)[_a51_slotarr->offset + (size_t) l11];
                if ((l8 >= INT32_C(0))) {
                    t6 = ((vader_struct_vader_bytecode_BcExport_t*) l6)->f_extern_name;
                    vader_struct_vader_bytecode_BcExport_t* _a52_obj = (vader_struct_vader_bytecode_BcExport_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcExport_t));
                    vader_obj_header_init(_a52_obj, 507u);
                    _a52_obj->f_extern_name = t6;
                    _a52_obj->f_fn_index = l8;
                    l26 = (void*) _a52_obj;
    ...
    vader_array_t* _a53_arr = vader_array_new(9u, 0u, 7u, 179u);
    l4 = (void*) _a53_arr;
    vader_array_t* _a54_arr = vader_array_new(9u, 0u, 7u, 179u);
    l5 = (void*) _a54_arr;
    vader_array_t* _a55_arr = vader_array_new(9u, 0u, 7u, 179u);
    l6 = (void*) _a55_arr;
    vader_struct_std_collections_MutableMap__i32__i32_t* _a56_obj = (vader_struct_std_collections_MutableMap__i32__i32_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__i32_t));
    vader_obj_header_init(_a56_obj, 319u);
    _a56_obj->f_ekeys = l4;
    _a56_obj->f_evals = l5;
    _a56_obj->f_index = l6;
    _a56_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a56_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a56_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l4 = (void*) _a56_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_886: {
            if ((l7 >= l3)) {
                ...
                vader_array_t* _a57_slotarr = ((vader_array_t*) l6);
                if (_a57_slotarr->buf != NULL && _a57_slotarr->buf->header.forward != NULL) { _a57_slotarr->buf = vader_array_buf_forward(_a57_slotarr->buf); }
                if ((size_t) l7 >= _a57_slotarr->length) { vader_trap("array index out of bounds"); }
                l8 = ((int32_t*) _a57_slotarr->buf->slots)[_a57_slotarr->offset + (size_t) l7];
                vader_array_t* _a58_slotarr = ((vader_array_t*) l26);
                if (_a58_slotarr->buf != NULL && _a58_slotarr->buf->header.forward != NULL) { _a58_slotarr->buf = vader_array_buf_forward(_a58_slotarr->buf); }
                if ((size_t) l7 >= _a58_slotarr->length) { vader_trap("array index out of bounds"); }
                l10 = ((int32_t*) _a58_slotarr->buf->slots)[_a58_slotarr->offset + (size_t) l7];
                vader_struct___Tuple_i32_i32_3103e027_t* _a60_obj = &_a59_storage;
                vader_obj_header_init(_a60_obj, 238u);
                _a60_obj->f__0 = l8;
                _a60_obj->f__1 = l10;
                l5 = (void*) _a60_obj;
                l20 = ((vader_struct___Tuple_i32_i32_3103e027_t*) l5)->f__0;
                l24 = ((vader_struct___Tuple_i32_i32_3103e027_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l24);
                l11 = (size_t) (int64_t) t1;
                vader_array_t* _a61_slotarr = ((vader_array_t*) l14);
                if (_a61_slotarr->buf != NULL && _a61_slotarr->buf->header.forward != NULL) { _a61_slotarr->buf = vader_array_buf_forward(_a61_slotarr->buf); }
                if ((size_t) l11 >= _a61_slotarr->length) { vader_trap("array index out of bounds"); }
                l25 = ((int32_t*) _a61_slotarr->buf->slots)[_a61_slotarr->offset + (size_t) l11];
                if ((l25 >= INT32_C(0))) {
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a62_arr = vader_array_new(8u, 0u, 0u, 176u);
    l4 = (void*) _a62_arr;
    vader_array_t* _a63_arr = vader_array_new(9u, 0u, 7u, 179u);
    l5 = (void*) _a63_arr;
    vader_array_t* _a64_arr = vader_array_new(9u, 0u, 7u, 179u);
    l6 = (void*) _a64_arr;
    vader_struct_std_collections_MutableMap__string__i32_t* _a65_obj = (vader_struct_std_collections_MutableMap__string__i32_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__string__i32_t));
    vader_obj_header_init(_a65_obj, 367u);
    _a65_obj->f_ekeys = l4;
    _a65_obj->f_evals = l5;
    _a65_obj->f_index = l6;
    _a65_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a65_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a65_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l4 = (void*) _a65_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_962: {
            if ((l7 >= l3)) {
                ...
                vader_array_t* _a66_slotarr = ((vader_array_t*) l6);
                if (_a66_slotarr->buf != NULL && _a66_slotarr->buf->header.forward != NULL) { _a66_slotarr->buf = vader_array_buf_forward(_a66_slotarr->buf); }
                if ((size_t) l7 >= _a66_slotarr->length) { vader_trap("array index out of bounds"); }
                t3 = vader_array_box_slots(_a66_slotarr->buf)[_a66_slotarr->offset + (size_t) l7];
                l9 = t3.payload.s;
                vader_array_t* _a67_slotarr = ((vader_array_t*) l26);
                if (_a67_slotarr->buf != NULL && _a67_slotarr->buf->header.forward != NULL) { _a67_slotarr->buf = vader_array_buf_forward(_a67_slotarr->buf); }
                if ((size_t) l7 >= _a67_slotarr->length) { vader_trap("array index out of bounds"); }
                l8 = ((int32_t*) _a67_slotarr->buf->slots)[_a67_slotarr->offset + (size_t) l7];
                vader_struct___Tuple_string_i32_4ccf6d4f_t* _a69_obj = &_a68_storage;
                vader_obj_header_init(_a69_obj, 242u);
                _a69_obj->f__0 = l9;
                _a69_obj->f__1 = l8;
                l5 = (void*) _a69_obj;
                l34 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l5)->f__0;
                l10 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                ...
                if ((size_t) l11 >= _a70_slotarr->length) { vader_trap("array index out of bounds"); }
                l20 = ((int32_t*) _a70_slotarr->buf->slots)[_a70_slotarr->offset + (size_t) l11];
                if ((l20 >= INT32_C(0))) {
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a71_arr = vader_array_new(9u, 0u, 7u, 179u);
    l4 = (void*) _a71_arr;
    vader_array_t* _a72_arr = vader_array_new(16u, 0u, 0u, 187u);
    l5 = (void*) _a72_arr;
    vader_array_t* _a73_arr = vader_array_new(9u, 0u, 7u, 179u);
    l6 = (void*) _a73_arr;
    vader_struct_std_collections_MutableMap__i32__Any___t* _a74_obj = (vader_struct_std_collections_MutableMap__i32__Any___t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__i32__Any___t));
    vader_obj_header_init(_a74_obj, 291u);
    _a74_obj->f_ekeys = l4;
    _a74_obj->f_evals = l5;
    _a74_obj->f_index = l6;
    _a74_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a74_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a74_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l4 = (void*) _a74_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1039: {
            if ((l7 >= l3)) {
                ...
                vader_array_t* _a75_slotarr = ((vader_array_t*) l6);
                if (_a75_slotarr->buf != NULL && _a75_slotarr->buf->header.forward != NULL) { _a75_slotarr->buf = vader_array_buf_forward(_a75_slotarr->buf); }
                if ((size_t) l7 >= _a75_slotarr->length) { vader_trap("array index out of bounds"); }
                l8 = ((int32_t*) _a75_slotarr->buf->slots)[_a75_slotarr->offset + (size_t) l7];
                vader_array_t* _a76_slotarr = ((vader_array_t*) l26);
                if (_a76_slotarr->buf != NULL && _a76_slotarr->buf->header.forward != NULL) { _a76_slotarr->buf = vader_array_buf_forward(_a76_slotarr->buf); }
                if ((size_t) l7 >= _a76_slotarr->length) { vader_trap("array index out of bounds"); }
                l5 = vader_array_ref_load_obj(_a76_slotarr->buf, _a76_slotarr->offset + (size_t) l7);
                vader_struct___Tuple_i32_Array_i32__9e989074_t* _a77_obj = (vader_struct___Tuple_i32_Array_i32__9e989074_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i32_Array_i32__9e989074_t));
                vader_obj_header_init(_a77_obj, 235u);
                _a77_obj->f__0 = l8;
                _a77_obj->f__1 = l5;
                l27 = (void*) _a77_obj;
                l10 = ((vader_struct___Tuple_i32_Array_i32__9e989074_t*) l27)->f__0;
                l28 = ((vader_struct___Tuple_i32_Array_i32__9e989074_t*) l27)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
                ...
                t1 = ((int64_t) (int32_t) l10);
                l16 = (size_t) (int64_t) t1;
                vader_array_t* _a78_slotarr = ((vader_array_t*) l14);
                if (_a78_slotarr->buf != NULL && _a78_slotarr->buf->header.forward != NULL) { _a78_slotarr->buf = vader_array_buf_forward(_a78_slotarr->buf); }
                if ((size_t) l16 >= _a78_slotarr->length) { vader_trap("array index out of bounds"); }
                l20 = ((int32_t*) _a78_slotarr->buf->slots)[_a78_slotarr->offset + (size_t) l16];
                if ((l20 < INT32_C(0))) {
                    goto loop_1039;
                }
                ...
                if (l19.tag == 9u) {
                    ...
                    l18 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_1106: {
                            if ((l18 < l17)) {
                                vader_array_t* _a79_slotarr = ((vader_array_t*) l30);
                                if (_a79_slotarr->buf != NULL && _a79_slotarr->buf->header.forward != NULL) { _a79_slotarr->buf = vader_array_buf_forward(_a79_slotarr->buf); }
                                if ((size_t) l18 >= _a79_slotarr->length) { vader_trap("array index out of bounds"); }
                                l24 = ((int32_t*) _a79_slotarr->buf->slots)[_a79_slotarr->offset + (size_t) l18];
                    ...
                    std_collections_MutableMap_IndexSet_set_at__i32__Any(l4, l20, vader_ref_box(l28));
                }
                goto loop_1039;
            }
        }
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(39u, 0u, 13u, 511u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_160: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 544u) {
                                ...
                                if ((size_t) l14 >= _a11_slotarr->length) { vader_trap("array index out of bounds"); }
                                ...
                                vader_obj_header_init(_a12_obj, 544u);
                                _a12_obj->f_index = t4;
                                l15 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    void* l32 = NULL;
    void* l37 = NULL;
    size_t l4, l5, l8, l9, l12, l13, l16, l17;
    int32_t l10, l14, l18, l26, l27, l29, l33, l34, l35, l36;
    vader_box_t l19 = vader_box_null(), l38 = vader_box_null();
    ...
    bool t4;
    size_t t5;
    vader_box_t* gc_roots[3] = { &l19, &l38, &t2 };
    void** gc_raw_roots[17] = { &l0, &l1, &l2, &l3, &l6, &l7, &l11, &l15, &l23, &l24, &l25, &l28, &l30, &l31, &l32, &l37, &t0 };
    vader_struct___Tuple_i32_Array_i32__9e989074_t _a16_storage = {0};
    vader_struct___Tuple_string_i32_4ccf6d4f_t _a42_storage = {0};
    void* gc_stack_objs[2] = { (void*) &_a16_storage, (void*) &_a42_storage };
    vader_string_t* gc_atom_roots[4] = { &l20, &l21, &l22, &l40 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 3u, 17u, gc_roots, gc_raw_roots, 2u, gc_stack_objs, 4u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(9u, 0u, 7u, 179u);
    l1 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 174u);
    ...
    vader_obj_header_init(_a4_obj, 386u);
    _a4_obj->f_inner = t0;
    l1 = (void*) _a4_obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_27: {
            if ((l5 < l4)) {
                ...
                l9 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc44_hdr = (vader_array_t*) l2;
                    size_t _pc44_len = _pc44_hdr->length;
                    size_t _pc44_cap = (_pc44_hdr->offset == 0 && !vader_array_is_borrowed(_pc44_hdr) && _pc44_hdr->length >= _pc44_hdr->buf->length) ? _pc44_hdr->capacity : (size_t) 0;
                    void* _pc44_slots = _pc44_hdr->buf->slots;
                    loop_44: {
                        if ((l9 < l8)) {
                            vader_array_t* _a7_slotarr = ((vader_array_t*) l7);
                            if (_a7_slotarr->buf != NULL && _a7_slotarr->buf->header.forward != NULL) { _a7_slotarr->buf = vader_array_buf_forward(_a7_slotarr->buf); }
                            if ((size_t) l9 >= _a7_slotarr->length) { vader_trap("array index out of bounds"); }
                            l10 = ((int32_t*) _a7_slotarr->buf->slots)[_a7_slotarr->offset + (size_t) l9];
                            if (VADER_LIKELY(_pc44_len < _pc44_cap)) {
                                ((int32_t*) _pc44_slots)[_pc44_len] = (int32_t) (l10);
                                _pc44_len += 1;
                            } else {
                                _pc44_hdr->length = _pc44_len;
                                if (_pc44_hdr->buf->length < _pc44_len) { _pc44_hdr->buf->length = _pc44_len; }
                                vader_array_push_i32((vader_array_t*) l2, l10);
                                _pc44_hdr = (vader_array_t*) l2;
                                _pc44_len = _pc44_hdr->length;
                                _pc44_cap = (_pc44_hdr->offset == 0 && !vader_array_is_borrowed(_pc44_hdr) && _pc44_hdr->length >= _pc44_hdr->buf->length) ? _pc44_hdr->capacity : (size_t) 0;
                                _pc44_slots = _pc44_hdr->buf->slots;
                            }
                            t1 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t1;
                            goto loop_44;
                ...
                l11 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l6)->f_signature)->f_param_types;
                l12 = ((vader_array_t*) l11)->length;
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc72_hdr = (vader_array_t*) l2;
                    size_t _pc72_len = _pc72_hdr->length;
                    size_t _pc72_cap = (_pc72_hdr->offset == 0 && !vader_array_is_borrowed(_pc72_hdr) && _pc72_hdr->length >= _pc72_hdr->buf->length) ? _pc72_hdr->capacity : (size_t) 0;
                    void* _pc72_slots = _pc72_hdr->buf->slots;
                    loop_72: {
                        if ((l13 < l12)) {
                            vader_array_t* _a8_slotarr = ((vader_array_t*) l11);
                            if (_a8_slotarr->buf != NULL && _a8_slotarr->buf->header.forward != NULL) { _a8_slotarr->buf = vader_array_buf_forward(_a8_slotarr->buf); }
                            if ((size_t) l13 >= _a8_slotarr->length) { vader_trap("array index out of bounds"); }
                            l14 = ((int32_t*) _a8_slotarr->buf->slots)[_a8_slotarr->offset + (size_t) l13];
                            if (VADER_LIKELY(_pc72_len < _pc72_cap)) {
                                ((int32_t*) _pc72_slots)[_pc72_len] = (int32_t) (l14);
                                _pc72_len += 1;
                            } else {
                                _pc72_hdr->length = _pc72_len;
                                if (_pc72_hdr->buf->length < _pc72_len) { _pc72_hdr->buf->length = _pc72_len; }
                                vader_array_push_i32((vader_array_t*) l2, l14);
                                _pc72_hdr = (vader_array_t*) l2;
                                _pc72_len = _pc72_hdr->length;
                                _pc72_cap = (_pc72_hdr->offset == 0 && !vader_array_is_borrowed(_pc72_hdr) && _pc72_hdr->length >= _pc72_hdr->buf->length) ? _pc72_hdr->capacity : (size_t) 0;
                                _pc72_slots = _pc72_hdr->buf->slots;
                            }
                            t1 = (l13 + INT64_C(1));
                ...
                l15 = ((vader_struct_vader_bytecode_BcFunction_t*) l6)->f_body;
                l16 = ((vader_array_t*) l15)->length;
                l17 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc99_hdr = (vader_array_t*) l2;
                    size_t _pc99_len = _pc99_hdr->length;
                    size_t _pc99_cap = (_pc99_hdr->offset == 0 && !vader_array_is_borrowed(_pc99_hdr) && _pc99_hdr->length >= _pc99_hdr->buf->length) ? _pc99_hdr->capacity : (size_t) 0;
                    void* _pc99_slots = _pc99_hdr->buf->slots;
                    loop_99: {
                        if ((l17 < l16)) {
                            vader_array_t* _a9_slotarr = ((vader_array_t*) l15);
                            if (_a9_slotarr->buf != NULL && _a9_slotarr->buf->header.forward != NULL) { _a9_slotarr->buf = vader_array_buf_forward(_a9_slotarr->buf); }
                            if ((size_t) l17 >= _a9_slotarr->length) { vader_trap("array index out of bounds"); }
                            t2 = vader_array_ref_load_box(_a9_slotarr->buf, _a9_slotarr->offset + (size_t) l17);
                            l18 = vader_bytecode_type_index_of(t2);
                            if ((l18 >= INT32_C(0))) {
                                if (VADER_LIKELY(_pc99_len < _pc99_cap)) {
                                    ((int32_t*) _pc99_slots)[_pc99_len] = (int32_t) (l18);
                                    _pc99_len += 1;
                                } else {
                                    _pc99_hdr->length = _pc99_len;
                                    if (_pc99_hdr->buf->length < _pc99_len) { _pc99_hdr->buf->length = _pc99_len; }
                                    vader_array_push_i32((vader_array_t*) l2, l18);
                                    _pc99_hdr = (vader_array_t*) l2;
                                    _pc99_len = _pc99_hdr->length;
                                    _pc99_cap = (_pc99_hdr->offset == 0 && !vader_array_is_borrowed(_pc99_hdr) && _pc99_hdr->length >= _pc99_hdr->buf->length) ? _pc99_hdr->capacity : (size_t) 0;
                                    _pc99_slots = _pc99_hdr->buf->slots;
                                }
                            }
                            t1 = (l17 + INT64_C(1));
                            l17 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_139: {
            if ((l5 < l4)) {
                ...
                l6 = vader_array_ref_load_obj(_a10_slotarr->buf, _a10_slotarr->offset + (size_t) l5);
                l7 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_result_types;
                l8 = ((vader_array_t*) l7)->length;
                l9 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc156_hdr = (vader_array_t*) l2;
                    size_t _pc156_len = _pc156_hdr->length;
                    size_t _pc156_cap = (_pc156_hdr->offset == 0 && !vader_array_is_borrowed(_pc156_hdr) && _pc156_hdr->length >= _pc156_hdr->buf->length) ? _pc156_hdr->capacity : (size_t) 0;
                    void* _pc156_slots = _pc156_hdr->buf->slots;
                    loop_156: {
                        if ((l9 < l8)) {
                            vader_array_t* _a11_slotarr = ((vader_array_t*) l7);
                            if (_a11_slotarr->buf != NULL && _a11_slotarr->buf->header.forward != NULL) { _a11_slotarr->buf = vader_array_buf_forward(_a11_slotarr->buf); }
                            if ((size_t) l9 >= _a11_slotarr->length) { vader_trap("array index out of bounds"); }
                            l10 = ((int32_t*) _a11_slotarr->buf->slots)[_a11_slotarr->offset + (size_t) l9];
                            if (VADER_LIKELY(_pc156_len < _pc156_cap)) {
                                ((int32_t*) _pc156_slots)[_pc156_len] = (int32_t) (l10);
                                _pc156_len += 1;
                            } else {
                                _pc156_hdr->length = _pc156_len;
                                if (_pc156_hdr->buf->length < _pc156_len) { _pc156_hdr->buf->length = _pc156_len; }
                                vader_array_push_i32((vader_array_t*) l2, l10);
                                _pc156_hdr = (vader_array_t*) l2;
                                _pc156_len = _pc156_hdr->length;
                                _pc156_cap = (_pc156_hdr->offset == 0 && !vader_array_is_borrowed(_pc156_hdr) && _pc156_hdr->length >= _pc156_hdr->buf->length) ? _pc156_hdr->capacity : (size_t) 0;
                                _pc156_slots = _pc156_hdr->buf->slots;
                            }
                            t1 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t1;
                            goto loop_156;
                ...
                l11 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_types;
                l12 = ((vader_array_t*) l11)->length;
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc184_hdr = (vader_array_t*) l2;
                    size_t _pc184_len = _pc184_hdr->length;
                    size_t _pc184_cap = (_pc184_hdr->offset == 0 && !vader_array_is_borrowed(_pc184_hdr) && _pc184_hdr->length >= _pc184_hdr->buf->length) ? _pc184_hdr->capacity : (size_t) 0;
                    void* _pc184_slots = _pc184_hdr->buf->slots;
                    loop_184: {
                        if ((l13 < l12)) {
                            vader_array_t* _a12_slotarr = ((vader_array_t*) l11);
                            if (_a12_slotarr->buf != NULL && _a12_slotarr->buf->header.forward != NULL) { _a12_slotarr->buf = vader_array_buf_forward(_a12_slotarr->buf); }
                            if ((size_t) l13 >= _a12_slotarr->length) { vader_trap("array index out of bounds"); }
                            l14 = ((int32_t*) _a12_slotarr->buf->slots)[_a12_slotarr->offset + (size_t) l13];
                            if (VADER_LIKELY(_pc184_len < _pc184_cap)) {
                                ((int32_t*) _pc184_slots)[_pc184_len] = (int32_t) (l14);
                                _pc184_len += 1;
                            } else {
                                _pc184_hdr->length = _pc184_len;
                                if (_pc184_hdr->buf->length < _pc184_len) { _pc184_hdr->buf->length = _pc184_len; }
                                vader_array_push_i32((vader_array_t*) l2, l14);
                                _pc184_hdr = (vader_array_t*) l2;
                                _pc184_len = _pc184_hdr->length;
                                _pc184_cap = (_pc184_hdr->offset == 0 && !vader_array_is_borrowed(_pc184_hdr) && _pc184_hdr->length >= _pc184_hdr->buf->length) ? _pc184_hdr->capacity : (size_t) 0;
                                _pc184_slots = _pc184_hdr->buf->slots;
                            }
                            t1 = (l13 + INT64_C(1));
                            l13 = (size_t) (int64_t) t1;
                            goto loop_184;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        vader_array_t* _pc219_hdr = (vader_array_t*) l2;
        size_t _pc219_len = _pc219_hdr->length;
        size_t _pc219_cap = (_pc219_hdr->offset == 0 && !vader_array_is_borrowed(_pc219_hdr) && _pc219_hdr->length >= _pc219_hdr->buf->length) ? _pc219_hdr->capacity : (size_t) 0;
        void* _pc219_slots = _pc219_hdr->buf->slots;
        loop_219: {
            if ((l5 < l4)) {
                vader_array_t* _a13_slotarr = ((vader_array_t*) l3);
                if (_a13_slotarr->buf != NULL && _a13_slotarr->buf->header.forward != NULL) { _a13_slotarr->buf = vader_array_buf_forward(_a13_slotarr->buf); }
                if ((size_t) l5 >= _a13_slotarr->length) { vader_trap("array index out of bounds"); }
                l10 = ((int32_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l5];
                if (VADER_LIKELY(_pc219_len < _pc219_cap)) {
                    ((int32_t*) _pc219_slots)[_pc219_len] = (int32_t) (l10);
                    _pc219_len += 1;
                } else {
                    _pc219_hdr->length = _pc219_len;
                    if (_pc219_hdr->buf->length < _pc219_len) { _pc219_hdr->buf->length = _pc219_len; }
                    vader_array_push_i32((vader_array_t*) l2, l10);
                    _pc219_hdr = (vader_array_t*) l2;
                    _pc219_len = _pc219_hdr->length;
                    _pc219_cap = (_pc219_hdr->offset == 0 && !vader_array_is_borrowed(_pc219_hdr) && _pc219_hdr->length >= _pc219_hdr->buf->length) ? _pc219_hdr->capacity : (size_t) 0;
                    _pc219_slots = _pc219_hdr->buf->slots;
                }
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
                goto loop_219;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_251: {
            if ((l5 >= l4)) {
                ...
                vader_array_t* _a15_slotarr = ((vader_array_t*) l7);
                if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                if ((size_t) l5 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                l3 = vader_array_ref_load_obj(_a15_slotarr->buf, _a15_slotarr->offset + (size_t) l5);
                vader_struct___Tuple_i32_Array_i32__9e989074_t* _a17_obj = &_a16_storage;
                vader_obj_header_init(_a17_obj, 235u);
                _a17_obj->f__0 = l10;
                _a17_obj->f__1 = l3;
                t0 = (void*) _a17_obj;
                l11 = ((vader_struct___Tuple_i32_Array_i32__9e989074_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
                l8 = ((vader_array_t*) l11)->length;
                l9 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc280_hdr = (vader_array_t*) l2;
                    size_t _pc280_len = _pc280_hdr->length;
                    size_t _pc280_cap = (_pc280_hdr->offset == 0 && !vader_array_is_borrowed(_pc280_hdr) && _pc280_hdr->length >= _pc280_hdr->buf->length) ? _pc280_hdr->capacity : (size_t) 0;
                    void* _pc280_slots = _pc280_hdr->buf->slots;
                    loop_280: {
                        if ((l9 < l8)) {
                            vader_array_t* _a18_slotarr = ((vader_array_t*) l11);
                            if (_a18_slotarr->buf != NULL && _a18_slotarr->buf->header.forward != NULL) { _a18_slotarr->buf = vader_array_buf_forward(_a18_slotarr->buf); }
                            if ((size_t) l9 >= _a18_slotarr->length) { vader_trap("array index out of bounds"); }
                            l14 = ((int32_t*) _a18_slotarr->buf->slots)[_a18_slotarr->offset + (size_t) l9];
                            if (VADER_LIKELY(_pc280_len < _pc280_cap)) {
                                ((int32_t*) _pc280_slots)[_pc280_len] = (int32_t) (l14);
                                _pc280_len += 1;
                            } else {
                                _pc280_hdr->length = _pc280_len;
                                if (_pc280_hdr->buf->length < _pc280_len) { _pc280_hdr->buf->length = _pc280_len; }
                                vader_array_push_i32((vader_array_t*) l2, l14);
                                _pc280_hdr = (vader_array_t*) l2;
                                _pc280_len = _pc280_hdr->length;
                                _pc280_cap = (_pc280_hdr->offset == 0 && !vader_array_is_borrowed(_pc280_hdr) && _pc280_hdr->length >= _pc280_hdr->buf->length) ? _pc280_hdr->capacity : (size_t) 0;
                                _pc280_slots = _pc280_hdr->buf->slots;
                            }
                            t1 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t1;
                            goto loop_280;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_310: {
            if ((l5 < l4)) {
                ...
                t3 = ((int32_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l5];
    ...
    vader_array_t* _a20_arr = vader_array_new(9u, 0u, 7u, 179u);
    l2 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(132u, 0u, 13u, 1127u);
    l3 = (void*) _a21_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_351: {
            if ((l5 < l4)) {
                ...
                t4 = std_collections_MutableSet_Contains_contains__i32(l1, l10);
                if (t4) {
                    t5 = ((vader_array_t*) l3)->length;
                    l14 = ((int32_t) (size_t) t5);
                    vader_array_push_i32((vader_array_t*) l2, l14);
                    vader_array_t* _a22_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_types);
                    if (_a22_slotarr->buf != NULL && _a22_slotarr->buf->header.forward != NULL) { _a22_slotarr->buf = vader_array_buf_forward(_a22_slotarr->buf); }
                    if ((size_t) l5 >= _a22_slotarr->length) { vader_trap("array index out of bounds"); }
                    l19 = vader_array_ref_load_box(_a22_slotarr->buf, _a22_slotarr->offset + (size_t) l5);
                    vader_array_push((vader_array_t*) l3, l19);
                } else {
                    l18 = -(INT32_C(1));
                    vader_array_push_i32((vader_array_t*) l2, l18);
                }
    ...
    vader_array_t* _a23_arr = vader_array_new(132u, 0u, 13u, 1127u);
    l1 = (void*) _a23_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_401: {
            if ((l5 < l4)) {
                ...
                l19 = vader_array_ref_load_box(_a24_slotarr->buf, _a24_slotarr->offset + (size_t) l5);
                if (l19.tag == 520u) {
                    vader_array_t* _a25_arr = vader_array_new(37u, 0u, 13u, 508u);
                    l6 = (void*) _a25_arr;
                    t0 = l19.payload.obj;
                    ...
                    l9 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_423: {
                            if ((l9 < l8)) {
                                vader_array_t* _a26_slotarr = ((vader_array_t*) l7);
                                if (_a26_slotarr->buf != NULL && _a26_slotarr->buf->header.forward != NULL) { _a26_slotarr->buf = vader_array_buf_forward(_a26_slotarr->buf); }
                                if ((size_t) l9 >= _a26_slotarr->length) { vader_trap("array index out of bounds"); }
                                l11 = vader_array_ref_load_obj(_a26_slotarr->buf, _a26_slotarr->offset + (size_t) l9);
                                l20 = ((vader_struct_vader_bytecode_BcField_t*) l11)->f_name;
                                l10 = ((vader_struct_vader_bytecode_BcField_t*) l11)->f_type_index;
                                l14 = vader_bytecode_remap_idx(l2, l10);
                                vader_struct_vader_bytecode_BcField_t* _a27_obj = (vader_struct_vader_bytecode_BcField_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcField_t));
                                vader_obj_header_init(_a27_obj, 508u);
                                _a27_obj->f_name = l20;
                                _a27_obj->f_type_index = l14;
                                l15 = (void*) _a27_obj;
                                vader_array_push((vader_array_t*) l6, vader_ref_box(l15));
                                t1 = (l9 + INT64_C(1));
                                l9 = (size_t) (int64_t) t1;
                                goto loop_423;
                            }
                    ...
                    t0 = l19.payload.obj;
                    l21 = ((vader_struct_vader_bytecode_BcStruct_t*) t0)->f_name;
                    t0 = l19.payload.obj;
                    l22 = ((vader_struct_vader_bytecode_BcStruct_t*) t0)->f_c_name;
                    t0 = l19.payload.obj;
                    l18 = ((vader_struct_vader_bytecode_BcStruct_t*) t0)->f_symbol_id;
                    vader_struct_vader_bytecode_BcStruct_t* _a28_obj = (vader_struct_vader_bytecode_BcStruct_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcStruct_t));
                    vader_obj_header_init(_a28_obj, 520u);
                    _a28_obj->f_name = l21;
                    _a28_obj->f_fields = l6;
                    _a28_obj->f_c_name = l22;
                    _a28_obj->f_symbol_id = l18;
                    l23 = (void*) _a28_obj;
                    ...
                    if (l19.tag == 521u) {
                        ...
                        l24 = (void*) _a29_arr;
                        t0 = l19.payload.obj;
                        l25 = ((vader_struct_vader_bytecode_BcUnion_t*) t0)->f_variants;
                        l12 = ((vader_array_t*) l25)->length;
                        l13 = (size_t) (int64_t) INT64_C(0);
                        {
                            vader_array_t* _pc496_hdr = (vader_array_t*) l24;
                            size_t _pc496_len = _pc496_hdr->length;
                            size_t _pc496_cap = (_pc496_hdr->offset == 0 && !vader_array_is_borrowed(_pc496_hdr) && _pc496_hdr->length >= _pc496_hdr->buf->length) ? _pc496_hdr->capacity : (size_t) 0;
                            void* _pc496_slots = _pc496_hdr->buf->slots;
                            loop_496: {
                                if ((l13 < l12)) {
                                    vader_array_t* _a30_slotarr = ((vader_array_t*) l25);
                                    if (_a30_slotarr->buf != NULL && _a30_slotarr->buf->header.forward != NULL) { _a30_slotarr->buf = vader_array_buf_forward(_a30_slotarr->buf); }
                                    if ((size_t) l13 >= _a30_slotarr->length) { vader_trap("array index out of bounds"); }
                                    l26 = ((int32_t*) _a30_slotarr->buf->slots)[_a30_slotarr->offset + (size_t) l13];
                                    l27 = vader_bytecode_remap_idx(l2, l26);
                                    if (VADER_LIKELY(_pc496_len < _pc496_cap)) {
                                        ((int32_t*) _pc496_slots)[_pc496_len] = (int32_t) (l27);
                                        _pc496_len += 1;
                                    } else {
                                        _pc496_hdr->length = _pc496_len;
                                        if (_pc496_hdr->buf->length < _pc496_len) { _pc496_hdr->buf->length = _pc496_len; }
                                        vader_array_push_i32((vader_array_t*) l24, l27);
                                        _pc496_hdr = (vader_array_t*) l24;
                                        _pc496_len = _pc496_hdr->length;
                                        _pc496_cap = (_pc496_hdr->offset == 0 && !vader_array_is_borrowed(_pc496_hdr) && _pc496_hdr->length >= _pc496_hdr->buf->length) ? _pc496_hdr->capacity : (size_t) 0;
                                        _pc496_slots = _pc496_hdr->buf->slots;
                                    }
                                    t1 = (l13 + INT64_C(1));
                                    l13 = (size_t) (int64_t) t1;
                                    goto loop_496;
                        ...
                        vader_struct_vader_bytecode_BcUnion_t* _a31_obj = (vader_struct_vader_bytecode_BcUnion_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcUnion_t));
                        vader_obj_header_init(_a31_obj, 521u);
                        _a31_obj->f_variants = l24;
                        l28 = (void*) _a31_obj;
                        ...
                        if (l19.tag == 506u) {
                            ...
                            vader_struct_vader_bytecode_BcArray_t* _a32_obj = (vader_struct_vader_bytecode_BcArray_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcArray_t));
                            vader_obj_header_init(_a32_obj, 506u);
                            _a32_obj->f_element = t3;
                            l30 = (void*) _a32_obj;
                            ...
                            if (l19.tag == 509u) {
                                ...
                                l31 = (void*) _a33_arr;
                                t0 = l19.payload.obj;
                                l32 = ((vader_struct_vader_bytecode_BcFn_t*) t0)->f_params;
                                l16 = ((vader_array_t*) l32)->length;
                                l17 = (size_t) (int64_t) INT64_C(0);
                                {
                                    vader_array_t* _pc558_hdr = (vader_array_t*) l31;
                                    size_t _pc558_len = _pc558_hdr->length;
                                    size_t _pc558_cap = (_pc558_hdr->offset == 0 && !vader_array_is_borrowed(_pc558_hdr) && _pc558_hdr->length >= _pc558_hdr->buf->length) ? _pc558_hdr->capacity : (size_t) 0;
                                    void* _pc558_slots = _pc558_hdr->buf->slots;
                                    loop_558: {
                                        if ((l17 < l16)) {
                                            vader_array_t* _a34_slotarr = ((vader_array_t*) l32);
                                            if (_a34_slotarr->buf != NULL && _a34_slotarr->buf->header.forward != NULL) { _a34_slotarr->buf = vader_array_buf_forward(_a34_slotarr->buf); }
                                            if ((size_t) l17 >= _a34_slotarr->length) { vader_trap("array index out of bounds"); }
                                            l33 = ((int32_t*) _a34_slotarr->buf->slots)[_a34_slotarr->offset + (size_t) l17];
                                            l34 = vader_bytecode_remap_idx(l2, l33);
                                            if (VADER_LIKELY(_pc558_len < _pc558_cap)) {
                                                ((int32_t*) _pc558_slots)[_pc558_len] = (int32_t) (l34);
                                                _pc558_len += 1;
                                            } else {
                                                _pc558_hdr->length = _pc558_len;
                                                if (_pc558_hdr->buf->length < _pc558_len) { _pc558_hdr->buf->length = _pc558_len; }
                                                vader_array_push_i32((vader_array_t*) l31, l34);
                                                _pc558_hdr = (vader_array_t*) l31;
                                                _pc558_len = _pc558_hdr->length;
                                                _pc558_cap = (_pc558_hdr->offset == 0 && !vader_array_is_borrowed(_pc558_hdr) && _pc558_hdr->length >= _pc558_hdr->buf->length) ? _pc558_hdr->capacity : (size_t) 0;
                                                _pc558_slots = _pc558_hdr->buf->slots;
                                            }
                                            t1 = (l17 + INT64_C(1));
                                            l17 = (size_t) (int64_t) t1;
                                            goto loop_558;
                                ...
                                vader_struct_vader_bytecode_BcFn_t* _a35_obj = (vader_struct_vader_bytecode_BcFn_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcFn_t));
                                vader_obj_header_init(_a35_obj, 509u);
                                _a35_obj->f_params = l31;
                                _a35_obj->f_return_type = l36;
                                l37 = (void*) _a35_obj;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a36_arr = vader_array_new(8u, 0u, 0u, 176u);
    l1 = (void*) _a36_arr;
    vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 179u);
    l3 = (void*) _a37_arr;
    vader_array_t* _a38_arr = vader_array_new(9u, 0u, 7u, 179u);
    l6 = (void*) _a38_arr;
    vader_struct_std_collections_MutableMap__string__i32_t* _a39_obj = (vader_struct_std_collections_MutableMap__string__i32_t*) vader_gc_alloc(sizeof(vader_struct_std_collections_MutableMap__string__i32_t));
    vader_obj_header_init(_a39_obj, 367u);
    _a39_obj->f_ekeys = l1;
    _a39_obj->f_evals = l3;
    _a39_obj->f_index = l6;
    _a39_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    _a39_obj->f_size = (size_t) (int64_t) INT64_C(0);
    _a39_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a39_obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_645: {
            if ((l5 >= l4)) {
                ...
                vader_array_t* _a40_slotarr = ((vader_array_t*) l6);
                if (_a40_slotarr->buf != NULL && _a40_slotarr->buf->header.forward != NULL) { _a40_slotarr->buf = vader_array_buf_forward(_a40_slotarr->buf); }
                if ((size_t) l5 >= _a40_slotarr->length) { vader_trap("array index out of bounds"); }
                t2 = vader_array_box_slots(_a40_slotarr->buf)[_a40_slotarr->offset + (size_t) l5];
                l20 = t2.payload.s;
                vader_array_t* _a41_slotarr = ((vader_array_t*) l7);
                if (_a41_slotarr->buf != NULL && _a41_slotarr->buf->header.forward != NULL) { _a41_slotarr->buf = vader_array_buf_forward(_a41_slotarr->buf); }
                if ((size_t) l5 >= _a41_slotarr->length) { vader_trap("array index out of bounds"); }
                l10 = ((int32_t*) _a41_slotarr->buf->slots)[_a41_slotarr->offset + (size_t) l5];
                vader_struct___Tuple_string_i32_4ccf6d4f_t* _a43_obj = &_a42_storage;
                vader_obj_header_init(_a43_obj, 242u);
                _a43_obj->f__0 = l20;
                _a43_obj->f__1 = l10;
                l3 = (void*) _a43_obj;
                l21 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__0;
                l14 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
                l18 = vader_bytecode_remap_idx(l2, l14);
                if ((l18 >= INT32_C(0))) {
                    std_collections_MutableMap_IndexSet_set_at__string__i32(l1, l21, l18);
                }
                goto loop_645;
            }
        }
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_700: {
            if ((l5 < l4)) {
                vader_array_t* _a44_slotarr = ((vader_array_t*) l1);
                ...
                l3 = vader_array_ref_load_obj(_a44_slotarr->buf, _a44_slotarr->offset + (size_t) l5);
                vader_array_t* _a45_arr = vader_array_new(9u, 0u, 7u, 179u);
                l6 = (void*) _a45_arr;
                l7 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_param_types;
                l8 = ((vader_array_t*) l7)->length;
                l9 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc719_hdr = (vader_array_t*) l6;
                    size_t _pc719_len = _pc719_hdr->length;
                    size_t _pc719_cap = (_pc719_hdr->offset == 0 && !vader_array_is_borrowed(_pc719_hdr) && _pc719_hdr->length >= _pc719_hdr->buf->length) ? _pc719_hdr->capacity : (size_t) 0;
                    void* _pc719_slots = _pc719_hdr->buf->slots;
                    loop_719: {
                        if ((l9 < l8)) {
                            vader_array_t* _a46_slotarr = ((vader_array_t*) l7);
                            if (_a46_slotarr->buf != NULL && _a46_slotarr->buf->header.forward != NULL) { _a46_slotarr->buf = vader_array_buf_forward(_a46_slotarr->buf); }
                            if ((size_t) l9 >= _a46_slotarr->length) { vader_trap("array index out of bounds"); }
                            l10 = ((int32_t*) _a46_slotarr->buf->slots)[_a46_slotarr->offset + (size_t) l9];
                            l14 = vader_bytecode_remap_idx(l2, l10);
                            if (VADER_LIKELY(_pc719_len < _pc719_cap)) {
                                ((int32_t*) _pc719_slots)[_pc719_len] = (int32_t) (l14);
                                _pc719_len += 1;
                            } else {
                                _pc719_hdr->length = _pc719_len;
                                if (_pc719_hdr->buf->length < _pc719_len) { _pc719_hdr->buf->length = _pc719_len; }
                                vader_array_push_i32((vader_array_t*) l6, l14);
                                _pc719_hdr = (vader_array_t*) l6;
                                _pc719_len = _pc719_hdr->length;
                                _pc719_cap = (_pc719_hdr->offset == 0 && !vader_array_is_borrowed(_pc719_hdr) && _pc719_hdr->length >= _pc719_hdr->buf->length) ? _pc719_hdr->capacity : (size_t) 0;
                                _pc719_slots = _pc719_hdr->buf->slots;
                            }
                            t1 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t1;
                            goto loop_719;
                ...
                l11 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_params;
                l15 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_results;
                l23 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_result_types;
                l24 = vader_bytecode_remap_type_indices(l2, l23);
                l25 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_param_names;
                l28 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_param_mutable;
                l30 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_param_by_address;
                vader_struct_vader_bytecode_BcSignature_t* _a47_obj = (vader_struct_vader_bytecode_BcSignature_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcSignature_t));
                vader_obj_header_init(_a47_obj, 518u);
                _a47_obj->f_params = l11;
                _a47_obj->f_results = l15;
                _a47_obj->f_param_types = l6;
                _a47_obj->f_result_types = l24;
                _a47_obj->f_param_names = l25;
                _a47_obj->f_param_mutable = l28;
                _a47_obj->f_param_by_address = l30;
                l31 = (void*) _a47_obj;
                ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature = l31;
                VADER_WRITE_BARRIER((vader_struct_vader_bytecode_BcFunction_t*) l3);
                l12 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_body)->length;
                l13 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_783: {
                        if ((l13 < l12)) {
                            l32 = ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_body;
                            vader_array_t* _a48_slotarr = ((vader_array_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_body);
                            if (_a48_slotarr->buf != NULL && _a48_slotarr->buf->header.forward != NULL) { _a48_slotarr->buf = vader_array_buf_forward(_a48_slotarr->buf); }
                            if ((size_t) l13 >= _a48_slotarr->length) { vader_trap("array index out of bounds"); }
                            t2 = vader_array_ref_load_box(_a48_slotarr->buf, _a48_slotarr->offset + (size_t) l13);
                            l19 = vader_bytecode_remap_type_in_op(t2, l2);
                            vader_array_t* _a49_slotarr = ((vader_array_t*) l32);
                            if (_a49_slotarr->buf != NULL && _a49_slotarr->buf->header.forward != NULL) { _a49_slotarr->buf = vader_array_buf_forward(_a49_slotarr->buf); }
                            if ((size_t) l13 >= _a49_slotarr->length) { vader_trap("array index out of bounds"); }
                            vader_array_ref_store(_a49_slotarr->buf, _a49_slotarr->offset + (size_t) l13, l19.payload.obj);
    ...
    vader_array_t* _a50_arr = vader_array_new(39u, 0u, 13u, 511u);
    l1 = (void*) _a50_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_825: {
            if ((l5 < l4)) {
                vader_array_t* _a51_slotarr = ((vader_array_t*) l3);
                if (_a51_slotarr->buf != NULL && _a51_slotarr->buf->header.forward != NULL) { _a51_slotarr->buf = vader_array_buf_forward(_a51_slotarr->buf); }
                if ((size_t) l5 >= _a51_slotarr->length) { vader_trap("array index out of bounds"); }
                l6 = vader_array_ref_load_obj(_a51_slotarr->buf, _a51_slotarr->offset + (size_t) l5);
                vader_array_t* _a52_arr = vader_array_new(9u, 0u, 7u, 179u);
                l7 = (void*) _a52_arr;
                l11 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_types;
                l8 = ((vader_array_t*) l11)->length;
                l9 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc844_hdr = (vader_array_t*) l7;
                    size_t _pc844_len = _pc844_hdr->length;
                    size_t _pc844_cap = (_pc844_hdr->offset == 0 && !vader_array_is_borrowed(_pc844_hdr) && _pc844_hdr->length >= _pc844_hdr->buf->length) ? _pc844_hdr->capacity : (size_t) 0;
                    void* _pc844_slots = _pc844_hdr->buf->slots;
                    loop_844: {
                        if ((l9 < l8)) {
                            vader_array_t* _a53_slotarr = ((vader_array_t*) l11);
                            if (_a53_slotarr->buf != NULL && _a53_slotarr->buf->header.forward != NULL) { _a53_slotarr->buf = vader_array_buf_forward(_a53_slotarr->buf); }
                            if ((size_t) l9 >= _a53_slotarr->length) { vader_trap("array index out of bounds"); }
                            l10 = ((int32_t*) _a53_slotarr->buf->slots)[_a53_slotarr->offset + (size_t) l9];
                            l14 = vader_bytecode_remap_idx(l2, l10);
                            if (VADER_LIKELY(_pc844_len < _pc844_cap)) {
                                ((int32_t*) _pc844_slots)[_pc844_len] = (int32_t) (l14);
                                _pc844_len += 1;
                            } else {
                                _pc844_hdr->length = _pc844_len;
                                if (_pc844_hdr->buf->length < _pc844_len) { _pc844_hdr->buf->length = _pc844_len; }
                                vader_array_push_i32((vader_array_t*) l7, l14);
                                _pc844_hdr = (vader_array_t*) l7;
                                _pc844_len = _pc844_hdr->length;
                                _pc844_cap = (_pc844_hdr->offset == 0 && !vader_array_is_borrowed(_pc844_hdr) && _pc844_hdr->length >= _pc844_hdr->buf->length) ? _pc844_hdr->capacity : (size_t) 0;
                                _pc844_slots = _pc844_hdr->buf->slots;
                            }
                            t1 = (l9 + INT64_C(1));
                            l9 = (size_t) (int64_t) t1;
                            goto loop_844;
                ...
                l20 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_extern_name;
                l21 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_mangled_name;
                l15 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_params;
                l23 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_results;
                l24 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_result_types;
                l25 = vader_bytecode_remap_type_indices(l2, l24);
                l28 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_names;
                l30 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_mutable;
                l31 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_by_address;
                vader_struct_vader_bytecode_BcSignature_t* _a54_obj = (vader_struct_vader_bytecode_BcSignature_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcSignature_t));
                vader_obj_header_init(_a54_obj, 518u);
                _a54_obj->f_params = l15;
                _a54_obj->f_results = l23;
                _a54_obj->f_param_types = l7;
                _a54_obj->f_result_types = l25;
                _a54_obj->f_param_names = l28;
                _a54_obj->f_param_mutable = l30;
                _a54_obj->f_param_by_address = l31;
                l32 = (void*) _a54_obj;
                l39 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_is_extern;
                l22 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_c_header;
                l40 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_c_library;
                l18 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_c_variadic_fixed;
                vader_struct_vader_bytecode_BcImport_t* _a55_obj = (vader_struct_vader_bytecode_BcImport_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcImport_t));
                vader_obj_header_init(_a55_obj, 511u);
                _a55_obj->f_extern_name = l20;
                _a55_obj->f_mangled_name = l21;
                _a55_obj->f_signature = l32;
                _a55_obj->f_is_extern = l39;
                _a55_obj->f_c_header = l22;
                _a55_obj->f_c_library = l40;
                _a55_obj->f_c_variadic_fixed = l18;
                l37 = (void*) _a55_obj;
                vader_array_push((vader_array_t*) l1, vader_ref_box(l37));
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
...
static void vader_bytecode_push_scope(void* l0, void* l1, size_t l2, vader_string_t l3, int32_t l4) {
    ...
    l5 = ((vader_array_t*) l0)->length;
    if (l2 == l5) {
        vader_array_push((vader_array_t*) l0, vader_box_string(176u, l3));
        vader_array_push_i32((vader_array_t*) l1, l4);
    } else {
        vader_array_t* _a0_slotarr = ((vader_array_t*) l0);
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) l2 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        vader_array_box_slots(_a0_slotarr->buf)[_a0_slotarr->offset + (size_t) l2] = vader_box_string(176u, l3);
        VADER_WRITE_BARRIER(_a0_slotarr->buf);
        vader_array_t* _a1_slotarr = ((vader_array_t*) l1);
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 4u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(134u, 1u, 13u, 1149u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 651u) {
        ...
        vader_obj_header_init(_a7_obj, 651u);
    ...
    if (l0.tag == 545u) {
        ...
        vader_obj_header_init(_a9_obj, 545u);
    ...
    if (l0.tag == 627u) {
        ...
        vader_obj_header_init(_a10_obj, 627u);
    ...
    if (l0.tag == 572u) {
        ...
        vader_obj_header_init(_a11_obj, 572u);
    ...
    if (l0.tag == 622u) {
        ...
        vader_obj_header_init(_a12_obj, 622u);
        _a12_obj->f_slot = l2;
    ...
    if (l0.tag == 504u) {
        ...
        vader_obj_header_init(_a13_obj, 504u);
    ...
    if (l0.tag == 630u) {
        ...
        vader_obj_header_init(_a14_obj, 630u);
    ...
    if (l0.tag == 535u) {
        ...
        vader_obj_header_init(_a15_obj, 535u);
    ...
    if (l0.tag == 548u) {
        ...
        vader_obj_header_init(_a16_obj, 548u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l19 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 179u);
    l20 = (void*) _a8_arr;
                        ...
                        if (l21.tag == 623u) {
                            ...
                            if (l12 == l15) {
                                ...
                                if (!(l25)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 625u);
                                    _a16_obj->f_slot = t2;
                                    l27 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 633u) {
                                    ...
                                    if ((l17 > l29)) {
                                        ...
                                        if (!(l32.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 634u);
                                        ...
                                        if (l9.tag == 533u) {
                                            ...
                                            if ((l3 > l39)) {
                                                ...
                                                if (l42.tag == 530u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 530u);
                                                    _a24_obj->f_value = !(t5);
                                                    l46 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 533u) {
                                        ...
                                        if ((l3 > l39)) {
                                            ...
                                            if (l42.tag == 530u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 530u);
                                                _a32_obj->f_value = !(t5);
                                                l46 = (void*) _a32_obj;
                                    ...
                                    if (l9.tag == 533u) {
                                        ...
                                        if ((l3 > l39)) {
                                            ...
                                            if (l42.tag == 530u) {
                                                ...
                                                vader_obj_header_init(_a52_obj, 530u);
                                                _a52_obj->f_value = !(t5);
                                                l46 = (void*) _a52_obj;
                                ...
                                if (l9.tag == 533u) {
                                    ...
                                    if ((l3 > l39)) {
                                        ...
                                        if (l42.tag == 530u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 530u);
                                            _a60_obj->f_value = !(t5);
                                            l46 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 533u) {
                                ...
                                if ((l3 > l39)) {
                                    ...
                                    if (l42.tag == 530u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 530u);
                                        _a68_obj->f_value = !(t5);
                                        l46 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 633u) {
                            ...
                            if ((l17 > l29)) {
                                ...
                                if (!(l32.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 634u);
                                ...
                                if (l9.tag == 533u) {
                                    ...
                                    if ((l3 > l39)) {
                                        ...
                                        if (l42.tag == 530u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 530u);
                                            _a80_obj->f_value = !(t5);
                                            l46 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 533u) {
                                ...
                                if ((l3 > l39)) {
                                    ...
                                    if (l42.tag == 530u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 530u);
                                        _a88_obj->f_value = !(t5);
                                        l46 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 533u) {
                            ...
                            if ((l3 > l39)) {
                                ...
                                if (l42.tag == 530u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 530u);
                                    _a96_obj->f_value = !(t5);
                                    l46 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 633u) {
                        ...
                        if ((l17 > l29)) {
                            ...
                            if (!(l32.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 634u);
                            ...
                            if (l9.tag == 533u) {
                                ...
                                if ((l3 > l39)) {
                                    ...
                                    if (l42.tag == 530u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 530u);
                        ...
                        if (l9.tag == 533u) {
                            ...
                            if ((l3 > l39)) {
                                ...
                                if (l42.tag == 530u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 530u);
                    ...
                    if (l9.tag == 533u) {
                        ...
                        if ((l3 > l39)) {
                            ...
                            if (l42.tag == 530u) {
                                ...
                                vader_obj_header_init(_a124_obj, 530u);
                ...
                if (l9.tag == 633u) {
                    ...
                    if ((l17 > l29)) {
                        ...
                        if (!(l32.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 634u);
                        ...
                        if (l9.tag == 533u) {
                            ...
                            if ((l3 > l39)) {
                                ...
                                if (l42.tag == 530u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 530u);
                    ...
                    if (l9.tag == 533u) {
                        ...
                        if ((l3 > l39)) {
                            ...
                            if (l42.tag == 530u) {
                                ...
                                vader_obj_header_init(_a144_obj, 530u);
                ...
                if (l9.tag == 533u) {
                    ...
                    if ((l3 > l39)) {
                        ...
                        if (l42.tag == 530u) {
                            ...
                            vader_obj_header_init(_a152_obj, 530u);
    ...
    vader_obj_header_init(_a159_obj, 513u);
    _a159_obj->f_body = l1;
                ...
                if (l8.tag == 633u) {
                    ...
                    if ((l9 > INT64_C(0))) {
                        ...
                        if (!(l11.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a4_obj, 634u);
                            _a4_obj->f_value = l11;
                            l13 = (void*) _a4_obj;
                            vader_array_t* _a5_slotarr = ((vader_array_t*) l3);
                            if (_a5_slotarr->buf != NULL && _a5_slotarr->buf->header.forward != NULL) { _a5_slotarr->buf = vader_array_buf_forward(_a5_slotarr->buf); }
...
static bool vader_bytecode_same_intern_class(vader_box_t l0, vader_box_t l1) {
    ...
    if ((l0.tag == 932u || l0.tag == 939u)) {
        l4 = true;
    } else {
        l4 = (l1.tag == 932u || l1.tag == 939u);
    }
    if (l4) {
...
static vader_box_t vader_bytecode_shl_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a1_obj, 589u);
    t1 = (void*) _a1_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_shr_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a3_obj, 590u);
    t1 = (void*) _a3_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
vader_box_t vader_bytecode_slot_load_op_for(uint8_t l0, bool l1) {
    ...
    if (l2 == INT32_C(1)) {
        ...
        vader_obj_header_init(_a0_obj, 619u);
        ...
        if (l2 == INT32_C(2)) {
            ...
            if (l2 == INT32_C(3)) {
                ...
                vader_obj_header_init(_a2_obj, 618u);
...
vader_box_t vader_bytecode_slot_store_op_for(uint8_t l0, bool l1) {
    ...
    if (l2 == INT32_C(1)) {
        ...
        vader_obj_header_init(_a0_obj, 641u);
        _a0_obj->f_bounds_safe = l1;
        t1 = (void*) _a0_obj;
        l3 = vader_ref_box(t1);
    } else {
        if (l2 == INT32_C(2)) {
            ...
            vader_obj_header_init(_a1_obj, 642u);
            _a1_obj->f_bounds_safe = l1;
            t1 = (void*) _a1_obj;
            l3 = vader_ref_box(t1);
        } else {
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2124u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2124u);
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(129u, 0u, 13u, 1117u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 1u, 7u, 179u);
    ...
    vader_obj_header_init(_a10_obj, 513u);
    _a10_obj->f_body = l6;
...
static uint64_t vader_bytecode_symbol_hash(void* l0) {
    ...
    t0 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_module_name;
    if (t0 == 0u) {
        l1 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(101));
    ...
    l1 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), l1);
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1756u);
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_id;
    ...
    if (l5.tag == 578u) {
        if (l4.tag == 578u) {
            if (l0.tag == 573u) {
                ...
                vader_obj_header_init(_a1_obj, 578u);
            ...
            if (l0.tag == 586u) {
                ...
                vader_obj_header_init(_a3_obj, 578u);
    ...
    if (l5.tag == 598u) {
        if (l4.tag == 598u) {
            if (l0.tag == 593u) {
                ...
                vader_obj_header_init(_a4_obj, 598u);
            ...
            if (l0.tag == 612u) {
                ...
                vader_obj_header_init(_a5_obj, 598u);
            ...
            if (l0.tag == 606u) {
                ...
                vader_obj_header_init(_a6_obj, 598u);
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 887u);
    ...
    l3 = std_core_write_string_at(l6, l3, 887u);
...
uint64_t vader_bytecode_type_intern_hash(vader_box_t l0) {
    ...
    if (l0.tag == 939u) {
        ...
        if (l0.tag == 932u) {
            ...
            if (l0.tag == 929u) {
                l1 = vader_bytecode_bare_hash(554u);
            } else {
                if ((l0.tag == 934u || l0.tag == 935u || l0.tag == 936u || l0.tag == 937u || l0.tag == 940u || l0.tag == 944u || l0.tag == 945u || l0.tag == 947u)) {
                    ...
                    if (l0.tag == 931u) {
                        ...
                        if (l0.tag == 941u) {
                            l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(1));
                            t0 = l0.payload.obj;
                            ...
                            if (l0.tag == 942u) {
                                l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(2));
                                t0 = l0.payload.obj;
                                ...
                                if (l0.tag == 930u) {
                                    l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(3));
                                    t0 = l0.payload.obj;
                                    l3 = vader_bytecode_type_intern_hash(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
                                    l1 = vader_bytecode_mix64(l2, l3);
                                } else {
                                    if (l0.tag == 946u) {
                                        l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(4));
                                        t0 = l0.payload.obj;
                                        l4 = ((vader_struct_vader_types_UnionType_t*) t0)->f_variants;
                                        l1 = vader_bytecode_type_args_hash(l2, l4);
                                    } else {
                                        if (l0.tag == 943u) {
                                            l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(5));
                                            t0 = l0.payload.obj;
                                            l4 = ((vader_struct_vader_types_TupleType_t*) t0)->f_elements;
                                            l1 = vader_bytecode_type_args_hash(l2, l4);
                                        } else {
                                            if (l0.tag == 933u) {
                                                l2 = vader_bytecode_mix64((uint64_t) (int64_t) INT64_C(-3750763034362895579), (uint64_t) (int64_t) INT64_C(6));
                                                t0 = l0.payload.obj;
                                                l4 = ((vader_struct_vader_types_FnType_t*) t0)->f_params;
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 939u) {
        ...
        if (l0.tag == 941u) {
            ...
            t0 = l0.payload.obj;
            l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2517u);
            l1 = concat_5(756u, l2, 517u, l3, 536u);
        } else {
            if (l0.tag == 942u) {
                t0 = l0.payload.obj;
                l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) t0)->f_symbol);
                t0 = l0.payload.obj;
                l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2517u);
                l1 = concat_5(834u, l2, 517u, l3, 536u);
            } else {
                if (l0.tag == 932u) {
                    t0 = l0.payload.obj;
                    l1 = ((vader_struct_vader_types_EnumType_t*) t0)->f_repr;
                    ...
                    if (l0.tag == 931u) {
                        ...
                        if (l0.tag == 930u) {
                            ...
                            l1 = concat_3(556u, l2, 536u);
                        } else {
                            if (l0.tag == 946u) {
                                t0 = l0.payload.obj;
                                l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2517u);
                                l1 = concat_3(840u, l2, 536u);
                            } else {
                                if (l0.tag == 943u) {
                                    t0 = l0.payload.obj;
                                    l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2517u);
                                    l1 = concat_3(836u, l2, 536u);
                                } else {
                                    if (l0.tag == 933u) {
                                        t0 = l0.payload.obj;
                                        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) t0)->f_params, 391u);
                                        t0 = l0.payload.obj;
                                        l3 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) t0)->f_return_type);
                                        l1 = concat_4(617u, l2, 372u, l3);
                                    } else {
                                        if (l0.tag == 945u) {
                                            t0 = l0.payload.obj;
...
vader_box_t vader_bytecode_unary_op_for(uint8_t l0, uint8_t l1) {
    ...
    if (l0 == INT32_C(0)) {
        ...
        if (l0 == INT32_C(1)) {
            ...
            vader_obj_header_init(_a0_obj, 533u);
            t0 = (void*) _a0_obj;
            l2 = vader_ref_box(t0);
        } else {
            if (l0 == INT32_C(2)) {
...
static vader_box_t vader_bytecode_with_remapped_slot(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 624u) {
        ...
        vader_obj_header_init(_a1_obj, 624u);
        _a1_obj->f_slot = l1;
        t0 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l0.tag == 622u) {
        ...
        vader_obj_header_init(_a3_obj, 622u);
        _a3_obj->f_slot = l1;
        _a3_obj->f_type_id = l2;
