...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        if (l1 == 1153u) {
            ...
            vader_obj_header_init(_a4_obj, 599u);
            t1 = (void*) _a4_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 2117u) {
        ...
        if (l1 == 1853u) {
            ...
            vader_obj_header_init(_a6_obj, 612u);
            t1 = (void*) _a6_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
    ...
    if (l1 == 1153u) {
        ...
        vader_obj_header_init(_a8_obj, 579u);
        t1 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 2117u) {
        ...
        vader_obj_header_init(_a9_obj, 598u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1853u) {
        ...
        vader_obj_header_init(_a10_obj, 592u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a11_obj, 585u);
    t1 = (void*) _a11_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 523u; }
    }
    t0 = ((int64_t) (int32_t) l1);
    l3 = (size_t) (int64_t) t0;
    ...
    if (l5.tag == 523u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1897u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 929u) {
        ...
        vader_obj_header_init(_a4_obj, 514u);
    ...
    if (l0.tag == 942u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 516u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    l9 = std_core_write_string_at(l8, l9, 859u);
                    ...
                    vader_obj_header_init(_a13_obj, 516u);
                    _a13_obj->f_name = l11;
        ...
        l5 = std_core_write_string_at(l3, l5, 879u);
        l12 = ((int64_t) (int32_t) l2);
        l5 = std_core_write_int(l3, l5, l12);
        ...
        vader_obj_header_init(_a14_obj, 527u);
        _a14_obj->f_name = l11;
    ...
    if (l0.tag == 939u) {
        ...
        vader_obj_header_init(_a17_obj, 524u);
    ...
    if (l0.tag == 946u) {
        ...
        vader_obj_header_init(_a18_obj, 524u);
    ...
    if (l0.tag == 935u) {
        ...
        vader_obj_header_init(_a19_obj, 524u);
    ...
    if (l0.tag == 933u) {
        ...
        vader_obj_header_init(_a20_obj, 524u);
    ...
    if (l0.tag == 934u) {
        ...
        vader_obj_header_init(_a21_obj, 524u);
    ...
    if (l0.tag == 936u) {
        ...
        vader_obj_header_init(_a22_obj, 524u);
    ...
    if (l0.tag == 928u) {
        ...
        vader_obj_header_init(_a23_obj, 524u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1153u);
    ...
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1853u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1168u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1891u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
    ...
    if (l0 == INT32_C(11)) {
        ...
        vader_obj_header_init(_a1_obj, 541u);
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(12)) {
...
void* vader_bytecode_build_intrinsic_wrapper_body(void* l0, int32_t l1) {
    ...
    vader_obj_header_init(_a3_obj, 639u);
    l5 = (void*) _a3_obj;
    vader_array_push((vader_array_t*) l2, vader_ref_box(l5));
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 637u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_cmp_ne(uint8_t l0) {
    ...
    vader_obj_header_init(_a5_obj, 593u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(43u, 0u, 13u, 642u);
    l5 = (void*) _a0_arr;
            ...
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a5_obj, 642u);
                        _a5_obj->f_first = l9;
                        _a5_obj->f_last = l12;
                        l10 = (void*) _a5_obj;
                        ...
                        vader_obj_header_init(_a9_obj, 642u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 642u);
    ...
    vader_array_t* _a14_arr = vader_array_new(41u, 0u, 13u, 520u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(43u, 0u, 13u, 642u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
        ...
        loop_269: {
            if ((l7 < l2)) {
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 642u);
    ...
    vader_array_t* _a31_arr = vader_array_new(120u, 0u, 13u, 1093u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 518u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 537u || l0.tag == 553u || l0.tag == 566u || l0.tag == 584u || l0.tag == 604u || l0.tag == 635u || l0.tag == 650u)) {
        return l0;
    }
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(120u, 0u, 13u, 1093u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 630u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a18_obj, 630u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 629u) {
                    ...
                    vader_obj_header_init(_a25_obj, 629u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 628u) {
                    ...
                    vader_obj_header_init(_a28_obj, 628u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(41u, 0u, 13u, 520u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
    ...
    vader_obj_header_init(_a33_obj, 518u);
    _a33_obj->f_name = l36;
                            ...
                            if ((l9 < l8)) {
                                ...
                                if (l13) {
                                    ...
                                    if ((l16 > l17)) {
                                        ...
                                        vader_obj_header_init(_a3_obj, 642u);
                                        _a3_obj->f_first = l18;
                                        _a3_obj->f_last = l19;
                                        l6 = (void*) _a3_obj;
                                        l4 = true;
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 535u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1246u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 632u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1799u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 619u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1666u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 563u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1799u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 642u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1876u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2085u, 615u, 1229u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(10); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2085u, 606u, 1611u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2033u) {
        ...
        vader_obj_header_init(_a8_obj, 577u);
        t0 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2039u) {
    ...
    if (l0 == 2032u) {
        ...
        vader_obj_header_init(_a10_obj, 564u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2038u) {
        ...
        vader_obj_header_init(_a11_obj, 533u);
        t0 = (void*) _a11_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_neg_op(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a0_obj, 575u);
        t1 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_64_bit_int_val(l0);
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1877u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 376u);
    _a10_obj->f_ekeys = l3;
    _a10_obj->f_evals = l4;
    _a10_obj->f_index = l5;
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(39u, 0u, 13u, 518u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 327u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    vader_obj_header_init(_a19_obj, 376u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(40u, 0u, 13u, 519u);
    l7 = (void*) _a20_arr;
    ...
    vader_obj_header_init(_a24_obj, 327u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    vader_obj_header_init(_a28_obj, 376u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(37u, 0u, 13u, 515u);
    l10 = (void*) _a29_arr;
    ...
    vader_obj_header_init(_a34_obj, 300u);
    ...
    vader_obj_header_init(_a35_obj, 562u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1153u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1853u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2021u, 253u, l0, 253u, l1, 253u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(120u, 0u, 13u, 1093u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(124u, 0u, 13u, 1117u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_struct___Tuple_1275_t _a10_storage = {0};
    vader_struct___Tuple_1276_t _a56_storage = {0};
    vader_struct___Tuple_1277_t _a65_storage = {0};
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                l12 = t3.payload.b;
                vader_struct___Tuple_1275_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 226u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
                l10 = ((vader_struct___Tuple_1275_t*) t2)->f__0;
                t1 = (l11 + INT64_C(1));
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a20_obj, 376u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_obj_header_init(_a29_obj, 327u);
    _a29_obj->f_ekeys = l5;
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 518u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 550u) {
                                ...
                                vader_obj_header_init(_a38_obj, 550u);
                            ...
                            if (l19.tag == 578u) {
                                ...
                                vader_obj_header_init(_a41_obj, 578u);
                            ...
                            if (l19.tag == 633u) {
                                ...
                                vader_obj_header_init(_a44_obj, 633u);
    ...
    vader_array_t* _a46_arr = vader_array_new(37u, 0u, 13u, 515u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 515u);
    ...
    vader_obj_header_init(_a53_obj, 327u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_890: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1276_t* _a57_obj = &_a56_storage;
                vader_obj_header_init(_a57_obj, 227u);
                _a57_obj->f__0 = l8;
                _a57_obj->f__1 = l10;
                l5 = (void*) _a57_obj;
                l20 = ((vader_struct___Tuple_1276_t*) l5)->f__0;
                l24 = ((vader_struct___Tuple_1276_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a62_obj, 376u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1277_t* _a66_obj = &_a65_storage;
                vader_obj_header_init(_a66_obj, 228u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
                l34 = ((vader_struct___Tuple_1277_t*) l5)->f__0;
                l10 = ((vader_struct___Tuple_1277_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a71_obj, 300u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1278_t* _a74_obj = (vader_struct___Tuple_1278_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1278_t));
                vader_obj_header_init(_a74_obj, 229u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
                l10 = ((vader_struct___Tuple_1278_t*) l27)->f__0;
                l28 = ((vader_struct___Tuple_1278_t*) l27)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(40u, 0u, 13u, 519u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_164: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 551u) {
                                ...
                                vader_obj_header_init(_a12_obj, 551u);
                                _a12_obj->f_index = t4;
                                l16 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_struct___Tuple_1278_t _a14_storage = {0};
    vader_struct___Tuple_1277_t _a40_storage = {0};
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1278_t* _a15_obj = &_a14_storage;
                vader_obj_header_init(_a15_obj, 229u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
                l12 = ((vader_struct___Tuple_1278_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(122u, 0u, 13u, 1100u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(122u, 0u, 13u, 1100u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 527u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(38u, 0u, 13u, 516u);
                    l8 = (void*) _a23_arr;
                    ...
                    l10 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_395: {
                            if ((l10 < l9)) {
                                ...
                                vader_obj_header_init(_a25_obj, 516u);
                                _a25_obj->f_name = l18;
                    ...
                    vader_obj_header_init(_a26_obj, 527u);
                    _a26_obj->f_name = l22;
                    ...
                    if (l16.tag == 528u) {
                        ...
                        vader_obj_header_init(_a29_obj, 528u);
                        ...
                        if (l16.tag == 514u) {
                            ...
                            vader_obj_header_init(_a30_obj, 514u);
                            ...
                            if (l16.tag == 517u) {
                                ...
                                vader_obj_header_init(_a33_obj, 517u);
    ...
    vader_obj_header_init(_a37_obj, 376u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_623: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1277_t* _a41_obj = &_a40_storage;
                vader_obj_header_init(_a41_obj, 228u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l22 = ((vader_struct___Tuple_1277_t*) l3)->f__0;
                l11 = ((vader_struct___Tuple_1277_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_679: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a45_obj, 525u);
    ...
    vader_array_t* _a48_arr = vader_array_new(40u, 0u, 13u, 519u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_808: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a52_obj, 525u);
                ...
                vader_obj_header_init(_a53_obj, 519u);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(124u, 1u, 13u, 1117u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 657u) {
        ...
        vader_obj_header_init(_a7_obj, 657u);
    ...
    if (l0.tag == 633u) {
        ...
        vader_obj_header_init(_a10_obj, 633u);
    ...
    if (l0.tag == 578u) {
        ...
        vader_obj_header_init(_a11_obj, 578u);
    ...
    if (l0.tag == 628u) {
        ...
        vader_obj_header_init(_a12_obj, 628u);
        _a12_obj->f_slot = l3;
    ...
    if (l0.tag == 512u) {
        ...
        vader_obj_header_init(_a13_obj, 512u);
    ...
    if (l0.tag == 636u) {
        ...
        vader_obj_header_init(_a14_obj, 636u);
    ...
    if (l0.tag == 555u) {
        ...
        vader_obj_header_init(_a16_obj, 555u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(120u, 0u, 13u, 1093u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 167u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 629u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (!(l26)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 631u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 639u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 640u);
                                        ...
                                        if (l9.tag == 540u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 537u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 537u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 540u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 537u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 537u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 540u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 537u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 537u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 540u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 537u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 537u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 639u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 640u);
                                ...
                                if (l9.tag == 540u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 537u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 537u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 540u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 537u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 537u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 540u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 537u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 537u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 639u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 640u);
                            ...
                            if (l9.tag == 540u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 537u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 537u);
                        ...
                        if (l9.tag == 540u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 537u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 537u);
                    ...
                    if (l9.tag == 540u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 537u) {
                                ...
                                vader_obj_header_init(_a124_obj, 537u);
                ...
                if (l9.tag == 639u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 640u);
                        ...
                        if (l9.tag == 540u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 537u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 537u);
                    ...
                    if (l9.tag == 540u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 537u) {
                                ...
                                vader_obj_header_init(_a144_obj, 537u);
                ...
                if (l9.tag == 540u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 537u) {
                            ...
                            vader_obj_header_init(_a152_obj, 537u);
    ...
    vader_obj_header_init(_a159_obj, 521u);
    _a159_obj->f_body = l1;
...
void* vader_bytecode_run_bc_return_lit_fold(void* l0) {
                ...
                if (l8.tag == 639u) {
                    ...
                    if ((l9 > INT64_C(0))) {
                        ...
                        if (!(l11.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a4_obj, 640u);
                            _a4_obj->f_value = l11;
                            l13 = (void*) _a4_obj;
                            vader_array_t* _a5_slotarr = ((vader_array_t*) l3);
                            if (_a5_slotarr->buf != NULL && _a5_slotarr->buf->header.forward != NULL) { _a5_slotarr->buf = vader_array_buf_forward(_a5_slotarr->buf); }
    ...
    vader_obj_header_init(_a11_obj, 521u);
    _a11_obj->f_body = l1;
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2022u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2022u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(120u, 0u, 13u, 1093u);
    l6 = (void*) _a1_arr;
    ...
    vader_obj_header_init(_a10_obj, 521u);
    _a10_obj->f_body = l6;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1663u);
        ...
        if (l5.tag == 604u) {
            ...
            if (l4.tag == 604u) {
                ...
                if (l0.tag == 612u) {
                    ...
                    vader_obj_header_init(_a9_obj, 604u);
    ...
    if (l5.tag == 604u) {
        ...
        if (l4.tag == 604u) {
            ...
            if (l0.tag == 599u) {
                ...
                vader_obj_header_init(_a10_obj, 604u);
            ...
            if (l0.tag == 618u) {
                ...
                vader_obj_header_init(_a11_obj, 604u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 940u) {
        ...
        t1 = concat_5(736u, l2, 500u, l3, 519u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 941u) {
        l1 = l0.payload.obj;
        ...
        t1 = concat_5(812u, l2, 500u, l3, 519u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 931u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 928u) {
        { vader_gc_top = gc_frame.prev; return 537u; }
    }
