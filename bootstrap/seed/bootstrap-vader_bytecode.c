...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 508u) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1939u);
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_166: {
                if ((l6 < l5)) {
                    ...
                    l8 = std_core_write_string_at(l4, l8, 870u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        l2 = vader_bytecode_arith_op(l1, 1175u);
    } else {
        if (l0 == INT32_C(1)) {
            l2 = vader_bytecode_arith_op(l1, 2134u);
        } else {
            if (l0 == INT32_C(2)) {
                l2 = vader_bytecode_arith_op(l1, 1893u);
            } else {
                if (l0 == INT32_C(3)) {
                    ...
                    if (l0 == INT32_C(4)) {
                        ...
                        if (l0 == INT32_C(5)) {
                            ...
                            if (l0 == INT32_C(6)) {
                                ...
                                if (l0 == INT32_C(7)) {
                                    l2 = vader_bytecode_bit_op(l1, 1191u);
                                } else {
                                    if (l0 == INT32_C(8)) {
                                        l2 = vader_bytecode_bit_op(l1, 1933u);
                                    } else {
                                        if (l0 == INT32_C(9)) {
                                            l2 = vader_bytecode_bit_op(l1, 2423u);
                                        } else {
                                            if (l0 == INT32_C(10)) {
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1454u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 520u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1271u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 618u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1836u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 605u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1700u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 548u) {
    ...
    l6 = INT32_C(0);
    {
        loop_37: {
            if ((l6 < INT32_C(16))) {
                ...
                l3 = (size_t) (int64_t) t1;
                l8 = vader_string_slice_codepoints(455u, l2, l3);
                l5 = concat_2(l5, l8);
                l6 = (l6 + INT32_C(1));
                goto loop_37;
            }
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1490u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1918u; }
    }
...
int32_t vader_bytecode_intern_type(vader_box_t l0, void* l1) {
    ...
    l8 = vader_bytecode_type_intern_key(l0);
    l3 = std_collections_get__string__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_key, l8);
    if (l3.tag == 172u) {
        t3 = std_collections_get__u64__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_hash, l2);
        if (t3.tag == 0u) {
            l6 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_hash;
            l9 = ((int32_t) l3.payload.i);
            std_collections_put__u64__i32(l6, l2, l9);
            l9 = ((int32_t) l3.payload.i);
    ...
    std_collections_put__string__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_key, l8, l9);
    t3 = std_collections_get__u64__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_hash, l2);
    if (t3.tag == 0u) {
        std_collections_put__u64__i32(((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_type_hash, l2, l9);
    }
    vader_bytecode_record_slot_type(l1, l9, l0);
    l6 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_types;
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2102u, 620u, 1253u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(5); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2102u, 611u, 1644u);
    if (l0 == l1) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1919u, INT32_C(0));
    ...
    vader_obj_header_init(_a11_obj, 926u);
    _a11_obj->f_name = 1919u;
    t0 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(134u, 1u, 13u, 1194u);
    ((void**) _a12_arr->buf->slots)[_a12_arr->offset + 0u] = t0;
    l3 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(8u, 0u, 0u, 169u);
    l4 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a17_obj, 360u);
    _a17_obj->f_ekeys = l6;
    _a17_obj->f_evals = l7;
    _a17_obj->f_index = l8;
    ...
    l6 = (void*) _a17_obj;
    vader_array_t* _a18_arr = vader_array_new(38u, 0u, 13u, 503u);
    l7 = (void*) _a18_arr;
    ...
    l8 = (void*) _a22_obj;
    vader_array_t* _a23_arr = vader_array_new(8u, 0u, 0u, 169u);
    l9 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a26_obj, 360u);
    _a26_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a26_obj;
    vader_array_t* _a27_arr = vader_array_new(39u, 0u, 13u, 504u);
    l10 = (void*) _a27_arr;
    vader_array_t* _a28_arr = vader_array_new(9u, 0u, 7u, 172u);
    l11 = (void*) _a28_arr;
    vader_array_t* _a29_arr = vader_array_new(9u, 0u, 7u, 172u);
    l12 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 172u);
    l13 = (void*) _a30_arr;
    ...
    l11 = (void*) _a31_obj;
    vader_array_t* _a32_arr = vader_array_new(8u, 0u, 0u, 169u);
    l12 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a35_obj, 360u);
    ...
    l12 = (void*) _a35_obj;
    vader_array_t* _a36_arr = vader_array_new(36u, 0u, 13u, 500u);
    l13 = (void*) _a36_arr;
    vader_array_t* _a37_arr = vader_array_new(9u, 0u, 7u, 172u);
    l14 = (void*) _a37_arr;
    vader_array_t* _a38_arr = vader_array_new(9u, 0u, 7u, 172u);
    l15 = (void*) _a38_arr;
    vader_array_t* _a39_arr = vader_array_new(16u, 0u, 0u, 180u);
    l16 = (void*) _a39_arr;
    vader_array_t* _a40_arr = vader_array_new(9u, 0u, 7u, 172u);
    l17 = (void*) _a40_arr;
    ...
    vader_obj_header_init(_a42_obj, 547u);
    _a42_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1175u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2134u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1893u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2053u, 245u, l0, 245u, l1, 245u, l2);
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2054u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2054u);
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1696u);
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_id;
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 870u);
    ...
    l3 = std_core_write_string_at(l6, l3, 870u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 926u) {
        ...
        if (l0.tag == 928u) {
            ...
            t0 = l0.payload.obj;
            l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2434u);
            l1 = concat_5(744u, l2, 505u, l3, 524u);
        } else {
            if (l0.tag == 929u) {
                t0 = l0.payload.obj;
                l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) t0)->f_symbol);
                t0 = l0.payload.obj;
                l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2434u);
                l1 = concat_5(820u, l2, 505u, l3, 524u);
            } else {
                if (l0.tag == 919u) {
                    t0 = l0.payload.obj;
                    l1 = ((vader_struct_vader_types_EnumType_t*) t0)->f_repr;
                    ...
                    if (l0.tag == 918u) {
                        ...
                        if (l0.tag == 917u) {
                            ...
                            if (l0.tag == 933u) {
                                t0 = l0.payload.obj;
                                l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2434u);
                                l1 = concat_3(826u, l2, 524u);
                            } else {
                                if (l0.tag == 930u) {
                                    t0 = l0.payload.obj;
                                    l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2434u);
                                    l1 = concat_3(822u, l2, 524u);
                                } else {
                                    if (l0.tag == 920u) {
                                        t0 = l0.payload.obj;
                                        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) t0)->f_params, 371u);
                                        t0 = l0.payload.obj;
                                        l3 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) t0)->f_return_type);
                                        l1 = concat_4(606u, l2, 353u, l3);
                                    } else {
                                        if (l0.tag == 932u) {
                                            t0 = l0.payload.obj;
