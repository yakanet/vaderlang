...
vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 557u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 932u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(36u, 0u, 13u, 507u);
        l4 = (void*) _a11_arr;
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(41u, 0u, 13u, 632u);
    l5 = (void*) _a0_arr;
        ...
        loop_61: {
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    t1 = vader_box_bool(159u, ((uint8_t*) _a4_slotarr->buf->slots)[_a4_slotarr->offset + (size_t) l11]);
                    t2 = t1.payload.b;
                    if (!(t2)) {
    ...
    vader_array_t* _a14_arr = vader_array_new(39u, 0u, 13u, 511u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(41u, 0u, 13u, 632u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    l7 = l1;
    {
        loop_269: {
            if ((l7 < l2)) {
                ...
                t1 = vader_box_bool(159u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l7]);
                t2 = t1.payload.b;
                if (!(t2)) {
                    l8 = -(INT32_C(1));
    ...
    vader_array_t* _a31_arr = vader_array_new(116u, 0u, 13u, 1078u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 528u || l0.tag == 543u || l0.tag == 556u || l0.tag == 574u || l0.tag == 594u || l0.tag == 625u || l0.tag == 640u)) {
        return l0;
    }
...
vader_box_t vader_bytecode_convert_target_of(uint8_t l0) {
    if (l0 == INT32_C(0)) {
        return vader_box_i32(163u, INT32_C(0));
    }
    if (l0 == INT32_C(1)) {
        return vader_box_i32(163u, INT32_C(0));
    }
    ...
    if (l0 == INT32_C(3)) {
        return vader_box_i32(163u, INT32_C(1));
    }
    if (l0 == INT32_C(8)) {
        return vader_box_i32(163u, INT32_C(1));
    }
    ...
    if (l0 == INT32_C(10)) {
        return vader_box_i32(163u, INT32_C(2));
    }
    if (l0 == INT32_C(11)) {
        return vader_box_i32(163u, INT32_C(2));
    }
    if (l0 == INT32_C(13)) {
        return vader_box_i32(163u, INT32_C(3));
    }
    if (l0 == INT32_C(12)) {
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_200: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(159u, ((uint8_t*) _a8_slotarr->buf->slots)[_a8_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    vader_array_t* _a10_arr = vader_array_new(116u, 0u, 13u, 1078u);
    l8 = (void*) _a10_arr;
        ...
        loop_263: {
            if ((l6 < l4)) {
                ...
                if (l7.tag == 620u) {
                    ...
                    t2 = vader_box_bool(159u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l9]);
                    t3 = t2.payload.b;
                    if (t3) {
                        ...
                        vader_obj_header_init(_a15_obj, 549u);
                        l18 = (void*) _a15_obj;
                ...
                if (l7.tag == 621u) {
                    ...
                    t2 = vader_box_bool(159u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l13]);
                    t3 = t2.payload.b;
                    if (t3) {
                        t0 = (l6 + INT64_C(1));
                        l6 = (size_t) (int64_t) t0;
    ...
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 511u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(159u, ((uint8_t*) _a31_slotarr->buf->slots)[_a31_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_5: {
            if ((l5 < l2)) {
                ...
                t0 = vader_box_bool(159u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l5]);
                t1 = t0.payload.b;
                if (t1) {
...
int32_t vader_bytecode_intern_string(vader_string_t l0, void* l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_strings, vader_box_string(161u, l0));
...
vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 1935u) {
        ...
        vader_obj_header_init(_a8_obj, 567u);
        t0 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1941u) {
    ...
    if (l0 == 1934u) {
        ...
        vader_obj_header_init(_a10_obj, 554u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 1940u) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_obj_header_init(_a10_obj, 369u);
    _a10_obj->f_ekeys = l3;
    _a10_obj->f_evals = l4;
    _a10_obj->f_index = l5;
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 509u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 311u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    l6 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 163u);
    l7 = (void*) _a17_arr;
    ...
    vader_obj_header_init(_a19_obj, 369u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(38u, 0u, 13u, 510u);
    l7 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 163u);
    l8 = (void*) _a21_arr;
    vader_array_t* _a22_arr = vader_array_new(9u, 0u, 7u, 163u);
    l9 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(9u, 0u, 7u, 163u);
    l10 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a24_obj, 311u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    l8 = (void*) _a24_obj;
    vader_array_t* _a25_arr = vader_array_new(8u, 0u, 0u, 161u);
    l9 = (void*) _a25_arr;
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 163u);
    l10 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(9u, 0u, 7u, 163u);
    l11 = (void*) _a27_arr;
    ...
    vader_obj_header_init(_a28_obj, 369u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(35u, 0u, 13u, 506u);
    l10 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 163u);
    l11 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 163u);
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(15u, 0u, 0u, 170u);
    l13 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a34_obj, 277u);
    ...
    vader_obj_header_init(_a35_obj, 552u);
    _a35_obj->f_types = l0;
...
vader_box_t vader_bytecode_parse_val_type(vader_string_t l0) {
    vader_box_t t0;
    if (l0 == 1572u) {
        t0 = vader_box_i32(166u, INT32_C(0));
        return t0;
    }
    if (l0 == 1527u) {
        t0 = vader_box_i32(166u, INT32_C(1));
        return t0;
    }
    if (l0 == 1528u) {
        t0 = vader_box_i32(166u, INT32_C(2));
        return t0;
    }
    if (l0 == 1550u) {
        t0 = vader_box_i32(166u, INT32_C(3));
        return t0;
    }
    if (l0 == 1645u) {
        t0 = vader_box_i32(166u, INT32_C(4));
        return t0;
    }
    if (l0 == 2159u) {
        t0 = vader_box_i32(166u, INT32_C(5));
        return t0;
    }
    if (l0 == 2140u) {
        t0 = vader_box_i32(166u, INT32_C(6));
        return t0;
    }
    if (l0 == 2141u) {
        t0 = vader_box_i32(166u, INT32_C(7));
        return t0;
    }
    if (l0 == 2150u) {
        t0 = vader_box_i32(166u, INT32_C(8));
        return t0;
    }
    if (l0 == 2202u) {
        t0 = vader_box_i32(166u, INT32_C(9));
        return t0;
    }
    if (l0 == 1436u) {
        t0 = vader_box_i32(166u, INT32_C(10));
        return t0;
    }
    if (l0 == 1439u) {
        t0 = vader_box_i32(166u, INT32_C(11));
        return t0;
    }
    if (l0 == 1178u) {
        t0 = vader_box_i32(166u, INT32_C(12));
        return t0;
    }
    if (l0 == 1265u) {
        t0 = vader_box_i32(166u, INT32_C(13));
        return t0;
    }
    if (l0 == 2008u) {
        t0 = vader_box_i32(166u, INT32_C(14));
        return t0;
    }
    if (l0 == 1787u) {
        t0 = vader_box_i32(166u, INT32_C(15));
        return t0;
    }
    if (l0 == 2292u) {
        t0 = vader_box_i32(166u, INT32_C(16));
        return t0;
    }
    if (l0 == 1837u) {
        t0 = vader_box_i32(166u, INT32_C(17));
        return t0;
    }
    if (l0 == 1102u) {
        t0 = vader_box_i32(166u, INT32_C(18));
        return t0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 163u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(15u, 0u, 0u, 170u);
    l23 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 163u);
    l24 = (void*) _a17_arr;
    ...
    vader_array_t* _a26_arr = vader_array_new(116u, 0u, 13u, 1078u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(120u, 0u, 13u, 1102u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_struct___Tuple_1295_t _a10_storage = {0};
    vader_struct___Tuple_1296_t _a56_storage = {0};
    vader_struct___Tuple_1297_t _a65_storage = {0};
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                t3 = vader_box_bool(159u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l11]);
                l12 = t3.payload.b;
                vader_struct___Tuple_1295_t* _a11_obj = &_a10_storage;
                vader_obj_header_init(_a11_obj, 220u);
                _a11_obj->f__0 = l8;
                _a11_obj->f__1 = l12;
                t2 = (void*) _a11_obj;
                l10 = ((vader_struct___Tuple_1295_t*) t2)->f__0;
                t1 = (l11 + INT64_C(1));
                l11 = (size_t) (int64_t) t1;
    ...
    vader_obj_header_init(_a20_obj, 369u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(37u, 0u, 13u, 509u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 540u) {
                                ...
                                vader_obj_header_init(_a38_obj, 540u);
                            ...
                            if (l19.tag == 623u) {
                                ...
                                vader_obj_header_init(_a44_obj, 623u);
    ...
    vader_array_t* _a46_arr = vader_array_new(35u, 0u, 13u, 506u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 506u);
    ...
    vader_array_t* _a50_arr = vader_array_new(9u, 0u, 7u, 163u);
    l4 = (void*) _a50_arr;
    vader_array_t* _a51_arr = vader_array_new(9u, 0u, 7u, 163u);
    l5 = (void*) _a51_arr;
    vader_array_t* _a52_arr = vader_array_new(9u, 0u, 7u, 163u);
    l6 = (void*) _a52_arr;
    ...
    vader_obj_header_init(_a53_obj, 311u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_890: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1296_t* _a57_obj = &_a56_storage;
                vader_obj_header_init(_a57_obj, 221u);
                _a57_obj->f__0 = l8;
                _a57_obj->f__1 = l10;
                l5 = (void*) _a57_obj;
                l20 = ((vader_struct___Tuple_1296_t*) l5)->f__0;
                l24 = ((vader_struct___Tuple_1296_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a59_arr = vader_array_new(8u, 0u, 0u, 161u);
    l4 = (void*) _a59_arr;
    vader_array_t* _a60_arr = vader_array_new(9u, 0u, 7u, 163u);
    l5 = (void*) _a60_arr;
    vader_array_t* _a61_arr = vader_array_new(9u, 0u, 7u, 163u);
    l6 = (void*) _a61_arr;
    ...
    vader_obj_header_init(_a62_obj, 369u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1297_t* _a66_obj = &_a65_storage;
                vader_obj_header_init(_a66_obj, 222u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
                l34 = ((vader_struct___Tuple_1297_t*) l5)->f__0;
                l10 = ((vader_struct___Tuple_1297_t*) l5)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a68_arr = vader_array_new(9u, 0u, 7u, 163u);
    l4 = (void*) _a68_arr;
    vader_array_t* _a69_arr = vader_array_new(15u, 0u, 0u, 170u);
    l5 = (void*) _a69_arr;
    vader_array_t* _a70_arr = vader_array_new(9u, 0u, 7u, 163u);
    l6 = (void*) _a70_arr;
    ...
    vader_obj_header_init(_a71_obj, 277u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_1298_t* _a74_obj = (vader_struct___Tuple_1298_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_1298_t));
                vader_obj_header_init(_a74_obj, 223u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
                l10 = ((vader_struct___Tuple_1298_t*) l27)->f__0;
                l28 = ((vader_struct___Tuple_1298_t*) l27)->f__1;
                t1 = (l7 + INT64_C(1));
                l7 = (size_t) (int64_t) t1;
                t1 = ((int64_t) (int32_t) l10);
                l11 = (size_t) (int64_t) t1;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(38u, 0u, 13u, 510u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_164: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 541u) {
                                ...
                                vader_obj_header_init(_a12_obj, 541u);
                                _a12_obj->f_index = t4;
                                l16 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_struct___Tuple_1298_t _a14_storage = {0};
    vader_struct___Tuple_1297_t _a40_storage = {0};
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1298_t* _a15_obj = &_a14_storage;
                vader_obj_header_init(_a15_obj, 223u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
                l12 = ((vader_struct___Tuple_1298_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 163u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(118u, 0u, 13u, 1085u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(118u, 0u, 13u, 1085u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 518u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(36u, 0u, 13u, 507u);
                    l8 = (void*) _a23_arr;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a34_arr = vader_array_new(8u, 0u, 0u, 161u);
    l1 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(9u, 0u, 7u, 163u);
    l3 = (void*) _a35_arr;
    ...
    vader_obj_header_init(_a37_obj, 369u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_611: {
            if ((l5 >= l4)) {
                ...
                vader_struct___Tuple_1297_t* _a41_obj = &_a40_storage;
                vader_obj_header_init(_a41_obj, 222u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l20 = ((vader_struct___Tuple_1297_t*) l3)->f__0;
                l11 = ((vader_struct___Tuple_1297_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_667: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a43_arr = vader_array_new(9u, 0u, 7u, 163u);
                l6 = (void*) _a43_arr;
    ...
    vader_array_t* _a48_arr = vader_array_new(38u, 0u, 13u, 510u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
void vader_bytecode_push_scope(void* l0, void* l1, size_t l2, vader_string_t l3, int32_t l4) {
    ...
    l5 = ((vader_array_t*) l0)->length;
    if (l2 == l5) {
        vader_array_push((vader_array_t*) l0, vader_box_string(161u, l3));
        vader_array_push_i32((vader_array_t*) l1, l4);
    } else {
        vader_array_t* _a0_slotarr = ((vader_array_t*) l0);
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) l2 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        vader_array_box_slots(_a0_slotarr->buf)[_a0_slotarr->offset + (size_t) l2] = vader_box_string(161u, l3);
        VADER_WRITE_BARRIER(_a0_slotarr->buf);
        vader_array_t* _a1_slotarr = ((vader_array_t*) l1);
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
...
void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(120u, 1u, 13u, 1102u);
...
vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 545u) {
        ...
        vader_obj_header_init(_a16_obj, 545u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(116u, 0u, 13u, 1078u);
    l10 = (void*) _a7_arr;
                        ...
                        if (l22.tag == 619u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (l27) {
                                    ...
                                    if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                                    if ((size_t) l16 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                                    t3 = vader_box_bool(159u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l16]);
                                    l26 = t3.payload.b;
                                }
                                if (!(l26)) {
                                    t1 = ((vader_struct_vader_bytecode_LocalSet_t*) l18)->f_slot;
...
vader_box_t vader_bytecode_slot_width_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(14)) {
        return vader_box_i32(163u, INT32_C(4));
    }
    if (l0 == INT32_C(15)) {
        return vader_box_i32(163u, INT32_C(4));
    }
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(116u, 0u, 13u, 1078u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 1u, 7u, 163u);
        ...
        if (l5.tag == 594u) {
            ...
            if (l4.tag == 594u) {
                ...
                if (l0.tag == 602u) {
                    ...
                    vader_obj_header_init(_a9_obj, 594u);
    ...
    if (l5.tag == 594u) {
        ...
        if (l4.tag == 594u) {
            ...
            if (l0.tag == 589u) {
                ...
                vader_obj_header_init(_a10_obj, 594u);
            ...
            if (l0.tag == 608u) {
                ...
                vader_obj_header_init(_a11_obj, 594u);
