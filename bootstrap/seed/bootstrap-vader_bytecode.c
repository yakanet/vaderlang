            ...
            if (l5.tag == 513u) {
                ...
                if (l5.tag == 503u) {
                    ...
                    if (l5.tag == 517u) {
                        ...
                        l10 = vader_bytecode_key_join(l0, l7, 2522u);
                        l6 = concat_3(2346u, l10, 538u);
                    } else {
                        if (l5.tag == 506u) {
                            l7 = l5.payload.obj;
                            l8 = ((vader_struct_vader_bytecode_BcFn_t*) l7)->f_params;
                            l10 = vader_bytecode_key_join(l0, l8, 2522u);
                            ...
                            if (l0 == INT32_C(6)) {
                                ...
                                if (l0 == INT32_C(7)) {
                                    ...
                                    if (l0 == INT32_C(8)) {
                                        ...
                                        if (l0 == INT32_C(9)) {
                                            l2 = vader_bytecode_bit_op(l1, 2511u);
                                        } else {
                                            if (l0 == INT32_C(10)) {
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 936u) {
        ...
        if (l0.tag == 938u) {
            ...
            t0 = l0.payload.obj;
            l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2522u);
            ...
            if (l0.tag == 939u) {
                ...
                t0 = l0.payload.obj;
                l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2522u);
                ...
                if (l0.tag == 929u) {
                    ...
                    if (l0.tag == 928u) {
                        ...
                        if (l0.tag == 927u) {
                            ...
                            if (l0.tag == 943u) {
                                t0 = l0.payload.obj;
                                l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2522u);
                                l1 = concat_3(844u, l2, 538u);
                            } else {
                                if (l0.tag == 940u) {
                                    t0 = l0.payload.obj;
                                    l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2522u);
