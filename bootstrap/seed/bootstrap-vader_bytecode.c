...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a7_obj, 585u);
        t1 = (void*) _a7_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1156u) {
        ...
        vader_obj_header_init(_a8_obj, 559u);
        t1 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 2120u) {
        ...
        vader_obj_header_init(_a9_obj, 578u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1864u) {
        ...
        vader_obj_header_init(_a10_obj, 572u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a11_obj, 565u);
    t1 = (void*) _a11_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 502u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1908u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 913u) {
        ...
        vader_obj_header_init(_a10_obj, 496u);
    ...
    if (l0.tag == 923u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 495u);
        l4 = (void*) _a11_arr;
        ...
        vader_obj_header_init(_a14_obj, 506u);
        _a14_obj->f_name = l11;
    ...
    if (l0.tag == 925u) {
        ...
        vader_obj_header_init(_a15_obj, 503u);
    ...
    if (l0.tag == 924u) {
        ...
        vader_obj_header_init(_a16_obj, 503u);
    ...
    if (l0.tag == 920u) {
        ...
        vader_obj_header_init(_a17_obj, 503u);
    ...
    if (l0.tag == 927u) {
        ...
        vader_obj_header_init(_a18_obj, 503u);
    ...
    if (l0.tag == 916u) {
        ...
        vader_obj_header_init(_a19_obj, 503u);
    ...
    if (l0.tag == 914u) {
        ...
        vader_obj_header_init(_a20_obj, 503u);
    ...
    if (l0.tag == 915u) {
        ...
        vader_obj_header_init(_a21_obj, 503u);
    ...
    if (l0.tag == 917u) {
        ...
        vader_obj_header_init(_a22_obj, 503u);
    ...
    if (l0.tag == 909u) {
        ...
        vader_obj_header_init(_a23_obj, 503u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1156u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2120u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1864u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1171u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1902u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2411u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
    ...
    if (l0 == INT32_C(11)) {
        ...
        vader_obj_header_init(_a1_obj, 520u);
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (l1 == 1902u) {
        ...
        vader_obj_header_init(_a4_obj, 562u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a5_obj, 563u);
    t1 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    vader_obj_header_init(_a5_obj, 566u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(42u, 0u, 13u, 622u);
    l5 = (void*) _a0_arr;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_28: {
            if ((l7 < l2)) {
                ...
                vader_obj_header_init(_a2_obj, 622u);
                _a2_obj->f_first = l8;
                _a2_obj->f_last = l9;
                l10 = (void*) _a2_obj;
            ...
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a9_obj, 622u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 622u);
    ...
    vader_array_t* _a14_arr = vader_array_new(40u, 0u, 13u, 499u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(42u, 0u, 13u, 622u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
        ...
        loop_269: {
            if ((l7 < l2)) {
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 622u);
    ...
    vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 497u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 516u || l0.tag == 532u || l0.tag == 545u || l0.tag == 564u || l0.tag == 584u || l0.tag == 615u || l0.tag == 630u)) {
        return l0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1429u);
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 610u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a18_obj, 610u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 611u) {
                    ...
                    vader_obj_header_init(_a22_obj, 611u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 609u) {
                    ...
                    vader_obj_header_init(_a25_obj, 609u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 608u) {
                    ...
                    vader_obj_header_init(_a28_obj, 608u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(40u, 0u, 13u, 499u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 514u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1250u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 612u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1808u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 599u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1675u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 542u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1808u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 622u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1466u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1887u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2088u, 618u, 1233u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(7); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2088u, 609u, 1620u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2047u) {
        ...
        vader_obj_header_init(_a2_obj, 524u);
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2031u) {
    ...
    if (l0 == 2034u) {
        ...
        vader_obj_header_init(_a7_obj, 526u);
        t0 = (void*) _a7_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2040u) {
...
static vader_box_t vader_bytecode_mod_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a3_obj, 571u);
    t1 = (void*) _a3_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1888u, INT32_C(0));
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 497u);
    l4 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a15_obj, 307u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    vader_obj_header_init(_a19_obj, 356u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(39u, 0u, 13u, 498u);
    l7 = (void*) _a20_arr;
    ...
    vader_obj_header_init(_a24_obj, 307u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    vader_obj_header_init(_a28_obj, 356u);
    _a28_obj->f_ekeys = l9;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(36u, 0u, 13u, 494u);
    l10 = (void*) _a29_arr;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1156u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2120u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1864u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2028u, 252u, l0, 252u, l1, 252u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(123u, 0u, 13u, 1097u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(38u, 0u, 13u, 497u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_569: {
                    ...
                    loop_716: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 558u) {
                                ...
                                vader_obj_header_init(_a41_obj, 558u);
                            ...
                            if (l19.tag == 557u) {
                                ...
                                vader_obj_header_init(_a44_obj, 557u);
                            ...
                            if (l19.tag == 613u) {
                                ...
                                vader_obj_header_init(_a47_obj, 613u);
    ...
    vader_array_t* _a49_arr = vader_array_new(36u, 0u, 13u, 494u);
    l4 = (void*) _a49_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_855: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a52_obj, 494u);
    ...
    vader_obj_header_init(_a56_obj, 307u);
    _a56_obj->f_ekeys = l4;
    _a56_obj->f_evals = l5;
    _a56_obj->f_index = l6;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(39u, 0u, 13u, 498u);
    l3 = (void*) _a7_arr;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(121u, 0u, 13u, 1080u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1080u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 506u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(37u, 0u, 13u, 495u);
                    l8 = (void*) _a23_arr;
                    ...
                    vader_obj_header_init(_a26_obj, 506u);
                    _a26_obj->f_name = l20;
                    ...
                    if (l16.tag == 507u) {
                        ...
                        vader_obj_header_init(_a29_obj, 507u);
                        ...
                        if (l16.tag == 493u) {
                            ...
                            vader_obj_header_init(_a30_obj, 493u);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_671: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a45_obj, 504u);
    ...
    vader_array_t* _a48_arr = vader_array_new(39u, 0u, 13u, 498u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_800: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a53_obj, 498u);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(123u, 1u, 13u, 1097u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 486u) {
        ...
        vader_obj_header_init(_a6_obj, 486u);
    ...
    if (l0.tag == 637u) {
        ...
        vader_obj_header_init(_a7_obj, 637u);
    ...
    if (l0.tag == 638u) {
        ...
        vader_obj_header_init(_a8_obj, 638u);
    ...
    if (l0.tag == 558u) {
        ...
        vader_obj_header_init(_a11_obj, 558u);
    ...
    if (l0.tag == 608u) {
        ...
        vader_obj_header_init(_a12_obj, 608u);
        _a12_obj->f_slot = l3;
    ...
    if (l0.tag == 491u) {
        ...
        vader_obj_header_init(_a13_obj, 491u);
    ...
    if (l0.tag == 616u) {
        ...
        vader_obj_header_init(_a14_obj, 616u);
    ...
    if (l0.tag == 521u) {
        ...
        vader_obj_header_init(_a15_obj, 521u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 168u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 609u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (!(l26)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 611u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 619u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 620u);
                                        ...
                                        if (l9.tag == 519u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 516u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 516u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 519u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 516u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 516u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 519u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 516u) {
                                            ...
                                            vader_obj_header_init(_a40_obj, 516u);
                                            _a40_obj->f_value = !(t5);
                                            l47 = (void*) _a40_obj;
                                ...
                                if (l9.tag == 519u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 516u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 516u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 519u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 516u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 516u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 619u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 620u);
                                ...
                                if (l9.tag == 519u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 516u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 516u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 519u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 516u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 516u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 519u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 516u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 516u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 619u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 620u);
                            ...
                            if (l9.tag == 519u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 516u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 516u);
                        ...
                        if (l9.tag == 519u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 516u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 516u);
                    ...
                    if (l9.tag == 519u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 516u) {
                                ...
                                vader_obj_header_init(_a124_obj, 516u);
                ...
                if (l9.tag == 619u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 620u);
                        ...
                        if (l9.tag == 519u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 516u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 516u);
                    ...
                    if (l9.tag == 519u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 516u) {
                                ...
                                vader_obj_header_init(_a144_obj, 516u);
                ...
                if (l9.tag == 519u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 516u) {
                            ...
                            vader_obj_header_init(_a152_obj, 516u);
    ...
    vader_obj_header_init(_a159_obj, 500u);
    _a159_obj->f_body = l1;
...
void* vader_bytecode_run_bc_return_lit_fold(void* l0) {
    ...
    vader_obj_header_init(_a11_obj, 500u);
    _a11_obj->f_body = l1;
...
static vader_box_t vader_bytecode_shr_op(uint8_t l0) {
    ...
    if (l1) {
        ...
        vader_obj_header_init(_a2_obj, 577u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_box_t vader_bytecode_slot_load_op_for(uint8_t l0, bool l1) {
    ...
    if (l2 == INT32_C(3)) {
        ...
        vader_obj_header_init(_a2_obj, 604u);
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2029u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2029u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(119u, 0u, 13u, 1073u);
    l6 = (void*) _a1_arr;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1672u);
            ...
            if (l5.tag == 584u) {
                ...
                if (l4.tag == 584u) {
                    ...
                    if (l0.tag == 598u) {
                        ...
                        vader_obj_header_init(_a5_obj, 584u);
                    ...
                    if (l0.tag == 592u) {
                        ...
                        vader_obj_header_init(_a6_obj, 584u);
        ...
        if (l5.tag == 584u) {
            ...
            if (l4.tag == 584u) {
                ...
                if (l0.tag == 598u) {
                    ...
                    vader_obj_header_init(_a8_obj, 584u);
    ...
    if (l5.tag == 584u) {
        ...
        if (l4.tag == 584u) {
            ...
            if (l0.tag == 598u) {
                ...
                vader_obj_header_init(_a11_obj, 584u);
            ...
            if (l0.tag == 592u) {
                ...
                vader_obj_header_init(_a12_obj, 584u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2422u);
    ...
    if (l0.tag == 922u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2422u);
        t1 = concat_5(817u, l2, 503u, l3, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 912u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 926u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2422u);
        t1 = concat_3(823u, l2, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 923u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2422u);
        t1 = concat_3(819u, l2, 522u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 913u) {
        l1 = l0.payload.obj;
...
static vader_box_t vader_bytecode_with_remapped_slot(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 611u) {
        ...
        vader_obj_header_init(_a2_obj, 611u);
        _a2_obj->f_slot = l1;
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 608u) {
        ...
        vader_obj_header_init(_a3_obj, 608u);
        _a3_obj->f_slot = l1;
        _a3_obj->f_type_id = l3;
