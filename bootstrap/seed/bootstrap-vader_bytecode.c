...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 501u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1935u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 922u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 494u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    l9 = std_core_write_string_at(l8, l9, 874u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1183u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2142u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1891u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1198u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1929u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2435u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
static vader_box_t vader_bytecode_c_field_align_at(void* l0, void* l1, int32_t l2) {
    ...
    if (!(l3.tag == 0u)) {
        ...
        t2 = vader_box_i64(169u, ((int64_t) (int32_t) t1));
        return t2;
    }
    if ((l2 >= INT32_C(16))) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(42u, 0u, 13u, 621u);
    l5 = (void*) _a0_arr;
    ...
    vader_array_t* _a14_arr = vader_array_new(40u, 0u, 13u, 498u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(42u, 0u, 13u, 621u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1072u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 515u || l0.tag == 531u || l0.tag == 544u || l0.tag == 563u || l0.tag == 583u || l0.tag == 614u || l0.tag == 629u)) {
        return l0;
    }
...
void* vader_bytecode_default_emit_options(void) {
    ...
    vader_obj_header_init(_a1_obj, 539u);
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1457u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(119u, 0u, 13u, 1072u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 609u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a15_obj, 537u);
                        l18 = (void*) _a15_obj;
    ...
    vader_array_t* _a30_arr = vader_array_new(40u, 0u, 13u, 498u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 513u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1277u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 611u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1835u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 598u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1703u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 541u) {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1494u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1914u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2110u, 626u, 1260u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(6); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2110u, 617u, 1648u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2067u) {
        ...
        vader_obj_header_init(_a8_obj, 555u);
        t0 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2073u) {
    ...
    if (l0 == 2066u) {
        ...
        vader_obj_header_init(_a10_obj, 542u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2072u) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(121u, 0u, 13u, 1079u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 501u);
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1915u, INT32_C(0));
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 496u);
    l4 = (void*) _a11_arr;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(39u, 0u, 13u, 497u);
    l7 = (void*) _a20_arr;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(36u, 0u, 13u, 493u);
    l10 = (void*) _a29_arr;
    ...
    vader_obj_header_init(_a35_obj, 540u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1183u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2142u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1891u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2055u, 250u, l0, 250u, l1, 250u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(119u, 0u, 13u, 1072u);
    l3 = (void*) _a26_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(38u, 0u, 13u, 496u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_569: {
                    ...
                    loop_716: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 528u) {
                                ...
                                vader_obj_header_init(_a38_obj, 528u);
                            ...
                            if (l19.tag == 556u) {
                                ...
                                vader_obj_header_init(_a44_obj, 556u);
                            ...
                            if (l19.tag == 612u) {
                                ...
                                vader_obj_header_init(_a47_obj, 612u);
    ...
    vader_array_t* _a49_arr = vader_array_new(36u, 0u, 13u, 493u);
    l4 = (void*) _a49_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_855: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a52_obj, 493u);
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(39u, 0u, 13u, 497u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_164: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 529u) {
                                ...
                                vader_obj_header_init(_a12_obj, 529u);
                                _a12_obj->f_index = t4;
                                l16 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 168u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(121u, 0u, 13u, 1079u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1079u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 505u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(37u, 0u, 13u, 494u);
                    l8 = (void*) _a23_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_671: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a45_obj, 503u);
    ...
    vader_array_t* _a48_arr = vader_array_new(39u, 0u, 13u, 497u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_800: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a53_obj, 497u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 533u) {
        ...
        vader_obj_header_init(_a16_obj, 533u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(119u, 0u, 13u, 1072u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 168u);
    l14 = (void*) _a8_arr;
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2056u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2056u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(119u, 0u, 13u, 1072u);
    l6 = (void*) _a1_arr;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1700u);
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 874u);
    ...
    l3 = std_core_write_string_at(l6, l3, 874u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 920u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2446u);
        t1 = concat_5(749u, l2, 511u, l3, 530u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 921u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) l1)->f_symbol);
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2446u);
        t1 = concat_5(825u, l2, 511u, l3, 530u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 911u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 925u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2446u);
        t1 = concat_3(831u, l2, 530u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 922u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2446u);
        t1 = concat_3(827u, l2, 530u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 912u) {
        l1 = l0.payload.obj;
