...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a3_obj, 541u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (t0) {
        ...
        if (l1 == 2105u) {
            ...
            vader_obj_header_init(_a5_obj, 592u);
            t1 = (void*) _a5_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1844u) {
    ...
    if (l1 == 1146u) {
        ...
        vader_obj_header_init(_a8_obj, 553u);
        t1 = (void*) _a8_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 2105u) {
        ...
        vader_obj_header_init(_a9_obj, 572u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1844u) {
        ...
        vader_obj_header_init(_a10_obj, 566u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 497u) {
        ...
        l3 = std_core_write_string_at(l7, l3, 1888u);
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    if (l0.tag == 916u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(37u, 0u, 13u, 490u);
        l4 = (void*) _a11_arr;
        ...
        vader_obj_header_init(_a14_obj, 501u);
        _a14_obj->f_name = l11;
    ...
    if (l0.tag == 917u) {
        ...
        vader_obj_header_init(_a16_obj, 498u);
    ...
    if (l0.tag == 913u) {
        ...
        vader_obj_header_init(_a17_obj, 498u);
    ...
    if (l0.tag == 920u) {
        ...
        vader_obj_header_init(_a18_obj, 498u);
    ...
    if (l0.tag == 909u) {
        ...
        vader_obj_header_init(_a19_obj, 498u);
    ...
    if (l0.tag == 907u) {
        ...
        vader_obj_header_init(_a20_obj, 498u);
    ...
    if (l0.tag == 908u) {
        ...
        vader_obj_header_init(_a21_obj, 498u);
    ...
    if (l0.tag == 910u) {
        ...
        vader_obj_header_init(_a22_obj, 498u);
    ...
    if (l0.tag == 902u) {
        ...
        vader_obj_header_init(_a23_obj, 498u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1146u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2105u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1161u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
        t0 = vader_bytecode_bit_op(l1, 1882u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2393u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        if (l1 == 1161u) {
            ...
            vader_obj_header_init(_a0_obj, 574u);
            t1 = (void*) _a0_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1882u) {
    ...
    if (l1 == 1161u) {
        ...
        vader_obj_header_init(_a3_obj, 554u);
        t1 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1882u) {
...
vader_box_t vader_bytecode_c_field_val_type(void* l0, void* l1) {
    ...
    if (l5.tag == 497u) {
        t3 = l5.payload.obj;
        t2 = vader_box_i32(169u, (int32_t)(uint32_t) ((vader_struct_vader_bytecode_BcPrimitive_t*) t3)->f_val);
        return t2;
    }
    t2 = vader_box_obj(0u, NULL);
    return t2;
...
vader_box_t vader_bytecode_c_field_width(void* l0, void* l1) {
    ...
    t0 = vader_box_i64(167u, ((int64_t) (int32_t) t2));
    return t0;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(42u, 0u, 13u, 616u);
    l5 = (void*) _a0_arr;
            ...
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a9_obj, 616u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 616u);
    ...
    vader_array_t* _a14_arr = vader_array_new(40u, 0u, 13u, 494u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(42u, 0u, 13u, 616u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
        ...
        loop_269: {
            if ((l7 < l2)) {
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 616u);
    ...
    vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l5 = (void*) _a31_arr;
    ...
    vader_obj_header_init(_a34_obj, 492u);
    _a34_obj->f_name = l37;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 511u || l0.tag == 527u || l0.tag == 540u || l0.tag == 558u || l0.tag == 578u || l0.tag == 609u || l0.tag == 624u)) {
        return l0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 604u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a18_obj, 604u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 605u) {
                    ...
                    vader_obj_header_init(_a22_obj, 605u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 603u) {
                    ...
                    vader_obj_header_init(_a25_obj, 603u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 602u) {
                    ...
                    vader_obj_header_init(_a28_obj, 602u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(40u, 0u, 13u, 494u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 509u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1239u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 606u) {
                        ...
                        if (l7.tag == 593u) {
                            ...
                            vader_bytecode_push_scope(l2, l3, l4, 1657u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 537u) {
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2073u, 614u, 1222u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(7); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2073u, 605u, 1602u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2030u) {
        ...
        vader_obj_header_init(_a9_obj, 508u);
        t0 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2023u) {
        ...
        vader_obj_header_init(_a10_obj, 538u);
        t0 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2029u) {
        ...
        vader_obj_header_init(_a11_obj, 507u);
        t0 = (void*) _a11_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(121u, 0u, 13u, 1073u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 497u);
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 492u);
    l4 = (void*) _a11_arr;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(39u, 0u, 13u, 493u);
    l7 = (void*) _a20_arr;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(36u, 0u, 13u, 489u);
    l10 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 166u);
    l11 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 166u);
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(16u, 0u, 0u, 174u);
    l13 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a35_obj, 536u);
    _a35_obj->f_types = l0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1146u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2105u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2012u, 251u, l0, 251u, l1, 251u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 166u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(16u, 0u, 0u, 174u);
    l23 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 166u);
    l24 = (void*) _a17_arr;
    ...
    vader_array_t* _a26_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(123u, 0u, 13u, 1090u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(38u, 0u, 13u, 492u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 524u) {
                                ...
                                vader_obj_header_init(_a38_obj, 524u);
                            ...
                            if (l19.tag == 552u) {
                                ...
                                vader_obj_header_init(_a41_obj, 552u);
                            ...
                            if (l19.tag == 607u) {
                                ...
                                vader_obj_header_init(_a44_obj, 607u);
    ...
    vader_array_t* _a46_arr = vader_array_new(36u, 0u, 13u, 489u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 489u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a66_obj, 229u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
    ...
    l4 = (void*) _a68_arr;
    vader_array_t* _a69_arr = vader_array_new(16u, 0u, 0u, 174u);
    l5 = (void*) _a69_arr;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a74_obj, 222u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(39u, 0u, 13u, 493u);
    l3 = (void*) _a7_arr;
                    ...
                    loop_164: {
                        if ((l7 < l6)) {
                            ...
                            if (l8.tag == 525u) {
                                ...
                                vader_obj_header_init(_a12_obj, 525u);
                                _a12_obj->f_index = t4;
                                l16 = (void*) _a12_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_216: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a15_obj, 222u);
                _a15_obj->f__0 = l7;
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 166u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(121u, 0u, 13u, 1073u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1073u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 501u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(37u, 0u, 13u, 490u);
                    l8 = (void*) _a23_arr;
                    ...
                    l10 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_395: {
                            if ((l10 < l9)) {
                                ...
                                vader_obj_header_init(_a25_obj, 490u);
                                _a25_obj->f_name = l18;
                    ...
                    vader_obj_header_init(_a26_obj, 501u);
                    _a26_obj->f_name = l20;
                    ...
                    if (l16.tag == 502u) {
                        ...
                        vader_obj_header_init(_a29_obj, 502u);
                        ...
                        if (l16.tag == 488u) {
                            ...
                            if (l16.tag == 491u) {
                                ...
                                vader_obj_header_init(_a33_obj, 491u);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_615: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a41_obj, 229u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_671: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a45_obj, 499u);
    ...
    vader_array_t* _a48_arr = vader_array_new(39u, 0u, 13u, 493u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_800: {
            if ((l5 < l4)) {
                ...
                vader_obj_header_init(_a53_obj, 493u);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(123u, 1u, 13u, 1090u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 632u) {
        ...
        vader_obj_header_init(_a8_obj, 632u);
    ...
    if (l0.tag == 607u) {
        ...
        vader_obj_header_init(_a10_obj, 607u);
    ...
    if (l0.tag == 610u) {
        ...
        vader_obj_header_init(_a14_obj, 610u);
    ...
    if (l0.tag == 529u) {
        ...
        vader_obj_header_init(_a16_obj, 529u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 603u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (!(l26)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 605u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 613u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 614u);
                                        ...
                                        if (l9.tag == 514u) {
                                            ...
                                            if ((l3 > l40)) {
                                                ...
                                                if (l43.tag == 511u) {
                                                    ...
                                                    vader_obj_header_init(_a24_obj, 511u);
                                                    _a24_obj->f_value = !(t5);
                                                    l47 = (void*) _a24_obj;
                                    ...
                                    if (l9.tag == 514u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 511u) {
                                                ...
                                                vader_obj_header_init(_a32_obj, 511u);
                                                _a32_obj->f_value = !(t5);
                                                l47 = (void*) _a32_obj;
                                ...
                                if (l9.tag == 514u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 511u) {
                                            ...
                                            vader_obj_header_init(_a40_obj, 511u);
                                            _a40_obj->f_value = !(t5);
                                            l47 = (void*) _a40_obj;
                                    ...
                                    if (l9.tag == 514u) {
                                        ...
                                        if ((l3 > l40)) {
                                            ...
                                            if (l43.tag == 511u) {
                                                ...
                                                vader_obj_header_init(_a52_obj, 511u);
                                                _a52_obj->f_value = !(t5);
                                                l47 = (void*) _a52_obj;
                                ...
                                if (l9.tag == 514u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 511u) {
                                            ...
                                            vader_obj_header_init(_a60_obj, 511u);
                                            _a60_obj->f_value = !(t5);
                                            l47 = (void*) _a60_obj;
                            ...
                            if (l9.tag == 514u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 511u) {
                                        ...
                                        vader_obj_header_init(_a68_obj, 511u);
                                        _a68_obj->f_value = !(t5);
                                        l47 = (void*) _a68_obj;
                        ...
                        if (l9.tag == 613u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 614u);
                                ...
                                if (l9.tag == 514u) {
                                    ...
                                    if ((l3 > l40)) {
                                        ...
                                        if (l43.tag == 511u) {
                                            ...
                                            vader_obj_header_init(_a80_obj, 511u);
                                            _a80_obj->f_value = !(t5);
                                            l47 = (void*) _a80_obj;
                            ...
                            if (l9.tag == 514u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 511u) {
                                        ...
                                        vader_obj_header_init(_a88_obj, 511u);
                                        _a88_obj->f_value = !(t5);
                                        l47 = (void*) _a88_obj;
                        ...
                        if (l9.tag == 514u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 511u) {
                                    ...
                                    vader_obj_header_init(_a96_obj, 511u);
                                    _a96_obj->f_value = !(t5);
                                    l47 = (void*) _a96_obj;
                    ...
                    if (l9.tag == 613u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 614u);
                            ...
                            if (l9.tag == 514u) {
                                ...
                                if ((l3 > l40)) {
                                    ...
                                    if (l43.tag == 511u) {
                                        ...
                                        vader_obj_header_init(_a108_obj, 511u);
                        ...
                        if (l9.tag == 514u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 511u) {
                                    ...
                                    vader_obj_header_init(_a116_obj, 511u);
                    ...
                    if (l9.tag == 514u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 511u) {
                                ...
                                vader_obj_header_init(_a124_obj, 511u);
                ...
                if (l9.tag == 613u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 614u);
                        ...
                        if (l9.tag == 514u) {
                            ...
                            if ((l3 > l40)) {
                                ...
                                if (l43.tag == 511u) {
                                    ...
                                    vader_obj_header_init(_a136_obj, 511u);
                    ...
                    if (l9.tag == 514u) {
                        ...
                        if ((l3 > l40)) {
                            ...
                            if (l43.tag == 511u) {
                                ...
                                vader_obj_header_init(_a144_obj, 511u);
                ...
                if (l9.tag == 514u) {
                    ...
                    if ((l3 > l40)) {
                        ...
                        if (l43.tag == 511u) {
                            ...
                            vader_obj_header_init(_a152_obj, 511u);
    ...
    vader_obj_header_init(_a159_obj, 495u);
    _a159_obj->f_body = l1;
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2013u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2013u);
    l5 = ((vader_array_t*) l3)->length;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(119u, 0u, 13u, 1066u);
    l6 = (void*) _a1_arr;
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = std_core_write_string_at(l1, l2, 1654u);
            ...
            if (l5.tag == 578u) {
                ...
                if (l4.tag == 578u) {
                    ...
                    if (l0.tag == 586u) {
                        ...
                        vader_obj_header_init(_a6_obj, 578u);
        ...
        if (l5.tag == 578u) {
            ...
            if (l4.tag == 578u) {
                ...
                if (l0.tag == 573u) {
                    ...
                    vader_obj_header_init(_a7_obj, 578u);
                ...
                if (l0.tag == 592u) {
                    ...
                    vader_obj_header_init(_a8_obj, 578u);
    ...
    if (l5.tag == 578u) {
        ...
        if (l4.tag == 578u) {
            ...
            if (l0.tag == 586u) {
                ...
                vader_obj_header_init(_a12_obj, 578u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 914u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2404u);
    ...
    if (l0.tag == 915u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2404u);
    ...
    if (l0.tag == 919u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2404u);
        t1 = concat_3(818u, l2, 518u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 916u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2404u);
