...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        if (l1 == 2123u) {
            ...
            vader_obj_header_init(_a5_obj, 595u);
            t1 = (void*) _a5_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1861u) {
    ...
    if (l1 == 2123u) {
        ...
        vader_obj_header_init(_a9_obj, 575u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1861u) {
        ...
        vader_obj_header_init(_a10_obj, 569u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_bc_type_of_with_ctx(vader_box_t l0, void* l1, int32_t l2) {
    ...
    void** gc_raw_roots[6] = { &l1, &l3, &l4, &l8, &l13, &t0 };
    ...
    if (l0.tag == 919u) {
        l3 = l0.payload.obj;
        vader_array_t* _a11_arr = vader_array_new(38u, 0u, 13u, 493u);
        l4 = (void*) _a11_arr;
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    _a13_obj->f_c_size = l12;
                    _a13_obj->f_c_size_missing = false;
                    l13 = (void*) _a13_obj;
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        t0 = vader_bytecode_arith_op(l1, 1159u);
    ...
    if (l0 == INT32_C(2)) {
        t0 = vader_bytecode_arith_op(l1, 1861u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(3)) {
    ...
    if (l0 == INT32_C(7)) {
        t0 = vader_bytecode_bit_op(l1, 1174u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(8)) {
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        if (l1 == 1174u) {
            ...
            vader_obj_header_init(_a0_obj, 577u);
            t1 = (void*) _a0_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1900u) {
    ...
    if (l1 == 1900u) {
        ...
        vader_obj_header_init(_a4_obj, 559u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_bytecode_build_intrinsic_wrapper_body(void* l0, int32_t l1) {
    ...
    vader_obj_header_init(_a3_obj, 616u);
    l5 = (void*) _a3_obj;
    vader_array_push((vader_array_t*) l2, vader_ref_box(l5));
...
vader_box_t vader_bytecode_c_field_val_type(void* l0, void* l1) {
    ...
    if (l5.tag == 500u) {
        t3 = l5.payload.obj;
        t2 = vader_box_i32(170u, (int32_t)(uint32_t) ((vader_struct_vader_bytecode_BcPrimitive_t*) t3)->f_val);
        return t2;
    }
    t2 = vader_box_obj(0u, NULL);
    return t2;
...
vader_box_t vader_bytecode_c_field_width(void* l0, void* l1) {
    ...
    uint8_t t2;
    int32_t t3;
    t0 = ((vader_struct_vader_bytecode_BcField_t*) l0)->f_c_size;
    if ((t0 >= INT64_C(0))) {
        t0 = ((vader_struct_vader_bytecode_BcField_t*) l0)->f_c_size;
        t1 = vader_box_i64(168u, t0);
        return t1;
    }
    ...
    t2 = ((uint8_t) l2.payload.i);
    t3 = vader_bytecode_size_of_val_type(t2);
    t1 = vader_box_i64(168u, ((int64_t) (int32_t) t3));
    return t1;
}
...
static vader_box_t vader_bytecode_cmp_eq(uint8_t l0) {
    ...
    if (t1) {
        ...
        vader_obj_header_init(_a4_obj, 614u);
        t0 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_cmp_ge(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 637u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_64_bit_int_val(l0);
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(43u, 0u, 13u, 619u);
    l5 = (void*) _a0_arr;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_28: {
            if ((l7 < l2)) {
                ...
                vader_obj_header_init(_a2_obj, 619u);
                _a2_obj->f_first = l8;
                _a2_obj->f_last = l9;
                l10 = (void*) _a2_obj;
        ...
        loop_61: {
            if ((l7 < l4)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    t1 = vader_box_bool(162u, ((uint8_t*) _a4_slotarr->buf->slots)[_a4_slotarr->offset + (size_t) l11]);
                    t2 = t1.payload.b;
                    if (!(t2)) {
                        ...
                        vader_obj_header_init(_a9_obj, 619u);
                        _a9_obj->f_first = l13;
                        _a9_obj->f_last = l14;
                        l15 = (void*) _a9_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 619u);
    ...
    vader_array_t* _a14_arr = vader_array_new(41u, 0u, 13u, 497u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(43u, 0u, 13u, 619u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
    ...
    l7 = l1;
    {
        loop_269: {
            if ((l7 < l2)) {
                ...
                t1 = vader_box_bool(162u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l7]);
                t2 = t1.payload.b;
                if (!(t2)) {
                    l8 = -(INT32_C(1));
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 619u);
    ...
    vader_array_t* _a31_arr = vader_array_new(120u, 0u, 13u, 1070u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 514u || l0.tag == 530u || l0.tag == 543u || l0.tag == 561u || l0.tag == 581u || l0.tag == 612u || l0.tag == 627u)) {
        return l0;
    }
...
vader_box_t vader_bytecode_convert_target_of(uint8_t l0) {
    if (l0 == INT32_C(0)) {
        return vader_box_i32(167u, INT32_C(0));
    }
    if (l0 == INT32_C(1)) {
        return vader_box_i32(167u, INT32_C(0));
    }
    ...
    if (l0 == INT32_C(3)) {
        return vader_box_i32(167u, INT32_C(1));
    }
    if (l0 == INT32_C(8)) {
        return vader_box_i32(167u, INT32_C(1));
    }
    ...
    if (l0 == INT32_C(10)) {
        return vader_box_i32(167u, INT32_C(2));
    }
    if (l0 == INT32_C(11)) {
        return vader_box_i32(167u, INT32_C(2));
    }
    if (l0 == INT32_C(13)) {
        return vader_box_i32(167u, INT32_C(3));
    }
    if (l0 == INT32_C(12)) {
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a0_obj, 642u);
        t1 = (void*) _a0_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t0 = vader_bytecode_is_u32_class(l0);
    ...
    t2 = vader_bytecode_arith_op(l0, 1432u);
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_200: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(162u, ((uint8_t*) _a8_slotarr->buf->slots)[_a8_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    vader_array_t* _a10_arr = vader_array_new(120u, 0u, 13u, 1070u);
    l8 = (void*) _a10_arr;
        ...
        loop_263: {
            if ((l6 < l4)) {
                ...
                if (l7.tag == 607u) {
                    ...
                    t2 = vader_box_bool(162u, ((uint8_t*) _a13_slotarr->buf->slots)[_a13_slotarr->offset + (size_t) l9]);
                    t3 = t2.payload.b;
                    if (t3) {
                        ...
                        vader_obj_header_init(_a18_obj, 607u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 608u) {
                    ...
                    t2 = vader_box_bool(162u, ((uint8_t*) _a19_slotarr->buf->slots)[_a19_slotarr->offset + (size_t) l13]);
                    t3 = t2.payload.b;
                    if (t3) {
                        t0 = (l6 + INT64_C(1));
                        l6 = (size_t) (int64_t) t0;
                    ...
                    vader_obj_header_init(_a22_obj, 608u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 606u) {
                    ...
                    vader_obj_header_init(_a25_obj, 606u);
                    _a25_obj->f_slot = t1;
                    l26 = (void*) _a25_obj;
                ...
                if (l7.tag == 605u) {
                    ...
                    vader_obj_header_init(_a28_obj, 605u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(41u, 0u, 13u, 497u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
            if ((l4 < l2)) {
                ...
                t2 = vader_box_bool(162u, ((uint8_t*) _a31_slotarr->buf->slots)[_a31_slotarr->offset + (size_t) l4]);
                t3 = t2.payload.b;
                if (!(t3)) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_5: {
            if ((l5 < l2)) {
                ...
                t0 = vader_box_bool(162u, ((uint8_t*) _a0_slotarr->buf->slots)[_a0_slotarr->offset + (size_t) l5]);
                t1 = t0.payload.b;
                if (t1) {
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 512u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1252u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 609u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1807u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 596u) {
                            ...
                            if (l7.tag == 540u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1807u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 619u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1469u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1884u; }
    }
...
int32_t vader_bytecode_intern_cell_type(vader_box_t l0, void* l1) {
    ...
    void** gc_raw_roots[3] = { &l1, &l7, &l8 };
    vader_string_t* gc_atom_roots[2] = { &l3, &l9 };
    ...
    _a0_obj->f_c_size = l6;
    _a0_obj->f_c_size_missing = false;
    l7 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(38u, 0u, 13u, 493u);
    l8 = (void*) _a1_arr;
    vader_array_push((vader_array_t*) l8, vader_ref_box(l7));
    l7 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_types;
    l9 = vader_bytecode_type_intern_key(l0);
    l9 = concat_2(256u, l9);
    l2 = -(INT32_C(1));
...
int32_t vader_bytecode_intern_string(vader_string_t l0, void* l1) {
    ...
    vader_array_push((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l1)->f_strings, vader_box_string(164u, l0));
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2091u, 617u, 1235u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(7); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2091u, 608u, 1619u);
    if (l0 == l1) {
...
static vader_box_t vader_bytecode_intrinsic_op_for_mangled(vader_string_t l0) {
    ...
    if (l0 == 2034u) {
        ...
        vader_obj_header_init(_a5_obj, 611u);
        t0 = (void*) _a5_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == 2032u) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l6 < l5)) {
                ...
                vader_array_push((vader_array_t*) l3, vader_box_string(164u, l8));
                t0 = (l6 + INT64_C(1));
                l6 = (size_t) (int64_t) t0;
                goto loop_9;
            } else {
...
static vader_box_t vader_bytecode_neg_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a2_obj, 571u);
    t1 = (void*) _a2_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    l1 = (void*) _a5_obj;
    std_collections_put__string__i32(l1, 1885u, INT32_C(0));
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(39u, 0u, 13u, 495u);
    l4 = (void*) _a11_arr;
    ...
    l5 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(8u, 0u, 0u, 164u);
    l6 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 167u);
    l7 = (void*) _a17_arr;
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l8 = (void*) _a18_arr;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(40u, 0u, 13u, 496u);
    l7 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(9u, 0u, 7u, 167u);
    l8 = (void*) _a21_arr;
    vader_array_t* _a22_arr = vader_array_new(9u, 0u, 7u, 167u);
    l9 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(9u, 0u, 7u, 167u);
    l10 = (void*) _a23_arr;
    ...
    l8 = (void*) _a24_obj;
    vader_array_t* _a25_arr = vader_array_new(8u, 0u, 0u, 164u);
    l9 = (void*) _a25_arr;
    vader_array_t* _a26_arr = vader_array_new(9u, 0u, 7u, 167u);
    l10 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(9u, 0u, 7u, 167u);
    l11 = (void*) _a27_arr;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(37u, 0u, 13u, 492u);
    l10 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(9u, 0u, 7u, 167u);
    l11 = (void*) _a30_arr;
    vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 167u);
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(16u, 0u, 0u, 175u);
    l13 = (void*) _a32_arr;
...
static vader_box_t vader_bytecode_parse_val_type(vader_string_t l0) {
    vader_box_t t0;
    if (l0 == 1670u) {
        t0 = vader_box_i32(170u, INT32_C(0));
        return t0;
    }
    if (l0 == 1625u) {
        t0 = vader_box_i32(170u, INT32_C(1));
        return t0;
    }
    if (l0 == 1626u) {
        t0 = vader_box_i32(170u, INT32_C(2));
        return t0;
    }
    if (l0 == 1648u) {
        t0 = vader_box_i32(170u, INT32_C(3));
        return t0;
    }
    if (l0 == 1743u) {
        t0 = vader_box_i32(170u, INT32_C(4));
        return t0;
    }
    if (l0 == 2250u) {
        t0 = vader_box_i32(170u, INT32_C(5));
        return t0;
    }
    if (l0 == 2231u) {
        t0 = vader_box_i32(170u, INT32_C(6));
        return t0;
    }
    if (l0 == 2232u) {
        t0 = vader_box_i32(170u, INT32_C(7));
        return t0;
    }
    if (l0 == 2241u) {
        t0 = vader_box_i32(170u, INT32_C(8));
        return t0;
    }
    if (l0 == 2294u) {
        t0 = vader_box_i32(170u, INT32_C(9));
        return t0;
    }
    if (l0 == 1523u) {
        t0 = vader_box_i32(170u, INT32_C(10));
        return t0;
    }
    if (l0 == 1526u) {
        t0 = vader_box_i32(170u, INT32_C(11));
        return t0;
    }
    if (l0 == 1253u) {
        t0 = vader_box_i32(170u, INT32_C(12));
        return t0;
    }
    if (l0 == 1345u) {
        t0 = vader_box_i32(170u, INT32_C(13));
        return t0;
    }
    if (l0 == 2091u) {
        t0 = vader_box_i32(170u, INT32_C(14));
        return t0;
    }
    if (l0 == 1885u) {
        t0 = vader_box_i32(170u, INT32_C(15));
        return t0;
    }
    if (l0 == 2384u) {
        t0 = vader_box_i32(170u, INT32_C(16));
        return t0;
    }
    if (l0 == 1919u) {
        t0 = vader_box_i32(170u, INT32_C(17));
        return t0;
    }
    if (l0 == 1941u) {
        t0 = vader_box_i32(170u, INT32_C(18));
        return t0;
    }
    if (l0 == 1177u) {
        t0 = vader_box_i32(170u, INT32_C(19));
        return t0;
    }
    t0 = vader_box_obj(0u, NULL);
    return t0;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1159u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1861u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 167u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(16u, 0u, 0u, 175u);
    l23 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 167u);
    l24 = (void*) _a17_arr;
    ...
    vader_array_t* _a26_arr = vader_array_new(120u, 0u, 13u, 1070u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(124u, 0u, 13u, 1094u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_struct___Tuple_i32_i32_3103e027_t _a56_storage = {0};
    vader_struct___Tuple_string_i32_4ccf6d4f_t _a65_storage = {0};
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_158: {
            if ((l11 >= l7)) {
                ...
                t3 = vader_box_bool(162u, ((uint8_t*) _a9_slotarr->buf->slots)[_a9_slotarr->offset + (size_t) l11]);
                l12 = t3.payload.b;
    ...
    l12 = t4 == INT64_C(0);
    vader_array_t* _a17_arr = vader_array_new(8u, 0u, 0u, 164u);
    l5 = (void*) _a17_arr;
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a18_arr;
    ...
    vader_array_t* _a24_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a24_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_497: {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 495u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 555u) {
                                ...
                                vader_obj_header_init(_a41_obj, 555u);
                            ...
                            if (l19.tag == 610u) {
                                ...
                                vader_obj_header_init(_a44_obj, 610u);
    ...
    vader_array_t* _a46_arr = vader_array_new(37u, 0u, 13u, 492u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 492u);
    ...
    vader_array_t* _a50_arr = vader_array_new(9u, 0u, 7u, 167u);
    l4 = (void*) _a50_arr;
    vader_array_t* _a51_arr = vader_array_new(9u, 0u, 7u, 167u);
    l5 = (void*) _a51_arr;
    vader_array_t* _a52_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a52_arr;
    ...
    vader_obj_header_init(_a53_obj, 306u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_890: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_i32_i32_3103e027_t* _a57_obj = &_a56_storage;
                vader_obj_header_init(_a57_obj, 226u);
                _a57_obj->f__0 = l8;
                _a57_obj->f__1 = l10;
                l5 = (void*) _a57_obj;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a59_arr = vader_array_new(8u, 0u, 0u, 164u);
    l4 = (void*) _a59_arr;
    vader_array_t* _a60_arr = vader_array_new(9u, 0u, 7u, 167u);
    l5 = (void*) _a60_arr;
    vader_array_t* _a61_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a61_arr;
    ...
    vader_obj_header_init(_a62_obj, 355u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_string_i32_4ccf6d4f_t* _a66_obj = &_a65_storage;
                vader_obj_header_init(_a66_obj, 231u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a68_arr = vader_array_new(9u, 0u, 7u, 167u);
    l4 = (void*) _a68_arr;
    vader_array_t* _a69_arr = vader_array_new(16u, 0u, 0u, 175u);
    l5 = (void*) _a69_arr;
    vader_array_t* _a70_arr = vader_array_new(9u, 0u, 7u, 167u);
    l6 = (void*) _a70_arr;
    ...
    vader_obj_header_init(_a71_obj, 279u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_struct___Tuple_i32_Array_i32__9e989074_t* _a74_obj = (vader_struct___Tuple_i32_Array_i32__9e989074_t*) vader_gc_alloc(sizeof(vader_struct___Tuple_i32_Array_i32__9e989074_t));
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(40u, 0u, 13u, 496u);
    l3 = (void*) _a7_arr;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    void* l35 = NULL;
    void* l42 = NULL;
    size_t l4, l5, l9, l10, l13, l14, l36, l37;
    int32_t l7, l11, l15, l28, l29, l31, l38, l39, l40, l41;
    vader_box_t l16 = vader_box_null(), l43 = vader_box_null();
    ...
    bool t4;
    size_t t5;
    vader_box_t* gc_roots[3] = { &l16, &l43, &t2 };
    void** gc_raw_roots[20] = { &l0, &l1, &l2, &l3, &l6, &l8, &l12, &l17, &l21, &l24, &l25, &l26, &l27, &l30, &l32, &l33, &l34, &l35, &l42, &t0 };
    ...
    vader_string_t* gc_atom_roots[4] = { &l18, &l22, &l23, &l45 };
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(122u, 0u, 13u, 1077u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(122u, 0u, 13u, 1077u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 504u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(38u, 0u, 13u, 493u);
                    l8 = (void*) _a23_arr;
                    ...
                    l10 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_395: {
                            if ((l10 < l9)) {
                                ...
                                l19 = ((vader_struct_vader_bytecode_BcField_t*) l17)->f_c_size;
                                l20 = ((vader_struct_vader_bytecode_BcField_t*) l17)->f_c_size_missing;
                                ...
                                _a25_obj->f_c_size = l19;
                                _a25_obj->f_c_size_missing = l20;
                                l21 = (void*) _a25_obj;
                                vader_array_push((vader_array_t*) l8, vader_ref_box(l21));
                                t1 = (l10 + INT64_C(1));
                                l10 = (size_t) (int64_t) t1;
                                goto loop_395;
                            } else {
                    ...
                    l22 = ((vader_struct_vader_bytecode_BcStruct_t*) l6)->f_name;
                    l23 = ((vader_struct_vader_bytecode_BcStruct_t*) l6)->f_c_name;
                    ...
                    if (l16.tag == 505u) {
                        ...
                        vader_array_t* _a27_arr = vader_array_new(9u, 0u, 7u, 167u);
                        l26 = (void*) _a27_arr;
                        l27 = ((vader_struct_vader_bytecode_BcUnion_t*) l25)->f_variants;
                        l13 = ((vader_array_t*) l27)->length;
                        l14 = (size_t) (int64_t) INT64_C(0);
                        {
                            loop_472: {
                                if ((l14 < l13)) {
                                    vader_array_t* _a28_slotarr = ((vader_array_t*) l27);
                                    if (_a28_slotarr->buf != NULL && _a28_slotarr->buf->header.forward != NULL) { _a28_slotarr->buf = vader_array_buf_forward(_a28_slotarr->buf); }
                                    if ((size_t) l14 >= _a28_slotarr->length) { vader_trap("array index out of bounds"); }
                                    l28 = ((int32_t*) _a28_slotarr->buf->slots)[_a28_slotarr->offset + (size_t) l14];
                                    l29 = vader_bytecode_remap_idx(l2, l28);
                        ...
                        _a29_obj->f_variants = l26;
                        l30 = (void*) _a29_obj;
                        vader_array_push((vader_array_t*) l1, vader_ref_box(l30));
                    } else {
                        if (l16.tag == 491u) {
                            t0 = l16.payload.obj;
                            l31 = ((vader_struct_vader_bytecode_BcArray_t*) t0)->f_element;
                            t3 = vader_bytecode_remap_idx(l2, l31);
                            ...
                            l32 = (void*) _a30_obj;
                            vader_array_push((vader_array_t*) l1, vader_ref_box(l32));
                        } else {
                            if (l16.tag == 494u) {
                                l33 = l16.payload.obj;
                                vader_array_t* _a31_arr = vader_array_new(9u, 0u, 7u, 167u);
                                l34 = (void*) _a31_arr;
                                l35 = ((vader_struct_vader_bytecode_BcFn_t*) l33)->f_params;
                                l36 = ((vader_array_t*) l35)->length;
                                l37 = (size_t) (int64_t) INT64_C(0);
                                {
                                    loop_536: {
                                        if ((l37 < l36)) {
                                            vader_array_t* _a32_slotarr = ((vader_array_t*) l35);
                                            if (_a32_slotarr->buf != NULL && _a32_slotarr->buf->header.forward != NULL) { _a32_slotarr->buf = vader_array_buf_forward(_a32_slotarr->buf); }
                                            if ((size_t) l37 >= _a32_slotarr->length) { vader_trap("array index out of bounds"); }
                                            l38 = ((int32_t*) _a32_slotarr->buf->slots)[_a32_slotarr->offset + (size_t) l37];
                                            l39 = vader_bytecode_remap_idx(l2, l38);
                                            vader_array_push_i32((vader_array_t*) l34, l39);
                                            t1 = (l37 + INT64_C(1));
                                            l37 = (size_t) (int64_t) t1;
                                            goto loop_536;
                                        } else {
                                        }
                                    }
                                }
                                l40 = ((vader_struct_vader_bytecode_BcFn_t*) l33)->f_return_type;
                                l41 = vader_bytecode_remap_idx(l2, l40);
                                ...
                                _a33_obj->f_params = l34;
                                _a33_obj->f_return_type = l41;
                                l42 = (void*) _a33_obj;
                                vader_array_push((vader_array_t*) l1, vader_ref_box(l42));
                            } else {
                                l43 = l16;
                                vader_array_push((vader_array_t*) l1, l43);
                            }
                        }
                    }
                }
    ...
    VADER_WRITE_BARRIER((vader_struct_vader_bytecode_EmitterCtx_t*) l0);
    vader_array_t* _a34_arr = vader_array_new(8u, 0u, 0u, 164u);
    l1 = (void*) _a34_arr;
    vader_array_t* _a35_arr = vader_array_new(9u, 0u, 7u, 167u);
    l3 = (void*) _a35_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_623: {
            if ((l5 >= l4)) {
                ...
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l22 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__0;
                l11 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
                l15 = vader_bytecode_remap_idx(l2, l11);
                if ((l15 >= INT32_C(0))) {
                    std_collections_put__string__i32(l1, l22, l15);
                } else {
                }
                goto loop_623;
            }
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_679: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a43_arr = vader_array_new(9u, 0u, 7u, 167u);
                l6 = (void*) _a43_arr;
                ...
                l44 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_result;
                l15 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_result_type;
                l28 = vader_bytecode_remap_idx(l2, l15);
                ...
                l24 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature)->f_param_by_address;
                ...
                _a45_obj->f_result = l44;
                _a45_obj->f_param_types = l6;
                _a45_obj->f_result_type = l28;
                _a45_obj->f_param_names = l17;
                _a45_obj->f_param_mutable = l21;
                _a45_obj->f_param_by_address = l24;
                l25 = (void*) _a45_obj;
                ((vader_struct_vader_bytecode_BcFunction_t*) l3)->f_signature = l25;
    ...
    vader_array_t* _a48_arr = vader_array_new(40u, 0u, 13u, 496u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_808: {
            if ((l5 < l4)) {
                ...
                l22 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_mangled_name;
                l17 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_params;
                l44 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_result;
                ...
                l24 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_mutable;
                l25 = ((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_signature)->f_param_by_address;
                ...
                _a52_obj->f_result = l44;
                _a52_obj->f_param_types = l8;
                _a52_obj->f_result_type = l28;
                _a52_obj->f_param_names = l21;
                _a52_obj->f_param_mutable = l24;
                _a52_obj->f_param_by_address = l25;
                l26 = (void*) _a52_obj;
                l20 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_is_extern;
                l23 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_c_header;
                l45 = ((vader_struct_vader_bytecode_BcImport_t*) l6)->f_c_library;
                ...
                _a53_obj->f_mangled_name = l22;
                _a53_obj->f_signature = l26;
                _a53_obj->f_is_extern = l20;
                _a53_obj->f_c_header = l23;
                _a53_obj->f_c_library = l45;
                l27 = (void*) _a53_obj;
...
static void vader_bytecode_push_scope(void* l0, void* l1, size_t l2, vader_string_t l3, int32_t l4) {
    ...
    l5 = ((vader_array_t*) l0)->length;
    if (l2 == l5) {
        vader_array_push((vader_array_t*) l0, vader_box_string(164u, l3));
        vader_array_push_i32((vader_array_t*) l1, l4);
    } else {
        vader_array_t* _a0_slotarr = ((vader_array_t*) l0);
        if (_a0_slotarr->buf != NULL && _a0_slotarr->buf->header.forward != NULL) { _a0_slotarr->buf = vader_array_buf_forward(_a0_slotarr->buf); }
        if ((size_t) l2 >= _a0_slotarr->length) { vader_trap("array index out of bounds"); }
        vader_array_box_slots(_a0_slotarr->buf)[_a0_slotarr->offset + (size_t) l2] = vader_box_string(164u, l3);
        VADER_WRITE_BARRIER(_a0_slotarr->buf);
        vader_array_t* _a1_slotarr = ((vader_array_t*) l1);
        if (_a1_slotarr->buf != NULL && _a1_slotarr->buf->header.forward != NULL) { _a1_slotarr->buf = vader_array_buf_forward(_a1_slotarr->buf); }
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(124u, 1u, 13u, 1094u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 633u) {
        ...
        vader_obj_header_init(_a2_obj, 633u);
    ...
    if (l0.tag == 610u) {
        ...
        vader_obj_header_init(_a10_obj, 610u);
    ...
    if (l0.tag == 555u) {
        ...
        vader_obj_header_init(_a11_obj, 555u);
    ...
    if (l0.tag == 613u) {
        ...
        vader_obj_header_init(_a14_obj, 613u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(120u, 0u, 13u, 1070u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 167u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 606u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (l27) {
                                    ...
                                    if (_a15_slotarr->buf != NULL && _a15_slotarr->buf->header.forward != NULL) { _a15_slotarr->buf = vader_array_buf_forward(_a15_slotarr->buf); }
                                    if ((size_t) l16 >= _a15_slotarr->length) { vader_trap("array index out of bounds"); }
                                    t3 = vader_box_bool(162u, ((uint8_t*) _a15_slotarr->buf->slots)[_a15_slotarr->offset + (size_t) l16]);
                                    l26 = t3.payload.b;
                                }
                                if (!(l26)) {
                                    t1 = ((vader_struct_vader_bytecode_LocalSet_t*) l18)->f_slot;
                                ...
                                if (l9.tag == 616u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 617u);
                        ...
                        if (l9.tag == 616u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 617u);
                    ...
                    if (l9.tag == 616u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 617u);
                ...
                if (l9.tag == 616u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 617u);
...
static vader_box_t vader_bytecode_shl_op(uint8_t l0) {
    ...
    vader_obj_header_init(_a1_obj, 572u);
    t1 = (void*) _a1_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static vader_box_t vader_bytecode_slot_width_for(uint8_t l0) {
    ...
    if (l0 == INT32_C(14)) {
        return vader_box_i32(167u, INT32_C(4));
    }
    if (l0 == INT32_C(15)) {
        return vader_box_i32(167u, INT32_C(4));
    }
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(120u, 0u, 13u, 1070u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 1u, 7u, 167u);
            ...
            if (l5.tag == 581u) {
                ...
                if (l4.tag == 581u) {
                    ...
                    if (l0.tag == 595u) {
                        ...
                        vader_obj_header_init(_a5_obj, 581u);
                    ...
                    if (l0.tag == 589u) {
                        ...
                        vader_obj_header_init(_a6_obj, 581u);
        ...
        if (l5.tag == 581u) {
            ...
            if (l4.tag == 581u) {
                ...
                if (l0.tag == 576u) {
                    ...
                    vader_obj_header_init(_a7_obj, 581u);
                ...
                if (l0.tag == 595u) {
                    ...
                    vader_obj_header_init(_a8_obj, 581u);
                ...
                if (l0.tag == 589u) {
                    ...
                    vader_obj_header_init(_a9_obj, 581u);
    ...
    if (l5.tag == 581u) {
        ...
        if (l4.tag == 581u) {
            ...
            if (l0.tag == 576u) {
                ...
                vader_obj_header_init(_a10_obj, 581u);
            ...
            if (l0.tag == 595u) {
                ...
                vader_obj_header_init(_a11_obj, 581u);
            ...
            if (l0.tag == 589u) {
                ...
                vader_obj_header_init(_a12_obj, 581u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        ...
        t1 = concat_5(741u, l2, 502u, l3, 521u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 918u) {
        l1 = l0.payload.obj;
        ...
        t1 = concat_5(817u, l2, 502u, l3, 521u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 908u) {
        t0 = l0.payload.obj;
