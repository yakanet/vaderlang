...
static vader_box_t vader_bytecode_arith_op(uint8_t l0, vader_string_t l1) {
    ...
    if (t0) {
        ...
        if (l1 == 2117u) {
            ...
            vader_obj_header_init(_a5_obj, 599u);
            t1 = (void*) _a5_obj;
            { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
        }
        if (l1 == 1853u) {
    ...
    if (l1 == 2117u) {
        ...
        vader_obj_header_init(_a9_obj, 579u);
        t1 = (void*) _a9_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l1 == 1853u) {
        ...
        vader_obj_header_init(_a10_obj, 573u);
        t1 = (void*) _a10_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    vader_obj_header_init(_a11_obj, 566u);
    t1 = (void*) _a11_obj;
    { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_bytecode_bit_op(uint8_t l0, vader_string_t l1) {
    ...
    if (l1 == 1891u) {
        ...
        vader_obj_header_init(_a4_obj, 563u);
        t1 = (void*) _a4_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_bytecode_cmp_ne(uint8_t l0) {
    ...
    vader_obj_header_init(_a5_obj, 574u);
    t0 = (void*) _a5_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(43u, 0u, 13u, 623u);
    l5 = (void*) _a0_arr;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_160: {
            if ((l7 < l1)) {
                ...
                vader_obj_header_init(_a11_obj, 623u);
    ...
    vader_array_t* _a14_arr = vader_array_new(41u, 0u, 13u, 501u);
    l10 = (void*) _a14_arr;
    ...
    vader_array_t* _a17_arr = vader_array_new(43u, 0u, 13u, 623u);
    l17 = (void*) _a17_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_245: {
        ...
        loop_269: {
            if ((l7 < l2)) {
                ...
                if ((l9 < INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a27_obj, 623u);
    ...
    vader_array_t* _a31_arr = vader_array_new(120u, 0u, 13u, 1074u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 518u || l0.tag == 534u || l0.tag == 547u || l0.tag == 565u || l0.tag == 585u || l0.tag == 616u || l0.tag == 631u)) {
        return l0;
    }
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(120u, 0u, 13u, 1074u);
    l8 = (void*) _a10_arr;
            ...
            if ((l6 < l4)) {
                ...
                if (l7.tag == 611u) {
                    ...
                    if (t3) {
                        ...
                        vader_obj_header_init(_a18_obj, 611u);
                        _a18_obj->f_slot = t1;
                        l19 = (void*) _a18_obj;
                ...
                if (l7.tag == 612u) {
                    ...
                    vader_obj_header_init(_a22_obj, 612u);
                    _a22_obj->f_slot = t1;
                    l22 = (void*) _a22_obj;
                ...
                if (l7.tag == 609u) {
                    ...
                    vader_obj_header_init(_a28_obj, 609u);
                    _a28_obj->f_slot = l30;
    ...
    vader_array_t* _a30_arr = vader_array_new(41u, 0u, 13u, 501u);
    l17 = (void*) _a30_arr;
    l4 = l1;
    {
        loop_495: {
                            ...
                            if (l7.tag == 544u) {
                                if ((l4 > INT64_C(0))) {
                                    ...
                                    if (t2 == 1799u) {
                                        ...
                                        vader_obj_header_init(_a6_obj, 623u);
                                        _a6_obj->f_first = l11;
                                        _a6_obj->f_last = l12;
                                        l13 = (void*) _a6_obj;
...
static vader_box_t vader_bytecode_mod_op(uint8_t l0) {
    ...
    if (t0) {
        ...
        vader_obj_header_init(_a2_obj, 592u);
        t1 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(122u, 0u, 13u, 1081u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 504u);
    ...
    l3 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(39u, 0u, 13u, 499u);
    l4 = (void*) _a11_arr;
    ...
    l6 = (void*) _a19_obj;
    vader_array_t* _a20_arr = vader_array_new(40u, 0u, 13u, 500u);
    l7 = (void*) _a20_arr;
    ...
    l9 = (void*) _a28_obj;
    vader_array_t* _a29_arr = vader_array_new(37u, 0u, 13u, 496u);
    l10 = (void*) _a29_arr;
    ...
    vader_obj_header_init(_a34_obj, 281u);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_obj_header_init(_a18_obj, 279u);
    ...
    vader_array_t* _a26_arr = vader_array_new(120u, 0u, 13u, 1074u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(124u, 0u, 13u, 1098u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    l5 = (void*) _a29_obj;
    vader_array_t* _a30_arr = vader_array_new(39u, 0u, 13u, 499u);
    l13 = (void*) _a30_arr;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_559: {
                    ...
                    loop_706: {
                        if ((l15 < l11)) {
                            ...
                            if (l19.tag == 559u) {
                                ...
                                vader_obj_header_init(_a41_obj, 559u);
                            ...
                            if (l19.tag == 614u) {
                                ...
                                vader_obj_header_init(_a44_obj, 614u);
    ...
    vader_array_t* _a46_arr = vader_array_new(37u, 0u, 13u, 496u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
        ...
        loop_822: {
            if ((l7 < l3)) {
                ...
                if ((l8 >= INT32_C(0))) {
                    ...
                    vader_obj_header_init(_a49_obj, 496u);
    ...
    vader_obj_header_init(_a71_obj, 281u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
...
void vader_bytecode_prune_unused_imports(void* l0) {
    ...
    l2 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(40u, 0u, 13u, 500u);
    l3 = (void*) _a7_arr;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 167u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(122u, 0u, 13u, 1081u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(122u, 0u, 13u, 1081u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_372: {
            if ((l5 < l4)) {
                ...
                if (l16.tag == 508u) {
                    l6 = l16.payload.obj;
                    vader_array_t* _a23_arr = vader_array_new(38u, 0u, 13u, 497u);
                    l8 = (void*) _a23_arr;
    ...
    vader_array_t* _a48_arr = vader_array_new(40u, 0u, 13u, 500u);
    l1 = (void*) _a48_arr;
    l3 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_imports;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(124u, 1u, 13u, 1098u);
...
static vader_box_t vader_bytecode_remap_type_in_op(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 559u) {
        ...
        vader_obj_header_init(_a11_obj, 559u);
    ...
    if (l0.tag == 609u) {
        ...
        vader_obj_header_init(_a12_obj, 609u);
        _a12_obj->f_slot = l3;
    ...
    if (l0.tag == 617u) {
        ...
        vader_obj_header_init(_a14_obj, 617u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(120u, 0u, 13u, 1074u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 167u);
    l14 = (void*) _a8_arr;
                        ...
                        if (l22.tag == 610u) {
                            ...
                            if (l13 == l17) {
                                ...
                                if (!(l26)) {
                                    ...
                                    vader_obj_header_init(_a16_obj, 612u);
                                    _a16_obj->f_slot = t1;
                                    l28 = (void*) _a16_obj;
                                ...
                                if (l9.tag == 620u) {
                                    ...
                                    if ((l20 > l30)) {
                                        ...
                                        if (!(l33.tag == 0u)) {
                                            ...
                                            vader_obj_header_init(_a19_obj, 621u);
                        ...
                        if (l9.tag == 620u) {
                            ...
                            if ((l20 > l30)) {
                                ...
                                if (!(l33.tag == 0u)) {
                                    ...
                                    vader_obj_header_init(_a75_obj, 621u);
                    ...
                    if (l9.tag == 620u) {
                        ...
                        if ((l20 > l30)) {
                            ...
                            if (!(l33.tag == 0u)) {
                                ...
                                vader_obj_header_init(_a103_obj, 621u);
                ...
                if (l9.tag == 620u) {
                    ...
                    if ((l20 > l30)) {
                        ...
                        if (!(l33.tag == 0u)) {
                            ...
                            vader_obj_header_init(_a131_obj, 621u);
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(120u, 0u, 13u, 1074u);
    l6 = (void*) _a1_arr;
            ...
            if (l5.tag == 585u) {
                ...
                if (l4.tag == 585u) {
                    ...
                    if (l0.tag == 593u) {
                        ...
                        vader_obj_header_init(_a6_obj, 585u);
        ...
        if (l5.tag == 585u) {
            ...
            if (l4.tag == 585u) {
                ...
                if (l0.tag == 599u) {
                    ...
                    vader_obj_header_init(_a8_obj, 585u);
                ...
                if (l0.tag == 593u) {
                    ...
                    vader_obj_header_init(_a9_obj, 585u);
    ...
    if (l5.tag == 585u) {
        ...
        if (l4.tag == 585u) {
            ...
            if (l0.tag == 580u) {
                ...
                vader_obj_header_init(_a10_obj, 585u);
            ...
            if (l0.tag == 593u) {
                ...
                vader_obj_header_init(_a12_obj, 585u);
...
static vader_box_t vader_bytecode_with_remapped_slot(vader_box_t l0, int32_t l1) {
    ...
    if (l0.tag == 612u) {
        ...
        vader_obj_header_init(_a2_obj, 612u);
        _a2_obj->f_slot = l1;
        t0 = (void*) _a2_obj;
        { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    }
