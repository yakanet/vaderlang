        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_169: {
                if ((l6 < l5)) {
                    ...
                    l9 = std_core_write_string_at(l8, l9, 858u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    if (l0 == INT32_C(1)) {
        t0 = vader_bytecode_arith_op(l1, 2100u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(2)) {
    ...
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2388u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
    ...
    l6 = INT32_C(0);
    {
        loop_38: {
            if ((l6 < INT32_C(16))) {
                ...
                l3 = (size_t) (int64_t) t1;
                l8 = vader_string_slice_codepoints(444u, l2, l3);
                l5 = concat_2(l5, l8);
                l6 = (l6 + INT32_C(1));
                goto loop_38;
            } else {
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2068u, 609u, 1234u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(5); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2068u, 600u, 1620u);
    if (l0 == l1) {
...
static bool vader_bytecode_is_display_to_string(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 1u, 0u, gc_roots, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 243u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_strip_core_member(l0, 240u);
    if (!(l1.tag == 0u)) {
        t0 = l1.payload.s;
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2100u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_7(2019u, 239u, l0, 239u, l1, 239u, l2);
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2020u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2020u);
    l5 = ((vader_array_t*) l3)->length;
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 858u);
    ...
    l3 = std_core_write_string_at(l6, l3, 858u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 923u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2399u);
        t1 = concat_5(732u, l2, 494u, l3, 513u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 924u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) l1)->f_symbol);
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2399u);
        t1 = concat_5(808u, l2, 494u, l3, 513u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 914u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 912u) {
        ...
        t1 = concat_3(533u, l2, 513u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 928u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2399u);
        t1 = concat_3(814u, l2, 513u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 925u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2399u);
        t1 = concat_3(810u, l2, 513u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 915u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_FnType_t*) l1)->f_params, 360u);
        l3 = vader_bytecode_type_intern_key(((vader_struct_vader_types_FnType_t*) l1)->f_return_type);
        t1 = concat_4(595u, l2, 342u, l3);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 927u) {
        t0 = l0.payload.obj;
