    ...
    if (l0.tag == 936u) {
        ...
        if (l0.tag == 929u) {
            ...
            if (l0.tag == 926u) {
                ...
                if ((l0.tag == 931u || l0.tag == 932u || l0.tag == 933u || l0.tag == 934u || l0.tag == 937u || l0.tag == 941u || l0.tag == 942u || l0.tag == 944u)) {
                    l1 = vader_types_display_type(l0);
                } else {
                    if ((l0.tag == 927u || l0.tag == 928u || l0.tag == 930u || l0.tag == 938u || l0.tag == 939u || l0.tag == 940u || l0.tag == 943u)) {
                        l1 = 0u;
                    } else {
...
uint8_t vader_bytecode_bc_single_result(void* l0) {
    ...
    if ((t0 > INT64_C(1))) {
        ...
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l1, l2, 1378u);
        t0 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcSignature_t*) l0)->f_results)->length;
...
int32_t vader_bytecode_bc_single_result_type(void* l0) {
    ...
    if ((t0 > INT64_C(1))) {
        ...
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l1, l2, 1377u);
        t0 = ((vader_array_t*) ((vader_struct_vader_bytecode_BcSignature_t*) l0)->f_result_types)->length;
        t1 = ((int64_t) (size_t) t0);
        l3 = (uint64_t) (int64_t) t1;
        l2 = std_core_write_unsigned(l1, l2, l3);
...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 512u) {
        ...
        l3 = std_core_write_string_at(l8, l3, 2014u);
        ...
        l6 = (size_t) (int64_t) INT64_C(0);
        {
            loop_166: {
                if ((l6 < l5)) {
                    ...
                    l8 = std_core_write_string_at(l4, l8, 891u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l0 == INT32_C(0)) {
        l2 = vader_bytecode_arith_op(l1, 1230u);
    } else {
        if (l0 == INT32_C(1)) {
            l2 = vader_bytecode_arith_op(l1, 2210u);
        } else {
            if (l0 == INT32_C(2)) {
                l2 = vader_bytecode_arith_op(l1, 1964u);
            } else {
                if (l0 == INT32_C(3)) {
                    ...
                    if (l0 == INT32_C(4)) {
                        ...
                        if (l0 == INT32_C(5)) {
                            ...
                            if (l0 == INT32_C(6)) {
                                ...
                                if (l0 == INT32_C(7)) {
                                    l2 = vader_bytecode_bit_op(l1, 1248u);
                                } else {
                                    if (l0 == INT32_C(8)) {
                                        l2 = vader_bytecode_bit_op(l1, 2008u);
                                    } else {
                                        if (l0 == INT32_C(9)) {
                                            l2 = vader_bytecode_bit_op(l1, 2513u);
                                        } else {
                                            if (l0 == INT32_C(10)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a31_arr = vader_array_new(129u, 0u, 13u, 1114u);
    l5 = (void*) _a31_arr;
...
static vader_box_t vader_bytecode_div_op(uint8_t l0) {
    ...
    t2 = vader_bytecode_arith_op(l0, 1518u);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(129u, 0u, 13u, 1114u);
    l15 = (void*) _a10_arr;
        ...
        loop_14: {
            if ((l6 < l5)) {
                ...
                if (l7.tag == 524u) {
                    ...
                    vader_bytecode_push_scope(l2, l3, l4, 1329u, l8);
                    t0 = (l4 + INT64_C(1));
                    l4 = (size_t) (int64_t) t0;
                } else {
                    if (l7.tag == 622u) {
                        l9 = ((int32_t) (size_t) l6);
                        vader_bytecode_push_scope(l2, l3, l4, 1906u, l9);
                        t0 = (l4 + INT64_C(1));
                        l4 = (size_t) (int64_t) t0;
                    } else {
                        if (l7.tag == 609u) {
                            l10 = ((int32_t) (size_t) l6);
                            vader_bytecode_push_scope(l2, l3, l4, 1765u, l10);
                            t0 = (l4 + INT64_C(1));
                            l4 = (size_t) (int64_t) t0;
                        } else {
                            if (l7.tag == 552u) {
...
static vader_string_t vader_bytecode_int_equals_method(vader_string_t l0) {
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1553u; }
    }
    ...
    if (l2) {
        { vader_gc_top = gc_frame.prev; return 1992u; }
    }
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2178u, 634u, 1311u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(5); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2178u, 625u, 1709u);
    if (l0 == l1) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(132u, 0u, 13u, 1124u);
    l0 = (void*) _a0_arr;
    vader_struct_vader_bytecode_BcPrimitive_t* _a1_obj = (vader_struct_vader_bytecode_BcPrimitive_t*) vader_gc_alloc(sizeof(vader_struct_vader_bytecode_BcPrimitive_t));
    vader_obj_header_init(_a1_obj, 512u);
    ...
    l1 = (void*) _a5_obj;
    std_collections_MutableMap_IndexSet_set_at__string__i32(l1, 1993u, INT32_C(0));
    ...
    vader_obj_header_init(_a10_obj, 936u);
    _a10_obj->f_name = 1993u;
    t0 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 936u);
    _a11_obj->f_name = 1993u;
    t0 = (void*) _a11_obj;
    ...
    vader_obj_header_init(_a17_obj, 365u);
    _a17_obj->f_ekeys = l6;
    _a17_obj->f_evals = l7;
    _a17_obj->f_index = l8;
    ...
    vader_obj_header_init(_a26_obj, 365u);
    _a26_obj->f_ekeys = l9;
    ...
    vader_obj_header_init(_a35_obj, 365u);
...
static vader_box_t vader_bytecode_primitive_arith_op(vader_string_t l0) {
    ...
    if (l2) {
        ...
        t2 = vader_bytecode_arith_op(t1, 1230u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 2210u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    ...
    if (l2) {
        t0 = l1.payload.s;
        t1 = vader_bytecode_val_type_of_primitive_name(t0);
        t2 = vader_bytecode_arith_op(t1, 1964u);
        { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
vader_string_t vader_bytecode_primitive_member_mangle(vader_string_t l0, vader_string_t l1, vader_string_t l2) {
    ...
    vader_gc_top = &gc_frame;
    t0 = concat_6(2129u, l0, 262u, l1, 262u, l2);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a26_arr = vader_array_new(129u, 0u, 13u, 1114u);
    l3 = (void*) _a26_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_obj_header_init(_a20_obj, 365u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_obj_header_init(_a65_obj, 365u);
    _a65_obj->f_ekeys = l4;
    _a65_obj->f_evals = l5;
    _a65_obj->f_index = l6;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    void** gc_raw_roots[18] = { &l0, &l1, &l2, &l3, &l6, &l7, &l8, &l12, &l21, &l22, &l23, &l26, &l28, &l29, &l30, &l37, &l41, &t0 };
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 3u, 18u, gc_roots, gc_raw_roots, 2u, gc_stack_objs, 4u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(9u, 0u, 7u, 179u);
    l1 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(6u, 0u, 12u, 174u);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_207: {
            if ((l5 >= l4)) {
                ...
                l11 = ((int32_t*) _a12_slotarr->buf->slots)[_a12_slotarr->offset + (size_t) l5];
                ...
                _a15_obj->f__1 = l3;
                t0 = (void*) _a15_obj;
                l8 = ((vader_struct___Tuple_i32_Array_i32__9e989074_t*) t0)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
                l9 = ((vader_array_t*) l8)->length;
                l10 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l10 < l9)) {
                            vader_array_t* _a16_slotarr = ((vader_array_t*) l8);
                            if (_a16_slotarr->buf != NULL && _a16_slotarr->buf->header.forward != NULL) { _a16_slotarr->buf = vader_array_buf_forward(_a16_slotarr->buf); }
                            if ((size_t) l10 >= _a16_slotarr->length) { vader_trap("array index out of bounds"); }
                            l15 = ((int32_t*) _a16_slotarr->buf->slots)[_a16_slotarr->offset + (size_t) l10];
                            vader_array_push_i32((vader_array_t*) l2, l15);
                            t1 = (l10 + INT64_C(1));
                            l10 = (size_t) (int64_t) t1;
                            goto loop_236;
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 179u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(132u, 0u, 13u, 1124u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_307: {
    ...
    vader_array_t* _a21_arr = vader_array_new(132u, 0u, 13u, 1124u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
            ...
            if ((l5 < l4)) {
                ...
                if (l16.tag == 516u) {
                    ...
                    l10 = (size_t) (int64_t) INT64_C(0);
                    {
                        loop_379: {
                            if ((l10 < l9)) {
                                vader_array_t* _a24_slotarr = ((vader_array_t*) l7);
                                if (_a24_slotarr->buf != NULL && _a24_slotarr->buf->header.forward != NULL) { _a24_slotarr->buf = vader_array_buf_forward(_a24_slotarr->buf); }
                                if ((size_t) l10 >= _a24_slotarr->length) { vader_trap("array index out of bounds"); }
                                l8 = vader_array_ref_load_obj(_a24_slotarr->buf, _a24_slotarr->offset + (size_t) l10);
                    ...
                    if (l16.tag == 517u) {
                        ...
                        l14 = (size_t) (int64_t) INT64_C(0);
                        {
                            vader_array_t* _pc452_hdr = (vader_array_t*) l22;
                            size_t _pc452_len = _pc452_hdr->length;
                            size_t _pc452_cap = (_pc452_hdr->offset == 0 && !vader_array_is_borrowed(_pc452_hdr) && _pc452_hdr->length >= _pc452_hdr->buf->length) ? _pc452_hdr->capacity : (size_t) 0;
                            void* _pc452_slots = _pc452_hdr->buf->slots;
                            loop_452: {
                                if ((l14 < l13)) {
                                    ...
                                    if (VADER_LIKELY(_pc452_len < _pc452_cap)) {
                                        ((int32_t*) _pc452_slots)[_pc452_len] = (int32_t) (l25);
                                        _pc452_len += 1;
                                    } else {
                                        _pc452_hdr->length = _pc452_len;
                                        if (_pc452_hdr->buf->length < _pc452_len) { _pc452_hdr->buf->length = _pc452_len; }
                                        vader_array_push_i32((vader_array_t*) l22, l25);
                                        _pc452_hdr = (vader_array_t*) l22;
                                        _pc452_len = _pc452_hdr->length;
                                        _pc452_cap = (_pc452_hdr->offset == 0 && !vader_array_is_borrowed(_pc452_hdr) && _pc452_hdr->length >= _pc452_hdr->buf->length) ? _pc452_hdr->capacity : (size_t) 0;
                                        _pc452_slots = _pc452_hdr->buf->slots;
                                    }
                                    t1 = (l14 + INT64_C(1));
                                    l14 = (size_t) (int64_t) t1;
                                    goto loop_452;
                        ...
                        if (l16.tag == 503u) {
                            ...
                            if (l16.tag == 506u) {
                                ...
                                {
                                    vader_array_t* _pc514_hdr = (vader_array_t*) l29;
                                    size_t _pc514_len = _pc514_hdr->length;
                                    size_t _pc514_cap = (_pc514_hdr->offset == 0 && !vader_array_is_borrowed(_pc514_hdr) && _pc514_hdr->length >= _pc514_hdr->buf->length) ? _pc514_hdr->capacity : (size_t) 0;
                                    void* _pc514_slots = _pc514_hdr->buf->slots;
                                    loop_514: {
                                        if ((l32 < l31)) {
                                            ...
                                            if (VADER_LIKELY(_pc514_len < _pc514_cap)) {
                                                ((int32_t*) _pc514_slots)[_pc514_len] = (int32_t) (l34);
                                                _pc514_len += 1;
                                            } else {
                                                _pc514_hdr->length = _pc514_len;
                                                if (_pc514_hdr->buf->length < _pc514_len) { _pc514_hdr->buf->length = _pc514_len; }
                                                vader_array_push_i32((vader_array_t*) l29, l34);
                                                _pc514_hdr = (vader_array_t*) l29;
                                                _pc514_len = _pc514_hdr->length;
                                                _pc514_cap = (_pc514_hdr->offset == 0 && !vader_array_is_borrowed(_pc514_hdr) && _pc514_hdr->length >= _pc514_hdr->buf->length) ? _pc514_hdr->capacity : (size_t) 0;
                                                _pc514_slots = _pc514_hdr->buf->slots;
                                            }
                                            t1 = (l32 + INT64_C(1));
                                            l32 = (size_t) (int64_t) t1;
                                            goto loop_514;
    ...
    vader_obj_header_init(_a37_obj, 365u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_601: {
            if ((l5 >= l4)) {
                ...
                l18 = t2.payload.s;
                vader_array_t* _a39_slotarr = ((vader_array_t*) l7);
                if (_a39_slotarr->buf != NULL && _a39_slotarr->buf->header.forward != NULL) { _a39_slotarr->buf = vader_array_buf_forward(_a39_slotarr->buf); }
                if ((size_t) l5 >= _a39_slotarr->length) { vader_trap("array index out of bounds"); }
                l11 = ((int32_t*) _a39_slotarr->buf->slots)[_a39_slotarr->offset + (size_t) l5];
                ...
                l15 = ((vader_struct___Tuple_string_i32_4ccf6d4f_t*) l3)->f__1;
                t1 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t1;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_656: {
            if ((l5 < l4)) {
                ...
                l10 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc675_hdr = (vader_array_t*) l6;
                    size_t _pc675_len = _pc675_hdr->length;
                    size_t _pc675_cap = (_pc675_hdr->offset == 0 && !vader_array_is_borrowed(_pc675_hdr) && _pc675_hdr->length >= _pc675_hdr->buf->length) ? _pc675_hdr->capacity : (size_t) 0;
                    void* _pc675_slots = _pc675_hdr->buf->slots;
                    loop_675: {
                        if ((l10 < l9)) {
                            vader_array_t* _a44_slotarr = ((vader_array_t*) l7);
                            ...
                            l11 = ((int32_t*) _a44_slotarr->buf->slots)[_a44_slotarr->offset + (size_t) l10];
                            l15 = vader_bytecode_remap_idx(l2, l11);
                            if (VADER_LIKELY(_pc675_len < _pc675_cap)) {
                                ((int32_t*) _pc675_slots)[_pc675_len] = (int32_t) (l15);
                                _pc675_len += 1;
                            } else {
                                _pc675_hdr->length = _pc675_len;
                                if (_pc675_hdr->buf->length < _pc675_len) { _pc675_hdr->buf->length = _pc675_len; }
                                vader_array_push_i32((vader_array_t*) l6, l15);
                                _pc675_hdr = (vader_array_t*) l6;
                                _pc675_len = _pc675_hdr->length;
                                _pc675_cap = (_pc675_hdr->offset == 0 && !vader_array_is_borrowed(_pc675_hdr) && _pc675_hdr->length >= _pc675_hdr->buf->length) ? _pc675_hdr->capacity : (size_t) 0;
                                _pc675_slots = _pc675_hdr->buf->slots;
                            }
                            t1 = (l10 + INT64_C(1));
                            l10 = (size_t) (int64_t) t1;
                            goto loop_675;
                ...
                _a45_obj->f_results = l21;
                _a45_obj->f_param_types = l6;
                _a45_obj->f_result_types = l23;
                _a45_obj->f_param_names = l26;
                _a45_obj->f_param_mutable = l28;
                _a45_obj->f_param_by_address = l29;
                l30 = (void*) _a45_obj;
                ...
                l14 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_736: {
                        if ((l14 < l13)) {
                            ...
                            vader_array_t* _a47_slotarr = ((vader_array_t*) l37);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_778: {
            if ((l5 < l4)) {
                ...
                l10 = (size_t) (int64_t) INT64_C(0);
                {
                    vader_array_t* _pc797_hdr = (vader_array_t*) l7;
                    size_t _pc797_len = _pc797_hdr->length;
                    size_t _pc797_cap = (_pc797_hdr->offset == 0 && !vader_array_is_borrowed(_pc797_hdr) && _pc797_hdr->length >= _pc797_hdr->buf->length) ? _pc797_hdr->capacity : (size_t) 0;
                    void* _pc797_slots = _pc797_hdr->buf->slots;
                    loop_797: {
                        if ((l10 < l9)) {
                            vader_array_t* _a51_slotarr = ((vader_array_t*) l8);
                            if (_a51_slotarr->buf != NULL && _a51_slotarr->buf->header.forward != NULL) { _a51_slotarr->buf = vader_array_buf_forward(_a51_slotarr->buf); }
                            if ((size_t) l10 >= _a51_slotarr->length) { vader_trap("array index out of bounds"); }
                            l11 = ((int32_t*) _a51_slotarr->buf->slots)[_a51_slotarr->offset + (size_t) l10];
                            l15 = vader_bytecode_remap_idx(l2, l11);
                            if (VADER_LIKELY(_pc797_len < _pc797_cap)) {
                                ((int32_t*) _pc797_slots)[_pc797_len] = (int32_t) (l15);
                                _pc797_len += 1;
                            } else {
                                _pc797_hdr->length = _pc797_len;
                                if (_pc797_hdr->buf->length < _pc797_len) { _pc797_hdr->buf->length = _pc797_len; }
                                vader_array_push_i32((vader_array_t*) l7, l15);
                                _pc797_hdr = (vader_array_t*) l7;
                                _pc797_len = _pc797_hdr->length;
                                _pc797_cap = (_pc797_hdr->offset == 0 && !vader_array_is_borrowed(_pc797_hdr) && _pc797_hdr->length >= _pc797_hdr->buf->length) ? _pc797_hdr->capacity : (size_t) 0;
                                _pc797_slots = _pc797_hdr->buf->slots;
                            }
                            t1 = (l10 + INT64_C(1));
                            l10 = (size_t) (int64_t) t1;
                            goto loop_797;
                ...
                _a52_obj->f_params = l21;
                _a52_obj->f_results = l22;
                _a52_obj->f_param_types = l7;
                _a52_obj->f_result_types = l26;
                _a52_obj->f_param_names = l28;
                _a52_obj->f_param_mutable = l29;
                _a52_obj->f_param_by_address = l30;
                l37 = (void*) _a52_obj;
                ...
                _a53_obj->f_signature = l37;
                _a53_obj->f_is_extern = l39;
                _a53_obj->f_c_header = l20;
                _a53_obj->f_c_library = l40;
                _a53_obj->f_c_variadic_fixed = l17;
                l41 = (void*) _a53_obj;
    ...
    l4 = ((vader_array_t*) ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_type_by_slot)->length;
    {
        loop_7: {
            if ((l4 <= l3)) {
                ...
                vader_obj_header_init(_a0_obj, 936u);
                _a0_obj->f_name = 1993u;
                l6 = (void*) _a0_obj;
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(129u, 0u, 13u, 1114u);
    l20 = (void*) _a7_arr;
    l4 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 179u);
    l21 = (void*) _a8_arr;
        ...
        loop_22: {
            if ((l6 < l2)) {
                ...
                if (VADER_LIKELY(_pc22_len < _pc22_cap)) {
                    ...
                    if (_pc22_hdr->buf->length < _pc22_len) { _pc22_hdr->buf->length = _pc22_len; }
                    vader_array_push_i32((vader_array_t*) l5, l7);
...
static bool vader_bytecode_same_intern_class(vader_box_t l0, vader_box_t l1) {
    ...
    if ((l0.tag == 929u || l0.tag == 936u)) {
        l4 = true;
    } else {
        l4 = (l1.tag == 929u || l1.tag == 936u);
    }
    if (l4) {
...
static vader_box_t vader_bytecode_strip_core_member(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 2129u);
    if (!(t0)) {
        l2 = true;
    } else {
    ...
    l4 = vader_host_std_core_byte_len(2129u);
...
static vader_string_t vader_bytecode_symbol_key(void* l0) {
    ...
    if (t0 == 0u) {
        ...
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l1, l2, 1761u);
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) l0)->f_id;
...
static vader_string_t vader_bytecode_tuple_shape_name(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_bytecode_type_key_join(l0, 891u);
    ...
    l3 = std_core_write_string_at(l6, l3, 891u);
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 936u) {
        ...
        if (l0.tag == 938u) {
            ...
            t0 = l0.payload.obj;
            l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) t0)->f_args, 2524u);
            l1 = concat_5(760u, l2, 519u, l3, 538u);
        } else {
            if (l0.tag == 939u) {
                t0 = l0.payload.obj;
                l2 = vader_bytecode_symbol_key(((vader_struct_vader_types_TraitType_t*) t0)->f_symbol);
                t0 = l0.payload.obj;
                l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) t0)->f_args, 2524u);
                l1 = concat_5(838u, l2, 519u, l3, 538u);
            } else {
                if (l0.tag == 929u) {
                    t0 = l0.payload.obj;
                    l1 = ((vader_struct_vader_types_EnumType_t*) t0)->f_repr;
                    ...
                    if (l0.tag == 928u) {
                        ...
                        if (l0.tag == 927u) {
                            ...
                            if (l0.tag == 943u) {
                                t0 = l0.payload.obj;
                                l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) t0)->f_variants, 2524u);
                                l1 = concat_3(844u, l2, 538u);
                            } else {
                                if (l0.tag == 940u) {
                                    t0 = l0.payload.obj;
                                    l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) t0)->f_elements, 2524u);
                                    l1 = concat_3(840u, l2, 538u);
                                } else {
                                    if (l0.tag == 930u) {
                                        t0 = l0.payload.obj;
