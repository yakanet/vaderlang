...
vader_string_t vader_bytecode_bc_type_key(void* l0, int32_t l1) {
    ...
    if (l5.tag == 506u) {
        ...
        l9 = vader_bytecode_key_join(l0, l6, 2414u);
        t1 = concat_3(2246u, l9, 519u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l5.tag == 495u) {
        l6 = l5.payload.obj;
        l7 = ((vader_struct_vader_bytecode_BcFn_t*) l6)->f_params;
        l9 = vader_bytecode_key_join(l0, l7, 2414u);
...
vader_box_t vader_bytecode_binary_op_for(uint8_t l0, uint8_t l1) {
    ...
    if (l0 == INT32_C(9)) {
        t0 = vader_bytecode_bit_op(l1, 2403u);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0 == INT32_C(10)) {
...
void* vader_bytecode_coalesce_slots(void* l0) {
    ...
    vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1071u);
    l5 = (void*) _a31_arr;
...
vader_box_t vader_bytecode_const_op_of(vader_box_t l0) {
    vader_box_t t0;
    if ((l0.tag == 515u || l0.tag == 531u || l0.tag == 544u || l0.tag == 562u || l0.tag == 582u || l0.tag == 613u || l0.tag == 628u)) {
        return l0;
    }
...
void* vader_bytecode_drop_dead_stores(void* l0) {
    ...
    vader_array_t* _a10_arr = vader_array_new(119u, 0u, 13u, 1071u);
    l8 = (void*) _a10_arr;
...
uint8_t vader_bytecode_intrinsic_id_for(vader_string_t l0) {
    ...
    l1 = vader_bytecode_primitive_member_mangle(2084u, 615u, 1229u);
    if (l0 == l1) {
        { vader_gc_top = gc_frame.prev; return (uint8_t) (int32_t) INT32_C(10); }
    }
    l1 = vader_bytecode_primitive_member_mangle(2084u, 606u, 1611u);
    if (l0 == l1) {
...
void* vader_bytecode_new_emitter_ctx(void) {
    ...
    vader_obj_header_init(_a15_obj, 305u);
    _a15_obj->f_ekeys = l5;
    _a15_obj->f_evals = l6;
    _a15_obj->f_index = l7;
    ...
    vader_obj_header_init(_a19_obj, 354u);
    _a19_obj->f_ekeys = l6;
    _a19_obj->f_evals = l7;
    _a19_obj->f_index = l8;
    ...
    vader_obj_header_init(_a24_obj, 305u);
    _a24_obj->f_ekeys = l8;
    _a24_obj->f_evals = l9;
    ...
    vader_obj_header_init(_a28_obj, 354u);
    _a28_obj->f_ekeys = l9;
    ...
    l12 = (void*) _a31_arr;
    vader_array_t* _a32_arr = vader_array_new(15u, 0u, 0u, 174u);
    l13 = (void*) _a32_arr;
    ...
    vader_obj_header_init(_a34_obj, 278u);
...
void* vader_bytecode_propagate_const_single_use(void* l0) {
    ...
    vader_array_t* _a15_arr = vader_array_new(9u, 0u, 7u, 166u);
    l22 = (void*) _a15_arr;
    vader_array_t* _a16_arr = vader_array_new(15u, 0u, 0u, 174u);
    l23 = (void*) _a16_arr;
    vader_array_t* _a17_arr = vader_array_new(9u, 0u, 7u, 166u);
    l24 = (void*) _a17_arr;
    ...
    vader_obj_header_init(_a18_obj, 276u);
    ...
    vader_array_t* _a26_arr = vader_array_new(119u, 0u, 13u, 1071u);
    l3 = (void*) _a26_arr;
    vader_array_t* _a27_arr = vader_array_new(123u, 0u, 13u, 1095u);
    l4 = (void*) _a27_arr;
...
void vader_bytecode_prune_unused_functions(void* l0, void* l1, void* l2) {
    ...
    vader_obj_header_init(_a20_obj, 354u);
    _a20_obj->f_ekeys = l5;
    _a20_obj->f_evals = l6;
    ...
    vader_array_t* _a46_arr = vader_array_new(36u, 0u, 13u, 493u);
    l4 = (void*) _a46_arr;
    l5 = ((vader_struct_vader_bytecode_EmitterCtx_t*) l0)->f_exports;
    ...
    vader_obj_header_init(_a53_obj, 305u);
    _a53_obj->f_ekeys = l4;
    _a53_obj->f_evals = l5;
    _a53_obj->f_index = l6;
    ...
    vader_obj_header_init(_a62_obj, 354u);
    _a62_obj->f_ekeys = l4;
    _a62_obj->f_evals = l5;
    _a62_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_967: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a66_obj, 227u);
                _a66_obj->f__0 = l9;
                _a66_obj->f__1 = l8;
                l5 = (void*) _a66_obj;
    ...
    l4 = (void*) _a68_arr;
    vader_array_t* _a69_arr = vader_array_new(15u, 0u, 0u, 174u);
    l5 = (void*) _a69_arr;
    ...
    vader_obj_header_init(_a71_obj, 278u);
    _a71_obj->f_ekeys = l4;
    _a71_obj->f_evals = l5;
    _a71_obj->f_index = l6;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_1045: {
            if ((l7 >= l3)) {
                ...
                vader_obj_header_init(_a74_obj, 228u);
                _a74_obj->f__0 = l8;
                _a74_obj->f__1 = l5;
                l27 = (void*) _a74_obj;
...
void vader_bytecode_prune_unused_types(void* l0) {
    ...
    vader_array_t* _a18_arr = vader_array_new(9u, 0u, 7u, 166u);
    l2 = (void*) _a18_arr;
    vader_array_t* _a19_arr = vader_array_new(121u, 0u, 13u, 1078u);
    l3 = (void*) _a19_arr;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
    ...
    vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1078u);
    l1 = (void*) _a21_arr;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
    {
    ...
    vader_obj_header_init(_a37_obj, 354u);
    _a37_obj->f_ekeys = l1;
    _a37_obj->f_evals = l3;
    _a37_obj->f_index = l6;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_623: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a41_obj, 227u);
                _a41_obj->f__0 = l18;
                _a41_obj->f__1 = l7;
                l3 = (void*) _a41_obj;
                l22 = ((vader_struct___Tuple_1276_t*) l3)->f__0;
...
static void* vader_bytecode_remap_debug(void* l0, void* l1, size_t l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(123u, 1u, 13u, 1095u);
...
void* vader_bytecode_run_bc_peephole(void* l0) {
    ...
    vader_array_t* _a7_arr = vader_array_new(119u, 0u, 13u, 1071u);
    l10 = (void*) _a7_arr;
    l3 = (size_t) (int64_t) INT64_C(0);
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l14 = (void*) _a8_arr;
...
void* vader_bytecode_strip_self_copies(void* l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(119u, 0u, 13u, 1071u);
    l6 = (void*) _a1_arr;
...
vader_string_t vader_bytecode_type_intern_key(vader_box_t l0) {
    ...
    if (l0.tag == 918u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_StructType_t*) l1)->f_args, 2414u);
    ...
    if (l0.tag == 919u) {
        ...
        l3 = vader_bytecode_type_key_join(((vader_struct_vader_types_TraitType_t*) l1)->f_args, 2414u);
    ...
    if (l0.tag == 923u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_UnionType_t*) l1)->f_variants, 2414u);
        t1 = concat_3(818u, l2, 519u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 920u) {
        l1 = l0.payload.obj;
        l2 = vader_bytecode_type_key_join(((vader_struct_vader_types_TupleType_t*) l1)->f_elements, 2414u);
