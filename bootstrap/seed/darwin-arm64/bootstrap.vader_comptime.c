...
static void vader_comptime_bake_file_exprs(void* l0, void* l1, void* l2, void* l3, void* l4) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(27u, 0u, 13u, 450u);
    l5 = (void*) _a0_arr;
    l6 = l0;
...
static void* vader_comptime_collect_nodes(void* l0) {
    ...
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(14u, 0u, 4u, 173u);
    l2 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
    l3 = (void*) _a5_arr;
    vader_array_t* _a6_arr = vader_array_new(14u, 0u, 4u, 173u);
    l4 = (void*) _a6_arr;
    ...
    vader_obj_header_init(_a8_obj, 329u);
    _a8_obj->f_ekeys = l3;
    _a8_obj->f_evals = l4;
    _a8_obj->f_index = l5;
    ...
    vader_obj_header_init(_a9_obj, 704u);
    _a9_obj->f_by_id = l1;
    _a9_obj->f_order = l2;
        ...
        loop_42: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 418u) {
                    ...
                    vader_array_t* _a11_arr = vader_array_new(14u, 0u, 4u, 173u);
                    l4 = (void*) _a11_arr;
        ...
        loop_12: {
            if ((l7 < l6)) {
                ...
                if (l8.tag == 405u) {
                    ...
                    if (l11.tag == 0u) {
                        if (((vader_struct_vader_comptime_EvalResult_t*) l10)->f_value.tag == 691u) {
...
static void* vader_comptime_evaluate_call_expr(void* l0, void* l1) {
    ...
    if (((vader_obj_header_t*) l2)->type_index == 439u) {
        ...
        if (l4) {
            ...
            vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
            l19 = (void*) _a2_arr;
            vader_array_t* _a3_arr = vader_array_new(15u, 0u, 0u, 174u);
            l20 = (void*) _a3_arr;
            ...
            vader_obj_header_init(_a11_obj, 693u);
        ...
        l30 = (size_t) (int64_t) INT64_C(0);
        {
            loop_389: {
                if ((l30 >= l29)) {
                    ...
                    vader_obj_header_init(_a18_obj, 218u);
                    _a18_obj->f__0 = l31;
                    _a18_obj->f__1 = l32;
                    l33 = (void*) _a18_obj;
                    l34 = ((vader_struct___Tuple_1218_t*) l33)->f__0;
        ...
        vader_obj_header_init(_a21_obj, 693u);
    ...
    l19 = (void*) _a22_arr;
    vader_array_t* _a23_arr = vader_array_new(15u, 0u, 0u, 174u);
    l20 = (void*) _a23_arr;
    ...
    vader_obj_header_init(_a25_obj, 295u);
    ...
    l30 = (size_t) (int64_t) INT64_C(0);
    {
        loop_619: {
            if ((l30 >= l29)) {
                ...
                vader_obj_header_init(_a28_obj, 218u);
                _a28_obj->f__0 = l31;
                _a28_obj->f__1 = l32;
                l33 = (void*) _a28_obj;
                l34 = ((vader_struct___Tuple_1218_t*) l33)->f__0;
    ...
    vader_obj_header_init(_a31_obj, 693u);
...
static void* vader_comptime_evaluate_seq_lit(void* l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(125u, 0u, 13u, 1134u);
    l3 = (void*) _a0_arr;
    ...
    if (l8.tag == 939u) {
        ...
        l4 = (void*) _a3_arr;
        vader_array_t* _a4_arr = vader_array_new(15u, 0u, 0u, 174u);
        l7 = (void*) _a4_arr;
        vader_array_t* _a5_arr = vader_array_new(9u, 0u, 7u, 166u);
        l9 = (void*) _a5_arr;
        ...
        vader_obj_header_init(_a6_obj, 333u);
        _a6_obj->f_ekeys = l4;
        _a6_obj->f_evals = l7;
        _a6_obj->f_index = l9;
        ...
        vader_obj_header_init(_a8_obj, 707u);
...
static void* vader_comptime_harvest_instances(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(49u, 0u, 13u, 699u);
    l2 = (void*) _a4_arr;
                ...
                l21 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_110: {
                        if ((l21 >= l20)) {
                            ...
                            vader_obj_header_init(_a14_obj, 215u);
                            _a14_obj->f__0 = l22;
                            _a14_obj->f__1 = l23;
                            t1 = (void*) _a14_obj;
                ...
                l29 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_152: {
                        if ((l29 >= l28)) {
                            ...
                            vader_obj_header_init(_a17_obj, 216u);
                            _a17_obj->f__0 = l30;
                            _a17_obj->f__1 = l31;
                            t1 = (void*) _a17_obj;
                ...
                l37 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_194: {
                        if ((l37 >= l36)) {
                            ...
                            vader_obj_header_init(_a20_obj, 216u);
                            _a20_obj->f__0 = l38;
                            _a20_obj->f__1 = l39;
                            t1 = (void*) _a20_obj;
                ...
                l45 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_236: {
                        if ((l45 >= l44)) {
                            ...
                            vader_obj_header_init(_a23_obj, 216u);
                            _a23_obj->f__0 = l46;
                            _a23_obj->f__1 = l47;
                            t1 = (void*) _a23_obj;
                ...
                l53 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_278: {
                        if ((l53 >= l52)) {
                            ...
                            vader_obj_header_init(_a26_obj, 217u);
                            _a26_obj->f__0 = l54;
                            _a26_obj->f__1 = l55;
                            t1 = (void*) _a26_obj;
                ...
                l62 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_323: {
                        if ((l62 >= l61)) {
                            ...
                            vader_obj_header_init(_a29_obj, 216u);
                            _a29_obj->f__0 = l63;
                            _a29_obj->f__1 = l64;
                            t1 = (void*) _a29_obj;
...
static void* vader_comptime_new_evaluated_project(void* l0) {
    ...
    l2 = (void*) _a7_obj;
    vader_array_t* _a8_arr = vader_array_new(14u, 0u, 4u, 173u);
    l3 = (void*) _a8_arr;
    ...
    vader_obj_header_init(_a11_obj, 389u);
    _a11_obj->f_ekeys = l3;
    _a11_obj->f_evals = l4;
    _a11_obj->f_index = l5;
    ...
    l3 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(49u, 0u, 13u, 699u);
    l4 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(50u, 0u, 13u, 709u);
    l5 = (void*) _a13_arr;
...
static void* vader_comptime_normalize_int_result(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (((vader_struct_vader_comptime_EvalResult_t*) l0)->f_value.tag == 701u) {
    ...
    l4 = (size_t) (int64_t) INT64_C(0);
    {
        loop_71: {
            if ((l4 < l3)) {
                ...
                l6 = l7.payload.obj;
                vader_array_t* _a2_arr = vader_array_new(14u, 0u, 4u, 173u);
                l8 = (void*) _a2_arr;
...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_obj_header_init(_a2_obj, 284u);
    t0 = (void*) _a2_obj;
...
static void* vader_comptime_topo_sort(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(21u, 0u, 13u, 418u);
    l1 = (void*) _a0_arr;
