...
static inline void* vader_host_std_core_bytes(vader_string_t a0) { return (void*) vader_string_bytes_view(a0, 11u, 183u); }
static inline uint64_t vader_host_std_core_string_Hash_hash(vader_string_t a0) { return vader_string_hash(a0); }
static inline vader_box_t vader_host_std_env_get_env(vader_string_t a0) { const char* c0 = vader_string_to_cstr(a0); const char* r = getenv(c0); vader_box_t out = r == NULL ? vader_box_null() : vader_box_i64(177u, (int64_t) vader_atom_intern(r, strlen(r))); vader_cstr_free_for(a0, c0); return out; }
...
static inline vader_box_t vader_host_system_posix_sys_opendir(vader_string_t a0) { const char* c0 = vader_string_to_cstr(a0); void* r = opendir(c0); vader_cstr_free_for(a0, c0); return r == NULL ? vader_box_null() : vader_box_i64(179u, (int64_t) (intptr_t) r); }
...
static inline vader_box_t vader_host_system_posix_sys_readdir(void* a0) { void* r = readdir(a0); return r == NULL ? vader_box_null() : vader_box_i64(179u, (int64_t) (intptr_t) r); }
...
static inline vader_box_t vader_host_system_posix_sys_realpath(vader_string_t a0, void* a1) { const char* c0 = vader_string_to_cstr(a0); vader_slice_t s1 = vader_array_bytes((vader_array_t*) a1); void* r = realpath(c0, (void*) s1.ptr); vader_cstr_free_for(a0, c0); return r == NULL ? vader_box_null() : vader_box_i64(179u, (int64_t) (intptr_t) r); }
static inline vader_box_t vader_host_system_posix_sys_fopen(vader_string_t a0, vader_string_t a1) { const char* c0 = vader_string_to_cstr(a0); const char* c1 = vader_string_to_cstr(a1); void* r = fopen(c0, c1); vader_cstr_free_for(a0, c0); vader_cstr_free_for(a1, c1); return r == NULL ? vader_box_null() : vader_box_i64(179u, (int64_t) (intptr_t) r); }
...
static inline vader_box_t vader_host_system_posix_sys_getcwd(void* a0, size_t a1) { vader_slice_t s0 = vader_array_bytes((vader_array_t*) a0); void* r = getcwd((void*) s0.ptr, a1); return r == NULL ? vader_box_null() : vader_box_i64(179u, (int64_t) (intptr_t) r); }
