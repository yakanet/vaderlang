...
static inline vader_box_t vader_host_system_posix_sys_realpath(vader_string_t a0, void* a1) { const char* c0 = vader_string_to_cstr(a0); vader_slice_t s1 = vader_array_bytes((vader_array_t*) a1); void* r = realpath(c0, (void*) s1.ptr); vader_cstr_free_for(a0, c0); return r == NULL ? vader_box_null() : vader_box_i64(169u, (int64_t) (intptr_t) r); }
static inline vader_box_t vader_host_system_posix_sys_fopen(vader_string_t a0, vader_string_t a1) { const char* c0 = vader_string_to_cstr(a0); const char* c1 = vader_string_to_cstr(a1); void* r = fopen(c0, c1); vader_cstr_free_for(a0, c0); vader_cstr_free_for(a1, c1); return r == NULL ? vader_box_null() : vader_box_i64(169u, (int64_t) (intptr_t) r); }
...
static inline vader_box_t vader_host_system_posix_sys_getcwd(void* a0, size_t a1) { vader_slice_t s0 = vader_array_bytes((vader_array_t*) a0); void* r = getcwd((void*) s0.ptr, a1); return r == NULL ? vader_box_null() : vader_box_i64(169u, (int64_t) (intptr_t) r); }
