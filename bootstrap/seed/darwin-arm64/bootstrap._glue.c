...
vader_fn_t vader_fn_static_246 = { { 149u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_246, NULL };
...
vader_fn_t vader_fn_static_247 = { { 149u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_247, NULL };
...
vader_fn_t vader_fn_static_495 = { { 157u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_495, NULL };
...
vader_fn_t vader_fn_static_720 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_720, NULL };
...
vader_fn_t vader_fn_static_722 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_722, NULL };
...
vader_fn_t vader_fn_static_724 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_724, NULL };
...
vader_fn_t vader_fn_static_725 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_725, NULL };
vader_box_t vader_fn_tramp_975(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_ref_box(vader_comptime_evaluate_expr(a0, a1.payload.obj));
}
vader_fn_t vader_fn_static_975 = { { 156u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_975, NULL };
...
vader_fn_t vader_fn_static_1057 = { { 136u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1057, NULL };
...
vader_fn_t vader_fn_static_1058 = { { 136u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1058, NULL };
...
vader_fn_t vader_fn_static_1060 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1060, NULL };
...
vader_fn_t vader_fn_static_1061 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1061, NULL };
...
vader_fn_t vader_fn_static_1062 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1062, NULL };
...
vader_fn_t vader_fn_static_1063 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1063, NULL };
...
vader_fn_t vader_fn_static_1064 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1064, NULL };
...
vader_fn_t vader_fn_static_1066 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1066, NULL };
...
vader_fn_t vader_fn_static_1068 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1068, NULL };
...
vader_fn_t vader_fn_static_1070 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1070, NULL };
...
vader_fn_t vader_fn_static_1071 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1071, NULL };
vader_box_t vader_fn_tramp_1073(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_box_i64(168u, vader_comptime_op_add(((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_fn_t vader_fn_static_1073 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1073, NULL };
vader_box_t vader_fn_tramp_1174(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_box_bool(162u, vader_lower_pending_fn_instance_less(a0.payload.obj, a1.payload.obj));
}
vader_fn_t vader_fn_static_1174 = { { 152u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1174, NULL };
vader_box_t vader_fn_tramp_1208(void* env, vader_box_t a0, vader_box_t a1, vader_box_t a2, vader_box_t a3) {
    (void) env;
    return vader_ref_box(vader_lower_lower_block(a0.payload.obj, a1.payload.obj, a2.payload.b, a3.payload.b));
}
vader_fn_t vader_fn_static_1208 = { { 150u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1208, NULL };
vader_box_t vader_fn_tramp_1308(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_lower_lower_expr(a0.payload.obj, a1);
}
vader_fn_t vader_fn_static_1308 = { { 151u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1308, NULL };
vader_box_t vader_fn_tramp_2451(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_types_mk_trait(a0.payload.obj, a1.payload.obj);
}
vader_fn_t vader_fn_static_2451 = { { 153u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_2451, NULL };
...
vader_box_t vader_fn_lift_298(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_2081(env, a0.payload.obj, a1.payload.obj));
}
vader_box_t vader_fn_lift_312(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3101(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_579(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3979(env, a0, a1));
}
vader_box_t vader_fn_lift_984(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_2332(env, a0.payload.obj, a1.payload.obj));
}
vader_box_t vader_fn_lift_1093(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_5517(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_1111(void* env, vader_box_t a0, vader_box_t a1) {
...
vader_box_t vader_fn_lift_1138(void* env, vader_box_t a0) {
    __lambda_1729(env, a0);
    return vader_box_null();
}
vader_box_t vader_fn_lift_1310(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_4462(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_1808(void* env) {
...
vader_box_t vader_fn_lift_2027(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_1380(env, ((int32_t) a0.payload.i), ((int32_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2030(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_1390(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_2187(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_2832(env, ((size_t) a0.payload.i), ((size_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2520(void* env, vader_box_t a0) {
    return vader_box_bool(162u, __lambda_6091(env, ((uint32_t) a0.payload.i)));
}
vader_box_t vader_fn_lift_2589(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3475(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2590(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3478(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2591(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3481(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_2592(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3484(env, a0.payload.s, a1.payload.s));
}
