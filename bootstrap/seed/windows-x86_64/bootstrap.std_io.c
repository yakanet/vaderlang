...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 2u, 174u);
...
static vader_string_t std_io_from_wide(void* l0, int32_t l1) {
    ...
    vader_array_t* _a1_arr = vader_array_new(11u, 1u, 1u, 173u);
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 173u);
    ...
    vader_obj_header_init(_a4_obj, 239u);
    _a4_obj->f_cap_0 = l6;
    t2 = (void*) _a4_obj;
    vader_fn_t* _a5_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a5_closure, 135u);
    ...
    l7 = (void*) _a6_arr;
    {
        loop_94: {
            ...
            if (l4) {
                vader_array_push((vader_array_t*) l7, vader_box_string(167u, l3));
            } else {
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0, size_t l1) {
    ...
    bool t4;
    int64_t t5;
    void** gc_raw_roots[5] = { &l2, &l5, &l6, &l8, &t2 };
    vader_string_t* gc_atom_roots[1] = { &l0 };
    ...
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(11u, 1u, 1u, 173u);
    ...
    l5 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(13u, 1u, 3u, 175u);
    ...
    l6 = (void*) _a4_arr;
    {
        loop_37: {
            ...
            if (!(t4)) {
                ...
                t0 = ((int32_t*) _a5_slotarr->buf->slots)[_a5_slotarr->offset + (size_t) INT32_C(0)];
                t5 = ((int64_t) (uint32_t) t0);
                l7 = (size_t) (int64_t) t5;
                if ((l7 > INT64_C(0))) {
                    vader_array_t* _a6_arr = vader_array_slice((vader_array_t*) l5, (size_t) INT64_C(0), (size_t) l7);
                    l8 = (void*) _a6_arr;
                ...
                if ((t3 > l1)) {
                    ...
                    vader_struct_std_io_IOError_t* _a7_obj = (vader_struct_std_io_IOError_t*) vader_gc_alloc(sizeof(vader_struct_std_io_IOError_t));
                    vader_obj_header_init(_a7_obj, 386u);
                    _a7_obj->f_msg = 1587u;
                    _a7_obj->f_kind = (uint8_t) (int32_t) INT32_C(0);
                    _a7_obj->f_code = INT32_C(0);
                    t2 = (void*) _a7_obj;
                    { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
                }
    ...
    _a8_obj->f_msg = 1957u;
    _a8_obj->f_kind = (uint8_t) (int32_t) INT32_C(0);
    _a8_obj->f_code = INT32_C(0);
    t2 = (void*) _a8_obj;
    { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
}
...
static void* std_io_to_wide(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 2u, 174u);
    l1 = (void*) _a0_arr;
    l2 = -(INT32_C(1));
    ...
    if ((l2 <= INT32_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(12u, 0u, 2u, 174u);
        t0 = (void*) _a1_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a2_arr = vader_array_new(12u, 1u, 2u, 174u);
    ...
    if ((t2 <= INT32_C(0))) {
        vader_array_t* _a4_arr = vader_array_new(12u, 0u, 2u, 174u);
        t0 = (void*) _a4_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 173u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 173u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    vader_string_t* gc_atom_roots[2] = { &l0, &l7 };
    ...
    if (t3 == INT64_C(-1)) {
        ...
        _a1_obj->f_msg = 1914u;
        _a1_obj->f_kind = (uint8_t) (int32_t) INT32_C(0);
        _a1_obj->f_code = INT32_C(0);
        t1 = (void*) _a1_obj;
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t4 = ((vader_array_t*) l1)->length;
    if ((t4 > INT64_C(0))) {
        vader_array_t* _a2_arr = vader_array_new(13u, 1u, 3u, 175u);
