...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 2u, 173u);
...
static vader_string_t std_io_from_wide(void* l0, int32_t l1) {
    ...
    vader_array_t* _a1_arr = vader_array_new(11u, 1u, 1u, 172u);
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 172u);
    ...
    vader_obj_header_init(_a4_obj, 238u);
    _a4_obj->f_cap_0 = l6;
    t2 = (void*) _a4_obj;
    vader_fn_t* _a5_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a5_closure, 134u);
    ...
    l7 = (void*) _a6_arr;
    {
        loop_92: {
            ...
            if (l4) {
                vader_array_push((vader_array_t*) l7, vader_box_string(166u, l3));
            } else {
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0) {
    ...
    bool t4;
    int64_t t5;
    void** gc_raw_roots[5] = { &l1, &l4, &l5, &l7, &t2 };
    vader_string_t* gc_atom_roots[1] = { &l0 };
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 5u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    l1 = std_io_to_wide(l0);
    t0 = (INT32_C(1) | INT32_C(2));
    l2 = (uint32_t) (int32_t) t0;
    l3 = vader_host_system_windows_create_file_w(l1, (uint32_t) (int32_t) INT32_MIN, l2, vader_box_obj(0u, NULL), (uint32_t) (int32_t) INT32_C(3), (uint32_t) (int32_t) INT32_C(128), vader_box_obj(0u, NULL));
    t1 = (ptrdiff_t) (void*) l3;
    if (t1 == INT64_C(-1)) {
    ...
    l1 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(11u, 1u, 1u, 172u);
    ((uint8_t*) _a2_arr->buf->slots)[_a2_arr->offset + 0u] = (uint8_t) INT32_C(0);
    t2 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_repeat((vader_array_t*) t2, (size_t) INT64_C(65536));
    l4 = (void*) _a3_arr;
    vader_array_t* _a4_arr = vader_array_new(13u, 1u, 3u, 174u);
    ((int32_t*) _a4_arr->buf->slots)[_a4_arr->offset + 0u] = (int32_t) INT32_C(0);
    l5 = (void*) _a4_arr;
    {
        loop_35: {
            t3 = ((vader_array_t*) l1)->length;
            if ((t3 <= INT64_C(268435456))) {
                t3 = ((vader_array_t*) l4)->length;
                t0 = ((int32_t) (size_t) t3);
                l2 = (uint32_t) (int32_t) t0;
                t4 = vader_host_system_windows_read_file(l3, l4, l2, l5, vader_box_obj(0u, NULL));
                if (!(t4)) {
                    vader_host_system_windows_close_handle(l3);
                ...
                t0 = ((int32_t*) _a6_slotarr->buf->slots)[_a6_slotarr->offset + (size_t) INT32_C(0)];
                t5 = ((int64_t) (uint32_t) t0);
                l6 = (size_t) (int64_t) t5;
                if ((l6 > INT64_C(0))) {
                    vader_array_t* _a7_arr = vader_array_slice((vader_array_t*) l4, (size_t) INT64_C(0), (size_t) l6);
                    l7 = (void*) _a7_arr;
                    vader_array_push_all((vader_array_t*) l1, (vader_array_t*) l7);
                } else {
                }
...
static void* std_io_to_wide(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 2u, 173u);
    l1 = (void*) _a0_arr;
    l2 = -(INT32_C(1));
    ...
    if ((l2 <= INT32_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(12u, 0u, 2u, 173u);
        t0 = (void*) _a1_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a2_arr = vader_array_new(12u, 1u, 2u, 173u);
    ...
    if ((t2 <= INT32_C(0))) {
        vader_array_t* _a4_arr = vader_array_new(12u, 0u, 2u, 173u);
        t0 = (void*) _a4_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 172u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 172u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    if ((t4 > INT64_C(0))) {
        vader_array_t* _a2_arr = vader_array_new(13u, 1u, 3u, 174u);
        ((int32_t*) _a2_arr->buf->slots)[_a2_arr->offset + 0u] = (int32_t) INT32_C(0);
        l5 = (void*) _a2_arr;
        t4 = ((vader_array_t*) l1)->length;
