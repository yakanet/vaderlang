...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 167u);
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_host_system_posix_sys_fopen(l0, 1903u);
    if (l1.tag == 0u) {
    ...
    l2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(11u, 1u, 1u, 167u);
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 167u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 167u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    l4 = vader_host_system_posix_sys_fopen(l0, 2370u);
    if (l4.tag == 0u) {
