...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 2u, 185u);
...
void std_io_eprintln__string(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = concat_2(l0, 1u);
    std_io_write((uint8_t) (int32_t) INT32_C(1), l1);
...
static vader_string_t std_io_from_wide(void* l0, int32_t l1) {
    ...
    vader_array_t* _a1_arr = vader_array_new(11u, 1u, 1u, 184u);
...
static void* std_io_last_io_error(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 358u);
    _a0_obj->f_msg = l4;
    _a0_obj->f_kind = l2;
    _a0_obj->f_code = l5;
    t0 = (void*) _a0_obj;
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 184u);
    ...
    vader_obj_header_init(_a4_obj, 212u);
    _a4_obj->f_cap_0 = l6;
    t2 = (void*) _a4_obj;
    vader_fn_t* _a5_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a5_closure, 147u);
    ...
    l7 = (void*) _a6_arr;
    {
        loop_94: {
            ...
            if (l4) {
                vader_array_push((vader_array_t*) l7, vader_box_string(178u, l3));
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0, size_t l1) {
    ...
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(13u, 1u, 3u, 186u);
    ...
    l6 = (void*) _a3_arr;
    {
        loop_35: {
            ...
            if ((t3 > l1)) {
                ...
                vader_obj_header_init(_a6_obj, 358u);
                _a6_obj->f_msg = 1683u;
...
static void* std_io_to_wide(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 2u, 185u);
    l1 = (void*) _a0_arr;
    l2 = -(INT32_C(1));
    ...
    if ((l2 <= INT32_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(12u, 0u, 2u, 185u);
        t0 = (void*) _a1_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a2_arr = vader_array_new(12u, 1u, 2u, 185u);
    ...
    if ((t2 <= INT32_C(0))) {
        vader_array_t* _a4_arr = vader_array_new(12u, 0u, 2u, 185u);
        t0 = (void*) _a4_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 184u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 184u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    if (t3 == INT64_C(-1)) {
        t1 = std_io_last_io_error(2027u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t4 = ((vader_array_t*) l1)->length;
    if ((t4 > INT64_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(13u, 1u, 3u, 186u);
