...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 2u, 183u);
...
static vader_string_t std_io_from_wide(void* l0, int32_t l1) {
    ...
    vader_array_t* _a1_arr = vader_array_new(11u, 1u, 1u, 182u);
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_obj_header_init(_a4_obj, 246u);
    _a4_obj->f_cap_0 = l6;
    t2 = (void*) _a4_obj;
    vader_fn_t* _a5_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a5_closure, 145u);
    ...
    l7 = (void*) _a6_arr;
    {
        loop_94: {
            ...
            if (l4) {
                vader_array_push((vader_array_t*) l7, vader_box_string(176u, l3));
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0, size_t l1) {
    ...
    l5 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(13u, 1u, 3u, 184u);
...
static void* std_io_to_wide(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 2u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 2u, 183u);
    l1 = (void*) _a0_arr;
    l2 = -(INT32_C(1));
    ...
    if ((l2 <= INT32_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(12u, 0u, 2u, 183u);
        t0 = (void*) _a1_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a2_arr = vader_array_new(12u, 1u, 2u, 183u);
    ...
    if ((t2 <= INT32_C(0))) {
        vader_array_t* _a4_arr = vader_array_new(12u, 0u, 2u, 183u);
        t0 = (void*) _a4_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 182u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 182u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    if (t3 == INT64_C(-1)) {
        t1 = std_io_last_io_error(1995u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t4 = ((vader_array_t*) l1)->length;
    if ((t4 > INT64_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(13u, 1u, 3u, 184u);
