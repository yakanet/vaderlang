...
vader_string_t std_io_IOError_Error_message(void* l0) {
    vader_string_t t0;
    t0 = ((vader_struct_std_io_IOError_t*) l0)->f_msg;
    return t0;
}
...
vader_string_t std_io_current_executable_location(void) {
    ...
    vader_array_t* _a0_arr = vader_array_new(12u, 1u, 2u, 197u);
...
static vader_string_t std_io_from_wide(void* l0, int32_t l1) {
    ...
    l2 = (void*) _a0_arr;
    l3 = vader_host_system_windows_wide_char_to_multi_byte((uint32_t) 65001, (uint32_t) 0, l0, l1, l2, INT32_C(0), vader_box_obj(0u, NULL), vader_box_obj(0u, NULL));
    if ((l3 <= INT32_C(0))) {
        { vader_gc_top = gc_frame.prev; return 0u; }
    }
    vader_array_t* _a1_arr = vader_array_new(11u, 1u, 1u, 196u);
    ...
    l2 = (void*) _a2_arr;
    t1 = vader_host_system_windows_wide_char_to_multi_byte((uint32_t) 65001, (uint32_t) 0, l0, l1, l2, l3, vader_box_obj(0u, NULL), vader_box_obj(0u, NULL));
    if ((t1 <= INT32_C(0))) {
        { vader_gc_top = gc_frame.prev; return 0u; }
    }
...
static void* std_io_last_io_error(vader_string_t l0) {
    ...
    void* t0 = NULL;
    void** gc_raw_roots[1] = { &t0 };
    vader_string_t* gc_atom_roots[3] = { &l0, &l3, &l4 };
    vader_gc_frame_t gc_frame = {
        vader_gc_top, 0u, 1u, NULL, gc_raw_roots, 0u, NULL, 3u, gc_atom_roots,
    };
    vader_gc_top = &gc_frame;
    l1 = vader_host_system_windows_get_last_error();
    l2 = (uint8_t) 0;
    if (l1 == INT32_C(2)) {
        l2 = (uint8_t) 1;
    }
    ...
    l3 = std_io_describe_io_error_kind(l2);
    if (l3 == 0u) {
        l4 = l0;
    } else {
        l4 = l3;
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    void** gc_raw_roots[3] = { &l5, &l7, &t2 };
    vader_string_t* gc_atom_roots[3] = { &l0, &l3, &t3 };
    vader_gc_frame_t gc_frame = {
    ...
    if (t0 == INT64_C(0)) {
        ...
        l1 = vader_host_std_core_byte_at(l0, l2);
    }
    t0 = vader_host_std_core_byte_len(l0);
    if (t0 == INT64_C(0)) {
        l4 = true;
    ...
    vader_array_t* _a0_arr = vader_array_new(11u, 1u, 1u, 196u);
    ...
    if (t5 == INT64_C(-1)) {
        ...
        _a3_obj->f_msg = t3;
        _a3_obj->f_kind = (uint8_t) 0;
        _a3_obj->f_code = INT32_C(0);
        t2 = (void*) _a3_obj;
        { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_struct___defer_env_std_io_1_t* _a4_obj = (vader_struct___defer_env_std_io_1_t*) vader_gc_alloc(sizeof(vader_struct___defer_env_std_io_1_t));
    vader_obj_header_init(_a4_obj, 224u);
    _a4_obj->f_cap_0 = l6;
    t2 = (void*) _a4_obj;
    vader_fn_t* _a5_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a5_closure, 159u);
    _a5_closure->code = (void*) &vader_fn_lift___defer_std_io_0;
    _a5_closure->env = t2;
    t2 = (void*) _a5_closure;
    ...
    l7 = (void*) _a6_arr;
    {
        loop_94: {
            ...
            if (l4) {
                vader_array_push((vader_array_t*) l7, vader_box_string(190u, l3));
            }
            t6 = vader_host_system_windows_find_next_file(((vader_struct__Cell_CPointer_t*) l6.payload.obj)->f_value, l5);
            if (!(t6)) {
            } else {
                goto loop_94;
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0, size_t l1) {
    ...
    bool t4;
    int64_t t5;
    void** gc_raw_roots[6] = { &l2, &l5, &l6, &l7, &l9, &t2 };
    vader_string_t* gc_atom_roots[1] = { &l0 };
    vader_gc_frame_t gc_frame = {
        vader_gc_top, 0u, 6u, NULL, gc_raw_roots, 0u, NULL, 1u, gc_atom_roots,
    };
    vader_gc_top = &gc_frame;
    l2 = std_io_to_wide(l0);
    t0 = (INT32_C(1) | INT32_C(2));
    l3 = (uint32_t) (int32_t) t0;
    l4 = vader_host_system_windows_create_file_w(l2, (uint32_t) (int32_t) INT32_MIN, l3, vader_box_obj(0u, NULL), (uint32_t) 3, (uint32_t) 128, vader_box_obj(0u, NULL));
    t1 = (ptrdiff_t) (void*) l4;
    if (t1 == INT64_C(-1)) {
        t2 = std_io_last_io_error(1473u);
        { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a0_arr = vader_array_new(11u, 0u, 1u, 196u);
    l2 = (void*) _a0_arr;
    ...
    ((uint8_t*) _a1_arr->buf->slots)[_a1_arr->offset + 0u] = (uint8_t) INT32_C(0);
    t2 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_repeat((vader_array_t*) t2, (size_t) INT64_C(65536));
    l5 = (void*) _a2_arr;
    ...
    l6 = (void*) _a3_arr;
    {
        loop_35: {
            ...
            t0 = ((int32_t) (size_t) t3);
            l3 = (uint32_t) (int32_t) t0;
            t4 = vader_host_system_windows_read_file(l4, l5, l3, l6, vader_box_obj(0u, NULL));
            if (!(t4)) {
                l7 = std_io_last_io_error(1873u);
            ...
            t0 = ((int32_t*) _a4_slotarr->buf->slots)[_a4_slotarr->offset + (size_t) INT32_C(0)];
            t5 = ((int64_t) (uint32_t) t0);
            l8 = (size_t) (int64_t) t5;
            if ((l8 > INT64_C(0))) {
                vader_array_t* _a5_arr = vader_array_slice((vader_array_t*) l5, (size_t) INT64_C(0), (size_t) l8);
                l9 = (void*) _a5_arr;
                vader_array_push_all((vader_array_t*) l2, (vader_array_t*) l9);
            }
            ...
            if ((t3 > l1)) {
                ...
                vader_obj_header_init(_a6_obj, 371u);
                _a6_obj->f_msg = 1474u;
                _a6_obj->f_kind = (uint8_t) 0;
                _a6_obj->f_code = INT32_C(0);
                t2 = (void*) _a6_obj;
                { vader_box_t __vret = vader_ref_box(t2); vader_gc_top = gc_frame.prev; return __vret; }
            }
            l10 = ((vader_array_t*) l5)->length;
            if ((l8 < l10)) {
                vader_host_system_windows_close_handle(l4);
...
static void* std_io_to_wide(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(12u, 0u, 2u, 197u);
    l1 = (void*) _a0_arr;
    l2 = -(INT32_C(1));
    l2 = vader_host_system_windows_multi_byte_to_wide_char((uint32_t) 65001, (uint32_t) 0, l0, l2, l1, INT32_C(0));
    if ((l2 <= INT32_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(12u, 0u, 2u, 197u);
        t0 = (void*) _a1_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    vader_array_t* _a2_arr = vader_array_new(12u, 1u, 2u, 197u);
    ...
    l1 = (void*) _a3_arr;
    l4 = -(INT32_C(1));
    t2 = vader_host_system_windows_multi_byte_to_wide_char((uint32_t) 65001, (uint32_t) 0, l0, l4, l1, l2);
    if ((t2 <= INT32_C(0))) {
        vader_array_t* _a4_arr = vader_array_new(12u, 0u, 2u, 197u);
        t0 = (void*) _a4_arr;
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
        ...
        loop_11: {
            if ((l4 < l3)) {
                ...
                if (l5 == INT64_C(0)) {
                    ...
                    t2 = vader_array_read_u8(_a1_slotarr, _a1_slotarr->offset + (size_t) l5, 196u);
                ...
                if (l6) {
                    ...
                    t2 = vader_array_read_u8(_a2_slotarr, _a2_slotarr->offset + (size_t) l7, 196u);
                    t3 = ((uint8_t) t2.payload.i);
                    if (t3 == INT32_C(58)) {
                    } else {
                        t1 = (l2 + INT64_C(1));
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    l4 = vader_host_system_windows_create_file_w(t1, (uint32_t) 1073741824, (uint32_t) 1, vader_box_obj(0u, NULL), (uint32_t) 2, (uint32_t) 128, vader_box_obj(0u, NULL));
    t3 = (ptrdiff_t) (void*) l4;
    if (t3 == INT64_C(-1)) {
        t1 = std_io_last_io_error(1825u);
        { vader_box_t __vret = vader_ref_box(t1); vader_gc_top = gc_frame.prev; return __vret; }
    }
    t4 = ((vader_array_t*) l1)->length;
    if ((t4 > INT64_C(0))) {
        vader_array_t* _a1_arr = vader_array_new(13u, 1u, 3u, 198u);
