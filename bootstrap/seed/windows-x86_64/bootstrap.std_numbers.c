...
vader_string_t std_numbers_strip_numeric_text(vader_string_t l0, int32_t l1) {
    ...
    vader_struct___lambda_env_6073_t* _a1_obj = (vader_struct___lambda_env_6073_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_6073_t));
    ...
    _a2_closure->code = (void*) &vader_fn_lift___lambda_6072;
    _a2_closure->env = t0;
    l3 = (void*) _a2_closure;
