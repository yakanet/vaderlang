...
vader_fn_t vader_fn_static_248 = { { 149u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_248, NULL };
...
vader_fn_t vader_fn_static_496 = { { 157u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_496, NULL };
...
vader_fn_t vader_fn_static_721 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_721, NULL };
...
vader_fn_t vader_fn_static_723 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_723, NULL };
...
vader_fn_t vader_fn_static_726 = { { 147u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_726, NULL };
...
vader_fn_t vader_fn_static_976 = { { 156u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_976, NULL };
...
vader_fn_t vader_fn_static_1059 = { { 136u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1059, NULL };
...
vader_fn_t vader_fn_static_1065 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1065, NULL };
...
vader_fn_t vader_fn_static_1067 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1067, NULL };
...
vader_fn_t vader_fn_static_1069 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1069, NULL };
...
vader_fn_t vader_fn_static_1072 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1072, NULL };
...
vader_fn_t vader_fn_static_1074 = { { 144u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1074, NULL };
...
vader_fn_t vader_fn_static_1175 = { { 152u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1175, NULL };
...
vader_fn_t vader_fn_static_1209 = { { 150u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1209, NULL };
vader_box_t vader_fn_tramp_1309(void* env, vader_box_t a0, vader_box_t a1) {
    (void) env;
    return vader_lower_lower_expr(a0.payload.obj, a1);
}
vader_fn_t vader_fn_static_1309 = { { 151u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_1309, NULL };
...
vader_fn_t vader_fn_static_2452 = { { 153u, 0u, 0u, 0u, NULL }, (void*) &vader_fn_tramp_2452, NULL };
...
vader_box_t vader_fn_lift_313(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3100(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_580(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3978(env, a0, a1));
}
...
vader_box_t vader_fn_lift_1094(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_5516(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_1311(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_4461(env, a0.payload.s, a1.payload.s));
}
...
vader_box_t vader_fn_lift_2521(void* env, vader_box_t a0) {
    return vader_box_bool(162u, __lambda_6090(env, ((uint32_t) a0.payload.i)));
}
vader_box_t vader_fn_lift_2590(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3474(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2591(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3477(env, ((int64_t) a0.payload.i), ((int64_t) a1.payload.i)));
}
vader_box_t vader_fn_lift_2592(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3480(env, a0.payload.s, a1.payload.s));
}
vader_box_t vader_fn_lift_2593(void* env, vader_box_t a0, vader_box_t a1) {
    return vader_box_bool(162u, __lambda_3483(env, a0.payload.s, a1.payload.s));
}
