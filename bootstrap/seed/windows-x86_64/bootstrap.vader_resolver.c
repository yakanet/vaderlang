...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 903u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(90u, 1u, 13u, 903u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(90u, 1u, 13u, 903u);
        ...
        l7 = (size_t) (int64_t) INT64_C(0);
        {
            loop_35: {
                if ((l7 >= l6)) {
                    ...
                    vader_obj_header_init(_a6_obj, 196u);
                    _a6_obj->f__0 = l8;
                    _a6_obj->f__1 = l2;
                    l9 = (void*) _a6_obj;
...
static void vader_resolver_check_groups(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a7_obj, 336u);
    _a7_obj->f_ekeys = l3;
    _a7_obj->f_evals = l4;
    _a7_obj->f_index = l5;
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2141u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(920u, l4, 971u, l3, 229u, l10, 1034u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 487u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(117u, 0u, 13u, 1088u);
        l2 = (void*) _a1_arr;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a7_obj, 338u);
    _a7_obj->f_ekeys = l8;
    _a7_obj->f_evals = l9;
    _a7_obj->f_index = l10;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a13_obj, 338u);
    ...
    vader_obj_header_init(_a14_obj, 885u);
    _a14_obj->f_file = l11;
    _a14_obj->f_paths = l12;
    _a14_obj->f_excludes = l13;
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(83u, 1u, 13u, 885u);
    ...
    vader_obj_header_init(_a16_obj, 883u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(52u, 0u, 13u, 715u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(85u, 0u, 13u, 889u);
    l5 = (void*) _a5_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a7_obj, 197u);
                _a7_obj->f__0 = l9;
                _a7_obj->f__1 = l4;
                t1 = (void*) _a7_obj;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2291u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2291u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(920u, l2, 985u, l0, 1019u, 2149u, 988u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(920u, l0, 1016u, l7, 241u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(52u, 0u, 13u, 715u);
    l4 = (void*) _a1_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                vader_obj_header_init(_a3_obj, 197u);
                _a3_obj->f__0 = l6;
                _a3_obj->f__1 = l1;
                t1 = (void*) _a3_obj;
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2289u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static vader_string_t vader_resolver_for_type_display_name(vader_box_t l0) {
    ...
    if (l0.tag == 441u) {
        l1 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l1)->f_callee.tag == 442u) {
...
static vader_box_t vader_resolver_for_type_owner_sym(vader_box_t l0, void* l1, void* l2) {
    ...
    if (l0.tag == 441u) {
        l5 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l5)->f_callee.tag == 442u) {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(85u, 1u, 13u, 889u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(23u, 1u, 13u, 423u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(82u, 1u, 13u, 884u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_obj_header_init(_a4_obj, 336u);
    _a4_obj->f_ekeys = l10;
    _a4_obj->f_evals = l11;
    _a4_obj->f_index = l12;
    _a4_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    _a4_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l10 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(52u, 0u, 13u, 715u);
    l11 = (void*) _a5_arr;
    ...
    if (l7.tag == 164u) {
        ...
        vader_obj_header_init(_a9_obj, 336u);
        _a9_obj->f_ekeys = l16;
        _a9_obj->f_evals = l17;
        _a9_obj->f_index = l18;
        _a9_obj->f_mask = l19;
        ...
        if (l23.tag == 884u) {
            ...
            if (l39.tag == 884u) {
                ...
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(82u, 1u, 13u, 884u);
            ...
            vader_obj_header_init(_a13_obj, 891u);
            _a13_obj->f_entry = t1;
    ...
    if (l7.tag == 0u) {
        ...
        vader_obj_header_init(_a15_obj, 892u);
        ...
        vader_obj_header_init(_a19_obj, 336u);
        ...
        if (l23.tag == 0u) {
            ...
            vader_obj_header_init(_a20_obj, 891u);
        ...
        if (l23.tag == 884u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(82u, 1u, 13u, 884u);
            ...
            if (l39.tag == 884u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(82u, 1u, 13u, 884u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_169: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a5_obj, 201u);
                _a5_obj->f__0 = l8;
                _a5_obj->f__1 = l3;
                l9 = (void*) _a5_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_263: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a9_obj, 200u);
                _a9_obj->f__0 = l27;
                _a9_obj->f__1 = l3;
                l9 = (void*) _a9_obj;
...
static void* vader_resolver_new_import_target_table(void) {
    ...
    vader_obj_header_init(_a12_obj, 888u);
...
static void* vader_resolver_new_scope(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(18u, 1u, 13u, 371u);
    ...
    vader_obj_header_init(_a1_obj, 897u);
    _a1_obj->f_frames = t0;
    t0 = (void*) _a1_obj;
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(88u, 0u, 13u, 898u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(85u, 0u, 13u, 889u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 164u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2289u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    vader_obj_header_init(_a4_obj, 892u);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_49: {
            if ((l11 >= l10)) {
                ...
                vader_obj_header_init(_a3_obj, 196u);
                _a3_obj->f__0 = l13;
                _a3_obj->f__1 = l9;
                l15 = (void*) _a3_obj;
    ...
    vader_obj_header_init(_a11_obj, 298u);
    ...
    vader_obj_header_init(_a15_obj, 298u);
    ...
    vader_obj_header_init(_a19_obj, 330u);
    ...
    vader_obj_header_init(_a23_obj, 314u);
    ...
    vader_obj_header_init(_a27_obj, 314u);
    ...
    vader_obj_header_init(_a28_obj, 896u);
    _a28_obj->f_path = l1;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(52u, 0u, 13u, 715u);
    l9 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a17_obj, 894u);
    ...
    vader_obj_header_init(_a19_obj, 895u);
...
static vader_box_t vader_resolver_scan_folder(vader_string_t l0, void* l1) {
    ...
    if (l2.tag == 8u) {
        ...
        vader_struct___lambda_env_3083_t* _a0_obj = (vader_struct___lambda_env_3083_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3083_t));
        ...
        _a1_closure->code = (void*) &vader_fn_lift___lambda_3082;
        _a1_closure->env = t1;
        l6 = (void*) _a1_closure;
        ...
        vader_obj_header_init(_a5_obj, 886u);
        _a5_obj->f_name = l18;
    ...
    if (l2.tag == 401u) {
        ...
        vader_struct___lambda_env_3083_t* _a8_obj = (vader_struct___lambda_env_3083_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3083_t));
        vader_obj_header_init(_a8_obj, 270u);
        t1 = (void*) _a8_obj;
        vader_fn_t* _a9_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
        vader_obj_header_init(_a9_closure, 138u);
        _a9_closure->code = (void*) &vader_fn_lift___lambda_3082;
        _a9_closure->env = t1;
        l6 = (void*) _a9_closure;
        l8 = std_sort_sort__string(l3, l6);
        vader_array_t* _a10_arr = vader_array_new(8u, 0u, 0u, 164u);
        ...
        vader_obj_header_init(_a13_obj, 886u);
        _a13_obj->f_name = l18;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(88u, 0u, 13u, 898u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(113u, 0u, 13u, 1056u);
                l13 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a19_obj, 469u);
                _a19_obj->f_file = l22;
                _a19_obj->f_span = l31;
                _a19_obj->f_id = l17;
...
static void* vader_resolver_sort_by_name(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 3u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_struct___lambda_env_2070_t* _a0_obj = (vader_struct___lambda_env_2070_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2070_t));
    vader_obj_header_init(_a0_obj, 246u);
    t0 = (void*) _a0_obj;
    vader_fn_t* _a1_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a1_closure, 154u);
    _a1_closure->code = (void*) &vader_fn_lift___lambda_2069;
    _a1_closure->env = t0;
    l1 = (void*) _a1_closure;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 414u || l0.tag == 420u || l0.tag == 436u || l0.tag == 452u || l0.tag == 465u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 464u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 418u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(21u, 0u, 13u, 417u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 445u) {
        ...
        if (l5.tag == 0u) {
            ...
            vader_obj_header_init(_a9_obj, 445u);
            _a9_obj->f_span = l3;
            _a9_obj->f_id = l7;
            _a9_obj->f_cond = l15;
        ...
        if (l5.tag == 443u) {
            ...
            vader_obj_header_init(_a11_obj, 445u);
            _a11_obj->f_span = l3;
            _a11_obj->f_id = l7;
            _a11_obj->f_cond = l15;
        ...
        if (l5.tag == 444u) {
            ...
            if (l5.tag == 445u) {
                ...
                vader_obj_header_init(_a12_obj, 444u);
    ...
    if (l0.tag == 459u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(29u, 0u, 13u, 458u);
        l3 = (void*) _a14_arr;
        ...
        vader_obj_header_init(_a17_obj, 459u);
        _a17_obj->f_span = l6;
    ...
    if (l0.tag == 481u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(119u, 0u, 13u, 1091u);
        l3 = (void*) _a18_arr;
            ...
            loop_456: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 482u) {
                        ...
                        vader_obj_header_init(_a20_obj, 482u);
                        _a20_obj->f_span = l10;
                    ...
                    if (l4.tag == 483u) {
                        ...
                        vader_obj_header_init(_a21_obj, 483u);
                        _a21_obj->f_span = l19;
        ...
        vader_obj_header_init(_a22_obj, 481u);
        _a22_obj->f_span = l6;
    ...
    if (l0.tag == 474u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(112u, 0u, 13u, 1048u);
        l3 = (void*) _a23_arr;
        ...
        vader_obj_header_init(_a25_obj, 474u);
    ...
    if (l0.tag == 410u) {
        ...
        vader_obj_header_init(_a27_obj, 410u);
        _a27_obj->f_span = l3;
    ...
    if (l0.tag == 419u) {
        ...
        vader_obj_header_init(_a28_obj, 419u);
        _a28_obj->f_span = l3;
    ...
    if (l0.tag == 453u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(112u, 0u, 13u, 1048u);
        l3 = (void*) _a29_arr;
        ...
        vader_obj_header_init(_a31_obj, 453u);
        _a31_obj->f_span = l6;
    ...
    if (l0.tag == 430u) {
        ...
        vader_obj_header_init(_a32_obj, 430u);
        _a32_obj->f_span = l3;
    ...
    if (l0.tag == 476u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(118u, 0u, 13u, 1090u);
        l3 = (void*) _a33_arr;
            ...
            loop_748: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 478u) {
                        ...
                        vader_obj_header_init(_a35_obj, 478u);
                    ...
                    if (l4.tag == 477u) {
                        ...
                        vader_obj_header_init(_a36_obj, 477u);
                        _a36_obj->f_expr = l5;
                        _a36_obj->f_span = l18;
        ...
        vader_obj_header_init(_a37_obj, 476u);
    ...
    if (l0.tag == 455u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(26u, 0u, 13u, 438u);
        l3 = (void*) _a38_arr;
        ...
        l8 = (size_t) (int64_t) INT64_C(0);
        {
            loop_837: {
                if ((l8 < l7)) {
                    ...
                    vader_obj_header_init(_a40_obj, 438u);
                    _a40_obj->f_span = l10;
        ...
        vader_obj_header_init(_a41_obj, 455u);
        _a41_obj->f_span = l6;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(26u, 0u, 13u, 438u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_stmt(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 440u) {
        ...
        if (l6.tag == 451u) {
            ...
            vader_obj_header_init(_a8_obj, 440u);
            _a8_obj->f_span = l9;
            _a8_obj->f_id = l10;
            _a8_obj->f_label = l11;
            _a8_obj->f_form = l3;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 474u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(112u, 0u, 13u, 1048u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 441u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(112u, 0u, 13u, 1048u);
        l5 = (void*) _a10_arr;
...
void* vader_resolver_wildcard_ambiguities(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_obj_header_init(_a14_obj, 338u);
    _a14_obj->f_ekeys = l5;
    _a14_obj->f_evals = l6;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_244: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a17_obj, 198u);
                _a17_obj->f__0 = l9;
                _a17_obj->f__1 = l4;
                l13 = (void*) _a17_obj;
