        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1194u);
...
void* vader_resolver_build_core_seed(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    l4 = std_collections_get__string__Any(((vader_struct_vader_resolver_LoadedProject_t*) l0)->f_modules, 515u);
    if (l4.tag == 873u) {
        t0 = l4.payload.obj;
...
static void* vader_resolver_build_subst(void* l0, void* l1) {
    ...
    vader_resolver_bind_1(l2, 746u, l3);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 418u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(935u, l19, 985u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 935u);
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2168u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 411u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1514u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(935u, l4, 990u, l3, 226u, l10, 1060u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 426u);
    if (t0) {
        l6 = true;
    } else {
        l6 = std_string_starts_with(l0, 423u);
    }
    if (l6) {
        l7 = concat_3(935u, l0, 935u);
    ...
    t0 = std_string_starts_with(l0, 2318u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2318u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(935u, l2, 1005u, l0, 1044u, 2176u, 1008u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(935u, l0, 1041u, l7, 238u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2048u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2047u);
                }
                if (l8) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2051u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2050u);
                }
                if (l8) {
                    t0 = vader_box_string(166u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2316u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static vader_string_t vader_resolver_join_path(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = std_string_trim_prefix(l1, 426u);
    if (l0 == 0u) {
        { vader_string_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2054u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    std_collections_put__string__string(l10, 516u, l9);
    vader_array_t* _a9_arr = vader_array_new(8u, 1u, 0u, 166u);
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(166u, 516u);
    l11 = (void*) _a9_arr;
    ...
    _a10_obj->f_name = 2055u;
    _a10_obj->f_folder = 515u;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 166u) {
        ...
        if (l23.tag == 867u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2050u, l31, l22, l11);
            if (l35.tag == 867u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2053u, l31, l22, l11);
            if (l39.tag == 867u) {
                l40 = l39.payload.obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_21: {
            if ((l5 < l4)) {
                ...
                l6 = t0.payload.s;
                l3 = vader_resolver_symbol_make(l0, INT32_C(12), l6, 517u, 517u, (uint8_t) (int32_t) INT32_C(0), vader_box_obj(0u, NULL));
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2052u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1815u, 2052u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 166u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1815u;
            l8 = vader_resolver_origin_of_root(1815u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 166u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2316u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 277u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1727u);
        if (l3.tag == 272u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 418u) {
                                ...
                                l21 = concat_5(935u, l19, 969u, l20, 948u);
                                l22 = concat_2(1779u, l15);
                    ...
                    if (l5.tag == 867u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(935u, l15, 974u, l10, 1070u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 166u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(935u, l21, 965u, l25, 935u);
