...
static void* vader_comptime_combine_binary(void* l0, vader_box_t l1, vader_box_t l2) {
    ...
    if (l3 == INT32_C(0)) {
        l4 = (void*) &vader_fn_static_1074;
        t0 = vader_comptime_arithmetic_or_concat(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(1)) {
        l4 = (void*) &vader_fn_static_1072;
        t0 = vader_comptime_arithmetic(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(2)) {
        l4 = (void*) &vader_fn_static_1071;
        t0 = vader_comptime_arithmetic(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(3)) {
        l4 = (void*) &vader_fn_static_1069;
        t0 = vader_comptime_int_div_check(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(4)) {
        l4 = (void*) &vader_fn_static_1067;
        t0 = vader_comptime_int_mod_check(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(5)) {
        l4 = (void*) &vader_fn_static_1065;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(6)) {
        l4 = (void*) &vader_fn_static_1064;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(7)) {
        l4 = (void*) &vader_fn_static_1063;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(8)) {
        l4 = (void*) &vader_fn_static_1062;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(9)) {
        l4 = (void*) &vader_fn_static_1061;
        t0 = vader_comptime_arithmetic_int(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(10)) {
        l4 = (void*) &vader_fn_static_1059;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(11)) {
        l4 = (void*) &vader_fn_static_1058;
        t0 = vader_comptime_bool_op(l0, l1, l2, l4);
        { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l3 == INT32_C(12)) {
...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_struct___lambda_env_5517_t* _a2_obj = (vader_struct___lambda_env_5517_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5517_t));
    ...
    _a3_closure->code = (void*) &vader_fn_lift_1094;
    _a3_closure->env = t0;
    l4 = (void*) _a3_closure;
...
static void* vader_comptime_sorted_instances(void* l0) {
    ...
    vader_struct___lambda_env_2333_t* _a0_obj = (vader_struct___lambda_env_2333_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2333_t));
    ...
    _a1_closure->code = (void*) &vader_fn_lift_985;
    _a1_closure->env = t0;
    l2 = (void*) _a1_closure;
