...
static vader_string_t vader_comptime_render_struct(void* l0) {
    ...
    vader_struct___lambda_env_5499_t* _a2_obj = (vader_struct___lambda_env_5499_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_5499_t));
    vader_obj_header_init(_a2_obj, 286u);
    t0 = (void*) _a2_obj;
    vader_fn_t* _a3_closure = (vader_fn_t*) vader_gc_alloc(sizeof(vader_fn_t));
    vader_obj_header_init(_a3_closure, 138u);
    _a3_closure->code = (void*) &vader_fn_lift___lambda_5498;
    _a3_closure->env = t0;
    l4 = (void*) _a3_closure;
