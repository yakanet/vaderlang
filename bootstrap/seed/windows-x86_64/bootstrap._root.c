...
void __lambda_vader_lower_2(void* l0, vader_string_t l1, vader_string_t l2) {
    ...
    if (t0.tag == 0u) {
        ...
        vader_array_push((vader_array_t*) ((vader_struct__Cell_Array_string__t*) ((vader_struct___lambda_env_vader_lower_3_t*) l0)->f_cap_1.payload.obj)->f_value, vader_box_string(167u, l3));
    } else {
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
void __lambda_vader_midir_22(void* l0, int32_t l1) {
    ...
    ((vader_fn_erased_sig_1_t) _a0_fnobj->code)(_a0_fnobj->env, vader_box_i32(170u, l1));
