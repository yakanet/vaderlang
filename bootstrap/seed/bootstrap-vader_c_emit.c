...
static vader_box_t vader_c_emit_address_as_size(vader_box_t l0) {
    ...
    l1 = vader_c_emit_c_ast_cast(2161u, l0);
    t0 = vader_c_emit_c_ast_cast(1928u, l1);
...
static vader_box_t vader_c_emit_argument(size_t l0) {
    ...
    l2 = (size_t) 0;
    l2 = std_core_write_string_at(l1, l2, 1013u);
...
static vader_box_t vader_c_emit_array_pointer(vader_box_t l0) {
    ...
    vader_gc_top = &gc_frame;
    t0 = vader_c_emit_c_ast_cast(2233u, l0);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static void vader_c_emit_assert_stack_empty(void* l0, vader_string_t l1) {
    ...
    if (t0 != INT64_C(0)) {
        ...
        l4 = std_core_write_string_at(l6, l4, 777u);
        t0 = ((vader_array_t*) ((vader_struct_vader_c_emit_FnState_t*) l0)->f_stack)->length;
...
static vader_string_t vader_c_emit_aux(void* l0, vader_string_t l1) {
    ...
    l3 = std_core_write_string_at(l4, l3, 717u);
...
static vader_box_t vader_c_emit_box_call(vader_string_t l0, int32_t l1, vader_box_t l2) {
    ...
    vader_array_t* _a0_arr = vader_array_new(145u, 2u, 13u, 1201u);
...
static vader_box_t vader_c_emit_box_expr(vader_box_t l0, uint8_t l1, int32_t l2) {
    ...
    if (l3) {
        l4 = vader_c_emit_box_call(1535u, l2, l0);
    } else {
        if (l1 == INT32_C(5)) {
            l3 = true;
        } else {
        ...
        if (l3) {
            ...
            vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 1u] = vader_box_string(190u, 2158u);
            vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 0u] = vader_box_string(190u, 1617u);
            t0 = (void*) _a0_arr;
            ...
            _a1_obj->f_value = l0;
            l5 = (void*) _a1_obj;
            l4 = vader_c_emit_box_call(1535u, l2, vader_ref_box(l5));
        } else if (l1 == INT32_C(3)) {
            l4 = vader_c_emit_box_call(1557u, l2, l0);
        } else if (l1 == INT32_C(4)) {
            l6 = vader_c_emit_c_ast_cast(1618u, l0);
            l4 = vader_c_emit_box_call(1557u, l2, l6);
        } else {
            if (l1 == INT32_C(8)) {
                l3 = true;
            } else {
            ...
            if (l3) {
                ...
                vader_array_box_slots(_a2_arr->buf)[_a2_arr->offset + 1u] = vader_box_string(190u, 2159u);
                vader_array_box_slots(_a2_arr->buf)[_a2_arr->offset + 0u] = vader_box_string(190u, 1618u);
                t0 = (void*) _a2_arr;
                ...
                _a3_obj->f_value = l0;
                l5 = (void*) _a3_obj;
                l4 = vader_c_emit_box_call(1557u, l2, vader_ref_box(l5));
            } else if (l1 == INT32_C(10)) {
                l6 = vader_c_emit_c_ast_cast(1339u, l0);
                l4 = vader_c_emit_box_call(1428u, l2, l6);
            } else if (l1 == INT32_C(11)) {
                l4 = vader_c_emit_box_call(1428u, l2, l0);
            } else if (l1 == INT32_C(12)) {
                l4 = vader_c_emit_box_call(1144u, l2, l0);
            } else if (l1 == INT32_C(13)) {
                l6 = vader_c_emit_c_ast_cast(1617u, l0);
                l4 = vader_c_emit_box_call(1535u, l2, l6);
            } else if (l1 == INT32_C(14)) {
                l4 = vader_c_emit_box_call(2008u, l2, l0);
            } else {
                if (l1 == INT32_C(15)) {
                    l3 = true;
                } else {
                ...
                if (l3) {
                    ...
                    vader_array_t* _a4_arr = vader_array_new(145u, 0u, 13u, 1201u);
                    l5 = (void*) _a4_arr;
                    l4 = vader_c_emit_c_ast_call(2242u, l5);
                } else if (l1 == INT32_C(17)) {
                    l6 = vader_c_emit_c_ast_cast(1633u, l0);
                    l6 = vader_c_emit_c_ast_cast(1618u, l6);
                    l4 = vader_c_emit_box_call(1557u, l2, l6);
...
static vader_box_t vader_c_emit_box_slot_1(vader_string_t l0, vader_box_t l1) {
    ...
    t0 = concat_2(l0, 249u);
    t1 = vader_c_emit_c_ast_verbatim(t0);
    vader_array_t* _a0_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t1.payload.obj;
    l2 = (void*) _a0_arr;
    t1 = vader_c_emit_c_ast_call(2205u, l2);
...
static vader_box_t vader_c_emit_boxed_object(int32_t l0, vader_box_t l1) {
    ...
    l3 = (void*) _a0_obj;
    l4 = vader_c_emit_c_ast_cast(2335u, l1);
    t0 = vader_c_emit_c_ast_designated(269u, l4);
    vader_array_t* _a1_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ((void**) _a1_arr->buf->slots)[_a1_arr->offset + 0u] = t0.payload.obj;
    t1 = (void*) _a1_arr;
    l4 = vader_c_emit_c_ast_initializer_list(t1);
    vader_array_t* _a2_arr = vader_array_new(145u, 3u, 13u, 1201u);
...
static void* vader_c_emit_boxed_parameters(void* l0, size_t l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(54u, 1u, 13u, 691u);
    ...
    l3 = (size_t) 0;
    {
        loop_6: {
            if ((l3 < l1)) {
                l4 = std_core_new_byte_buffer((size_t) 21);
                l5 = (size_t) 0;
                l5 = std_core_write_string_at(l4, l5, 1013u);
...
static vader_box_t vader_c_emit_buffer_pointer(vader_box_t l0) {
    ...
    t0 = vader_c_emit_c_ast_cast(2258u, l1);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static void* vader_c_emit_c_struct_layout_asserts(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l2 = (void*) _a0_arr;
    ...
    l5 = (size_t) 0;
    {
        loop_11: {
            if ((l5 < l4)) {
                ...
                vader_array_t* _a2_arr = vader_array_new(145u, 1u, 13u, 1201u);
                ((void**) _a2_arr->buf->slots)[_a2_arr->offset + 0u] = t5.payload.obj;
                l12 = (void*) _a2_arr;
                l13 = vader_c_emit_c_ast_call(1929u, l12);
    ...
    l6 = (size_t) 0;
    {
        loop_13: {
            if ((l6 < l5)) {
                ...
                l12 = concat_5(1820u, l3, 239u, l11, 206u);
                if (l10.tag == 489u) {
                    t4 = l10.payload.obj;
...
static vader_box_t vader_c_emit_coerce_expr(void* l0, vader_box_t l1, uint8_t l2, uint8_t l3) {
    ...
    if (l3 == INT32_C(18)) {
        ...
        if (l4) {
            t0 = vader_c_emit_payload(l1, 1816u);
            { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        { vader_box_t __vret = l1; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static vader_box_t vader_c_emit_data_slot(uint8_t l0, uint64_t l1) {
    ...
    l4 = (void*) _a0_arr;
    l3 = vader_c_emit_c_ast_call(668u, l4);
    t2 = vader_c_emit_c_ast_cast(l2, l3);
    { vader_box_t __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static void* vader_c_emit_dispatcher_parameters(void* l0) {
    ...
    _a0_obj->f_type = 2245u;
    _a0_obj->f_name = 1876u;
    l1 = (void*) _a0_obj;
...
static void vader_c_emit_emit_agg_data_entry(void* l0, void* l1, void* l2, void* l3, void* l4) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l5 = (void*) _a0_arr;
    ...
    l7 = (size_t) 0;
    {
        loop_8: {
            if ((l7 < l6)) {
                ...
                l12 = std_core_write_string_at(l11, l12, 759u);
    ...
    vader_c_emit_push_pool_array(l1, l2, 2245u, (uint8_t) 0, l5);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_array_clear(void* l0) {
    ...
    l1 = (void*) _a0_arr;
    l2 = vader_c_emit_c_ast_call(2208u, l1);
...
static void vader_c_emit_emit_array_copy(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(145u, 5u, 13u, 1201u);
    ...
    l6 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2209u, l6);
...
static void vader_c_emit_emit_array_get(void* l0, void* l1) {
    ...
    if (l10) {
        ...
        vader_array_t* _a1_arr = vader_array_new(145u, 2u, 13u, 1201u);
    ...
    if (l9.tag == 0u) {
        ...
        l6 = std_core_write_string_at(l4, l6, 2132u);
        ...
        l4 = (void*) _a2_arr;
        l3 = vader_c_emit_c_ast_call(2224u, l4);
    } else {
        t2 = l9.payload.obj;
...
static void vader_c_emit_emit_array_new(void* l0, void* l1) {
    ...
    l4 = std_core_write_string_at(l2, l4, 2132u);
    ...
    vader_array_t* _a1_arr = vader_array_new(145u, 4u, 13u, 1201u);
    ...
    l2 = (void*) _a1_arr;
    l10 = vader_c_emit_c_ast_call(2211u, l2);
    vader_c_emit_declare(l0, 2233u, l8, l10);
        ...
        loop_142: {
            if ((l6 < l7)) {
                ...
                if (!(l10.tag == 0u)) {
                    ...
                    l21 = vader_c_emit_typed_slot(2335u, l8, l20);
...
static void vader_c_emit_emit_array_push(void* l0, void* l1) {
    ...
    if (l10) {
        ...
        l4 = (void*) _a1_arr;
        l12 = vader_c_emit_c_ast_call(2213u, l4);
    ...
    vader_array_t* _a2_arr = vader_array_new(145u, 2u, 13u, 1201u);
...
static void vader_c_emit_emit_array_push_all(void* l0) {
    ...
    l3 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2214u, l3);
    vader_c_emit_evaluate(l0, l1);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_array_remove_last(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t0.payload.obj;
    l1 = (void*) _a0_arr;
    l2 = vader_c_emit_c_ast_call(2229u, l1);
...
static void vader_c_emit_emit_array_repeat(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l2.payload.obj;
    l4 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2230u, l4);
    vader_c_emit_declare(l0, 2233u, l3, l1);
...
static void vader_c_emit_emit_array_set(void* l0, void* l1) {
    ...
    if (l10) {
        if (l8.tag == 490u) {
            ...
            l5 = (void*) _a2_arr;
            l4 = vader_c_emit_c_ast_call(2227u, l5);
            vader_c_emit_evaluate(l0, l4);
        }
        t2 = concat_2(l11, 249u);
        l4 = vader_c_emit_c_ast_verbatim(t2);
...
static void vader_c_emit_emit_array_slice(void* l0, void* l1) {
    ...
    l6 = (void*) _a0_arr;
    l2 = vader_c_emit_c_ast_call(2231u, l6);
    vader_c_emit_declare(l0, 2233u, l5, l2);
...
static void vader_c_emit_emit_atom_comptime_table(void* l0, void* l1) {
    ...
    vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 0u] = vader_box_string(190u, 410u);
    l2 = (void*) _a0_arr;
    t0 = ((vader_array_t*) ((vader_struct_vader_c_emit_EmitCtx_t*) l0)->f_atom_table)->length;
    if (t0 == INT64_C(0)) {
        ...
        vader_obj_header_init(_a1_obj, 689u);
        ...
        vader_obj_header_init(_a2_obj, 689u);
        ...
        vader_obj_header_init(_a4_obj, 689u);
        ...
        vader_obj_header_init(_a5_obj, 689u);
        _a5_obj->f_value = INT64_C(0);
        _a5_obj->f_unsigned_v = true;
        l7 = (void*) _a5_obj;
        l8 = vader_c_emit_c_ast_verbatim(148u);
        vader_array_t* _a6_arr = vader_array_new(145u, 6u, 13u, 1201u);
        ...
        vader_array_t* _a7_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ...
        vader_obj_header_init(_a9_obj, 679u);
        _a9_obj->f_storage = l9;
        _a9_obj->f_constant = true;
        _a9_obj->f_type = 2236u;
        _a9_obj->f_declarator = l3;
        l3 = (void*) _a9_obj;
        l8 = vader_c_emit_atom_count_define(l0);
        vader_array_t* _a10_arr = vader_array_new(147u, 2u, 13u, 1208u);
    ...
    l3 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l4 = (void*) _a13_arr;
    l11 = INT64_C(0);
    ...
    l13 = (size_t) 0;
    {
        loop_94: {
            if ((l13 < l12)) {
                ...
                l8 = vader_c_emit_c_ast_verbatim(2234u);
                ...
                vader_obj_header_init(_a16_obj, 689u);
    ...
    vader_obj_header_init(_a20_obj, 707u);
    l5 = (void*) _a20_obj;
    ...
    vader_obj_header_init(_a21_obj, 701u);
    ...
    vader_obj_header_init(_a22_obj, 671u);
    _a22_obj->f_name = 2234u;
    ...
    vader_obj_header_init(_a23_obj, 679u);
    ...
    vader_obj_header_init(_a24_obj, 707u);
    l5 = (void*) _a24_obj;
    ...
    vader_obj_header_init(_a25_obj, 671u);
    _a25_obj->f_name = 2235u;
    ...
    vader_obj_header_init(_a26_obj, 679u);
    _a26_obj->f_storage = l9;
    _a26_obj->f_constant = true;
    _a26_obj->f_type = 2236u;
    _a26_obj->f_declarator = l4;
    l4 = (void*) _a26_obj;
    vader_array_t* _a27_arr = vader_array_new(147u, 1u, 13u, 1208u);
    ...
    l2 = (void*) _a29_arr;
    vader_array_t* _a30_arr = vader_array_new(147u, 1u, 13u, 1208u);
    ...
    vader_array_t* _a33_arr = vader_array_new(147u, 1u, 13u, 1208u);
...
static void vader_c_emit_emit_branch(void* l0, int32_t l1, bool l2) {
    ...
    if (l4.tag == 652u) {
        ...
        if (t1) {
            ...
            l7 = (size_t) 0;
            l7 = std_core_write_string_at(l6, l7, 1724u);
            t0 = l4.payload.obj;
            ...
            l7 = (size_t) 0;
            l7 = std_core_write_string_at(l6, l7, 1361u);
            t0 = l4.payload.obj;
            t2 = ((vader_struct_vader_c_emit_ScopeInfo_t*) t0)->f_opener_pc;
            l8 = ((int64_t) (int32_t) t2);
            l7 = std_core_write_int(l6, l7, l8);
        ...
        if (l2) {
            ...
            l7 = (size_t) 0;
            l7 = std_core_write_string_at(l6, l7, 1155u);
            ...
            l7 = (size_t) 0;
            l7 = std_core_write_string_at(l6, l7, 1153u);
            l8 = ((int64_t) (int32_t) l1);
            l7 = std_core_write_int(l6, l7, l8);
            l7 = std_core_write_string_at(l6, l7, 206u);
            l9 = std_core_finish_buffer(l6, l7);
        ...
        l7 = (size_t) 0;
        l7 = std_core_write_string_at(l6, l7, 1354u);
        l8 = ((int64_t) (int32_t) l1);
        l7 = std_core_write_int(l6, l7, l8);
...
static void vader_c_emit_emit_buffer_new(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t1.payload.obj;
    l1 = (void*) _a0_arr;
    l2 = vader_c_emit_c_ast_call(2253u, l1);
    l2 = vader_c_emit_c_ast_cast(2335u, l2);
...
static void vader_c_emit_emit_buffer_to_string(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l2.payload.obj;
    l3 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2247u, l3);
...
static void vader_c_emit_emit_buffer_write_string(void* l0) {
    ...
    l4 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2259u, l4);
    vader_c_emit_evaluate(l0, l1);
    { vader_gc_top = gc_frame.prev; return; }
}
...
void* vader_c_emit_emit_c_split(void* l0, void* l1, vader_string_t l2) {
    ...
    l7 = (void*) _a2_obj;
    vader_c_emit_emit_preamble(l7, 438u);
    ...
    vader_array_box_slots(_a6_arr->buf)[_a6_arr->offset + 0u] = vader_box_string(190u, 437u);
    l9 = (void*) _a6_arr;
    ...
    _a7_obj->f_path = 2199u;
    _a7_obj->f_system = false;
    t0 = (void*) _a7_obj;
    vader_array_t* _a8_arr = vader_array_new(147u, 1u, 13u, 1208u);
...
static void vader_c_emit_emit_call_indirect(void* l0, void* l1) {
    ...
    if (l4.tag == 483u) {
        ...
        l8 = vader_c_emit_aux(l0, 1486u);
        l5 = vader_c_emit_object_pointer_of(l5);
        l5 = vader_c_emit_c_ast_cast(2275u, l5);
        vader_c_emit_declare(l0, 2275u, l8, l5);
        t4 = concat_2(l8, 253u);
        ...
        l3 = std_core_write_string_at(l7, l3, 769u);
        ...
        loop_27: {
            if ((l6 < l5)) {
                ...
                if ((t1 >= INT32_C(0))) {
                    ...
                    l11 = concat_2(2273u, l8);
                    l12 = vader_c_emit_external(2274u, l11, vader_box_obj(0u, NULL), false);
...
static void vader_c_emit_emit_closure_lift(void* l0, void* l1, int32_t l2) {
    ...
    l7 = vader_c_emit_c_ast_verbatim(1368u);
    ...
    vader_array_t* _a3_arr = vader_array_new(146u, 0u, 13u, 1205u);
    t4 = (void*) _a3_arr;
    ...
    vader_array_t* _a5_arr = vader_array_new(146u, 0u, 13u, 1205u);
    l6 = (void*) _a5_arr;
    ...
    vader_obj_header_init(_a6_obj, 677u);
...
static void vader_c_emit_emit_data_const_op(void* l0, void* l1) {
    ...
    l3 = (size_t) 0;
    l3 = std_core_write_string_at(l2, l3, 2263u);
...
static void vader_c_emit_emit_data_global_externs(void* l0, void* l1) {
    ...
    l4 = (size_t) 0;
    {
        loop_9: {
            if ((l4 < l3)) {
                ...
                l6 = std_core_new_byte_buffer((size_t) 31);
                l7 = (size_t) 0;
                l7 = std_core_write_string_at(l6, l7, 2263u);
                t2 = ((int64_t) (size_t) l4);
                l8 = (uint64_t) (int64_t) t2;
                l7 = std_core_write_unsigned(l6, l7, l8);
                l9 = std_core_finish_buffer(l6, l7);
                l10 = vader_c_emit_external(2232u, l9, vader_box_obj(0u, NULL), l5);
    ...
    if ((t4 > INT64_C(0))) {
        ...
        l6 = (void*) _a2_obj;
        l10 = vader_c_emit_external(2233u, 2283u, vader_ref_box(l6), false);
        ...
        l6 = (void*) _a3_obj;
        l11 = vader_c_emit_external(2335u, 2285u, vader_ref_box(l6), false);
        l12 = vader_c_emit_external(2279u, 2284u, vader_box_obj(0u, NULL), false);
        vader_array_t* _a4_arr = vader_array_new(147u, 3u, 13u, 1208u);
    ...
    l6 = (void*) _a5_obj;
    l10 = vader_c_emit_external(2236u, 2235u, vader_ref_box(l6), true);
    vader_array_push((vader_array_t*) l2, l10);
...
static void vader_c_emit_emit_data_pool(void* l0, void* l1) {
    ...
    l9 = (size_t) 0;
    {
        loop_43: {
            if ((l9 < l8)) {
                ...
                l11 = (size_t) 0;
                l11 = std_core_write_string_at(l5, l11, 2263u);
    ...
    vader_array_box_slots(_a8_arr->buf)[_a8_arr->offset + 2u] = vader_box_string(190u, 1885u);
    vader_array_box_slots(_a8_arr->buf)[_a8_arr->offset + 1u] = vader_box_string(190u, 494u);
    vader_array_box_slots(_a8_arr->buf)[_a8_arr->offset + 0u] = vader_box_string(190u, 411u);
    t3 = (void*) _a8_arr;
    vader_struct_vader_c_emit_c_ast_CSection_t* _a9_obj = (vader_struct_vader_c_emit_c_ast_CSection_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CSection_t));
    vader_obj_header_init(_a9_obj, 697u);
...
static vader_box_t vader_c_emit_emit_data_value(void* l0, void* l1, vader_box_t l2, vader_string_t l3, void* l4) {
    ...
    if (l2.tag == 498u) {
            ...
            l12 = (size_t) 0;
            {
                loop_97: {
                    if ((l12 < l10)) {
                        ...
                        l18 = std_core_write_string_at(l17, l18, 760u);
        ...
        vader_obj_header_init(_a7_obj, 679u);
...
static void vader_c_emit_emit_defer_pop_exec(void* l0, void* l1) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t2.payload.obj;
    l2 = (void*) _a0_arr;
    l5 = vader_c_emit_c_ast_call(2264u, l2);
    vader_c_emit_evaluate(l0, l5);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_defer_push(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t0.payload.obj;
    l2 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2265u, l2);
    vader_c_emit_evaluate(l0, l1);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_else(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_c_emit_assert_stack_empty(l0, 1352u);
...
static void vader_c_emit_emit_end(void* l0, int32_t l1) {
    ...
    l3 = (size_t) 0;
    l3 = std_core_write_string_at(l2, l3, 1910u);
    ...
    if (l6.tag == 0u) {
        ...
        l3 = (size_t) 0;
        l3 = std_core_write_string_at(l7, l3, 1355u);
        l4 = ((int64_t) (int32_t) l1);
    ...
    if (t1) {
        l7 = std_core_new_byte_buffer((size_t) 27);
        l3 = (size_t) 0;
        l3 = std_core_write_string_at(l7, l3, 1361u);
...
static void vader_c_emit_emit_fn_addr(void* l0, void* l1) {
    ...
    l5 = vader_c_emit_c_ast_cast(2335u, l5);
    vader_c_emit_assign(l0, vader_ref_box(l2), l5);
    l5 = vader_c_emit_c_ast_verbatim(2267u);
...
static void vader_c_emit_emit_fn_ref_tramp(void* l0, void* l1, int32_t l2, int32_t l3) {
    ...
    l7 = vader_c_emit_c_ast_verbatim(1368u);
    t2 = vader_c_emit_c_ast_cast(2334u, l7);
    ...
    t3 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    vader_array_t* _a4_arr = vader_array_new(146u, 0u, 13u, 1205u);
    l9 = (void*) _a4_arr;
    ...
    vader_obj_header_init(_a5_obj, 677u);
    ...
    t1 = concat_2(2276u, l6);
    t2 = vader_c_emit_c_ast_verbatim(t1);
    l11 = vader_c_emit_c_ast_address_of(t2);
    l11 = vader_c_emit_c_ast_cast(2335u, l11);
    ...
    vader_obj_header_init(_a6_obj, 708u);
    _a6_obj->f_text = 490u;
    l4 = (void*) _a6_obj;
    vader_array_t* _a7_arr = vader_array_new(145u, 3u, 13u, 1201u);
    ...
    l4 = (size_t) 0;
    {
        loop_9: {
            if ((l4 <= l3)) {
                l5 = std_core_new_byte_buffer((size_t) 42);
                l6 = (size_t) 0;
                l6 = std_core_write_string_at(l5, l6, 2270u);
                t0 = ((int64_t) (size_t) l4);
                l7 = (uint64_t) (int64_t) t0;
                l6 = std_core_write_unsigned(l5, l6, l7);
                l6 = std_core_write_string_at(l5, l6, 768u);
...
static void vader_c_emit_emit_global_const_roots(void* l0, void* l1) {
    ...
    l7 = (size_t) 0;
    {
        loop_23: {
            if ((l7 < l6)) {
                ...
                l10 = (size_t) 0;
                l10 = std_core_write_string_at(l9, l10, 2263u);
    ...
    vader_obj_header_init(_a4_obj, 679u);
    _a4_obj->f_storage = l3;
    _a4_obj->f_constant = false;
    _a4_obj->f_type = 2233u;
        ...
        loop_95: {
            if ((l7 < l6)) {
                ...
                if (!(t4.tag == 488u)) {
                    ...
                    l10 = (size_t) 0;
                    l10 = std_core_write_string_at(l5, l10, 2263u);
                    t2 = ((int64_t) (size_t) l8);
                    l11 = (uint64_t) (int64_t) t2;
                    l10 = std_core_write_unsigned(l5, l10, l11);
                    l10 = std_core_write_string_at(l5, l10, 756u);
    ...
    vader_obj_header_init(_a7_obj, 707u);
    l2 = (void*) _a7_obj;
    l12 = vader_c_emit_c_ast_initializer_list(l4);
    vader_struct_vader_c_emit_c_ast_CDeclarator_t* _a8_obj = (vader_struct_vader_c_emit_c_ast_CDeclarator_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CDeclarator_t));
    vader_obj_header_init(_a8_obj, 671u);
    _a8_obj->f_name = 2285u;
    ...
    vader_obj_header_init(_a10_obj, 708u);
    _a10_obj->f_text = 490u;
    l2 = (void*) _a10_obj;
    ...
    vader_obj_header_init(_a11_obj, 689u);
    ...
    vader_obj_header_init(_a13_obj, 708u);
    _a13_obj->f_text = 490u;
    l13 = (void*) _a13_obj;
    ...
    vader_obj_header_init(_a14_obj, 708u);
    _a14_obj->f_text = 490u;
    l14 = (void*) _a14_obj;
    t0 = ((vader_array_t*) l4)->length;
    l12 = vader_c_emit_c_ast_unsigned(((int64_t) (size_t) t0));
    l15 = vader_c_emit_c_ast_verbatim(2285u);
    vader_array_t* _a15_arr = vader_array_new(145u, 7u, 13u, 1201u);
    ...
    vader_obj_header_init(_a17_obj, 679u);
    _a17_obj->f_storage = l3;
    _a17_obj->f_constant = false;
    _a17_obj->f_type = 2279u;
...
static void vader_c_emit_emit_if_open(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_c_emit_pop(l0);
    vader_c_emit_assert_stack_empty(l0, 1589u);
...
static void vader_c_emit_emit_import_shims(void* l0, void* l1) {
    ...
    vader_array_t* _a2_arr = vader_array_new(8u, 0u, 0u, 190u);
    l4 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l5 = (void*) _a3_arr;
    ...
    vader_array_t* _a5_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l3 = (void*) _a5_arr;
    ...
    vader_array_box_slots(_a7_arr->buf)[_a7_arr->offset + 0u] = vader_box_string(190u, 443u);
    t4 = (void*) _a7_arr;
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(190u, 672u);
    t4 = (void*) _a9_arr;
    ...
    vader_array_box_slots(_a11_arr->buf)[_a11_arr->offset + 0u] = vader_box_string(190u, 953u);
    l2 = (void*) _a11_arr;
    ...
    l11 = (size_t) 0;
    {
        loop_16: {
            if ((l11 < l10)) {
                ...
                l14 = (size_t) 0;
                l14 = std_core_write_string_at(l13, l14, 1689u);
                t1 = (l7 + l11);
...
static void vader_c_emit_emit_main(void* l0, void* l1, vader_string_t l2) {
    ...
    vader_struct_vader_c_emit_c_ast_CParameter_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CParameter_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CParameter_t));
    vader_obj_header_init(_a0_obj, 691u);
    _a0_obj->f_type = 1615u;
    _a0_obj->f_name = 1063u;
    l3 = (void*) _a0_obj;
    vader_struct_vader_c_emit_c_ast_CParameter_t* _a1_obj = (vader_struct_vader_c_emit_c_ast_CParameter_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CParameter_t));
    vader_obj_header_init(_a1_obj, 691u);
    _a1_obj->f_type = 1255u;
    _a1_obj->f_name = 1066u;
    l4 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(54u, 2u, 13u, 691u);
    ...
    _a3_obj->f_result = 1615u;
    _a3_obj->f_name = 1730u;
...
static void vader_c_emit_emit_make_closure(void* l0, void* l1) {
    ...
    l4 = vader_c_emit_gc_allocation(2274u);
    vader_c_emit_declare(l0, 2275u, l3, l4);
    ...
    t0 = concat_2(2271u, l7);
    t1 = vader_c_emit_c_ast_verbatim(t0);
    l8 = vader_c_emit_c_ast_address_of(t1);
    l8 = vader_c_emit_c_ast_cast(2335u, l8);
    vader_c_emit_assign(l0, l4, l8);
    t0 = concat_2(l3, 253u);
    l4 = vader_c_emit_c_ast_verbatim(t0);
...
static void vader_c_emit_emit_memory_copy(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l5.payload.obj;
    l6 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2252u, l6);
    vader_c_emit_evaluate(l0, l1);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_mirrored_struct_typedefs(void* l0, void* l1) {
    ...
    vader_array_t* _a0_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l2 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l3 = (void*) _a1_arr;
...
static void vader_c_emit_emit_multi_call(void* l0, vader_string_t l1, void* l2, void* l3) {
    ...
    vader_array_t* _a0_arr = vader_array_new(55u, 0u, 13u, 705u);
    l5 = (void*) _a0_arr;
    l6 = ((vader_array_t*) l4)->length;
    l7 = (size_t) 0;
    {
...
static vader_box_t vader_c_emit_emit_nested_array(void* l0, void* l1, void* l2, vader_string_t l3, void* l4) {
    ...
    l6 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l11 = (void*) _a1_arr;
        ...
        loop_37: {
            if ((l13 < l12)) {
                ...
                if (l5 == INT32_C(0)) {
                    ...
                    l17 = std_core_write_string_at(l16, l17, 773u);
    ...
    t3 = vader_c_emit_c_ast_cast(2233u, l14);
...
static void vader_c_emit_emit_op(void* l0, int32_t l1, vader_box_t l2) {
    ...
    if (l2.tag == 551u) {
        ...
        vader_c_emit_push_unop(l0, 2382u, (uint8_t) 2);
    } else if (l2.tag == 547u) {
        ...
        vader_c_emit_push_unop(l0, 2382u, (uint8_t) 3);
    } else if (l2.tag == 582u) {
        ...
        vader_c_emit_emit_buffer_load(l0, 2249u, (uint8_t) 2);
    } else if (l2.tag == 590u) {
        vader_c_emit_emit_buffer_load(l0, 2250u, (uint8_t) 3);
    } else if (l2.tag == 588u) {
        vader_c_emit_emit_buffer_load(l0, 2248u, (uint8_t) 11);
    } else if (l2.tag == 616u) {
        vader_c_emit_emit_buffer_store(l0, 2257u, 2160u);
    } else if (l2.tag == 611u) {
        vader_c_emit_emit_buffer_store(l0, 2255u, 1617u);
    } else if (l2.tag == 612u) {
        vader_c_emit_emit_buffer_store(l0, 2256u, 1618u);
    } else if (l2.tag == 610u) {
        vader_c_emit_emit_buffer_store(l0, 2254u, 1339u);
    } else if (l2.tag == 592u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_LoadSlotI32_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_load_prim(l0, 1617u, (uint8_t) 2, l6);
    } else if (l2.tag == 593u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_LoadSlotI64_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_load_prim(l0, 1618u, (uint8_t) 3, l6);
    } else if (l2.tag == 591u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_LoadSlotF64_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_load_prim(l0, 1339u, (uint8_t) 11, l6);
    } else if (l2.tag == 614u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_StoreSlotI32_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_store_prim(l0, 1617u, (uint8_t) 2, l6);
    } else if (l2.tag == 615u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_StoreSlotI64_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_store_prim(l0, 1618u, (uint8_t) 3, l6);
    } else if (l2.tag == 613u) {
        t0 = l2.payload.obj;
        l6 = ((vader_struct_vader_bytecode_StoreSlotF64_t*) t0)->f_bounds_safe;
        vader_c_emit_emit_slot_store_prim(l0, 1339u, (uint8_t) 11, l6);
    } else if (l2.tag == 601u) {
...
static void vader_c_emit_emit_open_scope(void* l0, int32_t l1, uint8_t l2) {
    ...
    l4 = (size_t) 0;
    l4 = std_core_write_string_at(l3, l4, 1911u);
    ...
    if (l9) {
        ...
        l4 = (size_t) 0;
        l4 = std_core_write_string_at(l3, l4, 1724u);
        l5 = ((int64_t) (int32_t) l1);
        l4 = std_core_write_int(l3, l4, l5);
        l6 = std_core_finish_buffer(l3, l4);
    } else {
...
static void vader_c_emit_emit_preamble(void* l0, vader_string_t l1) {
    ...
    _a4_obj->f_path = 2015u;
    _a4_obj->f_system = true;
    l6 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(147u, 4u, 13u, 1208u);
...
static void vader_c_emit_emit_size_of_type(void* l0) {
    ...
    l1 = vader_c_emit_payload(t1, 1816u);
    l1 = vader_c_emit_c_ast_around(205u, l1, 714u);
...
static vader_string_t vader_c_emit_emit_slot_array_local(void* l0, vader_box_t l1, vader_box_t l2, bool l3) {
    ...
    if (!(l3)) {
        ...
        ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l4.payload.obj;
        l7 = (void*) _a0_arr;
        vader_c_emit_statement_macro(l0, 673u, l7);
    }
        ...
        loop_8: {
            if ((l9 < l8)) {
                        ...
                        loop_71: {
                            if ((l15 < l14)) {
                                ...
                                if (((int32_t) t0.payload.i) == l10) {
                                    ...
                                    l18 = vader_c_emit_c_ast_declaration(2308u, l16, l17);
                ...
                if (l11) {
                            ...
                            if ((l21 < l20)) {
                                ...
                                if (((int32_t) t0.payload.i) == l10) {
                                    if (l12) {
                                        ...
                                        l22 = t0.payload.s;
                                        l23 = vader_c_emit_c_ast_verbatim(490u);
                                        l24 = vader_c_emit_c_ast_declaration(2335u, l22, l23);
                                        ...
                                        l26 = t0.payload.s;
                                        l27 = vader_c_emit_c_ast_declaration(2335u, l26, vader_box_obj(0u, NULL));
                    ...
                    vader_array_t* _a9_arr = vader_array_new(51u, 0u, 13u, 671u);
                    l28 = (void*) _a9_arr;
                            ...
                            if ((l30 < l29)) {
                                ...
                                if (((int32_t) t0.payload.i) == l10) {
                                    if (l12) {
                                        ...
                                        l31 = t0.payload.s;
                                        vader_array_t* _a12_arr = vader_array_new(145u, 0u, 13u, 1201u);
                                        l32 = (void*) _a12_arr;
                                        l33 = vader_c_emit_c_ast_call(2242u, l32);
                                        ...
                                        vader_obj_header_init(_a13_obj, 671u);
                                        _a13_obj->f_name = l31;
                    ...
                    vader_obj_header_init(_a17_obj, 670u);
                    _a17_obj->f_type = t3;
...
static void vader_c_emit_emit_str_data_entry(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_c_emit_push_pool_array(l0, l1, 2245u, (uint8_t) 0, l4);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_string_slice(void* l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l3.payload.obj;
    l4 = (void*) _a0_arr;
    l1 = vader_c_emit_c_ast_call(2307u, l4);
    vader_c_emit_push_into_temporary(l0, l1, (uint8_t) 14);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_emit_struct_new(void* l0, void* l1) {
    ...
    if (l4.tag == 493u) {
        ...
        if (t5) {
            l17 = vader_c_emit_aux(l0, 1990u);
            l18 = vader_c_emit_aux(l0, 1816u);
        ...
        if ((l3 >= l12)) {
            ...
            l3 = (size_t) 0;
            l3 = std_core_write_string_at(l10, l3, 1608u);
            ...
            l3 = (size_t) 0;
            l3 = std_core_write_string_at(l10, l3, 2065u);
            l3 = std_core_write_string_at(l10, l3, l17);
            l3 = std_core_write_string_at(l10, l3, 820u);
            t4 = ((vader_array_t*) l2)->length;
            t1 = ((int64_t) (size_t) t4);
            l20 = (uint64_t) (int64_t) t1;
            l3 = std_core_write_unsigned(l10, l3, l20);
        ...
        l3 = (size_t) 0;
        l3 = std_core_write_string_at(l2, l3, 2035u);
        t0 = ((vader_struct_vader_bytecode_StructNew_t*) l1)->f_type_id;
...
static void vader_c_emit_emit_struct_set(void* l0, void* l1) {
    ...
    if (l4.tag == 493u) {
        ...
        l3 = (size_t) 0;
        l3 = std_core_write_string_at(l2, l3, 2039u);
        t0 = ((vader_struct_vader_bytecode_StructSet_t*) l1)->f_type_id;
    ...
    l8 = (size_t) 0;
    {
        loop_8: {
            if ((l8 < l7)) {
                ...
                l10 = (size_t) 0;
                l10 = std_core_write_string_at(l9, l10, 2052u);
...
static void vader_c_emit_emit_type_info_table(void* l0, void* l1) {
    ...
    vader_array_t* _a2_arr = vader_array_new(147u, 0u, 13u, 1208u);
    l6 = (void*) _a2_arr;
    if (l4) {
        l9 = vader_c_emit_single_offset_list(2272u, 1822u);
        vader_array_push((vader_array_t*) l6, l9);
    }
    if (l5) {
        l9 = vader_c_emit_single_offset_list(2212u, 1821u);
        vader_array_push((vader_array_t*) l6, l9);
    }
    vader_array_t* _a3_arr = vader_array_new(8u, 0u, 0u, 190u);
    t1 = (void*) _a3_arr;
    ...
    vader_array_t* _a5_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l6 = (void*) _a5_arr;
    l7 = (size_t) 0;
    {
        loop_78: {
            if ((l7 < l3)) {
                ...
                if (l9.tag == 493u) {
                    ...
                    l16 = vader_c_emit_single_reference_row(l7, 428u, 2274u, l15, 2272u);
                    vader_array_push((vader_array_t*) l6, l16);
                } else if (l9.tag == 480u) {
                    t1 = l10.payload.obj;
                    l17 = vader_bytecode_size_of_bc_type(vader_ref_box(t1));
                    l18 = vader_c_emit_single_reference_row(l7, 366u, 2232u, l17, 2212u);
    ...
    vader_obj_header_init(_a11_obj, 679u);
    _a11_obj->f_storage = (uint8_t) 1;
    _a11_obj->f_constant = true;
    _a11_obj->f_type = 1928u;
    _a11_obj->f_declarator = l6;
    l6 = (void*) _a11_obj;
    vader_array_t* _a12_arr = vader_array_new(8u, 0u, 0u, 190u);
    l11 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(147u, 2u, 13u, 1208u);
...
static void vader_c_emit_emit_vtable_dispatchers(void* l0, void* l1) {
    ...
    l6 = (size_t) 0;
    {
        loop_14: {
            if ((l6 < l5)) {
                ...
                vader_array_t* _a2_arr = vader_array_new(50u, 0u, 13u, 665u);
                l9 = (void*) _a2_arr;
                vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 193u);
                l10 = (void*) _a3_arr;
                ...
                l13 = (size_t) 0;
                {
                    loop_49: {
                        if ((l13 < l12)) {
                            ...
                            l21 = vader_c_emit_c_ast_verbatim(1876u);
                            ...
                            l25 = INT32_C(0);
                            {
                                loop_113: {
                                    if ((l25 < l24)) {
                                        ...
                                        l27 = (size_t) 0;
                                        l27 = std_core_write_string_at(l26, l27, 1013u);
                            ...
                            if (t7 == INT32_C(16)) {
                                ...
                                vader_obj_header_init(_a9_obj, 675u);
                                ...
                                l37 = (void*) _a11_obj;
                                vader_array_t* _a12_arr = vader_array_new(148u, 2u, 13u, 1210u);
                                ...
                                t8 = (void*) _a14_obj;
                                vader_array_t* _a15_arr = vader_array_new(148u, 1u, 13u, 1210u);
                            ...
                            vader_obj_header_init(_a16_obj, 665u);
                            _a16_obj->f_value = t4;
                            _a16_obj->f_body = l35;
                            l42 = (void*) _a16_obj;
                ...
                vader_obj_header_init(_a18_obj, 675u);
                _a18_obj->f_expression = t4;
                l45 = (void*) _a18_obj;
                t4 = vader_c_emit_c_ast_verbatim(1876u);
                ...
                vader_obj_header_init(_a19_obj, 688u);
                _a19_obj->f_base = t4;
                _a19_obj->f_member = 2053u;
                _a19_obj->f_arrow = false;
                l46 = (void*) _a19_obj;
                vader_array_t* _a20_arr = vader_array_new(148u, 1u, 13u, 1210u);
                ...
                t8 = (void*) _a21_obj;
                vader_array_t* _a22_arr = vader_array_new(146u, 1u, 13u, 1205u);
                ...
                vader_array_t* _a23_arr = vader_array_new(146u, 0u, 13u, 1205u);
                l51 = (void*) _a23_arr;
    ...
    vader_array_box_slots(_a26_arr->buf)[_a26_arr->offset + 0u] = vader_box_string(190u, 2338u);
    t8 = (void*) _a26_arr;
...
static void vader_c_emit_emit_vtable_forward_decls(void* l0, void* l1) {
    ...
    vader_array_box_slots(_a3_arr->buf)[_a3_arr->offset + 0u] = vader_box_string(190u, 2339u);
    t2 = (void*) _a3_arr;
    vader_struct_vader_c_emit_c_ast_CSection_t* _a4_obj = (vader_struct_vader_c_emit_c_ast_CSection_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CSection_t));
    vader_obj_header_init(_a4_obj, 697u);
...
static void* vader_c_emit_erased_parameters(size_t l0) {
    ...
    vader_struct_vader_c_emit_c_ast_CParameter_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CParameter_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CParameter_t));
    vader_obj_header_init(_a0_obj, 691u);
    _a0_obj->f_type = 2335u;
    _a0_obj->f_name = 1368u;
    t0 = (void*) _a0_obj;
...
static vader_box_t vader_c_emit_extern_decl(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(54u, 0u, 13u, 691u);
    l2 = (void*) _a0_arr;
...
static vader_string_t vader_c_emit_extern_parameter_type(void* l0, void* l1, size_t l2) {
    ...
    if (t0) {
        t1 = vader_c_emit_pointer_to(2334u, l3);
    ...
    if (t0) {
        { vader_gc_top = gc_frame.prev; return 2335u; }
    }
...
static void* vader_c_emit_find_erased_siblings(void* l0, int32_t l1) {
    ...
    if (l4.tag == 493u) {
        ...
        l6 = std_string_string_Contains_contains(t3, 732u);
        l7 = ((vader_array_t*) l0)->length;
        l8 = (size_t) 0;
        {
            loop_39: {
                    ...
                    if (t4.tag == 493u) {
                        ...
                        if (l10) {
                            ...
                            if (l6) {
                                ...
                                l13 = std_string_string_Contains_contains(t3, 732u);
                            } else {
                                l13 = false;
                            }
                            l9 = l13;
...
static vader_string_t vader_c_emit_float_lit(double l0) {
    ...
    if (l1 == 1788u) {
        { vader_gc_top = gc_frame.prev; return 738u; }
    }
    t0 = std_string_string_Contains_contains(l1, 258u);
    if (t0) {
        l2 = true;
    } else {
        l2 = std_string_string_Contains_contains(l1, 1348u);
    }
    if (l2) {
...
static void* vader_c_emit_forward_boxed(vader_string_t l0, void* l1, void* l2) {
    ...
    if (l4 == INT32_C(16)) {
        ...
        l6 = (void*) _a1_arr;
        vader_array_t* _a2_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l7 = (void*) _a2_arr;
        l8 = vader_c_emit_c_ast_call(2242u, l7);
        vader_struct_vader_c_emit_c_ast_CReturn_t* _a3_obj = (vader_struct_vader_c_emit_c_ast_CReturn_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CReturn_t));
        vader_obj_header_init(_a3_obj, 695u);
        _a3_obj->f_stores = l6;
        _a3_obj->f_value = l8;
        ...
        _a3_obj->f_pops_frame = false;
        l6 = (void*) _a3_obj;
        vader_array_t* _a4_arr = vader_array_new(146u, 2u, 13u, 1205u);
    ...
    t0 = (void*) _a6_obj;
    vader_array_t* _a7_arr = vader_array_new(146u, 1u, 13u, 1205u);
...
static void* vader_c_emit_forwarded_result(void* l0, void* l1, vader_box_t l2, bool l3) {
    ...
    vader_gc_top = &gc_frame;
    l4 = vader_c_emit_c_ast_verbatim(1865u);
    l5 = vader_c_emit_c_ast_verbatim(1837u);
    ...
    if (t2) {
        ...
        l9 = vader_c_emit_c_ast_declaration(2335u, 1865u, l2);
    ...
    if (t2) {
        ...
        l8 = vader_c_emit_c_ast_cast(1618u, l8);
        l8 = vader_c_emit_box_call(1557u, l6, l8);
        l9 = vader_c_emit_c_ast_declaration(1296u, 1865u, l2);
        l8 = vader_c_emit_null_or(l4, l8);
        l8 = vader_c_emit_c_ast_declaration(2245u, 1837u, l8);
    ...
    if (t0 == INT32_C(14)) {
        ...
        vader_obj_header_init(_a5_obj, 708u);
        _a5_obj->f_text = 490u;
        l10 = (void*) _a5_obj;
        ...
        l10 = (void*) _a6_obj;
        l8 = vader_c_emit_c_ast_declaration(1296u, 1865u, l2);
        l9 = vader_c_emit_c_ast_declaration(2308u, 1837u, vader_ref_box(l10));
    ...
    t4 = vader_c_emit_c_ast_declaration(t3, 1865u, l2);
...
static void* vader_c_emit_function_definition(void* l0, int32_t l1, void* l2) {
    ...
    if (l12) {
        ...
        vader_obj_header_init(_a3_obj, 708u);
        _a3_obj->f_text = 2282u;
        l6 = (void*) _a3_obj;
        ...
        vader_obj_header_init(_a4_obj, 708u);
        _a4_obj->f_text = 1510u;
        l27 = (void*) _a4_obj;
    ...
    vader_array_t* _a6_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l6 = (void*) _a6_arr;
    vader_array_t* _a7_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l27 = (void*) _a7_arr;
    vader_array_t* _a8_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l28 = (void*) _a8_arr;
    if (!(l3)) {
            ...
            loop_300: {
                if ((l10 < l9)) {
                    ...
                    if (((int32_t) t5.payload.i) == INT32_C(18)) {
                        ...
                        vader_obj_header_init(_a10_obj, 686u);
                        ...
                        if (((int32_t) t5.payload.i) == INT32_C(14)) {
                            ...
                            vader_obj_header_init(_a12_obj, 686u);
                            ...
                            if (t0) {
                                ...
                                vader_obj_header_init(_a14_obj, 686u);
    ...
    vader_array_t* _a15_arr = vader_array_new(146u, 0u, 13u, 1205u);
    l29 = (void*) _a15_arr;
    ...
    if (!(l3)) {
        ...
        if ((t6 > INT64_C(0))) {
            l11 = vader_c_emit_c_ast_array_declaration(2246u, 1512u, l6);
            vader_array_push((vader_array_t*) l29, l11);
        }
        t6 = ((vader_array_t*) l27)->length;
        if ((t6 > INT64_C(0))) {
            l11 = vader_c_emit_c_ast_array_declaration(2336u, 1511u, l27);
            vader_array_push((vader_array_t*) l29, l11);
        }
        t6 = ((vader_array_t*) l6)->length;
        if ((t6 > INT64_C(0))) {
        ...
        vader_array_t* _a16_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a16_arr;
        ...
        l16 = (size_t) 0;
        {
            loop_450: {
                if ((l16 < l10)) {
                    ...
                    l11 = vader_c_emit_c_ast_verbatim(2371u);
                    ...
                    l34 = vader_c_emit_c_ast_cast(2335u, l25);
        ...
        if ((l9 > INT64_C(0))) {
            l11 = vader_c_emit_c_ast_array_declaration(2335u, 1513u, l5);
            vader_array_push((vader_array_t*) l29, l11);
        }
        l10 = ((vader_array_t*) l28)->length;
        if ((l10 > INT64_C(0))) {
            l11 = vader_c_emit_c_ast_array_declaration(2309u, 1508u, l28);
            vader_array_push((vader_array_t*) l29, l11);
        }
        l11 = vader_c_emit_c_ast_verbatim(2282u);
        l5 = std_core_new_byte_buffer((size_t) 21);
        l16 = (size_t) 0;
        t6 = ((vader_array_t*) l6)->length;
        ...
        l16 = std_core_write_string_at(l5, l16, 2132u);
        ...
        vader_array_t* _a18_arr = vader_array_new(145u, 7u, 13u, 1201u);
        ...
        if ((l10 > INT64_C(0))) {
            ...
            l9 = std_core_write_string_at(l6, l9, 2132u);
            t4 = std_core_finish_buffer(l6, l9);
            l11 = vader_c_emit_c_ast_verbatim(t4);
            l13 = vader_c_emit_c_ast_verbatim(1508u);
            vader_array_t* _a19_arr = vader_array_new(145u, 2u, 13u, 1201u);
        ...
        vader_obj_header_init(_a20_obj, 684u);
        _a20_obj->f_elements = l5;
        l5 = (void*) _a20_obj;
        l11 = vader_c_emit_c_ast_declaration(2279u, 1509u, vader_ref_box(l5));
        vader_array_push((vader_array_t*) l29, l11);
        l11 = vader_c_emit_c_ast_verbatim(2282u);
        t5 = vader_c_emit_c_ast_verbatim(1509u);
    ...
    vader_obj_header_init(_a22_obj, 677u);
...
static vader_box_t vader_c_emit_gc_allocation(vader_string_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = concat_2(l0, 229u);
    t0 = concat_3(1930u, l0, 206u);
    t1 = vader_c_emit_c_ast_verbatim(t0);
    vader_array_t* _a0_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t1.payload.obj;
    l2 = (void*) _a0_arr;
    l3 = vader_c_emit_c_ast_call(2277u, l2);
...
static vader_box_t vader_c_emit_gc_statistic(vader_string_t l0) {
    ...
    vader_array_t* _a1_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l2 = (void*) _a1_arr;
    t0 = vader_c_emit_c_ast_call(2280u, l2);
    ...
    vader_obj_header_init(_a2_obj, 688u);
    _a2_obj->f_base = t0;
    _a2_obj->f_member = l0;
    _a2_obj->f_arrow = false;
    l2 = (void*) _a2_obj;
    l3 = vader_c_emit_c_ast_cast(1617u, vader_ref_box(l2));
    vader_struct_vader_c_emit_c_ast_CReturn_t* _a3_obj = (vader_struct_vader_c_emit_c_ast_CReturn_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CReturn_t));
    vader_obj_header_init(_a3_obj, 695u);
    _a3_obj->f_stores = l1;
    _a3_obj->f_value = l3;
...
static void* vader_c_emit_import_shim(void* l0, void* l1) {
    ...
    l5 = vader_c_emit_value_parameters(((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcImport_t*) l1)->f_signature)->f_params, 1013u);
    vader_struct_vader_c_emit_c_ast_CSignature_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CSignature_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CSignature_t));
    vader_obj_header_init(_a0_obj, 699u);
    ...
    _a1_obj->f_body = t1;
    l6 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(146u, 0u, 13u, 1205u);
    l7 = (void*) _a2_arr;
...
static void* vader_c_emit_include_of(vader_string_t l0) {
    ...
    if (l1) {
        l4 = std_string_starts_with(l0, 329u);
    } else {
        l4 = false;
    }
    if (l4) {
        l4 = std_string_ends_with(l0, 349u);
    } else {
        l4 = false;
    }
    if (l4) {
...
static vader_box_t vader_c_emit_info_row(size_t l0, void* l1) {
    ...
    l3 = (size_t) 0;
    l3 = std_core_write_string_at(l2, l3, 707u);
    t0 = ((int64_t) (size_t) l0);
    l4 = (uint64_t) (int64_t) t0;
    l3 = std_core_write_unsigned(l2, l3, l4);
    l3 = std_core_write_string_at(l2, l3, 711u);
    l5 = std_core_finish_buffer(l2, l3);
...
static void vader_c_emit_init_object_header(void* l0, vader_string_t l1, int32_t l2) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l3.payload.obj;
    l4 = (void*) _a0_arr;
    l3 = vader_c_emit_c_ast_call(2287u, l4);
    vader_c_emit_evaluate(l0, l3);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void* vader_c_emit_main_body(void* l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_c_emit_c_ast_verbatim(1063u);
    t0 = vader_c_emit_c_ast_cast(2334u, l2);
    vader_struct_vader_c_emit_c_ast_CExpressionStatement_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CExpressionStatement_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CExpressionStatement_t));
    vader_obj_header_init(_a0_obj, 675u);
    _a0_obj->f_expression = t0;
    l3 = (void*) _a0_obj;
    l2 = vader_c_emit_c_ast_verbatim(1066u);
    t0 = vader_c_emit_c_ast_cast(2334u, l2);
    vader_struct_vader_c_emit_c_ast_CExpressionStatement_t* _a1_obj = (vader_struct_vader_c_emit_c_ast_CExpressionStatement_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CExpressionStatement_t));
    vader_obj_header_init(_a1_obj, 675u);
    _a1_obj->f_expression = t0;
    l4 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(146u, 2u, 13u, 1205u);
    ((void**) _a2_arr->buf->slots)[_a2_arr->offset + 1u] = l4;
    ((void**) _a2_arr->buf->slots)[_a2_arr->offset + 0u] = l3;
    l3 = (void*) _a2_arr;
    ...
    l7 = t2 == INT64_C(1);
    l2 = vader_c_emit_c_ast_verbatim(2235u);
    l8 = vader_c_emit_c_ast_verbatim(677u);
    vader_array_t* _a6_arr = vader_array_new(145u, 2u, 13u, 1201u);
    ((void**) _a6_arr->buf->slots)[_a6_arr->offset + 1u] = l8.payload.obj;
    ((void**) _a6_arr->buf->slots)[_a6_arr->offset + 0u] = l2.payload.obj;
    l9 = (void*) _a6_arr;
    t0 = vader_c_emit_c_ast_perform(2237u, l9);
    vader_array_t* _a7_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if ((l6 > INT64_C(0))) {
        l2 = vader_c_emit_c_ast_verbatim(2282u);
        t0 = vader_c_emit_c_ast_verbatim(2284u);
        ...
        l2 = vader_c_emit_c_ast_verbatim(2283u);
        l8 = vader_c_emit_c_ast_unsigned(((int64_t) (size_t) l6));
        vader_array_t* _a9_arr = vader_array_new(145u, 2u, 13u, 1201u);
        ((void**) _a9_arr->buf->slots)[_a9_arr->offset + 1u] = l8.payload.obj;
        ((void**) _a9_arr->buf->slots)[_a9_arr->offset + 0u] = l2.payload.obj;
        l10 = (void*) _a9_arr;
        l2 = vader_c_emit_c_ast_perform(2239u, l10);
        vader_array_push((vader_array_t*) l9, l2);
    }
    t0 = vader_c_emit_c_ast_verbatim(2240u);
    vader_array_t* _a10_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ((void**) _a10_arr->buf->slots)[_a10_arr->offset + 0u] = t0.payload.obj;
    l10 = (void*) _a10_arr;
    l2 = vader_c_emit_c_ast_perform(1124u, l10);
    vader_array_push((vader_array_t*) l9, l2);
    t0 = vader_c_emit_c_ast_verbatim(2281u);
    vader_array_t* _a11_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ...
    if (l7) {
        ...
        l12 = (void*) _a15_arr;
        l2 = vader_c_emit_c_ast_call(2296u, l12);
        ...
        if (((int32_t) t0.payload.i) == INT32_C(18)) {
            l8 = vader_c_emit_c_ast_cast(2335u, l2);
            l8 = vader_c_emit_c_ast_declaration(2335u, 734u, l8);
            vader_array_push((vader_array_t*) l9, l8);
        } else {
            t0 = vader_c_emit_c_ast_unsigned(((int64_t) (int32_t) l11));
            vader_array_t* _a17_arr = vader_array_new(145u, 2u, 13u, 1201u);
            ((void**) _a17_arr->buf->slots)[_a17_arr->offset + 1u] = l2.payload.obj;
            ((void**) _a17_arr->buf->slots)[_a17_arr->offset + 0u] = t0.payload.obj;
            l12 = (void*) _a17_arr;
            l2 = vader_c_emit_c_ast_call(2243u, l12);
            l2 = vader_c_emit_c_ast_declaration(2245u, 734u, l2);
            vader_array_push((vader_array_t*) l9, l2);
        }
        l2 = vader_c_emit_c_ast_verbatim(734u);
    ...
    if (t6 == INT32_C(16)) {
        ...
        l3 = (void*) _a21_arr;
        l2 = vader_c_emit_c_ast_cast(1615u, l2);
...
static void* vader_c_emit_new_fn_state(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(146u, 0u, 13u, 1205u);
    t0 = (void*) _a0_arr;
    vader_struct_vader_c_emit_c_ast_CBlock_t* _a1_obj = (vader_struct_vader_c_emit_c_ast_CBlock_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CBlock_t));
    vader_obj_header_init(_a1_obj, 663u);
    _a1_obj->f_body = t0;
    l2 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(144u, 0u, 13u, 1200u);
    l3 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(55u, 0u, 13u, 705u);
    l4 = (void*) _a3_arr;
    ...
    l10 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(149u, 0u, 13u, 1212u);
    l11 = (void*) _a10_arr;
...
static vader_box_t vader_c_emit_null_or(vader_box_t l0, vader_box_t l1) {
    ...
    vader_array_t* _a1_arr = vader_array_new(145u, 0u, 13u, 1201u);
    l2 = (void*) _a1_arr;
    l4 = vader_c_emit_c_ast_call(2242u, l2);
...
static vader_box_t vader_c_emit_object_header(vader_box_t l0) {
    ...
    _a3_obj->f_text = 490u;
    l4 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(145u, 5u, 13u, 1201u);
...
static vader_box_t vader_c_emit_object_pointer(vader_box_t l0, uint8_t l1) {
    ...
    if (l1 == INT32_C(18)) {
        ...
        l2 = vader_c_emit_payload(l0, 1816u);
    }
    { vader_box_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static void vader_c_emit_open_else(void* l0) {
    ...
    l1 = l3.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(146u, 0u, 13u, 1205u);
    t2 = (void*) _a1_arr;
...
static vader_string_t vader_c_emit_out_param_name(size_t l0) {
    ...
    l2 = (size_t) 0;
    l2 = std_core_write_string_at(l1, l2, 750u);
    t0 = ((int64_t) (size_t) l0);
    l3 = (uint64_t) (int64_t) t0;
    l2 = std_core_write_unsigned(l1, l2, l3);
    t1 = std_core_finish_buffer(l1, l2);
...
static vader_box_t vader_c_emit_pc_capacity(int32_t l0) {
    ...
    _a2_obj->f_parts = t1;
    l3 = (void*) _a2_obj;
    l2 = vader_c_emit_pc_header(l0, 1696u);
    ...
    l2 = vader_c_emit_c_ast_verbatim(287u);
    l2 = vader_c_emit_c_ast_cast(1928u, l2);
...
static void vader_c_emit_pc_emit_preheader(void* l0, void* l1) {
    ...
    l4 = (size_t) 0;
    l4 = std_core_write_string_at(l3, l4, 765u);
    ...
    vader_c_emit_declare(l0, 2233u, l6, l7);
    l3 = std_core_new_byte_buffer((size_t) 27);
    l4 = (size_t) 0;
    l4 = std_core_write_string_at(l3, l4, 765u);
    l5 = ((int64_t) (int32_t) l2);
    l4 = std_core_write_int(l3, l4, l5);
    l4 = std_core_write_string_at(l3, l4, 763u);
    l6 = std_core_finish_buffer(l3, l4);
    l7 = vader_c_emit_pc_header(l2, 1696u);
    vader_c_emit_declare(l0, 1928u, l6, l7);
    l3 = std_core_new_byte_buffer((size_t) 27);
    l4 = (size_t) 0;
    l4 = std_core_write_string_at(l3, l4, 765u);
    l5 = ((int64_t) (int32_t) l2);
    l4 = std_core_write_int(l3, l4, l5);
    l4 = std_core_write_string_at(l3, l4, 757u);
    l6 = std_core_finish_buffer(l3, l4);
    ...
    l5 = ((int64_t) (int32_t) l2);
    l4 = std_core_write_int(l3, l4, l5);
    l4 = std_core_write_string_at(l3, l4, 767u);
    l6 = std_core_finish_buffer(l3, l4);
    l7 = vader_c_emit_pc_header(l2, 1164u);
    vader_c_emit_declare(l0, 2335u, l6, l7);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_pc_emit_push(void* l0, void* l1, vader_box_t l2, vader_box_t l3) {
    ...
    l9 = concat_2(l8, 229u);
    l5 = vader_c_emit_pc_local(l4, 1936u);
    ...
    vader_array_t* _a5_arr = vader_array_new(145u, 2u, 13u, 1201u);
    ...
    vader_c_emit_evaluate(l0, l5);
    l5 = vader_c_emit_pc_local(l4, 1528u);
...
static void vader_c_emit_pc_emit_writeback(void* l0, int32_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 1u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l2 = vader_c_emit_pc_header(l1, 1696u);
    l3 = vader_c_emit_pc_local(l1, 1695u);
...
static vader_box_t vader_c_emit_pc_local(int32_t l0, vader_string_t l1) {
    ...
    l3 = (size_t) 0;
    l3 = std_core_write_string_at(l4, l3, 765u);
...
static void vader_c_emit_pc_reload(void* l0, int32_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 1u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l2 = vader_c_emit_pc_local(l1, 1695u);
    l3 = vader_c_emit_pc_header(l1, 1696u);
    vader_c_emit_assign(l0, l2, l3);
    l2 = vader_c_emit_pc_local(l1, 1242u);
    l3 = vader_c_emit_pc_capacity(l1);
    vader_c_emit_assign(l0, l2, l3);
    l2 = vader_c_emit_pc_local(l1, 1936u);
...
static vader_box_t vader_c_emit_push_helper_for(uint8_t l0) {
    ...
    if (l1) {
        ...
        if (l1) {
            ...
            l2 = vader_box_string(190u, 2216u);
        } else if (l0 == INT32_C(1)) {
            ...
            l2 = vader_box_string(190u, 2215u);
        } else {
            if (l0 == INT32_C(13)) {
                l1 = true;
            } else {
    ...
    l10 = (size_t) 0;
    {
        loop_16: {
            if ((l10 < l9)) {
                ...
                ((void**) _a2_arr->buf->slots)[_a2_arr->offset + 0u] = t3.payload.obj;
                l21 = (void*) _a2_arr;
                l22 = vader_c_emit_c_ast_call(1929u, l21);
                l23 = ((vader_struct_vader_bytecode_BcField_t*) l11)->f_name;
                l24 = concat_2(1443u, l23);
                t3 = vader_c_emit_null_member(l4, l24);
                vader_array_t* _a3_arr = vader_array_new(145u, 1u, 13u, 1201u);
                ((void**) _a3_arr->buf->slots)[_a3_arr->offset + 0u] = t3.payload.obj;
                l25 = (void*) _a3_arr;
                l26 = vader_c_emit_c_ast_call(1929u, l25);
                ...
                l32 = (void*) _a4_arr;
                l33 = vader_c_emit_c_ast_call(739u, l32);
...
static void vader_c_emit_push_object(void* l0, vader_box_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 2u, 1u, gc_roots, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    l2 = vader_c_emit_c_ast_cast(2335u, l1);
    vader_c_emit_push_into_temporary(l0, l2, (uint8_t) 18);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void vader_c_emit_push_pool_array(void* l0, void* l1, vader_string_t l2, uint8_t l3, void* l4) {
    ...
    l11 = (size_t) 0;
    l11 = std_core_write_string_at(l13, l11, 2032u);
    ...
    l11 = std_core_write_string_at(l13, l11, 715u);
    l9 = std_core_finish_buffer(l13, l11);
    t3 = vader_c_emit_c_ast_verbatim(683u);
    ...
    _a2_obj->f_unsigned_v = true;
    l20 = (void*) _a2_obj;
    vader_array_t* _a3_arr = vader_array_new(145u, 3u, 13u, 1201u);
    ...
    vader_array_t* _a4_arr = vader_array_new(145u, 7u, 13u, 1201u);
    ...
    vader_obj_header_init(_a7_obj, 689u);
    _a7_obj->f_value = INT64_C(0);
    _a7_obj->f_unsigned_v = true;
    l13 = (void*) _a7_obj;
    t3 = vader_c_emit_c_ast_verbatim(l6);
    l17 = vader_c_emit_c_ast_address_of(t3);
    l17 = vader_c_emit_c_ast_cast(2206u, l17);
    vader_array_t* _a8_arr = vader_array_new(145u, 5u, 13u, 1201u);
    ...
    vader_obj_header_init(_a10_obj, 679u);
    _a10_obj->f_storage = l7;
    _a10_obj->f_constant = l8;
    _a10_obj->f_type = 2232u;
...
static void vader_c_emit_push_struct_field(void* l0, int32_t l1, int32_t l2, vader_box_t l3, uint8_t l4) {
    ...
    if (l7.tag == 493u) {
        ...
        l6 = (size_t) 0;
        l6 = std_core_write_string_at(l5, l6, 2029u);
...
static vader_box_t vader_c_emit_ref_box(vader_box_t l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l0.payload.obj;
    l1 = (void*) _a0_arr;
    t0 = vader_c_emit_c_ast_call(2295u, l1);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static vader_string_t vader_c_emit_resolve_array_local(void* l0, vader_box_t l1, bool l2) {
    ...
    l7 = vader_c_emit_aux(l0, 1935u);
    vader_c_emit_declare(l0, 2233u, l7, l1);
    t3 = vader_c_emit_c_ast_verbatim(l7);
    vader_array_t* _a1_arr = vader_array_new(145u, 1u, 13u, 1201u);
    ((void**) _a1_arr->buf->slots)[_a1_arr->offset + 0u] = t3.payload.obj;
    l3 = (void*) _a1_arr;
    vader_c_emit_statement_macro(l0, 674u, l3);
    l3 = ((vader_struct_vader_c_emit_FnState_t*) l0)->f_resolved_arrays;
...
static void* vader_c_emit_shim_body(void* l0, void* l1) {
    ...
    if (l4 == INT32_C(19)) {
        ...
        ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = l2.payload.obj;
        l5 = (void*) _a0_arr;
        t1 = vader_c_emit_c_ast_perform(2291u, l5);
        vader_array_t* _a1_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if (l4 == INT32_C(1)) {
        ...
        vader_array_t* _a3_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if (l4 == INT32_C(2)) {
        ...
        l5 = (void*) _a4_arr;
        t1 = vader_c_emit_c_ast_returning(2302u, l5);
        vader_array_t* _a5_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if (l4 == INT32_C(3)) {
        ...
        if ((l6 < INT32_C(0))) {
            ...
            vader_array_t* _a8_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ...
        if ((l7 < INT32_C(0))) {
            ...
            vader_array_t* _a9_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ...
        t2 = (void*) _a12_obj;
        vader_array_t* _a13_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a13_arr->buf->slots)[_a13_arr->offset + 0u] = t2;
        t2 = (void*) _a13_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(4)) {
        t1 = vader_c_emit_c_ast_cast(2233u, l2);
        vader_array_t* _a14_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a14_arr->buf->slots)[_a14_arr->offset + 0u] = t1.payload.obj;
        l5 = (void*) _a14_arr;
        t1 = vader_c_emit_c_ast_returning(2301u, l5);
        vader_array_t* _a15_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a15_arr->buf->slots)[_a15_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a15_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(6)) {
        vader_array_t* _a16_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a16_arr->buf->slots)[_a16_arr->offset + 0u] = l2.payload.obj;
        l5 = (void*) _a16_arr;
        t1 = vader_c_emit_c_ast_returning(2306u, l5);
        vader_array_t* _a17_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a17_arr->buf->slots)[_a17_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a17_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(12)) {
        vader_array_t* _a18_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a18_arr;
        t1 = vader_c_emit_c_ast_perform(2278u, l5);
        vader_array_t* _a19_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a19_arr->buf->slots)[_a19_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a19_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(13)) {
        t1 = vader_c_emit_gc_statistic(2086u);
        vader_array_t* _a20_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if (l4 == INT32_C(14)) {
        ...
        vader_array_t* _a21_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a21_arr->buf->slots)[_a21_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a21_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(15)) {
        t1 = vader_c_emit_gc_statistic(2087u);
        vader_array_t* _a22_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    if (l4 == INT32_C(16)) {
        vader_array_t* _a23_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a23_arr;
        t1 = vader_c_emit_c_ast_returning(2298u, l5);
        vader_array_t* _a24_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a24_arr->buf->slots)[_a24_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a24_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(17)) {
        vader_array_t* _a25_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a25_arr->buf->slots)[_a25_arr->offset + 0u] = l2.payload.obj;
        l5 = (void*) _a25_arr;
        t1 = vader_c_emit_c_ast_perform(2297u, l5);
        vader_array_t* _a26_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a26_arr->buf->slots)[_a26_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a26_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(18)) {
        vader_array_t* _a27_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a27_arr;
        t1 = vader_c_emit_c_ast_returning(2299u, l5);
        vader_array_t* _a28_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a28_arr->buf->slots)[_a28_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a28_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(22)) {
        vader_array_t* _a29_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a29_arr->buf->slots)[_a29_arr->offset + 0u] = l2.payload.obj;
        l5 = (void*) _a29_arr;
        l8 = vader_c_emit_c_ast_call(2310u, l5);
        l8 = vader_c_emit_c_ast_declaration(1296u, 1204u, l8);
        t1 = vader_c_emit_c_ast_verbatim(1204u);
        vader_array_t* _a30_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a30_arr->buf->slots)[_a30_arr->offset + 0u] = t1.payload.obj;
        l5 = (void*) _a30_arr;
        l9 = vader_c_emit_c_ast_call(2268u, l5);
        l9 = vader_c_emit_c_ast_declaration(2335u, 1865u, l9);
        l10 = vader_c_emit_c_ast_verbatim(1204u);
        vader_array_t* _a31_arr = vader_array_new(145u, 2u, 13u, 1201u);
        ((void**) _a31_arr->buf->slots)[_a31_arr->offset + 1u] = l10.payload.obj;
        ((void**) _a31_arr->buf->slots)[_a31_arr->offset + 0u] = l2.payload.obj;
        l5 = (void*) _a31_arr;
        l10 = vader_c_emit_c_ast_perform(2260u, l5);
        vader_array_t* _a32_arr = vader_array_new(49u, 0u, 13u, 661u);
        l5 = (void*) _a32_arr;
        t1 = vader_c_emit_c_ast_verbatim(1865u);
        ...
        l5 = (void*) _a33_obj;
        vader_array_t* _a34_arr = vader_array_new(146u, 4u, 13u, 1205u);
    ...
    if (l4 == INT32_C(23)) {
        ...
        vader_array_t* _a35_arr = vader_array_new(145u, 2u, 13u, 1201u);
        ((void**) _a35_arr->buf->slots)[_a35_arr->offset + 1u] = l9.payload.obj;
        ((void**) _a35_arr->buf->slots)[_a35_arr->offset + 0u] = l8.payload.obj;
        l5 = (void*) _a35_arr;
        l8 = vader_c_emit_c_ast_call(2269u, l5);
        vader_array_t* _a36_arr = vader_array_new(145u, 1u, 13u, 1201u);
        ((void**) _a36_arr->buf->slots)[_a36_arr->offset + 0u] = l3.payload.obj;
        l5 = (void*) _a36_arr;
        l9 = vader_c_emit_c_ast_call(2310u, l5);
        l9 = vader_c_emit_c_ast_declaration(1296u, 1205u, l9);
        l8 = vader_c_emit_c_ast_declaration(2335u, 1865u, l8);
        l10 = vader_c_emit_c_ast_verbatim(1205u);
        vader_array_t* _a37_arr = vader_array_new(145u, 2u, 13u, 1201u);
        ...
        l5 = (void*) _a39_obj;
        vader_array_t* _a40_arr = vader_array_new(146u, 4u, 13u, 1205u);
    ...
    if (l4 == INT32_C(24)) {
        ...
        l3 = vader_c_emit_c_ast_cast(2233u, l3);
        l8 = vader_c_emit_argument((size_t) 2);
        l8 = vader_c_emit_c_ast_cast(2233u, l8);
        l9 = vader_c_emit_argument((size_t) 3);
        vader_array_t* _a41_arr = vader_array_new(145u, 4u, 13u, 1201u);
        ...
        l5 = (void*) _a41_arr;
        t1 = vader_c_emit_c_ast_returning(2266u, l5);
        vader_array_t* _a42_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a42_arr->buf->slots)[_a42_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a42_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(20)) {
        vader_array_t* _a43_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a43_arr;
        t1 = vader_c_emit_c_ast_returning(2262u, l5);
        vader_array_t* _a44_arr = vader_array_new(146u, 1u, 13u, 1205u);
        ((void**) _a44_arr->buf->slots)[_a44_arr->offset + 0u] = t1.payload.obj;
        t2 = (void*) _a44_arr;
        { void* __vret = t2; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l4 == INT32_C(21)) {
        vader_array_t* _a45_arr = vader_array_new(145u, 0u, 13u, 1201u);
        l5 = (void*) _a45_arr;
        t1 = vader_c_emit_c_ast_returning(2261u, l5);
        vader_array_t* _a46_arr = vader_array_new(146u, 1u, 13u, 1205u);
    ...
    t0 = concat_2(2164u, l13);
    t1 = vader_c_emit_trap(t0);
    vader_array_t* _a47_arr = vader_array_new(146u, 1u, 13u, 1205u);
...
static void* vader_c_emit_signature_for(void* l0, int32_t l1) {
    ...
    VADER_ARRAY_CHECK_INDEX(_a0_slotarr, l3)
    l2 = vader_array_ref_load_obj(_a0_slotarr->buf, _a0_slotarr->offset + (size_t) l3);
    l4 = vader_c_emit_value_parameters(((vader_struct_vader_bytecode_BcSignature_t*) ((vader_struct_vader_bytecode_BcFunction_t*) l2)->f_signature)->f_params, 1689u);
...
static vader_box_t vader_c_emit_single_offset_list(vader_string_t l0, vader_string_t l1) {
    ...
    vader_obj_header_init(_a0_obj, 707u);
    l2 = (void*) _a0_obj;
    ...
    vader_obj_header_init(_a3_obj, 679u);
    _a3_obj->f_storage = (uint8_t) 0;
    _a3_obj->f_constant = true;
    _a3_obj->f_type = 2157u;
...
static vader_box_t vader_c_emit_size_as_address(vader_box_t l0) {
    ...
    vader_gc_top = &gc_frame;
    l1 = vader_c_emit_c_ast_cast(2161u, l0);
    t0 = vader_c_emit_c_ast_cast(2335u, l1);
    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static vader_box_t vader_c_emit_slot_index(vader_string_t l0, vader_box_t l1) {
    ...
    l3 = vader_c_emit_c_ast_cast(1928u, l3);
...
static void vader_c_emit_statement_macro(void* l0, vader_string_t l1, void* l2) {
    ...
    vader_obj_header_init(_a1_obj, 687u);
    _a1_obj->f_call = t0;
    l3 = (void*) _a1_obj;
    vader_c_emit_append_statement(l0, vader_ref_box(l3));
    { vader_gc_top = gc_frame.prev; return; }
...
static void* vader_c_emit_struct_definition(void* l0, void* l1, size_t l2) {
    ...
    _a0_obj->f_type = 2288u;
    _a0_obj->f_name = 1529u;
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(52u, 1u, 13u, 676u);
    ...
    l6 = (size_t) 0;
    {
        loop_12: {
            if ((l6 < l5)) {
                ...
                vader_obj_header_init(_a4_obj, 676u);
                _a4_obj->f_type = l10;
                _a4_obj->f_name = l12;
                l13 = (void*) _a4_obj;
    ...
    vader_obj_header_init(_a6_obj, 702u);
    _a6_obj->f_name = t4;
    _a6_obj->f_fields = l3;
    t0 = (void*) _a6_obj;
    { void* __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_c_emit_struct_field_init(void* l0, void* l1, vader_box_t l2, vader_string_t l3, int32_t l4, void* l5) {
    ...
    if (t4 == INT32_C(18)) {
        ...
        t1 = vader_c_emit_c_ast_cast(2335u, l11);
        { vader_box_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    l11 = l2;
    l11 = vader_c_emit_emit_data_value(l0, l1, l11, l3, l5);
...
static vader_box_t vader_c_emit_struct_info_row(void* l0, void* l1, void* l2, size_t l3) {
    ...
    vader_gc_top = &gc_frame;
    l4 = vader_c_emit_c_ast_verbatim(685u);
    ...
    vader_c_emit_push_offset_list(l8, 1860u, l9);
    l9 = ((vader_struct_vader_c_emit_StructOffsets_t*) l2)->f_str_offsets;
    vader_c_emit_push_offset_list(l8, 2008u, l9);
    l9 = ((vader_struct_vader_c_emit_StructOffsets_t*) l2)->f_ref_offsets;
    vader_c_emit_push_offset_list(l8, 1878u, l9);
...
static vader_box_t vader_c_emit_tag_expression(vader_box_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l1 == INT32_C(18)) {
        l2 = vader_c_emit_c_ast_pointer_member(2290u, l0, 2122u);
    } else {
        vader_struct_vader_c_emit_c_ast_CMember_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CMember_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CMember_t));
        vader_obj_header_init(_a0_obj, 688u);
        _a0_obj->f_base = l0;
        _a0_obj->f_member = 2053u;
        _a0_obj->f_arrow = false;
        t0 = (void*) _a0_obj;
        l2 = vader_ref_box(t0);
    }
...
static vader_box_t vader_c_emit_trap(vader_string_t l0) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t1.payload.obj;
    l1 = (void*) _a0_arr;
    t1 = vader_c_emit_c_ast_perform(2312u, l1);
    { vader_box_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static vader_box_t vader_c_emit_unbox_expr(vader_box_t l0, uint8_t l1) {
    ...
    vader_gc_top = &gc_frame;
    if (l1 == INT32_C(0)) {
        l2 = vader_c_emit_payload_cast(1619u, l0, 1533u);
    } else if (l1 == INT32_C(1)) {
        l2 = vader_c_emit_payload_cast(1616u, l0, 1533u);
    } else if (l1 == INT32_C(2)) {
        l2 = vader_c_emit_payload_cast(1617u, l0, 1533u);
    } else if (l1 == INT32_C(3)) {
        l2 = vader_c_emit_payload_cast(1618u, l0, 1533u);
    } else if (l1 == INT32_C(5)) {
        l2 = vader_c_emit_payload_cast(2160u, l0, 1533u);
    } else if (l1 == INT32_C(6)) {
        l2 = vader_c_emit_payload_cast(2157u, l0, 1533u);
    } else if (l1 == INT32_C(7)) {
        l2 = vader_c_emit_payload_cast(2158u, l0, 1533u);
    } else if (l1 == INT32_C(8)) {
        l2 = vader_c_emit_payload_cast(2159u, l0, 1533u);
    } else if (l1 == INT32_C(9)) {
        l2 = vader_c_emit_payload_cast(1928u, l0, 1533u);
    } else if (l1 == INT32_C(4)) {
        l2 = vader_c_emit_payload_cast(1861u, l0, 1533u);
    } else if (l1 == INT32_C(13)) {
        l2 = vader_c_emit_payload_cast(2158u, l0, 1533u);
    } else if (l1 == INT32_C(10)) {
        l2 = vader_c_emit_payload_cast(1478u, l0, 1424u);
    } else if (l1 == INT32_C(11)) {
        l2 = vader_c_emit_payload_cast(1339u, l0, 1424u);
    } else if (l1 == INT32_C(12)) {
        l2 = vader_c_emit_payload(l0, 1129u);
    } else if (l1 == INT32_C(14)) {
        l2 = vader_c_emit_payload(l0, 1906u);
    } else if (l1 == INT32_C(15)) {
        l2 = l0;
    } else if (l1 == INT32_C(16)) {
        l2 = vader_c_emit_c_ast_verbatim(196u);
    } else if (l1 == INT32_C(17)) {
        l3 = vader_c_emit_payload(l0, 1533u);
        l3 = vader_c_emit_c_ast_cast(1633u, l3);
        t0 = vader_c_emit_c_ast_cast(2335u, l3);
        vader_struct_vader_c_emit_c_ast_CParenthesized_t* _a0_obj = (vader_struct_vader_c_emit_c_ast_CParenthesized_t*) vader_gc_alloc(sizeof(vader_struct_vader_c_emit_c_ast_CParenthesized_t));
        vader_obj_header_init(_a0_obj, 692u);
        _a0_obj->f_inner = t0;
        t1 = (void*) _a0_obj;
...
static void* vader_c_emit_unit_names_of(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(8u, 1u, 0u, 190u);
    vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 0u] = vader_box_string(190u, 761u);
    l2 = (void*) _a0_arr;
...
static void vader_c_emit_unreachable(void* l0, vader_string_t l1) {
    ...
    ((void**) _a0_arr->buf->slots)[_a0_arr->offset + 0u] = t1.payload.obj;
    l2 = (void*) _a0_arr;
    l3 = vader_c_emit_c_ast_call(2316u, l2);
    vader_c_emit_evaluate(l0, l3);
    { vader_gc_top = gc_frame.prev; return; }
}
...
static void* vader_c_emit_user_extern_shim(void* l0, void* l1) {
        ...
        loop_18: {
            if ((l9 < l8)) {
                ...
                if (t0) {
                    ...
                    vader_obj_header_init(_a7_obj, 688u);
                    _a7_obj->f_base = t1;
                    _a7_obj->f_member = 1860u;
                    _a7_obj->f_arrow = false;
                    l22 = (void*) _a7_obj;
                    t0 = vader_c_emit_param_is_mutable(l2, l9);
                    if (t0) {
                        l23 = vader_c_emit_c_ast_cast(2335u, vader_ref_box(l22));
                    } else {
                    ...
                    if (t3 != 0u) {
                        ...
                        l32 = (size_t) 0;
                        l32 = std_core_write_string_at(l31, l32, 1839u);
                        t2 = ((int64_t) (size_t) l9);
                        ...
                        l37 = (size_t) 0;
                        l37 = std_core_write_string_at(l36, l37, 1839u);
                        t2 = ((int64_t) (size_t) l9);
                        l38 = (uint64_t) (int64_t) t2;
                        l37 = std_core_write_unsigned(l36, l37, l38);
                        l39 = std_core_finish_buffer(l36, l37);
                        t1 = vader_c_emit_c_ast_number(INT64_C(0));
                        vader_array_t* _a13_arr = vader_array_new(145u, 1u, 13u, 1201u);
                        ...
                        if (t0) {
                            ...
                            l46 = (size_t) 0;
                            l46 = std_core_write_string_at(l45, l46, 1839u);
                            t2 = ((int64_t) (size_t) l9);
                            ...
                            l51 = (size_t) 0;
                            l51 = std_core_write_string_at(l50, l51, 1839u);
                            t2 = ((int64_t) (size_t) l9);
                            ...
                            l54 = vader_c_emit_c_ast_cast(2335u, l53);
                            ...
                            if (t0) {
                                ...
                                vader_obj_header_init(_a16_obj, 688u);
                                _a16_obj->f_base = l10;
                                _a16_obj->f_member = 2053u;
                                _a16_obj->f_arrow = false;
                                l56 = (void*) _a16_obj;
                                l57 = vader_c_emit_c_ast_verbatim(676u);
                                ...
                                vader_obj_header_init(_a17_obj, 688u);
                                _a17_obj->f_base = l10;
                                _a17_obj->f_member = 1848u;
                                ...
                                vader_obj_header_init(_a18_obj, 688u);
                                _a18_obj->f_base = vader_ref_box(t4);
                                _a18_obj->f_member = 1533u;
                                ...
                                vader_obj_header_init(_a19_obj, 708u);
                                _a19_obj->f_text = 490u;
                                l60 = (void*) _a19_obj;
                                l61 = vader_c_emit_c_ast_cast(1633u, vader_ref_box(l59));
                                l62 = vader_c_emit_c_ast_cast(2335u, l61);
                                ...
                                if (((int32_t) t1.payload.i) == INT32_C(14)) {
                                    ...
                                    vader_array_t* _a22_arr = vader_array_new(145u, 1u, 13u, 1201u);
                                    ((void**) _a22_arr->buf->slots)[_a22_arr->offset + 0u] = l10.payload.obj;
                                    l77 = (void*) _a22_arr;
                                    l78 = vader_c_emit_c_ast_call(2310u, l77);
    ...
    vader_array_t* _a24_arr = vader_array_new(146u, 0u, 13u, 1205u);
    l12 = (void*) _a24_arr;
    t5 = ((vader_array_t*) l7)->length;
    if ((t5 > INT64_C(0))) {
        t5 = ((vader_array_t*) l7)->length;
        l10 = vader_c_emit_c_ast_number(((int64_t) (size_t) t5));
        l13 = vader_c_emit_c_ast_array_declaration(2336u, 753u, l7);
        vader_array_push((vader_array_t*) l4, l13);
        l13 = vader_c_emit_c_ast_verbatim(752u);
        l18 = vader_c_emit_c_ast_verbatim(753u);
        vader_array_t* _a25_arr = vader_array_new(145u, 3u, 13u, 1201u);
        ...
        l7 = (void*) _a25_arr;
        l10 = vader_c_emit_c_ast_perform(679u, l7);
        vader_array_push((vader_array_t*) l4, l10);
        vader_array_t* _a26_arr = vader_array_new(145u, 1u, 13u, 1201u);
...
static vader_string_t vader_c_emit_vtable_helper_name(vader_string_t l0) {
    ...
    t1 = std_string_join(t0, 731u);
    l1 = vader_c_emit_sanitise(t1);
    t1 = concat_2(2320u, l1);
    { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
}
...
static void vader_c_emit_write_barrier(void* l0, vader_box_t l1) {
    ...
    l2 = (void*) _a0_arr;
    l3 = vader_c_emit_c_ast_call(686u, l2);
    vader_c_emit_evaluate(l0, l3);
    { vader_gc_top = gc_frame.prev; return; }
}
