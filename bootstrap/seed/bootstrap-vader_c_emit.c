...
static vader_string_t vader_c_emit_box_slot_c(void* l0, void* l1, vader_box_t l2, vader_string_t l3, int32_t l4, void* l5) {
    ...
    if (l2.tag == 510u) {
        ...
        l8 = std_core_write_string_at(l7, l8, 2401u);
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    l8 = std_core_write_string_at(l6, l8, 2401u);
    l9 = ((int64_t) (int32_t) l4);
...
static vader_string_t vader_c_emit_dispatcher_formal(void* l0) {
    ...
    _a1_obj->f_parts = t0;
    l1 = (void*) _a1_obj;
    std_string_builder_append(l1, 2318u);
...
static void vader_c_emit_emit_agg_data_entry(void* l0, size_t l1, void* l2, int32_t l3, int32_t l4, void* l5, void* l6) {
    ...
    std_string_builder_append(l0, l17);
    std_string_builder_append(l0, 2413u);
...
static void vader_c_emit_emit_buffer_to_string(void* l0) {
    ...
    l3 = vader_c_emit_name_of(l1);
    l2 = concat_5(2321u, l2, 374u, l3, 326u);
...
static void vader_c_emit_emit_buffer_write_string(void* l0) {
    ...
    l8 = vader_c_emit_name_of(l2);
    l5 = concat_7(2331u, l7, 374u, l8, 370u, l5, 353u);
    vader_c_emit_line(l0, l5);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static void vader_c_emit_emit_call_indirect(void* l0, void* l1) {
    ...
    if (l4.tag == 496u) {
        ...
        l9 = concat_5(2337u, l8, 66u, l9, 494u);
        vader_c_emit_line(l0, l9);
        if (l6 == INT32_C(0)) {
            l9 = concat_2(l8, 401u);
        } else {
        ...
        loop_92: {
            if ((l5 < l4)) {
                ...
                if (l13) {
                    ...
                    l7 = ((int32_t) (size_t) l5);
                    l8 = vader_c_emit_tramp_key(l3, l7);
                    l9 = concat_5(2319u, l8, 287u, l6, 354u);
                    std_string_builder_append(l1, l9);
                } else {
                }
                t4 = (l5 + INT64_C(1));
...
static void vader_c_emit_emit_closure_lift(void* l0, void* l1, int32_t l2) {
    ...
    l6 = concat_6(t1, 2319u, l5, 287u, l6, 341u);
...
static vader_string_t vader_c_emit_emit_data_value(void* l0, void* l1, vader_box_t l2, vader_string_t l3, void* l4) {
    ...
    if (l2.tag == 511u) {
        ...
        l10 = (size_t) (int64_t) INT64_C(0);
        l10 = std_core_write_string_at(l9, l10, 2401u);
...
static void vader_c_emit_emit_end(void* l0, int32_t l1) {
    ...
    if (l6.tag == 663u) {
        ...
        if (t0) {
            ...
            l3 = (size_t) (int64_t) INT64_C(0);
            l3 = std_core_write_string_at(l7, l3, 2412u);
...
static void vader_c_emit_emit_fn_ref_tramp(void* l0, void* l1, int32_t l2, int32_t l3) {
    ...
    l8 = concat_6(l7, 2320u, l6, 287u, l8, 341u);
    std_string_builder_append(l1, l8);
...
static void vader_c_emit_emit_global_const_roots(void* l0, void* l1) {
    ...
    l3 = (size_t) (int64_t) INT64_C(0);
    l3 = std_core_write_string_at(l5, l3, 2402u);
    t0 = ((vader_array_t*) l2)->length;
    t1 = ((int64_t) (size_t) t0);
...
static void vader_c_emit_emit_memory_copy(void* l0) {
    ...
    l8 = vader_c_emit_name_of(l2);
    l9 = vader_c_emit_name_of(l1);
    l5 = concat_11(2326u, l5, 374u, l6, 370u, l7, 374u, l8, 374u, l9, 353u);
    vader_c_emit_line(l0, l5);
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
}
...
static void vader_c_emit_emit_op(void* l0, int32_t l1, vader_box_t l2) {
    ...
    if (l2.tag == 560u) {
        vader_c_emit_push_unop(l0, 2414u, (uint8_t) (int32_t) INT32_C(2));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 559u) {
    ...
    if (l2.tag == 561u) {
        vader_c_emit_push_binop(l0, 2407u, (uint8_t) (int32_t) INT32_C(2));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 562u) {
    ...
    if (l2.tag == 581u) {
        vader_c_emit_push_binop(l0, 2407u, (uint8_t) (int32_t) INT32_C(3));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 582u) {
    ...
    if (l2.tag == 580u) {
        vader_c_emit_push_unop(l0, 2414u, (uint8_t) (int32_t) INT32_C(3));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 594u) {
    ...
    if (l2.tag == 520u) {
        vader_c_emit_push_binop(l0, 2408u, (uint8_t) (int32_t) INT32_C(12));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 630u) {
    ...
    if (l2.tag == 602u) {
        vader_c_emit_emit_buffer_load(l0, 2324u, (uint8_t) (int32_t) INT32_C(3));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 600u) {
        vader_c_emit_emit_buffer_load(l0, 2322u, (uint8_t) (int32_t) INT32_C(11));
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 628u) {
    ...
    if (l2.tag == 623u) {
        vader_c_emit_emit_buffer_store(l0, 2328u, 313u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 624u) {
        vader_c_emit_emit_buffer_store(l0, 2329u, 315u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 622u) {
        vader_c_emit_emit_buffer_store(l0, 2327u, 312u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l2.tag == 175u) {
...
static void vader_c_emit_emit_return(void* l0) {
    ...
    if (t1) {
        ...
        l2 = concat_5(2401u, l6, 90u, l2, 497u);
        vader_c_emit_line(l0, l2);
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
...
static void vader_c_emit_emit_string_slice(void* l0) {
    ...
    l5 = vader_c_emit_name_of(l1);
    l3 = concat_7(2347u, l3, 370u, l4, 370u, l5, 326u);
...
static vader_string_t vader_c_emit_erased_sig_params(int32_t l0) {
    ...
    _a1_obj->f_parts = t0;
    l1 = (void*) _a1_obj;
    std_string_builder_append(l1, 2372u);
    l2 = INT32_C(0);
    {
        loop_8: {
            if ((l2 < l0)) {
                ...
                if (t0) {
                    ...
                    if (t1 != 0u) {
                        ...
                        if (t0) {
                            ...
                            if (t0) {
                                vader_array_push((vader_array_t*) l2, vader_box_string(164u, 2371u));
                            } else {
...
static vader_string_t vader_c_emit_io_err_shim(vader_string_t l0, vader_string_t l1, void* l2) {
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    l6 = std_core_write_string_at(l7, l6, 2317u);
    ...
    vader_array_box_slots(_a0_arr->buf)[_a0_arr->offset + 6u] = vader_box_string(164u, 2409u);
...
static vader_string_t vader_c_emit_struct_field_init(void* l0, void* l1, vader_box_t l2, vader_string_t l3, int32_t l4, void* l5) {
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    l11 = std_core_write_string_at(l6, l11, 2401u);
        ...
        loop_16: {
            if ((l9 < l8)) {
                ...
                if (t0) {
                    ...
                    l12 = (size_t) (int64_t) INT64_C(0);
                    l12 = std_core_write_string_at(l11, l12, 2346u);
                    ...
                    if (t2 != 0u) {
                        ...
                        if (t0) {
                            ...
                            if (t0) {
                                ...
                                l86 = std_core_write_string_at(l85, l86, 2374u);
                                t1 = ((int64_t) (size_t) l9);
