        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1138u);
...
void* vader_resolver_build_core_seed(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    l4 = std_collections_get__string__Any(((vader_struct_vader_resolver_LoadedProject_t*) l0)->f_modules, 501u);
    if (l4.tag == 867u) {
        t0 = l4.payload.obj;
...
static void* vader_resolver_build_subst(void* l0, void* l1) {
    ...
    vader_resolver_bind_1(l2, 728u, l3);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 415u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(909u, l19, 951u, l20, l17);
...
static void vader_resolver_check_orphan_rule(void* l0, vader_string_t l1, void* l2, void* l3, void* l4, void* l5) {
    ...
    if (l8) {
        ...
        l12 = concat_4(l12, 110u, l13, 238u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 909u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 989u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 408u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1451u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(909u, l4, 956u, l3, 239u, l10, 1018u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 418u);
    if (t0) {
        l6 = true;
    } else {
        l6 = std_string_starts_with(l0, 415u);
    }
    if (l6) {
        l7 = concat_3(909u, l0, 909u);
    ...
    t0 = std_string_starts_with(l0, 2284u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2284u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(909u, l2, 969u, l0, 1003u, 2142u, 972u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(909u, l0, 1000u, l7, 251u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 1985u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 1984u);
                }
                if (l8) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 1988u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 1987u);
                }
                if (l8) {
                    t0 = vader_box_string(162u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2282u);
...
static vader_string_t vader_resolver_join_path(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL };
    vader_gc_top = &gc_frame;
    l2 = std_string_trim_prefix(l1, 418u);
    if (l0 == 0u) {
        { vader_string_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(1991u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    std_collections_put__string__string(l10, 502u, l9);
    vader_array_t* _a9_arr = vader_array_new(8u, 1u, 0u, 162u);
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(162u, 502u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 162u) {
        ...
        if (l23.tag == 861u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(1987u, l31, l22, l11);
            if (l35.tag == 861u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(1990u, l31, l22, l11);
            if (l39.tag == 861u) {
                l40 = l39.payload.obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_21: {
            if ((l5 < l4)) {
                ...
                l6 = t0.payload.s;
                l3 = vader_resolver_symbol_make(l0, INT32_C(12), l6, 503u, (uint8_t) (int32_t) INT32_C(0), vader_box_obj(0u, NULL));
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 1989u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1752u, 1989u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 162u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1752u;
            l8 = vader_resolver_origin_of_root(1752u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 162u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2282u);
    ...
    if (l3.tag == 277u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1662u);
        if (l3.tag == 272u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 415u) {
                                ...
                                l21 = concat_5(909u, l19, 937u, l20, 921u);
                                l22 = concat_2(1716u, l15);
...
static vader_string_t vader_resolver_span_origin(void* l0) {
    ...
    l2 = std_core_write_string_at(l3, l2, 461u);
                    ...
                    if (l5.tag == 861u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(909u, l15, 942u, l10, 1028u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 162u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(909u, l21, 934u, l25, 909u);
