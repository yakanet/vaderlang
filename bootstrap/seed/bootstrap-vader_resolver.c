                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 417u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(931u, l19, 975u, l20, l17);
...
static void vader_resolver_check_orphan_rule(void* l0, vader_string_t l1, void* l2, void* l3, void* l4, void* l5) {
    ...
    if (l8) {
        ...
        l12 = concat_4(l12, 117u, l13, 240u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1014u);
        ...
        l3 = std_core_write_string_at(l8, l3, 383u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(931u, l4, 980u, l3, 241u, l10, 1043u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(931u, l2, 994u, l0, 1028u, 2168u, 997u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(931u, l0, 1025u, l7, 253u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static vader_string_t vader_resolver_entry_folder_of(vader_string_t l0) {
    ...
    if (l2 == 0u) {
        { vader_gc_top = gc_frame.prev; return 424u; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2026u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 163u) {
        ...
        if (l23.tag == 863u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2022u, l31, l22, l11);
            if (l35.tag == 863u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2025u, l31, l22, l11);
            if (l39.tag == 863u) {
                l40 = l39.payload.obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2024u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1786u, 2024u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 279u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1696u);
        if (l3.tag == 274u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 417u) {
                                ...
                                l21 = concat_5(931u, l19, 961u, l20, 943u);
                    ...
                    if (l5.tag == 863u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(931u, l15, 966u, l10, 1053u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 163u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(931u, l21, 958u, l25, 931u);
