        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1167u);
...
void* vader_resolver_build_core_seed(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    l4 = std_collections_get__string__Any(((vader_struct_vader_resolver_LoadedProject_t*) l0)->f_modules, 497u);
    if (l4.tag == 873u) {
        t0 = l4.payload.obj;
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 418u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(918u, l19, 967u, l20, l17);
...
static void vader_resolver_check_orphan_rule(void* l0, vader_string_t l1, void* l2, void* l3, void* l4, void* l5) {
    ...
    if (l8) {
        ...
        l12 = concat_4(l12, 115u, l13, 214u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2124u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 960u);
                    ...
                    l20 = concat_3(918u, l7, 955u);
                    l21 = concat_3(l19, l20, 1377u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 411u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1485u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(918u, l4, 972u, l3, 215u, l10, 1042u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 409u);
    if (t0) {
        l6 = true;
    } else {
        l6 = std_string_starts_with(l0, 406u);
    }
    if (l6) {
    ...
    t0 = std_string_starts_with(l0, 2272u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2272u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(918u, l2, 987u, l0, 1026u, 2132u, 990u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(918u, l0, 1023u, l7, 227u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static vader_string_t vader_resolver_entry_folder_of(vader_string_t l0) {
    ...
    if (l2 == 0u) {
        { vader_gc_top = gc_frame.prev; return 403u; }
    }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2270u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static vader_string_t vader_resolver_join_path(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = std_string_trim_prefix(l1, 409u);
    if (l0 == 0u) {
        { vader_string_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    std_collections_put__string__string(l10, 498u, l9);
    vader_array_t* _a9_arr = vader_array_new(8u, 1u, 0u, 166u);
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(166u, 498u);
    l11 = (void*) _a9_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_21: {
            if ((l5 < l4)) {
                ...
                l6 = t0.payload.s;
                l3 = vader_resolver_symbol_make(l0, INT32_C(12), l6, 499u, 499u, (uint8_t) (int32_t) INT32_C(0), vader_box_obj(0u, NULL));
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1785u, 2014u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 166u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1785u;
            l8 = vader_resolver_origin_of_root(1785u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 166u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2270u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 418u) {
                                ...
                                l21 = concat_5(918u, l19, 951u, l20, 931u);
                                l22 = concat_2(1749u, l15);
                    ...
                    if (l5.tag == 867u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(918u, l15, 956u, l10, 1052u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 166u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(918u, l21, 947u, l25, 918u);
