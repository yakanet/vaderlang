        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) t0)->f_op == INT32_C(18)) {
            ...
            if (t1 != 0u) {
                if (l2) {
                    ...
                    l5 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l5, 1240u);
...
static void* vader_resolver_build_subst(void* l0, void* l1) {
    ...
    vader_resolver_bind_1(l2, 754u, l3);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 426u) {
                                ...
                                if (!(l13.tag == 0u)) {
                                    ...
                                    l20 = concat_5(974u, l18, 1027u, l19, l16);
                                        ...
                                        if ((l15 < l14)) {
                                            ...
                                            if (!(l32.tag == 0u)) {
                                                ...
                                                if (t2) {
                                                    ...
                                                    l33 = concat_5(974u, l36, 1052u, l37, 1077u);
                                                } else {
                                                    t0 = l10.payload.obj;
                                                    ...
                                                    l33 = concat_6(974u, l38, 986u, l39, 991u, l40);
                                                }
                                                t0 = l10.payload.obj;
                                                ...
                                                loop_70: {
                                                    if ((l15 < l14)) {
                                                        ...
                                                        if (l16.tag == 419u) {
                                                            ...
                                                            l22 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l21, 1207u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 974u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 1075u);
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2238u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 419u) {
                    ...
                    l13 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l12, 1571u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(974u, l4, 1033u, l3, 236u, l10, 1107u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2388u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2388u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_5(974u, l2, 1050u, l0, 1091u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(974u, l0, 1089u, l7, 250u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_18: {
            t1 = vader_resolver_join_path(l1, 2386u);
            t0 = std_io_exists(t1);
            if (t0) {
...
static vader_string_t vader_resolver_generated_root_for(vader_box_t l0) {
    ...
    l1 = vader_resolver_join_path(l1, 1361u);
    t0 = std_io_is_dir(l1);
    if (!(t0)) {
...
static vader_box_t vader_resolver_home_root(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_std_env_get_env(846u);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2124u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l18.tag == 0u) {
        ...
        t1 = concat_3(1978u, l13, 1007u);
        l6 = concat_2(t1, 1229u);
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2122u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1880u, 2122u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l10.tag == 0u) {
        l8 = vader_resolver_origin_of_root(1880u);
        l4 = vader_resolver_plain_root(1880u, l8);
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    }
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 176u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2386u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 283u) {
        t1 = l3.payload.obj;
        l3 = std_collections_MutableMap_Index_at__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1787u);
        if (l3.tag == 278u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 426u) {
                                ...
                                l20 = concat_5(974u, l18, 1010u, l19, 989u);
                                l21 = concat_2(1844u, l14);
                    ...
                    if (l11.tag == 872u) {
                        ...
                        if (t5 == 0u) {
                            ...
                            if (l16 != l17) {
                                ...
                                l21 = concat_5(974u, l19, 997u, l20, 1080u);
                    ...
                    if (l10.tag == 878u) {
                        ...
                        if (l12.tag == 0u) {
                            ...
                            if (t3 == INT32_C(1)) {
                                ...
                                l15 = concat_5(974u, l14, 1015u, l9, 1118u);
            ...
            if (l18.tag == 0u) {
                ...
                if (l18.tag == 176u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(974u, l21, 1005u, l25, 974u);
