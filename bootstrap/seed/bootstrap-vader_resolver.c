        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1164u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 416u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(921u, l19, 967u, l20, l17);
...
static void vader_resolver_check_orphan_rule(void* l0, vader_string_t l1, void* l2, void* l3, void* l4, void* l5) {
    ...
    if (l8) {
        ...
        l12 = concat_4(l12, 115u, l13, 228u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 921u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 1006u);
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2142u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 409u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1481u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(921u, l4, 972u, l3, 229u, l10, 1035u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2292u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2292u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(921u, l2, 986u, l0, 1020u, 2150u, 989u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(921u, l0, 1017u, l7, 241u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2013u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2012u);
                }
                if (l8) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2016u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2015u);
                }
                if (l8) {
                    t0 = vader_box_string(164u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2290u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static vader_box_t vader_resolver_home_root(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_std_env_get_env(821u);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2019u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(164u, 505u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 164u) {
        ...
        if (l23.tag == 863u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2015u, l31, l22, l11);
            if (l35.tag == 863u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2018u, l31, l22, l11);
            if (l39.tag == 863u) {
                l40 = l39.payload.obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2017u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1779u, 2017u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 164u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1779u;
            l8 = vader_resolver_origin_of_root(1779u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 164u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2290u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 274u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1690u);
        if (l3.tag == 269u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 416u) {
                                ...
                                l21 = concat_5(921u, l19, 953u, l20, 933u);
                                l22 = concat_2(1743u, l15);
                    ...
                    if (l5.tag == 863u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(921u, l15, 958u, l10, 1045u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 164u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(921u, l21, 950u, l25, 921u);
