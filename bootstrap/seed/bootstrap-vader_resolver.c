...
void* vader_resolver_build_core_seed(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    l4 = std_collections_get__string__Any(((vader_struct_vader_resolver_LoadedProject_t*) l0)->f_modules, 516u);
    if (l4.tag == 869u) {
        t0 = l4.payload.obj;
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 417u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(928u, l19, 972u, l20, l17);
...
static void vader_resolver_check_orphan_rule(void* l0, vader_string_t l1, void* l2, void* l3, void* l4, void* l5) {
    ...
    if (l8) {
        ...
        l12 = concat_4(l12, 115u, l13, 245u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 928u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 1011u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(928u, l4, 977u, l3, 246u, l10, 1040u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (t0) {
        ...
        l6 = std_string_starts_with(l0, 427u);
    }
    if (l6) {
        l7 = concat_3(928u, l0, 928u);
    ...
    t0 = std_string_starts_with(l0, 2317u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2317u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(928u, l2, 991u, l0, 1025u, 2175u, 994u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(928u, l0, 1022u, l7, 258u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static vader_string_t vader_resolver_entry_folder_of(vader_string_t l0) {
    ...
    if (l2 == 0u) {
        { vader_gc_top = gc_frame.prev; return 425u; }
    }
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2017u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2016u);
                }
                if (l8) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2020u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2019u);
                }
                if (l8) {
                    t0 = vader_box_string(163u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2315u);
...
static vader_string_t vader_resolver_join_path(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = std_string_trim_prefix(l1, 430u);
    if (l0 == 0u) {
        { vader_string_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2023u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    std_collections_put__string__string(l10, 517u, l9);
    vader_array_t* _a9_arr = vader_array_new(8u, 1u, 0u, 163u);
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(163u, 517u);
    l11 = (void*) _a9_arr;
    ...
    _a10_obj->f_name = 2024u;
    _a10_obj->f_folder = 516u;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 163u) {
        ...
        if (l23.tag == 863u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2019u, l31, l22, l11);
            if (l35.tag == 863u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2022u, l31, l22, l11);
            if (l39.tag == 863u) {
                l40 = l39.payload.obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_21: {
            if ((l5 < l4)) {
                ...
                l6 = t0.payload.s;
                l3 = vader_resolver_symbol_make(l0, INT32_C(12), l6, 518u, 518u, (uint8_t) (int32_t) INT32_C(0), vader_box_obj(0u, NULL));
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2021u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1783u, 2021u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 163u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1783u;
            l8 = vader_resolver_origin_of_root(1783u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 163u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2315u);
    ...
    if (l3.tag == 279u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1693u);
        if (l3.tag == 274u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 417u) {
                                ...
                                l21 = concat_5(928u, l19, 958u, l20, 940u);
                                l22 = concat_2(1747u, l15);
...
static vader_box_t vader_resolver_scan_folder(vader_string_t l0, void* l1) {
    ...
    if (l2.tag == 8u) {
        ...
        vader_struct___lambda_env_3010_t* _a0_obj = (vader_struct___lambda_env_3010_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3010_t));
    ...
    if (l2.tag == 384u) {
        ...
        vader_struct___lambda_env_3010_t* _a8_obj = (vader_struct___lambda_env_3010_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3010_t));
...
static void* vader_resolver_sort_by_name(void* l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 3u, NULL, gc_raw_roots, 0u, NULL };
    vader_gc_top = &gc_frame;
    vader_struct___lambda_env_2008_t* _a0_obj = (vader_struct___lambda_env_2008_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_2008_t));
...
static vader_string_t vader_resolver_span_origin(void* l0) {
    ...
    l2 = std_core_write_string_at(l3, l2, 476u);
                    ...
                    if (l5.tag == 863u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(928u, l15, 963u, l10, 1050u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 163u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(928u, l21, 955u, l25, 928u);
