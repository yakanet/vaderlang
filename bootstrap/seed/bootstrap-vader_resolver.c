        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) t0)->f_op == INT32_C(18)) {
            ...
            if (t1 != 0u) {
                if (l2) {
                    ...
                    l5 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l5, 1242u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 389u) {
                                ...
                                if (!(l13.tag == 0u)) {
                                    ...
                                    l20 = concat_5(976u, l18, 1029u, l19, l16);
                                        ...
                                        if ((l15 < l14)) {
                                            ...
                                            if (!(l32.tag == 0u)) {
                                                ...
                                                if (t2) {
                                                    ...
                                                    l33 = concat_5(976u, l36, 1054u, l37, 1079u);
                                                } else {
                                                    t0 = l10.payload.obj;
                                                    ...
                                                    l33 = concat_6(976u, l38, 988u, l39, 993u, l40);
                                                }
                                                t0 = l10.payload.obj;
                                                ...
                                                loop_70: {
                                                    if ((l15 < l14)) {
                                                        ...
                                                        if (l16.tag == 382u) {
                                                            ...
                                                            l22 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l21, 1209u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 976u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 1077u);
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2241u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 382u) {
                    ...
                    l13 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l12, 1573u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(976u, l4, 1035u, l3, 236u, l10, 1109u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2391u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2391u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_5(976u, l2, 1052u, l0, 1093u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(976u, l0, 1091u, l7, 250u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
vader_box_t vader_resolver_find_async_module_id(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            ...
            t2 = (l5 + INT64_C(1));
            l5 = (size_t) (int64_t) t2;
            t3 = std_string_ends_with(l7, 2120u);
            if (t3) {
                l8 = true;
            } else {
                l8 = std_string_ends_with(l7, 2119u);
            }
            if (l8) {
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_18: {
            t1 = vader_resolver_join_path(l1, 2389u);
            t0 = std_io_exists(t1);
            if (t0) {
...
static vader_string_t vader_resolver_generated_root_for(vader_box_t l0) {
    ...
    l1 = vader_resolver_join_path(l1, 1363u);
    t0 = std_io_is_dir(l1);
    if (!(t0)) {
...
static vader_box_t vader_resolver_home_root(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_std_env_get_env(848u);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2126u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l18.tag == 0u) {
        ...
        t1 = concat_3(1980u, l13, 1009u);
        l6 = concat_2(t1, 1231u);
    ...
    if (l18.tag == 842u) {
        ...
        l16 = (void*) _a13_arr;
        l19 = vader_resolver_resolve_lazy(2122u, l12, l15, l11);
        if (l19.tag == 842u) {
            t0 = l19.payload.obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2124u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1882u, 2124u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l10.tag == 0u) {
        l8 = vader_resolver_origin_of_root(1882u);
        l4 = vader_resolver_plain_root(1882u, l8);
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    }
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 176u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2389u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 247u) {
        t1 = l3.payload.obj;
        l3 = std_collections_MutableMap_Index_at__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1789u);
        if (l3.tag == 242u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 389u) {
                                ...
                                l20 = concat_5(976u, l18, 1012u, l19, 991u);
                                l21 = concat_2(1846u, l14);
                    ...
                    if (l11.tag == 836u) {
                        ...
                        if (t5 == 0u) {
                            ...
                            if (l16 != l17) {
                                ...
                                l21 = concat_5(976u, l19, 999u, l20, 1082u);
                    ...
                    if (l10.tag == 842u) {
                        ...
                        if (l12.tag == 0u) {
                            ...
                            if (t3 == INT32_C(1)) {
                                ...
                                l15 = concat_5(976u, l14, 1017u, l9, 1120u);
            ...
            if (l17.tag == 0u) {
                ...
                if (l17.tag == 176u) {
                    ...
                    if (l21.tag == 0u) {
                        ...
                        l25 = concat_5(976u, l20, 1007u, l24, 976u);
