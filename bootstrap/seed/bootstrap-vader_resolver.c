...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 881u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(89u, 1u, 13u, 881u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(89u, 1u, 13u, 881u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2140u);
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(82u, 1u, 13u, 863u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(51u, 0u, 13u, 693u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(84u, 0u, 13u, 867u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2290u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2290u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(920u, l2, 985u, l0, 1019u, 2148u, 988u);
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(51u, 0u, 13u, 693u);
    l4 = (void*) _a1_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2014u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2013u);
                }
                if (l8) {
                    t0 = vader_box_string(163u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2288u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(84u, 1u, 13u, 867u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 401u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2017u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(81u, 1u, 13u, 862u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_obj_header_init(_a4_obj, 314u);
    _a4_obj->f_ekeys = l10;
    _a4_obj->f_evals = l11;
    _a4_obj->f_index = l12;
    _a4_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    _a4_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l10 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(51u, 0u, 13u, 693u);
    l11 = (void*) _a5_arr;
    ...
    if (l7.tag == 163u) {
        ...
        vader_obj_header_init(_a9_obj, 314u);
        _a9_obj->f_ekeys = l16;
        _a9_obj->f_evals = l17;
        _a9_obj->f_index = l18;
        _a9_obj->f_mask = l19;
        ...
        if (l23.tag == 862u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2013u, l31, l22, l11);
            if (l35.tag == 862u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2016u, l31, l22, l11);
            if (l39.tag == 862u) {
                l40 = l39.payload.obj;
                l41 = ((vader_struct_vader_resolver_DiscoveredModule_t*) l40)->f_folder;
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(81u, 1u, 13u, 862u);
    ...
    if (l7.tag == 0u) {
        ...
        if (l23.tag == 862u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(81u, 1u, 13u, 862u);
            ...
            if (l39.tag == 862u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(81u, 1u, 13u, 862u);
...
static void* vader_resolver_new_scope(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(17u, 1u, 13u, 349u);
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2015u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(87u, 0u, 13u, 876u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void vader_resolver_pop(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(17u, 0u, 13u, 349u);
    l2 = (void*) _a0_arr;
    t0 = (l1 - INT64_C(1));
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(84u, 0u, 13u, 867u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
    ...
    l10 = vader_resolver_sidecar_root(1778u, 2015u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 163u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2288u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a11_obj, 276u);
    ...
    vader_obj_header_init(_a15_obj, 276u);
    ...
    vader_obj_header_init(_a19_obj, 308u);
    ...
    vader_obj_header_init(_a23_obj, 292u);
    ...
    vader_obj_header_init(_a27_obj, 292u);
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(51u, 0u, 13u, 693u);
    l9 = (void*) _a16_arr;
...
static vader_box_t vader_resolver_scan_folder(vader_string_t l0, void* l1) {
    ...
    if (l2.tag == 8u) {
        ...
        vader_obj_header_init(_a0_obj, 258u);
        t1 = (void*) _a0_obj;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_obj_header_init(_a11_obj, 357u);
    _a11_obj->f_ekeys = l5;
    _a11_obj->f_evals = l6;
    _a11_obj->f_index = l7;
    _a11_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_array_t* _a15_arr = vader_array_new(87u, 0u, 13u, 876u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(112u, 0u, 13u, 1034u);
                l13 = (void*) _a17_arr;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 392u || l0.tag == 398u || l0.tag == 414u || l0.tag == 430u || l0.tag == 443u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 442u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 437u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(28u, 0u, 13u, 436u);
        l3 = (void*) _a14_arr;
    ...
    if (l0.tag == 459u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(118u, 0u, 13u, 1069u);
        l3 = (void*) _a18_arr;
    ...
    if (l0.tag == 452u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(111u, 0u, 13u, 1026u);
        l3 = (void*) _a23_arr;
    ...
    if (l0.tag == 388u) {
        ...
        vader_obj_header_init(_a27_obj, 388u);
        _a27_obj->f_span = l3;
    ...
    if (l0.tag == 431u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(111u, 0u, 13u, 1026u);
        l3 = (void*) _a29_arr;
    ...
    if (l0.tag == 454u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(117u, 0u, 13u, 1068u);
        l3 = (void*) _a33_arr;
    ...
    if (l0.tag == 433u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(25u, 0u, 13u, 416u);
        l3 = (void*) _a38_arr;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 452u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(111u, 0u, 13u, 1026u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 419u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(111u, 0u, 13u, 1026u);
        l5 = (void*) _a10_arr;
