...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l12.tag == 0u) {
        l11 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l8 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a0_arr = vader_array_new(89u, 1u, 13u, 890u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 472u) {
        vader_array_t* _a1_arr = vader_array_new(118u, 0u, 13u, 1080u);
        l1 = (void*) _a1_arr;
        t0 = l0.payload.obj;
        l3 = ((vader_struct_toolchain_ast_TupleBinding_t*) t0)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(82u, 1u, 13u, 872u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(51u, 0u, 13u, 701u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(84u, 0u, 13u, 876u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(931u, l2, 1001u, l0, 1041u, 2166u, 1004u);
...
static vader_string_t vader_resolver_for_type_display_name(vader_box_t l0) {
    ...
    if (l0.tag == 426u) {
        t0 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) t0)->f_callee.tag == 427u) {
            t0 = l0.payload.obj;
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(84u, 1u, 13u, 876u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 408u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(81u, 1u, 13u, 871u);
    ...
    t0 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(81u, 1u, 13u, 871u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 169u) {
        ...
        if (l7.tag == 0u) {
            ...
            vader_obj_header_init(_a7_obj, 879u);
    ...
    if (l18.tag == 871u) {
        ...
        vader_array_t* _a13_arr = vader_array_new(81u, 1u, 13u, 871u);
        ...
        if (l19.tag == 871u) {
            ...
            if (!(t2)) {
                t0 = l19.payload.obj;
                vader_array_t* _a14_arr = vader_array_new(81u, 1u, 13u, 871u);
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(87u, 0u, 13u, 885u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(84u, 0u, 13u, 876u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 280u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1722u);
        if (l3.tag == 275u) {
            t1 = l3.payload.obj;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(51u, 0u, 13u, 701u);
    l9 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a17_obj, 881u);
    ...
    vader_obj_header_init(_a19_obj, 882u);
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(87u, 0u, 13u, 885u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_319: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(114u, 0u, 13u, 1048u);
                l15 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a19_obj, 454u);
                _a19_obj->f_file = l21;
                _a19_obj->f_span = l29;
                _a19_obj->f_id = l16;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 400u || l0.tag == 405u || l0.tag == 421u || l0.tag == 437u || l0.tag == 450u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 449u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 403u) {
        vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 402u);
        l2 = (void*) _a1_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 397u) {
        ...
        vader_obj_header_init(_a8_obj, 397u);
        _a8_obj->f_span = l2;
    ...
    if (l0.tag == 444u) {
        vader_array_t* _a12_arr = vader_array_new(28u, 0u, 13u, 443u);
        l2 = (void*) _a12_arr;
        t0 = l0.payload.obj;
        ...
        l7 = (size_t) (int64_t) INT64_C(0);
        {
            loop_353: {
                if ((l7 < l6)) {
                    ...
                    vader_obj_header_init(_a14_obj, 443u);
                    _a14_obj->f_span = l9;
        ...
        vader_obj_header_init(_a15_obj, 444u);
        _a15_obj->f_span = l5;
    ...
    if (l0.tag == 466u) {
        vader_array_t* _a16_arr = vader_array_new(120u, 0u, 13u, 1083u);
        l2 = (void*) _a16_arr;
        t0 = l0.payload.obj;
            ...
            loop_459: {
                if ((l7 < l6)) {
                    ...
                    if (l3.tag == 467u) {
                        ...
                        vader_obj_header_init(_a18_obj, 467u);
                        _a18_obj->f_span = l8;
                        ...
                        if (l3.tag == 468u) {
                            ...
                            vader_obj_header_init(_a19_obj, 468u);
                            _a19_obj->f_span = l16;
    ...
    if (l0.tag == 459u) {
        vader_array_t* _a21_arr = vader_array_new(113u, 0u, 13u, 1040u);
        l2 = (void*) _a21_arr;
        t0 = l0.payload.obj;
        ...
        vader_obj_header_init(_a23_obj, 459u);
    ...
    if (l0.tag == 455u) {
        ...
        vader_obj_header_init(_a24_obj, 455u);
        _a24_obj->f_span = l2;
    ...
    if (l0.tag == 396u) {
        ...
        vader_obj_header_init(_a25_obj, 396u);
        _a25_obj->f_span = l2;
    ...
    if (l0.tag == 404u) {
        ...
        vader_obj_header_init(_a26_obj, 404u);
        _a26_obj->f_span = l2;
    ...
    if (l0.tag == 438u) {
        vader_array_t* _a27_arr = vader_array_new(113u, 0u, 13u, 1040u);
        l2 = (void*) _a27_arr;
        t0 = l0.payload.obj;
        ...
        vader_obj_header_init(_a29_obj, 438u);
        _a29_obj->f_span = l5;
    ...
    if (l0.tag == 415u) {
        ...
        vader_obj_header_init(_a30_obj, 415u);
        _a30_obj->f_span = l2;
    ...
    if (l0.tag == 461u) {
        vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1082u);
        l2 = (void*) _a31_arr;
        t0 = l0.payload.obj;
            ...
            loop_768: {
                if ((l7 < l6)) {
                    ...
                    if (l3.tag == 463u) {
                        ...
                        vader_obj_header_init(_a33_obj, 463u);
                        ...
                        if (l3.tag == 462u) {
                            ...
                            vader_obj_header_init(_a34_obj, 462u);
                            _a34_obj->f_expr = l4;
                            _a34_obj->f_span = l11;
        ...
        vader_obj_header_init(_a35_obj, 461u);
    ...
    if (l0.tag == 440u) {
        vader_array_t* _a36_arr = vader_array_new(25u, 0u, 13u, 423u);
        l2 = (void*) _a36_arr;
        t0 = l0.payload.obj;
        ...
        l7 = (size_t) (int64_t) INT64_C(0);
        {
            loop_852: {
                if ((l7 < l6)) {
                    ...
                    vader_obj_header_init(_a38_obj, 423u);
                    _a38_obj->f_span = l9;
        ...
        vader_obj_header_init(_a39_obj, 440u);
        _a39_obj->f_span = l5;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 423u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 459u) {
        vader_array_t* _a7_arr = vader_array_new(113u, 0u, 13u, 1040u);
        l4 = (void*) _a7_arr;
        t0 = l0.payload.obj;
        ...
        vader_obj_header_init(_a9_obj, 459u);
    ...
    if (l0.tag == 426u) {
        vader_array_t* _a10_arr = vader_array_new(113u, 0u, 13u, 1040u);
        l4 = (void*) _a10_arr;
        t0 = l0.payload.obj;
                    ...
                    if (l1.tag == 476u) {
                        ...
                        if (l1.tag == 397u) {
                            ...
                            if (l1.tag == 449u) {
                                ...
                                if ((l4.tag == 401u || l4.tag == 407u || l4.tag == 458u)) {
                                    l9 = l4;
                                    vader_resolver_walk_stmt(l0, l9);
                                } else {
                                    if ((l4.tag == 393u || l4.tag == 396u || l4.tag == 397u || l4.tag == 399u || l4.tag == 400u || l4.tag == 403u || l4.tag == 404u || l4.tag == 405u || l4.tag == 415u || l4.tag == 420u || l4.tag == 421u || l4.tag == 424u || l4.tag == 426u || l4.tag == 427u || l4.tag == 430u || l4.tag == 435u || l4.tag == 437u || l4.tag == 438u || l4.tag == 440u || l4.tag == 444u || l4.tag == 446u || l4.tag == 449u || l4.tag == 450u || l4.tag == 455u || l4.tag == 459u || l4.tag == 461u || l4.tag == 466u || l4.tag == 476u)) {
                                        vader_resolver_walk_expr(l0, l4);
                                    } else {
                                        { vader_gc_top = gc_frame.prev; return; }
                                    }
