...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2240u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2390u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2390u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_18: {
            t1 = vader_resolver_join_path(l1, 2388u);
            t0 = std_io_exists(t1);
            if (t0) {
...
static void* vader_resolver_new_scope(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(18u, 1u, 13u, 360u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 176u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2388u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    vader_obj_header_init(_a21_obj, 384u);
    _a21_obj->f_inner = t0;
    l10 = (void*) _a21_obj;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_obj_header_init(_a7_obj, 364u);
    _a7_obj->f_ekeys = l4;
    _a7_obj->f_evals = l5;
    _a7_obj->f_index = l6;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_240: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a17_obj, 242u);
                _a17_obj->f__0 = l9;
                _a17_obj->f__1 = l4;
                l13 = (void*) _a17_obj;
            ...
            if (l18.tag == 0u) {
                ...
                if (l18.tag == 176u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(976u, l21, 1007u, l25, 976u);
