        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1177u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 419u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(924u, l19, 973u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1017u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1922u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 412u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1496u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(924u, l4, 978u, l3, 217u, l10, 1049u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 469u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(117u, 0u, 13u, 1073u);
        l2 = (void*) _a1_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(924u, l2, 993u, l0, 1033u, 2144u, 996u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(924u, l0, 1030u, l7, 229u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2025u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2024u);
                }
                if (l8) {
                    t0 = vader_box_string(167u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2028u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 167u) {
        ...
        if (l23.tag == 868u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2024u, l31, l22, l11);
            if (l35.tag == 868u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2027u, l31, l22, l11);
            if (l39.tag == 868u) {
                l40 = l39.payload.obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2026u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1797u, 2026u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 167u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1797u;
            l8 = vader_resolver_origin_of_root(1797u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 278u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1709u);
        if (l3.tag == 273u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 419u) {
                                ...
                                l21 = concat_5(924u, l19, 957u, l20, 937u);
                                l22 = concat_2(1761u, l15);
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 463u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(119u, 0u, 13u, 1076u);
        l3 = (void*) _a18_arr;
    ...
    if (l0.tag == 458u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(118u, 0u, 13u, 1075u);
        l3 = (void*) _a33_arr;
                    ...
                    if (l5.tag == 868u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(924u, l15, 962u, l10, 1059u);
