...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l12.tag == 0u) {
        l11 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l8 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a0_arr = vader_array_new(89u, 1u, 13u, 883u);
        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) t0)->f_op == INT32_C(18)) {
            ...
            if (t1 != 0u) {
                if (l2) {
                    ...
                    l5 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l5, 1186u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 418u) {
                                ...
                                if (!(l13.tag == 0u)) {
                                    ...
                                    l20 = concat_5(931u, l18, 981u, l19, l16);
                                        ...
                                        if ((l15 < l14)) {
                                            ...
                                            if (!(l32.tag == 0u)) {
                                                ...
                                                if (t2) {
                                                    ...
                                                    l33 = concat_5(931u, l36, 1003u, l37, 1027u);
                                                } else {
                                                    t0 = l10.payload.obj;
                                                    ...
                                                    l33 = concat_6(931u, l38, 942u, l39, 947u, l40);
                                                }
                                                t0 = l10.payload.obj;
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 931u);
        l3 = std_core_write_string_at(l8, l3, l6);
        l3 = std_core_write_string_at(l8, l3, 1026u);
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2162u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 411u) {
                    ...
                    l13 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l12, 1509u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(931u, l4, 986u, l3, 219u, l10, 1057u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 468u) {
        vader_array_t* _a1_arr = vader_array_new(118u, 0u, 13u, 1085u);
        l1 = (void*) _a1_arr;
        t0 = l0.payload.obj;
        l3 = ((vader_struct_toolchain_ast_TupleBinding_t*) t0)->f_elements;
        l4 = ((vader_array_t*) l3)->length;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a14_obj, 865u);
    _a14_obj->f_file = l11;
    _a14_obj->f_paths = l12;
    _a14_obj->f_excludes = l13;
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(82u, 1u, 13u, 865u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(84u, 0u, 13u, 869u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    vader_gc_top = &gc_frame;
    t0 = std_string_starts_with(l0, 420u);
    if (t0) {
        l6 = true;
    } else {
        l6 = std_string_starts_with(l0, 417u);
    }
    if (l6) {
        l7 = concat_3(931u, l0, 931u);
    ...
    t0 = std_string_starts_with(l0, 2310u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2310u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(931u, l2, 1001u, l0, 1041u, 2170u, 1004u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(931u, l0, 1039u, l7, 233u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
vader_box_t vader_resolver_find_core_module_id(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            ...
            t2 = (l5 + INT64_C(1));
            l5 = (size_t) (int64_t) t2;
            t3 = std_string_ends_with(l7, 2047u);
            if (t3) {
                l8 = true;
            } else {
                l8 = std_string_ends_with(l7, 2046u);
            }
            if (l8) {
                t0 = vader_box_string(169u, l7);
                { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_18: {
            t1 = vader_resolver_join_path(l1, 2308u);
            t0 = std_io_exists(t1);
            if (t0) {
...
static vader_string_t vader_resolver_generated_root_for(vader_box_t l0) {
    ...
    l1 = vader_resolver_join_path(l1, 1306u);
    t0 = std_io_is_dir(l1);
    if (!(t0)) {
...
static vader_box_t vader_resolver_home_root(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_std_env_get_env(830u);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(84u, 1u, 13u, 869u);
...
static vader_string_t vader_resolver_join_path(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = std_string_trim_prefix(l1, 420u);
    if (l0 == 0u) {
        { vader_string_t __vret = l2; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2050u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(81u, 1u, 13u, 864u);
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(169u, 509u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l18.tag == 0u) {
        ...
        l16 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l16, 1483u);
    ...
    if (l18.tag == 864u) {
        ...
        vader_array_t* _a13_arr = vader_array_new(81u, 1u, 13u, 864u);
        ...
        l19 = vader_resolver_resolve_lazy(2049u, l12, l15, l11);
        if (l19.tag == 864u) {
            t0 = l19.payload.obj;
            l6 = ((vader_struct_vader_resolver_DiscoveredModule_t*) t0)->f_folder;
            ...
            if (!(t2)) {
                t0 = l19.payload.obj;
                vader_array_t* _a14_arr = vader_array_new(81u, 1u, 13u, 864u);
...
static void* vader_resolver_new_import_target_table(void) {
    ...
    vader_obj_header_init(_a12_obj, 868u);
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2048u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(87u, 0u, 13u, 878u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(84u, 0u, 13u, 869u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
    ...
    l10 = vader_resolver_sidecar_root(1813u, 2048u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l10.tag == 0u) {
        l8 = vader_resolver_origin_of_root(1813u);
        l4 = vader_resolver_plain_root(1813u, l8);
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    }
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 169u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2308u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 277u) {
        t1 = l3.payload.obj;
        l3 = std_collections_MutableMap_Index_at__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1722u);
        if (l3.tag == 272u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 418u) {
                                ...
                                l20 = concat_5(931u, l18, 965u, l19, 945u);
                                l21 = concat_2(1777u, l14);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a28_obj, 876u);
    _a28_obj->f_path = l1;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    vader_obj_header_init(_a19_obj, 875u);
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_42: {
            if ((l6 < l5)) {
                ...
                t3 = std_string_ends_with(l7, 436u);
                if (t3) {
                    t3 = std_io_is_dir(l8);
                    l9 = !(t3);
                } else {
                    ...
                    if (l11.tag == 858u) {
                        ...
                        if (t5 == 0u) {
                            ...
                            if (l16 != l17) {
                                ...
                                l21 = concat_5(931u, l19, 953u, l20, 1030u);
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
                                        ...
                                        loop_125: {
                                            if ((l17 < l16)) {
                                                ...
                                                if (l20.tag == 0u) {
                                                    ...
                                                    l22 = concat_2(414u, l23);
                                                } else {
                                                    l24 = l20.payload.s;
                                                    l25 = std_target_Os_Display_to_string(l18);
                                                    l22 = concat_3(l24, 378u, l25);
                                                }
    ...
    vader_array_t* _a15_arr = vader_array_new(87u, 0u, 13u, 878u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_252: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(114u, 0u, 13u, 1053u);
                l15 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a20_obj, 878u);
                _a20_obj->f_path = l14;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 462u) {
        vader_array_t* _a16_arr = vader_array_new(120u, 0u, 13u, 1088u);
        l2 = (void*) _a16_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 455u) {
        vader_array_t* _a21_arr = vader_array_new(113u, 0u, 13u, 1045u);
        l2 = (void*) _a21_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 434u) {
        vader_array_t* _a27_arr = vader_array_new(113u, 0u, 13u, 1045u);
        l2 = (void*) _a27_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 457u) {
        vader_array_t* _a31_arr = vader_array_new(119u, 0u, 13u, 1087u);
        l2 = (void*) _a31_arr;
        t0 = l0.payload.obj;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 455u) {
        vader_array_t* _a7_arr = vader_array_new(113u, 0u, 13u, 1045u);
        l4 = (void*) _a7_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 422u) {
        vader_array_t* _a10_arr = vader_array_new(113u, 0u, 13u, 1045u);
        l4 = (void*) _a10_arr;
        t0 = l0.payload.obj;
                    ...
                    if (l10.tag == 864u) {
                        ...
                        if (l12.tag == 0u) {
                            ...
                            if (t3 == INT32_C(1)) {
                                ...
                                l15 = concat_5(931u, l14, 970u, l9, 1067u);
            ...
            if (l18.tag == 0u) {
                ...
                if (l18.tag == 169u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(931u, l21, 961u, l25, 931u);
