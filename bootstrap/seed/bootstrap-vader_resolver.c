        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1153u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 407u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(918u, l19, 962u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1001u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l20 = concat_3(918u, l7, 952u);
                    l21 = concat_3(l19, l20, 1359u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 400u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1469u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(918u, l4, 967u, l3, 233u, l10, 1030u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(918u, l2, 981u, l0, 1015u, 2144u, 984u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(918u, l0, 1012u, l7, 245u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 1997u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 1996u);
                }
                if (l8) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2000u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 1999u);
                }
                if (l8) {
                    t0 = vader_box_string(161u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_box_t vader_resolver_home_root(vader_string_t l0, vader_string_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_std_env_get_env(819u);
    if (l2.tag == 0u) {
        t0 = vader_box_obj(0u, NULL);
        { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2003u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(161u, 504u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 161u) {
        ...
        if (l23.tag == 853u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(1999u, l31, l22, l11);
            if (l35.tag == 853u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2002u, l31, l22, l11);
            if (l39.tag == 853u) {
                l40 = l39.payload.obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2001u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1766u, 2001u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 407u) {
                                ...
                                l21 = concat_5(918u, l19, 948u, l20, 930u);
...
static vader_box_t vader_resolver_scan_folder(vader_string_t l0, void* l1) {
    ...
    if (l2.tag == 8u) {
        ...
        vader_struct___lambda_env_3059_t* _a0_obj = (vader_struct___lambda_env_3059_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3059_t));
    ...
    if (l2.tag == 374u) {
        ...
        vader_struct___lambda_env_3059_t* _a8_obj = (vader_struct___lambda_env_3059_t*) vader_gc_alloc(sizeof(vader_struct___lambda_env_3059_t));
                    ...
                    if (l5.tag == 853u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(918u, l15, 953u, l10, 1040u);
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 161u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(918u, l21, 945u, l25, 918u);
