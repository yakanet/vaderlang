...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 884u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(90u, 1u, 13u, 884u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(90u, 1u, 13u, 884u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 468u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(117u, 0u, 13u, 1069u);
        l2 = (void*) _a1_arr;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(83u, 1u, 13u, 866u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(52u, 0u, 13u, 696u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(85u, 0u, 13u, 870u);
    l5 = (void*) _a5_arr;
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(52u, 0u, 13u, 696u);
    l4 = (void*) _a1_arr;
...
static vader_string_t vader_resolver_for_type_display_name(vader_box_t l0) {
    ...
    if (l0.tag == 422u) {
        l1 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l1)->f_callee.tag == 423u) {
...
static vader_box_t vader_resolver_for_type_owner_sym(vader_box_t l0, void* l1, void* l2) {
    ...
    if (l0.tag == 422u) {
        l5 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l5)->f_callee.tag == 423u) {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(85u, 1u, 13u, 870u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(23u, 1u, 13u, 404u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(82u, 1u, 13u, 865u);
    ...
    t0 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(82u, 1u, 13u, 865u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    _a4_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l10 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(52u, 0u, 13u, 696u);
    l11 = (void*) _a5_arr;
    ...
    if (l7.tag == 164u) {
        ...
        if (l23.tag == 865u) {
            ...
            if (l39.tag == 865u) {
                ...
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(82u, 1u, 13u, 865u);
    ...
    if (l7.tag == 0u) {
        ...
        if (l23.tag == 865u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(82u, 1u, 13u, 865u);
            ...
            if (l39.tag == 865u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(82u, 1u, 13u, 865u);
            ...
            vader_obj_header_init(_a23_obj, 872u);
            _a23_obj->f_entry = t1;
...
static void* vader_resolver_new_scope(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(18u, 1u, 13u, 352u);
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(88u, 0u, 13u, 879u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void vader_resolver_pop(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(18u, 0u, 13u, 352u);
    l2 = (void*) _a0_arr;
    t0 = (l1 - INT64_C(1));
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(85u, 0u, 13u, 870u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a15_obj, 279u);
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(52u, 0u, 13u, 696u);
    l9 = (void*) _a16_arr;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(88u, 0u, 13u, 879u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(113u, 0u, 13u, 1037u);
                l13 = (void*) _a17_arr;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 395u || l0.tag == 401u || l0.tag == 417u || l0.tag == 433u || l0.tag == 446u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 445u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 399u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(21u, 0u, 13u, 398u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 440u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(29u, 0u, 13u, 439u);
        l3 = (void*) _a14_arr;
    ...
    if (l0.tag == 462u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(119u, 0u, 13u, 1072u);
        l3 = (void*) _a18_arr;
            ...
            loop_456: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 463u) {
                        ...
                        vader_obj_header_init(_a20_obj, 463u);
                        _a20_obj->f_span = l10;
                    ...
                    if (l4.tag == 464u) {
                        ...
                        vader_obj_header_init(_a21_obj, 464u);
                        _a21_obj->f_span = l19;
        ...
        vader_obj_header_init(_a22_obj, 462u);
        _a22_obj->f_span = l6;
    ...
    if (l0.tag == 455u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(112u, 0u, 13u, 1029u);
        l3 = (void*) _a23_arr;
        ...
        vader_obj_header_init(_a25_obj, 455u);
    ...
    if (l0.tag == 451u) {
        ...
        vader_obj_header_init(_a26_obj, 451u);
        _a26_obj->f_span = l3;
    ...
    if (l0.tag == 400u) {
        ...
        vader_obj_header_init(_a28_obj, 400u);
        _a28_obj->f_span = l3;
    ...
    if (l0.tag == 434u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(112u, 0u, 13u, 1029u);
        l3 = (void*) _a29_arr;
        ...
        vader_obj_header_init(_a31_obj, 434u);
        _a31_obj->f_span = l6;
    ...
    if (l0.tag == 411u) {
        ...
        vader_obj_header_init(_a32_obj, 411u);
        _a32_obj->f_span = l3;
    ...
    if (l0.tag == 457u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(118u, 0u, 13u, 1071u);
        l3 = (void*) _a33_arr;
            ...
            loop_748: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 458u) {
                        ...
                        vader_obj_header_init(_a36_obj, 458u);
                        _a36_obj->f_expr = l5;
                        _a36_obj->f_span = l18;
        ...
        vader_obj_header_init(_a37_obj, 457u);
    ...
    if (l0.tag == 436u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(26u, 0u, 13u, 419u);
        l3 = (void*) _a38_arr;
        ...
        l8 = (size_t) (int64_t) INT64_C(0);
        {
            loop_837: {
                if ((l8 < l7)) {
                    ...
                    vader_obj_header_init(_a40_obj, 419u);
                    _a40_obj->f_span = l10;
        ...
        vader_obj_header_init(_a41_obj, 436u);
        _a41_obj->f_span = l6;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(26u, 0u, 13u, 419u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_stmt(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 421u) {
        ...
        if (l6.tag == 430u) {
            ...
            vader_obj_header_init(_a7_obj, 421u);
            _a7_obj->f_span = l9;
            _a7_obj->f_id = l10;
            _a7_obj->f_label = l11;
            _a7_obj->f_form = l3;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 455u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(112u, 0u, 13u, 1029u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 422u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(112u, 0u, 13u, 1029u);
        l5 = (void*) _a10_arr;
