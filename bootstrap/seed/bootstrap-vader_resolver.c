...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l12.tag == 0u) {
        l11 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l8 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a0_arr = vader_array_new(97u, 1u, 13u, 899u);
        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) t0)->f_op == INT32_C(18)) {
            ...
            if (t1 != 0u) {
                if (l2) {
                    ...
                    l5 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l5, 1243u);
...
static void* vader_resolver_build_subst(void* l0, void* l1) {
    ...
    vader_resolver_bind_1(l2, 756u, l3);
...
static void vader_resolver_check_groups(void* l0, void* l1) {
    ...
    vader_obj_header_init(_a7_obj, 325u);
    _a7_obj->f_ekeys = l3;
    _a7_obj->f_evals = l4;
    _a7_obj->f_index = l5;
                                        ...
                                        if ((l15 < l14)) {
                                            ...
                                            if (!(l32.tag == 0u)) {
                                                ...
                                                if (t2) {
                                                    ...
                                                    l33 = concat_5(977u, l36, 1055u, l37, 1080u);
                                                } else {
                                                    t0 = l10.payload.obj;
                                                ...
                                                loop_70: {
                                                    if ((l15 < l14)) {
                                                        ...
                                                        if (l16.tag == 419u) {
                                                            ...
                                                            l22 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l21, 1210u);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1078u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 2019u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 419u) {
                    ...
                    l13 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l12, 1574u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(977u, l4, 1036u, l3, 236u, l10, 1110u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 476u) {
        vader_array_t* _a1_arr = vader_array_new(126u, 0u, 13u, 1107u);
        l1 = (void*) _a1_arr;
        t0 = l0.payload.obj;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a13_obj, 327u);
    ...
    vader_obj_header_init(_a14_obj, 880u);
    _a14_obj->f_file = l11;
    _a14_obj->f_paths = l12;
    _a14_obj->f_excludes = l13;
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(89u, 1u, 13u, 880u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(91u, 0u, 13u, 884u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_5(977u, l2, 1053u, l0, 1094u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(977u, l0, 1092u, l7, 250u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
vader_box_t vader_resolver_find_async_module_id(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            ...
            t2 = (l5 + INT64_C(1));
            l5 = (size_t) (int64_t) t2;
            t3 = std_string_ends_with(l7, 2121u);
            if (t3) {
                l8 = true;
            } else {
                l8 = std_string_ends_with(l7, 2120u);
            }
            if (l8) {
...
vader_box_t vader_resolver_find_core_module_id(void* l0) {
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            ...
            t2 = (l5 + INT64_C(1));
            l5 = (size_t) (int64_t) t2;
            t3 = std_string_ends_with(l7, 2124u);
            if (t3) {
                l8 = true;
            } else {
                l8 = std_string_ends_with(l7, 2123u);
            }
            if (l8) {
                t0 = vader_box_string(176u, l7);
                { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static vader_string_t vader_resolver_generated_root_for(vader_box_t l0) {
    ...
    l1 = vader_resolver_join_path(l1, 1364u);
    t0 = std_io_is_dir(l1);
    if (!(t0)) {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(91u, 1u, 13u, 884u);
    ...
    if (l3 != 0u) {
        ...
        vader_obj_header_init(_a2_obj, 884u);
        _a2_obj->f_dir = l3;
        _a2_obj->f_prefix = 0u;
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2127u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(88u, 1u, 13u, 879u);
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(176u, 523u);
    l11 = (void*) _a9_arr;
    ...
    vader_obj_header_init(_a10_obj, 879u);
    _a10_obj->f_name = 2128u;
    _a10_obj->f_folder = 522u;
    _a10_obj->f_files = l11;
    _a10_obj->f_origin = (uint8_t) (int32_t) INT32_C(1);
    t0 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(88u, 1u, 13u, 879u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_obj_header_init(_a4_obj, 325u);
    _a4_obj->f_ekeys = l10;
    _a4_obj->f_evals = l11;
    _a4_obj->f_index = l12;
    _a4_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a11_obj, 325u);
    ...
    if (l18.tag == 0u) {
        ...
        t1 = concat_3(1981u, l13, 1010u);
        l6 = concat_2(t1, 1232u);
    ...
    if (l18.tag == 879u) {
        ...
        vader_array_t* _a13_arr = vader_array_new(88u, 1u, 13u, 879u);
        ((void**) _a13_arr->buf->slots)[_a13_arr->offset + 0u] = l16;
        l16 = (void*) _a13_arr;
        l19 = vader_resolver_resolve_lazy(2123u, l12, l15, l11);
        if (l19.tag == 879u) {
            t0 = l19.payload.obj;
        ...
        l19 = vader_resolver_resolve_lazy(2126u, l12, l15, l11);
        if (l19.tag == 879u) {
            t0 = l19.payload.obj;
            l6 = ((vader_struct_vader_resolver_DiscoveredModule_t*) t0)->f_folder;
            ...
            if (!(t2)) {
                t0 = l19.payload.obj;
                vader_array_t* _a14_arr = vader_array_new(88u, 1u, 13u, 879u);
        ...
        vader_obj_header_init(_a15_obj, 886u);
        _a15_obj->f_entry = t1;
...
static void* vader_resolver_new_import_table(void) {
    ...
    vader_obj_header_init(_a3_obj, 286u);
    _a3_obj->f_ekeys = l0;
    _a3_obj->f_evals = l1;
    _a3_obj->f_index = l2;
    _a3_obj->f_mask = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_new_import_target_table(void) {
    ...
    vader_obj_header_init(_a7_obj, 319u);
    _a7_obj->f_ekeys = l1;
    _a7_obj->f_evals = l2;
    _a7_obj->f_index = l3;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a12_obj, 883u);
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2125u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(95u, 0u, 13u, 894u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_9: {
            if ((l7 < l6)) {
                ...
                vader_obj_header_init(_a3_obj, 894u);
                _a3_obj->f_path = l8;
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(91u, 0u, 13u, 884u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
    ...
    l10 = vader_resolver_sidecar_root(1883u, 2125u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l10.tag == 0u) {
        l8 = vader_resolver_origin_of_root(1883u);
        l4 = vader_resolver_plain_root(1883u, l8);
        vader_array_push((vader_array_t*) l3, vader_ref_box(l4));
    }
    { void* __vret = l3; vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 283u) {
        t1 = l3.payload.obj;
        l3 = std_collections_MutableMap_Index_at__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1790u);
        if (l3.tag == 278u) {
            t1 = l3.payload.obj;
...
static vader_box_t vader_resolver_resolve_lazy(vader_string_t l0, void* l1, void* l2, void* l3) {
    ...
    vader_obj_header_init(_a4_obj, 879u);
    _a4_obj->f_name = l0;
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a7_obj, 286u);
    _a7_obj->f_ekeys = l17;
    _a7_obj->f_evals = l18;
    _a7_obj->f_index = l19;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_obj_header_init(_a11_obj, 286u);
    ...
    vader_obj_header_init(_a15_obj, 286u);
    ...
    vader_obj_header_init(_a19_obj, 319u);
    ...
    vader_obj_header_init(_a23_obj, 301u);
    ...
    vader_obj_header_init(_a27_obj, 301u);
    ...
    vader_obj_header_init(_a28_obj, 892u);
    _a28_obj->f_path = l1;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(93u, 0u, 13u, 889u);
    l9 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a20_obj, 315u);
    ...
    vader_obj_header_init(_a23_obj, 890u);
    ...
    vader_obj_header_init(_a25_obj, 891u);
...
static vader_box_t vader_resolver_scan_folder(vader_string_t l0, void* l1) {
    ...
    vader_obj_header_init(_a1_obj, 269u);
    t2 = (void*) _a1_obj;
    ...
    vader_obj_header_init(_a6_obj, 881u);
    _a6_obj->f_name = 0u;
                    ...
                    if (l11.tag == 873u) {
                        ...
                        if (t5 == 0u) {
                            ...
                            if (l16 != l17) {
                                ...
                                l21 = concat_5(977u, l19, 1000u, l20, 1083u);
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(95u, 0u, 13u, 894u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_252: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(122u, 0u, 13u, 1072u);
                l15 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a20_obj, 894u);
                _a20_obj->f_path = l14;
...
static void* vader_resolver_sort_by_name(void* l0) {
    ...
    vader_obj_header_init(_a0_obj, 268u);
    t0 = (void*) _a0_obj;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 470u) {
        vader_array_t* _a16_arr = vader_array_new(128u, 0u, 13u, 1110u);
        l2 = (void*) _a16_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 463u) {
        vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1063u);
        l2 = (void*) _a21_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 442u) {
        vader_array_t* _a27_arr = vader_array_new(121u, 0u, 13u, 1063u);
        l2 = (void*) _a27_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 465u) {
        vader_array_t* _a31_arr = vader_array_new(127u, 0u, 13u, 1109u);
        l2 = (void*) _a31_arr;
        t0 = l0.payload.obj;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 463u) {
        vader_array_t* _a7_arr = vader_array_new(121u, 0u, 13u, 1063u);
        l4 = (void*) _a7_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 430u) {
        vader_array_t* _a10_arr = vader_array_new(121u, 0u, 13u, 1063u);
        l4 = (void*) _a10_arr;
        t0 = l0.payload.obj;
...
static void vader_resolver_walk_for(void* l0, void* l1) {
    ...
    if (l2.tag == 438u) {
        ...
        if (l3.tag == 452u) {
            ...
            if (l3.tag == 417u) {
                l4 = l3.payload.obj;
                vader_array_t* _a0_arr = vader_array_new(97u, 0u, 13u, 899u);
                l6 = (void*) _a0_arr;
                    ...
                    if (l10.tag == 879u) {
                        ...
                        if (l12.tag == 0u) {
                            ...
                            if (t3 == INT32_C(1)) {
                                ...
                                l15 = concat_5(977u, l14, 1018u, l9, 1121u);
...
static void vader_resolver_walk_let(void* l0, void* l1) {
    ...
    if (!(t0)) {
        ...
        if ((t2 > INT64_C(0))) {
            ...
            vader_obj_header_init(_a2_obj, 889u);
            _a2_obj->f_syms = l3;
            _a2_obj->f_span = l7;
            l3 = (void*) _a2_obj;
...
void* vader_resolver_wildcard_ambiguities(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_obj_header_init(_a14_obj, 327u);
    _a14_obj->f_ekeys = l5;
    _a14_obj->f_evals = l6;
            ...
            if (l18.tag == 0u) {
                ...
                if (l18.tag == 176u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(977u, l21, 1008u, l25, 977u);
