...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 877u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(89u, 1u, 13u, 877u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(89u, 1u, 13u, 877u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_109: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a9_obj, 216u);
                _a9_obj->f__0 = l8;
                _a9_obj->f__1 = l2;
                l9 = (void*) _a9_obj;
                l10 = ((vader_struct___Tuple_2_cb60e7c5b39cd1d9_t*) l9)->f__0;
                ...
                l17 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_119: {
                        if ((l17 >= l16)) {
                            ...
                            vader_obj_header_init(_a10_obj, 216u);
                            _a10_obj->f__0 = l12;
                            _a10_obj->f__1 = l18;
                            t3 = (void*) _a10_obj;
...
static void vader_resolver_check_groups(void* l0, void* l1) {
    ...
    l3 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(16u, 0u, 0u, 174u);
    l4 = (void*) _a5_arr;
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 411u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(919u, l19, 964u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2129u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 404u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1472u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(919u, l4, 969u, l3, 227u, l10, 1033u);
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    l13 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(16u, 0u, 0u, 174u);
    l14 = (void*) _a11_arr;
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(82u, 1u, 13u, 859u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(51u, 0u, 13u, 689u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(84u, 0u, 13u, 863u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2279u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2279u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(919u, l2, 984u, l0, 1018u, 2137u, 987u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(919u, l0, 1015u, l7, 239u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(51u, 0u, 13u, 689u);
    l4 = (void*) _a1_arr;
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2003u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2002u);
                }
                if (l8) {
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2277u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static vader_string_t vader_resolver_for_type_display_name(vader_box_t l0) {
    ...
    if (l0.tag == 415u) {
        l1 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l1)->f_callee.tag == 416u) {
...
static vader_box_t vader_resolver_for_type_owner_sym(vader_box_t l0, void* l1, void* l2) {
    ...
    if (l0.tag == 415u) {
        l5 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l5)->f_callee.tag == 416u) {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(84u, 1u, 13u, 863u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_name = 1707u;
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 397u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2009u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(81u, 1u, 13u, 858u);
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(163u, 503u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_array_t* _a1_arr = vader_array_new(8u, 0u, 0u, 163u);
    l10 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(16u, 0u, 0u, 174u);
    l11 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 166u);
    l12 = (void*) _a3_arr;
    ...
    _a4_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l10 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(51u, 0u, 13u, 689u);
    l11 = (void*) _a5_arr;
    ...
    if (l7.tag == 163u) {
        ...
        l16 = (void*) _a6_arr;
        vader_array_t* _a7_arr = vader_array_new(16u, 0u, 0u, 174u);
        l17 = (void*) _a7_arr;
        ...
        if (l23.tag == 858u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2005u, l31, l22, l11);
            if (l35.tag == 858u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2008u, l31, l22, l11);
            if (l39.tag == 858u) {
                l40 = l39.payload.obj;
                l41 = ((vader_struct_vader_resolver_DiscoveredModule_t*) l40)->f_folder;
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(81u, 1u, 13u, 858u);
    ...
    if (l7.tag == 0u) {
        ...
        l16 = (void*) _a16_arr;
        vader_array_t* _a17_arr = vader_array_new(16u, 0u, 0u, 174u);
        l17 = (void*) _a17_arr;
        ...
        if (l23.tag == 0u) {
            ...
            vader_obj_header_init(_a20_obj, 865u);
        ...
        if (l23.tag == 858u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(81u, 1u, 13u, 858u);
            ...
            if (l39.tag == 858u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(81u, 1u, 13u, 858u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_169: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a5_obj, 211u);
                _a5_obj->f__0 = l8;
                _a5_obj->f__1 = l3;
                l9 = (void*) _a5_obj;
...
static void* vader_resolver_new_scope(void* l0) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(18u, 1u, 13u, 348u);
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2007u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(87u, 0u, 13u, 872u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void vader_resolver_pop(void* l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(18u, 0u, 13u, 348u);
    l2 = (void*) _a0_arr;
    t0 = (l1 - INT64_C(1));
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(84u, 0u, 13u, 863u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
    ...
    l10 = vader_resolver_sidecar_root(1769u, 2007u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 163u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2277u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 272u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1680u);
        if (l3.tag == 267u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 411u) {
                                ...
                                l21 = concat_5(919u, l19, 950u, l20, 931u);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l18 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(16u, 0u, 0u, 174u);
    l19 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 166u);
    l20 = (void*) _a10_arr;
    ...
    vader_array_t* _a12_arr = vader_array_new(9u, 0u, 7u, 166u);
    l19 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(16u, 0u, 0u, 174u);
    l20 = (void*) _a13_arr;
    ...
    l22 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(16u, 0u, 0u, 174u);
    l23 = (void*) _a21_arr;
    ...
    l23 = (void*) _a24_arr;
    vader_array_t* _a25_arr = vader_array_new(16u, 0u, 0u, 174u);
    l24 = (void*) _a25_arr;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(51u, 0u, 13u, 689u);
    l9 = (void*) _a16_arr;
    ...
    vader_obj_header_init(_a17_obj, 868u);
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(87u, 0u, 13u, 872u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(112u, 0u, 13u, 1030u);
                l13 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a19_obj, 443u);
                _a19_obj->f_file = l22;
                _a19_obj->f_span = l31;
                _a19_obj->f_id = l17;
...
static vader_box_t vader_resolver_substitute_coalesce_fallback(vader_box_t l0, void* l1) {
    ...
    if ((l0.tag == 390u || l0.tag == 396u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if ((l0.tag == 382u || l0.tag == 385u || l0.tag == 386u || l0.tag == 388u || l0.tag == 389u || l0.tag == 392u || l0.tag == 393u || l0.tag == 394u || l0.tag == 404u || l0.tag == 409u || l0.tag == 410u || l0.tag == 413u || l0.tag == 415u || l0.tag == 416u || l0.tag == 419u || l0.tag == 424u || l0.tag == 426u || l0.tag == 427u || l0.tag == 429u || l0.tag == 433u || l0.tag == 435u || l0.tag == 438u || l0.tag == 439u || l0.tag == 444u || l0.tag == 448u || l0.tag == 450u || l0.tag == 455u || l0.tag == 465u)) {
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 389u || l0.tag == 394u || l0.tag == 410u || l0.tag == 426u || l0.tag == 439u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 438u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 392u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 391u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 419u) {
        ...
        if (l5.tag == 417u) {
            ...
            vader_obj_header_init(_a11_obj, 419u);
            _a11_obj->f_span = l3;
            _a11_obj->f_id = l7;
            _a11_obj->f_cond = l15;
    ...
    if (l0.tag == 433u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(28u, 0u, 13u, 432u);
        l3 = (void*) _a14_arr;
        ...
        vader_obj_header_init(_a17_obj, 433u);
        _a17_obj->f_span = l6;
    ...
    if (l0.tag == 455u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(118u, 0u, 13u, 1064u);
        l3 = (void*) _a18_arr;
            ...
            loop_456: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 456u) {
                        ...
                        vader_obj_header_init(_a20_obj, 456u);
                        _a20_obj->f_span = l10;
                    ...
                    if (l4.tag == 457u) {
                        ...
                        vader_obj_header_init(_a21_obj, 457u);
                        _a21_obj->f_span = l19;
        ...
        vader_obj_header_init(_a22_obj, 455u);
        _a22_obj->f_span = l6;
    ...
    if (l0.tag == 448u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(111u, 0u, 13u, 1022u);
        l3 = (void*) _a23_arr;
        ...
        vader_obj_header_init(_a25_obj, 448u);
    ...
    if (l0.tag == 444u) {
        ...
        vader_obj_header_init(_a26_obj, 444u);
        _a26_obj->f_span = l3;
    ...
    if (l0.tag == 393u) {
        ...
        vader_obj_header_init(_a28_obj, 393u);
        _a28_obj->f_span = l3;
    ...
    if (l0.tag == 427u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(111u, 0u, 13u, 1022u);
        l3 = (void*) _a29_arr;
        ...
        vader_obj_header_init(_a31_obj, 427u);
        _a31_obj->f_span = l6;
    ...
    if (l0.tag == 404u) {
        ...
        vader_obj_header_init(_a32_obj, 404u);
        _a32_obj->f_span = l3;
    ...
    if (l0.tag == 450u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(117u, 0u, 13u, 1063u);
        l3 = (void*) _a33_arr;
            ...
            loop_748: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 452u) {
                        ...
                        vader_obj_header_init(_a35_obj, 452u);
                    ...
                    if (l4.tag == 451u) {
                        ...
                        vader_obj_header_init(_a36_obj, 451u);
                        _a36_obj->f_expr = l5;
                        _a36_obj->f_span = l18;
        ...
        vader_obj_header_init(_a37_obj, 450u);
    ...
    if (l0.tag == 429u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(25u, 0u, 13u, 412u);
        l3 = (void*) _a38_arr;
        ...
        l8 = (size_t) (int64_t) INT64_C(0);
        {
            loop_837: {
                if ((l8 < l7)) {
                    ...
                    vader_obj_header_init(_a40_obj, 412u);
                    _a40_obj->f_span = l10;
        ...
        vader_obj_header_init(_a41_obj, 429u);
        _a41_obj->f_span = l6;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 412u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_stmt(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 414u) {
        ...
        if (l6.tag == 425u) {
            ...
            vader_obj_header_init(_a8_obj, 414u);
            _a8_obj->f_span = l9;
            _a8_obj->f_id = l10;
            _a8_obj->f_label = l11;
            _a8_obj->f_form = l3;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 435u) {
        ...
        vader_obj_header_init(_a6_obj, 435u);
        _a6_obj->f_span = l5;
        _a6_obj->f_id = (size_t) (int64_t) INT64_C(0);
        _a6_obj->f_inner = l3;
        t0 = (void*) _a6_obj;
    ...
    if (l0.tag == 448u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(111u, 0u, 13u, 1022u);
        l5 = (void*) _a7_arr;
        ...
        vader_obj_header_init(_a9_obj, 448u);
    ...
    if (l0.tag == 415u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(111u, 0u, 13u, 1022u);
        l5 = (void*) _a10_arr;
                    ...
                    if (l5.tag == 858u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(919u, l15, 955u, l10, 1043u);
...
void* vader_resolver_wildcard_ambiguities(void* l0, void* l1, void* l2, void* l3) {
    ...
    l5 = (void*) _a11_arr;
    vader_array_t* _a12_arr = vader_array_new(16u, 0u, 0u, 174u);
    l6 = (void*) _a12_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_244: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a17_obj, 228u);
                _a17_obj->f__0 = l9;
                _a17_obj->f__1 = l4;
                l13 = (void*) _a17_obj;
            ...
            if ((l8 >= l7)) {
                ...
                if (l18.tag == 163u) {
                    ...
                    if (l22.tag == 0u) {
                        ...
                        l26 = concat_5(919u, l21, 947u, l25, 919u);
