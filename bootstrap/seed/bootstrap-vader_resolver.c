...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2130u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1916u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 411u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1491u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(923u, l2, 992u, l0, 1031u, 2138u, 995u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1791u, 2020u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 166u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1791u;
            l8 = vader_resolver_origin_of_root(1791u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 277u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1703u);
        if (l3.tag == 272u) {
            t1 = l3.payload.obj;
