        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1162u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 414u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(923u, l19, 969u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1009u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1900u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 407u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1479u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(923u, l4, 974u, l3, 229u, l10, 1039u);
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(923u, l2, 989u, l0, 1023u, 2145u, 992u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(923u, l0, 1020u, l7, 241u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_name = 1715u;
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 400u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(165u, 507u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1777u, 2015u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 165u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1777u;
            l8 = vader_resolver_origin_of_root(1777u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 274u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1688u);
        if (l3.tag == 269u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 414u) {
                                ...
                                l21 = concat_5(923u, l19, 955u, l20, 936u);
                                l22 = concat_2(1741u, l15);
...
static vader_box_t vader_resolver_substitute_coalesce_fallback(vader_box_t l0, void* l1) {
    ...
    if ((l0.tag == 393u || l0.tag == 399u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if ((l0.tag == 385u || l0.tag == 388u || l0.tag == 389u || l0.tag == 391u || l0.tag == 392u || l0.tag == 395u || l0.tag == 396u || l0.tag == 397u || l0.tag == 407u || l0.tag == 412u || l0.tag == 413u || l0.tag == 416u || l0.tag == 418u || l0.tag == 419u || l0.tag == 422u || l0.tag == 427u || l0.tag == 429u || l0.tag == 430u || l0.tag == 432u || l0.tag == 436u || l0.tag == 438u || l0.tag == 441u || l0.tag == 442u || l0.tag == 447u || l0.tag == 451u || l0.tag == 453u || l0.tag == 458u || l0.tag == 468u)) {
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 392u || l0.tag == 397u || l0.tag == 413u || l0.tag == 429u || l0.tag == 442u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 441u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 395u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 394u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 436u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(28u, 0u, 13u, 435u);
        l3 = (void*) _a14_arr;
    ...
    if (l0.tag == 458u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(118u, 0u, 13u, 1068u);
        l3 = (void*) _a18_arr;
    ...
    if (l0.tag == 453u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(117u, 0u, 13u, 1067u);
        l3 = (void*) _a33_arr;
    ...
    if (l0.tag == 432u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(25u, 0u, 13u, 415u);
        l3 = (void*) _a38_arr;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 415u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
                    ...
                    if (l5.tag == 862u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(923u, l15, 960u, l10, 1049u);
