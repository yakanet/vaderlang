...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(89u, 1u, 13u, 884u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 416u) {
                                ...
                                if (!(l14.tag == 0u)) {
                                    ...
                                    l21 = concat_5(924u, l19, 971u, l20, l17);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2144u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1912u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(924u, l4, 976u, l3, 228u, l10, 1042u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(51u, 0u, 13u, 695u);
    l4 = (void*) _a4_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    t0 = std_string_starts_with(l0, 2294u);
    if (t0) {
        t0 = std_string_starts_with(l2, 2294u);
        l6 = !(t0);
    } else {
        l6 = false;
    }
    ...
    if (l6) {
        l7 = concat_7(924u, l2, 991u, l0, 1026u, 2152u, 994u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(924u, l0, 1023u, l7, 240u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(51u, 0u, 13u, 695u);
    l4 = (void*) _a1_arr;
...
static vader_box_t vader_resolver_find_manifest_root(vader_string_t l0) {
    ...
    {
        loop_19: {
            t1 = vader_resolver_join_path(l1, 2292u);
            t0 = std_io_exists(t1);
            if (t0) {
            } else {
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_name = 1725u;
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 402u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_obj_header_init(_a4_obj, 316u);
    _a4_obj->f_ekeys = l10;
    _a4_obj->f_evals = l11;
    _a4_obj->f_index = l12;
    _a4_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    if (l7.tag == 165u) {
        ...
        vader_obj_header_init(_a9_obj, 316u);
        _a9_obj->f_ekeys = l16;
        _a9_obj->f_evals = l17;
        _a9_obj->f_index = l18;
        _a9_obj->f_mask = l19;
        ...
        if (l23.tag == 865u) {
            ...
            if (l39.tag == 865u) {
                ...
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(81u, 1u, 13u, 865u);
    ...
    if (l7.tag == 0u) {
        ...
        vader_obj_header_init(_a19_obj, 316u);
        ...
        if (l23.tag == 865u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(81u, 1u, 13u, 865u);
            ...
            if (l39.tag == 865u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(81u, 1u, 13u, 865u);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1787u, 2023u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 165u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1787u;
            l8 = vader_resolver_origin_of_root(1787u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    vader_array_t* _a0_arr = vader_array_new(8u, 0u, 0u, 165u);
    l1 = (void*) _a0_arr;
    l2 = vader_resolver_join_path(l0, 2292u);
    t0 = std_io_exists(l2);
    if (!(t0)) {
    ...
    if (l3.tag == 274u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1698u);
        if (l3.tag == 269u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 416u) {
                                ...
                                l21 = concat_5(924u, l19, 956u, l20, 937u);
                                l22 = concat_2(1751u, l15);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a19_obj, 310u);
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(51u, 0u, 13u, 695u);
    l9 = (void*) _a16_arr;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(112u, 0u, 13u, 1037u);
                l13 = (void*) _a17_arr;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 397u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 396u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 438u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(28u, 0u, 13u, 437u);
        l3 = (void*) _a14_arr;
    ...
    if (l0.tag == 460u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(118u, 0u, 13u, 1071u);
        l3 = (void*) _a18_arr;
    ...
    if (l0.tag == 453u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(111u, 0u, 13u, 1029u);
        l3 = (void*) _a23_arr;
    ...
    if (l0.tag == 432u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(111u, 0u, 13u, 1029u);
        l3 = (void*) _a29_arr;
    ...
    if (l0.tag == 455u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(117u, 0u, 13u, 1070u);
        l3 = (void*) _a33_arr;
    ...
    if (l0.tag == 434u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(25u, 0u, 13u, 417u);
        l3 = (void*) _a38_arr;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 417u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 453u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(111u, 0u, 13u, 1029u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 420u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(111u, 0u, 13u, 1029u);
        l5 = (void*) _a10_arr;
                    ...
                    if (l5.tag == 865u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(924u, l15, 961u, l10, 1052u);
