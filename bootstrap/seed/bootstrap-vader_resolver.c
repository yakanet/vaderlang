...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 880u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(90u, 1u, 13u, 880u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(90u, 1u, 13u, 880u);
        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) l3)->f_op == INT32_C(18)) {
            ...
            if (t0 != 0u) {
                if (l2) {
                    ...
                    l6 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l6, 1166u);
...
void* vader_resolver_build_core_seed(void* l0) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l1 = (void*) _a3_obj;
    l4 = std_collections_get__string__Any(((vader_struct_vader_resolver_LoadedProject_t*) l0)->f_modules, 505u);
    if (l4.tag == 867u) {
        t0 = l4.payload.obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_109: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a9_obj, 217u);
                _a9_obj->f__0 = l8;
                _a9_obj->f__1 = l2;
                l9 = (void*) _a9_obj;
                l10 = ((vader_struct___Tuple_2_cb60e7c5b39cd1d9_t*) l9)->f__0;
...
static void* vader_resolver_build_subst(void* l0, void* l1) {
    ...
    vader_resolver_bind_1(l2, 734u, l3);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = std_core_write_string_at(l8, l3, 1007u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1905u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
                    l18 = std_core_write_unsigned(l8, l18, l9);
                    l18 = std_core_write_string_at(l8, l18, 145u);
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 407u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1483u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(921u, l4, 972u, l3, 229u, l10, 1036u);
...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 464u) {
        l1 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(117u, 0u, 13u, 1065u);
        l2 = (void*) _a1_arr;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(83u, 1u, 13u, 862u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(52u, 0u, 13u, 692u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(85u, 0u, 13u, 866u);
    l5 = (void*) _a5_arr;
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(921u, l2, 987u, l0, 1021u, 2150u, 990u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(921u, l0, 1018u, l7, 241u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(52u, 0u, 13u, 692u);
    l4 = (void*) _a1_arr;
...
static vader_string_t vader_resolver_for_type_display_name(vader_box_t l0) {
    ...
    if (l0.tag == 418u) {
        l1 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l1)->f_callee.tag == 419u) {
...
static vader_box_t vader_resolver_for_type_owner_sym(vader_box_t l0, void* l1, void* l2) {
    ...
    if (l0.tag == 418u) {
        l5 = l0.payload.obj;
        if (((vader_struct_toolchain_ast_GenericInstExpr_t*) l5)->f_callee.tag == 419u) {
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(85u, 1u, 13u, 866u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_name = 1719u;
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(23u, 1u, 13u, 400u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2022u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(82u, 1u, 13u, 861u);
    ...
    l15 = (size_t) (int64_t) INT64_C(0);
    {
        loop_60: {
            if ((l15 >= l14)) {
                ...
                vader_obj_header_init(_a8_obj, 233u);
                _a8_obj->f__0 = l9;
                _a8_obj->f__1 = l16;
                l11 = (void*) _a8_obj;
    ...
    std_collections_put__string__string(l10, 506u, l9);
    vader_array_t* _a9_arr = vader_array_new(8u, 1u, 0u, 164u);
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(164u, 506u);
    l11 = (void*) _a9_arr;
    ...
    _a10_obj->f_name = 2023u;
    _a10_obj->f_folder = 505u;
    _a10_obj->f_files = l11;
    _a10_obj->f_origin = (uint8_t) (int32_t) INT32_C(1);
    t0 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(82u, 1u, 13u, 861u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 164u) {
        ...
        if (l23.tag == 861u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2018u, l31, l22, l11);
            if (l35.tag == 861u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2021u, l31, l22, l11);
            if (l39.tag == 861u) {
                l40 = l39.payload.obj;
                l41 = ((vader_struct_vader_resolver_DiscoveredModule_t*) l40)->f_folder;
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(82u, 1u, 13u, 861u);
    ...
    if (l7.tag == 0u) {
        ...
        if (l23.tag == 861u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(82u, 1u, 13u, 861u);
            ...
            if (l39.tag == 861u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(82u, 1u, 13u, 861u);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_21: {
            if ((l5 < l4)) {
                ...
                l6 = t0.payload.s;
                l3 = vader_resolver_symbol_make(l0, INT32_C(12), l6, 507u, 507u, (uint8_t) (int32_t) INT32_C(0), vader_box_obj(0u, NULL));
    ...
    l6 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l6 >= l5)) {
                ...
                vader_obj_header_init(_a2_obj, 230u);
                _a2_obj->f__0 = l7;
                _a2_obj->f__1 = l2;
                l8 = (void*) _a2_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_169: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a5_obj, 212u);
                _a5_obj->f__0 = l8;
                _a5_obj->f__1 = l3;
                l9 = (void*) _a5_obj;
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2020u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(88u, 0u, 13u, 875u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(85u, 0u, 13u, 866u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
    ...
    l10 = vader_resolver_sidecar_root(1781u, 2020u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 164u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1781u;
            l8 = vader_resolver_origin_of_root(1781u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 274u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1692u);
        if (l3.tag == 269u) {
            t1 = l3.payload.obj;
    ...
    l11 = (size_t) (int64_t) INT64_C(0);
    {
        loop_49: {
            if ((l11 >= l10)) {
                ...
                vader_obj_header_init(_a3_obj, 217u);
                _a3_obj->f__0 = l13;
                _a3_obj->f__1 = l9;
                l15 = (void*) _a3_obj;
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(52u, 0u, 13u, 692u);
    l9 = (void*) _a16_arr;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(88u, 0u, 13u, 875u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(113u, 0u, 13u, 1033u);
                l13 = (void*) _a17_arr;
                ...
                vader_obj_header_init(_a19_obj, 446u);
                _a19_obj->f_file = l22;
                _a19_obj->f_span = l31;
                _a19_obj->f_id = l17;
...
static vader_box_t vader_resolver_substitute_coalesce_fallback(vader_box_t l0, void* l1) {
    ...
    if ((l0.tag == 392u || l0.tag == 399u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if ((l0.tag == 384u || l0.tag == 387u || l0.tag == 388u || l0.tag == 390u || l0.tag == 391u || l0.tag == 395u || l0.tag == 396u || l0.tag == 397u || l0.tag == 407u || l0.tag == 412u || l0.tag == 413u || l0.tag == 416u || l0.tag == 418u || l0.tag == 419u || l0.tag == 422u || l0.tag == 427u || l0.tag == 429u || l0.tag == 430u || l0.tag == 432u || l0.tag == 436u || l0.tag == 438u || l0.tag == 441u || l0.tag == 442u || l0.tag == 447u || l0.tag == 451u || l0.tag == 453u || l0.tag == 458u || l0.tag == 468u)) {
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 391u || l0.tag == 397u || l0.tag == 413u || l0.tag == 429u || l0.tag == 442u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 441u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 395u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(21u, 0u, 13u, 394u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 422u) {
        ...
        if (l5.tag == 0u) {
            ...
            vader_obj_header_init(_a9_obj, 422u);
            _a9_obj->f_span = l3;
            _a9_obj->f_id = l7;
            _a9_obj->f_cond = l15;
        ...
        if (l5.tag == 420u) {
            ...
            vader_obj_header_init(_a11_obj, 422u);
            _a11_obj->f_span = l3;
            _a11_obj->f_id = l7;
            _a11_obj->f_cond = l15;
        ...
        if (l5.tag == 421u) {
            ...
            vader_obj_header_init(_a13_obj, 422u);
            _a13_obj->f_span = l3;
            _a13_obj->f_id = l7;
            _a13_obj->f_cond = l15;
    ...
    if (l0.tag == 436u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(29u, 0u, 13u, 435u);
        l3 = (void*) _a14_arr;
        ...
        vader_obj_header_init(_a17_obj, 436u);
        _a17_obj->f_span = l6;
    ...
    if (l0.tag == 458u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(119u, 0u, 13u, 1068u);
        l3 = (void*) _a18_arr;
            ...
            loop_456: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 459u) {
                        ...
                        vader_obj_header_init(_a20_obj, 459u);
                        _a20_obj->f_span = l10;
                    ...
                    if (l4.tag == 460u) {
                        ...
                        vader_obj_header_init(_a21_obj, 460u);
                        _a21_obj->f_span = l19;
        ...
        vader_obj_header_init(_a22_obj, 458u);
        _a22_obj->f_span = l6;
    ...
    if (l0.tag == 451u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(112u, 0u, 13u, 1025u);
        l3 = (void*) _a23_arr;
        ...
        vader_obj_header_init(_a25_obj, 451u);
    ...
    if (l0.tag == 447u) {
        ...
        vader_obj_header_init(_a26_obj, 447u);
        _a26_obj->f_span = l3;
    ...
    if (l0.tag == 387u) {
        ...
        vader_obj_header_init(_a27_obj, 387u);
        _a27_obj->f_span = l3;
    ...
    if (l0.tag == 396u) {
        ...
        vader_obj_header_init(_a28_obj, 396u);
        _a28_obj->f_span = l3;
    ...
    if (l0.tag == 430u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(112u, 0u, 13u, 1025u);
        l3 = (void*) _a29_arr;
        ...
        vader_obj_header_init(_a31_obj, 430u);
        _a31_obj->f_span = l6;
    ...
    if (l0.tag == 407u) {
        ...
        vader_obj_header_init(_a32_obj, 407u);
        _a32_obj->f_span = l3;
    ...
    if (l0.tag == 453u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(118u, 0u, 13u, 1067u);
        l3 = (void*) _a33_arr;
            ...
            loop_748: {
                if ((l8 < l7)) {
                    ...
                    if (l4.tag == 455u) {
                        ...
                        vader_obj_header_init(_a35_obj, 455u);
                    ...
                    if (l4.tag == 454u) {
                        ...
                        vader_obj_header_init(_a36_obj, 454u);
                        _a36_obj->f_expr = l5;
                        _a36_obj->f_span = l18;
        ...
        vader_obj_header_init(_a37_obj, 453u);
    ...
    if (l0.tag == 432u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(26u, 0u, 13u, 415u);
        l3 = (void*) _a38_arr;
        ...
        l8 = (size_t) (int64_t) INT64_C(0);
        {
            loop_837: {
                if ((l8 < l7)) {
                    ...
                    vader_obj_header_init(_a40_obj, 415u);
                    _a40_obj->f_span = l10;
        ...
        vader_obj_header_init(_a41_obj, 432u);
        _a41_obj->f_span = l6;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 451u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(112u, 0u, 13u, 1025u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 418u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(112u, 0u, 13u, 1025u);
        l5 = (void*) _a10_arr;
                    ...
                    if (l5.tag == 861u) {
                        ...
                        if (l13.tag == 0u) {
                            ...
                            if (t2 == INT32_C(1)) {
                                ...
                                l16 = concat_5(921u, l15, 958u, l10, 1046u);
                ...
                l16 = (size_t) (int64_t) INT64_C(0);
                {
                    loop_63: {
                        if ((l16 >= l15)) {
                            ...
                            vader_obj_header_init(_a8_obj, 217u);
                            _a8_obj->f__0 = l17;
                            _a8_obj->f__1 = l18;
                            t2 = (void*) _a8_obj;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_244: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a17_obj, 230u);
                _a17_obj->f__0 = l9;
                _a17_obj->f__1 = l4;
                l13 = (void*) _a17_obj;
