...
static vader_box_t vader_resolver_clone_let_binding(vader_box_t l0) {
    ...
    if (l0.tag == 476u) {
        vader_array_t* _a1_arr = vader_array_new(126u, 0u, 13u, 1108u);
        l1 = (void*) _a1_arr;
        t0 = l0.payload.obj;
    ...
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_252: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(122u, 0u, 13u, 1073u);
                l15 = (void*) _a17_arr;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 470u) {
        vader_array_t* _a16_arr = vader_array_new(128u, 0u, 13u, 1111u);
        l2 = (void*) _a16_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 463u) {
        vader_array_t* _a21_arr = vader_array_new(121u, 0u, 13u, 1064u);
        l2 = (void*) _a21_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 442u) {
        vader_array_t* _a27_arr = vader_array_new(121u, 0u, 13u, 1064u);
        l2 = (void*) _a27_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 465u) {
        vader_array_t* _a31_arr = vader_array_new(127u, 0u, 13u, 1110u);
        l2 = (void*) _a31_arr;
        t0 = l0.payload.obj;
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 463u) {
        vader_array_t* _a7_arr = vader_array_new(121u, 0u, 13u, 1064u);
        l4 = (void*) _a7_arr;
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 430u) {
        vader_array_t* _a10_arr = vader_array_new(121u, 0u, 13u, 1064u);
        l4 = (void*) _a10_arr;
        t0 = l0.payload.obj;
