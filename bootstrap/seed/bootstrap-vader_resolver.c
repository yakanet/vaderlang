        ...
        if (((vader_struct_toolchain_ast_BinaryExpr_t*) t0)->f_op == INT32_C(18)) {
            ...
            if (t1 != 0u) {
                if (l2) {
                    ...
                    l5 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(28), l5, 1179u);
                        ...
                        if ((l9 < l8)) {
                            ...
                            if (l10.tag == 421u) {
                                ...
                                if (!(l13.tag == 0u)) {
                                    ...
                                    l20 = concat_5(925u, l18, 974u, l19, l16);
...
static void vader_resolver_check_signature(void* l0, void* l1, void* l2) {
    ...
    if (l3 != l4) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l8, l3, 2150u);
        ...
        loop_121: {
            if ((l4 < l3)) {
                ...
                if (l6 != l7) {
                    ...
                    l18 = std_core_write_string_at(l8, l18, 1935u);
                    t0 = (l4 + INT64_C(1));
                    l9 = (uint64_t) (int64_t) t0;
        ...
        loop_7: {
            if ((l4 < l3)) {
                ...
                if (l5.tag == 414u) {
                    ...
                    l14 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(34), l13, 1502u);
...
static void vader_resolver_check_wildcard_ambiguity(void* l0, void* l1, void* l2) {
    ...
    l3 = concat_7(925u, l4, 979u, l3, 217u, l10, 1050u);
...
static void vader_resolver_collect_import(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    if (l10.tag == 411u) {
        ...
        l9 = ((vader_struct_toolchain_ast_ImportDecl_t*) l1)->f_path;
        vader_array_push((vader_array_t*) l12, vader_box_string(169u, l9));
            ...
            loop_130: {
                if ((l14 < l13)) {
                    ...
                    if (l10.tag == 169u) {
                        ...
                        vader_array_push((vader_array_t*) l12, vader_box_string(169u, l19));
                        if (l18 != 864u) {
...
static vader_box_t vader_resolver_diagnose_import_path(vader_string_t l0, void* l1, vader_string_t l2, void* l3, void* l4, void* l5) {
    ...
    if (l6) {
        l7 = concat_7(925u, l2, 994u, l0, 1034u, 2158u, 997u);
    ...
    if (l9.tag == 0u) {
        ...
        if (l9.tag == 0u) {
            ...
            l7 = l9.payload.s;
            l7 = concat_5(925u, l0, 1031u, l7, 229u);
            l8 = vader_diagnostics_resolver_error((uint8_t) (int32_t) INT32_C(0), l1, l7);
            vader_array_push((vader_array_t*) l5, vader_ref_box(l8));
        }
        t1 = vader_box_obj(0u, NULL);
    ...
    l5 = (size_t) (int64_t) INT64_C(0);
    {
        loop_12: {
            if ((l5 >= l4)) {
                ...
                t2 = (l5 + INT64_C(1));
                l5 = (size_t) (int64_t) t2;
                t3 = std_string_ends_with(l7, 2039u);
                if (t3) {
                    l8 = true;
                } else {
                    l8 = std_string_ends_with(l7, 2038u);
                }
                if (l8) {
                    t0 = vader_box_string(169u, l7);
                    { vader_box_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    vader_gc_top = &gc_frame;
    l8 = vader_resolver_resolve_lazy(2042u, l1, l2, l3);
    if (l8.tag == 0u) {
        { vader_gc_top = gc_frame.prev; return; }
    }
    t0 = l8.payload.obj;
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(169u, 503u);
    l11 = (void*) _a9_arr;
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    if (l7.tag == 169u) {
        ...
        if (l23.tag == 870u) {
            ...
            l34 = (void*) _a11_arr;
            l35 = vader_resolver_resolve_lazy(2038u, l31, l22, l11);
            if (l35.tag == 870u) {
                l36 = l35.payload.obj;
            ...
            l39 = vader_resolver_resolve_lazy(2041u, l31, l22, l11);
            if (l39.tag == 870u) {
                l40 = l39.payload.obj;
    ...
    if (l1.tag == 471u) {
        ...
        if (l1.tag == 456u) {
            ...
            if (l5.tag == 889u) {
                ...
                t0 = l5.payload.obj;
                l6 = ((vader_struct_vader_resolver_symbol_Symbol_t*) t0)->f_id;
                std_collections_put__i32__bool(l2, l6, true);
            } else {
            }
        } else {
        }
...
static uint8_t vader_resolver_origin_of_root(vader_string_t l0) {
    ...
    vader_gc_frame_t gc_frame = { vader_gc_top, 0u, 0u, NULL, NULL, 0u, NULL, 2u, gc_atom_roots };
    vader_gc_top = &gc_frame;
    t0 = vader_resolver_join_path(l0, 2040u);
    t1 = std_io_exists(t0);
    if (t1) {
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    l10 = vader_resolver_sidecar_root(1806u, 2040u);
    if (!(l10.tag == 0u)) {
        t2 = l10.payload.s;
    ...
    if (l0.tag == 169u) {
        ...
        if (l10.tag == 0u) {
            l7 = 1806u;
            l8 = vader_resolver_origin_of_root(1806u);
...
static void* vader_resolver_read_manifest(vader_string_t l0) {
    ...
    if (l3.tag == 280u) {
        t1 = l3.payload.obj;
        l3 = std_collections_get__string__Any(((vader_struct_json_JsonObject_t*) t1)->f_entries, 1715u);
        if (l3.tag == 275u) {
            t1 = l3.payload.obj;
                    ...
                    loop_23: {
                        if ((l10 < l9)) {
                            ...
                            if (l11.tag == 421u) {
                                ...
                                l20 = concat_5(925u, l18, 958u, l19, 938u);
                                l21 = concat_2(1770u, l14);
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 443u) {
        ...
        l13 = ((vader_struct_toolchain_ast_MatchExpr_t*) l2)->f_bind_as;
                    ...
                    if (l10.tag == 870u) {
                        ...
                        if (l12.tag == 0u) {
                            ...
                            if (t3 == INT32_C(1)) {
                                ...
                                l15 = concat_5(925u, l14, 963u, l9, 1060u);
