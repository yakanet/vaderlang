...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1954u);
    ...
    if (l0.tag == 918u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2117u);
    ...
    if (l0.tag == 908u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1432u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 920u) {
        { vader_gc_top = gc_frame.prev; return 2154u; }
    }
    if (l0.tag == 905u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 920u) {
        std_string_builder_append(l0, 2154u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 916u) {
    ...
    if (l1.tag == 913u) {
        std_string_builder_append(l0, 1855u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 912u) {
    ...
    if (l1.tag == 909u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1564u);
        l6 = true;
