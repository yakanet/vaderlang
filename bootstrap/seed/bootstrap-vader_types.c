...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 926u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2035u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 927u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2176u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 915u) {
        ...
        if (t3) {
            ...
            t1 = concat_3(1201u, l1, 327u);
            { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t0 = l0.payload.obj;
        l1 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
        t1 = concat_3(1213u, l1, 327u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 928u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 917u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1498u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 916u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1462u);
        t0 = l0.payload.obj;
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        { vader_gc_top = gc_frame.prev; return 2470u; }
    }
    if (l0.tag == 920u) {
        { vader_gc_top = gc_frame.prev; return 2469u; }
    }
    if (l0.tag == 919u) {
    ...
    if (l0.tag == 929u) {
        { vader_gc_top = gc_frame.prev; return 2217u; }
    }
    if (l0.tag == 914u) {
        ...
        if (l0.tag == 926u) {
            ...
            if (l0.tag == 928u) {
                ...
                if (l0.tag == 931u) {
                    ...
                    if ((l0.tag == 914u || l0.tag == 916u || l0.tag == 917u || l0.tag == 918u || l0.tag == 919u || l0.tag == 920u || l0.tag == 921u || l0.tag == 922u || l0.tag == 924u || l0.tag == 925u || l0.tag == 927u || l0.tag == 929u || l0.tag == 930u || l0.tag == 932u)) {
                        l1 = false;
                    } else {
    ...
    if (l0.tag == 915u) {
        ...
        if (l0.tag == 926u) {
            ...
            if (l0.tag == 928u) {
                ...
                if ((l0.tag == 914u || l0.tag == 916u || l0.tag == 917u || l0.tag == 918u || l0.tag == 919u || l0.tag == 920u || l0.tag == 921u || l0.tag == 922u || l0.tag == 924u || l0.tag == 925u || l0.tag == 927u || l0.tag == 929u || l0.tag == 930u || l0.tag == 931u || l0.tag == 932u)) {
                    l1 = false;
                } else {
                ...
                if (l1.tag == 916u) {
                    ...
                    if (l1.tag == 927u) {
                        ...
                        if (l1.tag == 930u) {
                            ...
                            if (l1.tag == 929u) {
                                std_string_builder_append(l0, 2217u);
                            } else {
                                if (l1.tag == 925u) {
                                    ...
                                    if (l1.tag == 932u) {
                                        ...
                                        if (l1.tag == 922u) {
                                            std_string_builder_append(l0, 1934u);
                                        } else {
                                            if (l1.tag == 921u) {
                                                std_string_builder_append(l0, 2470u);
                                            } else {
                                                if (l1.tag == 920u) {
                                                    std_string_builder_append(l0, 2469u);
                                                } else {
                                                    if (l1.tag == 919u) {
                                                        ...
                                                        if (l1.tag == 915u) {
                                                            t0 = l1.payload.obj;
                                                            if (((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 931u) {
                                                                l5 = true;
                                                            } else {
                                                                t0 = l1.payload.obj;
                                                                l5 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 918u;
                                                            }
                                                            if (l5) {
                                                            ...
                                                            if (l1.tag == 928u) {
                                                                ...
                                                                if (l1.tag == 918u) {
                                                                    std_string_builder_append(l0, 1631u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
