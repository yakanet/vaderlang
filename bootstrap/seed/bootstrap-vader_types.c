...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 916u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2129u);
    ...
    if (l0.tag == 904u) {
        ...
        if (t2) {
            ...
            t0 = concat_3(1151u, l2, 329u);
            { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l2 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) l1)->f_element);
        t0 = concat_3(1161u, l2, 329u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 917u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 911u) {
        { vader_gc_top = gc_frame.prev; return 232u; }
    }
    if (l0.tag == 910u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 918u) {
        { vader_gc_top = gc_frame.prev; return 2166u; }
    }
    if (l0.tag == 903u) {
...
vader_box_t vader_types_mk_fn(void* l0, vader_box_t l1) {
    ...
    vader_obj_header_init(_a1_obj, 907u);
    _a1_obj->f_params = l0;
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(161u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 374u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 918u) {
        std_string_builder_append(l0, 2166u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 914u) {
    ...
    if (l1.tag == 911u) {
        std_string_builder_append(l0, 1864u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 910u) {
    ...
    if (l1.tag == 904u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 920u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 907u;
        }
        if (l6) {
    ...
    if (l1.tag == 917u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 374u, l2);
    ...
    if (l1.tag == 907u) {
        ...
        std_string_builder_append(l0, 332u);
    ...
    if (l1.tag == 920u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 213u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 903u) {
