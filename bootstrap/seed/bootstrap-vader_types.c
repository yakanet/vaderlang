...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1934u);
        ...
        l3 = std_core_write_string_at(l4, l3, 498u);
        l3 = std_core_write_string_at(l4, l3, l2);
        l3 = std_core_write_string_at(l4, l3, 517u);
    ...
    if (l0.tag == 921u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 652u);
    ...
    if (l0.tag == 908u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1408u);
    ...
    if (l0.tag == 907u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1375u);
    ...
    if (l0.tag == 920u) {
        { vader_gc_top = gc_frame.prev; return 631u; }
    }
    if (l0.tag == 916u) {
    ...
    if (l0.tag == 913u) {
        { vader_gc_top = gc_frame.prev; return 241u; }
    }
    if (l0.tag == 912u) {
    ...
    if (l0.tag == 905u) {
        { vader_gc_top = gc_frame.prev; return 532u; }
    }
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 913u) {
        { vader_gc_top = gc_frame.prev; return 1836u; }
    }
    if (l0.tag == 912u) {
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 909u);
    _a2_obj->f_params = l1;
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 923u) {
        std_string_builder_append(l0, 521u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 913u) {
        std_string_builder_append(l0, 1836u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 912u) {
    ...
    if (l1.tag == 906u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 922u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 909u;
        }
        if (l6) {
        ...
        std_string_builder_append(l0, 835u);
        if (l2) {
    ...
    if (l1.tag == 909u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1544u);
        l6 = true;
        ...
        std_string_builder_append(l0, 337u);
    ...
    if (l1.tag == 922u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 222u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 905u) {
        std_string_builder_append(l0, 535u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
