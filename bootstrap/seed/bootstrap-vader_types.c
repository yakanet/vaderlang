...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 920u) {
        std_string_builder_append(l0, 738u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 927u) {
    ...
    if (l1.tag == 913u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1576u);
        l6 = true;
