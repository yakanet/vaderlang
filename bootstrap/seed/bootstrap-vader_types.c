...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2002u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 922u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2144u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 912u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1468u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 911u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1432u);
        t0 = l0.payload.obj;
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 924u) {
        { vader_gc_top = gc_frame.prev; return 2185u; }
    }
    if (l0.tag == 909u) {
        ...
        if (l0.tag == 921u) {
            ...
            if (l0.tag == 923u) {
                ...
                if (l0.tag == 926u) {
                    ...
                    if ((l0.tag == 909u || l0.tag == 911u || l0.tag == 912u || l0.tag == 913u || l0.tag == 914u || l0.tag == 915u || l0.tag == 916u || l0.tag == 917u || l0.tag == 919u || l0.tag == 920u || l0.tag == 922u || l0.tag == 924u || l0.tag == 925u || l0.tag == 927u)) {
                        l1 = false;
                    } else {
                ...
                if (l1.tag == 911u) {
                    ...
                    if (l1.tag == 922u) {
                        ...
                        if (l1.tag == 925u) {
                            ...
                            if (l1.tag == 924u) {
                                std_string_builder_append(l0, 2185u);
                            } else {
                                if (l1.tag == 920u) {
                                            ...
                                            if (l1.tag == 916u) {
                                                ...
                                                if (l1.tag == 915u) {
                                                    ...
                                                    if (l1.tag == 914u) {
                                                        ...
                                                        if (l1.tag == 910u) {
                                                            t0 = l1.payload.obj;
                                                            if (((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 926u) {
                                                                l5 = true;
                                                            } else {
                                                                t0 = l1.payload.obj;
                                                                l5 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 913u;
                                                            }
                                                            if (l5) {
                                                            ...
                                                            if (l1.tag == 923u) {
                                                                ...
                                                                vader_types_write_type_list_mut(l0, l4, 372u, l2);
                                                                ...
                                                                if (l1.tag == 913u) {
                                                                    std_string_builder_append(l0, 1602u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
