...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 918u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1945u);
        ...
        l3 = std_core_write_string_at(l4, l3, 503u);
        l3 = std_core_write_string_at(l4, l3, l2);
        l3 = std_core_write_string_at(l4, l3, 522u);
    ...
    if (l0.tag == 919u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2131u);
    ...
    if (l0.tag == 909u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1419u);
    ...
    if (l0.tag == 908u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1385u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 913u) {
        { vader_gc_top = gc_frame.prev; return 2427u; }
    }
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2426u; }
    }
    if (l0.tag == 911u) {
    ...
    if (l0.tag == 921u) {
        { vader_gc_top = gc_frame.prev; return 2168u; }
    }
    if (l0.tag == 906u) {
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(160u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
    ...
    vader_obj_header_init(_a2_obj, 910u);
    _a2_obj->f_params = l1;
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 376u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 921u) {
        std_string_builder_append(l0, 2168u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 917u) {
    ...
    if (l1.tag == 924u) {
        std_string_builder_append(l0, 526u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 914u) {
        std_string_builder_append(l0, 1847u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 913u) {
        std_string_builder_append(l0, 2427u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 912u) {
    ...
    if (l1.tag == 907u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 923u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 910u;
        }
        if (l6) {
    ...
    if (l1.tag == 920u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 376u, l2);
    ...
    if (l1.tag == 910u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1555u);
        l6 = true;
        ...
        std_string_builder_append(l0, 340u);
    ...
    if (l1.tag == 923u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 223u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 906u) {
