...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 919u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1962u);
    ...
    if (l0.tag == 920u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2128u);
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1439u);
    ...
    if (l0.tag == 909u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1405u);
    ...
    if (l0.tag == 915u) {
        { vader_gc_top = gc_frame.prev; return 231u; }
    }
    if (l0.tag == 914u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2413u; }
    }
    if (l0.tag == 918u) {
        { vader_gc_top = gc_frame.prev; return 733u; }
    }
    if (l0.tag == 922u) {
        { vader_gc_top = gc_frame.prev; return 2165u; }
    }
    if (l0.tag == 907u) {
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(162u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 373u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 922u) {
        std_string_builder_append(l0, 2165u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 918u) {
    ...
    if (l1.tag == 915u) {
        std_string_builder_append(l0, 1863u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 914u) {
    ...
    if (l1.tag == 908u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 924u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 911u;
        }
        if (l6) {
        ...
        std_string_builder_append(l0, 843u);
        if (l2) {
    ...
    if (l1.tag == 921u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 373u, l2);
    ...
    if (l1.tag == 911u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1572u);
        l6 = true;
    ...
    if (l1.tag == 924u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 212u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 907u) {
