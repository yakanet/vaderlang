...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 904u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2105u);
        t0 = l0.payload.obj;
        ...
        l2 = std_core_write_string_at(l3, l2, 542u);
    ...
    if (l0.tag == 905u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2247u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 895u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1553u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 894u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1514u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 903u) {
        { vader_gc_top = gc_frame.prev; return 759u; }
    }
    if (l0.tag == 910u) {
        { vader_gc_top = gc_frame.prev; return 546u; }
    }
    if (l0.tag == 900u) {
        { vader_gc_top = gc_frame.prev; return 242u; }
    }
    if (l0.tag == 899u) {
    ...
    if (l0.tag == 892u) {
        { vader_gc_top = gc_frame.prev; return 557u; }
    }
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 899u) {
        { vader_gc_top = gc_frame.prev; return 2553u; }
    }
    if (l0.tag == 898u) {
        { vader_gc_top = gc_frame.prev; return 2552u; }
    }
    if (l0.tag == 897u) {
        { vader_gc_top = gc_frame.prev; return 2551u; }
    }
    if (l0.tag == 903u) {
        { vader_gc_top = gc_frame.prev; return 761u; }
    }
    if (l0.tag == 907u) {
        { vader_gc_top = gc_frame.prev; return 2295u; }
    }
    if (l0.tag == 892u) {
...
vader_string_t vader_types_display_type_key(vader_box_t l0) {
    ...
    if ((l0.tag == 894u || l0.tag == 895u || l0.tag == 908u)) {
        t0 = l0.payload.obj;
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_types_DistinctType_t*) t0)->f_symbol)->f_name;
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if ((l0.tag == 904u || l0.tag == 905u)) {
        t0 = l0.payload.obj;
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        ...
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(176u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
    ...
    if (l0.tag == 902u) {
        ...
        if (l0.tag == 895u) {
            ...
            if (l0.tag == 894u) {
                ...
                if ((l0.tag == 893u || l0.tag == 896u || l0.tag == 904u || l0.tag == 906u)) {
                    l1 = INT64_C(8);
                } else {
                    if ((l0.tag == 892u || l0.tag == 905u || l0.tag == 909u)) {
                        l1 = INT64_C(16);
                    } else {
        ...
        if (l0.tag == 904u) {
            ...
            if (l0.tag == 906u) {
                ...
                if (l0.tag == 909u) {
                    ...
                    if ((l0.tag == 892u || l0.tag == 894u || l0.tag == 895u || l0.tag == 896u || l0.tag == 897u || l0.tag == 898u || l0.tag == 899u || l0.tag == 900u || l0.tag == 902u || l0.tag == 903u || l0.tag == 905u || l0.tag == 907u || l0.tag == 908u || l0.tag == 910u)) {
                        l1 = false;
                    } else {
    ...
    if (l0.tag == 893u) {
        ...
        if (l0.tag == 904u) {
            ...
            if (l0.tag == 906u) {
                ...
                if ((l0.tag == 892u || l0.tag == 894u || l0.tag == 895u || l0.tag == 896u || l0.tag == 897u || l0.tag == 898u || l0.tag == 899u || l0.tag == 900u || l0.tag == 902u || l0.tag == 903u || l0.tag == 905u || l0.tag == 907u || l0.tag == 908u || l0.tag == 909u || l0.tag == 910u)) {
                    l1 = false;
                } else {
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 395u, l3);
                ...
                if (l1.tag == 894u) {
                    ...
                    if (l1.tag == 905u) {
                        ...
                        if (l1.tag == 908u) {
                            ...
                            if (l1.tag == 907u) {
                                std_string_builder_append(l0, 2295u);
                            } else {
                                if (l1.tag == 903u) {
                                    std_string_builder_append(l0, 761u);
                                } else {
                                    if (l1.tag == 910u) {
                                        std_string_builder_append(l0, 546u);
                                    } else {
                                        if (l1.tag == 900u) {
                                            std_string_builder_append(l0, 1999u);
                                        } else {
                                            if (l1.tag == 899u) {
                                                std_string_builder_append(l0, 2553u);
                                            } else {
                                                if (l1.tag == 898u) {
                                                    std_string_builder_append(l0, 2552u);
                                                } else {
                                                    if (l1.tag == 897u) {
                                                        std_string_builder_append(l0, 2551u);
                                                    } else {
                                                        if (l1.tag == 893u) {
                                                            t0 = l1.payload.obj;
                                                            if (((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 909u) {
                                                                l5 = true;
                                                            } else {
                                                                t0 = l1.payload.obj;
                                                                l5 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 896u;
                                                            }
                                                            if (l5) {
                                                            ...
                                                            std_string_builder_append(l0, 883u);
                                                            if (l2) {
                                                                t0 = l1.payload.obj;
                                                                t1 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_immutable;
                                                                l5 = !(t1);
                                                            ...
                                                            if (l1.tag == 906u) {
                                                                ...
                                                                vader_types_write_type_list_mut(l0, l4, 395u, l2);
                                                                ...
                                                                if (l1.tag == 896u) {
                                                                    std_string_builder_append(l0, 1690u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
                                                                    ...
                                                                    l8 = (size_t) (int64_t) INT64_C(0);
                                                                    {
                                                                        loop_268: {
                                                                            if ((l8 < l7)) {
                                                                                if (!(l5)) {
                                                                                    std_string_builder_append(l0, 395u);
                                                                                }
                                                                                l5 = false;
                                                                                t0 = l1.payload.obj;
                                                                    ...
                                                                    std_string_builder_append(l0, 349u);
                                                                    t0 = l1.payload.obj;
                                                                    ...
                                                                    if (l1.tag == 909u) {
                                                                        ...
                                                                        vader_types_write_type_list_mut(l0, l4, 218u, l2);
                                                                    } else {
                                                                        if (l1.tag == 892u) {
                                                                            std_string_builder_append(l0, 560u);
                                                                        } else {
                                                                            { vader_gc_top = gc_frame.prev; return; }
                                                                        }
                                                                    }
