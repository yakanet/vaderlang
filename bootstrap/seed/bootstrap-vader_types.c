...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 908u) {
        ...
        if (t2) {
            ...
            t0 = concat_3(1153u, l2, 340u);
            { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l2 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) l1)->f_element);
        t0 = concat_3(1163u, l2, 340u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 921u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1440u);
    ...
    if (l0.tag == 909u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1406u);
    ...
    if (l0.tag == 915u) {
        { vader_gc_top = gc_frame.prev; return 243u; }
    }
    if (l0.tag == 914u) {
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 383u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 915u) {
        std_string_builder_append(l0, 1870u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 914u) {
    ...
    if (l1.tag == 921u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 383u, l2);
    ...
    if (l1.tag == 911u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1577u);
        l6 = true;
        ...
        l9 = (size_t) (int64_t) INT64_C(0);
        {
            loop_279: {
                if ((l9 < l8)) {
                    if (!(l6)) {
                        std_string_builder_append(l0, 383u);
                    } else {
                    }
                    l6 = false;
        ...
        std_string_builder_append(l0, 344u);
    ...
    if (l1.tag == 924u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 224u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 907u) {
