...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 914u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1952u);
    ...
    if (l0.tag == 915u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2115u);
    ...
    if (l0.tag == 903u) {
        ...
        if (t2) {
            ...
            t0 = concat_3(1143u, l2, 327u);
            { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l2 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) l1)->f_element);
        t0 = concat_3(1153u, l2, 327u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 916u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 904u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1395u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        { vader_gc_top = gc_frame.prev; return 2152u; }
    }
    if (l0.tag == 902u) {
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 906u);
    _a2_obj->f_params = l1;
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 917u) {
        std_string_builder_append(l0, 2152u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 913u) {
    ...
    if (l1.tag == 907u) {
        std_string_builder_append(l0, 2401u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 903u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 919u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 906u;
        }
        if (l6) {
    ...
    if (l1.tag == 906u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1562u);
        l6 = true;
