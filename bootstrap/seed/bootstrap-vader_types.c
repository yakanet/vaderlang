...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2120u);
    ...
    if (l0.tag == 899u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1391u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 903u) {
        { vader_gc_top = gc_frame.prev; return 2412u; }
    }
    if (l0.tag == 902u) {
    ...
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2157u; }
    }
    if (l0.tag == 897u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 912u) {
        std_string_builder_append(l0, 2157u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 908u) {
    ...
    if (l1.tag == 905u) {
        std_string_builder_append(l0, 1849u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 904u) {
    ...
    if (l1.tag == 901u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1556u);
        l6 = true;
