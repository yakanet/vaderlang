...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 936u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2046u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 937u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2187u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 925u) {
        ...
        if (t3) {
            ...
            t1 = concat_3(1203u, l1, 331u);
            { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t0 = l0.payload.obj;
        l1 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
        t1 = concat_3(1215u, l1, 331u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 938u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 927u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1502u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 926u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1466u);
        t0 = l0.payload.obj;
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 932u) {
        { vader_gc_top = gc_frame.prev; return 1944u; }
    }
    if (l0.tag == 931u) {
        { vader_gc_top = gc_frame.prev; return 2485u; }
    }
    if (l0.tag == 930u) {
                ...
                if (l1.tag == 926u) {
                    ...
                    if (l1.tag == 937u) {
                        ...
                        if (l1.tag == 940u) {
                            ...
                            if (l1.tag == 939u) {
                                std_string_builder_append(l0, 2232u);
                            } else {
                                if (l1.tag == 935u) {
                                    ...
                                    if (l1.tag == 942u) {
                                        ...
                                        if (l1.tag == 932u) {
                                            std_string_builder_append(l0, 1944u);
                                        } else {
                                            if (l1.tag == 931u) {
                                                std_string_builder_append(l0, 2485u);
                                            } else {
                                                if (l1.tag == 930u) {
                                                    ...
                                                    if (l1.tag == 929u) {
                                                        ...
                                                        if (l1.tag == 925u) {
                                                            ...
                                                            if (l1.tag == 938u) {
                                                                ...
                                                                if (l1.tag == 928u) {
                                                                    std_string_builder_append(l0, 1636u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
