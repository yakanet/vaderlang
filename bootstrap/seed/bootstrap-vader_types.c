...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 925u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1980u);
    ...
    if (l0.tag == 916u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1455u);
    ...
    if (l0.tag == 915u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1420u);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 921u) {
        std_string_builder_append(l0, 1883u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 920u) {
    ...
    if (l1.tag == 917u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1589u);
        l6 = true;
