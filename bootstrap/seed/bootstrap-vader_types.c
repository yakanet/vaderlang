...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1969u);
    ...
    if (l0.tag == 912u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1442u);
    ...
    if (l0.tag == 917u) {
        { vader_gc_top = gc_frame.prev; return 229u; }
    }
    if (l0.tag == 916u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 926u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 210u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 909u) {
