...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 909u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1948u);
        ...
        l3 = std_core_write_string_at(l4, l3, 501u);
        l3 = std_core_write_string_at(l4, l3, l2);
        l3 = std_core_write_string_at(l4, l3, 520u);
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2123u);
    ...
    if (l0.tag == 913u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 657u);
    ...
    if (l0.tag == 900u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1427u);
    ...
    if (l0.tag == 899u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1393u);
    ...
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 636u; }
    }
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 731u; }
    }
    if (l0.tag == 915u) {
        { vader_gc_top = gc_frame.prev; return 524u; }
    }
    if (l0.tag == 905u) {
        { vader_gc_top = gc_frame.prev; return 235u; }
    }
    if (l0.tag == 904u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 904u) {
        { vader_gc_top = gc_frame.prev; return 2416u; }
    }
    if (l0.tag == 903u) {
        { vader_gc_top = gc_frame.prev; return 2415u; }
    }
    if (l0.tag == 902u) {
        { vader_gc_top = gc_frame.prev; return 2414u; }
    }
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 733u; }
    }
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2160u; }
    }
    if (l0.tag == 897u) {
...
vader_box_t vader_types_mk_fn(void* l0, vader_box_t l1) {
    ...
    vader_obj_header_init(_a1_obj, 901u);
    _a1_obj->f_params = l0;
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    l5 = (size_t) (int64_t) INT64_C(1);
    {
        loop_18: {
            if ((l5 < l4)) {
                ...
                t1 = vader_box_bool(159u, ((uint8_t*) _a1_slotarr->buf->slots)[_a1_slotarr->offset + (size_t) l5]);
                l6 = t1.payload.b;
    ...
    vader_obj_header_init(_a2_obj, 901u);
    _a2_obj->f_params = l1;
...
vader_box_t vader_types_mk_primitive(vader_string_t l0) {
    ...
    vader_obj_header_init(_a0_obj, 907u);
    _a0_obj->f_name = l0;
    t0 = (void*) _a0_obj;
    { vader_box_t __vret = vader_ref_box(t0); vader_gc_top = gc_frame.prev; return __vret; }
    vader_gc_top = gc_frame.prev;
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 375u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 912u) {
        std_string_builder_append(l0, 2160u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 908u) {
        std_string_builder_append(l0, 733u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 915u) {
        std_string_builder_append(l0, 524u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 905u) {
        std_string_builder_append(l0, 1851u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 904u) {
    ...
    if (l1.tag == 898u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 914u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 901u;
        }
        if (l6) {
        ...
        std_string_builder_append(l0, 842u);
        if (l2) {
    ...
    if (l1.tag == 911u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 375u, l2);
    ...
    if (l1.tag == 901u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1558u);
        l6 = true;
        ...
        std_string_builder_append(l0, 336u);
    ...
    if (l1.tag == 897u) {
        std_string_builder_append(l0, 538u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    { vader_gc_top = gc_frame.prev; return; }
    vader_gc_top = gc_frame.prev;
