...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2119u);
    ...
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 729u; }
    }
    if (l0.tag == 915u) {
        { vader_gc_top = gc_frame.prev; return 522u; }
    }
    if (l0.tag == 905u) {
        { vader_gc_top = gc_frame.prev; return 234u; }
    }
    if (l0.tag == 904u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 905u) {
        { vader_gc_top = gc_frame.prev; return 1848u; }
    }
    if (l0.tag == 904u) {
    ...
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2156u; }
    }
    if (l0.tag == 897u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 912u) {
        std_string_builder_append(l0, 2156u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 908u) {
        std_string_builder_append(l0, 731u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 915u) {
    ...
    if (l1.tag == 905u) {
        std_string_builder_append(l0, 1848u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 904u) {
    ...
    if (l1.tag == 914u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 215u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 897u) {
