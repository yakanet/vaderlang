...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 938u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2077u);
        t0 = l0.payload.obj;
        ...
        l2 = std_core_write_string_at(l3, l2, 519u);
        l2 = std_core_write_string_at(l3, l2, l1);
        l2 = std_core_write_string_at(l3, l2, 538u);
    ...
    if (l0.tag == 939u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2219u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 927u) {
        ...
        if (t3) {
            ...
            t1 = concat_3(1226u, l1, 344u);
            { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
        }
        t0 = l0.payload.obj;
        l1 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) t0)->f_element);
        t1 = concat_3(1238u, l1, 344u);
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 940u) {
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 929u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1531u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 928u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1493u);
        t0 = l0.payload.obj;
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 931u) {
        { vader_gc_top = gc_frame.prev; return 2518u; }
    }
    if (l0.tag == 937u) {
        { vader_gc_top = gc_frame.prev; return 755u; }
    }
    if (l0.tag == 941u) {
        { vader_gc_top = gc_frame.prev; return 2264u; }
    }
    if (l0.tag == 926u) {
...
vader_string_t vader_types_display_type_key(vader_box_t l0) {
    ...
    if ((l0.tag == 928u || l0.tag == 929u || l0.tag == 942u)) {
        t0 = l0.payload.obj;
        t1 = ((vader_struct_vader_resolver_symbol_Symbol_t*) ((vader_struct_vader_types_DistinctType_t*) t0)->f_symbol)->f_name;
        { vader_string_t __vret = t1; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if ((l0.tag == 938u || l0.tag == 939u)) {
        t0 = l0.payload.obj;
...
vader_box_t vader_types_mk_fn(void* l0, vader_box_t l1) {
    ...
    vader_obj_header_init(_a1_obj, 930u);
    _a1_obj->f_params = l0;
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 930u);
    _a2_obj->f_params = l1;
    ...
    if (l0.tag == 936u) {
        ...
        if (l0.tag == 929u) {
            ...
            if (l0.tag == 928u) {
                ...
                if ((l0.tag == 927u || l0.tag == 930u || l0.tag == 938u || l0.tag == 940u)) {
                    l1 = INT64_C(8);
                } else {
                    if ((l0.tag == 926u || l0.tag == 939u || l0.tag == 943u)) {
                        l1 = INT64_C(16);
                    } else {
        ...
        if (l0.tag == 938u) {
            ...
            if (l0.tag == 940u) {
                ...
                if (l0.tag == 943u) {
                    ...
                    if ((l0.tag == 926u || l0.tag == 928u || l0.tag == 929u || l0.tag == 930u || l0.tag == 931u || l0.tag == 932u || l0.tag == 933u || l0.tag == 934u || l0.tag == 936u || l0.tag == 937u || l0.tag == 939u || l0.tag == 941u || l0.tag == 942u || l0.tag == 944u)) {
                        l1 = false;
                    } else {
    ...
    if (l0.tag == 927u) {
        ...
        if (l0.tag == 938u) {
            ...
            if (l0.tag == 940u) {
                ...
                if ((l0.tag == 926u || l0.tag == 928u || l0.tag == 929u || l0.tag == 930u || l0.tag == 931u || l0.tag == 932u || l0.tag == 933u || l0.tag == 934u || l0.tag == 936u || l0.tag == 937u || l0.tag == 939u || l0.tag == 941u || l0.tag == 942u || l0.tag == 943u || l0.tag == 944u)) {
                    l1 = false;
                } else {
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 394u, l3);
                ...
                if (l1.tag == 928u) {
                    ...
                    if (l1.tag == 939u) {
                        ...
                        if (l1.tag == 942u) {
                            ...
                            if (l1.tag == 941u) {
                                std_string_builder_append(l0, 2264u);
                            } else {
                                if (l1.tag == 937u) {
                                    ...
                                    if (l1.tag == 944u) {
                                        ...
                                        if (l1.tag == 934u) {
                                            std_string_builder_append(l0, 1972u);
                                        } else {
                                            if (l1.tag == 933u) {
                                                ...
                                                if (l1.tag == 932u) {
                                                    ...
                                                    if (l1.tag == 931u) {
                                                        std_string_builder_append(l0, 2518u);
                                                    } else {
                                                        if (l1.tag == 927u) {
                                                            t0 = l1.payload.obj;
                                                            if (((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 943u) {
                                                                l5 = true;
                                                            } else {
                                                                t0 = l1.payload.obj;
                                                                l5 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_element.tag == 930u;
                                                            }
                                                            if (l5) {
                                                            ...
                                                            std_string_builder_append(l0, 872u);
                                                            if (l2) {
                                                                t0 = l1.payload.obj;
                                                                t1 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_immutable;
                                                                l5 = !(t1);
                                                            ...
                                                            if (l1.tag == 940u) {
                                                                ...
                                                                vader_types_write_type_list_mut(l0, l4, 394u, l2);
                                                                ...
                                                                if (l1.tag == 930u) {
                                                                    std_string_builder_append(l0, 1665u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
                                                                    ...
                                                                    l8 = (size_t) (int64_t) INT64_C(0);
                                                                    {
                                                                        loop_268: {
                                                                            if ((l8 < l7)) {
                                                                                if (!(l5)) {
                                                                                    std_string_builder_append(l0, 394u);
                                                                                }
                                                                                l5 = false;
                                                                                t0 = l1.payload.obj;
                                                                    ...
                                                                    std_string_builder_append(l0, 347u);
                                                                    t0 = l1.payload.obj;
                                                                    ...
                                                                    if (l1.tag == 943u) {
                                                                        ...
                                                                        vader_types_write_type_list_mut(l0, l4, 217u, l2);
                                                                    } else {
                                                                        if (l1.tag == 926u) {
