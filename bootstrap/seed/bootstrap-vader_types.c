...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 937u) {
        ...
        l2 = std_core_write_string_at(l3, l2, 2076u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 938u) {
        ...
        l3 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l2));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 2218u);
        t0 = l0.payload.obj;
    ...
    if (l0.tag == 928u) {
        l3 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l2 = (size_t) (int64_t) INT64_C(0);
        l2 = std_core_write_string_at(l3, l2, 1530u);
        t0 = l0.payload.obj;
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 940u) {
        { vader_gc_top = gc_frame.prev; return 2263u; }
    }
    if (l0.tag == 925u) {
...
vader_string_t vader_types_type_base_name(vader_box_t l0) {
    ...
    if (l0.tag == 926u) {
        { vader_gc_top = gc_frame.prev; return 871u; }
    }
                ...
                if (l1.tag == 927u) {
                    ...
                    if (l1.tag == 938u) {
                        ...
                        if (l1.tag == 941u) {
                            ...
                            if (l1.tag == 940u) {
                                std_string_builder_append(l0, 2263u);
                            } else {
                                if (l1.tag == 936u) {
                                    std_string_builder_append(l0, 754u);
                                } else {
                                    if (l1.tag == 943u) {
                                        std_string_builder_append(l0, 542u);
                                    } else {
                                        if (l1.tag == 933u) {
                                            std_string_builder_append(l0, 1971u);
                                        } else {
                                            if (l1.tag == 932u) {
                                                ...
                                                if (l1.tag == 931u) {
                                                    ...
                                                    if (l1.tag == 930u) {
                                                        ...
                                                        if (l1.tag == 926u) {
                                                            ...
                                                            std_string_builder_append(l0, 871u);
                                                            if (l2) {
                                                                t0 = l1.payload.obj;
                                                                t1 = ((vader_struct_vader_types_ArrayType_t*) t0)->f_immutable;
                                                                l5 = !(t1);
                                                            ...
                                                            if (l1.tag == 939u) {
                                                                ...
                                                                if (l1.tag == 929u) {
                                                                    std_string_builder_append(l0, 1664u);
                                                                    l5 = true;
                                                                    t0 = l1.payload.obj;
