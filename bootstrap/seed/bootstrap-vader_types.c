...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 919u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1966u);
    ...
    if (l0.tag == 920u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2143u);
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1438u);
    ...
    if (l0.tag == 909u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1404u);
    ...
    if (l0.tag == 918u) {
        { vader_gc_top = gc_frame.prev; return 741u; }
    }
    if (l0.tag == 925u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 913u) {
        { vader_gc_top = gc_frame.prev; return 2439u; }
    }
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2438u; }
    }
    if (l0.tag == 918u) {
...
vader_string_t vader_types_type_base_name(vader_box_t l0) {
    ...
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 852u; }
    }
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 918u) {
        std_string_builder_append(l0, 743u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 925u) {
    ...
    if (l1.tag == 915u) {
        std_string_builder_append(l0, 1868u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 914u) {
    ...
    if (l1.tag == 913u) {
        std_string_builder_append(l0, 2439u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 912u) {
    ...
    if (l1.tag == 908u) {
        ...
        std_string_builder_append(l0, 852u);
        if (l2) {
    ...
    if (l1.tag == 911u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1575u);
        l6 = true;
        ...
        std_string_builder_append(l0, 343u);
