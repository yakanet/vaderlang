...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1971u);
    ...
    if (l0.tag == 922u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2130u);
    ...
    if (l0.tag == 910u) {
        ...
        if (t2) {
            ...
            t0 = concat_3(1153u, l2, 328u);
            { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
        }
        l2 = vader_types_canonical_key(((vader_struct_vader_types_ArrayType_t*) l1)->f_element);
        t0 = concat_3(1163u, l2, 328u);
        { vader_string_t __vret = t0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 923u) {
        l1 = l0.payload.obj;
    ...
    if (l0.tag == 925u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 659u);
    ...
    if (l0.tag == 912u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1443u);
    ...
    if (l0.tag == 917u) {
        { vader_gc_top = gc_frame.prev; return 230u; }
    }
    if (l0.tag == 916u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 916u) {
        { vader_gc_top = gc_frame.prev; return 2421u; }
    }
    if (l0.tag == 915u) {
        { vader_gc_top = gc_frame.prev; return 2420u; }
    }
    if (l0.tag == 914u) {
        { vader_gc_top = gc_frame.prev; return 2419u; }
    }
    if (l0.tag == 920u) {
        { vader_gc_top = gc_frame.prev; return 737u; }
    }
    if (l0.tag == 924u) {
        { vader_gc_top = gc_frame.prev; return 2167u; }
    }
    if (l0.tag == 909u) {
...
vader_string_t vader_types_type_base_name(vader_box_t l0) {
    ...
    if (l0.tag == 910u) {
        { vader_gc_top = gc_frame.prev; return 847u; }
    }
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 924u) {
        std_string_builder_append(l0, 2167u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 920u) {
        std_string_builder_append(l0, 737u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 927u) {
    ...
    if (l1.tag == 917u) {
        std_string_builder_append(l0, 1873u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 916u) {
    ...
    if (l1.tag == 910u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 926u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 913u;
        }
        if (l6) {
        ...
        std_string_builder_append(l0, 847u);
        if (l2) {
    ...
    if (l1.tag == 926u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 211u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 909u) {
