...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 909u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1942u);
    ...
    if (l0.tag == 910u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2109u);
    ...
    if (l0.tag == 899u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1386u);
    ...
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 724u; }
    }
    if (l0.tag == 915u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 902u) {
        { vader_gc_top = gc_frame.prev; return 2394u; }
    }
    if (l0.tag == 908u) {
        { vader_gc_top = gc_frame.prev; return 726u; }
    }
    if (l0.tag == 912u) {
        { vader_gc_top = gc_frame.prev; return 2146u; }
    }
    if (l0.tag == 897u) {
...
static void vader_types_write_named_mut(void* l0, vader_string_t l1, void* l2, bool l3) {
    ...
    vader_types_write_type_list_mut(l0, l2, 367u, l3);
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 912u) {
        std_string_builder_append(l0, 2146u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 908u) {
        std_string_builder_append(l0, 726u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 915u) {
    ...
    if (l1.tag == 905u) {
        std_string_builder_append(l0, 1844u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 904u) {
    ...
    if (l1.tag == 903u) {
        std_string_builder_append(l0, 2395u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 902u) {
        std_string_builder_append(l0, 2394u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 898u) {
        l4 = l1.payload.obj;
    ...
    if (l1.tag == 911u) {
        ...
        vader_types_write_type_list_mut(l0, l5, 367u, l2);
    ...
    if (l1.tag == 901u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1552u);
        l6 = true;
    ...
    if (l1.tag == 914u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 209u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 897u) {
