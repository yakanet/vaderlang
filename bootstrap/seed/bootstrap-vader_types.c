...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 917u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1936u);
    ...
    if (l0.tag == 921u) {
        ...
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 654u);
    ...
    if (l0.tag == 907u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1377u);
    ...
    if (l0.tag == 920u) {
        { vader_gc_top = gc_frame.prev; return 633u; }
    }
    if (l0.tag == 916u) {
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 911u) {
        { vader_gc_top = gc_frame.prev; return 2417u; }
    }
    if (l0.tag == 910u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 916u) {
        std_string_builder_append(l0, 730u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 923u) {
    ...
    if (l1.tag == 913u) {
        std_string_builder_append(l0, 1838u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 912u) {
    ...
    if (l1.tag == 906u) {
        ...
        std_string_builder_append(l0, 837u);
        if (l2) {
    ...
    if (l1.tag == 909u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1546u);
        l6 = true;
    ...
    if (l1.tag == 922u) {
        ...
        vader_types_write_type_list_mut(l0, l4, 221u, l2);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 905u) {
