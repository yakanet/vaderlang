...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 923u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2116u);
    ...
    if (l0.tag == 913u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1450u);
    ...
    if (l0.tag == 912u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1415u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 916u) {
        { vader_gc_top = gc_frame.prev; return 2403u; }
    }
    if (l0.tag == 915u) {
    ...
    if (l0.tag == 925u) {
        { vader_gc_top = gc_frame.prev; return 2153u; }
    }
    if (l0.tag == 910u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 925u) {
        std_string_builder_append(l0, 2153u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 921u) {
    ...
    if (l1.tag == 918u) {
        std_string_builder_append(l0, 1877u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 917u) {
    ...
    if (l1.tag == 915u) {
        std_string_builder_append(l0, 2402u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 911u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 927u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 914u;
        }
        if (l6) {
    ...
    if (l1.tag == 914u) {
        l4 = l1.payload.obj;
        std_string_builder_append(l0, 1584u);
        l6 = true;
