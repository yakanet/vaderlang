...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 940u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 1961u);
    ...
    if (l0.tag == 941u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2127u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 943u) {
        { vader_gc_top = gc_frame.prev; return 2164u; }
    }
    if (l0.tag == 928u) {
...
vader_box_t vader_types_mk_fn(void* l0, vader_box_t l1) {
    ...
    vader_obj_header_init(_a1_obj, 932u);
    _a1_obj->f_params = l0;
...
vader_box_t vader_types_mk_fn_drop_self(void* l0, void* l1, vader_box_t l2) {
    ...
    vader_obj_header_init(_a2_obj, 932u);
    _a2_obj->f_params = l1;
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 943u) {
        std_string_builder_append(l0, 2164u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 939u) {
    ...
    if (l1.tag == 929u) {
        l4 = l1.payload.obj;
        if (((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 945u) {
            l6 = true;
        } else {
            l6 = ((vader_struct_vader_types_ArrayType_t*) l4)->f_element.tag == 932u;
        }
        if (l6) {
