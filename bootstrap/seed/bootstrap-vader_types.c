...
vader_string_t vader_types_canonical_key(vader_box_t l0) {
    ...
    if (l0.tag == 918u) {
        ...
        l3 = std_core_write_string_at(l4, l3, 524u);
    ...
    if (l0.tag == 919u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) (INT64_C(23) + l3));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 2134u);
    ...
    if (l0.tag == 909u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1422u);
    ...
    if (l0.tag == 908u) {
        ...
        l4 = std_core_new_byte_buffer((size_t) (int64_t) INT64_C(21));
        l3 = (size_t) (int64_t) INT64_C(0);
        l3 = std_core_write_string_at(l4, l3, 1388u);
...
vader_string_t vader_types_display_type(vader_box_t l0) {
    ...
    if (l0.tag == 921u) {
        { vader_gc_top = gc_frame.prev; return 2172u; }
    }
    if (l0.tag == 906u) {
...
static void vader_types_write_type_mut(void* l0, vader_box_t l1, bool l2) {
    ...
    if (l1.tag == 921u) {
        std_string_builder_append(l0, 2172u);
        { vader_gc_top = gc_frame.prev; return; }
    }
    if (l1.tag == 917u) {
    ...
    if (l1.tag == 910u) {
        ...
        std_string_builder_append(l0, 341u);
