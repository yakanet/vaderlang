...
static void vader_resolver_add_fn(void* l0, void* l1, vader_string_t l2, vader_string_t l3, void* l4, void* l5) {
    ...
    if (l9.tag == 900u) {
        ...
        if (l15.tag == 0u) {
            ...
            vader_array_t* _a0_arr = vader_array_new(89u, 1u, 13u, 900u);
    ...
    if (l15.tag == 0u) {
        l16 = ((vader_struct_vader_resolver_CollectedModule_t*) l0)->f_fn_overloads;
        l17 = ((vader_struct_toolchain_ast_FnDecl_t*) l1)->f_name;
        vader_array_t* _a1_arr = vader_array_new(89u, 1u, 13u, 900u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_109: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a9_obj, 195u);
                _a9_obj->f__0 = l8;
                _a9_obj->f__1 = l2;
                l9 = (void*) _a9_obj;
                l10 = ((vader_struct___Tuple_1135_t*) l9)->f__0;
...
static void vader_resolver_check_groups(void* l0, void* l1) {
    ...
    l3 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(15u, 0u, 0u, 174u);
    l4 = (void*) _a5_arr;
    ...
    vader_obj_header_init(_a7_obj, 333u);
    _a7_obj->f_ekeys = l3;
    _a7_obj->f_evals = l4;
    _a7_obj->f_index = l5;
...
static void* vader_resolver_collect_module(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a7_obj, 335u);
    _a7_obj->f_ekeys = l8;
    _a7_obj->f_evals = l9;
    _a7_obj->f_index = l10;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    l13 = (void*) _a10_arr;
    vader_array_t* _a11_arr = vader_array_new(15u, 0u, 0u, 174u);
    l14 = (void*) _a11_arr;
    ...
    vader_obj_header_init(_a13_obj, 335u);
    ...
    t0 = (void*) _a14_obj;
    vader_array_t* _a15_arr = vader_array_new(82u, 1u, 13u, 882u);
...
static void* vader_resolver_collect_module_no_index(void* l0, vader_string_t l1, void* l2) {
    ...
    _a3_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l3 = (void*) _a3_obj;
    vader_array_t* _a4_arr = vader_array_new(51u, 0u, 13u, 712u);
    l4 = (void*) _a4_arr;
    vader_array_t* _a5_arr = vader_array_new(84u, 0u, 13u, 886u);
    l5 = (void*) _a5_arr;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_26: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a7_obj, 196u);
                _a7_obj->f__0 = l9;
                _a7_obj->f__1 = l4;
                t1 = (void*) _a7_obj;
...
static void* vader_resolver_discarded_bodies(void* l0, vader_box_t l1) {
    ...
    l3 = l1.payload.obj;
    vader_array_t* _a1_arr = vader_array_new(51u, 0u, 13u, 712u);
    l4 = (void*) _a1_arr;
...
static void* vader_resolver_include_paths(vader_string_t l0, vader_string_t l1, void* l2, vader_string_t l3) {
    ...
    t0 = (void*) _a0_obj;
    vader_array_t* _a1_arr = vader_array_new(84u, 1u, 13u, 886u);
...
static void* vader_resolver_intrinsic_decorator(void* l0) {
    ...
    _a1_obj->f_args = l1;
    t0 = (void*) _a1_obj;
    vader_array_t* _a2_arr = vader_array_new(22u, 1u, 13u, 420u);
...
static void vader_resolver_load_baked_target(void* l0, void* l1, void* l2, void* l3, void* l4, void* l5, void* l6, void* l7) {
    ...
    if (!(t1)) {
        t0 = l8.payload.obj;
        vader_array_t* _a0_arr = vader_array_new(81u, 1u, 13u, 881u);
    ...
    l15 = (size_t) (int64_t) INT64_C(0);
    {
        loop_60: {
            if ((l15 >= l14)) {
                ...
                vader_obj_header_init(_a8_obj, 198u);
                _a8_obj->f__0 = l9;
                _a8_obj->f__1 = l16;
                l11 = (void*) _a8_obj;
    ...
    vader_array_box_slots(_a9_arr->buf)[_a9_arr->offset + 0u] = vader_box_string(163u, 504u);
    l11 = (void*) _a9_arr;
    ...
    t0 = (void*) _a10_obj;
    vader_array_t* _a11_arr = vader_array_new(81u, 1u, 13u, 881u);
...
static void* vader_resolver_load_project_with_overlay(vader_string_t l0, void* l1, void* l2, vader_box_t l3) {
    ...
    vader_array_t* _a1_arr = vader_array_new(8u, 0u, 0u, 163u);
    l10 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(15u, 0u, 0u, 174u);
    l11 = (void*) _a2_arr;
    vader_array_t* _a3_arr = vader_array_new(9u, 0u, 7u, 166u);
    l12 = (void*) _a3_arr;
    ...
    _a4_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l10 = (void*) _a4_obj;
    vader_array_t* _a5_arr = vader_array_new(51u, 0u, 13u, 712u);
    l11 = (void*) _a5_arr;
    ...
    if (l7.tag == 163u) {
        ...
        l16 = (void*) _a6_arr;
        vader_array_t* _a7_arr = vader_array_new(15u, 0u, 0u, 174u);
        l17 = (void*) _a7_arr;
        ...
        if (l23.tag == 881u) {
            ...
            if (l39.tag == 881u) {
                ...
                if (!(t2)) {
                    vader_array_t* _a12_arr = vader_array_new(81u, 1u, 13u, 881u);
    ...
    if (l7.tag == 0u) {
        ...
        l16 = (void*) _a16_arr;
        vader_array_t* _a17_arr = vader_array_new(15u, 0u, 0u, 174u);
        l17 = (void*) _a17_arr;
        ...
        vader_obj_header_init(_a19_obj, 333u);
        ...
        if (l23.tag == 881u) {
            ...
            vader_array_t* _a21_arr = vader_array_new(81u, 1u, 13u, 881u);
            ...
            if (l39.tag == 881u) {
                ...
                t2 = vader_resolver_has_module(l10, l41);
                if (!(t2)) {
                    vader_array_t* _a22_arr = vader_array_new(81u, 1u, 13u, 881u);
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_169: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a5_obj, 200u);
                _a5_obj->f__0 = l8;
                _a5_obj->f__1 = l3;
                l9 = (void*) _a5_obj;
    ...
    l7 = (size_t) (int64_t) INT64_C(0);
    {
        loop_263: {
            if ((l7 >= l6)) {
                ...
                vader_obj_header_init(_a9_obj, 199u);
                _a9_obj->f__0 = l27;
                _a9_obj->f__1 = l3;
                l9 = (void*) _a9_obj;
...
static void* vader_resolver_parse_module_files(void* l0, void* l1, void* l2, void* l3) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(87u, 0u, 13u, 895u);
    l4 = (void*) _a0_arr;
    l5 = l0;
    l6 = ((vader_array_t*) l5)->length;
    l7 = (size_t) (int64_t) INT64_C(0);
...
static void* vader_resolver_project_include_paths(vader_box_t l0, void* l1, void* l2) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(84u, 0u, 13u, 886u);
    l3 = (void*) _a0_arr;
    l4 = l2;
    l5 = ((vader_array_t*) l4)->length;
    l6 = (size_t) (int64_t) INT64_C(0);
...
void* vader_resolver_resolve_module_with_collected_dp_seeded(void* l0, vader_string_t l1, vader_string_t l2, void* l3, void* l4, void* l5, void* l6) {
    ...
    vader_obj_header_init(_a7_obj, 295u);
    _a7_obj->f_ekeys = l17;
    _a7_obj->f_evals = l18;
    _a7_obj->f_index = l19;
    _a7_obj->f_mask = (size_t) (int64_t) INT64_C(0);
    ...
    vader_array_t* _a8_arr = vader_array_new(9u, 0u, 7u, 166u);
    l18 = (void*) _a8_arr;
    vader_array_t* _a9_arr = vader_array_new(15u, 0u, 0u, 174u);
    l19 = (void*) _a9_arr;
    vader_array_t* _a10_arr = vader_array_new(9u, 0u, 7u, 166u);
    l20 = (void*) _a10_arr;
    ...
    vader_obj_header_init(_a11_obj, 295u);
    ...
    vader_array_t* _a12_arr = vader_array_new(9u, 0u, 7u, 166u);
    l19 = (void*) _a12_arr;
    vader_array_t* _a13_arr = vader_array_new(15u, 0u, 0u, 174u);
    l20 = (void*) _a13_arr;
    ...
    vader_obj_header_init(_a15_obj, 295u);
    ...
    vader_obj_header_init(_a19_obj, 327u);
    ...
    l22 = (void*) _a20_arr;
    vader_array_t* _a21_arr = vader_array_new(15u, 0u, 0u, 174u);
    l23 = (void*) _a21_arr;
    ...
    vader_obj_header_init(_a23_obj, 311u);
    ...
    l23 = (void*) _a24_arr;
    vader_array_t* _a25_arr = vader_array_new(15u, 0u, 0u, 174u);
    l24 = (void*) _a25_arr;
    ...
    vader_obj_header_init(_a27_obj, 311u);
...
static void* vader_resolver_resolve_program(void* l0, void* l1, vader_string_t l2, void* l3, void* l4) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(13u, 0u, 4u, 172u);
    l5 = (void*) _a0_arr;
    vader_array_t* _a1_arr = vader_array_new(15u, 0u, 0u, 174u);
    l6 = (void*) _a1_arr;
    vader_array_t* _a2_arr = vader_array_new(9u, 0u, 7u, 166u);
    ...
    _a15_obj->f_tombs = (size_t) (int64_t) INT64_C(0);
    l8 = (void*) _a15_obj;
    vader_array_t* _a16_arr = vader_array_new(51u, 0u, 13u, 712u);
    l9 = (void*) _a16_arr;
...
static void* vader_resolver_select_target_bodies(void* l0, vader_box_t l1, void* l2) {
    ...
    vader_array_t* _a15_arr = vader_array_new(87u, 0u, 13u, 895u);
    l5 = (void*) _a15_arr;
    l6 = l0;
    l8 = ((vader_array_t*) l6)->length;
    l9 = (size_t) (int64_t) INT64_C(0);
    {
        loop_458: {
            if ((l9 < l8)) {
                ...
                vader_array_t* _a17_arr = vader_array_new(112u, 0u, 13u, 1053u);
                l13 = (void*) _a17_arr;
...
static vader_box_t vader_resolver_substitute_expr_full(vader_box_t l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    if ((l0.tag == 411u || l0.tag == 417u || l0.tag == 433u || l0.tag == 449u || l0.tag == 462u)) {
        { vader_box_t __vret = l0; vader_gc_top = gc_frame.prev; return __vret; }
    }
    if (l0.tag == 461u) {
        l2 = l0.payload.obj;
    ...
    if (l0.tag == 415u) {
        l2 = l0.payload.obj;
        vader_array_t* _a1_arr = vader_array_new(20u, 0u, 13u, 414u);
        l3 = (void*) _a1_arr;
    ...
    if (l0.tag == 456u) {
        l2 = l0.payload.obj;
        vader_array_t* _a14_arr = vader_array_new(28u, 0u, 13u, 455u);
        l3 = (void*) _a14_arr;
    ...
    if (l0.tag == 478u) {
        l2 = l0.payload.obj;
        vader_array_t* _a18_arr = vader_array_new(118u, 0u, 13u, 1088u);
        l3 = (void*) _a18_arr;
    ...
    if (l0.tag == 471u) {
        l2 = l0.payload.obj;
        vader_array_t* _a23_arr = vader_array_new(111u, 0u, 13u, 1045u);
        l3 = (void*) _a23_arr;
    ...
    if (l0.tag == 407u) {
        ...
        vader_obj_header_init(_a27_obj, 407u);
        _a27_obj->f_span = l3;
    ...
    if (l0.tag == 450u) {
        l2 = l0.payload.obj;
        vader_array_t* _a29_arr = vader_array_new(111u, 0u, 13u, 1045u);
        l3 = (void*) _a29_arr;
    ...
    if (l0.tag == 473u) {
        l2 = l0.payload.obj;
        vader_array_t* _a33_arr = vader_array_new(117u, 0u, 13u, 1087u);
        l3 = (void*) _a33_arr;
    ...
    if (l0.tag == 452u) {
        l2 = l0.payload.obj;
        vader_array_t* _a38_arr = vader_array_new(25u, 0u, 13u, 435u);
        l3 = (void*) _a38_arr;
...
static void* vader_resolver_substitute_params(void* l0, void* l1) {
    ...
    vader_gc_top = &gc_frame;
    vader_array_t* _a0_arr = vader_array_new(25u, 0u, 13u, 435u);
    l2 = (void*) _a0_arr;
    l3 = l0;
    l4 = ((vader_array_t*) l3)->length;
    l5 = (size_t) (int64_t) INT64_C(0);
...
static vader_box_t vader_resolver_substitute_type_expr(vader_box_t l0, void* l1) {
    ...
    if (l0.tag == 471u) {
        l2 = l0.payload.obj;
        vader_array_t* _a7_arr = vader_array_new(111u, 0u, 13u, 1045u);
        l5 = (void*) _a7_arr;
    ...
    if (l0.tag == 438u) {
        l2 = l0.payload.obj;
        vader_array_t* _a10_arr = vader_array_new(111u, 0u, 13u, 1045u);
        l5 = (void*) _a10_arr;
...
void* vader_resolver_wildcard_ambiguities(void* l0, void* l1, void* l2, void* l3) {
    ...
    l5 = (void*) _a11_arr;
    vader_array_t* _a12_arr = vader_array_new(15u, 0u, 0u, 174u);
    l6 = (void*) _a12_arr;
    ...
    vader_obj_header_init(_a14_obj, 335u);
    _a14_obj->f_ekeys = l5;
    _a14_obj->f_evals = l6;
    ...
    l8 = (size_t) (int64_t) INT64_C(0);
    {
        loop_244: {
            if ((l8 >= l7)) {
                ...
                vader_obj_header_init(_a17_obj, 197u);
                _a17_obj->f__0 = l9;
                _a17_obj->f__1 = l4;
                l13 = (void*) _a17_obj;
