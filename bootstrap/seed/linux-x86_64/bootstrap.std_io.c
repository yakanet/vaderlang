...
vader_string_t std_io_current_executable_location(void) {
    ...
    t3 = vader_host_system_posix_sys_readlink(460u, l0, l1);
    if ((t3 <= INT64_C(0))) {
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_obj_header_init(_a1_obj, 194u);
    _a1_obj->f_value = t2;
    t1 = (void*) _a1_obj;
    l1 = vader_ref_box(t1);
    ...
    l2 = (void*) _a4_arr;
    {
        loop_24: {
            ...
            if (l3.tag == 0u) {
                ...
                if (l5) {
                    vader_array_push((vader_array_t*) l2, vader_box_string(175u, l4));
                }
                goto loop_24;
            }
        }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0, size_t l1) {
    ...
    vader_gc_top = &gc_frame;
    l2 = vader_host_system_posix_sys_fopen(l0, 2008u);
    if (l2.tag == 0u) {
        t0 = std_io_last_io_error(1389u);
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    l4 = vader_host_system_posix_sys_fopen(l0, 2457u);
    if (l4.tag == 0u) {
