...
vader_string_t std_io_current_executable_location(void) {
    ...
    t3 = vader_host_system_posix_sys_readlink(444u, l0, l1);
    if ((t3 <= INT64_C(0))) {
...
vader_box_t std_io_read_dir(vader_string_t l0) {
    ...
    vader_obj_header_init(_a3_closure, 134u);
    ...
    l2 = (void*) _a4_arr;
    {
        loop_22: {
            ...
            if (l3.tag == 0u) {
                ...
                if (l5) {
                    vader_array_push((vader_array_t*) l2, vader_box_string(166u, l4));
                } else {
                }
                goto loop_22;
            }
...
static vader_box_t std_io_read_file_bytes(vader_string_t l0) {
    ...
    l3 = (void*) _a3_arr;
    {
        loop_18: {
            ...
            if ((t1 <= INT64_C(268435456))) {
                l4 = ((vader_array_t*) l3)->length;
                l5 = ((void*) (intptr_t) l1.payload.i);
                l6 = vader_host_system_posix_sys_fread(l3, (size_t) (int64_t) INT64_C(1), l4, l5);
                if ((l6 > INT64_C(0))) {
                    vader_array_t* _a4_arr = vader_array_slice((vader_array_t*) l3, (size_t) INT64_C(0), (size_t) l6);
                    l7 = (void*) _a4_arr;
...
static vader_box_t std_io_write_file_bytes(vader_string_t l0, void* l1) {
    ...
    l4 = vader_host_system_posix_sys_fopen(l0, 2377u);
    if (l4.tag == 0u) {
