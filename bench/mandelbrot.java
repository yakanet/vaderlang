...
// checksum. Run directly via `java bench/mandelbrot.java` (single-source-file
// launcher, no separate javac step).
...
public class mandelbrot {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("mandelbrot %dx%d iter=%d checksum=%d%n", WIDTH, HEIGHT, MAX_ITER, checksum);
    }
}
